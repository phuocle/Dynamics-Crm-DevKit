...
namespace PL.DynamicsCrm.DevKit.Shared
{
    public class GeneratedCSharpLateBound
    {
        ...
        internal string Go(OrganizationServiceProxy crmService, string entity, string rootNameSpace, string sharedNameSpace)
        {
            ...
            code += $"//\t\tGenerated by PL.DynamicsCrm.DevKit {PL.DynamicsCrm.DevKit.Shared.Const.VERSION} - https://github.com/phuocle/Dynamics-Crm-DevKit\r\n";
            code += $"//\t\tGenerated date: {DateTime.Now.ToString("yyyy-MM-dd hh:mm")}\r\n";
            code += $"// </auto-generated>\r\n";
            code += $"//---------------------------------------------------------------------------------------------------\r\n";
