...
namespace PL.DynamicsCrm.DevKit.Shared
{
    public class GeneratedCSharpLateBound
    {
        ...
        internal string Go(OrganizationServiceProxy crmService, string companyName, string projectName, string entity, string rootNameSpace, string sharedNameSpace)
        {
