...
namespace DynamicsCrm.DevKit.Wizard.ItemTemplates
{
    public class JsForm : IWizard
    {
        ...
        public void RunFinished()
        {
            ...
            Utility.ForceWriteAllText(TypeScriptDeclarationFileName, GeneratedJsFormCodeTypeScriptDeclaration);
        ...
        public void RunStarted(object automationObject, Dictionary<string, string> replacementsDictionary, WizardRunKind runKind, object[] customParams)
        {
            try
            {
                ...
                var form = new FormItemForm(ItemType.JsForm, DTE, string.Empty, string.Empty);
                ...
                GeneratedJsFormCodeTypeScriptDeclaration = form.GeneratedJsFormCodeTypeScriptDeclaration;
            }
            catch
            {
                throw;
