...
namespace PL.Debug.Plugin.Account
{
    ...
    "PL.Debug.Plugin.Account.PostAccountCreateSynchronous", 1, IsolationModeEnum.Sandbox,
    ...
    public class PostAccountCreateSynchronous : IPlugin
    {
        ...
        */
        ...
        public PostAccountCreateSynchronous(string unsecureString, string secureString)
        {
