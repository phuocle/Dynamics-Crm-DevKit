...
namespace PL.DevKit.Monkey.Workflow._2
{
    [CrmPluginRegistration("SendMail", "SendMail", "", "PL.DevKit.Monkey.Workflow._2", IsolationModeEnum.Sandbox)]
    public class SendMail : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: SendMail");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: SendMail");
        }
    }
}
