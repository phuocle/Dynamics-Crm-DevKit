...
namespace PL.DevKit.Monkey.CustomActionAccount
{
    [CrmPluginRegistration("new_AjaxAccount", "account", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "",
    "PL.DevKit.Monkey.CustomActionAccount.Account.PostAccountnew_AjaxAccountSynchronous", 1, IsolationModeEnum.Sandbox)]
