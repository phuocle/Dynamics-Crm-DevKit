...
DevKit.FormAccountQuickCreate = function (executionContext, defaultWebResourceName) {
...
DevKit.AccountApi = function (entity) {
	return {
...
//{'JsForm':['Account','Account Quick Create'],'JsWebApi':true,'IsDebugForm':false,'IsDebugWebApi':false}