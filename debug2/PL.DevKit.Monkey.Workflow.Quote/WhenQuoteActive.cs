...
namespace PL.DevKit.Monkey.WorkflowQuote
{
    [CrmPluginRegistration("WhenQuoteActive", "WhenQuoteActive", "", "PL.DevKit.Monkey.WorkflowQuote", IsolationModeEnum.Sandbox)]
    public class WhenQuoteActive : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: WhenQuoteActive");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: WhenQuoteActive");
        }
    }
}
