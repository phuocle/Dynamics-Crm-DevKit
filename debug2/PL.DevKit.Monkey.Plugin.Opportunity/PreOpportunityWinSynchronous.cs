...
namespace PL.DevKit.Monkey.PluginOpportunity
{
    [CrmPluginRegistration("Win", "opportunity", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "",
    "PL.DevKit.Monkey.PluginOpportunity.PreOpportunityWinSynchronous", 1, IsolationModeEnum.Sandbox,
    ...
    public class PreOpportunityWinSynchronous : IPlugin
    {
        /*
          InputParameters:
        ...
        */
        ...
        public PreOpportunityWinSynchronous(string unsecureString, string secureString)
        {
