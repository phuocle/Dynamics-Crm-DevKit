...
namespace PL.DevKit.Monkey.PluginContact
{
    [CrmPluginRegistration("Create", "contact", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "",
    "PL.DevKit.Monkey.PluginContact.PreContactCreateSynchronous", 1, IsolationModeEnum.Sandbox,
    ...
    public class PreContactCreateSynchronous : IPlugin
    {
        ...
        */
        ...
        public PreContactCreateSynchronous(string unsecureString, string secureString)
        {
