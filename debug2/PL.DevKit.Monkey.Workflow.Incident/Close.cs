...
namespace PL.DevKit.Monkey.WorkflowIncident
{
    [CrmPluginRegistration("Close", "Close", "", "PL.DevKit.Monkey.WorkflowIncident", IsolationModeEnum.Sandbox)]
    public class Close : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: Close");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: Close");
        }
    }
}
