...
namespace PL.DevKit.Monkey.WorkflowTask
{
    [CrmPluginRegistration("TaskAssigned", "TaskAssigned", "", "PL.DevKit.Monkey.WorkflowTask", IsolationModeEnum.Sandbox)]
    public class TaskAssigned : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: TaskAssigned");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: TaskAssigned");
        }
    }
}
