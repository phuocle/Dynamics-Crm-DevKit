...
using Paz.LuckeyMonkey.Shared.Entities.TemplateOptionSets;

namespace Paz.LuckeyMonkey.Shared.Entities.TemplateOptionSets
{
...
namespace Paz.LuckeyMonkey.Shared.Entities
{
    public partial class Template : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public Template(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
        ...
        public ComponentState? ComponentState
        {
            get
            {
                ...
                return (ComponentState)value.Value;
            }
        }
