...
using Paz.LuckeyMonkey.Shared.Entities.ActivityPartyOptionSets;

namespace Paz.LuckeyMonkey.Shared.Entities.ActivityPartyOptionSets
{
...
namespace Paz.LuckeyMonkey.Shared.Entities
{
    public partial class ActivityParty : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public ActivityParty(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
