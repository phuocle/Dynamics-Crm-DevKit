...
using Paz.LuckeyMonkey.Shared.Entities.EmailOptionSets;

namespace Paz.LuckeyMonkey.Shared.Entities.EmailOptionSets
{
...
namespace Paz.LuckeyMonkey.Shared.Entities
{
    public partial class Email : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public Email(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
