...
//		Generated by PL.DynamicsCrm.DevKit 1.2.2 - https://github.com/phuocle/Dynamics-Crm-DevKit
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Paz.LuckeyMonkey.Shared.Entities
{
	public partial class Lead : EntityBase
	{
		public struct Fields
		{
			...
			public const string paz_field3_Base = "paz_field3_base";
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public int? paz_Field2
		{
			get { return Entity.GetAttributeValue<int?>(Fields.paz_Field2); }
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public decimal? paz_Field3
		{
			get
			{
				var value = Entity.GetAttributeValue<Money>(Fields.paz_Field3);
				if (value == null) return null;
				return value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.paz_Field3] = new Money(value.Value);
				else
					Entity.Attributes[Fields.paz_Field3] = null;
			}
		}

		/// <summary>
		/// <para>Value of the Field3 in base currency.</para>
		/// <para>ReadOnly - Money - MinValue: -922,337,203,685,477 - MaxValue: 922,337,203,685,477</para>
		/// <para>Field3 (Base)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public decimal? paz_field3_Base
		{
			get
			{
				var value = Entity.GetAttributeValue<Money>(Fields.paz_field3_Base);
				if (value == null) return null;
				return value.Value;
			}
		}
