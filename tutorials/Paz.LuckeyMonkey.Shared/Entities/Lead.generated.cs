...
namespace Paz.LuckeyMonkey.Shared.Entities.LeadOptionSets
{
...
namespace Paz.LuckeyMonkey.Shared.Entities
{
    public partial class Lead : EntityBase
    {
        public struct Fields
        {
            ...
            public const string adx_ImportStatus = "adx_importstatus";
            public const string adx_LeadTypeId = "adx_leadtypeid";
            public const string adx_LeadTypetext = "adx_leadtypetext";
            public const string adx_OpportuntiyProductsfromLead = "adx_opportuntiyproductsfromlead";
            public const string adx_ReferenceCode = "adx_referencecode";
            public const string adx_TerritoryId = "adx_territoryid";
            ...
            public const string cxlvhlp_chatactivityid = "cxlvhlp_chatactivityid";
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public bool? adx_ImportStatus
        {
            get { return Entity.GetAttributeValue<bool?>(Fields.adx_ImportStatus); }
            set { Entity.Attributes[Fields.adx_ImportStatus] = value; }
        }

        /// <summary>
        /// <para>Unique identifier for Lead Type associated with Lead.</para>
        /// <para>Lookup</para>
        /// <para>Lead Type</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public EntityReference adx_LeadTypeId
        {
            get { return Entity.GetAttributeValue<EntityReference>(Fields.adx_LeadTypeId); }
            set { Entity.Attributes[Fields.adx_LeadTypeId] = value; }
        }

        /// <summary>
        /// <para>String - MaxLength: 100</para>
        /// <para>Lead Type (text)</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public string adx_LeadTypetext
        {
            get { return Entity.GetAttributeValue<string>(Fields.adx_LeadTypetext); }
            set { Entity.Attributes[Fields.adx_LeadTypetext] = value; }
        }

        /// <summary>
        /// <para>Memo - MaxLength: 2000</para>
        /// <para>Opportuntiy Products from Lead</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public string adx_OpportuntiyProductsfromLead
        {
            get { return Entity.GetAttributeValue<string>(Fields.adx_OpportuntiyProductsfromLead); }
            set { Entity.Attributes[Fields.adx_OpportuntiyProductsfromLead] = value; }
        }

        /// <summary>
        /// <para>String - MaxLength: 100</para>
        /// <para>Reference Code</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public string adx_ReferenceCode
        {
            get { return Entity.GetAttributeValue<string>(Fields.adx_ReferenceCode); }
            set { Entity.Attributes[Fields.adx_ReferenceCode] = value; }
        }

        /// <summary>
        /// <para>Unique identifier for Territory associated with Lead.</para>
        /// <para>Lookup</para>
        /// <para>Territory</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public EntityReference adx_TerritoryId
        {
            get { return Entity.GetAttributeValue<EntityReference>(Fields.adx_TerritoryId); }
            set { Entity.Attributes[Fields.adx_TerritoryId] = value; }
        }
        ...
        public BudgetStatus? BudgetStatus
        {
            get
            {
                ...
                if (value == null) return null;
                return (BudgetStatus)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public string cxlvhlp_chatactivityid
        {
            get { return Entity.GetAttributeValue<string>(Fields.cxlvhlp_chatactivityid); }
            set { Entity.Attributes[Fields.cxlvhlp_chatactivityid] = value; }
        }
        ...
        public InitialCommunication? InitialCommunication
        {
            get
            {
                ...
                if (value == null) return null;
                return (InitialCommunication)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public LeadQualityCode? LeadQualityCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LeadQualityCode);
                if (value == null) return null;
                return (LeadQualityCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <summary>
        /// <para>Used internally to track the unique linkedin id of the lead record.</para>
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public msdyn_ordertype? msdyn_ordertype
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_ordertype);
                if (value == null) return null;
                return (msdyn_ordertype)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        public PurchaseProcess? PurchaseProcess
        {
            get
            {
                ...
                if (value == null) return null;
                return (PurchaseProcess)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        public PurchaseTimeFrame? PurchaseTimeFrame
        {
            get
            {
                ...
                if (value == null) return null;
                return (PurchaseTimeFrame)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <summary>
        /// <para>Current stage of the sales process for the lead.</para>
        /// <para>Picklist</para>
        /// <para>Sales Stage Code</para>
        /// </summary>
        [DebuggerNonUserCode()]
        public SalesStageCode? SalesStageCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SalesStageCode);
                if (value == null) return null;
                return (SalesStageCode)value.Value;
            }
            set
            {
                if (value.HasValue)
