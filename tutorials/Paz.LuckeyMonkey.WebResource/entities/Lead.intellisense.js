...
LuckeyMonkey.LeadApi = function (entity) {
	return {
		...
		///<field name='paz_Field2' type='Integer'>Edm.Int32</field>
		paz_Field2: intellisense.EntityValue,
		///<field name='paz_Field3' type='Money'>Edm.Decimal</field>
		paz_Field3: intellisense.EntityValue,
		///<field name='paz_field3_Base' type='Money'>ReadOnly - Edm.Decimal</field>
		paz_field3_Base: intellisense.EntityValue,
