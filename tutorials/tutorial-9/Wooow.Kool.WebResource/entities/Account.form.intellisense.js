...
Kool.Form.Account = function(executionContext) {
	...
	var body = {
		...
		///<field name="Address1_FreightTermsCode" type="OptionSet.Account.Address1_FreightTermsCode"></field>
		Address1_FreightTermsCode: intellisense.FieldOptionSet,
		///<field name="Address1_ShippingMethodCode" type="OptionSet.Account.Address1_ShippingMethodCode"></field>
		...
		///<field name="IndustryCode" type="OptionSet.Account.IndustryCode"></field>
		...
		///<field name="OwnershipCode" type="OptionSet.Account.OwnershipCode"></field>
		...
		///<field name="PaymentTermsCode" type="OptionSet.Account.PaymentTermsCode"></field>
		PaymentTermsCode: intellisense.FieldOptionSet,
		///<field name="PreferredContactMethodCode" type="OptionSet.Account.PreferredContactMethodCode"></field>
...
Kool.Form.Account2 = function(executionContext) {
	...
	tab.SUMMARY_TAB = {
		...
		Section: {
			ACCOUNT_INFORMATION: intellisense.FormSection,
			Timeline: intellisense.FormSection,
			ref_pan_SUMMARY_TAB_section_6: intellisense.FormSection
		}
	};
	tab.DETAILS_TAB = {
		///<field name="AddTabStateChange" type="Function"></field>
