...
(function (DevKit) {
	DevKit.ActionCardUserSettingsApi = function (e) {
		...
		for (const field in _actioncardusersettings) {
			const fieldConfig = _actioncardusersettings[field];
			webApiField(actioncardusersettings, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
