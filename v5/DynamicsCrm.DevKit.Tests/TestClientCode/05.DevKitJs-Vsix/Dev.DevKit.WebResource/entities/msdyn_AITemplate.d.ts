...
declare namespace DevKit {
	export class msdyn_AITemplateApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.msdyn_AITemplate.ComponentState | null;
		...
		/** For internal use only. */
		readonly msdyn_AITemplateIdUnique: string | null;
		/** Data binding */
		...
		statecode: OptionSet.msdyn_AITemplate.statecode | null;
		/** Reason for the status of the AITemplate */
		statuscode: OptionSet.msdyn_AITemplate.statuscode | null;
		/** For internal use only. */
