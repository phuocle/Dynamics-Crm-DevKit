...
(function (DevKit) {
	DevKit.mspcat_CatalogSubmissionFilesApi = function (e) {
		...
		const _mspcat_catalogsubmissionfiles = {
			...
			mspcat_FileType: { a: 'mspcat_filetype', g: 'Integer' },
			mspcat_ImageSize: { a: 'mspcat_imagesize', g: 'Integer' },
		...
		for (const field in _mspcat_catalogsubmissionfiles) {
			const fieldConfig = _mspcat_catalogsubmissionfiles[field];
			webApiField(mspcat_catalogsubmissionfiles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
