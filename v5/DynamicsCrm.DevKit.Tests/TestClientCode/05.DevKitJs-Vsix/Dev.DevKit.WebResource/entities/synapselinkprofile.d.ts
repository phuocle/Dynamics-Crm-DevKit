...
declare namespace DevKit {
	export class synapselinkprofileApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.synapselinkprofile.ComponentState | null;
		...
		DestinationSyncState: OptionSet.synapselinkprofile.DestinationSyncState | null;
		/** Extended properties */
		...
		ProfileState: OptionSet.synapselinkprofile.ProfileState | null;
		/** Type of profile */
		ProfileType: OptionSet.synapselinkprofile.ProfileType | null;
		...
		statecode: OptionSet.synapselinkprofile.statecode | null;
		/** Reason for the status of the Synapse Link Profile */
		statuscode: OptionSet.synapselinkprofile.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** Unique identifier for entity instances */
		synapselinkprofileId: string | null;
		/** For internal use only. */
