...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.DependencyNodeApi = function (e) {
		...
		const _dependencynode = {
			...
			IntroducedVersion: { a: 'introducedversion', g: 'Number' },
			IsSharedComponent: { a: 'issharedcomponent', r: true, g: 'Boolean' },
			ObjectId: { a: 'objectid' },
		...
		for (const field in _dependencynode) {
			const fieldConfig = _dependencynode[field];
			webApiField(dependencynode, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
