...
(function (DevKit) {
	DevKit.AIPluginOperationApi = function (e) {
		...
		const _aipluginoperation = {
			...
			IsConsequential: { a: 'isconsequential', g: 'Boolean' },
		...
		for (const field in _aipluginoperation) {
			const fieldConfig = _aipluginoperation[field];
			webApiField(aipluginoperation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
