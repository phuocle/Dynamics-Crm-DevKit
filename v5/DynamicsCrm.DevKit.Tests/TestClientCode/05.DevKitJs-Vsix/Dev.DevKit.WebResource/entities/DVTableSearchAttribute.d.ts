...
declare namespace DevKit {
	...
	export class FormDVTableSearchAttribute_main_form extends DevKit.IForm {
		/**
	...
	export class DVTableSearchAttributeApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.DVTableSearchAttribute.ComponentState | null;
		...
		DVTableSearchAttributeId: string | null;
		/** Unique identifier for DVTableSearchEntity associated with DVTableSearchAttribute. */
		dvtablesearchentity: string | null;
		...
		statecode: OptionSet.DVTableSearchAttribute.statecode | null;
		/** Reason for the status of the DVTableSearchAttribute */
		statuscode: OptionSet.DVTableSearchAttribute.statuscode | null;
		/** For internal use only. */
