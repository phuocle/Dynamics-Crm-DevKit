...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SystemUserLicensesApi = function (e) {
		...
		for (const field in _systemuserlicenses) {
			const fieldConfig = _systemuserlicenses[field];
			webApiField(systemuserlicenses, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
