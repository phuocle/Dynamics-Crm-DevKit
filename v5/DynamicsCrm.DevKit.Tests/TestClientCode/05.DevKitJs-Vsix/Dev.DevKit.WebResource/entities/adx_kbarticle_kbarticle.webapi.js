...
(function (DevKit) {
	DevKit.adx_kbarticle_kbarticleApi = function (e) {
		...
		const _adx_kbarticle_kbarticle = {
		...
		for (const field in _adx_kbarticle_kbarticle) {
			const fieldConfig = _adx_kbarticle_kbarticle[field];
			webApiField(adx_kbarticle_kbarticle, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
