...
declare namespace DevKit {
	export class PluginPackageApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.PluginPackage.ComponentState | null;
		Content: string | null;
		...
		statecode: OptionSet.PluginPackage.statecode | null;
		/** Reason for the status of the Plugin Package */
		statuscode: OptionSet.PluginPackage.statuscode | null;
		/** For internal use only. */
