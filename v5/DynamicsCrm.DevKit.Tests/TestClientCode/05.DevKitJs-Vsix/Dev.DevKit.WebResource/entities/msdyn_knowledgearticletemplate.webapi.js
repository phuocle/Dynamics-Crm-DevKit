...
(function (DevKit) {
	DevKit.msdyn_knowledgearticletemplateApi = function (e) {
		...
		const _msdyn_knowledgearticletemplate = {
			...
			msdyn_isinternal: { a: 'msdyn_isinternal', g: 'Boolean' },
			...
			msdyn_sectiondetails: { a: 'msdyn_sectiondetails' },
		...
		for (const field in _msdyn_knowledgearticletemplate) {
			const fieldConfig = _msdyn_knowledgearticletemplate[field];
			webApiField(msdyn_knowledgearticletemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
