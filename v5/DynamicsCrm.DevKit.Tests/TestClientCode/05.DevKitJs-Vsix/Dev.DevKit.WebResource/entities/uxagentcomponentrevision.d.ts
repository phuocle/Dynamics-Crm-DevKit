...
declare namespace DevKit {
	export class uxagentcomponentrevisionApi {
		/**
		* DynamicsCrm.DevKit uxagentcomponentrevisionApi
		...
		*/
		...
		statecode: OptionSet.uxagentcomponentrevision.statecode | null;
		/** Reason for the status of the UX Agent Component Revision */
		statuscode: OptionSet.uxagentcomponentrevision.statuscode | null;
		...
		uxagentcomponentrevisionId: string | null;
		/** Version Number */
...
declare namespace OptionSet {
	namespace uxagentcomponentrevision {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
