...
(function (DevKit) {
	DevKit.msdyn_connectordatasource_environmentvaApi = function (e) {
		...
		const _msdyn_connectordatasource_environmentva = {
		...
		for (const field in _msdyn_connectordatasource_environmentva) {
			const fieldConfig = _msdyn_connectordatasource_environmentva[field];
			webApiField(msdyn_connectordatasource_environmentva, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
