...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.KbArticleTemplateApi = function (e) {
		...
		for (const field in _kbarticletemplate) {
			const fieldConfig = _kbarticletemplate[field];
			webApiField(kbarticletemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
