...
(function (DevKit) {
	DevKit.ChannelAccessProfileRuleItemApi = function (e) {
		...
		const _channelaccessprofileruleitem = {
		...
		for (const field in _channelaccessprofileruleitem) {
			const fieldConfig = _channelaccessprofileruleitem[field];
			webApiField(channelaccessprofileruleitem, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
