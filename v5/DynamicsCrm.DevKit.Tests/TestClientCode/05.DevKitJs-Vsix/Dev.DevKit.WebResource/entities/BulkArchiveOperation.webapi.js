...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.BulkArchiveOperationApi = function (e) {
		...
		const _bulkarchiveoperation = {
			...
			LastMarkedVersionNumber: { a: 'lastmarkedversionnumber', g: 'Integer' },
		...
		for (const field in _bulkarchiveoperation) {
			const fieldConfig = _bulkarchiveoperation[field];
			webApiField(bulkarchiveoperation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
