...
(function (DevKit) {
	DevKit.SubscriptionStatisticsOutlookApi = function (e) {
		...
		const _subscriptionstatisticsoutlook = {
			FullSyncRequired: { a: 'fullsyncrequired', g: 'Boolean' },
		...
		for (const field in _subscriptionstatisticsoutlook) {
			const fieldConfig = _subscriptionstatisticsoutlook[field];
			webApiField(subscriptionstatisticsoutlook, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
