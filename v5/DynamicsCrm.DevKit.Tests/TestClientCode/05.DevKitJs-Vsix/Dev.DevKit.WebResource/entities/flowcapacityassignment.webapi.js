...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.flowcapacityassignmentApi = function (e) {
		...
		const _flowcapacityassignment = {
			AllocationOrigin: { a: 'allocationorigin', g: 'Integer' },
			AllowAutoAllocation: { a: 'allowautoallocation', g: 'Boolean' },
			CapacityOverage: { a: 'capacityoverage', g: 'Integer' },
			CapacitySource: { a: 'capacitysource', g: 'Integer' },
			CapacityType: { a: 'capacitytype', g: 'Integer' },
			Count: { a: 'count', g: 'Integer' },
		...
		for (const field in _flowcapacityassignment) {
			const fieldConfig = _flowcapacityassignment[field];
			webApiField(flowcapacityassignment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
