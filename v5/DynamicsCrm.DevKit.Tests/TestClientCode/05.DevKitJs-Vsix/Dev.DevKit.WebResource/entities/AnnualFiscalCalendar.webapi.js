...
(function (DevKit) {
	DevKit.AnnualFiscalCalendarApi = function (e) {
		...
		const _annualfiscalcalendar = {
			...
			Period1: { a: 'annual', g: 'Number' },
			Period1_Base: { a: 'annual_base', r: true, g: 'Number' },
		...
		for (const field in _annualfiscalcalendar) {
			const fieldConfig = _annualfiscalcalendar[field];
			webApiField(annualfiscalcalendar, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
