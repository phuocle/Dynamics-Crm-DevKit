...
(function (DevKit) {
	DevKit.ProcessStageApi = function (e) {
		...
		const _processstage = {
			...
			IsTrigger: { a: 'istrigger', g: 'Boolean' },
			OperationId: { a: 'operationid' },
			OperationKind: { a: 'operationkind', g: 'Integer' },
			...
			StageCategory: { a: 'stagecategory', g: 'Integer' },
		...
		for (const field in _processstage) {
			const fieldConfig = _processstage[field];
			webApiField(processstage, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
