...
declare namespace DevKit {
	...
	export class Formmsdyn_AIFpTrainingDocument_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_AIFpTrainingDocumentApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_AIFpTrainingDocument.statecode | null;
		/** Reason for the status of the AI Form Processing Document */
		statuscode: OptionSet.msdyn_AIFpTrainingDocument.statuscode | null;
