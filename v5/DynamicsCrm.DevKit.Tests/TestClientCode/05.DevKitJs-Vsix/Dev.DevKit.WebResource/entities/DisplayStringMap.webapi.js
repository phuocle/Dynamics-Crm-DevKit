...
(function (DevKit) {
	DevKit.DisplayStringMapApi = function (e) {
		...
		for (const field in _displaystringmap) {
			const fieldConfig = _displaystringmap[field];
			webApiField(displaystringmap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
