...
(function (DevKit) {
	DevKit.TraceAssociationApi = function (e) {
		...
		for (const field in _traceassociation) {
			const fieldConfig = _traceassociation[field];
			webApiField(traceassociation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
