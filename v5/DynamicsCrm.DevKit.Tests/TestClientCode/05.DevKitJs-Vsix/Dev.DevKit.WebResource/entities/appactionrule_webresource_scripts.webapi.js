...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.appactionrule_webresource_scriptsApi = function (e) {
		...
		const _appactionrule_webresource_scripts = {
		...
		for (const field in _appactionrule_webresource_scripts) {
			const fieldConfig = _appactionrule_webresource_scripts[field];
			webApiField(appactionrule_webresource_scripts, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
