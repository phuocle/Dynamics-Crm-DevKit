...
(function (DevKit) {
	...
	DevKit.Formbotcomponent_Information = function(executionContext, defaultWebResourceName) {
		const form = {
			body: ["AccentColor", "Category", "ChildComponents", "ComponentType", "Content", "CreatedBy", "CreatedOn", "Data", "Dependencies", "Description", "HelpLink", "IconUrl", "Language", "ModifiedBy", "ModifiedOn", "name", "OwnerId", "OwningBusinessUnit", "ParentBotComponentCollectionId", "ParentBotComponentId", "ParentBotId", "RelatedBotComponents", "RelatedBots", "RelatedProcesses", "ReusePolicy", "SchemaName", "statecode", "statuscode"],
			bpf: [],
			dialog: [],
