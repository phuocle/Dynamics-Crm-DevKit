...
(function (DevKit) {
	DevKit.ActionCardApi = function (e) {
		...
		const _actioncard = {
			...
			RecordIdObjectTypeCode2: { a: 'recordidobjecttypecode2', g: 'Integer' },
			...
			Visibility: { a: 'visibility', g: 'Boolean' }
		};
		if (e === undefined) e = {};
		const u = {};
		const actioncard = {};
		...
		for (const field in _actioncard) {
			const fieldConfig = _actioncard[field];
			webApiField(actioncard, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		actioncard.Entity = u;
