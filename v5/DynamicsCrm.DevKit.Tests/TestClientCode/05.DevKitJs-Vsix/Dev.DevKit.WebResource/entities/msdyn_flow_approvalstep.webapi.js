...
(function (DevKit) {
	DevKit.msdyn_flow_approvalstepApi = function (e) {
		...
		const _msdyn_flow_approvalstep = {
			...
			msdyn_flow_approvalstep_number: { a: 'msdyn_flow_approvalstep_number', g: 'Integer' },
			msdyn_flow_approvalstep_result: { a: 'msdyn_flow_approvalstep_result' },
			msdyn_flow_approvalstep_stage: { a: 'msdyn_flow_approvalstep_stage', g: 'Integer' },
		...
		for (const field in _msdyn_flow_approvalstep) {
			const fieldConfig = _msdyn_flow_approvalstep[field];
			webApiField(msdyn_flow_approvalstep, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
