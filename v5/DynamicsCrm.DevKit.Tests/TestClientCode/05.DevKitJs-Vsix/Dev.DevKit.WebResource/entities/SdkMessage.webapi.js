...
(function (DevKit) {
	DevKit.SdkMessageApi = function (e) {
		...
		const _sdkmessage = {
			AutoTransact: { a: 'autotransact', g: 'Boolean' },
			...
			Expand: { a: 'expand', g: 'Boolean' },
			IntroducedVersion: { a: 'introducedversion' },
			IsActive: { a: 'isactive', g: 'Boolean' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			IsPrivate: { a: 'isprivate', g: 'Boolean' },
			IsReadOnly: { a: 'isreadonly', g: 'Boolean' },
			IsValidForExecuteAsync: { a: 'isvalidforexecuteasync', r: true, g: 'Boolean' },
		...
		for (const field in _sdkmessage) {
			const fieldConfig = _sdkmessage[field];
			webApiField(sdkmessage, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		sdkmessage.Entity = u;
