...
declare namespace DevKit {
	namespace Formcard_Information {
		interface Tabs {
		}
		interface Body {
			/** AppDefinition */
	...
	export class Formcard_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form card_Information */
		Body: DevKit.Formcard_Information.Body;
	}
	export class cardApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.card.ComponentState | null;
		...
		Sizes: Array<OptionSet.card.Sizes> | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Card */
		statecode: OptionSet.card.statecode | null;
		/** Reason for the status of the Card */
		statuscode: OptionSet.card.statuscode | null;
		/** For internal use only. */
