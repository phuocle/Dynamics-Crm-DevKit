...
(function (DevKit) {
	DevKit.OrgInsightsNotificationApi = function (e) {
		...
		const _orginsightsnotification = {
		...
		for (const field in _orginsightsnotification) {
			const fieldConfig = _orginsightsnotification[field];
			webApiField(orginsightsnotification, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
