...
(function (DevKit) {
	DevKit.bot_environmentvariabledefinitionApi = function (e) {
		...
		const _bot_environmentvariabledefinition = {
		...
		for (const field in _bot_environmentvariabledefinition) {
			const fieldConfig = _bot_environmentvariabledefinition[field];
			webApiField(bot_environmentvariabledefinition, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
