...
(function (DevKit) {
	DevKit.SystemUserAuthorizationChangeTrackerApi = function (e) {
		...
		const _systemuserauthorizationchangetracker = {
			ChangedOn_UtcDateAndTime: { a: 'changedon', r: true, g: 'DateTime' },
			ChangedVersionNumber: { a: 'changedversionnumber', r: true, g: 'Integer' },
			ComputedOn_UtcDateAndTime: { a: 'computedon', r: true, g: 'DateTime' },
			ComputedVersionNumber: { a: 'computedversionnumber', r: true, g: 'Integer' },
		...
		for (const field in _systemuserauthorizationchangetracker) {
			const fieldConfig = _systemuserauthorizationchangetracker[field];
			webApiField(systemuserauthorizationchangetracker, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
