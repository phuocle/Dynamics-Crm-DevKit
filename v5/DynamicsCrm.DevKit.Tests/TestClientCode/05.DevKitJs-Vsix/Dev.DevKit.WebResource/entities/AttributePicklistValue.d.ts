...
declare namespace DevKit {
	export class AttributePicklistValueApi {
		/**
		* DynamicsCrm.DevKit AttributePicklistValueApi
		...
		*/
		...
		readonly ComponentState: OptionSet.AttributePicklistValue.ComponentState | null;
...
declare namespace OptionSet {
	namespace AttributePicklistValue {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
