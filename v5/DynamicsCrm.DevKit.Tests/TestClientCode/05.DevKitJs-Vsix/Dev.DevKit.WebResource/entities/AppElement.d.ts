...
declare namespace DevKit {
	export class AppElementApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.AppElement.ComponentState | null;
		...
		readonly statecode: OptionSet.AppElement.statecode | null;
		/** Reason for the status of the AppElement */
		readonly statuscode: OptionSet.AppElement.statuscode | null;
		/** For internal use only. */
