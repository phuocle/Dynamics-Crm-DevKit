...
declare namespace DevKit {
	...
	export class Formmspp_shortcut_Information extends DevKit.IForm {
		/**
	...
	export class mspp_shortcutApi {
		...
		*/
		...
		/** Unique identifier for Web Page associated with Shortcut. */
		mspp_parentpage_webpageid: string | null;
		/** Unique identifier for entity instances */
		mspp_shortcutId: string | null;
		...
		statecode: OptionSet.mspp_shortcut.statecode | null;
		/** Reason for the status of the Shortcut */
		statuscode: OptionSet.mspp_shortcut.statuscode | null;
		/**
