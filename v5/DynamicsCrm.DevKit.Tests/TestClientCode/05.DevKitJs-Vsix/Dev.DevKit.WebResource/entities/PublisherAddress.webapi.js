...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PublisherAddressApi = function (e) {
		...
		const _publisheraddress = {
			AddressNumber: { a: 'addressnumber', g: 'Integer' },
			AddressTypeCode: { a: 'addresstypecode', g: 'Integer' },
			City: { a: 'city' },
			Country: { a: 'country' },
			County: { a: 'county' },
			...
			Fax: { a: 'fax' },
			FreightTermsCode: { a: 'freighttermscode', g: 'Integer' },
			ImportSequenceNumber: { a: 'importsequencenumber', g: 'Integer' },
			Latitude: { a: 'latitude', g: 'Number' },
			Line1: { a: 'line1' },
			Line2: { a: 'line2' },
			Line3: { a: 'line3' },
			Longitude: { a: 'longitude', g: 'Number' },
		...
		for (const field in _publisheraddress) {
			const fieldConfig = _publisheraddress[field];
			webApiField(publisheraddress, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
