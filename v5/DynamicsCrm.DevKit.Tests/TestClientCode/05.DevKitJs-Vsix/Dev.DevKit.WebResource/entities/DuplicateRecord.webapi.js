...
(function (DevKit) {
	DevKit.DuplicateRecordApi = function (e) {
		...
		for (const field in _duplicaterecord) {
			const fieldConfig = _duplicaterecord[field];
			webApiField(duplicaterecord, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
