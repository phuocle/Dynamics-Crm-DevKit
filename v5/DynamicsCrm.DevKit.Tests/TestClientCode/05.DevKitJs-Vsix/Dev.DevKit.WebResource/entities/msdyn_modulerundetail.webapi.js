...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_modulerundetailApi = function (e) {
		...
		const _msdyn_modulerundetail = {
			...
			msdyn_IsCompleted: { a: 'msdyn_iscompleted', g: 'Boolean' },
			msdyn_ModelRunId: { a: 'msdyn_modelrunid' },
			msdyn_ModuleConfigId: { a: 'msdyn_moduleconfigid' },
			msdyn_ModuleConfigIdVersion: { a: 'msdyn_moduleconfigidversion', g: 'Integer' },
			...
			msdyn_QueuedTime_UtcDateAndTime: { a: 'msdyn_queuedtime', g: 'DateTime' },
		...
		for (const field in _msdyn_modulerundetail) {
			const fieldConfig = _msdyn_modulerundetail[field];
			webApiField(msdyn_modulerundetail, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
