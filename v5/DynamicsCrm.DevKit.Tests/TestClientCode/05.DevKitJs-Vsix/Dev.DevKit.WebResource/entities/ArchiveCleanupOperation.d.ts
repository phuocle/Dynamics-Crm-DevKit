...
declare namespace DevKit {
	...
	export class FormArchiveCleanupOperation_Information extends DevKit.IForm {
		/**
	...
	export class ArchiveCleanupOperationApi {
		...
		*/
		...
		ArchiveCleanupOperationId: string | null;
		...
		/** The name of the custom entity. */
		Name: string | null;
		OperationName: OptionSet.ArchiveCleanupOperation.OperationName | null;
		...
		statecode: OptionSet.ArchiveCleanupOperation.statecode | null;
		/** Reason for the status of the archivecleanupoperation */
		statuscode: OptionSet.ArchiveCleanupOperation.statuscode | null;
