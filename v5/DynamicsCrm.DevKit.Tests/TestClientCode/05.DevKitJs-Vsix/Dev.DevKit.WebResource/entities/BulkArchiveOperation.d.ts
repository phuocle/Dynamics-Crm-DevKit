...
declare namespace DevKit {
	...
	export class FormBulkArchiveOperation_Information extends DevKit.IForm {
		/**
	...
	export class BulkArchiveOperationApi {
		...
		*/
		...
		statecode: OptionSet.BulkArchiveOperation.statecode | null;
		/** Reason for the status of the bulkarchiveoperation */
		statuscode: OptionSet.BulkArchiveOperation.statuscode | null;
