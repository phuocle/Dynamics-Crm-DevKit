...
(function (DevKit) {
	DevKit.HierarchyRuleApi = function (e) {
		...
		const _hierarchyrule = {
			...
			ShowDisabled: { a: 'showdisabled', g: 'Boolean' },
		...
		for (const field in _hierarchyrule) {
			const fieldConfig = _hierarchyrule[field];
			webApiField(hierarchyrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
