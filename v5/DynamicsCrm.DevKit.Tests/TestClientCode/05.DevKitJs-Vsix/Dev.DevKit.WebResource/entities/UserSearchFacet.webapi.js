...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.UserSearchFacetApi = function (e) {
		...
		const _usersearchfacet = {
			AttributeName: { a: 'attributename' },
			EntityName2: { a: 'entityname' },
			FacetOrder: { a: 'facetorder', g: 'Integer' },
		...
		for (const field in _usersearchfacet) {
			const fieldConfig = _usersearchfacet[field];
			webApiField(usersearchfacet, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
