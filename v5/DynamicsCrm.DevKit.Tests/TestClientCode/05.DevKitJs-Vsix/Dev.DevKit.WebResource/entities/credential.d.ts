...
declare namespace DevKit {
	...
	export class Formcredential_Information extends DevKit.IForm {
		/**
	...
	export class credentialApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.credential.ComponentState | null;
		connectiontype: OptionSet.credential.connectiontype | null;
		...
		credentialtype: OptionSet.credential.credentialtype | null;
		cyberarkapplicationid: string | null;
		cyberarkobject: string | null;
		...
		cyberarksafe: string | null;
		cyberarkusername: string | null;
		...
		statecode: OptionSet.credential.statecode | null;
		/** Reason for the status of the Credential */
		statuscode: OptionSet.credential.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** Types of allowed usage for the credential. */
		usagetype: Array<OptionSet.credential.usagetype> | null;
