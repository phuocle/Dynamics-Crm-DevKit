...
declare namespace DevKit {
	export class DependencyApi {
		/**
		* DynamicsCrm.DevKit DependencyApi
		...
		*/
		...
		readonly DependencyType: OptionSet.Dependency.DependencyType | null;
		readonly DependentComponentBaseSolutionId: string | null;
		/** Unique identifier of the dependent component's node. */
		readonly DependentComponentNodeId: string | null;
		readonly DependentComponentObjectId: string | null;
		readonly DependentComponentParentId: string | null;
		readonly DependentComponentType: OptionSet.Dependency.DependentComponentType | null;
		readonly RequiredComponentBaseSolutionId: string | null;
		readonly RequiredComponentIntroducedVersion: number | null;
		/** Unique identifier of the required component's node */
		readonly RequiredComponentNodeId: string | null;
		readonly RequiredComponentObjectId: string | null;
		readonly RequiredComponentParentId: string | null;
		readonly RequiredComponentType: OptionSet.Dependency.RequiredComponentType | null;
