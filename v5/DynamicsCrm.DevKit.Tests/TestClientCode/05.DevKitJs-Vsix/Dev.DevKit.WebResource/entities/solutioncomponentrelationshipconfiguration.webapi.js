...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.solutioncomponentrelationshipconfigurationApi = function (e) {
		...
		const _solutioncomponentrelationshipconfiguration = {
			AddRelatedComponents: { a: 'addrelatedcomponents', g: 'Boolean' },
			CascadeRemoveComponents: { a: 'cascaderemovecomponents', g: 'Boolean' },
			...
			ForceAddingManagedRelatedComponents: { a: 'forceaddingmanagedrelatedcomponents', g: 'Boolean' },
			...
			name: { a: 'name' },
			NoMissingDependencyForApiManagedSolution: { a: 'nomissingdependencyforapimanagedsolution', g: 'Boolean' },
			...
			PrimaryEntityDependencyType: { a: 'primaryentitydependencytype', g: 'Integer' },
			RespectParentRootComponentBehavior: { a: 'respectparentrootcomponentbehavior', g: 'Boolean' },
			SecondaryEntityDependencyType: { a: 'secondaryentitydependencytype', g: 'Integer' },
		...
		for (const field in _solutioncomponentrelationshipconfiguration) {
			const fieldConfig = _solutioncomponentrelationshipconfiguration[field];
			webApiField(solutioncomponentrelationshipconfiguration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
