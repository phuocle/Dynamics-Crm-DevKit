...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.EntityAnalyticsConfigApi = function (e) {
		...
		const _entityanalyticsconfig = {
			ComponentIdUnique: { a: 'componentidunique', r: true },
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			EntityAnalyticsConfigId: { a: 'entityanalyticsconfigid' },
			EntityDataSource: { a: 'entitydatasource', g: 'Integer' },
			IsEnabledForADLS: { a: 'isenabledforadls', g: 'Boolean' },
			IsEnabledForTimeSeries: { a: 'isenabledfortimeseries', g: 'Boolean' },
		...
		for (const field in _entityanalyticsconfig) {
			const fieldConfig = _entityanalyticsconfig[field];
			webApiField(entityanalyticsconfig, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
