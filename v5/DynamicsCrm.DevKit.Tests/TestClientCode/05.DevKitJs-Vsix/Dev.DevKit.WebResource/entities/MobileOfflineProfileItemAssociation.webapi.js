...
(function (DevKit) {
	DevKit.MobileOfflineProfileItemAssociationApi = function (e) {
		...
		const _mobileofflineprofileitemassociation = {
			...
			SelectedRelationShipsSchema: { a: 'selectedrelationshipsschema', g: 'Integer' },
		...
		for (const field in _mobileofflineprofileitemassociation) {
			const fieldConfig = _mobileofflineprofileitemassociation[field];
			webApiField(mobileofflineprofileitemassociation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
