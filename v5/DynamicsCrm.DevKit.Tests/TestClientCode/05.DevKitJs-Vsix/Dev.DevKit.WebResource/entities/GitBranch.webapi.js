...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.GitBranchApi = function (e) {
		...
		for (const field in _gitbranch) {
			const fieldConfig = _gitbranch[field];
			webApiField(gitbranch, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		gitbranch.Entity = u;
