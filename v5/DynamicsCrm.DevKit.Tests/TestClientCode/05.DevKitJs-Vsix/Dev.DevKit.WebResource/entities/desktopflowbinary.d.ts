...
declare namespace DevKit {
	export class desktopflowbinaryApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.desktopflowbinary.ComponentState | null;
		...
		statecode: OptionSet.desktopflowbinary.statecode | null;
		/** Reason for the status of the Desktop Flow Binary */
		statuscode: OptionSet.desktopflowbinary.statuscode | null;
		/** For internal use only. */
