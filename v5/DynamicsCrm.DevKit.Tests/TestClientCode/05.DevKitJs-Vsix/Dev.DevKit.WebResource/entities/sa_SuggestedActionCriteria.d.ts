...
declare namespace DevKit {
	export class sa_SuggestedActionCriteriaApi {
		/**
		* DynamicsCrm.DevKit sa_SuggestedActionCriteriaApi
		...
		*/
		...
		sa_SuggestedActionCriteriaId: string | null;
		sa_TableId: string | null;
		/** Status of the Suggested Action Criteria */
		statecode: OptionSet.sa_SuggestedActionCriteria.statecode | null;
		/** Reason for the status of the Suggested Action Criteria */
		statuscode: OptionSet.sa_SuggestedActionCriteria.statuscode | null;
...
declare namespace OptionSet {
	namespace sa_SuggestedActionCriteria {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
