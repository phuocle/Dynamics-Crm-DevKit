...
(function (DevKit) {
	DevKit.msdyn_customcontrolextendedsettingsApi = function (e) {
		...
		const _msdyn_customcontrolextendedsettings = {
			...
			msdyn_timelineWall_isAutoExpanded: { a: 'msdyn_timelineWall_isAutoExpanded', g: 'Boolean' },
			msdyn_timelineWall_isFilterPaneOpen: { a: 'msdyn_timelineWall_isFilterPaneOpen', g: 'Boolean' },
			msdyn_timelineWall_isSortOrderNewerToOlder: { a: 'msdyn_timelineWall_isSortOrderNewerToOlder', g: 'Boolean' },
		...
		for (const field in _msdyn_customcontrolextendedsettings) {
			const fieldConfig = _msdyn_customcontrolextendedsettings[field];
			webApiField(msdyn_customcontrolextendedsettings, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
