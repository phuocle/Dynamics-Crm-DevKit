...
(function (DevKit) {
	DevKit.msdyn_AIBFileApi = function (e) {
		...
		const _msdyn_aibfile = {
			...
			msdyn_Size: { a: 'msdyn_size', g: 'Integer' },
		...
		for (const field in _msdyn_aibfile) {
			const fieldConfig = _msdyn_aibfile[field];
			webApiField(msdyn_aibfile, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
