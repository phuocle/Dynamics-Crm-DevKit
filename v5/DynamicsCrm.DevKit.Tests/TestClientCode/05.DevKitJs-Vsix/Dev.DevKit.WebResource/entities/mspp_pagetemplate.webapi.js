...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_pagetemplateApi = function (e) {
		...
		const _mspp_pagetemplate = {
			...
			mspp_usewebsiteheaderandfooter: { a: 'mspp_usewebsiteheaderandfooter', g: 'Boolean' },
		...
		for (const field in _mspp_pagetemplate) {
			const fieldConfig = _mspp_pagetemplate[field];
			webApiField(mspp_pagetemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
