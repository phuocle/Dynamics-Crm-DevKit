...
declare namespace DevKit {
	...
	export class FormCustomAPI_Information extends DevKit.IForm {
		/**
	...
	export class CustomAPIApi {
		...
		*/
		...
		/** The type of custom processing step allowed */
		AllowedCustomProcessingStepType: OptionSet.CustomAPI.AllowedCustomProcessingStepType | null;
		/** The binding type of the custom API */
		BindingType: OptionSet.CustomAPI.BindingType | null;
		/** The logical name of the entity bound to the custom API */
		BoundEntityLogicalName: string | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.CustomAPI.ComponentState | null;
		...
		statecode: OptionSet.CustomAPI.statecode | null;
		/** Reason for the status of the Custom API */
		statuscode: OptionSet.CustomAPI.statuscode | null;
		/** For internal use only. */
