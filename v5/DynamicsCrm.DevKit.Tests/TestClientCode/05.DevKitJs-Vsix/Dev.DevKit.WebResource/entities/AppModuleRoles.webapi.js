...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AppModuleRolesApi = function (e) {
		...
		for (const field in _appmoduleroles) {
			const fieldConfig = _appmoduleroles[field];
			webApiField(appmoduleroles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
