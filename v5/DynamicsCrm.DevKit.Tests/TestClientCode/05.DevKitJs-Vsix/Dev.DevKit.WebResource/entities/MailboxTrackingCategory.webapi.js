...
(function (DevKit) {
	DevKit.MailboxTrackingCategoryApi = function (e) {
		...
		const _mailboxtrackingcategory = {
			CategoryOnboardingStatus: { a: 'categoryonboardingstatus', g: 'Integer' },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			ExchangeCategoryColor: { a: 'exchangecategorycolor', g: 'Integer' },
		...
		for (const field in _mailboxtrackingcategory) {
			const fieldConfig = _mailboxtrackingcategory[field];
			webApiField(mailboxtrackingcategory, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
