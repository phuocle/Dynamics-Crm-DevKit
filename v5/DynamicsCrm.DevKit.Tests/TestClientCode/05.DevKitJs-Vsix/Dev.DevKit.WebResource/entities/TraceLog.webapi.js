...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TraceLogApi = function (e) {
		...
		const _tracelog = {
			CanBeDeleted: { a: 'canbedeleted', g: 'Boolean' },
			CollationLevel: { a: 'collationlevel', g: 'Integer' },
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			ErrorDetails: { a: 'errordetails' },
			ErrorTypeDisplay: { a: 'errortypedisplay' },
			IsUnique: { a: 'isunique', g: 'Boolean' },
			...
			TraceCode: { a: 'tracecode', g: 'Integer' },
			TraceDetailXml: { a: 'tracedetailxml' },
			TraceLogId: { a: 'tracelogid' },
			TraceParameterHash: { a: 'traceparameterhash', r: true, g: 'Integer' },
			...
			TraceStatus: { a: 'tracestatus', g: 'Boolean' },
		...
		for (const field in _tracelog) {
			const fieldConfig = _tracelog[field];
			webApiField(tracelog, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		tracelog.Entity = u;
