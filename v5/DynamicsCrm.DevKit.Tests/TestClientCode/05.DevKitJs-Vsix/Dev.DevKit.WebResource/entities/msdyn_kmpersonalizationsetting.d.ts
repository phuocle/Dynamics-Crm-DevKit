...
declare namespace DevKit {
	...
	export class Formmsdyn_kmpersonalizationsetting_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_kmpersonalizationsettingApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_kmpersonalizationsetting.statecode | null;
		/** Reason for the status of the Knowledge personalization */
		statuscode: OptionSet.msdyn_kmpersonalizationsetting.statuscode | null;
