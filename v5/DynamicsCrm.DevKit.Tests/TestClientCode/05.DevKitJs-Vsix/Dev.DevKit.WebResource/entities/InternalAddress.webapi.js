...
(function (DevKit) {
	DevKit.InternalAddressApi = function (e) {
		...
		for (const field in _internaladdress) {
			const fieldConfig = _internaladdress[field];
			webApiField(internaladdress, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
