...
(function (DevKit) {
	DevKit.BulkDeleteFailureApi = function (e) {
		...
		const _bulkdeletefailure = {
			...
			ErrorNumber: { a: 'errornumber', r: true, g: 'Integer' },
			OrderedQueryIndex: { a: 'orderedqueryindex', r: true, g: 'Integer' },
		...
		for (const field in _bulkdeletefailure) {
			const fieldConfig = _bulkdeletefailure[field];
			webApiField(bulkdeletefailure, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
