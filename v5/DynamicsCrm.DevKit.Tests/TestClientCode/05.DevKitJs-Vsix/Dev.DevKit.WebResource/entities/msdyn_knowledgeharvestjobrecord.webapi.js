...
(function (DevKit) {
	DevKit.msdyn_knowledgeharvestjobrecordApi = function (e) {
		...
		const _msdyn_knowledgeharvestjobrecord = {
			...
			msdyn_entityname: { a: 'msdyn_entityname', g: 'Integer' },
		...
		for (const field in _msdyn_knowledgeharvestjobrecord) {
			const fieldConfig = _msdyn_knowledgeharvestjobrecord[field];
			webApiField(msdyn_knowledgeharvestjobrecord, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
