...
(function (DevKit) {
	DevKit.msdyn_analysisjobApi = function (e) {
		...
		const _msdyn_analysisjob = {
			...
			msdyn_AnalysisJobsReport_name: { a: 'msdyn_analysisjobsreport', r: true },
			...
			msdyn_InAppNotificationEnabled: { a: 'msdyn_inappnotificationenabled', g: 'Boolean' },
			msdyn_name: { a: 'msdyn_name' },
			msdyn_RuleFailCount: { a: 'msdyn_rulefailcount', g: 'Integer' },
			msdyn_RulePassCount: { a: 'msdyn_rulepasscount', g: 'Integer' },
			msdyn_RuleRunCount: { a: 'msdyn_ruleruncount', g: 'Integer' },
			msdyn_RunCorrelationId: { a: 'msdyn_runcorrelationid' },
			msdyn_sevcriticalcount: { a: 'msdyn_sevcriticalcount', g: 'Integer' },
			msdyn_sevhighcount: { a: 'msdyn_sevhighcount', g: 'Integer' },
			msdyn_sevlowcount: { a: 'msdyn_sevlowcount', g: 'Integer' },
			msdyn_sevmediumcount: { a: 'msdyn_sevmediumcount', g: 'Integer' },
			msdyn_StartTime_UtcDateAndTime: { a: 'msdyn_starttime', g: 'DateTime' },
			msdyn_SuggestionCount: { a: 'msdyn_suggestioncount', g: 'Integer' },
			msdyn_TenantId: { a: 'msdyn_tenantid' },
			msdyn_TriggerType: { a: 'msdyn_triggertype' },
			msdyn_WarningCount: { a: 'msdyn_warningcount', g: 'Integer' },
		...
		for (const field in _msdyn_analysisjob) {
			const fieldConfig = _msdyn_analysisjob[field];
			webApiField(msdyn_analysisjob, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
