...
(function (DevKit) {
	...
	DevKit.FormSharePointSite_Information = function(executionContext, defaultWebResourceName) {
		const form = {
			body: ["AbsoluteURL", "Description", "IsGridPresent", "IsPowerBISite", "LastValidated", "Name", "OwnerId", "ParentSite", "RelativeUrl", "urloption", "ValidationStatus", "ValidationStatusErrorCode"],
			bpf: [],
			dialog: [],
			grid: [],
			header: [],
