...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrivilegeCheckerLogApi = function (e) {
		...
		const _privilegecheckerlog = {
			...
			CheckType: { a: 'checktype', r: true, g: 'Integer' },
			...
			PrivilegeDepth: { a: 'privilegedepth', r: true, g: 'Integer' },
			...
			TimeZoneRuleVersionNumber: { a: 'timezoneruleversionnumber', r: true, g: 'Integer' },
			UTCConversionTimeZoneCode: { a: 'utcconversiontimezonecode', r: true, g: 'Integer' },
		...
		for (const field in _privilegecheckerlog) {
			const fieldConfig = _privilegecheckerlog[field];
			webApiField(privilegecheckerlog, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
