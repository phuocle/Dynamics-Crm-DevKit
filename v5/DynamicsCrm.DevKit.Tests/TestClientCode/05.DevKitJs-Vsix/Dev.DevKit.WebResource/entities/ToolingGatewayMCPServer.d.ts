...
declare namespace DevKit {
	export class ToolingGatewayMCPServerApi {
		/**
		* DynamicsCrm.DevKit ToolingGatewayMCPServerApi
		...
		*/
		...
		statecode: OptionSet.ToolingGatewayMCPServer.statecode | null;
		/** Reason for the status of the ToolingGatewayMCPServer */
		statuscode: OptionSet.ToolingGatewayMCPServer.statuscode | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** The associated Tooling Gateway */
		ToolingGatewayId: string | null;
		/** Unique identifier for entity instances */
		ToolingGatewayMCPServerId: string | null;
...
declare namespace OptionSet {
	namespace ToolingGatewayMCPServer {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
