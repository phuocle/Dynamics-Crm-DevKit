...
declare namespace DevKit {
	export class StagedEntityRelationshipRelationshipsApi {
		/**
		* DynamicsCrm.DevKit StagedEntityRelationshipRelationshipsApi
		...
		*/
		...
		StagedEntityRelationshipRelationshipsId: string | null;
		...
		statecode: OptionSet.StagedEntityRelationshipRelationships.statecode | null;
		/** Reason for the status of the staged entity relationship relationships. */
		statuscode: OptionSet.StagedEntityRelationshipRelationships.statuscode | null;
		...
		*/
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances. */
			readonly StagedEntityRelationshipRelationshipsId: string;
			/** A unique identifier used to tie together all objects staged within the same transaction. */
...
declare namespace OptionSet {
	namespace StagedEntityRelationshipRelationships {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
