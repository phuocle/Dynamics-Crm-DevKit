...
(function (DevKit) {
	DevKit.fxexpressionApi = function (e) {
		...
		for (const field in _fxexpression) {
			const fieldConfig = _fxexpression[field];
			webApiField(fxexpression, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
