...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.synapselinkprofileApi = function (e) {
		...
		const _synapselinkprofile = {
			ActivationTime_UtcDateAndTime: { a: 'activationtime', g: 'DateTime' },
			ComponentIdUnique: { a: 'componentidunique', r: true },
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			CopyAttachments: { a: 'copyattachments', g: 'Boolean' },
			CopyFiles: { a: 'copyfiles', g: 'Boolean' },
			...
			DestinationSyncState: { a: 'destinationsyncstate', g: 'Integer' },
			...
			ProfileState: { a: 'profilestate', g: 'Integer' },
			ProfileType: { a: 'profiletype', g: 'Integer' },
			ProfileUpdatedTime_UtcDateAndTime: { a: 'profileupdatedtime', g: 'DateTime' },
			ProfileVersion: { a: 'profileversion' },
			SnapshotsToPersist: { a: 'snapshotstopersist', g: 'Integer' },
		...
		for (const field in _synapselinkprofile) {
			const fieldConfig = _synapselinkprofile[field];
			webApiField(synapselinkprofile, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
