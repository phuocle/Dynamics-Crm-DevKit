...
declare namespace DevKit {
	export class KeyVaultReferenceApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.KeyVaultReference.ComponentState | null;
		...
		KeyType: OptionSet.KeyVaultReference.KeyType | null;
		...
		PreAuthorizedApplicationType: OptionSet.KeyVaultReference.PreAuthorizedApplicationType | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Key Vault Reference */
		statecode: OptionSet.KeyVaultReference.statecode | null;
		/** Reason for the status of the Key Vault Reference */
		statuscode: OptionSet.KeyVaultReference.statuscode | null;
		/** For internal use only. */
