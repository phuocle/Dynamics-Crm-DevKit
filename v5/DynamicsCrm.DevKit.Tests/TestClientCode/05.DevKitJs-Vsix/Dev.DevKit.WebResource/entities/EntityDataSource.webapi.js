...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.EntityDataSourceApi = function (e) {
		...
		for (const field in _entitydatasource) {
			const fieldConfig = _entitydatasource[field];
			webApiField(entitydatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
