...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CommentApi = function (e) {
		...
		const _comment = {
			...
			ArtifactType: { a: 'artifacttype', g: 'Integer' },
			Body: { a: 'body' },
		...
		for (const field in _comment) {
			const fieldConfig = _comment[field];
			webApiField(comment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		comment.Entity = u;
