...
(function (DevKit) {
	DevKit.powerpagesite_dvfilesearchApi = function (e) {
		...
		const _powerpagesite_dvfilesearch = {
		...
		for (const field in _powerpagesite_dvfilesearch) {
			const fieldConfig = _powerpagesite_dvfilesearch[field];
			webApiField(powerpagesite_dvfilesearch, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
