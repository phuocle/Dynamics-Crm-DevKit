...
(function (DevKit) {
	DevKit.RibbonClientMetadataApi = function (e) {
		...
		const _ribbonclientmetadata = {
			...
			RibbonJsonFileRef_name: { a: 'ribbonjsonfileref', r: true },
		...
		for (const field in _ribbonclientmetadata) {
			const fieldConfig = _ribbonclientmetadata[field];
			webApiField(ribbonclientmetadata, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
