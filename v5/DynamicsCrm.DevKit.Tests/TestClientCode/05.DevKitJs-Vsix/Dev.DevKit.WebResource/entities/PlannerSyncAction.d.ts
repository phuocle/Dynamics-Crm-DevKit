...
declare namespace DevKit {
	export class PlannerSyncActionApi {
		...
		*/
		...
		PlannerBusinessScenarioId: string | null;
		/** Planner Sync Action Id */
		PlannerSyncActionId: string | null;
		...
		statecode: OptionSet.PlannerSyncAction.statecode | null;
		/** Reason for the status of the Planner Sync Action */
		statuscode: OptionSet.PlannerSyncAction.statuscode | null;
