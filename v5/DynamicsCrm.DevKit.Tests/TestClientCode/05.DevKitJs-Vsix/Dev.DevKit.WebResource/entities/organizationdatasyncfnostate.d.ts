...
declare namespace DevKit {
	export class organizationdatasyncfnostateApi {
		/**
		* DynamicsCrm.DevKit organizationdatasyncfnostateApi
		...
		*/
		...
		currentfullsyncstate: OptionSet.organizationdatasyncfnostate.currentfullsyncstate | null;
		...
		organizationdatasyncfnostateId: string | null;
		...
		statecode: OptionSet.organizationdatasyncfnostate.statecode | null;
		/** Reason for the status of the OrganizationDataSyncFnoState */
		statuscode: OptionSet.organizationdatasyncfnostate.statuscode | null;
...
declare namespace OptionSet {
	namespace organizationdatasyncfnostate {
