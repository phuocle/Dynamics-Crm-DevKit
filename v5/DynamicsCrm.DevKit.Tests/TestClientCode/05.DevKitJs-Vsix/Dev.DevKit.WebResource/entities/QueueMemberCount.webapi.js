...
(function (DevKit) {
	DevKit.QueueMemberCountApi = function (e) {
		...
		for (const field in _queuemembercount) {
			const fieldConfig = _queuemembercount[field];
			webApiField(queuemembercount, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
