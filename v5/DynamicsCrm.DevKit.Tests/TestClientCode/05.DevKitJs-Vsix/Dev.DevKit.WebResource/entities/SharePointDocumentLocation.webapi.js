...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SharePointDocumentLocationApi = function (e) {
		...
		const _sharepointdocumentlocation = {
			...
			LocationType: { a: 'locationtype', g: 'Integer' },
		...
		for (const field in _sharepointdocumentlocation) {
			const fieldConfig = _sharepointdocumentlocation[field];
			webApiField(sharepointdocumentlocation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
