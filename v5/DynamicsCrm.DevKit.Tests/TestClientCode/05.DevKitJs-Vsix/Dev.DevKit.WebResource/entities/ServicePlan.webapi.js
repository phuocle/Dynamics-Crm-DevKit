...
(function (DevKit) {
	DevKit.ServicePlanApi = function (e) {
		...
		for (const field in _serviceplan) {
			const fieldConfig = _serviceplan[field];
			webApiField(serviceplan, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
