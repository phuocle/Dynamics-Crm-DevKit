...
(function (DevKit) {
	DevKit.datalakeworkspaceApi = function (e) {
		...
		for (const field in _datalakeworkspace) {
			const fieldConfig = _datalakeworkspace[field];
			webApiField(datalakeworkspace, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
