...
(function (DevKit) {
	DevKit.msdyn_kbattachmentApi = function (e) {
		...
		const _msdyn_kbattachment = {
			...
			msdyn_fileattachment_name: { a: 'msdyn_fileattachment', r: true },
			...
			msdyn_filesize: { a: 'msdyn_filesize', g: 'Integer' },
		...
		for (const field in _msdyn_kbattachment) {
			const fieldConfig = _msdyn_kbattachment[field];
			webApiField(msdyn_kbattachment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
