...
(function (DevKit) {
	DevKit.powerpagecomponent_mspp_webrole_contactApi = function (e) {
		...
		const _powerpagecomponent_mspp_webrole_contact = {
		...
		for (const field in _powerpagecomponent_mspp_webrole_contact) {
			const fieldConfig = _powerpagecomponent_mspp_webrole_contact[field];
			webApiField(powerpagecomponent_mspp_webrole_contact, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
