...
declare namespace DevKit {
	...
	export class FormImport_Information extends DevKit.IForm {
		/**
	...
	export class ImportApi {
		...
		*/
		...
		ModeCode: OptionSet.Import.ModeCode | null;
		...
		readonly StateCode: OptionSet.Import.StateCode | null;
		/** Shows the reason code that explains the import job's status to identify the job's stage of the import processes, from transforming the data to completed. */
		StatusCode: OptionSet.Import.StatusCode | null;
		/**
