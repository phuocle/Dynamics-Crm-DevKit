...
declare namespace DevKit {
	namespace Formpowerbidataset_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formpowerbidataset_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form powerbidataset_Information */
		Body: DevKit.Formpowerbidataset_Information.Body;
	}
	export class powerbidatasetApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.powerbidataset.ComponentState | null;
		...
		statecode: OptionSet.powerbidataset.statecode | null;
		/** Reason for the status of the Power BI Dataset */
		statuscode: OptionSet.powerbidataset.statuscode | null;
		/** For internal use only. */
