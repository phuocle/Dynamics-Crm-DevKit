...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.MobileOfflineProfileApi = function (e) {
		...
		for (const field in _mobileofflineprofile) {
			const fieldConfig = _mobileofflineprofile[field];
			webApiField(mobileofflineprofile, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
