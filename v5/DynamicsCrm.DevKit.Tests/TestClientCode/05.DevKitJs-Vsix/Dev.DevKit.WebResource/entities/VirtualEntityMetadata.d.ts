...
declare namespace DevKit {
	...
	export class FormVirtualEntityMetadata_Information extends DevKit.IForm {
		/**
	...
	export class VirtualEntityMetadataApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.VirtualEntityMetadata.ComponentState | null;
		...
		statecode: OptionSet.VirtualEntityMetadata.statecode | null;
		/** Reason for the status of the VirtualEntityMetadata */
		statuscode: OptionSet.VirtualEntityMetadata.statuscode | null;
		/** For internal use only. */
