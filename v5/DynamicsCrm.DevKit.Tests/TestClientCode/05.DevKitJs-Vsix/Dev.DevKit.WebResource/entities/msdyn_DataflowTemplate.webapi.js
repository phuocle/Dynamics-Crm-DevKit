...
(function (DevKit) {
	DevKit.msdyn_DataflowTemplateApi = function (e) {
		...
		const _msdyn_dataflowtemplate = {
			...
			msdyn_IsDisabled: { a: 'msdyn_isdisabled', g: 'Boolean' },
			...
			msdyn_TemplateState: { a: 'msdyn_templatestate', g: 'Integer' },
		...
		for (const field in _msdyn_dataflowtemplate) {
			const fieldConfig = _msdyn_dataflowtemplate[field];
			webApiField(msdyn_dataflowtemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
