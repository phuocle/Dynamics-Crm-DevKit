...
(function (DevKit) {
	DevKit.AttributeImageConfigApi = function (e) {
		...
		for (const field in _attributeimageconfig) {
			const fieldConfig = _attributeimageconfig[field];
			webApiField(attributeimageconfig, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
