...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.OrgInsightsMetricApi = function (e) {
		...
		for (const field in _orginsightsmetric) {
			const fieldConfig = _orginsightsmetric[field];
			webApiField(orginsightsmetric, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
