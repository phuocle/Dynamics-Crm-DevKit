...
(function (DevKit) {
	DevKit.ConvertRuleApi = function (e) {
		...
		const _convertrule = {
			AllowUnknownSender: { a: 'allowunknownsender', g: 'Boolean' },
			...
			CheckActiveEntitlement: { a: 'checkactiveentitlement', g: 'Boolean' },
			CheckBlockedSocialProfile: { a: 'checkblockedsocialprofile', g: 'Boolean' },
			CheckDirectMessages: { a: 'checkdirectmessages', g: 'Boolean' },
			CheckIfResolved: { a: 'checkifresolved', g: 'Boolean' },
			...
			ResolvedSince: { a: 'resolvedsince', g: 'Integer' },
			ResponseTemplateId: { b: 'responsetemplateid', a: '_responsetemplateid_value', c: 'templates', d: 'template' },
			SendAutomaticResponse: { a: 'sendautomaticresponse', g: 'Boolean' },
			SolutionId: { a: 'solutionid', r: true },
			SourceTypeCode: { a: 'sourcetypecode', g: 'Integer' },
		...
		for (const field in _convertrule) {
			const fieldConfig = _convertrule[field];
			webApiField(convertrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
