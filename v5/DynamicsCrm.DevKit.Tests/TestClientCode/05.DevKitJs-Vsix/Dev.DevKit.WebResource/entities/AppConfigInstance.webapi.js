...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AppConfigInstanceApi = function (e) {
		...
		for (const field in _appconfiginstance) {
			const fieldConfig = _appconfiginstance[field];
			webApiField(appconfiginstance, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
