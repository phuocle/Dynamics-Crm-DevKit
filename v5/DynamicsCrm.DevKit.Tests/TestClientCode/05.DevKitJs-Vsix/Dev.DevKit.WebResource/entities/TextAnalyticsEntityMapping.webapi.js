...
(function (DevKit) {
	DevKit.TextAnalyticsEntityMappingApi = function (e) {
		...
		const _textanalyticsentitymapping = {
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			Entity2: { a: 'entity' },
			EntityDisplayName: { a: 'entitydisplayname' },
			EntityPickList: { a: 'entitypicklist', g: 'Integer' },
			Field: { a: 'field' },
			FieldDisplayName: { a: 'fielddisplayname' },
			FieldPickList: { a: 'fieldpicklist', g: 'Integer' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			IsTextMatchMapping: { a: 'istextmatchmapping', g: 'Boolean' },
			ModelType: { a: 'modeltype', g: 'Integer' },
		...
		for (const field in _textanalyticsentitymapping) {
			const fieldConfig = _textanalyticsentitymapping[field];
			webApiField(textanalyticsentitymapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
