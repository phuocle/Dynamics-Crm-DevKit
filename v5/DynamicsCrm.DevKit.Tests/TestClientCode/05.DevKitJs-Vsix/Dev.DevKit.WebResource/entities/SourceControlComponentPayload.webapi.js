...
(function (DevKit) {
	DevKit.SourceControlComponentPayloadApi = function (e) {
		...
		const _sourcecontrolcomponentpayload = {
		...
		for (const field in _sourcecontrolcomponentpayload) {
			const fieldConfig = _sourcecontrolcomponentpayload[field];
			webApiField(sourcecontrolcomponentpayload, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
