...
(function (DevKit) {
	DevKit.searchtelemetryApi = function (e) {
		...
		const _searchtelemetry = {
			CorrelationId: { a: 'correlationid' },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			EyesOnAnalyticsAllowed: { a: 'eyesonanalyticsallowed', g: 'Boolean' },
		...
		for (const field in _searchtelemetry) {
			const fieldConfig = _searchtelemetry[field];
			webApiField(searchtelemetry, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
