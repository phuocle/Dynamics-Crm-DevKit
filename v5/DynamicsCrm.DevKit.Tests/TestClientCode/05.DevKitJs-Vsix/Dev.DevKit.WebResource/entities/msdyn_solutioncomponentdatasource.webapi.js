...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_solutioncomponentdatasourceApi = function (e) {
		...
		const _msdyn_solutioncomponentdatasource = {
		...
		for (const field in _msdyn_solutioncomponentdatasource) {
			const fieldConfig = _msdyn_solutioncomponentdatasource[field];
			webApiField(msdyn_solutioncomponentdatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
