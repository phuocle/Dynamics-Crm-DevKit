...
(function (DevKit) {
	DevKit.msdyn_flow_flowapprovalApi = function (e) {
		...
		const _msdyn_flow_flowapproval = {
			...
			msdyn_flow_flowapproval_sendflowemail: { a: 'msdyn_flow_flowapproval_sendflowemail', g: 'Boolean' },
			msdyn_flow_flowapproval_sendflowpush: { a: 'msdyn_flow_flowapproval_sendflowpush', g: 'Boolean' },
		...
		for (const field in _msdyn_flow_flowapproval) {
			const fieldConfig = _msdyn_flow_flowapproval[field];
			webApiField(msdyn_flow_flowapproval, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
