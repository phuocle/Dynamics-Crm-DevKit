...
declare namespace DevKit {
	...
	export class FormDVFileSearchAttribute_Information extends DevKit.IForm {
		/**
	...
	export class DVFileSearchAttributeApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.DVFileSearchAttribute.ComponentState | null;
		...
		DVFileSearchAttributeId: string | null;
		/** Unique identifier for DVFileSearchEntity associated with DVFileSearchAttribute. */
		dvfilesearchentity: string | null;
		...
		statecode: OptionSet.DVFileSearchAttribute.statecode | null;
		/** Reason for the status of the DVFileSearchAttribute */
		statuscode: OptionSet.DVFileSearchAttribute.statuscode | null;
		/** For internal use only. */
