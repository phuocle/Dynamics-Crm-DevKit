...
(function (DevKit) {
	DevKit.CustomAPIApi = function (e) {
		...
		const _customapi = {
			AllowedCustomProcessingStepType: { a: 'allowedcustomprocessingsteptype', g: 'Integer' },
			BindingType: { a: 'bindingtype', g: 'Integer' },
			...
			IsFunction: { a: 'isfunction', g: 'Boolean' },
			...
			WorkflowSdkStepEnabled: { a: 'workflowsdkstepenabled', g: 'Boolean' }
		};
		if (e === undefined) e = {};
		const u = {};
		const customapi = {};
		...
		for (const field in _customapi) {
			const fieldConfig = _customapi[field];
			webApiField(customapi, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		customapi.Entity = u;
