...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ProcessTriggerApi = function (e) {
		...
		const _processtrigger = {
			...
			PipelineStage: { a: 'pipelinestage', g: 'Integer' },
		...
		for (const field in _processtrigger) {
			const fieldConfig = _processtrigger[field];
			webApiField(processtrigger, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
