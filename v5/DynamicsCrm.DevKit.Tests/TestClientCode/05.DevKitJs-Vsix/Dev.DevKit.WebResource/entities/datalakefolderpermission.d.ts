...
declare namespace DevKit {
	export class datalakefolderpermissionApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.datalakefolderpermission.ComponentState | null;
		...
		readonly statecode: OptionSet.datalakefolderpermission.statecode | null;
		/** Reason for the status of the Data Lake Folder Permission */
		readonly statuscode: OptionSet.datalakefolderpermission.statuscode | null;
		/** For internal use only. */
