...
declare namespace DevKit {
	export class appactionruleApi {
		...
		*/
		...
		appactionruleId: string | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.appactionrule.ComponentState | null;
		/** Context associated with AppActionRule Entity. */
		Context: OptionSet.appactionrule.Context | null;
		...
		statecode: OptionSet.appactionrule.statecode | null;
		/** Reason for the status of the App Action Rule */
		statuscode: OptionSet.appactionrule.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** Type of classic visible rule. */
		Type: OptionSet.appactionrule.Type | null;
