...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_pmrecordingApi = function (e) {
		...
		const _msdyn_pmrecording = {
			...
			msdyn_publishingstatus: { a: 'msdyn_publishingstatus', g: 'Integer' },
		...
		for (const field in _msdyn_pmrecording) {
			const fieldConfig = _msdyn_pmrecording[field];
			webApiField(msdyn_pmrecording, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
