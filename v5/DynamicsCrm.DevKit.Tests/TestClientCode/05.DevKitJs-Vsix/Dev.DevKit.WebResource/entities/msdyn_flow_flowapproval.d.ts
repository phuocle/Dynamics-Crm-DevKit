...
declare namespace DevKit {
	...
	export class Formmsdyn_flow_flowapproval_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_flow_flowapprovalApi {
		...
		*/
		...
		/** The linked approval. */
		msdyn_flow_flowapproval_approval: string | null;
		...
		msdyn_flow_flowapprovalId: string | null;
		...
		statecode: OptionSet.msdyn_flow_flowapproval.statecode | null;
		/** Reason for the status of the Flow Approval */
		statuscode: OptionSet.msdyn_flow_flowapproval.statuscode | null;
