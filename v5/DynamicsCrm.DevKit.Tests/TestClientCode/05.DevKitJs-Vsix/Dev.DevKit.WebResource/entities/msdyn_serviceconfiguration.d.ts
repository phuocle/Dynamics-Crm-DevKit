...
declare namespace DevKit {
	...
	export class Formmsdyn_serviceconfiguration_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_serviceconfigurationApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_serviceconfiguration.statecode | null;
		/** Reason for the status of the Service Configuration */
		statuscode: OptionSet.msdyn_serviceconfiguration.statuscode | null;
