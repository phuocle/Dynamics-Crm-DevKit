...
declare namespace DevKit {
	namespace FormMcpTool_Main_Form {
		...
		interface Body {
			...
			Annotations: DevKit.Controls.String;
			/** Backend Tool Type */
			...
			InputSchema: DevKit.Controls.String;
	...
	export class FormMcpTool_Main_Form extends DevKit.IForm {
		/**
		* McpTool Main Form [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		/** The Body section of form McpTool_Main_Form */
		Body: DevKit.FormMcpTool_Main_Form.Body;
	}
	export class MCPToolApi {
		/**
		* DynamicsCrm.DevKit MCPToolApi
		...
		*/
		...
		/** Backend Tool Type */
		BackendToolType: OptionSet.MCPTool.BackendToolType | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.MCPTool.ComponentState | null;
		/** Connector ID */
		...
		/** HTTP Method */
		HTTPMethod: OptionSet.MCPTool.HTTPMethod | null;
		...
		statecode: OptionSet.MCPTool.statecode | null;
		/** Reason for the status of the MCPTool */
		statuscode: OptionSet.MCPTool.statuscode | null;
		/** For internal use only. */
