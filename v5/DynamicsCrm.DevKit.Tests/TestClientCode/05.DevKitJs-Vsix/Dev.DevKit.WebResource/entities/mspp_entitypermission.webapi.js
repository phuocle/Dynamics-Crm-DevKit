...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_entitypermissionApi = function (e) {
		...
		const _mspp_entitypermission = {
			mspp_accountrelationship: { a: 'mspp_accountrelationship' },
			mspp_append: { a: 'mspp_append', g: 'Boolean' },
			mspp_appendto: { a: 'mspp_appendto', g: 'Boolean' },
			mspp_contactrelationship: { a: 'mspp_contactrelationship' },
			mspp_create: { a: 'mspp_create', g: 'Boolean' },
			...
			mspp_delete: { a: 'mspp_delete', g: 'Boolean' },
			...
			mspp_read: { a: 'mspp_read', g: 'Boolean' },
			mspp_scope: { a: 'mspp_scope', g: 'Integer' },
			mspp_websiteid: { b: 'mspp_websiteid', a: '_mspp_websiteid_value', c: 'mspp_websites', d: 'mspp_website' },
			mspp_write: { a: 'mspp_write', g: 'Boolean' },
		...
		for (const field in _mspp_entitypermission) {
			const fieldConfig = _mspp_entitypermission[field];
			webApiField(mspp_entitypermission, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
