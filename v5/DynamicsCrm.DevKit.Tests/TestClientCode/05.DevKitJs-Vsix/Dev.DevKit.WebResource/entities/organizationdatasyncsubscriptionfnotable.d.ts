...
declare namespace DevKit {
	export class organizationdatasyncsubscriptionfnotableApi {
		/**
		* DynamicsCrm.DevKit organizationdatasyncsubscriptionfnotableApi
		...
		*/
		...
		BlobPartitionBy: OptionSet.organizationdatasyncsubscriptionfnotable.BlobPartitionBy | null;
		...
		organizationdatasyncsubscriptionfnotableId: string | null;
		/** Unique identifier for the organization */
		readonly OrganizationId: string | null;
		/** Date and time that the record was migrated. */
		OverriddenCreatedOn_UtcDateOnly: Date | null;
		/** Status of the OrganizationDataSyncSubscriptionFnoTable */
		statecode: OptionSet.organizationdatasyncsubscriptionfnotable.statecode | null;
		/** Reason for the status of the OrganizationDataSyncSubscriptionFnoTable */
		statuscode: OptionSet.organizationdatasyncsubscriptionfnotable.statuscode | null;
...
declare namespace OptionSet {
	namespace organizationdatasyncsubscriptionfnotable {
