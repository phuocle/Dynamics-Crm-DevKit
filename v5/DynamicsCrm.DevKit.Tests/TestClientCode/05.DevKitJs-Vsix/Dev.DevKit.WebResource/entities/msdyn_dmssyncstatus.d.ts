...
declare namespace DevKit {
	export class msdyn_dmssyncstatusApi {
		...
		*/
		...
		msdyn_dmssyncstatusId: string | null;
		/** Sync End Time */
		...
		msdyn_lookupfield_dmssyncrequest: string | null;
		/** Sync Start Time */
		...
		statecode: OptionSet.msdyn_dmssyncstatus.statecode | null;
		/** Reason for the status of the DMS Sync Status */
		statuscode: OptionSet.msdyn_dmssyncstatus.statuscode | null;
