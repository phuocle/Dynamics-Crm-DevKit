...
declare namespace DevKit {
	export class sensitivitylabelattributemappingApi {
		/**
		* DynamicsCrm.DevKit sensitivitylabelattributemappingApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.sensitivitylabelattributemapping.ComponentState | null;
		...
		sensitivitylabelattributemappingId: string | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Sensitivity Label Attribute Mapping */
		statecode: OptionSet.sensitivitylabelattributemapping.statecode | null;
		/** Reason for the status of the Sensitivity Label Attribute Mapping */
		statuscode: OptionSet.sensitivitylabelattributemapping.statuscode | null;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace sensitivitylabelattributemapping {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
