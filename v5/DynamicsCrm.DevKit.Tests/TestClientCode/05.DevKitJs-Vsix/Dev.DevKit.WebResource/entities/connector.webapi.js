...
(function (DevKit) {
	DevKit.connectorApi = function (e) {
		...
		const _connector = {
			Capabilities: { a: 'capabilities', g: 'MultiOptionSet' },
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			ConnectionParameters: { a: 'connectionparameters' },
			ConnectionParameterSets: { a: 'connectionparametersets' },
			connectorId: { a: 'connectorid' },
			ConnectorIdUnique: { a: 'connectoridunique', r: true },
			ConnectorInternalId: { a: 'connectorinternalid' },
			ConnectorType: { a: 'connectortype', g: 'Integer' },
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			CustomCodeBlobContent: { a: 'customcodeblobcontent' },
			Description: { a: 'description' },
			DisplayName: { a: 'displayname' },
			EntityImage: { a: 'iconblob' },
			EntityImage_Timestamp: { a: 'iconblob_timestamp', r: true },
			EntityImage_URL: { a: 'iconblob_url', r: true },
			IconBlob: { a: 'iconblob' },
			...
			ScriptOperations: { a: 'scriptoperations' },
		...
		for (const field in _connector) {
			const fieldConfig = _connector[field];
			webApiField(connector, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		connector.Entity = u;
