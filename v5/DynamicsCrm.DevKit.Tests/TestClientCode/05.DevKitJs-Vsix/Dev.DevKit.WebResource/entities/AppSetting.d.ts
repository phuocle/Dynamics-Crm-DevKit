...
declare namespace DevKit {
	export class AppSettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.AppSetting.ComponentState | null;
		...
		readonly statecode: OptionSet.AppSetting.statecode | null;
		/** Reason for the status of the AppSetting */
		readonly statuscode: OptionSet.AppSetting.statuscode | null;
		/** For internal use only. */
