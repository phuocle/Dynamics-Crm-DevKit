...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SyncErrorApi = function (e) {
		...
		const _syncerror = {
			...
			ErrorTime_UtcDateAndTime: { a: 'errortime', g: 'DateTime' },
		...
		for (const field in _syncerror) {
			const fieldConfig = _syncerror[field];
			webApiField(syncerror, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		syncerror.Entity = u;
