...
(function (DevKit) {
	DevKit.msdyn_flow_approvalresponseApi = function (e) {
		...
		const _msdyn_flow_approvalresponse = {
			...
			msdyn_flow_approvalresponse_stage: { a: 'msdyn_flow_approvalresponse_stage', g: 'Integer' },
			msdyn_flow_approvalresponse_stepnumber: { a: 'msdyn_flow_approvalresponse_stepnumber', g: 'Integer' },
		...
		for (const field in _msdyn_flow_approvalresponse) {
			const fieldConfig = _msdyn_flow_approvalresponse[field];
			webApiField(msdyn_flow_approvalresponse, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
