...
(function (DevKit) {
	DevKit.MsGraphResourceToSubscriptionApi = function (e) {
		...
		const _msgraphresourcetosubscription = {
			CreatedInGraphOn_TimezoneDateAndTime: { a: 'createdingraphon', g: 'DateTime' },
			...
			ResourceType: { a: 'resourcetype', g: 'Integer' },
		...
		for (const field in _msgraphresourcetosubscription) {
			const fieldConfig = _msgraphresourcetosubscription[field];
			webApiField(msgraphresourcetosubscription, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
