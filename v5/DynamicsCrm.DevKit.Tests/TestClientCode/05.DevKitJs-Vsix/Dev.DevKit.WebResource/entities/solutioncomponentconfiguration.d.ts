...
declare namespace DevKit {
	...
	export class Formsolutioncomponentconfiguration_Information extends DevKit.IForm {
		/**
	...
	export class solutioncomponentconfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.solutioncomponentconfiguration.ComponentState | null;
		...
		FileFormat: OptionSet.solutioncomponentconfiguration.FileFormat | null;
		FileScope: OptionSet.solutioncomponentconfiguration.FileScope | null;
		...
		statecode: OptionSet.solutioncomponentconfiguration.statecode | null;
		/** Reason for the status of the Solution Component Configuration */
		statuscode: OptionSet.solutioncomponentconfiguration.statuscode | null;
		/** For internal use only. */
