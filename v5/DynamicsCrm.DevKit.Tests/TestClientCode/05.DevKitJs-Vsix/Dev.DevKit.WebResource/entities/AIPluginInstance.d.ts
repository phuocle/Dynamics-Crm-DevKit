...
declare namespace DevKit {
	...
	export class AIPluginInstanceApi {
		/**
		* DynamicsCrm.DevKit AIPluginInstanceApi
		...
		*/
		...
		AIPluginInstanceId: string | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.AIPluginInstance.ComponentState | null;
		...
		/** Status of the AIPluginInstance */
		statecode: OptionSet.AIPluginInstance.statecode | null;
		/** Reason for the status of the AIPluginInstance */
		statuscode: OptionSet.AIPluginInstance.statuscode | null;
		/** For internal use only. */
