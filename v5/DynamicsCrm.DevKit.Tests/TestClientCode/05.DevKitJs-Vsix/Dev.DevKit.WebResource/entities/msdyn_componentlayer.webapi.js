...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_componentlayerApi = function (e) {
		...
		const _msdyn_componentlayer = {
			...
			msdyn_endtime_UtcDateAndTime: { a: 'msdyn_overwritetime', g: 'DateTime' },
		...
		for (const field in _msdyn_componentlayer) {
			const fieldConfig = _msdyn_componentlayer[field];
			webApiField(msdyn_componentlayer, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
