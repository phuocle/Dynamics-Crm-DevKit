...
declare namespace DevKit {
	...
	export class FormEnvironmentVariableValue_Information extends DevKit.IForm {
		/**
	...
	export class EnvironmentVariableValueApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.EnvironmentVariableValue.ComponentState | null;
		...
		/** For internal use only. */
		readonly EnvironmentVariableValueIdUnique: string | null;
		...
		statecode: OptionSet.EnvironmentVariableValue.statecode | null;
		/** Reason for the status of the Environment Variable Value */
		statuscode: OptionSet.EnvironmentVariableValue.statuscode | null;
		/** For internal use only. */
