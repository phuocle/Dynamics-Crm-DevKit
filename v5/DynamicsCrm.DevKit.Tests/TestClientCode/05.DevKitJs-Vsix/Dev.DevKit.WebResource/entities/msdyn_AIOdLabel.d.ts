...
declare namespace DevKit {
	...
	export class Formmsdyn_AIOdLabel_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_AIOdLabelApi {
		...
		*/
		...
		/** Status of the Label */
		statecode: OptionSet.msdyn_AIOdLabel.statecode | null;
		/** Reason for the status of the Label */
		statuscode: OptionSet.msdyn_AIOdLabel.statuscode | null;
