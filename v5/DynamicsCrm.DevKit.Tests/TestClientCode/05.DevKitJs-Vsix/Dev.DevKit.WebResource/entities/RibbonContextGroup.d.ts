...
declare namespace DevKit {
	export class RibbonContextGroupApi {
		/**
		* DynamicsCrm.DevKit RibbonContextGroupApi
		...
		*/
		...
		readonly ComponentState: OptionSet.RibbonContextGroup.ComponentState | null;
		...
		readonly RibbonContextGroupUniqueId: string | null;
