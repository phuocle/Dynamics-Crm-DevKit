...
declare namespace DevKit {
	export class supportusertableApi {
		...
		*/
		...
		EnabledforSoftDelete: OptionSet.supportusertable.EnabledforSoftDelete | null;
		...
		IsActive: OptionSet.supportusertable.IsActive | null;
		...
		statecode: OptionSet.supportusertable.statecode | null;
		/** Reason for the status of the SupportUserTable */
		statuscode: OptionSet.supportusertable.statuscode | null;
		/** Unique identifier for entity instances */
		supportusertableId: string | null;
