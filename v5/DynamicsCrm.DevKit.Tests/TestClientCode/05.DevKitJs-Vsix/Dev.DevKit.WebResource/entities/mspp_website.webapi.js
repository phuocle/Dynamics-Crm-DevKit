...
(function (DevKit) {
	DevKit.mspp_websiteApi = function (e) {
		...
		const _mspp_website = {
			...
			mspp_website_language: { a: 'mspp_website_language', g: 'Integer' },
		...
		for (const field in _mspp_website) {
			const fieldConfig = _mspp_website[field];
			webApiField(mspp_website, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
