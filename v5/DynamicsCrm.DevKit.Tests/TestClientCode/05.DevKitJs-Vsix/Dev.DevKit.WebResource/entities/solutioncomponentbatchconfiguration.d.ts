...
declare namespace DevKit {
	...
	export class Formsolutioncomponentbatchconfiguration_Information extends DevKit.IForm {
		/**
	...
	export class solutioncomponentbatchconfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.solutioncomponentbatchconfiguration.ComponentState | null;
		...
		/** The name of the custom entity. */
		name: string | null;
		Operation: OptionSet.solutioncomponentbatchconfiguration.Operation | null;
		...
		statecode: OptionSet.solutioncomponentbatchconfiguration.statecode | null;
		/** Reason for the status of the Solution Component Batch Configuration */
		statuscode: OptionSet.solutioncomponentbatchconfiguration.statuscode | null;
		/** For internal use only. */
