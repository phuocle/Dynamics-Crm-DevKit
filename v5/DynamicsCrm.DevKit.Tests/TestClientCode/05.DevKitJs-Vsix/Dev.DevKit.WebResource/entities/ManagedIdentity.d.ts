...
declare namespace DevKit {
	export class ManagedIdentityApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ManagedIdentity.ComponentState | null;
		...
		CredentialSource: OptionSet.ManagedIdentity.CredentialSource | null;
		/** Determines Identity type for Managed Identity */
		IdentityType: OptionSet.ManagedIdentity.IdentityType | null;
		...
		statecode: OptionSet.ManagedIdentity.statecode | null;
		/** Reason for the status of the Managed Identity */
		statuscode: OptionSet.ManagedIdentity.statuscode | null;
		/** Where the Scope of the SubjectName for Managed Identity will be determined. */
		SubjectScope: OptionSet.ManagedIdentity.SubjectScope | null;
		/** For internal use only. */
