...
(function (DevKit) {
	DevKit.DelveActionHubApi = function (e) {
		...
		const _delveactionhub = {
			CardType: { a: 'cardtype', r: true, g: 'Integer' },
			...
			MessageTime_UtcDateAndTime: { a: 'messagetime', r: true, g: 'DateTime' },
			...
			SenderEntityObjectTypeCode: { a: 'senderentityobjecttypecode', r: true, g: 'Integer' },
		...
		for (const field in _delveactionhub) {
			const fieldConfig = _delveactionhub[field];
			webApiField(delveactionhub, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
