...
declare namespace DevKit {
	export class ApplicationUserApi {
		...
		*/
		...
		ApplicationType: OptionSet.ApplicationUser.ApplicationType | null;
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ApplicationUser.ComponentState | null;
		...
		statecode: OptionSet.ApplicationUser.statecode | null;
		/** Reason for the status of the ApplicationUser */
		statuscode: OptionSet.ApplicationUser.statuscode | null;
		/** For internal use only. */
