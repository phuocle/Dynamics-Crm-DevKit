...
declare namespace DevKit {
	export class StagedEntityRelationshipRoleApi {
		/**
		* DynamicsCrm.DevKit StagedEntityRelationshipRoleApi
		...
		*/
		...
		StagedEntityRelationshipRoleId: string | null;
		...
		statecode: OptionSet.StagedEntityRelationshipRole.statecode | null;
		/** Reason for the status of the staged entity relationship role. */
		statuscode: OptionSet.StagedEntityRelationshipRole.statuscode | null;
...
declare namespace OptionSet {
	namespace StagedEntityRelationshipRole {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
