...
(function (DevKit) {
	DevKit.SystemUserProfilesApi = function (e) {
		...
		for (const field in _systemuserprofiles) {
			const fieldConfig = _systemuserprofiles[field];
			webApiField(systemuserprofiles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
