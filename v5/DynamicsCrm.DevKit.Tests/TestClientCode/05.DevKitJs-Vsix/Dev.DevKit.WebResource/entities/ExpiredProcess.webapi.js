...
var DevKit;
(function (DevKit) {
	DevKit.ExpiredProcessApi = function (e) {
		...
		expiredprocess.ODataEntity = e;
		expiredprocess.FormattedValue = {};
		for (const field in _expiredprocess) {
			const fieldConfig = _expiredprocess[field];
			webApiField(expiredprocess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		...
		expiredprocess.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		expiredprocess.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
