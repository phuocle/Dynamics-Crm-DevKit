...
declare namespace DevKit {
	export class flowmachineimageversionApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.flowmachineimageversion.ComponentState | null;
		...
		statecode: OptionSet.flowmachineimageversion.statecode | null;
		/** Reason for the status of the Flow Machine Image Version */
		statuscode: OptionSet.flowmachineimageversion.statuscode | null;
		/** Flow Machine Image Version Error Message. */
		statuserrormessage: string | null;
		/** The Flow machine image version supported scenario. */
		SupportedScenario: OptionSet.flowmachineimageversion.SupportedScenario | null;
		/** For internal use only. */
