...
(function (DevKit) {
	DevKit.EventExpanderBreadcrumbApi = function (e) {
		...
		const _eventexpanderbreadcrumb = {
			...
			StateCode: { a: 'breadcrumbstatecode', g: 'Integer' },
			StatusCode: { a: 'breadcrumbstatuscode', g: 'Integer' },
		...
		for (const field in _eventexpanderbreadcrumb) {
			const fieldConfig = _eventexpanderbreadcrumb[field];
			webApiField(eventexpanderbreadcrumb, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
