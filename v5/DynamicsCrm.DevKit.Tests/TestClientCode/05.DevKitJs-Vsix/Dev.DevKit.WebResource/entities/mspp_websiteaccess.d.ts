...
declare namespace DevKit {
	...
	export class Formmspp_websiteaccess_Information extends DevKit.IForm {
		/**
	...
	export class mspp_websiteaccessApi {
		...
		*/
		...
		mspp_websiteaccessId: string | null;
		/** Unique identifier for Website associated with Website Access. */
		mspp_websiteid: string | null;
		/** Status of the Website Access */
		statecode: OptionSet.mspp_websiteaccess.statecode | null;
		/** Reason for the status of the Website Access */
		statuscode: OptionSet.mspp_websiteaccess.statuscode | null;
		/**
