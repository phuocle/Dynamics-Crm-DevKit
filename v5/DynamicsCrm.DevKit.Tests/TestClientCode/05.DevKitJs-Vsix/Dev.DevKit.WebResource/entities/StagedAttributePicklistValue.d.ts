...
declare namespace DevKit {
	export class StagedAttributePicklistValueApi {
		/**
		* DynamicsCrm.DevKit StagedAttributePicklistValueApi
		...
		*/
		...
		StagedAttributePicklistValueId: string | null;
		...
		statecode: OptionSet.StagedAttributePicklistValue.statecode | null;
		/** Reason for the status of the staged attribute picklist value. */
		statuscode: OptionSet.StagedAttributePicklistValue.statuscode | null;
...
declare namespace OptionSet {
	namespace StagedAttributePicklistValue {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
