...
declare namespace DevKit {
	export class fabricaiskillApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.fabricaiskill.ComponentState | null;
		...
		statecode: OptionSet.fabricaiskill.statecode | null;
		/** Reason for the status of the Fabric AISkill. */
		statuscode: OptionSet.fabricaiskill.statuscode | null;
		/** For internal use only. */
