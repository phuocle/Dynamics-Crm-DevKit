...
(function (DevKit) {
	DevKit.PluginPackageApi = function (e) {
		...
		const _pluginpackage = {
			...
			ExportKeyVersion: { a: 'exportkeyversion', g: 'Integer' },
		...
		for (const field in _pluginpackage) {
			const fieldConfig = _pluginpackage[field];
			webApiField(pluginpackage, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
