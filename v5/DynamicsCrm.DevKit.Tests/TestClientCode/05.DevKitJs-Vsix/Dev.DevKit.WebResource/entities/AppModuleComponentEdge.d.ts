...
declare namespace DevKit {
	export class AppModuleComponentEdgeApi {
		...
		*/
		...
		ComponentNodeFrom: string | null;
		/** Model-Driven App child commponent node */
		ComponentNodeTo: string | null;
		...
		statecode: OptionSet.AppModuleComponentEdge.statecode | null;
		/** Reason for the status of the Model-Driven App Component Nodes Edge */
		statuscode: OptionSet.AppModuleComponentEdge.statuscode | null;
