...
declare namespace DevKit {
	export class ActivityPointerApi {
		...
		*/
		...
		Community: OptionSet.ActivityPointer.Community | null;
		...
		DeliveryPriorityCode: OptionSet.ActivityPointer.DeliveryPriorityCode | null;
		...
		readonly InstanceTypeCode: OptionSet.ActivityPointer.InstanceTypeCode | null;
		...
		PriorityCode: OptionSet.ActivityPointer.PriorityCode | null;
		...
		StateCode: OptionSet.ActivityPointer.StateCode | null;
		/** Reason for the status of the activity. */
		StatusCode: OptionSet.ActivityPointer.StatusCode | null;
