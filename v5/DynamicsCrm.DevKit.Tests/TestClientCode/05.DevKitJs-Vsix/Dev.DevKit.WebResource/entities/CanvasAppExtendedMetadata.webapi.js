...
(function (DevKit) {
	DevKit.CanvasAppExtendedMetadataApi = function (e) {
		...
		const _canvasappextendedmetadata = {
		...
		for (const field in _canvasappextendedmetadata) {
			const fieldConfig = _canvasappextendedmetadata[field];
			webApiField(canvasappextendedmetadata, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		...
		return canvasappextendedmetadata;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.CanvasAppExtendedMetadata = {
