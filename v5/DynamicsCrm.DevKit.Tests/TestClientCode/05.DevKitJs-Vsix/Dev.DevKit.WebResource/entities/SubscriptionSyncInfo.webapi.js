...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SubscriptionSyncInfoApi = function (e) {
		...
		const _subscriptionsyncinfo = {
			ClientVersion: { a: 'clientversion' },
			DataSize: { a: 'datasize', g: 'Integer' },
			DeleteObjectCount: { a: 'deleteobjectcount', g: 'Integer' },
			EndTime_UtcDateOnly: { a: 'endtime', r: true, g: 'DateTime' },
			InsertObjectCount: { a: 'insertobjectcount', g: 'Integer' },
			StartTime_UtcDateOnly: { a: 'starttime', r: true, g: 'DateTime' },
			SubscriptionId: { b: 'subscriptionid', a: '_subscriptionid_value', c: 'subscriptions', d: 'subscription' },
			SubscriptionSyncInfoId2: { a: 'subscriptionsyncinfoid', r: true, g: 'Integer' },
			SyncResult: { a: 'syncresult', g: 'Boolean' },
		...
		for (const field in _subscriptionsyncinfo) {
			const fieldConfig = _subscriptionsyncinfo[field];
			webApiField(subscriptionsyncinfo, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
