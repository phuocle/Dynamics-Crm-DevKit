...
(function (DevKit) {
	DevKit.HierarchySecurityConfigurationApi = function (e) {
		...
		const _hierarchysecurityconfiguration = {
		...
		for (const field in _hierarchysecurityconfiguration) {
			const fieldConfig = _hierarchysecurityconfiguration[field];
			webApiField(hierarchysecurityconfiguration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
