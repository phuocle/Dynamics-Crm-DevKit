...
(function (DevKit) {
	DevKit.mspp_webpageaccesscontrolrule_webroleApi = function (e) {
		...
		const _mspp_webpageaccesscontrolrule_webrole = {
		...
		for (const field in _mspp_webpageaccesscontrolrule_webrole) {
			const fieldConfig = _mspp_webpageaccesscontrolrule_webrole[field];
			webApiField(mspp_webpageaccesscontrolrule_webrole, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
