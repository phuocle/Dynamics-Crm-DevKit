...
declare namespace DevKit {
	...
	export class FormCategory extends DevKit.IForm {
		/**
		* Category [Main Form]
	...
	export class FormCategory_Main_Interactive extends DevKit.IForm {
		/**
	...
	export class FormCategory_Quick_Create extends DevKit.IForm {
		/**
