...
(function (DevKit) {
	DevKit.FieldPermissionApi = function (e) {
		...
		const _fieldpermission = {
			AttributeLogicalName: { a: 'attributelogicalname' },
			CanCreate: { a: 'cancreate', g: 'Integer' },
			CanRead: { a: 'canread', g: 'Integer' },
			CanReadUnMasked: { a: 'canreadunmasked', g: 'Integer' },
			CanUpdate: { a: 'canupdate', g: 'Integer' },
		...
		for (const field in _fieldpermission) {
			const fieldConfig = _fieldpermission[field];
			webApiField(fieldpermission, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
