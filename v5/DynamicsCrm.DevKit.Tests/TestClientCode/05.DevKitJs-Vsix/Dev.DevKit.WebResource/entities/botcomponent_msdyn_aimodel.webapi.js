...
(function (DevKit) {
	DevKit.botcomponent_msdyn_aimodelApi = function (e) {
		...
		const _botcomponent_msdyn_aimodel = {
		...
		for (const field in _botcomponent_msdyn_aimodel) {
			const fieldConfig = _botcomponent_msdyn_aimodel[field];
			webApiField(botcomponent_msdyn_aimodel, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
