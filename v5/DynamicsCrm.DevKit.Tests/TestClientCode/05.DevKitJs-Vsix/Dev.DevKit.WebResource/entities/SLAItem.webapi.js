...
(function (DevKit) {
	DevKit.SLAItemApi = function (e) {
		...
		const _slaitem = {
			...
			FailureAfter: { a: 'failureafter', g: 'Integer' },
			...
			msdyn_CustomTimeCalculation: { a: 'msdyn_customtimecalculation', g: 'Boolean' },
			...
			WarnAfter: { a: 'warnafter', g: 'Integer' },
		...
		for (const field in _slaitem) {
			const fieldConfig = _slaitem[field];
			webApiField(slaitem, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		slaitem.Entity = u;
