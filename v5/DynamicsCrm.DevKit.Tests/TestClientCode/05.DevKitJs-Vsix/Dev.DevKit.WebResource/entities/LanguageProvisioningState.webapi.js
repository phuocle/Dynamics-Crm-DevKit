...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.LanguageProvisioningStateApi = function (e) {
		...
		const _languageprovisioningstate = {
			...
			ProvisioningStage: { a: 'provisioningstage', g: 'Integer' },
		...
		for (const field in _languageprovisioningstate) {
			const fieldConfig = _languageprovisioningstate[field];
			webApiField(languageprovisioningstate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
