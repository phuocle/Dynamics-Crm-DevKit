...
declare namespace DevKit {
	export class ImportEntityMappingApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.ImportEntityMapping.ComponentState | null;
		...
		DeDupe: OptionSet.ImportEntityMapping.DeDupe | null;
		/** Unique identifier of the import entity mapping. */
		ImportEntityMappingId: string | null;
		/** Unique identifier of the Import Entity Mapping. */
		readonly ImportEntityMappingIdUnique: string | null;
		...
		ProcessCode: OptionSet.ImportEntityMapping.ProcessCode | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Name of the source entity. */
		SourceEntityName: string | null;
		/** Status of the import entity mapping. */
		readonly StateCode: OptionSet.ImportEntityMapping.StateCode | null;
		/** Reason for the status of the import entity mapping. */
		StatusCode: OptionSet.ImportEntityMapping.StatusCode | null;
		/** For internal use only. */
