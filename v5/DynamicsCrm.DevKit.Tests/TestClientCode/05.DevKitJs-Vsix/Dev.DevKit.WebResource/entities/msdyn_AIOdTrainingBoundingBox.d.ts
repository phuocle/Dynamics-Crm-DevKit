...
declare namespace DevKit {
	...
	export class Formmsdyn_AIOdTrainingBoundingBox_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_AIOdTrainingBoundingBoxApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_AIOdTrainingBoundingBox.statecode | null;
		/** Reason for the status of the TrainingBoundingBox */
		statuscode: OptionSet.msdyn_AIOdTrainingBoundingBox.statuscode | null;
