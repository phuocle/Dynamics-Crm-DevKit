...
(function (DevKit) {
	DevKit.SubscriptionClientsApi = function (e) {
		...
		const _subscriptionclients = {
			ClientId: { a: 'clientid', r: true },
			IsPrimaryClient: { a: 'isprimaryclient', r: true, g: 'Boolean' },
		...
		for (const field in _subscriptionclients) {
			const fieldConfig = _subscriptionclients[field];
			webApiField(subscriptionclients, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
