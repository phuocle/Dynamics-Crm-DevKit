...
(function (DevKit) {
	DevKit.ComplexControlApi = function (e) {
		...
		for (const field in _complexcontrol) {
			const fieldConfig = _complexcontrol[field];
			webApiField(complexcontrol, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
