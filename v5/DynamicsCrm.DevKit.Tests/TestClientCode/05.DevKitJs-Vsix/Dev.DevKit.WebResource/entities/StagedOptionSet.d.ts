...
declare namespace DevKit {
	export class StagedOptionSetApi {
		/**
		* DynamicsCrm.DevKit StagedOptionSetApi
		...
		*/
		...
		statecode: OptionSet.StagedOptionSet.statecode | null;
		/** Reason for the status of the staged option set. */
		statuscode: OptionSet.StagedOptionSet.statuscode | null;
