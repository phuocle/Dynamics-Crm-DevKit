...
(function (DevKit) {
	DevKit.EntityImageConfigApi = function (e) {
		...
		for (const field in _entityimageconfig) {
			const fieldConfig = _entityimageconfig[field];
			webApiField(entityimageconfig, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
