...
declare namespace DevKit {
	export class AppModuleComponentNodeApi {
		...
		*/
		...
		statecode: OptionSet.AppModuleComponentNode.statecode | null;
		/** Reason for the status of the Model-Driven App Component Node */
		statuscode: OptionSet.AppModuleComponentNode.statuscode | null;
		...
		ValidationStatus: OptionSet.AppModuleComponentNode.ValidationStatus | null;
		/** Version Number */
