...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PluginTypeApi = function (e) {
		...
		const _plugintype = {
			...
			IsWorkflowActivity: { a: 'isworkflowactivity', r: true, g: 'Boolean' },
			...
			PluginTypeExportKey: { a: 'plugintypeexportkey' },
		...
		for (const field in _plugintype) {
			const fieldConfig = _plugintype[field];
			webApiField(plugintype, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		plugintype.Entity = u;
