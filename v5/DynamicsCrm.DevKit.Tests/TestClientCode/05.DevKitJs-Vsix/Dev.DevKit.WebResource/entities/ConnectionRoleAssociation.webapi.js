...
(function (DevKit) {
	DevKit.ConnectionRoleAssociationApi = function (e) {
		...
		const _connectionroleassociation = {
		...
		for (const field in _connectionroleassociation) {
			const fieldConfig = _connectionroleassociation[field];
			webApiField(connectionroleassociation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
