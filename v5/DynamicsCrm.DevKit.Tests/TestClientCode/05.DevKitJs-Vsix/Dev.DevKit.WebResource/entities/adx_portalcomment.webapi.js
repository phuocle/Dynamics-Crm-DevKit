...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.adx_portalcommentApi = function (e) {
		...
		const _adx_portalcomment = {
			...
			adx_PortalCommentDirectionCode: { a: 'adx_portalcommentdirectioncode', g: 'Integer' },
		...
		for (const field in _adx_portalcomment) {
			const fieldConfig = _adx_portalcomment[field];
			webApiField(adx_portalcomment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
