...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.floweventApi = function (e) {
		...
		const _flowevent = {
			...
			EventDuration: { a: 'eventduration', g: 'Integer' },
		...
		for (const field in _flowevent) {
			const fieldConfig = _flowevent[field];
			webApiField(flowevent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		flowevent.Entity = u;
