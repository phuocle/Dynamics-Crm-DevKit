...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.cascadegrantrevokeaccessrecordstrackerApi = function (e) {
		...
		const _cascadegrantrevokeaccessrecordstracker = {
			...
			ProcessedRecords: { a: 'processedrecords', g: 'Integer' },
			...
			TotalRecords: { a: 'totalrecords', g: 'Integer' },
		...
		for (const field in _cascadegrantrevokeaccessrecordstracker) {
			const fieldConfig = _cascadegrantrevokeaccessrecordstracker[field];
			webApiField(cascadegrantrevokeaccessrecordstracker, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
