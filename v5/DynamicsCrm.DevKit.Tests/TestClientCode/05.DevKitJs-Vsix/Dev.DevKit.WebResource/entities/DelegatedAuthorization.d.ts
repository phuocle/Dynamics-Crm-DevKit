...
declare namespace DevKit {
	export class DelegatedAuthorizationApi {
		...
		*/
		...
		/** Type of provider. */
		ProviderType: OptionSet.DelegatedAuthorization.ProviderType | null;
		/** Identifier for Project Roadmap */
		RoadmapProjectId: string | null;
		/** Identifier for SharePoint list */
		SharePointListId: string | null;
		/** SharePoint site (URL) */
		SharePointSite: string | null;
		/** Status of the DelegatedAuthorization */
		statecode: OptionSet.DelegatedAuthorization.statecode | null;
		/** Reason for the status of the DelegatedAuthorization */
		statuscode: OptionSet.DelegatedAuthorization.statuscode | null;
