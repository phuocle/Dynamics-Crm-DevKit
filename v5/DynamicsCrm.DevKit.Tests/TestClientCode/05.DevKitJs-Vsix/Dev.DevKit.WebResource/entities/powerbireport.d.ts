...
declare namespace DevKit {
	...
	export class Formpowerbireport_Information extends DevKit.IForm {
		/**
	...
	export class powerbireportApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.powerbireport.ComponentState | null;
		...
		statecode: OptionSet.powerbireport.statecode | null;
		/** Reason for the status of the Power BI Report */
		statuscode: OptionSet.powerbireport.statuscode | null;
		/** For internal use only. */
