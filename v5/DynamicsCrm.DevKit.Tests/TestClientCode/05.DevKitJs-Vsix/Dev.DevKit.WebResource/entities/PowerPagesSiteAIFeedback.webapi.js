...
(function (DevKit) {
	DevKit.PowerPagesSiteAIFeedbackApi = function (e) {
		...
		for (const field in _powerpagessiteaifeedback) {
			const fieldConfig = _powerpagessiteaifeedback[field];
			webApiField(powerpagessiteaifeedback, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
