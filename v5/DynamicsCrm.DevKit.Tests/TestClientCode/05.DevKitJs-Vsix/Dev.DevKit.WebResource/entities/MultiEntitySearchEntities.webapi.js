...
(function (DevKit) {
	DevKit.MultiEntitySearchEntitiesApi = function (e) {
		...
		const _multientitysearchentities = {
			EntityName2: { a: 'entityname', r: true },
			EntityOrder: { a: 'entityorder', r: true, g: 'Integer' },
		...
		for (const field in _multientitysearchentities) {
			const fieldConfig = _multientitysearchentities[field];
			webApiField(multientitysearchentities, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
