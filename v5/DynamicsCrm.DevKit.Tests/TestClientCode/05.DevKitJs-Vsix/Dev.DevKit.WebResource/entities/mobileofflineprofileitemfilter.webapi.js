...
(function (DevKit) {
	DevKit.mobileofflineprofileitemfilterApi = function (e) {
		...
		const _mobileofflineprofileitemfilter = {
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			fetchxml: { a: 'fetchxml' },
			IsActivity: { a: 'isactivity', g: 'Boolean' },
			IsIntersect: { a: 'isintersect', g: 'Boolean' },
			...
			outerFetchXml: { a: 'outerfetchXml' },
			subtype: { a: 'subtype', g: 'Integer' },
		...
		for (const field in _mobileofflineprofileitemfilter) {
			const fieldConfig = _mobileofflineprofileitemfilter[field];
			webApiField(mobileofflineprofileitemfilter, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
