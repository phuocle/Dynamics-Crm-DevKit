...
declare namespace DevKit {
	namespace Formmsdyn_pmview_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formmsdyn_pmview_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_pmview_Information */
		Body: DevKit.Formmsdyn_pmview_Information.Body;
	}
	export class msdyn_pmviewApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_pmview.ComponentState | null;
		...
		msdyn_parentpmviewid: string | null;
		...
		msdyn_type: OptionSet.msdyn_pmview.msdyn_type | null;
		...
		statecode: OptionSet.msdyn_pmview.statecode | null;
		/** Reason for the status of the PM View */
		statuscode: OptionSet.msdyn_pmview.statuscode | null;
		/** For internal use only. */
