...
(function (DevKit) {
	DevKit.MaskingRuleApi = function (e) {
		...
		const _maskingrule = {
			...
			MaskedRichTestData: { a: 'maskedrichtestdata' },
		...
		for (const field in _maskingrule) {
			const fieldConfig = _maskingrule[field];
			webApiField(maskingrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
