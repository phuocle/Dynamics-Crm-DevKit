...
declare namespace DevKit {
	export class tdsmetadataApi {
		/**
		* DynamicsCrm.DevKit tdsmetadataApi
		...
		*/
		...
		statecode: OptionSet.tdsmetadata.statecode | null;
		/** Reason for the status of the TdsMetadata */
		statuscode: OptionSet.tdsmetadata.statuscode | null;
		/** Unique identifier for entity instances */
		tdsmetadataId: string | null;
