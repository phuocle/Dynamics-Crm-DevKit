...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.flowmachineApi = function (e) {
		...
		const _flowmachine = {
			...
			HostedMachineState: { a: 'hostedmachinestate', g: 'Integer' },
			HostingType: { a: 'hostingtype', g: 'Integer' },
			ImportSequenceNumber: { a: 'importsequencenumber', g: 'Integer' },
			KeyDeliveryStatus: { a: 'keydeliverystatus', g: 'Integer' },
			KeyReceivedDate_UtcDateAndTime: { a: 'keyreceiveddate', g: 'DateTime' },
			LastHeartbeatDate_UtcDateAndTime: { a: 'lastheartbeatdate', g: 'DateTime' },
			LastKnownPictureInPictureSupport: { a: 'lastknownpictureinpicturesupport', g: 'Integer' },
			MachineMetadata: { a: 'machinemetadata' },
			ModifiedBy: { b: 'modifiedby', a: '_modifiedby_value', c: 'systemusers', d: 'systemuser', r: true },
			ModifiedOn_UtcDateAndTime: { a: 'modifiedon', r: true, g: 'DateTime' },
			ModifiedOnBehalfBy: { b: 'modifiedonbehalfby', a: '_modifiedonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			name: { a: 'name' },
			OvercapacitySince_UtcDateAndTime: { a: 'overcapacitysince', g: 'DateTime' },
			...
			SessionCapacity: { a: 'sessioncapacity', g: 'Integer' },
			SnapshotStartedAt_UtcDateAndTime: { a: 'snapshotstartedat', g: 'DateTime' },
		...
		for (const field in _flowmachine) {
			const fieldConfig = _flowmachine[field];
			webApiField(flowmachine, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
