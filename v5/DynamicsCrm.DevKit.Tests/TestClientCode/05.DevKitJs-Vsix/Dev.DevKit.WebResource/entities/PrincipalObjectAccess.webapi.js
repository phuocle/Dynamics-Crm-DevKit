...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrincipalObjectAccessApi = function (e) {
		...
		const _principalobjectaccess = {
			AccessRightsMask: { a: 'accessrightsmask', g: 'Integer' },
			ChangedOn_UtcDateOnly: { a: 'changedon', g: 'DateTime' },
			InheritedAccessRightsMask: { a: 'inheritedaccessrightsmask', g: 'Integer' },
		...
		for (const field in _principalobjectaccess) {
			const fieldConfig = _principalobjectaccess[field];
			webApiField(principalobjectaccess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
