...
(function (DevKit) {
	DevKit.TeamSyncAttributeMappingProfilesApi = function (e) {
		...
		const _teamsyncattributemappingprofiles = {
		...
		for (const field in _teamsyncattributemappingprofiles) {
			const fieldConfig = _teamsyncattributemappingprofiles[field];
			webApiField(teamsyncattributemappingprofiles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
