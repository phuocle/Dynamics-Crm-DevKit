...
(function (DevKit) {
	DevKit.cascadegrantrevokeaccessversiontrackerApi = function (e) {
		...
		const _cascadegrantrevokeaccessversiontracker = {
			...
			ParentObjectTypeCode: { a: 'parentobjecttypecode', g: 'Integer' },
		...
		for (const field in _cascadegrantrevokeaccessversiontracker) {
			const fieldConfig = _cascadegrantrevokeaccessversiontracker[field];
			webApiField(cascadegrantrevokeaccessversiontracker, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
