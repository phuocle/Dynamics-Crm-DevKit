...
(function (DevKit) {
	DevKit.AppModuleComponentApi = function (e) {
		...
		const _appmodulecomponent = {
			...
			RootComponentBehavior: { a: 'rootcomponentbehavior', g: 'Integer' },
		...
		for (const field in _appmodulecomponent) {
			const fieldConfig = _appmodulecomponent[field];
			webApiField(appmodulecomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
