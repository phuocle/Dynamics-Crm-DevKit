...
(function (DevKit) {
	DevKit.KeyVaultReferenceApi = function (e) {
		...
		const _keyvaultreference = {
			...
			IsValidated: { a: 'isvalidated', g: 'Boolean' },
			KeyName: { a: 'keyname' },
			KeyType: { a: 'keytype', g: 'Integer' },
			...
			PreAuthorizedApplicationType: { a: 'preauthorizedapplicationtype', g: 'Integer' },
		...
		for (const field in _keyvaultreference) {
			const fieldConfig = _keyvaultreference[field];
			webApiField(keyvaultreference, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
