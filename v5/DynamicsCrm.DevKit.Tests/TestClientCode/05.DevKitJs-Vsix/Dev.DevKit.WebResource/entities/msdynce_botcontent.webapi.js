...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdynce_botcontentApi = function (e) {
		...
		const _msdynce_botcontent = {
			...
			msdynce_autonumber: { a: 'msdynce_autonumber' },
			msdynce_botcontentId: { a: 'msdynce_botcontentid' },
			msdynce_botid: { a: 'msdynce_botid' },
			msdynce_state: { a: 'msdynce_state', g: 'Integer' },
		...
		for (const field in _msdynce_botcontent) {
			const fieldConfig = _msdynce_botcontent[field];
			webApiField(msdynce_botcontent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
