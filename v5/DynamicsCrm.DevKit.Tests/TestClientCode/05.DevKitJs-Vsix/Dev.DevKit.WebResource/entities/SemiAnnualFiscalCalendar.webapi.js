...
(function (DevKit) {
	DevKit.SemiAnnualFiscalCalendarApi = function (e) {
		...
		const _semiannualfiscalcalendar = {
			...
			Period1: { a: 'firsthalf', g: 'Number' },
			Period1_Base: { a: 'firsthalf_base', r: true, g: 'Number' },
			Period7: { a: 'secondhalf', g: 'Number' },
			Period7_Base: { a: 'secondhalf_base', r: true, g: 'Number' },
		...
		for (const field in _semiannualfiscalcalendar) {
			const fieldConfig = _semiannualfiscalcalendar[field];
			webApiField(semiannualfiscalcalendar, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
