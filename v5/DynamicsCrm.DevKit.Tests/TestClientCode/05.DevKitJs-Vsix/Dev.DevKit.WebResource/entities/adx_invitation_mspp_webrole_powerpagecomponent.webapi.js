...
(function (DevKit) {
	DevKit.adx_invitation_mspp_webrole_powerpagecomponentApi = function (e) {
		...
		const _adx_invitation_mspp_webrole_powerpagecomponent = {
		...
		for (const field in _adx_invitation_mspp_webrole_powerpagecomponent) {
			const fieldConfig = _adx_invitation_mspp_webrole_powerpagecomponent[field];
			webApiField(adx_invitation_mspp_webrole_powerpagecomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
