...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SubscriptionSyncEntryOutlookApi = function (e) {
		...
		const _subscriptionsyncentryoutlook = {
			ObjectId: { a: 'objectid' },
		...
		for (const field in _subscriptionsyncentryoutlook) {
			const fieldConfig = _subscriptionsyncentryoutlook[field];
			webApiField(subscriptionsyncentryoutlook, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
