...
declare namespace DevKit {
	export class msdyn_knowledgemanagementsettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_knowledgemanagementsetting.ComponentState | null;
		...
		msdyn_actionlist: Array<OptionSet.msdyn_knowledgemanagementsetting.msdyn_actionlist> | null;
		...
		msdyn_knowledgemanagementsettingId: string | null;
		msdyn_showcontextualactions: boolean | null;
		msdyn_status: OptionSet.msdyn_knowledgemanagementsetting.msdyn_status | null;
		...
		statecode: OptionSet.msdyn_knowledgemanagementsetting.statecode | null;
		/** Reason for the status of the KnowledgeManagementSetting */
		statuscode: OptionSet.msdyn_knowledgemanagementsetting.statuscode | null;
		/** For internal use only. */
