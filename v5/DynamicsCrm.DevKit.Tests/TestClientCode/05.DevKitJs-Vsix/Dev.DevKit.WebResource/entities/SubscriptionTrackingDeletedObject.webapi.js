...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SubscriptionTrackingDeletedObjectApi = function (e) {
		...
		const _subscriptiontrackingdeletedobject = {
			CrmCreatedOn_UtcDateAndTime: { a: 'crmcreatedon', g: 'DateTime' },
			DeleteTime_UtcDateAndTime: { a: 'deletetime', g: 'DateTime' },
			IsArchivalDelete: { a: 'isarchivaldelete', g: 'Boolean' },
			IsLogicalDelete: { a: 'islogicaldelete', g: 'Boolean' },
			ObjectId: { a: 'objectid', r: true },
			TimeStamp: { a: 'timestamp', r: true, g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _subscriptiontrackingdeletedobject) {
			const fieldConfig = _subscriptiontrackingdeletedobject[field];
			webApiField(subscriptiontrackingdeletedobject, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
