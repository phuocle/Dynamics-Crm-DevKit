...
declare namespace DevKit {
	export class msdyn_qnaApi {
		/**
		* DynamicsCrm.DevKit msdyn_qnaApi
		...
		*/
		...
		statecode: OptionSet.msdyn_qna.statecode | null;
		/** Reason for the status of the QnA record */
		statuscode: OptionSet.msdyn_qna.statuscode | null;
		...
		*/
		readonly FormattedValue: {
			...
			/** Chunk Id of the chunk */
			readonly msdyn_ChunkId: string;
			/** Logical Name of the source entity */
			readonly msdyn_EntityName: string;
			/** Unique identifier for entity instances */
			readonly msdyn_qnaId: string;
			/** QnA generated for the given chunk */
			readonly msdyn_QnAText: string;
			/** Question generated for the given chunk */
			readonly msdyn_Question: string;
			readonly msdyn_Rank: string;
			/** Record id of the document from which QnA was generated */
			readonly msdyn_RecordId: string;
			/** Version of the record on which the QnA was generated */
			readonly msdyn_RecordVersion: string;
			readonly msdyn_ReferenceCount: string;
