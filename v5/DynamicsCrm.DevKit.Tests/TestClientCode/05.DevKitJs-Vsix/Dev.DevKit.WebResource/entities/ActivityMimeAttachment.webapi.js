...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ActivityMimeAttachmentApi = function (e) {
		...
		const _activitymimeattachment = {
			...
			AttachmentNumber: { a: 'attachmentnumber', g: 'Integer' },
			Body: { a: 'body' },
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			FileName: { a: 'filename' },
			FileSize: { a: 'filesize', r: true, g: 'Integer' },
			IsFollowed: { a: 'isfollowed', r: true, g: 'Boolean' },
		...
		for (const field in _activitymimeattachment) {
			const fieldConfig = _activitymimeattachment[field];
			webApiField(activitymimeattachment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
