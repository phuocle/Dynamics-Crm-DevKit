...
(function (/** @type {any} */ DevKit) {
	'use strict';
	DevKit.FormGoal_Information = function(executionContext, defaultWebResourceName) {
		const form = {
			body: ["ActualDecimal", "ActualInteger", "ActualMoney", "child_goals", "ConsiderOnlyGoalOwnersRecords", "CustomRollupFieldDecimal", "CustomRollupFieldInteger", "CustomRollupFieldMoney", "FiscalPeriod", "FiscalYear", "GoalEndDate", "GoalOwnerId", "GoalStartDate", "InProgressDecimal", "InProgressInteger", "InProgressMoney", "IsFiscalPeriodGoal", "LastRolledupDate", "MetricId", "MetricId1", "notescontrol", "OwnerId", "ParentGoalId", "Percentage", "Percentage1", "Percentage2", "RollupOnlyFromChildGoals", "RollUpQueryActualDecimalId", "RollupQueryActualIntegerId", "RollUpQueryActualMoneyId", "RollUpQueryCustomDecimalId", "RollUpQueryCustomIntegerId", "RollUpQueryCustomMoneyId", "RollUpQueryInprogressDecimalId", "RollUpQueryInprogressIntegerId", "RollUpQueryInprogressMoneyId", "StretchTargetDecimal", "StretchTargetInteger", "StretchTargetMoney", "TargetDecimal", "TargetInteger", "TargetMoney", "Title"],
			bpf: [],
			dialog: [],
			grid: ["child_goals"],
			header: [],
