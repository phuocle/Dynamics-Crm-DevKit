...
var DevKit;
(function (DevKit) {
	DevKit.InvalidDependencyApi = function (e) {
		...
		const _invaliddependency = {
			ExistingComponentId: { a: 'existingcomponentid', r: true },
			ExistingComponentType: { a: 'existingcomponenttype', r: true, g: 'Integer' },
			ExistingDependencyType: { a: 'existingdependencytype', r: true, g: 'Integer' },
			InvalidDependencyId: { a: 'invaliddependencyid', r: true },
			IsExistingNodeRequiredComponent: { a: 'isexistingnoderequiredcomponent', r: true, g: 'Boolean' },
			MissingComponentId: { a: 'missingcomponentid' },
			MissingComponentInfo: { a: 'missingcomponentinfo', r: true },
			MissingComponentLookupType: { a: 'missingcomponentlookuptype', r: true, g: 'Integer' },
			MissingComponentType: { a: 'missingcomponenttype', r: true, g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		const invaliddependency = {};
		invaliddependency.ODataEntity = e;
		invaliddependency.FormattedValue = {};
		for (const field in _invaliddependency) {
			const fieldConfig = _invaliddependency[field];
			webApiField(invaliddependency, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		...
		invaliddependency.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		invaliddependency.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
