...
(function (DevKit) {
	DevKit.SubscriptionApi = function (e) {
		...
		const _subscription = {
			...
			CompletedSyncStartedOn_UtcDateOnly: { a: 'completedsyncstartedon', r: true, g: 'DateTime' },
			CompletedSyncVersionNumber: { a: 'completedsyncversionnumber', r: true, g: 'Integer' },
			LastSyncStartedOn_UtcDateOnly: { a: 'lastsyncstartedon', r: true, g: 'DateTime' },
			MachineName: { a: 'machinename' },
			ReInitialize: { a: 'reinitialize', g: 'Boolean' },
			ResetForCreate: { a: 'resetforcreate', g: 'Boolean' },
			SubscriptionId: { a: 'subscriptionid', r: true },
			SubscriptionType: { a: 'subscriptiontype', g: 'Integer' },
		...
		for (const field in _subscription) {
			const fieldConfig = _subscription[field];
			webApiField(subscription, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
