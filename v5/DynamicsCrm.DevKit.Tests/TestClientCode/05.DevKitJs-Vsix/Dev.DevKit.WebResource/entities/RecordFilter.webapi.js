...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RecordFilterApi = function (e) {
		...
		const _recordfilter = {
			...
			FetchXml: { a: 'fetchxml' },
			FilterLinkedRecords: { a: 'filterlinkedrecords', g: 'Boolean' },
			ImportSequenceNumber: { a: 'importsequencenumber', g: 'Integer' },
			IsCustomizable: { a: 'iscustomizable' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			IsRoleBusinessUnitQuery: { a: 'isrolebusinessunitquery', r: true, g: 'Boolean' },
		...
		for (const field in _recordfilter) {
			const fieldConfig = _recordfilter[field];
			webApiField(recordfilter, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
