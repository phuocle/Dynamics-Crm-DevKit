...
(function (DevKit) {
	DevKit.mspp_accesscontrolrule_publishingstateApi = function (e) {
		...
		const _mspp_accesscontrolrule_publishingstate = {
		...
		for (const field in _mspp_accesscontrolrule_publishingstate) {
			const fieldConfig = _mspp_accesscontrolrule_publishingstate[field];
			webApiField(mspp_accesscontrolrule_publishingstate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
