...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.FileAttachmentApi = function (e) {
		...
		const _fileattachment = {
			...
			IsCommitted: { a: 'iscommitted', r: true, g: 'Boolean' },
			MimeType: { a: 'mimetype' },
		...
		for (const field in _fileattachment) {
			const fieldConfig = _fileattachment[field];
			webApiField(fileattachment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
