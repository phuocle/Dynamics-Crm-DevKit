...
declare namespace DevKit {
	namespace Formbusinessprocess_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formbusinessprocess_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form businessprocess_Information */
		Body: DevKit.Formbusinessprocess_Information.Body;
	}
	export class businessprocessApi {
		/**
		* DynamicsCrm.DevKit businessprocessApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.businessprocess.ComponentState | null;
		...
		processmapstatus: OptionSet.businessprocess.processmapstatus | null;
		...
		statecode: OptionSet.businessprocess.statecode | null;
		/** Reason for the status of the Business Process */
		statuscode: OptionSet.businessprocess.statuscode | null;
		/** For internal use only. */
