...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspcat_PackageStoreApi = function (e) {
		...
		const _mspcat_packagestore = {
			...
			mspcat_IntendedDeploymentType: { a: 'mspcat_intendeddeploymenttype', g: 'Integer' },
			mspcat_Name: { a: 'mspcat_name' },
			mspcat_Operation: { a: 'mspcat_operation', g: 'Integer' },
		...
		for (const field in _mspcat_packagestore) {
			const fieldConfig = _mspcat_packagestore[field];
			webApiField(mspcat_packagestore, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
