...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ManagedPropertyApi = function (e) {
		...
		for (const field in _managedproperty) {
			const fieldConfig = _managedproperty[field];
			webApiField(managedproperty, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
