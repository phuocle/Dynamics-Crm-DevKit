...
(function (DevKit) {
	DevKit.AIPluginConversationStarterMappingApi = function (e) {
		...
		const _aipluginconversationstartermapping = {
		...
		for (const field in _aipluginconversationstartermapping) {
			const fieldConfig = _aipluginconversationstartermapping[field];
			webApiField(aipluginconversationstartermapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
