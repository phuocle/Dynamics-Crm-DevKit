...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.WorkflowWaitSubscriptionApi = function (e) {
		...
		for (const field in _workflowwaitsubscription) {
			const fieldConfig = _workflowwaitsubscription[field];
			webApiField(workflowwaitsubscription, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
