...
(function (DevKit) {
	DevKit.componentversionnrddatasourceApi = function (e) {
		...
		const _componentversionnrddatasource = {
		...
		for (const field in _componentversionnrddatasource) {
			const fieldConfig = _componentversionnrddatasource[field];
			webApiField(componentversionnrddatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
