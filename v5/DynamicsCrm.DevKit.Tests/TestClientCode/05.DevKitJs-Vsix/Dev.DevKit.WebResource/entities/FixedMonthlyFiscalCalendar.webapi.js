...
(function (DevKit) {
	DevKit.FixedMonthlyFiscalCalendarApi = function (e) {
		...
		const _fixedmonthlyfiscalcalendar = {
		...
		for (const field in _fixedmonthlyfiscalcalendar) {
			const fieldConfig = _fixedmonthlyfiscalcalendar[field];
			webApiField(fixedmonthlyfiscalcalendar, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
