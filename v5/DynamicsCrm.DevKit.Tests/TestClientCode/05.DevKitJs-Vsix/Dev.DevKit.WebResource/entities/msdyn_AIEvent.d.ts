...
declare namespace DevKit {
	...
	export class Formmsdyn_AIEvent_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_AIEventApi {
		...
		*/
		...
		msdyn_ProcessingStatus: OptionSet.msdyn_AIEvent.msdyn_ProcessingStatus | null;
		...
		statecode: OptionSet.msdyn_AIEvent.statecode | null;
		/** Reason for the status of the AI Event */
		statuscode: OptionSet.msdyn_AIEvent.statuscode | null;
