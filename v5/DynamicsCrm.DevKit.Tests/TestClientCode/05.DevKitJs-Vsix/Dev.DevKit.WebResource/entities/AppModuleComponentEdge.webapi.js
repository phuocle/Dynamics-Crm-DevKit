...
(function (DevKit) {
	DevKit.AppModuleComponentEdgeApi = function (e) {
		...
		for (const field in _appmodulecomponentedge) {
			const fieldConfig = _appmodulecomponentedge[field];
			webApiField(appmodulecomponentedge, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
