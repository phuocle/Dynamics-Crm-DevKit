...
declare namespace DevKit {
	...
	export class Formreconciliationentityinfo_Information extends DevKit.IForm {
		/**
	...
	export class reconciliationentityinfoApi {
		...
		*/
		...
		reconciliationentityinfoId: string | null;
		/** Id of the reconciliation operation. */
		ReconciliationInfoId: string | null;
		/** Status of the ReconciliationEntityInfo */
		statecode: OptionSet.reconciliationentityinfo.statecode | null;
		/** Reason for the status of the ReconciliationEntityInfo */
		statuscode: OptionSet.reconciliationentityinfo.statuscode | null;
