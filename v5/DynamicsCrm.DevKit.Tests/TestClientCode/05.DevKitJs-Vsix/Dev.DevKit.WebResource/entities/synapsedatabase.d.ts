...
declare namespace DevKit {
	export class synapsedatabaseApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.synapsedatabase.ComponentState | null;
		...
		LakehouseConnectionId: string | null;
		...
		LakehouseWorkspaceId: string | null;
		...
		statecode: OptionSet.synapsedatabase.statecode | null;
		/** Reason for the status of the Synapse Database */
		statuscode: OptionSet.synapsedatabase.statuscode | null;
		/** Azure subscription for the Synapse database */
		Subscription: string | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** Unique identifier for entity instances */
		synapsedatabaseId: string | null;
