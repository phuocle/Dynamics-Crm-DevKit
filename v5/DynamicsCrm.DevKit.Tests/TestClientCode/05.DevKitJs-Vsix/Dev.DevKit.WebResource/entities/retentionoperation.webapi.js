...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.retentionoperationApi = function (e) {
		...
		for (const field in _retentionoperation) {
			const fieldConfig = _retentionoperation[field];
			webApiField(retentionoperation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
