...
declare namespace DevKit {
	export class ColumnMappingApi {
		...
		*/
		...
		/** Unique identifier of the Column Mapping. */
		readonly ColumnMappingIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.ColumnMapping.ComponentState | null;
		...
		ProcessCode: OptionSet.ColumnMapping.ProcessCode | null;
		...
		readonly StateCode: OptionSet.ColumnMapping.StateCode | null;
		/** Reason for the status of the column mapping. */
		StatusCode: OptionSet.ColumnMapping.StatusCode | null;
		/** For internal use only. */
