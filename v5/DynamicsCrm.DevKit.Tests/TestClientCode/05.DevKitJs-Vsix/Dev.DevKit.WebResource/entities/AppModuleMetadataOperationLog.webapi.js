...
(function (DevKit) {
	DevKit.AppModuleMetadataOperationLogApi = function (e) {
		...
		const _appmodulemetadataoperationlog = {
		...
		for (const field in _appmodulemetadataoperationlog) {
			const fieldConfig = _appmodulemetadataoperationlog[field];
			webApiField(appmodulemetadataoperationlog, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
