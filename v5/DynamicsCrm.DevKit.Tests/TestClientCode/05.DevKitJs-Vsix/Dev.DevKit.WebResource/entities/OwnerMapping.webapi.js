...
(function (DevKit) {
	DevKit.OwnerMappingApi = function (e) {
		...
		for (const field in _ownermapping) {
			const fieldConfig = _ownermapping[field];
			webApiField(ownermapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
