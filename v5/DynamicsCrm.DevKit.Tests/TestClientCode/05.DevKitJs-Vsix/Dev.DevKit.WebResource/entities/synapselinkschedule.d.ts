...
declare namespace DevKit {
	export class synapselinkscheduleApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.synapselinkschedule.ComponentState | null;
		...
		/** Recurrence unit */
		RecurrenceUnit: OptionSet.synapselinkschedule.RecurrenceUnit | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Start time */
		StartTime_UtcDateAndTime: Date | null;
		/** Status of the Synapse Link Schedule */
		statecode: OptionSet.synapselinkschedule.statecode | null;
		/** Reason for the status of the Synapse Link Schedule */
		statuscode: OptionSet.synapselinkschedule.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** Unique identifier for entity instances */
		synapselinkscheduleId: string | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** Schedule type */
		Type: OptionSet.synapselinkschedule.Type | null;
		/** Unique name */
