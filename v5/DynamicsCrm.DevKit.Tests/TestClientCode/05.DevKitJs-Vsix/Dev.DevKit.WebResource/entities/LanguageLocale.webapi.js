...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.LanguageLocaleApi = function (e) {
		...
		for (const field in _languagelocale) {
			const fieldConfig = _languagelocale[field];
			webApiField(languagelocale, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
