...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SocialInsightsConfigurationApi = function (e) {
		...
		const _socialinsightsconfiguration = {
			...
			SocialDataItemType: { a: 'socialdataitemtype', g: 'Integer' },
		...
		for (const field in _socialinsightsconfiguration) {
			const fieldConfig = _socialinsightsconfiguration[field];
			webApiField(socialinsightsconfiguration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
