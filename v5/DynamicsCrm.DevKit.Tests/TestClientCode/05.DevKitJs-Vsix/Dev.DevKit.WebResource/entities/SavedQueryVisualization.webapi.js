...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SavedQueryVisualizationApi = function (e) {
		...
		const _savedqueryvisualization = {
		...
		for (const field in _savedqueryvisualization) {
			const fieldConfig = _savedqueryvisualization[field];
			webApiField(savedqueryvisualization, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
