...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SolutionHistoryDataApi = function (e) {
		...
		const _solutionhistorydata = {
			...
			IsMicrosoftPublisher: { a: 'ismicrosoftpublisher', g: 'Boolean' },
			IsOverwriteCustomizations: { a: 'isoverwritecustomizations', g: 'Boolean' },
			IsPatch: { a: 'ispatch', g: 'Boolean' },
			Operation: { a: 'operation', g: 'Integer' },
			PackageName: { a: 'packagename' },
			PackageVersion: { a: 'packageversion' },
			PublisherName: { a: 'publishername' },
			Result: { a: 'result', g: 'Integer' },
			...
			SubOperation: { a: 'suboperation', g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _solutionhistorydata) {
			const fieldConfig = _solutionhistorydata[field];
			webApiField(solutionhistorydata, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
