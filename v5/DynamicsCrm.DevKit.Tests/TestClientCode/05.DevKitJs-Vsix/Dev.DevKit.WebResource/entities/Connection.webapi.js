...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ConnectionApi = function (e) {
		...
		const _connection = {
			...
			EffectiveEnd_UtcDateOnly: { a: 'effectiveend', g: 'DateTime' },
			EffectiveStart_UtcDateOnly: { a: 'effectivestart', g: 'DateTime' },
			...
			IsMaster: { a: 'ismaster', r: true, g: 'Boolean' },
			...
			Record1ObjectTypeCode: { a: 'record1objecttypecode', r: true, g: 'Integer' },
			Record1RoleId: { b: 'record1roleid', a: '_record1roleid_value', c: 'connectionroles', d: 'connectionrole' },
			Record2ObjectTypeCode: { a: 'record2objecttypecode', r: true, g: 'Integer' },
		...
		for (const field in _connection) {
			const fieldConfig = _connection[field];
			webApiField(connection, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		connection.Entity = u;
