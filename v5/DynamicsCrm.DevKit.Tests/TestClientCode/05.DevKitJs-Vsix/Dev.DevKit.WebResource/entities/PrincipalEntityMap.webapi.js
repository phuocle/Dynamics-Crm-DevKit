...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrincipalEntityMapApi = function (e) {
		...
		for (const field in _principalentitymap) {
			const fieldConfig = _principalentitymap[field];
			webApiField(principalentitymap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
