...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.FaxApi = function (e) {
		...
		const _fax = {
			...
			NumberOfPages: { a: 'numberofpages', g: 'Integer' },
		...
		fax.ODataEntity = e;
		fax.FormattedValue = {};
		for (const field in _fax) {
			const fieldConfig = _fax[field];
			webApiField(fax, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
