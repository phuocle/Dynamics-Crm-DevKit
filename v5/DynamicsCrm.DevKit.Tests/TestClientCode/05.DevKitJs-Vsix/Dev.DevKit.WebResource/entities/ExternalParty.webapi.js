...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ExternalPartyApi = function (e) {
		...
		const _externalparty = {
			...
			LastDisabledOn_UtcDateOnly: { a: 'lastdisabledon', g: 'DateTime' },
			LastEnabledOn_UtcDateOnly: { a: 'lastenabledon', g: 'DateTime' },
			LastName: { a: 'lastname' },
		...
		const u = {};
		const externalparty = {};
		externalparty.ODataEntity = e;
		externalparty.FormattedValue = {};
		for (const field in _externalparty) {
			const fieldConfig = _externalparty[field];
			webApiField(externalparty, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		...
		externalparty.getAliasedValue = function (alias, isMultiOptionSet = false) {
