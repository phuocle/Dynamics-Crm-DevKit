...
declare namespace DevKit {
	...
	export class Formpowerpagesitepublished_Information extends DevKit.IForm {
		/**
	...
	export class powerpagesitepublishedApi {
		...
		*/
		...
		powerpagesitepublishedId: string | null;
		...
		statecode: OptionSet.powerpagesitepublished.statecode | null;
		/** Reason for the status of the Power Pages Site Published */
		statuscode: OptionSet.powerpagesitepublished.statuscode | null;
