...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_AITemplateApi = function (e) {
		...
		const _msdyn_aitemplate = {
			...
			msdyn_IsTrainable: { a: 'msdyn_istrainable', g: 'Boolean' },
		...
		for (const field in _msdyn_aitemplate) {
			const fieldConfig = _msdyn_aitemplate[field];
			webApiField(msdyn_aitemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
