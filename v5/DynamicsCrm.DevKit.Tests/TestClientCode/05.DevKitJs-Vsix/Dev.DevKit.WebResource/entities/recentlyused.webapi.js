...
(function (DevKit) {
	DevKit.recentlyusedApi = function (e) {
		...
		const _recentlyused = {
			...
			LastAccessed_UtcDateAndTime: { a: 'lastaccessed', r: true, g: 'DateTime' },
		...
		for (const field in _recentlyused) {
			const fieldConfig = _recentlyused[field];
			webApiField(recentlyused, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
