...
declare namespace DevKit {
	export class ProcessTriggerApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.ProcessTrigger.ComponentState | null;
		/** Name of the control. */
		ControlName: string | null;
		/** Type of the control to which this trigger is bound */
		ControlType: OptionSet.ProcessTrigger.ControlType | null;
		...
		PipelineStage: OptionSet.ProcessTrigger.PipelineStage | null;
		/** Shows the ID of the process. */
		ProcessId: string | null;
		/** Unique identifier of the process trigger record. */
		ProcessTriggerId: string | null;
		/** For internal use only. */
		readonly ProcessTriggerIdUnique: string | null;
		/** Scope level for PBL rules. */
		Scope: OptionSet.ProcessTrigger.Scope | null;
