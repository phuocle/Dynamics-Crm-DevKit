...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AnnotationApi = function (e) {
		...
		const _annotation = {
			...
			IsDocument: { a: 'isdocument', g: 'Boolean' },
		...
		for (const field in _annotation) {
			const fieldConfig = _annotation[field];
			webApiField(annotation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		annotation.Entity = u;
