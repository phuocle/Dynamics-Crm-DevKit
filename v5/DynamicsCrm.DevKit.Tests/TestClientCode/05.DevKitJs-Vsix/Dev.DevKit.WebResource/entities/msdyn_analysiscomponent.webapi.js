...
(function (DevKit) {
	DevKit.msdyn_analysiscomponentApi = function (e) {
		...
		const _msdyn_analysiscomponent = {
			...
			msdyn_RulePassRate: { a: 'msdyn_rulepassrate', g: 'Integer' },
		...
		for (const field in _msdyn_analysiscomponent) {
			const fieldConfig = _msdyn_analysiscomponent[field];
			webApiField(msdyn_analysiscomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
