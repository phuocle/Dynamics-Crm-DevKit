...
declare namespace DevKit {
	namespace Formflowsessionbinary_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formflowsessionbinary_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form flowsessionbinary_Information */
		Body: DevKit.Formflowsessionbinary_Information.Body;
	}
	export class flowsessionbinaryApi {
		/**
		* DynamicsCrm.DevKit flowsessionbinaryApi
		...
		*/
		...
		flowsessionbinaryId: string | null;
		...
		statecode: OptionSet.flowsessionbinary.statecode | null;
		/** Reason for the status of the Flow Session Binary */
		statuscode: OptionSet.flowsessionbinary.statuscode | null;
		...
		*/
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly flowsessionbinaryId: string;
			/** The ID associated with the flow run */
