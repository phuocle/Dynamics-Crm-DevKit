...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RibbonMetadataToProcessApi = function (e) {
		...
		const _ribbonmetadatatoprocess = {
			...
			IsDbUpdate: { a: 'isdbupdate', g: 'Integer' },
			ProcessedOn_UtcDateAndTime: { a: 'processedon', r: true, g: 'DateTime' },
		...
		for (const field in _ribbonmetadatatoprocess) {
			const fieldConfig = _ribbonmetadatatoprocess[field];
			webApiField(ribbonmetadatatoprocess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
