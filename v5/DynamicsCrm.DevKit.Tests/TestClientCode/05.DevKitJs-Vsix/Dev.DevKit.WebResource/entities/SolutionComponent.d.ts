...
declare namespace DevKit {
	export class SolutionComponentApi {
		...
		*/
		...
		readonly ComponentType: OptionSet.SolutionComponent.ComponentType | null;
		...
		readonly RootComponentBehavior: OptionSet.SolutionComponent.RootComponentBehavior | null;
		/** The parent ID of the subcomponent, which will be a root */
		readonly RootSolutionComponentId: string | null;
		/** Unique identifier of the solution component. */
		readonly SolutionComponentId: string | null;
