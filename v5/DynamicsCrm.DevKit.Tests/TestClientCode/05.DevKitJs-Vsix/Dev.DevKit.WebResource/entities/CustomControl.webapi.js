...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CustomControlApi = function (e) {
		...
		for (const field in _customcontrol) {
			const fieldConfig = _customcontrol[field];
			webApiField(customcontrol, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
