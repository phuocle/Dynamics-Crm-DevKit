...
(function (DevKit) {
	DevKit.RibbonContextGroupApi = function (e) {
		...
		for (const field in _ribboncontextgroup) {
			const fieldConfig = _ribboncontextgroup[field];
			webApiField(ribboncontextgroup, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
