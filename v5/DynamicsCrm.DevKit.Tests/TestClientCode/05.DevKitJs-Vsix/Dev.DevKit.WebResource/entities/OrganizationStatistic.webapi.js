...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.OrganizationStatisticApi = function (e) {
		...
		const _organizationstatistic = {
			Hour: { a: 'hour', r: true, g: 'Integer' },
			OrganizationStatisticId: { a: 'organizationstatisticid', r: true },
			ServerName: { a: 'servername', r: true },
			StatisticType: { a: 'statistictype', r: true, g: 'Integer' },
			StatisticValue: { a: 'statisticvalue', r: true, g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _organizationstatistic) {
			const fieldConfig = _organizationstatistic[field];
			webApiField(organizationstatistic, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
