...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RollupJobApi = function (e) {
		...
		const _rollupjob = {
			DepthProcessed: { a: 'depthprocessed', r: true, g: 'Integer' },
			PostponeUntil_UtcDateAndTime: { a: 'postponeuntil', r: true, g: 'DateTime' },
			RecordCreatedOn_UtcDateAndTime: { a: 'recordcreatedon', r: true, g: 'DateTime' },
			RetryCount: { a: 'retrycount', r: true, g: 'Integer' },
			RollupJobId2: { a: 'rollupjobid', r: true, g: 'Integer' },
			...
			SourceEntityTypeCode: { a: 'sourceentitytypecode', r: true, g: 'Integer' },
		...
		for (const field in _rollupjob) {
			const fieldConfig = _rollupjob[field];
			webApiField(rollupjob, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		rollupjob.Entity = u;
