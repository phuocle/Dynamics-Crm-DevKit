...
(function (DevKit) {
	DevKit.mspp_sitemarkerApi = function (e) {
		...
		for (const field in _mspp_sitemarker) {
			const fieldConfig = _mspp_sitemarker[field];
			webApiField(mspp_sitemarker, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
