...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CallbackRegistrationApi = function (e) {
		...
		const _callbackregistration = {
			...
			HardDelete: { a: 'harddelete', g: 'Boolean' },
			LogicAppsVersion: { a: 'logicappsversion' },
			Message: { a: 'message', g: 'Integer' },
			...
			SoftDeleteStatus: { a: 'softdeletestatus', g: 'Integer' },
			Url: { a: 'url' },
		...
		for (const field in _callbackregistration) {
			const fieldConfig = _callbackregistration[field];
			webApiField(callbackregistration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
