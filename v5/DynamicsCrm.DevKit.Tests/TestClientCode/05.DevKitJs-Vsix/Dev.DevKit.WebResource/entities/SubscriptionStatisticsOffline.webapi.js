...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SubscriptionStatisticsOfflineApi = function (e) {
		...
		const _subscriptionstatisticsoffline = {
		...
		for (const field in _subscriptionstatisticsoffline) {
			const fieldConfig = _subscriptionstatisticsoffline[field];
			webApiField(subscriptionstatisticsoffline, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
