...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.KnowledgeArticlesCategoriesApi = function (e) {
		...
		const _knowledgearticlescategories = {
		...
		for (const field in _knowledgearticlescategories) {
			const fieldConfig = _knowledgearticlescategories[field];
			webApiField(knowledgearticlescategories, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
