...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.adx_invitation_invitecontactsApi = function (e) {
		...
		const _adx_invitation_invitecontacts = {
		...
		for (const field in _adx_invitation_invitecontacts) {
			const fieldConfig = _adx_invitation_invitecontacts[field];
			webApiField(adx_invitation_invitecontacts, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
