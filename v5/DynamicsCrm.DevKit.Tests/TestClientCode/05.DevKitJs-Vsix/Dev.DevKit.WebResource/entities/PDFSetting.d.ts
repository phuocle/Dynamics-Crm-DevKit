...
declare namespace DevKit {
	...
	export class FormPDFSetting_Information extends DevKit.IForm {
		/**
	...
	export class PDFSettingApi {
		...
		*/
		...
		statecode: OptionSet.PDFSetting.statecode | null;
		/** Reason for the status of the pdfsetting */
		statuscode: OptionSet.PDFSetting.statuscode | null;
