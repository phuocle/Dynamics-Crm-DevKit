...
declare namespace DevKit {
	...
	export class Formmspp_publishingstatetransitionrule_Information extends DevKit.IForm {
		/**
	...
	export class mspp_publishingstatetransitionruleApi {
		...
		*/
		...
		/** Unique identifier for Publishing State associated with Publishing State Transition Rule. */
		mspp_fromstate_publishingstateid: string | null;
		...
		mspp_publishingstatetransitionruleId: string | null;
		/** Unique identifier for Publishing State associated with Publishing State Transition Rule. */
		mspp_tostate_publishingstateid: string | null;
		/** Unique identifier for Website associated with Publishing State Transition Rule. */
		mspp_websiteid: string | null;
		/** Status of the Publishing State Transition Rule */
		statecode: OptionSet.mspp_publishingstatetransitionrule.statecode | null;
		/** Reason for the status of the Publishing State Transition Rule */
		statuscode: OptionSet.mspp_publishingstatetransitionrule.statuscode | null;
		/**
