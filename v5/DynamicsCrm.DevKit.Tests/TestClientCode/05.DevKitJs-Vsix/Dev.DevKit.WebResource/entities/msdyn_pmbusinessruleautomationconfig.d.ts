...
declare namespace DevKit {
	namespace Formmsdyn_pmbusinessruleautomationconfig_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formmsdyn_pmbusinessruleautomationconfig_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_pmbusinessruleautomationconfig_Information */
		Body: DevKit.Formmsdyn_pmbusinessruleautomationconfig_Information.Body;
	}
	export class msdyn_pmbusinessruleautomationconfigApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_pmbusinessruleautomationconfig.ComponentState | null;
		...
		msdyn_pmbusinessruleautomationconfigId: string | null;
		...
		statecode: OptionSet.msdyn_pmbusinessruleautomationconfig.statecode | null;
		/** Reason for the status of the PM Business Rule Automation Config */
		statuscode: OptionSet.msdyn_pmbusinessruleautomationconfig.statuscode | null;
		/** For internal use only. */
