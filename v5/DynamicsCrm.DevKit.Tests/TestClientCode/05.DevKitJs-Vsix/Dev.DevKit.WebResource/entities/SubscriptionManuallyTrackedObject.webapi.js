...
(function (DevKit) {
	DevKit.SubscriptionManuallyTrackedObjectApi = function (e) {
		...
		for (const field in _subscriptionmanuallytrackedobject) {
			const fieldConfig = _subscriptionmanuallytrackedobject[field];
			webApiField(subscriptionmanuallytrackedobject, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
