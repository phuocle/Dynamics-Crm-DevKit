...
(function (DevKit) {
	DevKit.mspp_powerpagescoreentitydsApi = function (e) {
		...
		const _mspp_powerpagescoreentityds = {
		...
		for (const field in _mspp_powerpagescoreentityds) {
			const fieldConfig = _mspp_powerpagescoreentityds[field];
			webApiField(mspp_powerpagescoreentityds, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
