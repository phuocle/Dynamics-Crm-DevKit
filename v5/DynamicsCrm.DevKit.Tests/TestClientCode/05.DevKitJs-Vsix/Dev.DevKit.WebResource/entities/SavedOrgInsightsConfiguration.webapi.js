...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SavedOrgInsightsConfigurationApi = function (e) {
		...
		const _savedorginsightsconfiguration = {
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			Description: { a: 'description' },
			IsDefault: { a: 'isdefault', g: 'Boolean' },
			IsDrilldown: { a: 'isdrilldown', g: 'Boolean' },
			JsonData: { a: 'jsondata', r: true },
			JsonDataEndTime_UtcDateAndTime: { a: 'jsondataendtime', r: true, g: 'DateTime' },
			JsonDataStartTime_UtcDateAndTime: { a: 'jsondatastarttime', r: true, g: 'DateTime' },
			Lookback: { a: 'lookback', g: 'Integer' },
			MetricType: { a: 'metrictype', g: 'Integer' },
			...
			PlotOption: { a: 'plotoption', g: 'Integer' },
		...
		for (const field in _savedorginsightsconfiguration) {
			const fieldConfig = _savedorginsightsconfiguration[field];
			webApiField(savedorginsightsconfiguration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
