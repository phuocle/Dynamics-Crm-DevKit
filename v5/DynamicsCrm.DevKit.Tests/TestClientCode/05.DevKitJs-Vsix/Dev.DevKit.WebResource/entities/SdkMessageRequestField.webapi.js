...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SdkMessageRequestFieldApi = function (e) {
		...
		const _sdkmessagerequestfield = {
			...
			FieldMask: { a: 'fieldmask', r: true, g: 'Integer' },
		...
		for (const field in _sdkmessagerequestfield) {
			const fieldConfig = _sdkmessagerequestfield[field];
			webApiField(sdkmessagerequestfield, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
