...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.organizationdatasyncfnostateApi = function (e) {
		...
		const _organizationdatasyncfnostate = {
			continuefromlastdeltasync: { a: 'continuefromlastdeltasync', g: 'Boolean' },
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			currentfullsyncfetchxml: { a: 'currentfullsyncfetchxml' },
			currentfullsyncstate: { a: 'currentfullsyncstate', g: 'Integer' },
			...
			lockexpiretimestamp_UtcDateAndTime: { a: 'lockexpiretimestamp', g: 'DateTime' },
			...
			name: { a: 'name' },
			nullstatedate_UtcDateOnly: { a: 'nullstatedate', g: 'DateTime' },
			...
			pagenumber: { a: 'pagenumber', g: 'Integer' },
			...
			usepagingcookiemax: { a: 'usepagingcookiemax', g: 'Boolean' },
		...
		for (const field in _organizationdatasyncfnostate) {
			const fieldConfig = _organizationdatasyncfnostate[field];
			webApiField(organizationdatasyncfnostate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
