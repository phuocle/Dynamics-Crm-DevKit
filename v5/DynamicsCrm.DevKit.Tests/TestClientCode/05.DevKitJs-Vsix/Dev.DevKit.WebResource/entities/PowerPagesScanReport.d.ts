...
declare namespace DevKit {
	...
	export class FormPowerPagesScanReport_Information extends DevKit.IForm {
		/**
	...
	export class PowerPagesScanReportApi {
		...
		*/
		...
		PowerPagesScanReportId: string | null;
		/** Status of the PowerPagesScanReport */
		statecode: OptionSet.PowerPagesScanReport.statecode | null;
		/** Reason for the status of the PowerPagesScanReport */
		statuscode: OptionSet.PowerPagesScanReport.statuscode | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		Type: OptionSet.PowerPagesScanReport.Type | null;
