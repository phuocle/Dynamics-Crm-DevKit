...
(function (DevKit) {
	DevKit.powerfxruleApi = function (e) {
		...
		for (const field in _powerfxrule) {
			const fieldConfig = _powerfxrule[field];
			webApiField(powerfxrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
