...
(function (DevKit) {
	DevKit.mspp_columnpermissionApi = function (e) {
		...
		const _mspp_columnpermission = {
			...
			mspp_permissions: { a: 'mspp_permissions', g: 'MultiOptionSet' },
		...
		for (const field in _mspp_columnpermission) {
			const fieldConfig = _mspp_columnpermission[field];
			webApiField(mspp_columnpermission, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
