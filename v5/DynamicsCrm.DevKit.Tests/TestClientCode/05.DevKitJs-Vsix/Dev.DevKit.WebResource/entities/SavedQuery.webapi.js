...
(function (DevKit) {
	DevKit.SavedQueryApi = function (e) {
		...
		const _savedquery = {
			...
			IsCustom: { a: 'iscustom', r: true, g: 'Boolean' },
			IsCustomizable: { a: 'iscustomizable' },
			IsDefault: { a: 'isdefault', g: 'Boolean' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			IsPrivate: { a: 'isprivate', r: true, g: 'Boolean' },
			IsQuickFindQuery: { a: 'isquickfindquery', g: 'Boolean' },
			IsUserDefined: { a: 'isuserdefined', r: true, g: 'Boolean' },
			...
			OrganizationTabOrder: { a: 'organizationtaborder', r: true, g: 'Integer' },
			OverwriteTime_UtcDateOnly: { a: 'overwritetime', r: true, g: 'DateTime' },
			QueryAPI: { a: 'queryapi', r: true },
			QueryAppUsage: { a: 'queryappusage', g: 'Integer' },
			QueryType: { a: 'querytype', g: 'Integer' },
			RoleDisplayConditionsXml: { a: 'roledisplayconditionsxml' },
		...
		for (const field in _savedquery) {
			const fieldConfig = _savedquery[field];
			webApiField(savedquery, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		savedquery.Entity = u;
