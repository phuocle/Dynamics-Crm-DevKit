...
(function (DevKit) {
	DevKit.msdyn_solutionhealthruleApi = function (e) {
		...
		const _msdyn_solutionhealthrule = {
			...
			msdyn_ResolutionType: { a: 'msdyn_resolutiontype', g: 'Integer' },
		...
		for (const field in _msdyn_solutionhealthrule) {
			const fieldConfig = _msdyn_solutionhealthrule[field];
			webApiField(msdyn_solutionhealthrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
