...
(function (DevKit) {
	DevKit.BusinessUnitNewsArticleApi = function (e) {
		...
		const _businessunitnewsarticle = {
			ActiveOn_UtcDateOnly: { a: 'activeon', g: 'DateTime' },
			ActiveUntil_UtcDateOnly: { a: 'activeuntil', g: 'DateTime' },
			ArticleTitle: { a: 'articletitle' },
			ArticleTypeCode: { a: 'articletypecode', g: 'Integer' },
			...
			ShowOnHomepage: { a: 'showonhomepage', g: 'Boolean' },
		...
		for (const field in _businessunitnewsarticle) {
			const fieldConfig = _businessunitnewsarticle[field];
			webApiField(businessunitnewsarticle, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
