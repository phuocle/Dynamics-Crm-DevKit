...
(function (DevKit) {
	DevKit.msdyn_mobileappApi = function (e) {
		...
		const _msdyn_mobileapp = {
			...
			msdyn_azureBlobStorageAccountName: { a: 'msdyn_azureblobstorageaccountname' },
			msdyn_azureBlobStorageContainerName: { a: 'msdyn_azureblobstoragecontainername' },
			...
			msdyn_isAppSigningEnabled: { a: 'msdyn_isappsigningenabled' },
			...
			msdyn_storageTypeForUpload: { a: 'msdyn_storagetypeforupload' },
		...
		for (const field in _msdyn_mobileapp) {
			const fieldConfig = _msdyn_mobileapp[field];
			webApiField(msdyn_mobileapp, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
