...
(function (DevKit) {
	DevKit.UntrackedEmailApi = function (e) {
		...
		for (const field in _untrackedemail) {
			const fieldConfig = _untrackedemail[field];
			webApiField(untrackedemail, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
