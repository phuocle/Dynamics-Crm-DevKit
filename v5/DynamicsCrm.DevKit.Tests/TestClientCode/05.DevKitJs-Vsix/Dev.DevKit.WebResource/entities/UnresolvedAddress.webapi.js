...
(function (DevKit) {
	DevKit.UnresolvedAddressApi = function (e) {
		...
		for (const field in _unresolvedaddress) {
			const fieldConfig = _unresolvedaddress[field];
			webApiField(unresolvedaddress, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
