...
(function (DevKit) {
	DevKit.RecordCountSnapshotApi = function (e) {
		...
		const _recordcountsnapshot = {
			Count: { a: 'count', r: true, g: 'Integer' },
			LastUpdated_UtcDateOnly: { a: 'lastupdated', r: true, g: 'DateTime' },
			ObjectTypeCode: { a: 'objecttypecode', r: true, g: 'Integer' },
			RecordCountSnapshotId: { a: 'recordcountsnapshotid', r: true },
			VersionNumberConverted: { a: 'versionnumberconverted', r: true, g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _recordcountsnapshot) {
			const fieldConfig = _recordcountsnapshot[field];
			webApiField(recordcountsnapshot, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
