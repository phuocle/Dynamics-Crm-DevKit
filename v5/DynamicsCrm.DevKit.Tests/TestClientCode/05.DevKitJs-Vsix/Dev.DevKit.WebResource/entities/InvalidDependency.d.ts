...
declare namespace DevKit {
	export class InvalidDependencyApi {
		...
		*/
		...
		readonly ExistingComponentId: string | null;
		/** Component type of the object that has an invalid dependency */
		readonly ExistingComponentType: OptionSet.InvalidDependency.ExistingComponentType | null;
		/** The dependency type of the invalid dependency. */
		readonly ExistingDependencyType: OptionSet.InvalidDependency.ExistingDependencyType | null;
		/** Unique identifier of the invalid dependency. */
		readonly InvalidDependencyId: string | null;
		...
		readonly MissingComponentType: OptionSet.InvalidDependency.MissingComponentType | null;
		/**
