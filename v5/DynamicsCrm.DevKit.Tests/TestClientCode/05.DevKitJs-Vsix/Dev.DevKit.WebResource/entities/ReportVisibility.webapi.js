...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ReportVisibilityApi = function (e) {
		...
		const _reportvisibility = {
			...
			VisibilityCode: { a: 'visibilitycode', g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _reportvisibility) {
			const fieldConfig = _reportvisibility[field];
			webApiField(reportvisibility, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
