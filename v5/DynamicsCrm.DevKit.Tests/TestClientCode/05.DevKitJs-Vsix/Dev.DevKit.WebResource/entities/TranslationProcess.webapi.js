...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TranslationProcessApi = function (e) {
		...
		for (const field in _translationprocess) {
			const fieldConfig = _translationprocess[field];
			webApiField(translationprocess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
