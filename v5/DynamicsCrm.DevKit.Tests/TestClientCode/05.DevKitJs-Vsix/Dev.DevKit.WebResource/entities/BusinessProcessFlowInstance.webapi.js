...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.BusinessProcessFlowInstanceApi = function (e) {
		...
		const _businessprocessflowinstance = {
			ActiveStageStartedOn_UtcDateAndTime: { a: 'activestagestartedon', r: true, g: 'DateTime' },
		...
		for (const field in _businessprocessflowinstance) {
			const fieldConfig = _businessprocessflowinstance[field];
			webApiField(businessprocessflowinstance, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
