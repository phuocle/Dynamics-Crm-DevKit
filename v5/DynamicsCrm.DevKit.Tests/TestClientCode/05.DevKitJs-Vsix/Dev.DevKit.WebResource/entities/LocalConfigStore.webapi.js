...
(function (DevKit) {
	DevKit.LocalConfigStoreApi = function (e) {
		...
		const _localconfigstore = {
			AssemblyName: { a: 'assemblyname', r: true },
			Id: { a: 'id' },
			IsValueSet: { a: 'isvalueset', r: true, g: 'Boolean' },
		...
		for (const field in _localconfigstore) {
			const fieldConfig = _localconfigstore[field];
			webApiField(localconfigstore, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
