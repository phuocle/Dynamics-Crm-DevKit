...
declare namespace DevKit {
	...
	export class FormExpiredProcess extends DevKit.IForm {
		/**
	...
	export class ExpiredProcessApi {
		...
		*/
		...
		StateCode: OptionSet.ExpiredProcess.StateCode | null;
		/** Select the delve action record status. */
		StatusCode: OptionSet.ExpiredProcess.StatusCode | null;
