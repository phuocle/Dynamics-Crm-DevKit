...
(function (DevKit) {
	DevKit.UserEntityInstanceDataApi = function (e) {
		...
		const _userentityinstancedata = {
			CommonEnd_UtcDateAndTime: { a: 'commonend', g: 'DateTime' },
			CommonStart_UtcDateAndTime: { a: 'commonstart', g: 'DateTime' },
			DueDate_UtcDateAndTime: { a: 'duedate', g: 'DateTime' },
			FlagDueBy_UtcDateAndTime: { a: 'flagdueby', g: 'DateTime' },
			FlagRequest: { a: 'flagrequest' },
			FlagStatus: { a: 'flagstatus', g: 'Integer' },
			...
			ReminderSet: { a: 'reminderset', g: 'Boolean' },
			ReminderTime_UtcDateAndTime: { a: 'remindertime', g: 'DateTime' },
			StartTime_UtcDateAndTime: { a: 'starttime', g: 'DateTime' },
			ToDoItemFlags: { a: 'todoitemflags', g: 'Integer' },
			ToDoOrdinalDate_UtcDateAndTime: { a: 'todoordinaldate', g: 'DateTime' },
		...
		for (const field in _userentityinstancedata) {
			const fieldConfig = _userentityinstancedata[field];
			webApiField(userentityinstancedata, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
