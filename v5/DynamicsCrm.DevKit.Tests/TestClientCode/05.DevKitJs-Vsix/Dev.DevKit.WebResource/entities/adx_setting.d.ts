...
declare namespace DevKit {
	...
	export class Formadx_setting_Information extends DevKit.IForm {
		/**
	...
	export class adx_settingApi {
		...
		*/
		...
		statecode: OptionSet.adx_setting.statecode | null;
		/** Select the Setting's status. */
		statuscode: OptionSet.adx_setting.statuscode | null;
