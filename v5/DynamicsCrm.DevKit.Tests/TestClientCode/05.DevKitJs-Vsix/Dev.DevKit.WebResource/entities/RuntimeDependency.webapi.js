...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RuntimeDependencyApi = function (e) {
		...
		const _runtimedependency = {
			...
			DependentComponentType: { a: 'dependentcomponenttype', g: 'Integer' },
			IsPublished: { a: 'ispublished' },
			RequiredComponentModifiedTime_UtcDateAndTime: { a: 'requiredcomponentmodifiedtime', r: true, g: 'DateTime' },
		...
		for (const field in _runtimedependency) {
			const fieldConfig = _runtimedependency[field];
			webApiField(runtimedependency, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
