...
(function (DevKit) {
	DevKit.mspp_publishingstatetransitionruleApi = function (e) {
		...
		const _mspp_publishingstatetransitionrule = {
		...
		for (const field in _mspp_publishingstatetransitionrule) {
			const fieldConfig = _mspp_publishingstatetransitionrule[field];
			webApiField(mspp_publishingstatetransitionrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
