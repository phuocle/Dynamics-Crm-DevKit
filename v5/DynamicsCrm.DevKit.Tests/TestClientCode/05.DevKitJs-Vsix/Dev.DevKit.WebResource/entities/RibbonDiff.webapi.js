...
(function (DevKit) {
	DevKit.RibbonDiffApi = function (e) {
		...
		const _ribbondiff = {
			...
			DiffId: { a: 'diffid' },
			DiffType: { a: 'difftype', r: true, g: 'Integer' },
			Entity2: { a: 'entity' },
			IsAppAware: { a: 'isappaware', r: true, g: 'Boolean' },
		...
		for (const field in _ribbondiff) {
			const fieldConfig = _ribbondiff[field];
			webApiField(ribbondiff, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		ribbondiff.Entity = u;
