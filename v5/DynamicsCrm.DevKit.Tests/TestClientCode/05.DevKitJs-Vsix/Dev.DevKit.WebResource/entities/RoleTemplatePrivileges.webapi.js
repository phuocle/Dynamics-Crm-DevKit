...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RoleTemplatePrivilegesApi = function (e) {
		...
		const _roletemplateprivileges = {
			IsBasic: { a: 'isbasic', g: 'Boolean' },
			IsDeep: { a: 'isdeep', g: 'Boolean' },
			IsGlobal: { a: 'isglobal', g: 'Boolean' },
			IsLocal: { a: 'islocal', g: 'Boolean' },
		...
		for (const field in _roletemplateprivileges) {
			const fieldConfig = _roletemplateprivileges[field];
			webApiField(roletemplateprivileges, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
