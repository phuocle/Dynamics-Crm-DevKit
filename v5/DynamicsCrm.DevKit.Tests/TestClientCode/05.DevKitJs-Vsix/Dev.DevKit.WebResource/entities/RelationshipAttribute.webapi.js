...
(function (DevKit) {
	DevKit.RelationshipAttributeApi = function (e) {
		...
		for (const field in _relationshipattribute) {
			const fieldConfig = _relationshipattribute[field];
			webApiField(relationshipattribute, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
