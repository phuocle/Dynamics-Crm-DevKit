...
(function (DevKit) {
	DevKit.DependencyFeatureApi = function (e) {
		...
		for (const field in _dependencyfeature) {
			const fieldConfig = _dependencyfeature[field];
			webApiField(dependencyfeature, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
