...
(function (DevKit) {
	DevKit.MultiSelectAttributeOptionValuesApi = function (e) {
		...
		const _multiselectattributeoptionvalues = {
			MultiSelectFullTextIdKey: { a: 'multiselectfulltextidkey', r: true, g: 'Integer' },
		...
		for (const field in _multiselectattributeoptionvalues) {
			const fieldConfig = _multiselectattributeoptionvalues[field];
			webApiField(multiselectattributeoptionvalues, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
