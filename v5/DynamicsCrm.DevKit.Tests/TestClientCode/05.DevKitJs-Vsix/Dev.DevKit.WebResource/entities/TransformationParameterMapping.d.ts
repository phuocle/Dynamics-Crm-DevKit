...
declare namespace DevKit {
	export class TransformationParameterMappingApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.TransformationParameterMapping.ComponentState | null;
		...
		DataTypeCode: OptionSet.TransformationParameterMapping.DataTypeCode | null;
		...
		ParameterTypeCode: OptionSet.TransformationParameterMapping.ParameterTypeCode | null;
		...
		/** Unique identifier of the Transformation Parameter Mapping. */
		readonly TransformationParameterMappingIdUnique: string | null;
		/**
