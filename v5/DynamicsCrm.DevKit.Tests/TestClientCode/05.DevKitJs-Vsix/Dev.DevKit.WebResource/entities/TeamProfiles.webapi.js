...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TeamProfilesApi = function (e) {
		...
		for (const field in _teamprofiles) {
			const fieldConfig = _teamprofiles[field];
			webApiField(teamprofiles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
