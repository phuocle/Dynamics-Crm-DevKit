...
(function (DevKit) {
	DevKit.organizationdatasyncstateApi = function (e) {
		...
		const _organizationdatasyncstate = {
		...
		for (const field in _organizationdatasyncstate) {
			const fieldConfig = _organizationdatasyncstate[field];
			webApiField(organizationdatasyncstate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
