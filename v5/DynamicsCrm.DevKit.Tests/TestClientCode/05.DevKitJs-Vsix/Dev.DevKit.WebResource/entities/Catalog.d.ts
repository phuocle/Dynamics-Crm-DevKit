...
declare namespace DevKit {
	...
	export class FormCatalog_Information extends DevKit.IForm {
		/**
	...
	export class CatalogApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.Catalog.ComponentState | null;
		...
		statecode: OptionSet.Catalog.statecode | null;
		/** Reason for the status of the Catalog */
		statuscode: OptionSet.Catalog.statuscode | null;
		/** For internal use only. */
