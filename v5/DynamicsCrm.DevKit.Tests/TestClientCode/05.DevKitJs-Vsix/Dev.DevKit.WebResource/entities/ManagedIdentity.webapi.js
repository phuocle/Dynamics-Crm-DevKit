...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ManagedIdentityApi = function (e) {
		...
		const _managedidentity = {
			...
			CredentialSource: { a: 'credentialsource', g: 'Integer' },
			IdentityType: { a: 'identitytype', g: 'Integer' },
			...
			ManagedIdentityId: { a: 'managedidentityid' },
			...
			SubjectScope: { a: 'subjectscope', g: 'Integer' },
		...
		managedidentity.ODataEntity = e;
		managedidentity.FormattedValue = {};
		for (const field in _managedidentity) {
			const fieldConfig = _managedidentity[field];
			webApiField(managedidentity, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		managedidentity.Entity = u;
		managedidentity.EntityName = 'managedidentity';
		managedidentity.EntityCollectionName = 'managedidentities';
		managedidentity['@odata.etag'] = e?.['@odata.etag'];
		managedidentity.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		managedidentity.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
