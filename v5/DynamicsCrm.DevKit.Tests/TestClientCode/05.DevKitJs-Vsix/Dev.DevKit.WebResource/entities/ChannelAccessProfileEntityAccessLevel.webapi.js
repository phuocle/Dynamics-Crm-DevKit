...
(function (DevKit) {
	DevKit.ChannelAccessProfileEntityAccessLevelApi = function (e) {
		...
		const _channelaccessprofileentityaccesslevel = {
			...
			EntityAccessLevelDepthMask: { a: 'entityaccessleveldepthmask', g: 'Integer' },
		...
		for (const field in _channelaccessprofileentityaccesslevel) {
			const fieldConfig = _channelaccessprofileentityaccesslevel[field];
			webApiField(channelaccessprofileentityaccesslevel, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
