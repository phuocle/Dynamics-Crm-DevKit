...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.DuplicateRuleConditionApi = function (e) {
		...
		const _duplicaterulecondition = {
			...
			IgnoreBlankValues: { a: 'ignoreblankvalues', g: 'Boolean' },
			...
			OperatorCode: { a: 'operatorcode', g: 'Integer' },
			OperatorParam: { a: 'operatorparam', g: 'Integer' },
		...
		for (const field in _duplicaterulecondition) {
			const fieldConfig = _duplicaterulecondition[field];
			webApiField(duplicaterulecondition, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
