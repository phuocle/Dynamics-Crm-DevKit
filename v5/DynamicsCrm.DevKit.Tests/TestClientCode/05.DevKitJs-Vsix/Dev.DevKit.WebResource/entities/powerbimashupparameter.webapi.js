...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.powerbimashupparameterApi = function (e) {
		...
		const _powerbimashupparameter = {
			...
			IsNotRequired: { a: 'isnotrequired', g: 'Boolean' },
			...
			ParameterValueSource: { a: 'parametervaluesource', g: 'Integer' },
		...
		for (const field in _powerbimashupparameter) {
			const fieldConfig = _powerbimashupparameter[field];
			webApiField(powerbimashupparameter, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
