...
declare namespace DevKit {
	...
	export class Formmsdyn_richtextfile_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_richtextfileApi {
		...
		*/
		...
		msdyn_imageblob_Timestamp: number | null;
		msdyn_imageblob_URL: string | null;
		readonly msdyn_imageblobId: string | null;
		/** The name of the custom entity. */
		...
		statecode: OptionSet.msdyn_richtextfile.statecode | null;
		/** Reason for the status of the Rich Text Attachment */
		statuscode: OptionSet.msdyn_richtextfile.statuscode | null;
