...
(function (DevKit) {
	DevKit.QueueItemApi = function (e) {
		...
		const _queueitem = {
			...
			EnteredOn_UtcDateAndTime: { a: 'enteredon', r: true, g: 'DateTime' },
			...
			WorkerIdModifiedOn_UtcDateOnly: { a: 'workeridmodifiedon', r: true, g: 'DateTime' }
		};
		if (e === undefined) e = {};
		const u = {};
		const queueitem = {};
		...
		for (const field in _queueitem) {
			const fieldConfig = _queueitem[field];
			webApiField(queueitem, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		queueitem.Entity = u;
