...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_pmsimulationApi = function (e) {
		...
		const _msdyn_pmsimulation = {
			...
			msdyn_end_UtcDateAndTime: { a: 'msdyn_end', g: 'DateTime' },
			msdyn_generatelog: { a: 'msdyn_generatelog', g: 'Boolean' },
			...
			msdyn_start_UtcDateAndTime: { a: 'msdyn_start', g: 'DateTime' },
			msdyn_state: { a: 'msdyn_state', g: 'Integer' },
		...
		for (const field in _msdyn_pmsimulation) {
			const fieldConfig = _msdyn_pmsimulation[field];
			webApiField(msdyn_pmsimulation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
