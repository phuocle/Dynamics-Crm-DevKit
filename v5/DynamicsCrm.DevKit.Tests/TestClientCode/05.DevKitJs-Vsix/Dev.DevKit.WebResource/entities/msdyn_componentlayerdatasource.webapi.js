...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_componentlayerdatasourceApi = function (e) {
		...
		const _msdyn_componentlayerdatasource = {
		...
		for (const field in _msdyn_componentlayerdatasource) {
			const fieldConfig = _msdyn_componentlayerdatasource[field];
			webApiField(msdyn_componentlayerdatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
