...
(function (DevKit) {
	DevKit.datalakeworkspacepermissionApi = function (e) {
		...
		const _datalakeworkspacepermission = {
			appid: { a: 'appid' },
		...
		for (const field in _datalakeworkspacepermission) {
			const fieldConfig = _datalakeworkspacepermission[field];
			webApiField(datalakeworkspacepermission, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
