...
(function (DevKit) {
	DevKit.RecommendedDocumentApi = function (e) {
		...
		for (const field in _recommendeddocument) {
			const fieldConfig = _recommendeddocument[field];
			webApiField(recommendeddocument, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
