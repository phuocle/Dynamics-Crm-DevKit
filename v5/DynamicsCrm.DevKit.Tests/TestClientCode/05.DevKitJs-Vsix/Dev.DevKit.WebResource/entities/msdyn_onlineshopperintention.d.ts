...
declare namespace DevKit {
	export class msdyn_onlineshopperintentionApi {
		/**
		* DynamicsCrm.DevKit msdyn_onlineshopperintentionApi
		...
		*/
		...
		msdyn_onlineshopperintentionId: string | null;
		...
		statecode: OptionSet.msdyn_onlineshopperintention.statecode | null;
		/** Reason for the status of the Online Shopper Intention */
		statuscode: OptionSet.msdyn_onlineshopperintention.statuscode | null;
...
declare namespace OptionSet {
	namespace msdyn_onlineshopperintention {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
