...
(function (DevKit) {
	DevKit.ReplicationBacklogApi = function (e) {
		...
		const _replicationbacklog = {
			Data: { a: 'data', r: true },
			ReplicationBacklogId: { a: 'replicationbacklogid', r: true },
			ReplicationBacklogType: { a: 'replicationbacklogtype', r: true, g: 'Integer' },
		...
		for (const field in _replicationbacklog) {
			const fieldConfig = _replicationbacklog[field];
			webApiField(replicationbacklog, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
