...
(function (DevKit) {
	DevKit.adx_invitation_redeemedcontactsApi = function (e) {
		...
		const _adx_invitation_redeemedcontacts = {
		...
		for (const field in _adx_invitation_redeemedcontacts) {
			const fieldConfig = _adx_invitation_redeemedcontacts[field];
			webApiField(adx_invitation_redeemedcontacts, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
