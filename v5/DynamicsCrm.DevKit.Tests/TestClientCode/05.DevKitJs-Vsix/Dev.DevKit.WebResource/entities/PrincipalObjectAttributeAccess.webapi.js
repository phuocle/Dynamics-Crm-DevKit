...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrincipalObjectAttributeAccessApi = function (e) {
		...
		const _principalobjectattributeaccess = {
			AttributeId: { a: 'attributeid' },
			OrganizationId: { b: 'organizationid', a: '_organizationid_value', c: 'organizations', d: 'organization', r: true },
			PrincipalObjectAttributeAccessId: { a: 'principalobjectattributeaccessid' },
			ReadAccess: { a: 'readaccess', g: 'Boolean' },
			UpdateAccess: { a: 'updateaccess', g: 'Boolean' },
		...
		for (const field in _principalobjectattributeaccess) {
			const fieldConfig = _principalobjectattributeaccess[field];
			webApiField(principalobjectattributeaccess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
