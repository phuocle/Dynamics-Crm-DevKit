...
(function (DevKit) {
	DevKit.msdyn_knowledgesearchinsightApi = function (e) {
		...
		const _msdyn_knowledgesearchinsight = {
			...
			msdyn_ResponseTime: { a: 'msdyn_responsetime', g: 'Integer' },
			msdyn_ResultCount: { a: 'msdyn_resultcount', g: 'Integer' },
		...
		for (const field in _msdyn_knowledgesearchinsight) {
			const fieldConfig = _msdyn_knowledgesearchinsight[field];
			webApiField(msdyn_knowledgesearchinsight, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
