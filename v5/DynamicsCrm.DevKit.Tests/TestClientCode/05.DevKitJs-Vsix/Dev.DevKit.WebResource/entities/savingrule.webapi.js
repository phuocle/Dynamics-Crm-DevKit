...
var DevKit;
(function (DevKit) {
	DevKit.savingruleApi = function (e) {
		...
		const _savingrule = {
			...
			endedon_UtcDateAndTime: { a: 'endedon', g: 'DateTime' },
		...
		const u = {};
		const savingrule = {};
		savingrule.ODataEntity = e;
		savingrule.FormattedValue = {};
		for (const field in _savingrule) {
			const fieldConfig = _savingrule[field];
			webApiField(savingrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		savingrule.Entity = u;
		savingrule.EntityName = 'savingrule';
		savingrule.EntityCollectionName = 'savingrules';
		savingrule['@odata.etag'] = e?.['@odata.etag'];
		savingrule.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		savingrule.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
