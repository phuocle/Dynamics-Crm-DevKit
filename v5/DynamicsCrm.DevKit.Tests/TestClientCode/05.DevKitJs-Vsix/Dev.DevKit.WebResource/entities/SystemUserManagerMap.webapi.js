...
(function (DevKit) {
	DevKit.SystemUserManagerMapApi = function (e) {
		...
		const _systemusermanagermap = {
			HierarchyLevel: { a: 'hierarchylevel', r: true, g: 'Integer' },
		...
		for (const field in _systemusermanagermap) {
			const fieldConfig = _systemusermanagermap[field];
			webApiField(systemusermanagermap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
