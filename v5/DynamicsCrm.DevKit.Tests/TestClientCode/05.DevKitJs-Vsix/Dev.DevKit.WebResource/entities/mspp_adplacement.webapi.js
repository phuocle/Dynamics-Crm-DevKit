...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_adplacementApi = function (e) {
		...
		for (const field in _mspp_adplacement) {
			const fieldConfig = _mspp_adplacement[field];
			webApiField(mspp_adplacement, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
