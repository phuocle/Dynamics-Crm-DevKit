...
(function (DevKit) {
	DevKit.adx_invitationApi = function (e) {
		...
		for (const field in _adx_invitation) {
			const fieldConfig = _adx_invitation[field];
			webApiField(adx_invitation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
