...
(function (DevKit) {
	DevKit.ExchangeSyncIdMappingApi = function (e) {
		...
		const _exchangesyncidmapping = {
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			ExchangeEntryId: { a: 'exchangeentryid' },
			ExchangeSyncIdmappingId: { a: 'exchangesyncidmappingid' },
			FromCrmChangeType: { a: 'fromcrmchangetype', g: 'Integer' },
			IsDeletedInExchange: { a: 'isdeletedinexchange', g: 'Boolean' },
			IsUnlinkedInCRM: { a: 'isunlinkedincrm', g: 'Boolean' },
			...
			Retries: { a: 'retries', g: 'Integer' },
			ToCrmChangeType: { a: 'tocrmchangetype', g: 'Integer' },
			UserDecision: { a: 'userdecision', g: 'Integer' },
		...
		for (const field in _exchangesyncidmapping) {
			const fieldConfig = _exchangesyncidmapping[field];
			webApiField(exchangesyncidmapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
