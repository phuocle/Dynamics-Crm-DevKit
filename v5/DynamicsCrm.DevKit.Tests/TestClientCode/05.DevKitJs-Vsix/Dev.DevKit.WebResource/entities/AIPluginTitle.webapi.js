...
(function (DevKit) {
	DevKit.AIPluginTitleApi = function (e) {
		...
		for (const field in _aiplugintitle) {
			const fieldConfig = _aiplugintitle[field];
			webApiField(aiplugintitle, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
