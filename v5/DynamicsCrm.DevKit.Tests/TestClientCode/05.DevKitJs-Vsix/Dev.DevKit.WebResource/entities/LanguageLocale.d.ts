...
declare namespace DevKit {
	...
	export class FormLanguageLocale extends DevKit.IForm {
		/**
	...
	export class LanguageLocaleApi {
		...
		*/
		...
		/** State Code */
		statecode: OptionSet.LanguageLocale.statecode | null;
		/** Language Status Code */
		statuscode: OptionSet.LanguageLocale.statuscode | null;
