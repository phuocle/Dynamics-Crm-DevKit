...
declare namespace DevKit {
	export class purviewlabelinfoApi {
		/**
		* DynamicsCrm.DevKit purviewlabelinfoApi
		...
		*/
		...
		purviewlabelinfoId: string | null;
		/** Status of the PurviewLabelInfo */
		statecode: OptionSet.purviewlabelinfo.statecode | null;
		/** Reason for the status of the PurviewLabelInfo */
		statuscode: OptionSet.purviewlabelinfo.statuscode | null;
