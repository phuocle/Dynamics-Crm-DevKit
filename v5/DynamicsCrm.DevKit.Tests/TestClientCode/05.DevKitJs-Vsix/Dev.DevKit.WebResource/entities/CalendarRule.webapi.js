...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CalendarRuleApi = function (e) {
		...
		const _calendarrule = {
			...
			EffectiveIntervalEnd_UtcDateOnly: { a: 'effectiveintervalend', g: 'DateTime' },
			EffectiveIntervalStart_UtcDateOnly: { a: 'effectiveintervalstart', g: 'DateTime' },
			Effort: { a: 'effort', g: 'Number' },
			EndTime_UtcDateAndTime: { a: 'endtime', g: 'DateTime' },
			ExtentCode: { a: 'extentcode', g: 'Integer' },
			GroupDesignator: { a: 'groupdesignator' },
			InnerCalendarId: { b: 'innercalendarid', a: '_innercalendarid_value', c: 'calendars', d: 'calendar' },
			IsModified: { a: 'ismodified', g: 'Boolean' },
			IsSelected: { a: 'isselected', g: 'Boolean' },
			IsSimple: { a: 'issimple', g: 'Boolean' },
			IsVaried: { a: 'isvaried', g: 'Boolean' },
			ModifiedBy: { b: 'modifiedby', a: '_modifiedby_value', c: 'systemusers', d: 'systemuser', r: true },
			ModifiedOn_UtcDateAndTime: { a: 'modifiedon', r: true, g: 'DateTime' },
			ModifiedOnBehalfBy: { b: 'modifiedonbehalfby', a: '_modifiedonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			Name: { a: 'name' },
			Offset: { a: 'offset', g: 'Integer' },
			OrganizationId: { a: 'organizationid', r: true },
			Pattern: { a: 'pattern' },
			Rank: { a: 'rank', g: 'Integer' },
			StartTime_UtcDateAndTime: { a: 'starttime', g: 'DateTime' },
			SubCode: { a: 'subcode', g: 'Integer' },
			TimeCode: { a: 'timecode', g: 'Integer' },
		...
		for (const field in _calendarrule) {
			const fieldConfig = _calendarrule[field];
			webApiField(calendarrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
