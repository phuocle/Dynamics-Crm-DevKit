...
declare namespace DevKit {
	export class msdyn_dmssyncrequestApi {
		/**
		* DynamicsCrm.DevKit msdyn_dmssyncrequestApi
		...
		*/
		...
		msdyn_dmssyncrequestId: string | null;
		/** Entity mapping. */
		...
		statecode: OptionSet.msdyn_dmssyncrequest.statecode | null;
		/** Reason for the status of the DMS Sync Request */
		statuscode: OptionSet.msdyn_dmssyncrequest.statuscode | null;
		...
		*/
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_dmssyncrequestId: string;
			/** Entity mapping. */
			readonly msdyn_EntityMapping: string;
			/** Request Type */
			readonly msdyn_RequestType: string;
			/** The primary attribute for the DMS Sync Request entity. */
			readonly msdyn_RequestUniqueName: string;
			/** Sync parameters. */
			readonly msdyn_SyncParameters: string;
			/** Sync Scenario */
			readonly msdyn_SyncScenario: string;
			/** User Object Id */
...
declare namespace OptionSet {
	namespace msdyn_dmssyncrequest {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
