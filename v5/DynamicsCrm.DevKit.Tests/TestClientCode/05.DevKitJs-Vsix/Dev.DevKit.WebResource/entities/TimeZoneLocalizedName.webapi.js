...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TimeZoneLocalizedNameApi = function (e) {
		...
		const _timezonelocalizedname = {
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			CultureId: { a: 'cultureid', g: 'Integer' },
		...
		for (const field in _timezonelocalizedname) {
			const fieldConfig = _timezonelocalizedname[field];
			webApiField(timezonelocalizedname, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
