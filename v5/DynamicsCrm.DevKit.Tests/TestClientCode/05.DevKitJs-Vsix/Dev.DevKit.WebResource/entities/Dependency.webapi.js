...
(function (DevKit) {
	DevKit.DependencyApi = function (e) {
		...
		const _dependency = {
			...
			DependencyType: { a: 'dependencytype', r: true, g: 'Integer' },
			...
			DependentComponentType: { a: 'dependentcomponenttype', r: true, g: 'Integer' },
			RequiredComponentBaseSolutionId: { a: 'requiredcomponentbasesolutionid', r: true },
			RequiredComponentIntroducedVersion: { a: 'requiredcomponentintroducedversion', r: true, g: 'Number' },
			...
			RequiredComponentType: { a: 'requiredcomponenttype', r: true, g: 'Integer' },
		...
		for (const field in _dependency) {
			const fieldConfig = _dependency[field];
			webApiField(dependency, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		dependency.Entity = u;
