...
(function (DevKit) {
	DevKit.mspp_webpageaccesscontrolruleApi = function (e) {
		...
		const _mspp_webpageaccesscontrolrule = {
			...
			mspp_right: { a: 'mspp_right', g: 'Integer' },
		...
		for (const field in _mspp_webpageaccesscontrolrule) {
			const fieldConfig = _mspp_webpageaccesscontrolrule[field];
			webApiField(mspp_webpageaccesscontrolrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
