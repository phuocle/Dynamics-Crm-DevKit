...
declare namespace DevKit {
	export class msdyn_dataflow_datalakefolderApi {
		/**
		* DynamicsCrm.DevKit msdyn_dataflow_datalakefolderApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dataflow_datalakefolder.ComponentState | null;
		...
		readonly msdyn_Dataflow: string | null;
		msdyn_dataflow_datalakefolder2: string | null;
		/** Unique identifier for entity instances */
		msdyn_dataflow_datalakefolderId: string | null;
		msdyn_DatalakeFolder: string | null;
		...
		statecode: OptionSet.msdyn_dataflow_datalakefolder.statecode | null;
		/** Reason for the status of the Dataflow DatalakeFolder */
		statuscode: OptionSet.msdyn_dataflow_datalakefolder.statuscode | null;
		/** For internal use only. */
		...
		*/
		readonly FormattedValue: {
			...
			readonly originaldataflowid: string;
			/** Date and time that the record was migrated. */
...
declare namespace OptionSet {
	namespace msdyn_dataflow_datalakefolder {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
