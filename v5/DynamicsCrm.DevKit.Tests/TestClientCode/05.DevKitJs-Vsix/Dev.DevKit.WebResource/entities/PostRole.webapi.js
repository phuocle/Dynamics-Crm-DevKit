...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PostRoleApi = function (e) {
		...
		for (const field in _postrole) {
			const fieldConfig = _postrole[field];
			webApiField(postrole, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		postrole.Entity = u;
