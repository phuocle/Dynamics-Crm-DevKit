...
(function (DevKit) {
	DevKit.ColumnMappingApi = function (e) {
		...
		for (const field in _columnmapping) {
			const fieldConfig = _columnmapping[field];
			webApiField(columnmapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
