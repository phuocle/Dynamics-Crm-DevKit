...
(function (DevKit) {
	DevKit.SharedObjectsForReadApi = function (e) {
		...
		for (const field in _sharedobjectsforread) {
			const fieldConfig = _sharedobjectsforread[field];
			webApiField(sharedobjectsforread, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
