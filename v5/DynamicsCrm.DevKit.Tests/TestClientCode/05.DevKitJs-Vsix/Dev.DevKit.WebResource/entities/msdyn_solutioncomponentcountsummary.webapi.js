...
(function (DevKit) {
	DevKit.msdyn_solutioncomponentcountsummaryApi = function (e) {
		...
		const _msdyn_solutioncomponentcountsummary = {
		...
		for (const field in _msdyn_solutioncomponentcountsummary) {
			const fieldConfig = _msdyn_solutioncomponentcountsummary[field];
			webApiField(msdyn_solutioncomponentcountsummary, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
