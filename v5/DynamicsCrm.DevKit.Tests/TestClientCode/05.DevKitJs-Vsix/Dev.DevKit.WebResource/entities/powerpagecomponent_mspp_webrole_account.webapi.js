...
(function (DevKit) {
	DevKit.powerpagecomponent_mspp_webrole_accountApi = function (e) {
		...
		const _powerpagecomponent_mspp_webrole_account = {
		...
		for (const field in _powerpagecomponent_mspp_webrole_account) {
			const fieldConfig = _powerpagecomponent_mspp_webrole_account[field];
			webApiField(powerpagecomponent_mspp_webrole_account, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
