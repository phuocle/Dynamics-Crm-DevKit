...
(function (DevKit) {
	DevKit.mspp_publishingstatetransitionrule_webroleApi = function (e) {
		...
		const _mspp_publishingstatetransitionrule_webrole = {
		...
		for (const field in _mspp_publishingstatetransitionrule_webrole) {
			const fieldConfig = _mspp_publishingstatetransitionrule_webrole[field];
			webApiField(mspp_publishingstatetransitionrule_webrole, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
