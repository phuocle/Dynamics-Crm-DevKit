...
declare namespace DevKit {
	export class msdyn_modulerundetailApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_modulerundetail.ComponentState | null;
		...
		msdyn_modulerundetailId: string | null;
		...
		statecode: OptionSet.msdyn_modulerundetail.statecode | null;
		/** Reason for the status of the ModuleRunDetail */
		statuscode: OptionSet.msdyn_modulerundetail.statuscode | null;
		/** For internal use only. */
