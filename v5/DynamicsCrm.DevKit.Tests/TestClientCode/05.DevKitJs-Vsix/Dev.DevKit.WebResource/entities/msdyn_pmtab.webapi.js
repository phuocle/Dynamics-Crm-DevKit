...
var DevKit;
(function (DevKit) {
	DevKit.msdyn_pmtabApi = function (e) {
		...
		const _msdyn_pmtab = {
			...
			msdyn_order: { a: 'msdyn_order', g: 'Integer' },
			msdyn_pmtabId: { a: 'msdyn_pmtabid' },
		...
		const u = {};
		const msdyn_pmtab = {};
		msdyn_pmtab.ODataEntity = e;
		msdyn_pmtab.FormattedValue = {};
		for (const field in _msdyn_pmtab) {
			const fieldConfig = _msdyn_pmtab[field];
			webApiField(msdyn_pmtab, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		msdyn_pmtab.Entity = u;
		msdyn_pmtab.EntityName = 'msdyn_pmtab';
		msdyn_pmtab.EntityCollectionName = 'msdyn_pmtabs';
		msdyn_pmtab['@odata.etag'] = e?.['@odata.etag'];
		msdyn_pmtab.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_pmtab.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
