...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SystemApplicationMetadataApi = function (e) {
		...
		const _systemapplicationmetadata = {
		...
		for (const field in _systemapplicationmetadata) {
			const fieldConfig = _systemapplicationmetadata[field];
			webApiField(systemapplicationmetadata, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
