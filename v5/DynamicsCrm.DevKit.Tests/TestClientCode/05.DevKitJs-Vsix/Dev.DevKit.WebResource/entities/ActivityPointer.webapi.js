...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ActivityPointerApi = function (e) {
		...
		for (const field in _activitypointer) {
			const fieldConfig = _activitypointer[field];
			webApiField(activitypointer, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
