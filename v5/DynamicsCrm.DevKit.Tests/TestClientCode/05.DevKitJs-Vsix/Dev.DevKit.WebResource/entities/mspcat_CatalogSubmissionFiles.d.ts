...
declare namespace DevKit {
	...
	export class FormMain_Information_Form extends DevKit.IForm {
		/**
	...
	export class mspcat_CatalogSubmissionFilesApi {
		...
		*/
		...
		mspcat_CatalogSubmissionFilesId: string | null;
		/** File Item description */
		mspcat_Description: string | null;
		/** File asset */
		readonly mspcat_File_name: string | null;
		/** Type of File Described */
		mspcat_FileType: OptionSet.mspcat_CatalogSubmissionFiles.mspcat_FileType | null;
		/** Size of Image Described */
		mspcat_ImageSize: OptionSet.mspcat_CatalogSubmissionFiles.mspcat_ImageSize | null;
		mspcat_Name: string | null;
		/** Related Package Store Item. */
		mspcat_PackageStore: string | null;
		...
		/** Status of the Catalog Submission Files */
		statecode: OptionSet.mspcat_CatalogSubmissionFiles.statecode | null;
		/** Reason for the status of the Catalog Submission Files */
		statuscode: OptionSet.mspcat_CatalogSubmissionFiles.statuscode | null;
