...
declare namespace DevKit {
	export class ServicePlanMappingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ServicePlanMapping.ComponentState | null;
		...
		statecode: OptionSet.ServicePlanMapping.statecode | null;
		/** Reason for the status of the Service Plan Mapping */
		statuscode: OptionSet.ServicePlanMapping.statuscode | null;
		/** For internal use only. */
