...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ConnectionRoleObjectTypeCodeApi = function (e) {
		...
		const _connectionroleobjecttypecode = {
		...
		for (const field in _connectionroleobjecttypecode) {
			const fieldConfig = _connectionroleobjecttypecode[field];
			webApiField(connectionroleobjecttypecode, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
