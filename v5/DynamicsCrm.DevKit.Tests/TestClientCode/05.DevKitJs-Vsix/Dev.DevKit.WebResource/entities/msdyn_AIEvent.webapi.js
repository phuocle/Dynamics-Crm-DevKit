...
(function (DevKit) {
	DevKit.msdyn_AIEventApi = function (e) {
		...
		const _msdyn_aievent = {
			...
			msdyn_ConsumptionSource: { a: 'msdyn_consumptionsource', g: 'Integer' },
			msdyn_CreditConsumed: { a: 'msdyn_creditconsumed', g: 'Integer' },
			msdyn_DataInfo: { a: 'msdyn_datainfo' },
			msdyn_DataInfoFile_name: { a: 'msdyn_datainfofile', r: true },
			msdyn_DataType: { a: 'msdyn_datatype' },
			msdyn_EventData: { a: 'msdyn_eventdata' },
			msdyn_Name: { a: 'msdyn_name' },
			msdyn_Output: { a: 'msdyn_output' },
			msdyn_OutputFile_name: { a: 'msdyn_outputfile', r: true },
			msdyn_PartnerSource: { a: 'msdyn_partnersource' },
			msdyn_ProcessingDate_UtcDateAndTime: { a: 'msdyn_processingdate', g: 'DateTime' },
			...
			QuickTest: { a: 'msdyn_quicktest', g: 'Boolean' },
		...
		for (const field in _msdyn_aievent) {
			const fieldConfig = _msdyn_aievent[field];
			webApiField(msdyn_aievent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
