...
(function (DevKit) {
	DevKit.mainfewshotApi = function (e) {
		...
		for (const field in _mainfewshot) {
			const fieldConfig = _mainfewshot[field];
			webApiField(mainfewshot, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
