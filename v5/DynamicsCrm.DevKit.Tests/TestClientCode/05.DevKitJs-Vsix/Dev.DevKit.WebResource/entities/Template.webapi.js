...
(function (DevKit) {
	DevKit.TemplateApi = function (e) {
		...
		const _template = {
			...
			IsRecommended: { a: 'isrecommended', r: true, g: 'Boolean' },
			LanguageCode: { a: 'languagecode', g: 'Integer' },
			MimeType: { a: 'mimetype' },
			ModifiedBy: { b: 'modifiedby', a: '_modifiedby_value', c: 'systemusers', d: 'systemuser', r: true },
			ModifiedOn_UtcDateAndTime: { a: 'modifiedon', r: true, g: 'DateTime' },
			ModifiedOnBehalfBy: { b: 'modifiedonbehalfby', a: '_modifiedonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			OpenCount: { a: 'opencount', r: true, g: 'Integer' },
			OpenRate: { a: 'openrate', r: true, g: 'Integer' },
			...
			ReplyRate: { a: 'replyrate', r: true, g: 'Integer' },
			SafeHtml: { a: 'safehtml' },
			...
			Title: { a: 'title' },
			UsedCount: { a: 'usedcount', r: true, g: 'Integer' },
		...
		for (const field in _template) {
			const fieldConfig = _template[field];
			webApiField(template, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		template.Entity = u;
