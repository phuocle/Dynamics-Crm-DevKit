...
declare namespace DevKit {
	...
	export class Formflowevent_Information extends DevKit.IForm {
		/**
	...
	export class floweventApi {
		...
		*/
		...
		statecode: OptionSet.flowevent.statecode | null;
		/** Reason for the status of the Flow Event */
		statuscode: OptionSet.flowevent.statuscode | null;
