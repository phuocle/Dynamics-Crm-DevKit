...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.usermobileofflineprofilemembershipApi = function (e) {
		...
		const _usermobileofflineprofilemembership = {
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			HasMobileOfflineProfileIdConflict: { a: 'hasmobileofflineprofileidconflict', g: 'Boolean' },
		...
		for (const field in _usermobileofflineprofilemembership) {
			const fieldConfig = _usermobileofflineprofilemembership[field];
			webApiField(usermobileofflineprofilemembership, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
