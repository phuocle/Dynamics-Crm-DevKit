...
declare namespace DevKit {
	export class GovernanceConfigurationApi {
		/**
		* DynamicsCrm.DevKit GovernanceConfigurationApi
		...
		*/
		...
		GovernanceConfigurationId: string | null;
		...
		statecode: OptionSet.GovernanceConfiguration.statecode | null;
		/** Reason for the status of the Governance Configuration */
		statuscode: OptionSet.GovernanceConfiguration.statuscode | null;
		/** Tenant Guid */
...
declare namespace OptionSet {
	namespace GovernanceConfiguration {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
