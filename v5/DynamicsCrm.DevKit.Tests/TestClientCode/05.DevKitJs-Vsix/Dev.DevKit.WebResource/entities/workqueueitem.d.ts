...
declare namespace DevKit {
	namespace Formworkqueueitem_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formworkqueueitem_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form workqueueitem_Information */
		Body: DevKit.Formworkqueueitem_Information.Body;
	}
