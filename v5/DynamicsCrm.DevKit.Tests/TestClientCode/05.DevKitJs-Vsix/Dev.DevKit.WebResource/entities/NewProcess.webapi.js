...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.NewProcessApi = function (e) {
		...
		for (const field in _newprocess) {
			const fieldConfig = _newprocess[field];
			webApiField(newprocess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		newprocess.Entity = u;
