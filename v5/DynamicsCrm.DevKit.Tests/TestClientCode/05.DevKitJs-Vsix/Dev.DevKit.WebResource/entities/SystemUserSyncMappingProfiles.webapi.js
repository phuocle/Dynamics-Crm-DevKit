...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SystemUserSyncMappingProfilesApi = function (e) {
		...
		const _systemusersyncmappingprofiles = {
		...
		for (const field in _systemusersyncmappingprofiles) {
			const fieldConfig = _systemusersyncmappingprofiles[field];
			webApiField(systemusersyncmappingprofiles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
