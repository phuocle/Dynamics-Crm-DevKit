...
(function (DevKit) {
	DevKit.PostApi = function (e) {
		...
		post.ODataEntity = e;
		post.FormattedValue = {};
		for (const field in _post) {
			const fieldConfig = _post[field];
			webApiField(post, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		post.Entity = u;
