...
(function (DevKit) {
	DevKit.ImportLogApi = function (e) {
		...
		const _importlog = {
			...
			ErrorNumber: { a: 'errornumber', g: 'Integer' },
			...
			LogPhaseCode: { a: 'logphasecode', g: 'Integer' },
			...
			SequenceNumber: { a: 'sequencenumber', r: true, g: 'Integer' },
		...
		for (const field in _importlog) {
			const fieldConfig = _importlog[field];
			webApiField(importlog, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		importlog.Entity = u;
