...
(function (DevKit) {
	DevKit.KbArticleApi = function (e) {
		...
		const _kbarticle = {
			adx_averagerating: { a: 'adx_averagerating', g: 'Number' },
			adx_averagerating_int: { a: 'adx_averagerating_int', g: 'Integer' },
			adx_downvotes: { a: 'adx_downvotes', g: 'Integer' },
			adx_ratingcount: { a: 'adx_ratingcount', g: 'Integer' },
			adx_ratingsum: { a: 'adx_ratingsum', g: 'Integer' },
			adx_upvotes: { a: 'adx_upvotes', g: 'Integer' },
			...
			msa_publishtoweb: { a: 'msa_publishtoweb', g: 'Boolean' },
		...
		for (const field in _kbarticle) {
			const fieldConfig = _kbarticle[field];
			webApiField(kbarticle, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		kbarticle.Entity = u;
