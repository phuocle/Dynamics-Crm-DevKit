...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TraceRegardingApi = function (e) {
		...
		for (const field in _traceregarding) {
			const fieldConfig = _traceregarding[field];
			webApiField(traceregarding, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
