...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.componentversiondatasourceApi = function (e) {
		...
		const _componentversiondatasource = {
		...
		for (const field in _componentversiondatasource) {
			const fieldConfig = _componentversiondatasource[field];
			webApiField(componentversiondatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
