...
declare namespace DevKit {
	export class SourceControlComponentApi {
		...
		*/
		...
		Action: OptionSet.SourceControlComponent.Action | null;
		...
		SolutionComponentState: OptionSet.SourceControlComponent.SolutionComponentState | null;
		/** Unique identifier for entity instances */
		SourceControlComponentId: string | null;
		/** Unique identifier of Source Control Component Payload */
		SourceControlComponentPayloadId: string | null;
		/** Time to live in seconds. */
		TTLInSeconds: number | null;
		/** Describes a user action to resolve a conflict. */
		UserAction: OptionSet.SourceControlComponent.UserAction | null;
		/** Version Number */
