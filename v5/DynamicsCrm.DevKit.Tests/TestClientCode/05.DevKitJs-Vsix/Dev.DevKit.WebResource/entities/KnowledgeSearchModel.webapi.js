...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.KnowledgeSearchModelApi = function (e) {
		...
		const _knowledgesearchmodel = {
			...
			MaxKeyWords: { a: 'maxkeywords', g: 'Integer' },
		...
		for (const field in _knowledgesearchmodel) {
			const fieldConfig = _knowledgesearchmodel[field];
			webApiField(knowledgesearchmodel, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
