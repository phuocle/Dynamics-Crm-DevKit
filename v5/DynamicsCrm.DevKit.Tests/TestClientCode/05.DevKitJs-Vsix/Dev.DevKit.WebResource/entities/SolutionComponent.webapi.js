...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SolutionComponentApi = function (e) {
		...
		solutioncomponent.ODataEntity = e;
		solutioncomponent.FormattedValue = {};
		for (const field in _solutioncomponent) {
			const fieldConfig = _solutioncomponent[field];
			webApiField(solutioncomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		...
		solutioncomponent.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		solutioncomponent.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
