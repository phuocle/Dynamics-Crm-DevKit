...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AdvancedSimilarityRuleApi = function (e) {
		...
		const _advancedsimilarityrule = {
			...
			FilterResultByStatus: { a: 'filterresultbystatus', g: 'Integer' },
			FilterResultByStatusDisplayName: { a: 'filterresultbystatusdisplayname' },
			IsAzureMLRequired: { a: 'isazuremlrequired', g: 'Boolean' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			MaxNumberKeyphrases: { a: 'maxnumberkeyphrases', g: 'Integer' },
			ModifiedBy: { b: 'modifiedby', a: '_modifiedby_value', c: 'systemusers', d: 'systemuser', r: true },
			ModifiedOn_UtcDateAndTime: { a: 'modifiedon', r: true, g: 'DateTime' },
			ModifiedOnBehalfBy: { b: 'modifiedonbehalfby', a: '_modifiedonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			name: { a: 'name' },
			NgramSize: { a: 'ngramsize', g: 'Integer' },
		...
		for (const field in _advancedsimilarityrule) {
			const fieldConfig = _advancedsimilarityrule[field];
			webApiField(advancedsimilarityrule, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
