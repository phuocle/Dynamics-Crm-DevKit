...
(function (DevKit) {
	DevKit.retentioncleanupoperationApi = function (e) {
		...
		const _retentioncleanupoperation = {
		...
		for (const field in _retentioncleanupoperation) {
			const fieldConfig = _retentioncleanupoperation[field];
			webApiField(retentioncleanupoperation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
