...
(function (DevKit) {
	DevKit.SourceControlComponentApi = function (e) {
		...
		const _sourcecontrolcomponent = {
			Action: { a: 'action', g: 'Integer' },
			...
			IsCommitted: { a: 'iscommitted', g: 'Boolean' },
			...
			SolutionComponentState: { a: 'solutioncomponentstate', g: 'Integer' },
			...
			UserAction: { a: 'useraction', g: 'Integer' },
		...
		for (const field in _sourcecontrolcomponent) {
			const fieldConfig = _sourcecontrolcomponent[field];
			webApiField(sourcecontrolcomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
