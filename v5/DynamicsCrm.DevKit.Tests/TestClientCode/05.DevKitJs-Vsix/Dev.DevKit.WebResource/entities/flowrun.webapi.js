...
(function (DevKit) {
	DevKit.flowrunApi = function (e) {
		...
		const _flowrun = {
			CallingProductResourceId: { a: 'callingproductresourceid' },
			CallingProductRunId: { a: 'callingproductrunid' },
			CallingProductType: { a: 'callingproducttype' },
			ClientTrackingId: { a: 'clienttrackingid' },
			ConversationId: { a: 'conversationid' },
			CreatedBy: { b: 'createdby', a: '_createdby_value', c: 'systemusers', d: 'systemuser', r: true },
			CreatedOn_UtcDateAndTime: { a: 'createdon', r: true, g: 'DateTime' },
			CreatedOnBehalfBy: { b: 'createdonbehalfby', a: '_createdonbehalfby_value', c: 'systemusers', d: 'systemuser', r: true },
			DurationInMs: { a: 'duration', g: 'Integer' },
			...
			IsPrimary: { a: 'isprimary', g: 'Integer' },
		...
		for (const field in _flowrun) {
			const fieldConfig = _flowrun[field];
			webApiField(flowrun, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		flowrun.Entity = u;
