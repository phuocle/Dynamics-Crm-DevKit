...
(function (DevKit) {
	DevKit.msdyn_nonrelationaldsApi = function (e) {
		...
		for (const field in _msdyn_nonrelationalds) {
			const fieldConfig = _msdyn_nonrelationalds[field];
			webApiField(msdyn_nonrelationalds, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
