...
(function (DevKit) {
	DevKit.botcomponent_aipluginoperationApi = function (e) {
		...
		const _botcomponent_aipluginoperation = {
		...
		for (const field in _botcomponent_aipluginoperation) {
			const fieldConfig = _botcomponent_aipluginoperation[field];
			webApiField(botcomponent_aipluginoperation, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
