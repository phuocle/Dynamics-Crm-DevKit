...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.StagedSourceControlComponentApi = function (e) {
		...
		const _stagedsourcecontrolcomponent = {
			ComponentId: { a: 'componentid' },
			ComponentOperationType: { a: 'componentoperationtype', g: 'Integer' },
		...
		for (const field in _stagedsourcecontrolcomponent) {
			const fieldConfig = _stagedsourcecontrolcomponent[field];
			webApiField(stagedsourcecontrolcomponent, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
