...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.tagApi = function (e) {
		...
		tag.ODataEntity = e;
		tag.FormattedValue = {};
		for (const field in _tag) {
			const fieldConfig = _tag[field];
			webApiField(tag, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		tag.Entity = u;
		tag.EntityName = 'tag';
		tag.EntityCollectionName = 'tags';
		tag['@odata.etag'] = e?.['@odata.etag'];
		tag.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		tag.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
