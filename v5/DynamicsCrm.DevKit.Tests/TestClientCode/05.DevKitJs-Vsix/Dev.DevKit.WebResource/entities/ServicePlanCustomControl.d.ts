...
declare namespace DevKit {
	export class ServicePlanCustomControlApi {
		/**
		* DynamicsCrm.DevKit ServicePlanCustomControlApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ServicePlanCustomControl.ComponentState | null;
		...
		ServicePlanCustomControlId: string | null;
		ServicePlanId: string | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Service Plan Custom Control */
		statecode: OptionSet.ServicePlanCustomControl.statecode | null;
		/** Reason for the status of the Service Plan Custom Control */
		statuscode: OptionSet.ServicePlanCustomControl.statuscode | null;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace ServicePlanCustomControl {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
