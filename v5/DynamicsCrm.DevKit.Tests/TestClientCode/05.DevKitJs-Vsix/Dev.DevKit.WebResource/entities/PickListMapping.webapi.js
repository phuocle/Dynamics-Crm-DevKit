...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PickListMappingApi = function (e) {
		...
		const _picklistmapping = {
			...
			TargetValue: { a: 'targetvalue', g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _picklistmapping) {
			const fieldConfig = _picklistmapping[field];
			webApiField(picklistmapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
