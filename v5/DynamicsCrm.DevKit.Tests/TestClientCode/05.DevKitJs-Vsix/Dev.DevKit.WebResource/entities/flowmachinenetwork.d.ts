...
declare namespace DevKit {
	export class flowmachinenetworkApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.flowmachinenetwork.ComponentState | null;
		...
		ProvisioningState: OptionSet.flowmachinenetwork.ProvisioningState | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Flow Machine Network */
		statecode: OptionSet.flowmachinenetwork.statecode | null;
		/** Reason for the status of the Flow Machine Network */
		statuscode: OptionSet.flowmachinenetwork.statuscode | null;
		...
		SupportedScenario: OptionSet.flowmachinenetwork.SupportedScenario | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** The Flow machine network type. */
		type: OptionSet.flowmachinenetwork.type | null;
		...
		*/
		readonly FormattedValue: {
			...
			/** Internal Use Only. */
			readonly NetworkMetadata: string;
			/** Deprecated. */
