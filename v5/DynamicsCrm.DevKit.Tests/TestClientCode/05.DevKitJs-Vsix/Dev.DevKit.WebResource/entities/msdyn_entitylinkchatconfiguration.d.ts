...
declare namespace DevKit {
	...
	export class FormEntity_link_chat_configuration extends DevKit.IForm {
		/**
	...
	export class msdyn_entitylinkchatconfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_entitylinkchatconfiguration.ComponentState | null;
		...
		statecode: OptionSet.msdyn_entitylinkchatconfiguration.statecode | null;
		/** Reason for the status of the Entitylink chat configuration */
		statuscode: OptionSet.msdyn_entitylinkchatconfiguration.statuscode | null;
		/** For internal use only. */
