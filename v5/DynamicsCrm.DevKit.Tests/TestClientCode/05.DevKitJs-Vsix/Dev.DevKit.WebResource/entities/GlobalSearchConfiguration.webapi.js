...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.GlobalSearchConfigurationApi = function (e) {
		...
		const _globalsearchconfiguration = {
			...
			IsLocalized: { a: 'islocalized', g: 'Boolean' },
			IsManaged: { a: 'ismanaged', r: true, g: 'Boolean' },
			IsSearchBoxVisible: { a: 'issearchboxvisible', g: 'Boolean' },
		...
		for (const field in _globalsearchconfiguration) {
			const fieldConfig = _globalsearchconfiguration[field];
			webApiField(globalsearchconfiguration, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
