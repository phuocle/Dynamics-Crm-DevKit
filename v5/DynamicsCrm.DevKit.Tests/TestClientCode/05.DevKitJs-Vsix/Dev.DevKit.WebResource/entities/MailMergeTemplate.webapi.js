...
(function (DevKit) {
	DevKit.MailMergeTemplateApi = function (e) {
		...
		const _mailmergetemplate = {
			...
			DocumentFormat: { a: 'documentformat', g: 'Integer' },
			...
			MailMergeType: { a: 'mailmergetype', g: 'Integer' },
			MimeType: { a: 'mimetype' },
		...
		for (const field in _mailmergetemplate) {
			const fieldConfig = _mailmergetemplate[field];
			webApiField(mailmergetemplate, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
