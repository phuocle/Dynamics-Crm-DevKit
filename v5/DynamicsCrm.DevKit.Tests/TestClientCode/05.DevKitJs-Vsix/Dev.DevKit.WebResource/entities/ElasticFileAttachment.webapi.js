...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ElasticFileAttachmentApi = function (e) {
		...
		for (const field in _elasticfileattachment) {
			const fieldConfig = _elasticfileattachment[field];
			webApiField(elasticfileattachment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
