...
(function (DevKit) {
	DevKit.UserEntityUISettingsApi = function (e) {
		...
		const _userentityuisettings = {
			...
			ShowInAddressBook: { a: 'showinaddressbook', g: 'Boolean' },
		...
		for (const field in _userentityuisettings) {
			const fieldConfig = _userentityuisettings[field];
			webApiField(userentityuisettings, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
