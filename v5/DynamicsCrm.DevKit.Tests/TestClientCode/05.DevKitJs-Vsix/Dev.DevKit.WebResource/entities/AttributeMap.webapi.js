...
(function (DevKit) {
	DevKit.AttributeMapApi = function (e) {
		...
		for (const field in _attributemap) {
			const fieldConfig = _attributemap[field];
			webApiField(attributemap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
