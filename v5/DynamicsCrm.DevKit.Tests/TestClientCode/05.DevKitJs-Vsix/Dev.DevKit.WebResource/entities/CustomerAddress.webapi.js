...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CustomerAddressApi = function (e) {
		...
		for (const field in _customeraddress) {
			const fieldConfig = _customeraddress[field];
			webApiField(customeraddress, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
