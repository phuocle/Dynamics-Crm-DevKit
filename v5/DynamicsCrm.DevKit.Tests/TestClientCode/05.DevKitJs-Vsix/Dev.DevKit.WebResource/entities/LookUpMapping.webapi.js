...
(function (DevKit) {
	DevKit.LookUpMappingApi = function (e) {
		...
		const _lookupmapping = {
			...
			LookUpSourceCode: { a: 'lookupsourcecode', g: 'Integer' },
		...
		for (const field in _lookupmapping) {
			const fieldConfig = _lookupmapping[field];
			webApiField(lookupmapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
