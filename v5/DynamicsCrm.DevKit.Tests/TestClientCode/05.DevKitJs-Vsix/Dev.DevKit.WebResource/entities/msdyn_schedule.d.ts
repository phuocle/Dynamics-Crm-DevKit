...
declare namespace DevKit {
	export class msdyn_scheduleApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_schedule.ComponentState | null;
		...
		msdyn_scheduleId: string | null;
		/** (Deprecated) Schedule id reference for dataflows etc. */
		readonly msdyn_scheduleidref: string | null;
		/** Dataflow schedule refresh type */
		msdyn_schedulerefreshtype: OptionSet.msdyn_schedule.msdyn_schedulerefreshtype | null;
		...
		statecode: OptionSet.msdyn_schedule.statecode | null;
		/** Reason for the status of the Schedule */
		statuscode: OptionSet.msdyn_schedule.statuscode | null;
		/** For internal use only. */
