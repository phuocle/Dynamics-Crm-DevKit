...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AzureServiceConnectionApi = function (e) {
		...
		const _azureserviceconnection = {
			...
			LastConnectionStatusCode: { a: 'lastconnectionstatuscode', g: 'Integer' },
			LastConnectionTime_UtcDateAndTime: { a: 'lastconnectiontime', g: 'DateTime' },
		...
		for (const field in _azureserviceconnection) {
			const fieldConfig = _azureserviceconnection[field];
			webApiField(azureserviceconnection, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
