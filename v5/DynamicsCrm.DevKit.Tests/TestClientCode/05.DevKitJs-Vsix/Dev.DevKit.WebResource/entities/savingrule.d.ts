...
declare namespace DevKit {
	namespace Formsavingrule_Information {
		interface Tabs {
		}
		interface Body {
			/** Name */
	...
	export class Formsavingrule_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form savingrule_Information */
		Body: DevKit.Formsavingrule_Information.Body;
	}
	export class savingruleApi {
		/**
		* DynamicsCrm.DevKit savingruleApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.savingrule.ComponentState | null;
		...
		statecode: OptionSet.savingrule.statecode | null;
		/** Reason for the status of the SavingRule */
		statuscode: OptionSet.savingrule.statuscode | null;
		/** For internal use only. */
