...
(function (DevKit) {
	DevKit.RoleEditorLayoutApi = function (e) {
		...
		const _roleeditorlayout = {
			...
			IsPrivacyRelated: { a: 'isprivacyrelated', g: 'Boolean' },
			ItemType: { a: 'itemtype', g: 'Integer' },
		...
		for (const field in _roleeditorlayout) {
			const fieldConfig = _roleeditorlayout[field];
			webApiField(roleeditorlayout, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
