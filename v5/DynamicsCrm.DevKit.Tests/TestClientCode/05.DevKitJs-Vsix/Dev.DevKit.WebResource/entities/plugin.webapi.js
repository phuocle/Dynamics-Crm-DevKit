...
(function (DevKit) {
	DevKit.pluginApi = function (e) {
		...
		for (const field in _plugin) {
			const fieldConfig = _plugin[field];
			webApiField(plugin, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		plugin.Entity = u;
