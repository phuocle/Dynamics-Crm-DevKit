...
(function (DevKit) {
	DevKit.MetadataDifferenceApi = function (e) {
		...
		for (const field in _metadatadifference) {
			const fieldConfig = _metadatadifference[field];
			webApiField(metadatadifference, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
