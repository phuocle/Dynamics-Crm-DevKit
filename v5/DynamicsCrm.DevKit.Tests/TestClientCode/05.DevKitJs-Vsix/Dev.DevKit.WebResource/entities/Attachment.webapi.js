...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.AttachmentApi = function (e) {
		...
		for (const field in _attachment) {
			const fieldConfig = _attachment[field];
			webApiField(attachment, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		attachment.Entity = u;
