...
(function (DevKit) {
	DevKit.NavigationSettingApi = function (e) {
		...
		const _navigationsetting = {
			AdvancedSettingOrder: { a: 'advancedsettingorder', g: 'Integer' },
			...
			Privileges: { a: 'privileges', g: 'Integer' },
			ProgressState: { a: 'progressstate', g: 'Boolean' },
			QuickSettingOrder: { a: 'quicksettingorder', g: 'Integer' },
			ResourceId: { a: 'resourceid' },
			SettingType: { a: 'settingtype', g: 'Integer' },
		...
		for (const field in _navigationsetting) {
			const fieldConfig = _navigationsetting[field];
			webApiField(navigationsetting, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
