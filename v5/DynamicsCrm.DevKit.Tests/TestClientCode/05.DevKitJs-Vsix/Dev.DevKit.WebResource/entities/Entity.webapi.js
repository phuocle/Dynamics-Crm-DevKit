...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.EntityApi = function (e) {
		...
		const _entity = {
			...
			IsActivity: { a: 'isactivity', r: true, g: 'Boolean' },
		...
		for (const field in _entity) {
			const fieldConfig = _entity[field];
			webApiField(entity, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		entity.Entity = u;
