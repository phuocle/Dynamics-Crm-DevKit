...
//	"use strict";
//
//	let form: Import.Import_Information;
//
//	async function onLoad(executionContext: any): Promise<void> {
//		form = new Import.Import_Information(executionContext);
//		registerEvents();
...
const formAllInOne = (function () {
	...
	let form: Import.AllInOne;

	async function onLoad(executionContext: any): Promise<void> {
		form = new Import.AllInOne(executionContext);
		registerEvents();
		form.UiAddLoaded(UiAddLoaded);
	}
...
export { /* formImport_Information, */ formAllInOne };