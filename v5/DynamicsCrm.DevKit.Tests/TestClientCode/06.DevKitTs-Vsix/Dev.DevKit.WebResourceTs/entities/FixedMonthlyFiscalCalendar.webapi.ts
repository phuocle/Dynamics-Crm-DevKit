/**
 * FixedMonthlyFiscalCalendar.webapi.ts - FixedMonthlyFiscalCalendar WebApi for early-bound style coding
...
const FixedMonthlyFiscalCalendarFieldConfig: DevKit.IWebApiFieldConfigMap = {
...
/**
 * FixedMonthlyFiscalCalendar WebApi class for early-bound style coding
 * Usage: const fixedMonthlyFiscalCalendar = new FixedMonthlyFiscalCalendarApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class FixedMonthlyFiscalCalendarApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<IFixedMonthlyFiscalCalendarApi>(entity, 'fixedmonthlyfiscalcalendar', 'fixedmonthlyfiscalcalendars', FixedMonthlyFiscalCalendarFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface FixedMonthlyFiscalCalendarApi extends IFixedMonthlyFiscalCalendarApi { }
