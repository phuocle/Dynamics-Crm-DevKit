...
/**
 * Formatted values interface for KeyVaultReference
 * All fields return string representation of their values
 */
export interface IKeyVaultReferenceFormattedValue {
...
export interface IKeyVaultReferenceApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IKeyVaultReferenceFormattedValue;
