...
/**
 * Formatted values interface for CustomControlResource
 * All fields return string representation of their values
 */
export interface ICustomControlResourceFormattedValue {
...
export interface ICustomControlResourceApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: ICustomControlResourceFormattedValue;
