...
/**
 * Formatted values interface for mspp_webpageaccesscontrolrule
 * All fields return string representation of their values
 */
export interface Imspp_webpageaccesscontrolruleFormattedValue {
...
export interface Imspp_webpageaccesscontrolruleApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imspp_webpageaccesscontrolruleFormattedValue;
