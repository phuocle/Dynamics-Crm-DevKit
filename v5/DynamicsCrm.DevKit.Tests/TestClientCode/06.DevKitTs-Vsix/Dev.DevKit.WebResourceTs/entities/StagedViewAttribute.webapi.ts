...
/**
 * Formatted values interface for StagedViewAttribute
 * All fields return string representation of their values
 */
export interface IStagedViewAttributeFormattedValue {
...
export interface IStagedViewAttributeApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IStagedViewAttributeFormattedValue;
