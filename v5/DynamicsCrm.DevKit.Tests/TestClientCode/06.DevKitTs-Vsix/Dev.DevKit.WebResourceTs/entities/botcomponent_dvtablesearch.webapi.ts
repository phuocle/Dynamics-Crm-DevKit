...
/**
 * Formatted values interface for botcomponent_dvtablesearch
 * All fields return string representation of their values
 */
export interface Ibotcomponent_dvtablesearchFormattedValue {
...
export interface Ibotcomponent_dvtablesearchApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Ibotcomponent_dvtablesearchFormattedValue;
