...
/**
 * Formatted values interface for approvalstageorder
 * All fields return string representation of their values
 */
export interface IapprovalstageorderFormattedValue {
...
export interface IapprovalstageorderApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IapprovalstageorderFormattedValue;
	/** The linked approval */
