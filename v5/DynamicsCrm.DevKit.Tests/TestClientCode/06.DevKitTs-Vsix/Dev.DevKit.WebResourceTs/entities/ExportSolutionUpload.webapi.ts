...
/**
 * Formatted values interface for ExportSolutionUpload
 * All fields return string representation of their values
 */
export interface IExportSolutionUploadFormattedValue {
...
export interface IExportSolutionUploadApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IExportSolutionUploadFormattedValue;
