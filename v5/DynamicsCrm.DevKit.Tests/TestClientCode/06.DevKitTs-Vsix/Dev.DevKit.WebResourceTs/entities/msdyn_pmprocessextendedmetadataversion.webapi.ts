...
/**
 * Formatted values interface for msdyn_pmprocessextendedmetadataversion
 * All fields return string representation of their values
 */
export interface Imsdyn_pmprocessextendedmetadataversionFormattedValue {
...
export interface Imsdyn_pmprocessextendedmetadataversionApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_pmprocessextendedmetadataversionFormattedValue;
