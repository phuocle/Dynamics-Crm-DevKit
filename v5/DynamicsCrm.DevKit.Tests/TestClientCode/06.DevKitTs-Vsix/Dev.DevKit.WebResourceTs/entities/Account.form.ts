...
export namespace Account {
	 ...
	 * Usage: new Account.Account(executionContext)
	 */
	export class Account extends FormBase<Account.IBody, Account.IHeader, Account.IGrid, Account.INavigation, Account.IQuickForm, Account.IProcess, Account.IDialog> {
		/**
		 * Creates a Account Form instance
	...
	// ========================================================================
	// Form: Account_DevKitV4
	// ========================================================================

	export namespace Account_DevKitV4 {
	...
	/**
	 * Account_DevKitV4 Form class
	 * Provides typed access to all form controls
	 * Usage: new Account.Account_DevKitV4(executionContext)
	 */
	export class Account_DevKitV4 extends FormBase<Account_DevKitV4.IBody, Account_DevKitV4.IHeader, Account_DevKitV4.IGrid, Account_DevKitV4.INavigation, Account_DevKitV4.IQuickForm, Account_DevKitV4.IProcess, Account_DevKitV4.IDialog> {
		/**
		 * Creates a Account_DevKitV4 Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	// ========================================================================
	// Form: Account_for_Interactive_experience
	// ========================================================================

	export namespace Account_for_Interactive_experience {
	...
	/**
	 * Account_for_Interactive_experience Form class
	 * Provides typed access to all form controls
	 * Usage: new Account.Account_for_Interactive_experience(executionContext)
	 */
	export class Account_for_Interactive_experience extends FormBase<Account_for_Interactive_experience.IBody, Account_for_Interactive_experience.IHeader, Account_for_Interactive_experience.IGrid, Account_for_Interactive_experience.INavigation, Account_for_Interactive_experience.IQuickForm, Account_for_Interactive_experience.IProcess, Account_for_Interactive_experience.IDialog> {
		/**
		 * Creates a Account_for_Interactive_experience Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	export namespace Account_Information {
	...
	/**
	 * Account_Information Form class
	 * Provides typed access to all form controls
	 * Usage: new Account.Account_Information(executionContext)
	 */
	export class Account_Information extends FormBase<Account_Information.IBody, Account_Information.IHeader, Account_Information.IGrid, Account_Information.INavigation, Account_Information.IQuickForm, Account_Information.IProcess, Account_Information.IDialog> {
		/**
		 * Creates a Account_Information Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	// ========================================================================
	// Form: Account_Quick_Create
	// ========================================================================

	export namespace Account_Quick_Create {
	...
	/**
	 * Account_Quick_Create Form class
	 * Provides typed access to all form controls
	 ...
	 * Usage: new Account.AllInOne(executionContext)
	 */
	export class AllInOne extends FormBase<AllInOne.IBody, AllInOne.IHeader, AllInOne.IGrid, AllInOne.INavigation, AllInOne.IQuickForm, AllInOne.IProcess, undefined> {
		/**
		 * Creates an aggregate Account Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
