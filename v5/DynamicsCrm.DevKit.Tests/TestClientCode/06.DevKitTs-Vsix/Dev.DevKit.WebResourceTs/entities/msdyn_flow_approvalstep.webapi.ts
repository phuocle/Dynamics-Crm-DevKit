...
/**
 * Formatted values interface for msdyn_flow_approvalstep
 * All fields return string representation of their values
 */
export interface Imsdyn_flow_approvalstepFormattedValue {
	...
	readonly msdyn_flow_approvalstep_model: string;
...
export interface Imsdyn_flow_approvalstepApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_flow_approvalstepFormattedValue;
