...
/**
 * Formatted values interface for msdyn_AIBDataset
 * All fields return string representation of their values
 */
export interface Imsdyn_AIBDatasetFormattedValue {
...
export interface Imsdyn_AIBDatasetApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AIBDatasetFormattedValue;
