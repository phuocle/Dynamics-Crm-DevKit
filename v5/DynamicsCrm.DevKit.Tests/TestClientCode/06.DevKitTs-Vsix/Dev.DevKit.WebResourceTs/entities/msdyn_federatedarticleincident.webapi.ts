...
/**
 * Formatted values interface for msdyn_federatedarticleincident
 * All fields return string representation of their values
 */
export interface Imsdyn_federatedarticleincidentFormattedValue {
...
export interface Imsdyn_federatedarticleincidentApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_federatedarticleincidentFormattedValue;
