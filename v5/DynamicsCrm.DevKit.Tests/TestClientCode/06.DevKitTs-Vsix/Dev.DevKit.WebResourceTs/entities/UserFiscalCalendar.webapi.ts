...
/**
 * Formatted values interface for UserFiscalCalendar
 * All fields return string representation of their values
 */
export interface IUserFiscalCalendarFormattedValue {
...
export interface IUserFiscalCalendarApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IUserFiscalCalendarFormattedValue;
