...
/**
 * Formatted values interface for msdyn_knowledgearticletemplate
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgearticletemplateFormattedValue {
...
export interface Imsdyn_knowledgearticletemplateApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgearticletemplateFormattedValue;
