...
/**
 * Formatted values interface for BusinessProcessLinkedArtifact
 * All fields return string representation of their values
 */
export interface IBusinessProcessLinkedArtifactFormattedValue {
...
export interface IBusinessProcessLinkedArtifactApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IBusinessProcessLinkedArtifactFormattedValue;
	/** Artifact Id */
