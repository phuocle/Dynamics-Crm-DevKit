...
/**
 * Formatted values interface for OrganizationSetting
 * All fields return string representation of their values
 */
export interface IOrganizationSettingFormattedValue {
...
export interface IOrganizationSettingApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IOrganizationSettingFormattedValue;
