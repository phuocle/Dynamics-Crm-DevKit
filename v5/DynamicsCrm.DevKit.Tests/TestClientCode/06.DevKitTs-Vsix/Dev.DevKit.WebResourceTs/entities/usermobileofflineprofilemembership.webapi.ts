...
/**
 * Formatted values interface for usermobileofflineprofilemembership
 * All fields return string representation of their values
 */
export interface IusermobileofflineprofilemembershipFormattedValue {
	readonly CreatedBy: string;
	readonly CreatedOn_UtcDateAndTime: string;
	readonly CreatedOnBehalfBy: string;
	readonly HasMobileOfflineProfileIdConflict: string;
	...
	readonly usermobileofflineprofilemembershipId: string;
...
export interface IusermobileofflineprofilemembershipApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IusermobileofflineprofilemembershipFormattedValue;
