...
/**
 * Formatted values interface for MetadataForArchival
 * All fields return string representation of their values
 */
export interface IMetadataForArchivalFormattedValue {
...
export interface IMetadataForArchivalApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IMetadataForArchivalFormattedValue;
