...
/**
 * Formatted values interface for msdyn_AIBFeedbackLoop
 * All fields return string representation of their values
 */
export interface Imsdyn_AIBFeedbackLoopFormattedValue {
...
export interface Imsdyn_AIBFeedbackLoopApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AIBFeedbackLoopFormattedValue;
