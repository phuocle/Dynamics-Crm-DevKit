...
export namespace Contact {
	 ...
	 * Usage: new Contact.Contact(executionContext)
	 */
	export class Contact extends FormBase<Contact.IBody, Contact.IHeader, Contact.IGrid, Contact.INavigation, Contact.IQuickForm, Contact.IProcess, Contact.IDialog> {
		/**
		 * Creates a Contact Form instance
	...
	export namespace Contact_Information {
	...
	/**
	 * Contact_Information Form class
	 * Provides typed access to all form controls
	 * Usage: new Contact.Contact_Information(executionContext)
	 */
	export class Contact_Information extends FormBase<Contact_Information.IBody, Contact_Information.IHeader, Contact_Information.IGrid, Contact_Information.INavigation, Contact_Information.IQuickForm, Contact_Information.IProcess, Contact_Information.IDialog> {
		/**
		 * Creates a Contact_Information Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
			super(executionContext, defaultWebResourceName, {
				body: ['AccountRoleCode', 'Address1_AddressTypeCode', 'Address1_City', 'Address1_Country', 'Address1_FreightTermsCode', 'Address1_Line1', 'Address1_Line2', 'Address1_Line3', 'Address1_Name', 'Address1_PostalCode', 'Address1_ShippingMethodCode', 'Address1_StateOrProvince', 'Address1_Telephone1', 'Anniversary', 'AssistantName', 'AssistantPhone', 'BirthDate', 'CreditLimit', 'CreditOnHold', 'Department', 'Description', 'DoNotBulkEMail', 'DoNotEMail', 'DoNotFax', 'DoNotPhone', 'DoNotPostalMail', 'EMailAddress1', 'FamilyStatusCode', 'Fax', 'FirstName', 'GenderCode', 'JobTitle', 'LastName', 'ManagerName', 'ManagerPhone', 'MiddleName', 'MobilePhone', 'notescontrol', 'OwnerId', 'ParentCustomerId', 'PaymentTermsCode', 'PreferredContactMethodCode', 'Salutation', 'SpousesName', 'Telephone1', 'Telephone2', 'TransactionCurrencyId'],
	...
	// ========================================================================
	// Form: Invite_Web_Form
	// ========================================================================

	export namespace Invite_Web_Form {
	...
	/**
	 * Invite_Web_Form Form class
	 * Provides typed access to all form controls
	 * Usage: new Contact.Invite_Web_Form(executionContext)
	 */
	export class Invite_Web_Form extends FormBase<Invite_Web_Form.IBody, Invite_Web_Form.IHeader, Invite_Web_Form.IGrid, Invite_Web_Form.INavigation, Invite_Web_Form.IQuickForm, Invite_Web_Form.IProcess, Invite_Web_Form.IDialog> {
		/**
		 * Creates a Invite_Web_Form Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	// ========================================================================
	// Form: Portal_Contact_Enhanced
	// ========================================================================

	export namespace Portal_Contact_Enhanced {
	...
	/**
	 * Portal_Contact_Enhanced Form class
	 * Provides typed access to all form controls
	 * Usage: new Contact.Portal_Contact_Enhanced(executionContext)
	 */
	export class Portal_Contact_Enhanced extends FormBase<Portal_Contact_Enhanced.IBody, Portal_Contact_Enhanced.IHeader, Portal_Contact_Enhanced.IGrid, Portal_Contact_Enhanced.INavigation, Portal_Contact_Enhanced.IQuickForm, Portal_Contact_Enhanced.IProcess, Portal_Contact_Enhanced.IDialog> {
		/**
		 * Creates a Portal_Contact_Enhanced Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
			super(executionContext, defaultWebResourceName, {
				body: ['AccountRoleCode', 'Address1_AddressTypeCode', 'Address1_City', 'Address1_Country', 'Address1_FreightTermsCode', 'Address1_Line1', 'Address1_Line2', 'Address1_Line3', 'Address1_Name', 'Address1_PostalCode', 'Address1_ShippingMethodCode', 'Address1_StateOrProvince', 'Address1_Telephone1', 'adx_identity_accessfailedcount', 'adx_identity_emailaddress1confirmed', 'adx_identity_locallogindisabled', 'adx_identity_lockoutenabled', 'adx_identity_lockoutenddate', 'adx_identity_logonenabled', 'adx_identity_mobilephoneconfirmed', 'adx_identity_securitystamp', 'adx_identity_twofactorenabled', 'adx_identity_username', 'Adx_TimeZone', 'Anniversary', 'AssistantName', 'AssistantPhone', 'BirthDate', 'CreditLimit', 'CreditOnHold', 'Department', 'Description', 'DoNotBulkEMail', 'DoNotEMail', 'DoNotFax', 'DoNotPhone', 'DoNotPostalMail', 'EMailAddress1', 'FamilyStatusCode', 'Fax', 'FirstName', 'GenderCode', 'JobTitle', 'LastName', 'ManagerName', 'ManagerPhone', 'MiddleName', 'MobilePhone', 'notescontrol', 'OwnerId', 'ParentCustomerId', 'PaymentTermsCode', 'PreferredContactMethodCode', 'Salutation', 'SpousesName', 'Telephone1', 'Telephone2', 'TransactionCurrencyId'],
				header: ['EMailAddress1', 'OwnerId', 'PreferredContactMethodCode'],
	...
	// ========================================================================
	// Form: Profile_Web_Form_Enhanced
	// ========================================================================

	export namespace Profile_Web_Form_Enhanced {
	...
	/**
	 * Profile_Web_Form_Enhanced Form class
	 * Provides typed access to all form controls
	 * Usage: new Contact.Profile_Web_Form_Enhanced(executionContext)
	 */
	export class Profile_Web_Form_Enhanced extends FormBase<Profile_Web_Form_Enhanced.IBody, Profile_Web_Form_Enhanced.IHeader, Profile_Web_Form_Enhanced.IGrid, Profile_Web_Form_Enhanced.INavigation, Profile_Web_Form_Enhanced.IQuickForm, Profile_Web_Form_Enhanced.IProcess, Profile_Web_Form_Enhanced.IDialog> {
		/**
		 * Creates a Profile_Web_Form_Enhanced Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	// ========================================================================
	// Form: Profile_Web_Form_Enhanced_Japanese
	// ========================================================================

	export namespace Profile_Web_Form_Enhanced_Japanese {
	...
	/**
	 * Profile_Web_Form_Enhanced_Japanese Form class
	 * Provides typed access to all form controls
	 * Usage: new Contact.Profile_Web_Form_Enhanced_Japanese(executionContext)
	 */
	export class Profile_Web_Form_Enhanced_Japanese extends FormBase<Profile_Web_Form_Enhanced_Japanese.IBody, Profile_Web_Form_Enhanced_Japanese.IHeader, Profile_Web_Form_Enhanced_Japanese.IGrid, Profile_Web_Form_Enhanced_Japanese.INavigation, Profile_Web_Form_Enhanced_Japanese.IQuickForm, Profile_Web_Form_Enhanced_Japanese.IProcess, Profile_Web_Form_Enhanced_Japanese.IDialog> {
		/**
		 * Creates a Profile_Web_Form_Enhanced_Japanese Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
	...
	// ========================================================================
	// Form: Contact_Quick_Create
	// ========================================================================

	export namespace Contact_Quick_Create {
	...
	/**
	 * Contact_Quick_Create Form class
	 * Provides typed access to all form controls
	 ...
	 * Usage: new Contact.AllInOne(executionContext)
	 */
	export class AllInOne extends FormBase<AllInOne.IBody, AllInOne.IHeader, AllInOne.IGrid, AllInOne.INavigation, AllInOne.IQuickForm, AllInOne.IProcess, undefined> {
		/**
		 * Creates an aggregate Contact Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
