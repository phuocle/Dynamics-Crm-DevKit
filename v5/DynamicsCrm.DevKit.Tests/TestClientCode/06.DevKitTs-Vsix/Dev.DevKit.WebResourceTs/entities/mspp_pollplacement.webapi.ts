...
/**
 * Formatted values interface for mspp_pollplacement
 * All fields return string representation of their values
 */
export interface Imspp_pollplacementFormattedValue {
...
export interface Imspp_pollplacementApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imspp_pollplacementFormattedValue;
