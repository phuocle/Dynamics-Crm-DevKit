/**
 * fxexpression.webapi.ts - fxexpression WebApi for early-bound style coding
...
const fxexpressionFieldConfig: DevKit.IWebApiFieldConfigMap = {
	...
	fxexpressionId: { logicalName: 'fxexpressionid' },
...
/**
 * fxexpression WebApi class for early-bound style coding
 * Usage: const fxexpression = new fxexpressionApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class fxexpressionApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<IfxexpressionApi>(entity, 'fxexpression', 'fxexpressions', fxexpressionFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface fxexpressionApi extends IfxexpressionApi { }
