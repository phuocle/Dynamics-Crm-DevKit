...
/**
 * Formatted values interface for msdyn_pmprocesstemplate
 * All fields return string representation of their values
 */
export interface Imsdyn_pmprocesstemplateFormattedValue {
...
export interface Imsdyn_pmprocesstemplateApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_pmprocesstemplateFormattedValue;
