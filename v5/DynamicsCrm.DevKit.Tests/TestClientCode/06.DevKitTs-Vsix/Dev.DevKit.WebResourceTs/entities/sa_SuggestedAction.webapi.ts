...
/**
 * Formatted values interface for sa_SuggestedAction
 * All fields return string representation of their values
 */
export interface Isa_SuggestedActionFormattedValue {
...
export interface Isa_SuggestedActionApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Isa_SuggestedActionFormattedValue;
