...
/**
 * Formatted values interface for msdyn_AIOptimizationPrivateData
 * All fields return string representation of their values
 */
export interface Imsdyn_AIOptimizationPrivateDataFormattedValue {
...
export interface Imsdyn_AIOptimizationPrivateDataApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AIOptimizationPrivateDataFormattedValue;
