...
/**
 * Formatted values interface for msdyn_appinsightsmetadata
 * All fields return string representation of their values
 */
export interface Imsdyn_appinsightsmetadataFormattedValue {
...
export interface Imsdyn_appinsightsmetadataApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_appinsightsmetadataFormattedValue;
