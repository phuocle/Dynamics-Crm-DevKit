...
/**
 * Formatted values interface for msdyn_dmsrequeststatus
 * All fields return string representation of their values
 */
export interface Imsdyn_dmsrequeststatusFormattedValue {
...
export interface Imsdyn_dmsrequeststatusApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_dmsrequeststatusFormattedValue;
