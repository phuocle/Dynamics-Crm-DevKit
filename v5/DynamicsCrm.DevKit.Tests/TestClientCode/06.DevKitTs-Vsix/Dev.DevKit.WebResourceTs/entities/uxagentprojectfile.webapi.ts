...
/**
 * Formatted values interface for uxagentprojectfile
 * All fields return string representation of their values
 */
export interface IuxagentprojectfileFormattedValue {
...
export interface IuxagentprojectfileApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IuxagentprojectfileFormattedValue;
