...
/**
 * Formatted values interface for msdyn_AIOdTrainingImage
 * All fields return string representation of their values
 */
export interface Imsdyn_AIOdTrainingImageFormattedValue {
...
export interface Imsdyn_AIOdTrainingImageApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AIOdTrainingImageFormattedValue;
