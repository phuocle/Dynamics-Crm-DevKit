...
/**
 * Formatted values interface for msdyn_knowledgeconfiguration
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgeconfigurationFormattedValue {
...
export interface Imsdyn_knowledgeconfigurationApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgeconfigurationFormattedValue;
