...
/**
 * Formatted values interface for msdyn_knowledgeinteractioninsight
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgeinteractioninsightFormattedValue {
...
export interface Imsdyn_knowledgeinteractioninsightApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgeinteractioninsightFormattedValue;
