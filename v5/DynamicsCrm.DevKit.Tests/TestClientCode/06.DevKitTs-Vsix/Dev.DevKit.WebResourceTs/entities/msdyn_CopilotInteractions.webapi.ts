...
/**
 * Formatted values interface for msdyn_CopilotInteractions
 * All fields return string representation of their values
 */
export interface Imsdyn_CopilotInteractionsFormattedValue {
...
export interface Imsdyn_CopilotInteractionsApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_CopilotInteractionsFormattedValue;
