...
/**
 * Formatted values interface for EnvironmentVariableValue
 * All fields return string representation of their values
 */
export interface IEnvironmentVariableValueFormattedValue {
...
export interface IEnvironmentVariableValueApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IEnvironmentVariableValueFormattedValue;
