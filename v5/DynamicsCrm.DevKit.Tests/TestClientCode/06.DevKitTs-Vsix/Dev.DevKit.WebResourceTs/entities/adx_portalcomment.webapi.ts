/**
 * adx_portalcomment.webapi.ts - adx_portalcomment WebApi for early-bound style coding
...
/**
 * Formatted values interface for adx_portalcomment
 * All fields return string representation of their values
 */
export interface Iadx_portalcommentFormattedValue {
...
/**
 * adx_portalcomment WebApi entity interface
 * Provides IntelliSense for early-bound style coding
 */
export interface Iadx_portalcommentApi extends DevKit.IWebApiEntity {
	/** Formatted values for all fields */
	readonly FormattedValue: Iadx_portalcommentFormattedValue;
	...
	adx_PortalCommentDirectionCode: number | null;
...
const adx_portalcommentFieldConfig: DevKit.IWebApiFieldConfigMap = {
	...
	adx_PortalCommentDirectionCode: { logicalName: 'adx_portalcommentdirectioncode', type: 'Integer' },
...
/**
 * adx_portalcomment WebApi class for early-bound style coding
 * Usage: const adx_portalcomment = new adx_portalcommentApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class adx_portalcommentApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<Iadx_portalcommentApi>(entity, 'adx_portalcomment', 'adx_portalcomments', adx_portalcommentFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface adx_portalcommentApi extends Iadx_portalcommentApi { }
