/**
 * CustomAPIRequestParameter.webapi.ts - CustomAPIRequestParameter WebApi for early-bound style coding
...
/**
 * CustomAPIRequestParameter WebApi entity interface
 * Provides IntelliSense for early-bound style coding
 */
export interface ICustomAPIRequestParameterApi extends DevKit.IWebApiEntity {
	/** Formatted values for all fields - auto-mapped to readonly string */
	readonly FormattedValue: { readonly [K in keyof Omit<ICustomAPIRequestParameterApi, 'FormattedValue'>]: string };
	...
	CustomAPIRequestParameterId: DevKit.Guid | null;
...
const CustomAPIRequestParameterFieldConfig: DevKit.IWebApiFieldConfigMap = {
	...
	CustomAPIRequestParameterId: { logicalName: 'customapirequestparameterid' },
	Description: { logicalName: 'description' },
	DisplayName: { logicalName: 'displayname' },
	ImportSequenceNumber: { logicalName: 'importsequencenumber', type: 'Integer' },
	IsCustomizable: { logicalName: 'iscustomizable' },
	IsManaged: { logicalName: 'ismanaged', readOnly: true, type: 'Boolean' },
	IsOptional: { logicalName: 'isoptional', type: 'Boolean' },
	LogicalEntityName: { logicalName: 'logicalentityname' },
...
/**
 * CustomAPIRequestParameter WebApi class for early-bound style coding
 * Usage: const customAPIRequestParameter = new CustomAPIRequestParameterApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class CustomAPIRequestParameterApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<ICustomAPIRequestParameterApi>(entity, 'customapirequestparameter', 'customapirequestparameters', CustomAPIRequestParameterFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface CustomAPIRequestParameterApi extends ICustomAPIRequestParameterApi { }
