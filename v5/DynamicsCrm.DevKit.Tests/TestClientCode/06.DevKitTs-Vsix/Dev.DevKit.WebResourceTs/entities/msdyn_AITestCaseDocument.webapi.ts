...
/**
 * Formatted values interface for msdyn_AITestCaseDocument
 * All fields return string representation of their values
 */
export interface Imsdyn_AITestCaseDocumentFormattedValue {
...
export interface Imsdyn_AITestCaseDocumentApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AITestCaseDocumentFormattedValue;
