...
/**
 * Formatted values interface for msdyn_AIBDatasetRecord
 * All fields return string representation of their values
 */
export interface Imsdyn_AIBDatasetRecordFormattedValue {
...
export interface Imsdyn_AIBDatasetRecordApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_AIBDatasetRecordFormattedValue;
