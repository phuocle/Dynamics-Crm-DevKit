/**
 * Letter.webapi.ts - Letter WebApi for early-bound style coding
...
const LetterFieldConfig: DevKit.IWebApiFieldConfigMap = {
...
/**
 * Letter WebApi class for early-bound style coding
 * Usage: const letter = new LetterApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class LetterApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<ILetterApi>(entity, 'letter', 'letters', LetterFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface LetterApi extends ILetterApi { }
