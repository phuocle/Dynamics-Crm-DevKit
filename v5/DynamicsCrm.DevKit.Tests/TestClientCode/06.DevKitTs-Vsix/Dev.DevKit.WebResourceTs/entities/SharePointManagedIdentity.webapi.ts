...
/**
 * Formatted values interface for SharePointManagedIdentity
 * All fields return string representation of their values
 */
export interface ISharePointManagedIdentityFormattedValue {
...
export interface ISharePointManagedIdentityApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: ISharePointManagedIdentityFormattedValue;
