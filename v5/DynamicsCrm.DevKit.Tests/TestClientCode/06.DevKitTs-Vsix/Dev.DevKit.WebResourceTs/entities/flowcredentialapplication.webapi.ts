...
/**
 * Formatted values interface for flowcredentialapplication
 * All fields return string representation of their values
 */
export interface IflowcredentialapplicationFormattedValue {
...
export interface IflowcredentialapplicationApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IflowcredentialapplicationFormattedValue;
