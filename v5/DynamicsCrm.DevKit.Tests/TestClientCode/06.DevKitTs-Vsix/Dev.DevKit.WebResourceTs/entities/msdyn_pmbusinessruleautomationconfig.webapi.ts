...
/**
 * Formatted values interface for msdyn_pmbusinessruleautomationconfig
 * All fields return string representation of their values
 */
export interface Imsdyn_pmbusinessruleautomationconfigFormattedValue {
...
export interface Imsdyn_pmbusinessruleautomationconfigApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_pmbusinessruleautomationconfigFormattedValue;
