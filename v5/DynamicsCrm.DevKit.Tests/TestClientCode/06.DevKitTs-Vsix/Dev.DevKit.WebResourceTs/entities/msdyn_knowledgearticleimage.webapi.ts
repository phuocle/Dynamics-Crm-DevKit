...
/**
 * Formatted values interface for msdyn_knowledgearticleimage
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgearticleimageFormattedValue {
...
export interface Imsdyn_knowledgearticleimageApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgearticleimageFormattedValue;
