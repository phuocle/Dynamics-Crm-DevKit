...
/**
 * Formatted values interface for msdyn_dmssyncrequest
 * All fields return string representation of their values
 */
export interface Imsdyn_dmssyncrequestFormattedValue {
...
export interface Imsdyn_dmssyncrequestApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_dmssyncrequestFormattedValue;
