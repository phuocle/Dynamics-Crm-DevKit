/**
 * package.form.ts - package Form for early-bound style form coding
 * Generated file - DO NOT MODIFY MANUALLY
 *
 * Structure:
 * 1. Imports
 * 2. Namespace package containing form classes: package.FormClassName
 * 3. Aggregate Form class: package.AllInOne (contains all fields from all forms)
 */
...
export namespace package {
	...
	export namespace package_Information {
	...
	export class package_Information extends FormBase<package_Information.IBody, package_Information.IHeader, package_Information.IGrid, package_Information.INavigation, package_Information.IQuickForm, package_Information.IProcess, package_Information.IDialog> {
		/**
		 * Creates a package_Information Form instance
	...
	export class AllInOne extends FormBase<AllInOne.IBody, AllInOne.IHeader, AllInOne.IGrid, AllInOne.INavigation, AllInOne.IQuickForm, AllInOne.IProcess, undefined> {
		/**
		 * Creates an aggregate package Form instance
		 * @param executionContext The execution context from form event
		 * @param defaultWebResourceName Optional default web resource name
		 */
		constructor(executionContext: any, defaultWebResourceName?: string) {
