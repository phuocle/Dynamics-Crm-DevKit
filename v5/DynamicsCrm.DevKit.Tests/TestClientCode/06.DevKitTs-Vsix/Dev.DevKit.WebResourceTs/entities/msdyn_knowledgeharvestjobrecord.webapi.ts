...
/**
 * Formatted values interface for msdyn_knowledgeharvestjobrecord
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgeharvestjobrecordFormattedValue {
...
export interface Imsdyn_knowledgeharvestjobrecordApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgeharvestjobrecordFormattedValue;
