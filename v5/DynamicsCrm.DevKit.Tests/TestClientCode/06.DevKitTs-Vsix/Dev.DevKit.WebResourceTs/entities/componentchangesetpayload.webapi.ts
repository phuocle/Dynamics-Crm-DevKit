...
/**
 * Formatted values interface for componentchangesetpayload
 * All fields return string representation of their values
 */
export interface IcomponentchangesetpayloadFormattedValue {
	readonly componentchangesetpayloadId: string;
...
export interface IcomponentchangesetpayloadApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IcomponentchangesetpayloadFormattedValue;
