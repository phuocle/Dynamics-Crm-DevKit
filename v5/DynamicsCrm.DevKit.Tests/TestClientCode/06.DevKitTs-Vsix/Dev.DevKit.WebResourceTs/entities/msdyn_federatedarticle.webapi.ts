...
/**
 * Formatted values interface for msdyn_federatedarticle
 * All fields return string representation of their values
 */
export interface Imsdyn_federatedarticleFormattedValue {
...
export interface Imsdyn_federatedarticleApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_federatedarticleFormattedValue;
