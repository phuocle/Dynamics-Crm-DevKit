/**
 * TranslationProcess.webapi.ts - TranslationProcess WebApi for early-bound style coding
...
/**
 * Formatted values interface for TranslationProcess
 * All fields return string representation of their values
 */
export interface ITranslationProcessFormattedValue {
...
/**
 * TranslationProcess WebApi entity interface
 * Provides IntelliSense for early-bound style coding
 */
export interface ITranslationProcessApi extends DevKit.IWebApiEntity {
	/** Formatted values for all fields */
	readonly FormattedValue: ITranslationProcessFormattedValue;
...
const TranslationProcessFieldConfig: DevKit.IWebApiFieldConfigMap = {
...
/**
 * TranslationProcess WebApi class for early-bound style coding
 * Usage: const translationProcess = new TranslationProcessApi(entity);
 * @param entity The entity object from OData response (optional for create operations)
 */
export class TranslationProcessApi {
	constructor(entity?: Record<string, any>) {
		const webApiEntity = createWebApiEntity<ITranslationProcessApi>(entity, 'translationprocess', 'translationprocesses', TranslationProcessFieldConfig);
		Object.defineProperties(this, Object.getOwnPropertyDescriptors(webApiEntity));
	}
}

export interface TranslationProcessApi extends ITranslationProcessApi { }
