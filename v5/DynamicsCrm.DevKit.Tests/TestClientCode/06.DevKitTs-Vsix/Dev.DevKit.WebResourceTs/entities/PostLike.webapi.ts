...
/**
 * Formatted values interface for PostLike
 * All fields return string representation of their values
 */
export interface IPostLikeFormattedValue {
	readonly CreatedBy: string;
	readonly CreatedOn_UtcDateAndTime: string;
	readonly CreatedOnBehalfBy: string;
	readonly OrganizationId: string;
	readonly PostId: string;
	readonly PostLikeId: string;
...
export interface IPostLikeApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IPostLikeFormattedValue;
