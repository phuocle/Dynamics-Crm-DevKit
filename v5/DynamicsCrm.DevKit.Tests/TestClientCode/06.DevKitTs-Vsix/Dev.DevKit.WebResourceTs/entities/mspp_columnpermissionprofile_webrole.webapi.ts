...
/**
 * Formatted values interface for mspp_columnpermissionprofile_webrole
 * All fields return string representation of their values
 */
export interface Imspp_columnpermissionprofile_webroleFormattedValue {
...
export interface Imspp_columnpermissionprofile_webroleApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imspp_columnpermissionprofile_webroleFormattedValue;
