...
/**
 * Formatted values interface for msdyn_knowledgesearchfilter
 * All fields return string representation of their values
 */
export interface Imsdyn_knowledgesearchfilterFormattedValue {
...
export interface Imsdyn_knowledgesearchfilterApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_knowledgesearchfilterFormattedValue;
