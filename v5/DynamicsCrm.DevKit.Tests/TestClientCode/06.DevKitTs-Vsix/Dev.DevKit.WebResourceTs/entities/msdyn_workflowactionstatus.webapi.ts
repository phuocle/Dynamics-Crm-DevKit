...
/**
 * Formatted values interface for msdyn_workflowactionstatus
 * All fields return string representation of their values
 */
export interface Imsdyn_workflowactionstatusFormattedValue {
...
export interface Imsdyn_workflowactionstatusApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_workflowactionstatusFormattedValue;
