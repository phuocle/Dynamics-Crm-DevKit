...
/**
 * Formatted values interface for BulkArchiveFailureDetail
 * All fields return string representation of their values
 */
export interface IBulkArchiveFailureDetailFormattedValue {
...
export interface IBulkArchiveFailureDetailApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IBulkArchiveFailureDetailFormattedValue;
