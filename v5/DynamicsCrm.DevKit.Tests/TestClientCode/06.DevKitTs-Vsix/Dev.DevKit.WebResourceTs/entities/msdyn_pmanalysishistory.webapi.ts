...
/**
 * Formatted values interface for msdyn_pmanalysishistory
 * All fields return string representation of their values
 */
export interface Imsdyn_pmanalysishistoryFormattedValue {
...
export interface Imsdyn_pmanalysishistoryApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_pmanalysishistoryFormattedValue;
