...
/**
 * Formatted values interface for teammobileofflineprofilemembership
 * All fields return string representation of their values
 */
export interface IteammobileofflineprofilemembershipFormattedValue {
...
export interface IteammobileofflineprofilemembershipApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: IteammobileofflineprofilemembershipFormattedValue;
