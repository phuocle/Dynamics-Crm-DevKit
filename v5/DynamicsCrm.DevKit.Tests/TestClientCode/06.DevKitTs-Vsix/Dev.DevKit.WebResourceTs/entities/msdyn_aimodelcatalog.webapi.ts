...
/**
 * Formatted values interface for msdyn_aimodelcatalog
 * All fields return string representation of their values
 */
export interface Imsdyn_aimodelcatalogFormattedValue {
...
export interface Imsdyn_aimodelcatalogApi extends DevKit.IWebApiEntity {
	...
	readonly FormattedValue: Imsdyn_aimodelcatalogFormattedValue;
