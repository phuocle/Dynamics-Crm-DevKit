...
export namespace FormAccount_for_Interactive_experience {
	...
	export interface IBody {
		...
		primarycontactid: DevKit.Controls.String;
		/** Primary Contact */
		primarycontactid: DevKit.Controls.Lookup;
		/** SIC Code */
	 ...
	 */
	export interface IHeader {
		numberofemployees: DevKit.Controls.String;
		ownerid: DevKit.Controls.String;
		revenue: DevKit.Controls.String;
	}

	/**
	 * DETAILS_TAB sections interface
	 */
	...
	/**
	 * SUMMARY_TAB sections interface
	 */
...
export namespace FormAccount_Information {
	 ...
	 */
	export interface IHeader {
		creditlimit: DevKit.Controls.String;
		ownerid: DevKit.Controls.String;
		preferredcontactmethodcode: DevKit.Controls.String;
		primarycontactid: DevKit.Controls.String;
		revenue: DevKit.Controls.String;
	}

	/**
	 * administration sections interface
	 */
	...
	/**
	 * notes_and_activities sections interface
	 */
	...
	/**
	 * notes_and_activities tab interface
	 */
