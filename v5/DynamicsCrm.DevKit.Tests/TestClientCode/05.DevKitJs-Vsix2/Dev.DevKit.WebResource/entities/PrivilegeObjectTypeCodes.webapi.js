...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrivilegeObjectTypeCodesApi = function (e) {
		...
		const _privilegeobjecttypecodes = {
		...
		for (const field in _privilegeobjecttypecodes) {
			const fieldConfig = _privilegeobjecttypecodes[field];
			webApiField(privilegeobjecttypecodes, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
