...
declare namespace DevKit {
	...
	export class FormEmailServerProfile_Information extends DevKit.IForm {
		/**
	...
	export class EmailServerProfileApi {
		...
		*/
		...
		ACSManagedIdentityId: string | null;
		...
		ExchangeVersion: OptionSet.EmailServerProfile.ExchangeVersion | null;
		/** Select the incoming email authentication protocol that is used for connecting to the email server. */
		IncomingAuthenticationProtocol: OptionSet.EmailServerProfile.IncomingAuthenticationProtocol | null;
		/** Select how credentials will be retrieved for incoming email. */
		IncomingCredentialRetrieval: OptionSet.EmailServerProfile.IncomingCredentialRetrieval | null;
		/** Indicates the incoming partner application. */
		readonly IncomingPartnerApplication: string | null;
		/** Type the password for incoming email. */
		...
		LastAuthorizationStatus: OptionSet.EmailServerProfile.LastAuthorizationStatus | null;
		...
		LastTestExecutionStatus: OptionSet.EmailServerProfile.LastTestExecutionStatus | null;
		...
		LastTestValidationStatus: OptionSet.EmailServerProfile.LastTestValidationStatus | null;
		...
		/** Select the outgoing email authentication protocol that is used for connecting to the email server. */
		OutgoingAuthenticationProtocol: OptionSet.EmailServerProfile.OutgoingAuthenticationProtocol | null;
		...
		/** Select how credentials will be retrieved for outgoing email. */
		OutgoingCredentialRetrieval: OptionSet.EmailServerProfile.OutgoingCredentialRetrieval | null;
		/** Indicates the outgoing partner application. */
		readonly OutgoingPartnerApplication: string | null;
		/** Type the password for outgoing email. */
		...
		PurviewManagedIdentityId: string | null;
		/** Select whether to send an email alert if more than 50% of the mailboxes in this email server profile failed to synchronize in an hour period. */
		SendEmailAlert: boolean | null;
		/** Select the authority for the email server. */
		ServerAuthority: OptionSet.EmailServerProfile.ServerAuthority | null;
		/** Select the profile's email server type. */
		ServerType: OptionSet.EmailServerProfile.ServerType | null;
		/** Shows whether the email server profile is active or inactive. */
		StateCode: OptionSet.EmailServerProfile.StateCode | null;
		/** Select the email server profile's status. */
		StatusCode: OptionSet.EmailServerProfile.StatusCode | null;
		/** Select whether to timeout a single mailbox. */
