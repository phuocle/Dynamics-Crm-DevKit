...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_columnpermissionprofile_webroleApi = function (e) {
		...
		const _mspp_columnpermissionprofile_webrole = {
		...
		for (const field in _mspp_columnpermissionprofile_webrole) {
			const fieldConfig = _mspp_columnpermissionprofile_webrole[field];
			webApiField(mspp_columnpermissionprofile_webrole, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
