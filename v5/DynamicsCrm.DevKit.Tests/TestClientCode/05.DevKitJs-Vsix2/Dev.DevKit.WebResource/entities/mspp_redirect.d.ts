...
declare namespace DevKit {
	...
	export class Formmspp_redirect_Information extends DevKit.IForm {
		/**
	...
	export class mspp_redirectApi {
		...
		*/
		...
		mspp_redirectId: string | null;
		/** The path to redirect visitors to */
		mspp_redirecturl: string | null;
		/** Unique identifier for Site Marker associated with Redirect. */
		mspp_sitemarkerid: string | null;
		mspp_statuscode: OptionSet.mspp_redirect.mspp_statuscode | null;
		/** Unique identifier for Web Page associated with Redirect. */
		mspp_webpageid: string | null;
		/** Unique identifier for Website associated with Redirect. */
		mspp_websiteid: string | null;
		/** Status of the Redirect */
		statecode: OptionSet.mspp_redirect.statecode | null;
		/** Reason for the status of the Redirect */
		statuscode: OptionSet.mspp_redirect.statuscode | null;
		/**
