...
declare namespace DevKit {
	export class msdyn_dmsrequeststatusApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dmsrequeststatus.ComponentState | null;
		...
		statecode: OptionSet.msdyn_dmsrequeststatus.statecode | null;
		/** Reason for the status of the msdyn_dmsrequeststatus */
		statuscode: OptionSet.msdyn_dmsrequeststatus.statuscode | null;
		/** For internal use only. */
