...
declare namespace DevKit {
	...
	export class Formmsdyn_analysisresultdetail_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_analysisresultdetailApi {
		...
		*/
		...
		msdyn_AnalysisResult: string | null;
		...
		statecode: OptionSet.msdyn_analysisresultdetail.statecode | null;
		/** Reason for the status of the Analysis Result Detail */
		statuscode: OptionSet.msdyn_analysisresultdetail.statuscode | null;
