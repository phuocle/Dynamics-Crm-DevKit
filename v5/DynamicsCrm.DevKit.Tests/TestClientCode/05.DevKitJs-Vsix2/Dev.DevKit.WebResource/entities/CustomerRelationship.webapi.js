...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.CustomerRelationshipApi = function (e) {
		...
		for (const field in _customerrelationship) {
			const fieldConfig = _customerrelationship[field];
			webApiField(customerrelationship, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
