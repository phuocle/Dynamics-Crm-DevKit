...
declare namespace DevKit {
	export class chatApi {
		...
		*/
		...
		Community: OptionSet.chat.Community | null;
		...
		DeliveryPriorityCode: OptionSet.chat.DeliveryPriorityCode | null;
		...
		readonly InstanceTypeCode: OptionSet.chat.InstanceTypeCode | null;
		...
		ModifiedInTeamsByActivityPartyId: string | null;
		...
		PriorityCode: OptionSet.chat.PriorityCode | null;
		...
		StateCode: OptionSet.chat.StateCode | null;
		/** Reason for the status of the activity. */
		StatusCode: OptionSet.chat.StatusCode | null;
		/** For internal use only. Subject */
		Subject: string | null;
		/** Displays the sync status. */
		SyncStatus: OptionSet.chat.SyncStatus | null;
