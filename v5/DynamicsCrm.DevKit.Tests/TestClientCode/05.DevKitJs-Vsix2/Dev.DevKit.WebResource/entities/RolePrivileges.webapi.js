...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RolePrivilegesApi = function (e) {
		...
		const _roleprivileges = {
			...
			PrivilegeDepthMask: { a: 'privilegedepthmask', g: 'Integer' },
		...
		for (const field in _roleprivileges) {
			const fieldConfig = _roleprivileges[field];
			webApiField(roleprivileges, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
