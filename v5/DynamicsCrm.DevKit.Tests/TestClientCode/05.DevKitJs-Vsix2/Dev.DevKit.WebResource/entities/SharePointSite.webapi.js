...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SharePointSiteApi = function (e) {
		...
		const _sharepointsite = {
			...
			IsGridPresent: { a: 'isgridpresent', g: 'Boolean' },
			IsPowerBISite: { a: 'ispowerbisite', g: 'Boolean' },
			LastValidated_UtcDateAndTime: { a: 'lastvalidated', g: 'DateTime' },
			...
			ValidationStatusErrorCode: { a: 'validationstatuserrorcode', g: 'Integer' },
		...
		for (const field in _sharepointsite) {
			const fieldConfig = _sharepointsite[field];
			webApiField(sharepointsite, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
