...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TransformationMappingApi = function (e) {
		...
		for (const field in _transformationmapping) {
			const fieldConfig = _transformationmapping[field];
			webApiField(transformationmapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
