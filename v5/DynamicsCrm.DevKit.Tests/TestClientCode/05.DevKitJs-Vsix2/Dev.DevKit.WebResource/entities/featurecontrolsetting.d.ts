...
declare namespace DevKit {
	...
	export class Formfeaturecontrolsetting_Information extends DevKit.IForm {
		/**
	...
	export class Formfeaturecontrolsetting_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
	...
	export class featurecontrolsettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.featurecontrolsetting.ComponentState | null;
		Content: string | null;
		...
		statecode: OptionSet.featurecontrolsetting.statecode | null;
		/** Reason for the status of the featurecontrolsetting */
		statuscode: OptionSet.featurecontrolsetting.statuscode | null;
		/** For internal use only. */
