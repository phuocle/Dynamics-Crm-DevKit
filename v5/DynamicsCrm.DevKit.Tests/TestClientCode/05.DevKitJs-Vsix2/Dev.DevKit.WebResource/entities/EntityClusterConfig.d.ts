...
declare namespace DevKit {
	namespace FormEntityClusterConfig_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class FormEntityClusterConfig_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form EntityClusterConfig_Information */
		Body: DevKit.FormEntityClusterConfig_Information.Body;
	}
	export class EntityClusterConfigApi {
		/**
		* DynamicsCrm.DevKit EntityClusterConfigApi
		...
		*/
		...
		/** Cluster Mode for the Table */
		ClusterMode: OptionSet.EntityClusterConfig.ClusterMode | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.EntityClusterConfig.ComponentState | null;
		...
		EntityClusterConfigId: string | null;
		/** The metadata for Entity. */
		...
		statecode: OptionSet.EntityClusterConfig.statecode | null;
		/** Reason for the status of the Entity Cluster Configuration */
		statuscode: OptionSet.EntityClusterConfig.statuscode | null;
		/** For internal use only. */
