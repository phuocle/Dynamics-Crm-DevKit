...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RelationshipApi = function (e) {
		...
		const _relationship = {
			CascadeArchive: { a: 'cascadearchive', r: true, g: 'Integer' },
			ComponentState: { a: 'componentstate', r: true, g: 'Integer' },
			EntityKeyId: { a: 'entitykeyid' },
			IsRelationshipAttributeDenormalized: { a: 'isrelationshipattributedenormalized', r: true, g: 'Boolean' },
			Name: { a: 'name' },
		...
		for (const field in _relationship) {
			const fieldConfig = _relationship[field];
			webApiField(relationship, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
