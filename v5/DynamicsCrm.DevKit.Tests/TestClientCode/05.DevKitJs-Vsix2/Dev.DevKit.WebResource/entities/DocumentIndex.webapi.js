...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.DocumentIndexApi = function (e) {
		...
		const _documentindex = {
			...
			DocumentTypeCode: { a: 'documenttypecode', g: 'Integer' },
			IsLatestVersion: { a: 'islatestversion', g: 'Boolean' },
			IsPublished: { a: 'ispublished', g: 'Boolean' },
			KeyWords: { a: 'keywords' },
			Location: { a: 'location' },
		...
		for (const field in _documentindex) {
			const fieldConfig = _documentindex[field];
			webApiField(documentindex, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
