...
declare namespace DevKit {
	export class datalakeworkspaceApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.datalakeworkspace.ComponentState | null;
		...
		readonly statecode: OptionSet.datalakeworkspace.statecode | null;
		/** Reason for the status of the Data Lake Workspace */
		readonly statuscode: OptionSet.datalakeworkspace.statuscode | null;
		/** For internal use only. */
