...
declare namespace DevKit {
	...
	export class FormCustomAPIRequestParameter_Information extends DevKit.IForm {
		/**
	...
	export class CustomAPIRequestParameterApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.CustomAPIRequestParameter.ComponentState | null;
		...
		statecode: OptionSet.CustomAPIRequestParameter.statecode | null;
		/** Reason for the status of the Custom API Request Parameter */
		statuscode: OptionSet.CustomAPIRequestParameter.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: number | null;
		/** The data type of the custom API request parameter */
		Type: OptionSet.CustomAPIRequestParameter.Type | null;
		/** Unique name for the custom API request parameter */
