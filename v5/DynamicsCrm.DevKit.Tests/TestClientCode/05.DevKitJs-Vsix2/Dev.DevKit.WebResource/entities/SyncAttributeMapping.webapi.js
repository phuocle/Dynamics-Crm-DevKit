...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SyncAttributeMappingApi = function (e) {
		...
		for (const field in _syncattributemapping) {
			const fieldConfig = _syncattributemapping[field];
			webApiField(syncattributemapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
