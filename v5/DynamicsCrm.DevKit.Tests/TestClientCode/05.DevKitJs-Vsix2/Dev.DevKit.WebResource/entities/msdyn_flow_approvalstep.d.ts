...
declare namespace DevKit {
	namespace Formmsdyn_flow_approvalstep_Information {
		interface Tabs {
		}
		interface Body {
			/** Name */
	...
	export class Formmsdyn_flow_approvalstep_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_flow_approvalstep_Information */
		Body: DevKit.Formmsdyn_flow_approvalstep_Information.Body;
	}
	export class msdyn_flow_approvalstepApi {
		...
		*/
		...
		msdyn_flow_approvalstep_approval: string | null;
		...
		msdyn_flow_approvalstep_stage: OptionSet.msdyn_flow_approvalstep.msdyn_flow_approvalstep_stage | null;
		/** Unique identifier for entity instances */
		msdyn_flow_approvalstepId: string | null;
		...
		statecode: OptionSet.msdyn_flow_approvalstep.statecode | null;
		/** Reason for the status of the Approval Step */
		statuscode: OptionSet.msdyn_flow_approvalstep.statuscode | null;
