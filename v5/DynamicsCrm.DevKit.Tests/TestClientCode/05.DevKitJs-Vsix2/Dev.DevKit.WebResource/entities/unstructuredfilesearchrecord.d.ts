...
declare namespace DevKit {
	export class unstructuredfilesearchrecordApi {
		/**
		* DynamicsCrm.DevKit unstructuredfilesearchrecordApi
		...
		*/
		...
		AttributeType: OptionSet.unstructuredfilesearchrecord.AttributeType | null;
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.unstructuredfilesearchrecord.ComponentState | null;
		...
		statecode: OptionSet.unstructuredfilesearchrecord.statecode | null;
		/** Reason for the status of the Table1 */
		statuscode: OptionSet.unstructuredfilesearchrecord.statuscode | null;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace unstructuredfilesearchrecord {
		enum AttributeType {
			/** FileType = 1*/
			FileType = 1,
			/** Multiline_Text = 2*/
