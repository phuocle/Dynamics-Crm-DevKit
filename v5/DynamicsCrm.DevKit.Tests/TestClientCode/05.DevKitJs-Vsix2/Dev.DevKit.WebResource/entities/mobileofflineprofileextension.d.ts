...
declare namespace DevKit {
	export class mobileofflineprofileextensionApi {
		/**
		* DynamicsCrm.DevKit mobileofflineprofileextensionApi
		...
		*/
		...
		mobileofflineprofileextensionId: string | null;
		...
		statecode: OptionSet.mobileofflineprofileextension.statecode | null;
		/** Reason for the status of the MobileOfflineProfileExtension */
		statuscode: OptionSet.mobileofflineprofileextension.statuscode | null;
...
declare namespace OptionSet {
	namespace mobileofflineprofileextension {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
