...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.PrincipalSyncAttributeMapApi = function (e) {
		...
		const _principalsyncattributemap = {
			AllowedSyncDirection: { a: 'allowedsyncdirection', g: 'Integer' },
			...
			DefaultSyncDirection: { a: 'defaultsyncdirection', g: 'Integer' },
			IsComputed: { a: 'iscomputed', r: true, g: 'Boolean' },
			...
			SyncDirection: { a: 'syncdirection', g: 'Integer' },
		...
		for (const field in _principalsyncattributemap) {
			const fieldConfig = _principalsyncattributemap[field];
			webApiField(principalsyncattributemap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
