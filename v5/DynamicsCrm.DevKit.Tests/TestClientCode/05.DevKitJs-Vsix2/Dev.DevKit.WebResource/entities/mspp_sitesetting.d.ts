...
declare namespace DevKit {
	...
	export class Formmspp_sitesetting_Information extends DevKit.IForm {
		/**
	...
	export class mspp_sitesettingApi {
		...
		*/
		...
		mspp_environmentvariable: string | null;
		/** Environment Variable Schema Name */
		...
		mspp_sitesettingId: string | null;
		/** Source from value is taken */
		mspp_source: OptionSet.mspp_sitesetting.mspp_source | null;
		mspp_value: string | null;
		/** Unique identifier for Website associated with Site Setting. */
		mspp_websiteid: string | null;
		/** Status of the Site Setting */
		statecode: OptionSet.mspp_sitesetting.statecode | null;
		/** Reason for the status of the Site Setting */
		statuscode: OptionSet.mspp_sitesetting.statuscode | null;
		/**
