...
declare namespace DevKit {
	export class organizationdatasyncstateApi {
		...
		*/
		...
		currentfullsyncstate: OptionSet.organizationdatasyncstate.currentfullsyncstate | null;
		...
		organizationdatasyncstateId: string | null;
		...
		statecode: OptionSet.organizationdatasyncstate.statecode | null;
		/** Reason for the status of the OrganizationDataSyncState */
		statuscode: OptionSet.organizationdatasyncstate.statuscode | null;
