...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TransformationParameterMappingApi = function (e) {
		...
		const _transformationparametermapping = {
			...
			ParameterArrayIndex: { a: 'parameterarrayindex', g: 'Integer' },
			ParameterSequence: { a: 'parametersequence', g: 'Integer' },
			ParameterTypeCode: { a: 'parametertypecode', g: 'Integer' },
		...
		for (const field in _transformationparametermapping) {
			const fieldConfig = _transformationparametermapping[field];
			webApiField(transformationparametermapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
