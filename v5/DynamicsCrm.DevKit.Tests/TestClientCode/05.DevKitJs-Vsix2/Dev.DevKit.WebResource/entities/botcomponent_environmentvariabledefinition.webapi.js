...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.botcomponent_environmentvariabledefinitionApi = function (e) {
		...
		const _botcomponent_environmentvariabledefinition = {
		...
		for (const field in _botcomponent_environmentvariabledefinition) {
			const fieldConfig = _botcomponent_environmentvariabledefinition[field];
			webApiField(botcomponent_environmentvariabledefinition, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
