...
declare namespace DevKit {
	export class DataProcessingConfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.DataProcessingConfiguration.ComponentState | null;
		...
		DataProcessingConfigurationId: string | null;
		ExternalDataProcessingConfigurationId: string | null;
		...
		ModuleType: OptionSet.DataProcessingConfiguration.ModuleType | null;
		...
		statecode: OptionSet.DataProcessingConfiguration.statecode | null;
		/** Reason for the status of the Data Processing configuration */
		statuscode: OptionSet.DataProcessingConfiguration.statuscode | null;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace DataProcessingConfiguration {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
