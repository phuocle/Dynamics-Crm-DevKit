...
declare namespace DevKit {
	namespace Formworkqueue_Information {
		interface Tabs {
		}
		interface Body {
	...
	export class Formworkqueue_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form workqueue_Information */
		Body: DevKit.Formworkqueue_Information.Body;
	}
