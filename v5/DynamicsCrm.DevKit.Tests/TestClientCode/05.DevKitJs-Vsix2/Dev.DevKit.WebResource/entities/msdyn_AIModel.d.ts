...
declare namespace DevKit {
	export class msdyn_AIModelApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.msdyn_AIModel.ComponentState | null;
		...
		statecode: OptionSet.msdyn_AIModel.statecode | null;
		/** Reason for the status of the AIModel */
		statuscode: OptionSet.msdyn_AIModel.statuscode | null;
		/** For internal use only. */
