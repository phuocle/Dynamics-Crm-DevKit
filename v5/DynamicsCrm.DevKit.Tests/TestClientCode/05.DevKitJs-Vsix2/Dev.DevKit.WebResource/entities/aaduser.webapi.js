...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.aaduserApi = function (e) {
		...
		const _aaduser = {
			...
			AccountEnabled: { a: 'accountenabled', g: 'Boolean' },
			BusinessPhones: { a: 'businessphones' },
			City: { a: 'city' },
			CompanyName: { a: 'companyname' },
			CreatedDateTime_UtcDateAndTime: { a: 'createddatetime', r: true, g: 'DateTime' },
		...
		for (const field in _aaduser) {
			const fieldConfig = _aaduser[field];
			webApiField(aaduser, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		aaduser.Entity = u;
