...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.RibbonTabToCommandMapApi = function (e) {
		...
		for (const field in _ribbontabtocommandmap) {
			const fieldConfig = _ribbontabtocommandmap[field];
			webApiField(ribbontabtocommandmap, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
