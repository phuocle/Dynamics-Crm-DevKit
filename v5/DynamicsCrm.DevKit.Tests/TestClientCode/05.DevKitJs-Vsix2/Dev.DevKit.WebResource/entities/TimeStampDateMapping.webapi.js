...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.TimeStampDateMappingApi = function (e) {
		...
		const _timestampdatemapping = {
			Date_UtcDateOnly: { a: 'date', r: true, g: 'DateTime' },
		...
		for (const field in _timestampdatemapping) {
			const fieldConfig = _timestampdatemapping[field];
			webApiField(timestampdatemapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
