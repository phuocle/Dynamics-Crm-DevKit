...
declare namespace DevKit {
	...
	export class FormRecycleBinConfig_Information extends DevKit.IForm {
		/**
	...
	export class RecycleBinConfigApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.RecycleBinConfig.ComponentState | null;
		...
		RecycleBinConfigId: string | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Restore Deleted Records Configuration */
		statecode: OptionSet.RecycleBinConfig.statecode | null;
		/** Reason for the status of the Restore Deleted Records Configuration */
		statuscode: OptionSet.RecycleBinConfig.statuscode | null;
		/** For internal use only. */
