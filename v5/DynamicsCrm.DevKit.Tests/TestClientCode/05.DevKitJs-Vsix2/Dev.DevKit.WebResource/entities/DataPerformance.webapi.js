...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.DataPerformanceApi = function (e) {
		...
		const _dataperformance = {
			AnyOptimizationApplied: { a: 'anyoptimizationapplied', r: true, g: 'Boolean' },
			AnyOptimizationAvailable: { a: 'anyoptimizationavailable', r: true, g: 'Boolean' },
			Component: { a: 'component', r: true },
			Count: { a: 'count', r: true, g: 'Integer' },
			DataPerformanceId: { a: 'dataperformanceid' },
			Entity2: { a: 'entity', r: true },
			EstimatedOptimizationImpact: { a: 'estimatedoptimizationimpact', r: true, g: 'Number' },
			ExecutionPeriod: { a: 'executionperiod', r: true },
			LastActionResult: { a: 'lastactionresult', r: true },
			LastOptimizationDate_UtcDateAndTime: { a: 'lastoptimizationdate', r: true, g: 'DateTime' },
			MaxTime: { a: 'maxtime', r: true, g: 'Number' },
			MedianTime: { a: 'mediantime', r: true, g: 'Number' },
			MinTime: { a: 'mintime', r: true, g: 'Number' },
			Operation: { a: 'operation', r: true },
			OptimizationStatus: { a: 'optimizationstatus', r: true },
			OptimizationStorage: { a: 'optimizationstorage', r: true, g: 'Number' },
			OrganizationId: { b: 'organizationid', a: '_organizationid_value', c: 'organizations', d: 'organization', r: true },
			RealizedOptimizationImpact: { a: 'realizedoptimizationimpact', r: true },
			Solution: { a: 'solution', r: true },
			Weight: { a: 'weight', r: true, g: 'Number' }
		};
		if (e === undefined) e = {};
		const u = {};
		...
		for (const field in _dataperformance) {
			const fieldConfig = _dataperformance[field];
			webApiField(dataperformance, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
