...
declare namespace DevKit {
	export class msdyn_dataflowApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dataflow.ComponentState | null;
		...
		statecode: OptionSet.msdyn_dataflow.statecode | null;
		/** Reason for the status of the Dataflow */
		statuscode: OptionSet.msdyn_dataflow.statuscode | null;
		/** For internal use only. */
