...
declare namespace DevKit {
	export class msdyn_AITestRunApi {
		/**
		* DynamicsCrm.DevKit msdyn_AITestRunApi
		...
		*/
		...
		msdyn_TestRunStatus: OptionSet.msdyn_AITestRun.msdyn_TestRunStatus | null;
		...
		statecode: OptionSet.msdyn_AITestRun.statecode | null;
		/** Reason for the status of the AI Test Run */
		statuscode: OptionSet.msdyn_AITestRun.statuscode | null;
...
declare namespace OptionSet {
	namespace msdyn_AITestRun {
		enum msdyn_TestRunStatus {
			/** Blocked = 3*/
			Blocked = 3,
			/** Canceled = 6*/
			Canceled = 6,
