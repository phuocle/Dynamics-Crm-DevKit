...
declare namespace DevKit {
	export class StagedAttributeLookupValueApi {
		/**
		* DynamicsCrm.DevKit StagedAttributeLookupValueApi
		...
		*/
		...
		StagedAttributeLookupValueId: string | null;
		...
		statecode: OptionSet.StagedAttributeLookupValue.statecode | null;
		/** Reason for the status of the staged attribute lookup value. */
		statuscode: OptionSet.StagedAttributeLookupValue.statuscode | null;
...
declare namespace OptionSet {
	namespace StagedAttributeLookupValue {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
