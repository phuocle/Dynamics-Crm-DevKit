...
declare namespace DevKit {
	export class StagedRelationshipExtraConditionApi {
		/**
		* DynamicsCrm.DevKit StagedRelationshipExtraConditionApi
		...
		*/
		...
		StagedRelationshipExtraConditionId: string | null;
		...
		statecode: OptionSet.StagedRelationshipExtraCondition.statecode | null;
		/** Reason for the status of the staged relationship extra condition. */
		statuscode: OptionSet.StagedRelationshipExtraCondition.statuscode | null;
...
declare namespace OptionSet {
	namespace StagedRelationshipExtraCondition {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
