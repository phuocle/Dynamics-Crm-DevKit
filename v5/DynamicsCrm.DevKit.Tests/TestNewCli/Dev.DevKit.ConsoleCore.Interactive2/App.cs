...
namespace Dev.DevKit.ConsoleCore.Interactive2
{
    public static class App
    {
        ...
        private static string ConnectionString => $"AuthType=OAuth;Url={Url};AppId=51f81489-12ee-4a9e-aaae-a2591f45987d;RedirectUri=http://localhost;LoginPrompt=Always;";
    }
}
