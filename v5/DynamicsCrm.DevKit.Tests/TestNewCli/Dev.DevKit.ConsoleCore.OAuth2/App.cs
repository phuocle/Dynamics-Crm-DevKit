...
namespace Dev.DevKit.ConsoleCore.OAuth2
{
    public static class App
    {
        ...
        private static string UserName => GetAppSettingValue("UserName");
        private static string Password => GetAppSettingValue("Password");
