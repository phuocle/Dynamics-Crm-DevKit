...
devkit server --auth OAuth --url "https://dynamics-crm-devkit-v4.crm.dynamics.com" --username "phuocle@phuocle.net" --json "..\DynamicsCrm.DevKit.Cli.json" --profile "DEBUG" --onlyupdateassembly