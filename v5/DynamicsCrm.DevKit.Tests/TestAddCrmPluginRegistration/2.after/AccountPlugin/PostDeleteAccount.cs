...
{
    [CrmPluginRegistration("Delete", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "AccountPlugin.PostDeleteAccount", 1,
        IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Id = "7d9ccdbf-6342-e911-a82f-000d3a17c513", DeleteAsyncOperation = true,
        Description = "AccountPlugin.PostDeleteAccount", UnSecureConfiguration = "AccountPlugin.PostDeleteAccount Configuration",
