...
const formAllInOne = (function () {
	...
	let form: Account.AllInOne;

	async function onLoad(executionContext: any): Promise<void> {
		form = new Account.AllInOne(executionContext);
		registerEvents();
		form.UiAddLoaded(UiAddLoaded);
	}
...
export { /* formAccount, */ /* formAccount_DevKitV4, */ /* formAccount_for_Interactive_experience, */ /* formAccount_Quick_Create, */ /* formAccount_Information, */ formAllInOne };