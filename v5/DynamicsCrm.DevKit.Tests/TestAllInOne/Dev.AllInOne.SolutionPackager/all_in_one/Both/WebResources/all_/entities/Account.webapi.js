...
// @ts-ignore
var AllInOne;
(function (/** @type {any} */ AllInOne) {
	if (AllInOne === undefined) AllInOne = {};
	AllInOne.AccountApi = function (e) {
		...
		const _account = {
			...
			devkit_account_health_label_fx: { a: 'devkit_account_health_label_fx', r: true },
			devkit_account_tier_calculated: { a: 'devkit_account_tier_calculated', r: true },
			devkit_active_contact_count_rollup: { a: 'devkit_active_contact_count_rollup', r: true, g: 'Integer' },
			devkit_active_contact_count_rollup_Date_UtcDateAndTime: { a: 'devkit_active_contact_count_rollup_date', r: true, g: 'DateTime' },
			devkit_active_contact_count_rollup_State: { a: 'devkit_active_contact_count_rollup_state', r: true, g: 'Integer' },
