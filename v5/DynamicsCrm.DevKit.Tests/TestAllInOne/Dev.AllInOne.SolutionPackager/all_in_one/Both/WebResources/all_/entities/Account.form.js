...
(function (/** @type {any} */ AllInOne) {
	'use strict';
	AllInOne.FormAccount = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	AllInOne.FormAccount_DevKitV4 = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	AllInOne.FormAccount_for_Interactive_experience = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	AllInOne.FormAccount_Information = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	AllInOne.FormAccount_Quick_Create = function(executionContext, defaultWebResourceName) {
		const form = {
