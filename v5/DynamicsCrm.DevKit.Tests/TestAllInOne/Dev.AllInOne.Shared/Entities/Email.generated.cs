...
//		Last Modified: 2026-06-24 09:58:55
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.AllInOne.Shared.Entities.EmailOptionSets
{
...
namespace Dev.AllInOne.Shared.Entities
{
    ...
    internal partial class Email : EntityBase
    {
        ...
        /// <para><strong>Access</strong>: ReadOnly</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.CorrelationMethod"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.CorrelationMethod.None"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.CorrelationMethod? CorrelationMethod
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CorrelationMethod);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.CorrelationMethod)value.Value;
            }
        }
        /// <summary>
        ...
        /// <para><strong>Access</strong>: Update: No</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.DeliveryPriorityCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Global Choice Logical Name</strong>: <c>activitypointer_deliveryprioritycode</c></para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.DeliveryPriorityCode.Normal"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.DeliveryPriorityCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Access</strong>: ReadOnly</para>
        /// <para><strong>Required Level</strong>: SystemRequired</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderStatus"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderStatus.NotSet"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderStatus? EmailReminderStatus
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EmailReminderStatus);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderStatus)value.Value;
            }
        }
        /// <summary>
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderType"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderType.If_I_do_not_receive_a_reply_by"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderType? EmailReminderType
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EmailReminderType);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.EmailReminderType)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.Notifications"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.Notifications.None"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.Notifications? Notifications
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Notifications);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.Notifications)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.PriorityCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.PriorityCode.Normal"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.PriorityCode? PriorityCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.PriorityCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Access</strong>: Create: No</para>
        /// <para><strong>Required Level</strong>: SystemRequired</para>
        /// <para><strong>Status</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.StateCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.StateCode.Open"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.StateCode? StateCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.StateCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Status Reason</strong>: <see cref="Dev.AllInOne.Shared.Entities.EmailOptionSets.StatusCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.EmailOptionSets.StatusCode? StatusCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.EmailOptionSets.StatusCode)value.Value;
            }
            set
            {
                if (value.HasValue)
