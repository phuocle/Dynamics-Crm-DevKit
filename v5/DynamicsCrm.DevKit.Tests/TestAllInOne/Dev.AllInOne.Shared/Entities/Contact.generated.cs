...
//		Last Modified: 2026-06-24 09:58:27
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.AllInOne.Shared.Entities.ContactOptionSets
{
...
namespace Dev.AllInOne.Shared.Entities
{
    ...
    internal partial class Contact : EntityBase
    {
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.AccountRoleCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.AccountRoleCode? AccountRoleCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AccountRoleCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.AccountRoleCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_AddressTypeCode? Address1_AddressTypeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address1_AddressTypeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_AddressTypeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_FreightTermsCode? Address1_FreightTermsCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address1_FreightTermsCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_FreightTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_ShippingMethodCode? Address1_ShippingMethodCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address1_ShippingMethodCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address1_ShippingMethodCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_AddressTypeCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_AddressTypeCode? Address2_AddressTypeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address2_AddressTypeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_AddressTypeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_FreightTermsCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_FreightTermsCode? Address2_FreightTermsCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address2_FreightTermsCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_FreightTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_ShippingMethodCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_ShippingMethodCode? Address2_ShippingMethodCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address2_ShippingMethodCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address2_ShippingMethodCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_AddressTypeCode? Address3_AddressTypeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address3_AddressTypeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_AddressTypeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_FreightTermsCode? Address3_FreightTermsCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address3_FreightTermsCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_FreightTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_ShippingMethodCode? Address3_ShippingMethodCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Address3_ShippingMethodCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.Address3_ShippingMethodCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerSizeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerSizeCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerSizeCode? CustomerSizeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CustomerSizeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerSizeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerTypeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerTypeCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerTypeCode? CustomerTypeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CustomerTypeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.CustomerTypeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.EducationCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.EducationCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.EducationCode? EducationCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EducationCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.EducationCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.FamilyStatusCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.FamilyStatusCode? FamilyStatusCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FamilyStatusCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.FamilyStatusCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.GenderCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.GenderCode? GenderCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.GenderCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.GenderCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.HasChildrenCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.HasChildrenCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.HasChildrenCode? HasChildrenCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.HasChildrenCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.HasChildrenCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.LeadSourceCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.LeadSourceCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.LeadSourceCode? LeadSourceCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LeadSourceCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.LeadSourceCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.mspp_userpreferredlcid"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Global Choice Logical Name</strong>: <c>powerpagelanguages</c></para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.mspp_userpreferredlcid? mspp_userpreferredlcid
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.mspp_userpreferredlcid);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.mspp_userpreferredlcid)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PaymentTermsCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.PaymentTermsCode? PaymentTermsCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PaymentTermsCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.PaymentTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentDayCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentDayCode? PreferredAppointmentDayCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PreferredAppointmentDayCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentDayCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentTimeCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentTimeCode.Morning"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentTimeCode? PreferredAppointmentTimeCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PreferredAppointmentTimeCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredAppointmentTimeCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredContactMethodCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredContactMethodCode.Any"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredContactMethodCode? PreferredContactMethodCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PreferredContactMethodCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.PreferredContactMethodCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.ShippingMethodCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.ShippingMethodCode? ShippingMethodCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShippingMethodCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.ShippingMethodCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Access</strong>: Create: No</para>
        /// <para><strong>Required Level</strong>: SystemRequired</para>
        /// <para><strong>Status</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.StateCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.StateCode.Active"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.StateCode? StateCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.StateCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Status Reason</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.StatusCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see langword="null"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.StatusCode? StatusCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.StatusCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>Advanced Find</strong>: Disabled</para>
        /// <para><strong>OptionSet</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.TerritoryCode"/> - <strong>Audit</strong>: Enabled</para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.AllInOne.Shared.Entities.ContactOptionSets.TerritoryCode.Default_Value"/></para>
        /// </summary>
        public Dev.AllInOne.Shared.Entities.ContactOptionSets.TerritoryCode? TerritoryCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TerritoryCode);
                if (value == null) return null;
                return (Dev.AllInOne.Shared.Entities.ContactOptionSets.TerritoryCode)value.Value;
            }
            set
            {
                if (value.HasValue)
