...
namespace Dev.AllInOne.Server.DataProviders.Sql
{
    [CrmPluginRegistration("Dev.AllInOne.Server.DataProviders.Sql.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "all_serversql")]
