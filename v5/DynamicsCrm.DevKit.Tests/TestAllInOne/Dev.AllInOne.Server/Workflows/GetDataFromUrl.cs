...
namespace Dev.AllInOne.Server.Workflows
{
    [CrmPluginRegistration("GetDataFromUrl", "GetDataFromUrl", "", "Dev.AllInOne.Server.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class GetDataFromUrl : CodeActivity
    {
