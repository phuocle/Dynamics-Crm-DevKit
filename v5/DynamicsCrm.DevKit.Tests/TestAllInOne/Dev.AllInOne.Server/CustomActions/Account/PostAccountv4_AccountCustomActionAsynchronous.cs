...
namespace Dev.AllInOne.Server.CustomActions.Account
{
    [CrmPluginRegistration("v4_AccountCustomAction", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.AllInOne.Server.CustomActions.Account.PostAccountv4_AccountCustomActionAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
