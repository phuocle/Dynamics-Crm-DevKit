...
namespace Dev.AllInOne.Server.CustomActions.None
{
    [CrmPluginRegistration("v4_CustomAction", "none", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.AllInOne.Server.CustomActions.None.PostNonev4_CustomActionAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
