...
using TargetPlugin = Dev.AllInOne.Server.CustomActions.Account.PreAccountv4_AccountCustomActionSynchronous;

namespace Dev.AllInOne.Server.Test.CustomActions.Account
{
    [TestClass]
    public class PreAccountv4_AccountCustomActionSynchronousTest : FakeXrmEasyTestBase
    {
        ...
        [TestMethod]
        public void PreAccountv4_AccountCustomActionSynchronousTest_00()
        {
        ...
        [TestMethod]
        public void PreAccountv4_AccountCustomActionSynchronousTest_01()
        {
            ////setup
            //var json = @"";
