...
using TargetPlugin = Dev.AllInOne.Server.CustomActions.None.PostNonev4_CustomActionAsynchronous;

namespace Dev.AllInOne.Server.Test.CustomActions.None
{
    [TestClass]
    public class PostNonev4_CustomActionAsynchronousTest : FakeXrmEasyTestBase
    {

        private const StageEnum PLUGIN_STAGE = StageEnum.PostOperation;
        private const string PLUGIN_MESSAGE = "v4_CustomAction";
        ...
        [TestMethod]
        public void PostNonev4_CustomActionAsynchronousTest_00()
        {
        ...
        [TestMethod]
        public void PostNonev4_CustomActionAsynchronousTest_01()
        {
            ////setup
            //var json = @"";
