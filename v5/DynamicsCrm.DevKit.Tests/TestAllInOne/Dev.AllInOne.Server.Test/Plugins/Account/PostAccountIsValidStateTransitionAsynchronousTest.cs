...
using TargetPlugin = Dev.AllInOne.Server.Plugins.Account.PostAccountIsValidStateTransitionAsynchronous;

namespace Dev.AllInOne.Server.Test.Plugins.Account
{
    [TestClass]
    public class PostAccountIsValidStateTransitionAsynchronousTest : FakeXrmEasyTestBase
    {

        private const StageEnum PLUGIN_STAGE = StageEnum.PostOperation;
        private const string PLUGIN_MESSAGE = "IsValidStateTransition";
        ...
        [TestMethod]
        public void PostAccountIsValidStateTransitionAsynchronousTest_00()
        {
        ...
        [TestMethod]
        public void PostAccountIsValidStateTransitionAsynchronousTest_01()
        {
            ////setup
            //var json = @"";
