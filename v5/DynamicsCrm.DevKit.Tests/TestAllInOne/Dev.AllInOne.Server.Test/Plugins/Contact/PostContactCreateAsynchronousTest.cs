...
using TargetPlugin = Dev.AllInOne.Server.Plugins.Contact.PostContactCreateAsynchronous;

namespace Dev.AllInOne.Server.Test.Plugins.Contact
{
    [TestClass]
    public class PostContactCreateAsynchronousTest : FakeXrmEasyTestBase
    {
        ...
        [TestMethod]
        public void PostContactCreateAsynchronousTest_00()
        {
        ...
        [TestMethod]
        public void PostContactCreateAsynchronousTest_01()
        {
            ////setup
            //var json = @"";
