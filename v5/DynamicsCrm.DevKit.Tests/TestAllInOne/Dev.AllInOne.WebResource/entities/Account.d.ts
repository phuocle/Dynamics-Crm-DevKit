...
declare namespace AllInOne {
	...
	export class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: AllInOne.FormAccount.Body;
		/** The Header section of form Account */
		Header: AllInOne.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: AllInOne.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: AllInOne.FormAccount.QuickForm;
		/** The Process of form Account */
		Process: AllInOne.FormAccount.Process;
		/** The Grid of form Account */
		Grid: AllInOne.FormAccount.Grid;
	}
	...
	export class FormAccount_DevKitV4 extends DevKit.IForm {
		...
		*/
		...
		Body: AllInOne.FormAccount_DevKitV4.Body;
		/** The Header section of form Account_DevKitV4 */
		Header: AllInOne.FormAccount_DevKitV4.Header;
		/** The Navigation of form Account_DevKitV4 */
		Navigation: AllInOne.FormAccount_DevKitV4.Navigation;
		/** The QuickForm of form Account_DevKitV4 */
		QuickForm: AllInOne.FormAccount_DevKitV4.QuickForm;
		/** The Process of form Account_DevKitV4 */
		Process: AllInOne.FormAccount_DevKitV4.Process;
		/** The Grid of form Account_DevKitV4 */
		Grid: AllInOne.FormAccount_DevKitV4.Grid;
	}
	...
	export class FormAccount_for_Interactive_experience extends DevKit.IForm {
		...
		*/
		...
		Body: AllInOne.FormAccount_for_Interactive_experience.Body;
		/** The Header section of form Account_for_Interactive_experience */
		Header: AllInOne.FormAccount_for_Interactive_experience.Header;
		/** The Navigation of form Account_for_Interactive_experience */
		Navigation: AllInOne.FormAccount_for_Interactive_experience.Navigation;
		/** The QuickForm of form Account_for_Interactive_experience */
		QuickForm: AllInOne.FormAccount_for_Interactive_experience.QuickForm;
		/** The Process of form Account_for_Interactive_experience */
		Process: AllInOne.FormAccount_for_Interactive_experience.Process;
		/** The Grid of form Account_for_Interactive_experience */
		Grid: AllInOne.FormAccount_for_Interactive_experience.Grid;
	}
	...
	export class FormAccount_Information extends DevKit.IForm {
		...
		*/
		...
		Body: AllInOne.FormAccount_Information.Body;
		/** The Header section of form Account_Information */
		Header: AllInOne.FormAccount_Information.Header;
		/** The Navigation of form Account_Information */
		Navigation: AllInOne.FormAccount_Information.Navigation;
		/** The Process of form Account_Information */
		Process: AllInOne.FormAccount_Information.Process;
		/** The Grid of form Account_Information */
		Grid: AllInOne.FormAccount_Information.Grid;
	}
	...
	export class FormAccount_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: AllInOne.FormAccount_Quick_Create.Body;
	}
