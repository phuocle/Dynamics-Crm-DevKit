...
//		Last Modified: 2026-06-17 10:14:00
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.DevKit.Shared.Entities
{
	...
	internal partial class Contact : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.AccountRoleCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address1_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address1_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address1_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address2_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address2_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address2_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address3_AddressTypeCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address3_FreightTermsCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.Address3_ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.CustomerSizeCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.CustomerTypeCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.EducationCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.FamilyStatusCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.GenderCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.HasChildrenCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.LeadSourceCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.mspp_userpreferredlcid"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.PaymentTermsCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.PreferredAppointmentDayCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.PreferredAppointmentTimeCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.PreferredContactMethodCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Description</strong>: Select a shipping method for deliveries sent to this address.</para>
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.ShippingMethodCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Access</strong>: Create: No</para>
		/// <para><strong>Required Level</strong>: SystemRequired</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.StateCode"/> - <strong>Audit</strong>: Enabled</para>
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.StatusCode"/> - <strong>Audit</strong>: Enabled</para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		...
		/// <para><strong>Advanced Find</strong>: Disabled</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ContactOptionSets.TerritoryCode"/> - <strong>Audit</strong>: Enabled</para>
