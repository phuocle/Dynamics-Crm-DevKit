...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class SystemUser : EntityBase
	{
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SystemUserOptionSets.SystemManagedUserType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SystemUserOptionSets.SystemManagedUserType.Entra_User"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.SystemUserOptionSets.SystemManagedUserType? SystemManagedUserType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SystemManagedUserType);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.SystemUserOptionSets.SystemManagedUserType)value.Value;
			}
			set
			{
				if (value.HasValue)
