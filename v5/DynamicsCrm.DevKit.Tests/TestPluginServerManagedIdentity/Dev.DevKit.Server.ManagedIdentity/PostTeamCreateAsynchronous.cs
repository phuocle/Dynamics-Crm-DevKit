...
{
    [CrmPluginRegistration("Create", "team", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.Server.ManagedIdentity.PostTeamCreateAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true, Image1Name = "PostImage", Image1Alias = "PostImage", Image1Type = ImageTypeEnum.PostImage, Image1Attributes = "*")]
    public class PostTeamCreateAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (!string.Equals(context.PrimaryEntityName, "team", StringComparison.OrdinalIgnoreCase)) throw new InvalidPluginExecutionException("PrimaryEntityName does not equals team");
