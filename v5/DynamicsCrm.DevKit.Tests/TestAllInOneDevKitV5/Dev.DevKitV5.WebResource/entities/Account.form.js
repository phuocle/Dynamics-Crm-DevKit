...
(function (/** @type {any} */ DevKitV5) {
	'use strict';
	DevKitV5.FormAccount = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	DevKitV5.FormAccount_DevKitV4 = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	DevKitV5.FormAccount_for_Interactive_experience = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	DevKitV5.FormAccount_Information = function(executionContext, defaultWebResourceName) {
		const form = {
	...
	DevKitV5.FormAccount_Quick_Create = function(executionContext, defaultWebResourceName) {
		const form = {
