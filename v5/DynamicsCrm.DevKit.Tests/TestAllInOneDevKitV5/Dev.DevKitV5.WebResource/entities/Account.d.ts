...
declare namespace DevKitV5 {
	...
	export class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV5.FormAccount.Body;
		/** The Header section of form Account */
		Header: DevKitV5.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: DevKitV5.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: DevKitV5.FormAccount.QuickForm;
		/** The Process of form Account */
		Process: DevKitV5.FormAccount.Process;
		/** The Grid of form Account */
		Grid: DevKitV5.FormAccount.Grid;
	}
	...
	export class FormAccount_DevKitV4 extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV5.FormAccount_DevKitV4.Body;
		/** The Header section of form Account_DevKitV4 */
		Header: DevKitV5.FormAccount_DevKitV4.Header;
		/** The Navigation of form Account_DevKitV4 */
		Navigation: DevKitV5.FormAccount_DevKitV4.Navigation;
		/** The QuickForm of form Account_DevKitV4 */
		QuickForm: DevKitV5.FormAccount_DevKitV4.QuickForm;
		/** The Process of form Account_DevKitV4 */
		Process: DevKitV5.FormAccount_DevKitV4.Process;
		/** The Grid of form Account_DevKitV4 */
		Grid: DevKitV5.FormAccount_DevKitV4.Grid;
	}
	...
	export class FormAccount_for_Interactive_experience extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV5.FormAccount_for_Interactive_experience.Body;
		/** The Header section of form Account_for_Interactive_experience */
		Header: DevKitV5.FormAccount_for_Interactive_experience.Header;
		/** The Navigation of form Account_for_Interactive_experience */
		Navigation: DevKitV5.FormAccount_for_Interactive_experience.Navigation;
		/** The QuickForm of form Account_for_Interactive_experience */
		QuickForm: DevKitV5.FormAccount_for_Interactive_experience.QuickForm;
		/** The Process of form Account_for_Interactive_experience */
		Process: DevKitV5.FormAccount_for_Interactive_experience.Process;
		/** The Grid of form Account_for_Interactive_experience */
		Grid: DevKitV5.FormAccount_for_Interactive_experience.Grid;
	}
	...
	export class FormAccount_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV5.FormAccount_Information.Body;
		/** The Header section of form Account_Information */
		Header: DevKitV5.FormAccount_Information.Header;
		/** The Navigation of form Account_Information */
		Navigation: DevKitV5.FormAccount_Information.Navigation;
		/** The Process of form Account_Information */
		Process: DevKitV5.FormAccount_Information.Process;
		/** The Grid of form Account_Information */
		Grid: DevKitV5.FormAccount_Information.Grid;
	}
	...
	export class FormAccount_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV5.FormAccount_Quick_Create.Body;
	}
	export class AccountApi {
		...
		*/
		readonly FormattedValue: {
			...
			readonly devkit_account_health_label_fx: string;
			readonly devkit_account_tier_calculated: string;
			readonly devkit_active_contact_count_rollup: string;
			/** Last Updated time of rollup field Active Contact Count. */
			readonly devkit_active_contact_count_rollup_Date_UtcDateAndTime: string;
			/** State of rollup field Active Contact Count. */
			readonly devkit_active_contact_count_rollup_State: string;
			/** Select whether the account allows bulk email sent through campaigns. If Do Not Allow is selected, the account can be added to marketing lists, but is excluded from email. */
