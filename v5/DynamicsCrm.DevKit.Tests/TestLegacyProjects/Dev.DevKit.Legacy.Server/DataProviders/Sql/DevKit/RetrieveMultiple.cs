...
namespace Dev.DevKit.Legacy.Server.DataProviders.Sql.DevKit
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.DevKit.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4legacy_sqlserverdevkit")]
