...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.LegacyToDevKit.Create", "Create", PluginType.DataProvider, DataSource = "v4legacy_sqlserverlegacytodevkit")]
