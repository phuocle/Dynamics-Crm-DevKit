...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.LegacyToDevKit.Delete", "Delete", PluginType.DataProvider, DataSource = "v4legacy_sqlserverlegacytodevkit")]
