...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.LegacyToDevKit.Retrieve", "Retrieve", PluginType.DataProvider, DataSource = "v4legacy_sqlserverlegacytodevkit")]
