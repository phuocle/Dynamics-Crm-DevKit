...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.LegacyToDevKit.Update", "Update", PluginType.DataProvider, DataSource = "v4legacy_sqlserverlegacytodevkit")]
