...
namespace Dev.DevKit.Legacy.Server.DataProviders.Sql
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4_sqllegacy")]
