...
"%DynamicsCrmDevKitCli%\tools\DynamicsCrm.DevKit.Cli.exe" /conn:%ConnectionString% /json:"..\..\..\DynamicsCrm.DevKit.Cli.json" /type:"datasources" /profile:"Sql-Server-Legacy"