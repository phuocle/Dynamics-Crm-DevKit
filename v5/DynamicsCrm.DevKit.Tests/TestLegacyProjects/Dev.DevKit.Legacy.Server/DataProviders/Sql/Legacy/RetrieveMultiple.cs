...
namespace Dev.DevKit.Legacy.Server.DataProviders.Sql.Legacy
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Server.DataProviders.Sql.Legacy.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4legacy_sqlserverlegacy")]
