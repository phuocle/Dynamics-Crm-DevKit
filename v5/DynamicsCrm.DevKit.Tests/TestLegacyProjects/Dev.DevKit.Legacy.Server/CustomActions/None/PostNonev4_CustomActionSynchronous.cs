...
namespace Dev.DevKit.Legacy.Server.CustomActions.None
{
    [CrmPluginRegistration("v4_CustomAction", "none", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "", "Dev.DevKit.Legacy.Server.CustomActions.None.PostNonev4_CustomActionSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction)]
    public class PostNonev4_CustomActionSynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostNonev4_CustomActionSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
