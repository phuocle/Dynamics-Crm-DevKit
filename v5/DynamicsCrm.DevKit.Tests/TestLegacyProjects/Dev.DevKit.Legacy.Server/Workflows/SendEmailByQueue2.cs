...
namespace Dev.DevKit.Legacy.Server.Workflows
{
    [CrmPluginRegistration("SendEmailByQueue2", "SendEmailByQueue2", "", "Dev.DevKit.Legacy.Server.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class SendEmailByQueue2 : CodeActivity
    {
