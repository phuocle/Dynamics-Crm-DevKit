...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.Legacy.Create", "Create", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagelegacy")]
