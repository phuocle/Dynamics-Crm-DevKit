...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.Legacy.Delete", "Delete", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagelegacy")]
