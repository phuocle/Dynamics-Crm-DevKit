...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.DevKit.Create", "Create", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagedevkit")]
