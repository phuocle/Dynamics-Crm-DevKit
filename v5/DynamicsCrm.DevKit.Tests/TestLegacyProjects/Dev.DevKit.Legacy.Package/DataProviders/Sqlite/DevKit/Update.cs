...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.DevKit.Update", "Update", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagedevkit")]
