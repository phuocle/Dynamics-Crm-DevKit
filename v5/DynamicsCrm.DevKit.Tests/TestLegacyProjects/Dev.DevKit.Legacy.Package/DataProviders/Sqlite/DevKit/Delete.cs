...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.DevKit.Delete", "Delete", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagedevkit")]
