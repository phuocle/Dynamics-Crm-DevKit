...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.DevKit.Retrieve", "Retrieve", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagedevkit")]
