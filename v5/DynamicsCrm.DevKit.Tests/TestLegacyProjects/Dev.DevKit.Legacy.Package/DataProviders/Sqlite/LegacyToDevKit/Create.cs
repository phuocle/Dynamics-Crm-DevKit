...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.LegacyToDevKit.Create", "Create", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagelegacytodevkit")]
