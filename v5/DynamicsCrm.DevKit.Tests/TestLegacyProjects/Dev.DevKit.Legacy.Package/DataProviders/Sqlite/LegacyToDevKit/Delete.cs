...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.LegacyToDevKit.Delete", "Delete", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagelegacytodevkit")]
