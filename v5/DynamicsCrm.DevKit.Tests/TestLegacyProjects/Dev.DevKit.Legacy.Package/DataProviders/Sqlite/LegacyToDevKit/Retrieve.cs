...
{
    [CrmPluginRegistration("Dev.DevKit.Legacy.Package.DataProviders.Sqlite.LegacyToDevKit.Retrieve", "Retrieve", PluginType.DataProvider, DataSource = "v4legacy_sqlitepackagelegacytodevkit")]
