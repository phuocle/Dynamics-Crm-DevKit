...
/// <summary>
/// DEVKIT1021: Tracing service in catch analyzer
///
/// File Scope:
/// - This file intentionally demonstrates DEVKIT1021 only.
/// - Visual Studio Error List should show DEVKIT1021 diagnostics from this file, not unrelated DEVKIT rules.
/// - New DEVKIT rules do not require changing this file because all warnings are disabled first, then DEVKIT1021 is restored.
///
/// Severity Rules:
/// - Catch blocks in plugins/workflows without ITracingService.Trace: WARNING - trace exception details before throwing
/// </summary>
