...
declare namespace DevKit {
	export class FieldPermissionApi {
		...
		*/
		...
		CanCreate: OptionSet.FieldPermission.CanCreate | null;
		/** Can this Profile read the attribute */
		CanRead: OptionSet.FieldPermission.CanRead | null;
		CanReadUnMasked: OptionSet.FieldPermission.CanReadUnMasked | null;
		/** Can this Profile update the attribute */
		CanUpdate: OptionSet.FieldPermission.CanUpdate | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.FieldPermission.ComponentState | null;
		/** Unique identifier of the Field Permission. */
		FieldPermissionId: string | null;
		/** For internal use only. */
		readonly FieldPermissionIdUnique: string | null;
