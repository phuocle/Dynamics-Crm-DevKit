...
declare namespace DevKit {
	...
	export class Formmspp_pollplacement_Information extends DevKit.IForm {
		/**
	...
	export class mspp_pollplacementApi {
		...
		*/
		...
		mspp_pollplacementId: string | null;
		/** Unique identifier for Website associated with Poll Placement. */
		mspp_websiteid: string | null;
		/** Unique identifier for Web Template associated with Poll Placement. */
		mspp_webtemplateid: string | null;
		/** Status of the Poll Placement */
		statecode: OptionSet.mspp_pollplacement.statecode | null;
		/** Reason for the status of the Poll Placement */
		statuscode: OptionSet.mspp_pollplacement.statuscode | null;
		/**
