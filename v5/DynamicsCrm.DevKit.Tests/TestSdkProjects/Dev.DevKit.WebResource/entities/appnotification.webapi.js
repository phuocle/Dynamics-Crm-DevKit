...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.appnotificationApi = function (e) {
		...
		const _appnotification = {
			...
			Title: { a: 'title' },
			ToastType: { a: 'toasttype', g: 'Integer' },
		...
		for (const field in _appnotification) {
			const fieldConfig = _appnotification[field];
			webApiField(appnotification, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
