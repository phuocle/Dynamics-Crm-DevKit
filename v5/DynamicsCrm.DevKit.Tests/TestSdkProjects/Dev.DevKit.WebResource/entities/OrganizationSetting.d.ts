...
declare namespace DevKit {
	export class OrganizationSettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.OrganizationSetting.ComponentState | null;
		...
		readonly statecode: OptionSet.OrganizationSetting.statecode | null;
		/** Reason for the status of the OrganizationSetting */
		readonly statuscode: OptionSet.OrganizationSetting.statuscode | null;
		/** For internal use only. */
