...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.botcomponent_workflowApi = function (e) {
		...
		for (const field in _botcomponent_workflow) {
			const fieldConfig = _botcomponent_workflow[field];
			webApiField(botcomponent_workflow, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
