...
declare namespace DevKit {
	export class synapselinkprofileentityApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.synapselinkprofileentity.ComponentState | null;
		...
		EntitySource: OptionSet.synapselinkprofileentity.EntitySource | null;
		/** Type of the entity */
		EntityType: OptionSet.synapselinkprofileentity.EntityType | null;
		/** Extended properties */
		...
		/** Partition strategy */
		PartitionStrategy: OptionSet.synapselinkprofileentity.PartitionStrategy | null;
		...
		statecode: OptionSet.synapselinkprofileentity.statecode | null;
		/** Reason for the status of the Synapse Link Profile Entity */
		statuscode: OptionSet.synapselinkprofileentity.statuscode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** Unique identifier for entity instances */
		synapselinkprofileentityId: string | null;
		/** For internal use only. */
