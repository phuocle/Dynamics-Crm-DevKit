...
declare namespace DevKit {
	...
	export class Formreconciliationentitystepinfo_Information extends DevKit.IForm {
		/**
	...
	export class reconciliationentitystepinfoApi {
		...
		*/
		...
		reconciliationentitystepinfoId: string | null;
		/** Status of the ReconciliationEntityStepInfo */
		statecode: OptionSet.reconciliationentitystepinfo.statecode | null;
		/** Reason for the status of the ReconciliationEntityStepInfo */
		statuscode: OptionSet.reconciliationentitystepinfo.statuscode | null;
