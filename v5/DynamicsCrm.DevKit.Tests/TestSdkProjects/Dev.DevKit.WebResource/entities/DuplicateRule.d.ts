...
declare namespace DevKit {
	...
	export class FormDuplicate_Detection_Rule_main_form extends DevKit.IForm {
		/**
	...
	export class FormDuplicateRule_Information extends DevKit.IForm {
		/**
	...
	export class DuplicateRuleApi {
		...
		*/
		...
		/** Record type of the record being evaluated for potential duplicates. */
		readonly BaseEntityTypeCode: OptionSet.DuplicateRule.BaseEntityTypeCode | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.DuplicateRule.ComponentState | null;
		/** Unique identifier of the user who created the duplicate detection rule. */
		...
		/** Record type of the records being evaluated as potential duplicates. */
		readonly MatchingEntityTypeCode: OptionSet.DuplicateRule.MatchingEntityTypeCode | null;
		/** Unique identifier of the user who last modified the duplicate detection rule. */
		...
		readonly StateCode: OptionSet.DuplicateRule.StateCode | null;
		/** Reason for the status of the duplicate detection rule. */
		StatusCode: OptionSet.DuplicateRule.StatusCode | null;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace DuplicateRule {
		enum BaseEntityTypeCode {
			...
			Sql_DataSource = 10704,
			/** Sql2_DataSource = 10927*/
			Sql2_DataSource = 10927,
			/** Sql3_DataSource = 10928*/
			Sql3_DataSource = 10928,
