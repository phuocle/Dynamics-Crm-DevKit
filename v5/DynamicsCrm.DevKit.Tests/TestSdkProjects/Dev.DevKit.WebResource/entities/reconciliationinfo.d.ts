...
declare namespace DevKit {
	...
	export class Formreconciliationinfo_Information extends DevKit.IForm {
		/**
	...
	export class reconciliationinfoApi {
		...
		*/
		...
		statecode: OptionSet.reconciliationinfo.statecode | null;
		/** Reason for the status of the ReconciliationInfo */
		statuscode: OptionSet.reconciliationinfo.statuscode | null;
