...
declare namespace DevKit {
	...
	export class FormDVTableSearch_main_form extends DevKit.IForm {
		/**
	...
	export class DVTableSearchApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.DVTableSearch.ComponentState | null;
		...
		knowledgesourceprofileid: string | null;
		...
		SearchType: OptionSet.DVTableSearch.SearchType | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the DVTableSearch */
		statecode: OptionSet.DVTableSearch.statecode | null;
		/** Reason for the status of the DVTableSearch */
		statuscode: OptionSet.DVTableSearch.statuscode | null;
		/** For internal use only. */
