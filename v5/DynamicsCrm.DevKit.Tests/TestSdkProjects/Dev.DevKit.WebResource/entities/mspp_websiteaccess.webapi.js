...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_websiteaccessApi = function (e) {
		...
		const _mspp_websiteaccess = {
			...
			mspp_managecontentsnippets: { a: 'mspp_managecontentsnippets', g: 'Boolean' },
			mspp_managesitemarkers: { a: 'mspp_managesitemarkers', g: 'Boolean' },
			mspp_manageweblinksets: { a: 'mspp_manageweblinksets', g: 'Boolean' },
			...
			mspp_previewunpublishedentities: { a: 'mspp_previewunpublishedentities', g: 'Boolean' },
		...
		for (const field in _mspp_websiteaccess) {
			const fieldConfig = _mspp_websiteaccess[field];
			webApiField(mspp_websiteaccess, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
