...
declare namespace DevKit {
	export class processorregistrationApi {
		/**
		* DynamicsCrm.DevKit processorregistrationApi
		...
		*/
		...
		processorregistrationId: string | null;
		processortype: string | null;
		signalname: string | null;
		/** Status of the processor registration */
		statecode: OptionSet.processorregistration.statecode | null;
		/** Reason for the status of the processor registration */
		statuscode: OptionSet.processorregistration.statuscode | null;
...
declare namespace OptionSet {
	namespace processorregistration {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
