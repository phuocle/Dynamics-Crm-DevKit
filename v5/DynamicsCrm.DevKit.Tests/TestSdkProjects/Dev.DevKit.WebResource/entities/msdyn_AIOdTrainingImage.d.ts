...
declare namespace DevKit {
	...
	export class Formmsdyn_AIOdTrainingImage_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_AIOdTrainingImageApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_AIOdTrainingImage.statecode | null;
		/** Reason for the status of the Training Image */
		statuscode: OptionSet.msdyn_AIOdTrainingImage.statuscode | null;
