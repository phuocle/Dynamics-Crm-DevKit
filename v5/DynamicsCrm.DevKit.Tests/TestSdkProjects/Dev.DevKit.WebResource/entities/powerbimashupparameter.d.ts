...
declare namespace DevKit {
	...
	export class Formpowerbimashupparameter_Information extends DevKit.IForm {
		/**
	...
	export class powerbimashupparameterApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.powerbimashupparameter.ComponentState | null;
		...
		/** The environment variable this mashup parameter is bound to */
		EnvironmentVariableId: string | null;
		...
		/** Specifies how the parameter value should be set */
		ParameterValueSource: OptionSet.powerbimashupparameter.ParameterValueSource | null;
		/** Unique identifier for entity instances */
		powerbimashupparameterId: string | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the Power BI Mashup Parameter */
		statecode: OptionSet.powerbimashupparameter.statecode | null;
		/** Reason for the status of the Power BI Mashup Parameter */
		statuscode: OptionSet.powerbimashupparameter.statuscode | null;
		/** For internal use only. */
