...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_webformstepApi = function (e) {
		...
		const _mspp_webformstep = {
			mspp_accept: { a: 'mspp_accept' },
			mspp_allowmultiplefiles: { a: 'mspp_allowmultiplefiles', g: 'Boolean' },
			...
			mspp_createautonumber: { a: 'mspp_createautonumber', g: 'Boolean' },
			...
			mspp_editexpiredstatusreason: { a: 'mspp_editexpiredstatusreason', g: 'Integer' },
			...
			mspp_loguser: { a: 'mspp_loguser', g: 'Boolean' },
			...
			mspp_movepreviouspermitted: { a: 'mspp_movepreviouspermitted', g: 'Boolean' },
		...
		for (const field in _mspp_webformstep) {
			const fieldConfig = _mspp_webformstep[field];
			webApiField(mspp_webformstep, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
