...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SdkMessageProcessingStepImageApi = function (e) {
		...
		const _sdkmessageprocessingstepimage = {
			...
			ImageType: { a: 'imagetype', g: 'Integer' },
		...
		for (const field in _sdkmessageprocessingstepimage) {
			const fieldConfig = _sdkmessageprocessingstepimage[field];
			webApiField(sdkmessageprocessingstepimage, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
