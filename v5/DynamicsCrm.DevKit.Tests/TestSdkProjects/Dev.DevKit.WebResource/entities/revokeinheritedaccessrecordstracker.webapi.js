...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.revokeinheritedaccessrecordstrackerApi = function (e) {
		...
		const _revokeinheritedaccessrecordstracker = {
		...
		for (const field in _revokeinheritedaccessrecordstracker) {
			const fieldConfig = _revokeinheritedaccessrecordstracker[field];
			webApiField(revokeinheritedaccessrecordstracker, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
