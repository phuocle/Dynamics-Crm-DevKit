...
declare namespace DevKit {
	...
	export class Formmsdyn_flow_approvalresponse_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_flow_approvalresponseApi {
		...
		*/
		...
		/** The linked approval. */
		msdyn_flow_approvalresponse_approval: string | null;
		...
		msdyn_flow_approvalresponse_stage: OptionSet.msdyn_flow_approvalresponse.msdyn_flow_approvalresponse_stage | null;
		msdyn_flow_approvalresponse_stepnumber: number | null;
		/** Unique identifier for entity instances */
		msdyn_flow_approvalresponseId: string | null;
		...
		statecode: OptionSet.msdyn_flow_approvalresponse.statecode | null;
		/** The reason for the status of the response. */
		statuscode: OptionSet.msdyn_flow_approvalresponse.statuscode | null;
