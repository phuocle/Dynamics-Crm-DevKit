...
declare namespace DevKit {
	export class SdkMessageRequestApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.SdkMessageRequest.ComponentState | null;
		...
		readonly SdkMessagePairId: string | null;
		...
		readonly SdkMessageRequestIdUnique: string | null;
