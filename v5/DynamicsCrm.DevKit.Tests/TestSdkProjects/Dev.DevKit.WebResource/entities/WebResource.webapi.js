...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.WebResourceApi = function (e) {
		...
		const _webresource = {
			...
			IsAvailableForMobileOffline: { a: 'isavailableformobileoffline', g: 'Boolean' },
			IsCustomizable: { a: 'iscustomizable' },
			IsEnabledForMobileClient: { a: 'isenabledformobileclient', g: 'Boolean' },
			IsHidden: { a: 'ishidden' },
			...
			WebResourceType: { a: 'webresourcetype', g: 'Integer' }
		};
		if (e === undefined) e = {};
		const u = {};
		const webresource = {};
		...
		for (const field in _webresource) {
			const fieldConfig = _webresource[field];
			webApiField(webresource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
