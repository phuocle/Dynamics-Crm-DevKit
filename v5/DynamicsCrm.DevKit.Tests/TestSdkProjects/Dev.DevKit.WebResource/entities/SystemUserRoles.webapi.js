...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SystemUserRolesApi = function (e) {
		...
		for (const field in _systemuserroles) {
			const fieldConfig = _systemuserroles[field];
			webApiField(systemuserroles, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
