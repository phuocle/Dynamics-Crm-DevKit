...
declare namespace DevKit {
	export class FederatedKnowledgeMetadataRefreshApi {
		/**
		* DynamicsCrm.DevKit FederatedKnowledgeMetadataRefreshApi
		...
		*/
		...
		/** Federated Job Type */
		federatedjobtype: OptionSet.FederatedKnowledgeMetadataRefresh.federatedjobtype | null;
		/** Unique identifier for metadatarefresh for federated knowledge source */
		FederatedKnowledgeMetadataRefreshId: string | null;
		...
		statecode: OptionSet.FederatedKnowledgeMetadataRefresh.statecode | null;
		/** Reason for the status of the FederatedKnowledgeMetadataRefresh */
		statuscode: OptionSet.FederatedKnowledgeMetadataRefresh.statuscode | null;
...
declare namespace OptionSet {
	namespace FederatedKnowledgeMetadataRefresh {
		enum federatedjobtype {
			/** Structured = 0*/
			Structured = 0,
			/** Unknown = 2*/
			Unknown = 2,
