...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ExternalPartyItemApi = function (e) {
		...
		for (const field in _externalpartyitem) {
			const fieldConfig = _externalpartyitem[field];
			webApiField(externalpartyitem, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
