...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_flow_actionapprovalmodel_teamApi = function (e) {
		...
		const _msdyn_flow_actionapprovalmodel_team = {
		...
		for (const field in _msdyn_flow_actionapprovalmodel_team) {
			const fieldConfig = _msdyn_flow_actionapprovalmodel_team[field];
			webApiField(msdyn_flow_actionapprovalmodel_team, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
