...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.appaction_appactionrule_classicrulesApi = function (e) {
		...
		const _appaction_appactionrule_classicrules = {
		...
		for (const field in _appaction_appactionrule_classicrules) {
			const fieldConfig = _appaction_appactionrule_classicrules[field];
			webApiField(appaction_appactionrule_classicrules, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
