...
declare namespace DevKit {
	...
	export class Formmsdyn_FormMapping_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_FormMappingApi {
		...
		*/
		...
		AllowedOperations: Array<OptionSet.msdyn_FormMapping.AllowedOperations> | null;
		/** The base entity that will be created or updated. Relationships to other entities will be described with respect to this entity. */
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_FormMapping.ComponentState | null;
		...
		msdyn_FormMappingId: string | null;
		msdyn_formname: string | null;
		msdyn_RequestedColumns: string | null;
		/** The type of operation to be performed. */
		Operation: OptionSet.msdyn_FormMapping.Operation | null;
		...
		statecode: OptionSet.msdyn_FormMapping.statecode | null;
		/** Reason for the status of the Form Mapping */
		statuscode: OptionSet.msdyn_FormMapping.statuscode | null;
		/** For internal use only. */
