...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.WizardAccessPrivilegeApi = function (e) {
		...
		for (const field in _wizardaccessprivilege) {
			const fieldConfig = _wizardaccessprivilege[field];
			webApiField(wizardaccessprivilege, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
