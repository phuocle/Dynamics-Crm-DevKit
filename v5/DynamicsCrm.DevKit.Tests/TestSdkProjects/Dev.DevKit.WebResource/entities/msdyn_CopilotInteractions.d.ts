...
declare namespace DevKit {
	...
	export class Formmsdyn_CopilotInteractions_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_CopilotInteractionsApi {
		...
		*/
		...
		msdyn_CopilotInteractionsId: string | null;
		...
		statecode: OptionSet.msdyn_CopilotInteractions.statecode | null;
		/** Reason for the status of the Copilot Interactions */
		statuscode: OptionSet.msdyn_CopilotInteractions.statuscode | null;
