...
declare namespace DevKit {
	export class StagedMetadataAsyncOperationApi {
		...
		*/
		...
		readonly StagedMetadataAsyncOperationId: string | null;
		/** Status of the Staged Metadata Async Operation */
		statecode: OptionSet.StagedMetadataAsyncOperation.statecode | null;
		/** Reason for the status of the Staged Metadata Async Operation */
		statuscode: OptionSet.StagedMetadataAsyncOperation.statuscode | null;
