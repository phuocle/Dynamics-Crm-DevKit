...
declare namespace DevKit {
	export class purviewlabelsynccacheApi {
		/**
		* DynamicsCrm.DevKit purviewlabelsynccacheApi
		...
		*/
		...
		purviewlabelsynccacheId: string | null;
		/** Status of the purviewlabelsynccache */
		statecode: OptionSet.purviewlabelsynccache.statecode | null;
		/** Reason for the status of the purviewlabelsynccache */
		statuscode: OptionSet.purviewlabelsynccache.statuscode | null;
...
declare namespace OptionSet {
	namespace purviewlabelsynccache {
		enum statecode {
			/** Active = 0*/
			Active = 0,
			/** Inactive = 1*/
