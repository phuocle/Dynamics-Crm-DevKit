...
declare namespace DevKit {
	export class DependencyFeatureApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.DependencyFeature.ComponentState | null;
		/** Unique identifier of a dependency feature. */
		readonly DependencyFeatureId: string | null;
		/** For internal use only. */
		readonly DependencyFeatureIdUnique: string | null;
