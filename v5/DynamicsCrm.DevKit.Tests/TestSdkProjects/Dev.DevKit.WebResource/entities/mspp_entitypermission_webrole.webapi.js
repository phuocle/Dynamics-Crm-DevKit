...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.mspp_entitypermission_webroleApi = function (e) {
		...
		const _mspp_entitypermission_webrole = {
		...
		for (const field in _mspp_entitypermission_webrole) {
			const fieldConfig = _mspp_entitypermission_webrole[field];
			webApiField(mspp_entitypermission_webrole, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
