...
declare namespace DevKit {
	export class workflowbinaryApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.workflowbinary.ComponentState | null;
		...
		statecode: OptionSet.workflowbinary.statecode | null;
		/** Reason for the status of the Workflow Binary */
		statuscode: OptionSet.workflowbinary.statuscode | null;
		/** For internal use only. */
