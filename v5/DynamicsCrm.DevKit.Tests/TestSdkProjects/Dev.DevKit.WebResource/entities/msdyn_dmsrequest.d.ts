...
declare namespace DevKit {
	export class msdyn_dmsrequestApi {
		/**
		* DynamicsCrm.DevKit msdyn_dmsrequestApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dmsrequest.ComponentState | null;
		...
		statecode: OptionSet.msdyn_dmsrequest.statecode | null;
		/** Reason for the status of the msdyn_dmsrequest */
		statuscode: OptionSet.msdyn_dmsrequest.statuscode | null;
		/** For internal use only. */
