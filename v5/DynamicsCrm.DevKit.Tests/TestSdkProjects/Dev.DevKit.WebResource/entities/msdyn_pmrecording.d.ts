...
declare namespace DevKit {
	...
	export class Formmsdyn_pmrecording_Information extends DevKit.IForm {
		/**
	...
	export class msdyn_pmrecordingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_pmrecording.ComponentState | null;
		...
		msdyn_publishingstatus: OptionSet.msdyn_pmrecording.msdyn_publishingstatus | null;
		/** The Workflow record that is used as a source for this recording. */
		msdyn_sourceworkflow: string | null;
		msdyn_type: OptionSet.msdyn_pmrecording.msdyn_type | null;
		...
		statecode: OptionSet.msdyn_pmrecording.statecode | null;
		/** Reason for the status of the Recording */
		statuscode: OptionSet.msdyn_pmrecording.statuscode | null;
		/** For internal use only. */
