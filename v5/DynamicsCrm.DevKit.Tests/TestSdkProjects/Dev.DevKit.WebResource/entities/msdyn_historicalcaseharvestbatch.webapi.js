...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_historicalcaseharvestbatchApi = function (e) {
		...
		const _msdyn_historicalcaseharvestbatch = {
			...
			ModuleRunId: { a: 'modulerunid' },
			msdyn_articlescreated: { a: 'msdyn_articlescreated', g: 'Integer' },
			msdyn_batchprocessingcompletedon_UtcDateAndTime: { a: 'msdyn_batchprocessingcompletedon', g: 'DateTime' },
			msdyn_batchsize: { a: 'msdyn_batchsize', g: 'Integer' },
			msdyn_casesskipped: { a: 'msdyn_casesskipped', g: 'Integer' },
		...
		for (const field in _msdyn_historicalcaseharvestbatch) {
			const fieldConfig = _msdyn_historicalcaseharvestbatch[field];
			webApiField(msdyn_historicalcaseharvestbatch, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
