...
declare namespace DevKit {
	...
	export class Formmspp_publishingstate_Information extends DevKit.IForm {
		/**
	...
	export class mspp_publishingstateApi {
		...
		*/
		...
		statecode: OptionSet.mspp_publishingstate.statecode | null;
		/** Reason for the status of the Publishing State */
		statuscode: OptionSet.mspp_publishingstate.statuscode | null;
		/**
