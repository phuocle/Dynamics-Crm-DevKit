...
declare namespace DevKit {
	export class ReplicationBacklogApi {
		...
		*/
		...
		readonly ReplicationBacklogId: string | null;
		/** The type of replication backlog. */
		readonly ReplicationBacklogType: OptionSet.ReplicationBacklog.ReplicationBacklogType | null;
		/** For internal use only. */
		readonly TargetDatacenterId: string | null;
