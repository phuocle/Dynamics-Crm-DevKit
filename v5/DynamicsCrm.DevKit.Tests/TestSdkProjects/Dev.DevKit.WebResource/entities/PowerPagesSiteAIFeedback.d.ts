...
declare namespace DevKit {
	...
	export class FormSubmit_Feedback extends DevKit.IForm {
		/**
	...
	export class PowerPagesSiteAIFeedbackApi {
		...
		*/
		...
		Feedback: OptionSet.PowerPagesSiteAIFeedback.Feedback | null;
		...
		PowerPagesSiteAIFeedbackId: string | null;
		/** Unique identifier for entity instances */
		PowerPagesSiteAIFeedbackName: string | null;
		/** Reason for down */
		Reason: string | null;
