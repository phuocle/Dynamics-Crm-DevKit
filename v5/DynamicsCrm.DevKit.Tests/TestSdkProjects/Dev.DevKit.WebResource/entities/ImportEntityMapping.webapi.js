...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.ImportEntityMappingApi = function (e) {
		...
		for (const field in _importentitymapping) {
			const fieldConfig = _importentitymapping[field];
			webApiField(importentitymapping, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
