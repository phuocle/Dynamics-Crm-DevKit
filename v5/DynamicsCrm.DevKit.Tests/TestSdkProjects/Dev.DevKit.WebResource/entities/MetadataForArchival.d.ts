...
declare namespace DevKit {
	...
	export class FormMetadataForArchival_Information extends DevKit.IForm {
		/**
	...
	export class FormMetadataForArchival_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
	...
	export class MetadataForArchivalApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.MetadataForArchival.ComponentState | null;
		...
		MetadataForArchivalId: string | null;
		...
		statecode: OptionSet.MetadataForArchival.statecode | null;
		/** Reason for the status of the MetadataForArchival */
		statuscode: OptionSet.MetadataForArchival.statuscode | null;
		/** For internal use only. */
