...
declare namespace DevKit {
	export class msdyn_knowledgesearchfilterApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_knowledgesearchfilter.ComponentState | null;
		...
		statecode: OptionSet.msdyn_knowledgesearchfilter.statecode | null;
		/** Reason for the status of the Knowledge search filter */
		statuscode: OptionSet.msdyn_knowledgesearchfilter.statuscode | null;
		/** For internal use only. */
