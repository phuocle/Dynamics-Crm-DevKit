...
declare namespace DevKit {
	export class AIPluginOperationResponseTemplateApi {
		...
		*/
		...
		AIPluginOperationResponseTemplateId: string | null;
		/** For internal use only. */
		readonly ComponentIdUnique: string | null;
		/** For internal use only. */
		readonly ComponentState: OptionSet.AIPluginOperationResponseTemplate.ComponentState | null;
		...
		statecode: OptionSet.AIPluginOperationResponseTemplate.statecode | null;
		/** Reason for the status of the AIPluginOperationResponseTemplate */
		statuscode: OptionSet.AIPluginOperationResponseTemplate.statuscode | null;
		/** For internal use only. */
