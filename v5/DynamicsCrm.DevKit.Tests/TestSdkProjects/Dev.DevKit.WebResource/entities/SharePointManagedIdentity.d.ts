...
declare namespace DevKit {
	export class SharePointManagedIdentityApi {
		/**
		* DynamicsCrm.DevKit SharePointManagedIdentityApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.SharePointManagedIdentity.ComponentState | null;
		...
		SharePointManagedIdentityId: string | null;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string | null;
		/** Status of the SharePointManagedIdentity */
		statecode: OptionSet.SharePointManagedIdentity.statecode | null;
		/** Reason for the status of the SharePointManagedIdentity */
		statuscode: OptionSet.SharePointManagedIdentity.statuscode | null;
		/** For internal use only. */
		...
		*/
		readonly FormattedValue: {
			...
			/** Unique identifier for SharePoint Managed Identity entity instances */
			readonly SharePointManagedIdentityId: string;
			/** Unique identifier of the associated solution. */
...
declare namespace OptionSet {
	namespace SharePointManagedIdentity {
		enum ComponentState {
			/** Deleted = 2*/
			Deleted = 2,
