...
declare namespace DevKit {
	...
	export class FormImportMap_Information extends DevKit.IForm {
		/**
	...
	export class ImportMapApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.ImportMap.ComponentState | null;
		/** Shows who created the record. */
		...
		SourceType: OptionSet.ImportMap.SourceType | null;
		...
		StateCode: OptionSet.ImportMap.StateCode | null;
		/** Select the data map's status. */
		StatusCode: OptionSet.ImportMap.StatusCode | null;
		/** For internal use only. */
		readonly SupportingSolutionId: string | null;
		/** Select the name of the Microsoft Dynamics 365 record type that this data map is defined for. */
		readonly TargetEntity: OptionSet.ImportMap.TargetEntity | null;
