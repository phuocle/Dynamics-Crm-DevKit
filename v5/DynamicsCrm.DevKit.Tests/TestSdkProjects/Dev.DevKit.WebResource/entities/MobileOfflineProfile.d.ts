...
declare namespace DevKit {
	...
	export class FormMobile_Offline_Profile extends DevKit.IForm {
		/**
	...
	export class MobileOfflineProfileApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.MobileOfflineProfile.ComponentState | null;
		...
		/** For Internal Use Only */
		readonly MobileOfflineProfileIdUnique: string | null;
