...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.SLAApi = function (e) {
		...
		const _sla = {
			AllowPauseResume: { a: 'allowpauseresume', g: 'Boolean' },
			ApplicableFrom: { a: 'applicablefrom' },
			ApplicableFromPickList: { a: 'applicablefrompicklist', g: 'Integer' },
			...
			Name: { a: 'name' },
			ObjectTypeCode: { a: 'objecttypecode', r: true, g: 'Integer' },
			...
			PrimaryEntityOTC: { a: 'primaryentityotc', g: 'Integer' },
			SLAId: { a: 'slaid' },
			SLAIdUnique: { a: 'slaidunique', r: true },
			SLAType: { a: 'slatype', g: 'Integer' },
			slaversion: { a: 'slaversion', g: 'Integer' },
		...
		sla.ODataEntity = e;
		sla.FormattedValue = {};
		for (const field in _sla) {
			const fieldConfig = _sla[field];
			webApiField(sla, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		sla.Entity = u;
		sla.EntityName = 'sla';
