...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.chatApi = function (e) {
		...
		const _chat = {
			...
			Subject: { a: 'subject' },
			SyncStatus: { a: 'syncstatus', g: 'Integer' },
			...
			UnLinkedOn_UtcDateAndTime: { a: 'unlinkedon', r: true, g: 'DateTime' },
		...
		chat.ODataEntity = e;
		chat.FormattedValue = {};
		for (const field in _chat) {
			const fieldConfig = _chat[field];
			webApiField(chat, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
