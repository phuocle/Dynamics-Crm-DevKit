...
(function (/** @type {any} */ DevKit) {
	...
	DevKit.msdyn_solutioncomponentcountdatasourceApi = function (e) {
		...
		const _msdyn_solutioncomponentcountdatasource = {
		...
		for (const field in _msdyn_solutioncomponentcountdatasource) {
			const fieldConfig = _msdyn_solutioncomponentcountdatasource[field];
			webApiField(msdyn_solutioncomponentcountdatasource, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
