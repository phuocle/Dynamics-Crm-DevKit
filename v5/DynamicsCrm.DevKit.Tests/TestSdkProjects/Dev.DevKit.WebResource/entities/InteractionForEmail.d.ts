...
declare namespace DevKit {
	export class InteractionForEmailApi {
		...
		*/
		...
		/** Email Activity Id. */
		readonly EmailActivityId: string | null;
		/** For internal use only. */
		EmailAddress: string | null;
		/** Email Activity Id. */
		readonly EmailInteractionReplyId: string | null;
		...
		/** For internal use only. */
		readonly InteractionPartyId: string | null;
		/** For internal use only */
		...
		readonly InteractionType: OptionSet.InteractionForEmail.InteractionType | null;
		...
		statecode: OptionSet.InteractionForEmail.statecode | null;
		/** Reason for the status of the Interaction for Email */
		statuscode: OptionSet.InteractionForEmail.statuscode | null;
		/** For internal use only. */
