...
declare namespace DevKit {
	export class msdyn_historicalcaseharvestbatchApi {
		...
		*/
		...
		msdyn_historicalcaseharvestbatchId: string | null;
		...
		statecode: OptionSet.msdyn_historicalcaseharvestbatch.statecode | null;
		/** Reason for the status of the msdyn_historicalcaseharvestbatch */
		statuscode: OptionSet.msdyn_historicalcaseharvestbatch.statuscode | null;
