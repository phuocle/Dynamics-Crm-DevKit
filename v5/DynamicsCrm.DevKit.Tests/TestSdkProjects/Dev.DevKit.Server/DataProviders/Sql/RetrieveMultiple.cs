...
namespace Dev.DevKit.Server.DataProviders.Sql
{
    [CrmPluginRegistration("Dev.DevKit.Server.DataProviders.Sql.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4_sql_datasource")]
