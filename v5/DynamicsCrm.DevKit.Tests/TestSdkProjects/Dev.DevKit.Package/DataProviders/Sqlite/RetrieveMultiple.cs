...
namespace Dev.DevKit.Package.DataProviders.Sqlite
{
    [CrmPluginRegistration("Dev.DevKit.Package.DataProviders.Sqlite.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4_packagesqlite")]
