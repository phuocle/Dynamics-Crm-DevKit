...
namespace Dev.DevKit.Package.Workflows
{
    [CrmPluginRegistration("WhoAmI", "WhoAmI", "", "Dev.DevKit.Package.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class WhoAmI : CodeActivity
    {
