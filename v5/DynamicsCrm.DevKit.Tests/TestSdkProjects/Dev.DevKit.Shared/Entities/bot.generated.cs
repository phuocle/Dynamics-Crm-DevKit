...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class bot : EntityBase
	{
		...
		/// <para><strong>Description</strong>: Used to visually identify your bot in channels and services. Represented in a base64 encoded string. Must be in PNG format, and no larger than 100KB in size. This value can be changed at any time.</para>
		/// <para><strong>Multiple Lines of Text</strong> - <strong>MaxLength</strong>: 136,533</para>
		/// </summary>
		[DebuggerNonUserCode()]
