...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class Workflow : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.WorkflowOptionSets.ModernFlowType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.WorkflowOptionSets.ModernFlowType.PowerAutomateFlow"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.WorkflowOptionSets.ModernFlowType? ModernFlowType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ModernFlowType);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.WorkflowOptionSets.ModernFlowType)value.Value;
			}
			set
			{
				if (value.HasValue)
