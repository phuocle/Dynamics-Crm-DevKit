...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class workqueue : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.workqueueOptionSets.continueprocessingifslaviolated"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.workqueueOptionSets.continueprocessingifslaviolated.NotSet"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.workqueueOptionSets.continueprocessingifslaviolated? continueprocessingifslaviolated
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.continueprocessingifslaviolated);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.workqueueOptionSets.continueprocessingifslaviolated)value.Value;
			}
			set
			{
				if (value.HasValue)
