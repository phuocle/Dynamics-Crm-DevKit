...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class Mailbox : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.MailboxOptionSets.ACSOutgoingEmailStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.MailboxOptionSets.ACSOutgoingEmailStatus.Not_Run"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.MailboxOptionSets.ACSOutgoingEmailStatus? ACSOutgoingEmailStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ACSOutgoingEmailStatus);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.MailboxOptionSets.ACSOutgoingEmailStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
