...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class EntityAnalyticsConfig : EntityBase
	{
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource.Dataverse"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource? EntityDataSource
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EntityDataSource);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource)value.Value;
			}
			set
			{
				if (value.HasValue)
