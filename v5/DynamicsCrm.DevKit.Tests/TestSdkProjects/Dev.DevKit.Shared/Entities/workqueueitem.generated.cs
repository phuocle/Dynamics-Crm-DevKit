...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class workqueueitem : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.workqueueitemOptionSets.slastatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.workqueueitemOptionSets.slastatus.NotSet"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.workqueueitemOptionSets.slastatus? slastatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.slastatus);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.workqueueitemOptionSets.slastatus)value.Value;
			}
			set
			{
				if (value.HasValue)
