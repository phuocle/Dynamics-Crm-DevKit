...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class connector : EntityBase
	{
		public struct Fields
		{
			...
			public const string ExtensionAssemblyId = "extensionassemblyid";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ExtensionAssemblyId</para>
		/// <para><strong>Description</strong>: Unique identifier of the Extension assembly location containing the CustomCodeBlobContent.</para>
		/// <para><strong>Lookup</strong>:</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference ExtensionAssemblyId
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.ExtensionAssemblyId); }
			set { Entity.Attributes[Fields.ExtensionAssemblyId] = value; }
		}
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
		/// </summary>
