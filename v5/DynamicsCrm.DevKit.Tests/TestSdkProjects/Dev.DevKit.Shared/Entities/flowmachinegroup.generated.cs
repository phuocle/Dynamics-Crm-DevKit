...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class flowmachinegroup : EntityBase
	{
		public struct Fields
		{
			...
			public const string ManagedVersion = "managedversion";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Managed Version</para>
		/// <para><strong>Description</strong>: Managed Version.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.ManagedVersion"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.ManagedVersion? ManagedVersion
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ManagedVersion);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.ManagedVersion)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.ManagedVersion] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.ManagedVersion] = null;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.UsageType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.UsageType.RpaOnly"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.UsageType? UsageType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.UsageType);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.flowmachinegroupOptionSets.UsageType)value.Value;
			}
			set
			{
				if (value.HasValue)
