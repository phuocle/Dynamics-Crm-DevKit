...
namespace Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class v4_accountbpf : EntityBase
	{
		...
		public const string EntityLogicalName = "v4_accountbpf";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 10919;
		public const string EntityCollectionSchemaName = "v4_accountbpfs";
		public const string EntityDisplayCollectionName = "AccountBPF";
		public const string DisplayName = "AccountBPF";
		public const string EntitySetName = "v4_accountbpfs";
		public const string EntityLogicalCollectionName = "v4_accountbpfs";
		...
		public const string EntitySchemaName = "v4_accountbpf";
		[DebuggerNonUserCode()]
		public v4_accountbpf()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public v4_accountbpf(Guid v4_accountbpfId)
		{
			Entity = new Entity(EntityLogicalName, v4_accountbpfId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public v4_accountbpf(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="v4_accountbpf"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public v4_accountbpf(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="v4_accountbpf"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public v4_accountbpf(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new v4_accountbpf(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="v4_accountbpf"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public v4_accountbpf(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new v4_accountbpf(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public v4_accountbpf(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>Description</strong>: Status of the AccountBPF</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the AccountBPF</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.v4_accountbpfOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
