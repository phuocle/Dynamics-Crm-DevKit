...
namespace Dev.DevKit.Shared.Entities.RibbonTabToCommandMapOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RibbonTabToCommandMap : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
