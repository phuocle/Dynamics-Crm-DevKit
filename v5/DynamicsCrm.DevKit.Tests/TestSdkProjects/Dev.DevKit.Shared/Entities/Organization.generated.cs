...
//		Last Modified: 2026-01-23 17:10:27
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.DevKit.Shared.Entities.OrganizationOptionSets
{
	...
	public enum CuaFlowLogsVerbosity
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: All data</para>
		/// <para><strong>Value</strong>: 0</para>
		/// </summary>
		All_data = 0,
		/// <summary>
		/// <para><strong>Display Name</strong>: Data without screenshots</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Data_without_screenshots = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Minimal</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Minimal = 2
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class Organization : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Block URLs and images in Copilot Studio responses</para>
		/// <para><strong>Description</strong>: Enable this feature to block URLs and images in Copilot Studio and agent responses for an individual environment. URLs will be replaced with placeholders.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.BlockUrlsInResponsesForCopilotStudio); }
			set { Entity.Attributes[Fields.BlockUrlsInResponsesForCopilotStudio] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Computer use logs verbosity</para>
		/// <para><strong>Description</strong>: Set the level of detail the computer use logs allow.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.OrganizationOptionSets.CuaFlowLogsVerbosity"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.OrganizationOptionSets.CuaFlowLogsVerbosity.All_data"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.OrganizationOptionSets.CuaFlowLogsVerbosity? CuaFlowLogsVerbosity
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CuaFlowLogsVerbosity);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.OrganizationOptionSets.CuaFlowLogsVerbosity)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.CuaFlowLogsVerbosity] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.CuaFlowLogsVerbosity] = null;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.OrganizationOptionSets.DesktopFlowRunActionLogVerbosity"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.OrganizationOptionSets.DesktopFlowRunActionLogVerbosity.Full"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.OrganizationOptionSets.DesktopFlowRunActionLogVerbosity? DesktopFlowRunActionLogVerbosity
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DesktopFlowRunActionLogVerbosity);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.OrganizationOptionSets.DesktopFlowRunActionLogVerbosity)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable the redirection to Modern Settings</para>
		/// <para><strong>Description</strong>: Enable the redirection to Modern Settings</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? EnableRedirectionToModernSettings
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.EnableRedirectionToModernSettings); }
			set { Entity.Attributes[Fields.EnableRedirectionToModernSettings] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable or disable Sensitivity Labels in Email</para>
		/// <para><strong>Description</strong>: Enable or disable Sensitivity Labels in Email.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.EnableSensitivityLabels); }
			set { Entity.Attributes[Fields.EnableSensitivityLabels] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable CUA on Hosted Groups v2 feature for this organization</para>
		/// <para><strong>Description</strong>: Indicates whether CUA on Hosted Groups V2 feature is enabled in this organization.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsCuaOnHmgV2Enabled); }
			set { Entity.Attributes[Fields.IsCuaOnHmgV2Enabled] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable version control for Desktop Flows in this organization.</para>
		/// <para><strong>Description</strong>: Indicates whether version control for Desktop Flows is enabled in this organization.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsDesktopFlowVersionControlEnabled); }
			set { Entity.Attributes[Fields.IsDesktopFlowVersionControlEnabled] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Opt-in of version control for Desktop Flows being automatically enabled for this organization.</para>
		/// <para><strong>Description</strong>: Indicates if this organization will opt-in to automatically to enable version control for Desktop Flows.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsDesktopFlowVersionControlEnabledByDefault); }
			set { Entity.Attributes[Fields.IsDesktopFlowVersionControlEnabledByDefault] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable Process Mining for this organization</para>
		/// <para><strong>Description</strong>: Indicates whether Process Mining is enabled in this organization.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsProcessMiningEnabled); }
			set { Entity.Attributes[Fields.IsProcessMiningEnabled] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable sending CUA audit logs to Purview</para>
		/// <para><strong>Description</strong>: Indicates whether sending CUA audit logs to Purview is enabled.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsSendCuaAuditLogToPurviewEnabled); }
			set { Entity.Attributes[Fields.IsSendCuaAuditLogToPurviewEnabled] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enable CUA log upload to Dataverse</para>
		/// <para><strong>Description</strong>: Indicates whether CUA log upload to Dataverse is enabled.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsUploadCuaLogToDataverseEnabled); }
			set { Entity.Attributes[Fields.IsUploadCuaLogToDataverseEnabled] = value; }
		}
		/// <summary>
