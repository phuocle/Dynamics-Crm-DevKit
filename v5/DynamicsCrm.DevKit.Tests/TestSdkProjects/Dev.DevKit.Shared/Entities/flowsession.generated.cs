...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class flowsession : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parent Desktop Flow Run Id Guid</para>
		/// <para><strong>Description</strong>: The run id of the parent desktop flow run, only used when the Desktop Flow was run by a desktop flow. Used instead of Parent Desktop Flow Run Id when the field is available. Same purpose but keeping only the guid instead of doing a lookup.</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid? ParentDesktopFlowRunGuid
		{
			get { return Entity.GetAttributeValue<Guid?>(Fields.ParentDesktopFlowRunGuid); }
			set { Entity.Attributes[Fields.ParentDesktopFlowRunGuid] = value; }
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.flowsessionOptionSets.SubCategory"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.flowsessionOptionSets.SubCategory.Default"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.flowsessionOptionSets.SubCategory? SubCategory
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SubCategory);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.flowsessionOptionSets.SubCategory)value.Value;
			}
			set
			{
				if (value.HasValue)
