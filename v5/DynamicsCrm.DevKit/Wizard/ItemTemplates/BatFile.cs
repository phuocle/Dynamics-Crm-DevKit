    ...
    internal class BatFile : ItemTemplateBase, IWizard
    {
        ...
        public bool ShouldAddProjectItem(string filePath)
        {
            using (TraceShouldAddProjectItem(filePath))
            {
                ...
                ItemTemplateTelemetry.Log(nameof(BatFile), "batfile", "ShouldAddProjectItem", $"file={filePath}; shouldAdd={shouldAdd}; isDevkitJs={IsDevkitJs}; isPluginManagedIdentity={IsPluginManagedIdentity}");
                return shouldAdd;
            }
