...
{
    internal class CustomAction : ItemTemplateBase, IWizard
    {
        ...
        public void RunStarted(object automationObject, Dictionary<string, string> replacementsDictionary, WizardRunKind runKind, object[] customParams)
        {
            ...
            {
                var form = new FormPlugin(ItemType.CustomAction, replacementsDictionary["$rootnamespace$"]);
                ...
                if (ok)
                {
                    ...
                    var t4Code = await T4Helper.GetT4CodeAsync(ItemType.CustomAction, form.CustomTemplate);
