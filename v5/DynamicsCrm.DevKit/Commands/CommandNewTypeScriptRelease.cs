...
{
    /// <summary>
    /// Command to deploy NEW TypeScript file in Release mode (minified without sourcemap)
    /// Only visible for .ts files
    /// </summary>
    [Command(PackageIds.CommandDeployNewTypeScriptRelease)]
    public class CommandNewTypeScriptRelease : BaseCommand<CommandNewTypeScriptRelease>
    {
