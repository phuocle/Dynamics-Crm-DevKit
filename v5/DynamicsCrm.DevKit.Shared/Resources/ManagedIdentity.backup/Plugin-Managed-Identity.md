...
> [!IMPORTANT]
> If your plugin uses Azure Key Vault with Managed Identity, you **MUST** use specific NuGet package versions. Using newer versions will cause deployment failures!
...
### Example Error (if using wrong versions)

```
Could not load file or assembly 'System.ClientModel, Version=1.0.0.0, Culture=neutral, PublicKeyToken=...'
```

### How to Fix if Already Using Wrong Versions

1. Remove existing package references
2. Clear NuGet cache: `dotnet nuget locals all --clear`
3. Add the correct versions as shown above
