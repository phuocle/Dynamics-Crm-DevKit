...
{
    private readonly ParseRecordUrlTool _tool = new(null!);
    ...
    public void ParseRecordUrl_EmptyInput_ReturnsError()
    {
        ...
        Assert.IsTrue(result.Contains("Error: input is required"));
    }
    ...
    public void ParseRecordUrl_RawGuid_ReturnsUnknownEntity()
    {
        ...
        Assert.IsTrue(result.Contains("[ParsedUrl]"));
        Assert.IsTrue(result.Contains("EntityName: (unknown)"));
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
        Assert.IsTrue(result.Contains("Source: raw GUID"));
    }
    ...
    public void ParseRecordUrl_GuidUpperCase_NormalizedToLower()
    {
        ...
        Assert.IsTrue(result.Contains("RecordId: aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"));
    }
    ...
    public void ParseRecordUrl_MainAspxWithEtn_ReturnsEntity()
    {
        ...
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
        Assert.IsTrue(result.Contains("Source: main.aspx (etn+id)"));
    }
    ...
    public void ParseRecordUrl_MainAspxWithBracedId_DecodesCorrectly()
    {
        ...
        Assert.IsTrue(result.Contains("EntityName: contact"));
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
    }
    ...
    public void ParseRecordUrl_WebApiUrl_ReturnsEntitySetName()
    {
        ...
        Assert.IsTrue(result.Contains("[ParsedUrl]"));
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
        // With null ServiceClient, resolution returns null → uses entitySetName as-is
    ...
    public void ParseRecordUrl_MakerFlowUrl_ReturnsWorkflow()
    {
        ...
        Assert.IsTrue(result.Contains("EnvironmentId: 11111111-1111-1111-1111-111111111111"));
    ...
    public void ParseRecordUrl_MakerFlowRunUrl_ReturnsFlowSession()
    {
        ...
        Assert.IsTrue(result.Contains("EntityName: flowsession"));
        Assert.IsTrue(result.Contains("RecordId: 33333333-3333-3333-3333-333333333333"));
        Assert.IsTrue(result.Contains("EnvironmentId: 11111111-1111-1111-1111-111111111111"));
        Assert.IsTrue(result.Contains("FlowId: 22222222-2222-2222-2222-222222222222"));
    }
    ...
    public void ParseRecordUrl_ReportViewer_ReturnsReport()
    {
        ...
        Assert.IsTrue(result.Contains("EntityName: report"));
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
    ...
    public void ParseRecordUrl_RunDialogUrl_ReturnsEntity()
    {
        ...
        Assert.IsTrue(result.Contains("EntityName: account"));
        Assert.IsTrue(result.Contains("RecordId: 11111111-2222-3333-4444-555555555555"));
        Assert.IsTrue(result.Contains("rundialog.aspx"));
    }
