...
DynamicsCrm.DevKit/
Γö£ΓöÇΓöÇ v4/
Γöé   Γö£ΓöÇΓöÇ DynamicsCrm.DevKit.Shared/
Γöé   Γöé   Γö£ΓöÇΓöÇ Models/
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ CrmConnection.cs                    [MODIFY]
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ DevKitConnections.cs                [MODIFY]
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ ConnectionMetadata.cs               [NEW]
Γöé   Γöé   Γö£ΓöÇΓöÇ Helper.cs                               [MODIFY]
Γöé   Γöé   Γö£ΓöÇΓöÇ Const.cs                                [MODIFY]
Γöé   Γöé   ΓööΓöÇΓöÇ ConnectionBuilder/                      [NEW FOLDER]
Γöé   Γöé       Γö£ΓöÇΓöÇ IConnectionBuilder.cs               [NEW]
Γöé   Γöé       Γö£ΓöÇΓöÇ InteractiveConnectionBuilder.cs     [NEW]
Γöé   Γöé       Γö£ΓöÇΓöÇ DeviceCodeConnectionBuilder.cs      [NEW]
Γöé   Γöé       Γö£ΓöÇΓöÇ ClientCertificateConnectionBuilder.cs [NEW]
Γöé   Γöé       Γö£ΓöÇΓöÇ ManagedIdentityConnectionBuilder.cs [NEW]
Γöé   Γöé       Γö£ΓöÇΓöÇ DefaultAzureCredentialConnectionBuilder.cs [NEW]
Γöé   Γöé       ΓööΓöÇΓöÇ PacCliConnectionBuilder.cs          [NEW]
Γöé   Γö£ΓöÇΓöÇ DynamicsCrm.DevKit.Cli/
Γöé   Γöé   Γö£ΓöÇΓöÇ Program.cs                              [MODIFY]
Γöé   Γöé   Γö£ΓöÇΓöÇ Models/
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ CommandLineArgs.cs                  [MODIFY]
Γöé   Γöé   Γö£ΓöÇΓöÇ ProjectUrlAutoParser.cs                 [NEW]
Γöé   Γöé   Γö£ΓöÇΓöÇ PacCliIntegration.cs                    [NEW]
Γöé   Γöé   Γö£ΓöÇΓöÇ ConnectionManager.cs                    [NEW]
Γöé   Γöé   ΓööΓöÇΓöÇ docs/
Γöé   Γöé       ΓööΓöÇΓöÇ README.md                           [MODIFY]
Γöé   Γö£ΓöÇΓöÇ DynamicsCrm.DevKit/
Γöé   Γöé   Γö£ΓöÇΓöÇ Lib/
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ Forms/
Γöé   Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ FormConnection.xaml             [MODIFY]
Γöé   Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ FormConnection.xaml.cs          [MODIFY]
Γöé   Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ FormConnectionManager.xaml      [NEW]
Γöé   Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ FormConnectionManager.xaml.cs   [NEW]
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ VsixHelper.cs                       [MODIFY]
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ ProjectUrlDetector.cs               [NEW]
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ ConnectionHealth.cs                 [NEW]
Γöé   Γöé   ΓööΓöÇΓöÇ Resources/
Γöé   Γöé       ΓööΓöÇΓöÇ [Connection UI resources]           [NEW]
Γöé   ΓööΓöÇΓöÇ docs/
Γöé       Γö£ΓöÇΓöÇ CONNECTION_TYPES.md                     [NEW]
Γöé       Γö£ΓöÇΓöÇ AUTHENTICATION_GUIDE.md                 [NEW]
Γöé       Γö£ΓöÇΓöÇ MIGRATION_GUIDE.md                      [NEW]
Γöé       ΓööΓöÇΓöÇ TROUBLESHOOTING.md                      [NEW]
```
...
public class ConnectionHealth
{
    ...
    public static string GetStatusIcon(CrmConnection connection)
    {
        if (!connection.LastTestSuccess.HasValue)
            return "Γùï"; // Never tested
        
        return connection.LastTestSuccess.Value ? "ΓùÅ" : "ΓÜá";
    }
