...
Γöé Connection Configuration                        Γöé
...
Γöé Saved Connections: [Dropdown Γû╝] [Manage...]    Γöé
Γö£ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöñ
Γöé ΓöîΓöÇ New/Edit Connection ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  Γöé
Γöé Γöé                                            Γöé  Γöé
Γöé Γöé Connection Name: [_____________]           Γöé  Γöé
Γöé Γöé                                            Γöé  Γöé
Γöé Γöé Environment URL: [_____________] [Detect] Γöé  Γöé
Γöé Γöé                                            Γöé  Γöé
Γöé Γöé Authentication Type:                       Γöé  Γöé
Γöé Γöé Γùï Interactive (Browser) [Default]          Γöé  Γöé
Γöé Γöé Γùï Device Code (Headless)                   Γöé  Γöé
Γöé Γöé Γùï Client Secret (App)                      Γöé  Γöé
Γöé Γöé Γùï Client Certificate (Cert)                Γöé  Γöé
Γöé Γöé Γùï Managed Identity (Azure)                 Γöé  Γöé
Γöé Γöé Γùï Azure Credential Chain                   Γöé  Γöé
Γöé Γöé Γùï PAC CLI Profile                          Γöé  Γöé
Γöé Γöé Γùï Username/Password (Legacy)               Γöé  Γöé
Γöé Γöé Γùï Active Directory (On-Prem)               Γöé  Γöé
Γöé Γöé                                            Γöé  Γöé
Γöé Γöé [Dynamic fields based on auth type]        Γöé  Γöé
Γöé Γöé                                            Γöé  Γöé
Γöé Γöé         [Test Connection] [Save]           Γöé  Γöé
...
**Client Certificate**:
- Client ID (required)
- Certificate Source: Γùï File  Γùï Store
- [If File]: Browse, Password
- [If Store]: Thumbprint, Location, Store Name

**Managed Identity**:
- Identity Type: Γùï System  Γùï User
- [If User]: Client ID
...
Γöé ΓùÅ MyDev (https://dev.crm.dynamics.com)  Γöé ΓåÉ Green = Last tested OK
Γöé ΓùÅ UAT (https://uat.crm.dynamics.com)    Γöé
Γöé Γùï Prod (https://prod.crm.dynamics.com)  Γöé ΓåÉ Gray = Never tested
Γöé ΓÜá Old (https://old.crm.dynamics.com)    Γöé ΓåÉ Yellow = Test failed
...
New menu item: **Tools ΓåÆ DynamicsCrm DevKit ΓåÆ Manage Connections**
...
2. Tools ΓåÆ DynamicsCrm DevKit ΓåÆ Manage Connections
