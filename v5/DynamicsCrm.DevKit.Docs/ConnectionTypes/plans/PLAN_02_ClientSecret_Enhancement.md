...
3. Go to Settings ΓåÆ Users + permissions ΓåÆ Application users
...
**Expected Result**: Γ£à ClientId and Secret ready for use
...
1. Power Platform Admin Center ΓåÆ Select environment
2. Settings ΓåÆ Users + permissions ΓåÆ Application users
...
**Expected Result**: Γ£à App user created and has permissions
...
**Expected Result**: Γ£à Connection succeeds (no browser prompt, direct auth)
...
**Expected Result**: Γ£à Connection includes ClientSecret type:
```json
{
  "Name": "ClientSecretTest",
  "Type": "ClientSecret",
...
**Expected Result**: Γ£à Error message: "ClientId must be a valid GUID"
...
**Expected Result**: Γ£à Error message: "ClientSecret cannot be empty"
...
**Expected Result**: Γ£à Error message: "URL must use HTTPS protocol"
...
**Expected Result**: Γ£à Warning dialog appears:
```
...
**Expected Result**: Γ£à Warning shows "Client Secret has expired"
...
**Expected Result**: Γ£à Authentication succeeds, deployment proceeds
...
**Expected Result**: Γ£à Auth restricted to specified tenant
...
**Expected Result**: Γ£à Error message displayed before attempting connection
...
**Expected Result**: Γ£à Pipeline runs successfully, no interactive prompts
