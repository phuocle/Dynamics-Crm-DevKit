...
- Mỗi tool sau khi build xong phải có 1 file test call mẫu tại DynamicsCrm.DevKit.Docs/testcall/{N}.{tool_name}.md (N là số thứ tự đọc được từ devkit mcp --tools) gồm 4 section H1: (1) Tool description AI đọc được, (2) Input tool call, (3) Output tool call, (4) Kết quả AI tổng hợp lại. Ví dụ: 9.whoami.md
