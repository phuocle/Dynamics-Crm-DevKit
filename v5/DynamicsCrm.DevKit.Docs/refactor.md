- Bỏ qua hết các code unit test, làm sau, do đó khi build thì dùng file @build-cli.md để build vì nó sẽ kill process mcp hiện tại và mcp sẽ tự động restart để test lại
