...
```text
SUMMARY: CRUD one Dataverse record. Create/update use fields_json; read can limit columns; delete is irreversible and follows relationship cascade rules.
...
Token sau optimize: 139
Tiết kiệm: 98 tokens (41.4%).
