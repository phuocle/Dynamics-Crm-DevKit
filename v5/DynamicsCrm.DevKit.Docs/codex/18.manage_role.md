...
```text
SUMMARY: Manage Dataverse security roles: list, inspect privileges, inspect a user's roles/effective privileges, assign/unassign, create/update/delete, or copy roles.
...
Token sau optimize: 192
Tiết kiệm: 256 tokens (57.1%).
