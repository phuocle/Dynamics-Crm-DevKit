...
[records_json] (string, required)
Inline JSON array, or .json/.csv file path. Max 5000.
...
|---|---:|---:|---:|
| Description | ~135 tokens | ~85 tokens | -37% |
| Parameters (3) | ~75 tokens | ~45 tokens | -40% |
| **Tổng** | **~210 tokens** | **~130 tokens** | **~38%** |

**Kết luận:** Tiết kiệm khoảng **38%** (~80 tokens). Gom DEFAULT block vào param `max_parallelism`, giữ đầy đủ syntax polymorphic và CSV behavior.
