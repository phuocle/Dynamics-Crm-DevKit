...
**Token hiện tại (description + parameters):** ~358 tokens
...
|---|---:|---:|---:|
| Description | ~178 tokens | ~78 tokens | -56% |
| Parameters (9) | ~180 tokens | ~110 tokens | -39% |
| **Tổng** | **~358 tokens** | **~188 tokens** | **~47%** |

**Kết luận:** Tiết kiệm khoảng **47%** (~170 tokens). Gom syntax pairs và bỏ phần WHEN TO USE chồng lấp ACTIONS.
