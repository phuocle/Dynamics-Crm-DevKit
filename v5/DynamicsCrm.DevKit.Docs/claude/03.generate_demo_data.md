...
**Token hiện tại (description + parameters):** ~681 tokens (o200k_base)
...
| **Tổng** | **~681 tokens** | **~345 tokens** | **~49%** |

**Kết luận:** Tiết kiệm khoảng **49%** (~336 tokens). Restore WHEN TO USE block riêng theo convention.
