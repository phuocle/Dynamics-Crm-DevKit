...
**Token hiện tại (description + parameters):** ~350 tokens (`o200k_base`)
...
| **Tổng** | **~350 tokens** | **~235 tokens** | **~33%** |

**Kết luận:** Tiết kiệm khoảng **33%** (~115 tokens). Restore WHEN TO USE riêng + fuzzy disambiguation rule cho `name_filter`. Description giữ KEY OUTPUT FIELDS.
