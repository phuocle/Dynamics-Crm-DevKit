...
**Token hiện tại (description + parameters):** ~237 tokens
...
| **Tổng** | **~237 tokens** | **~167 tokens** | **~29.5%** |

**Kết luận:** Tiết kiệm khoảng **29.5%** (~70 tokens). Restore WHEN TO USE block riêng.
