...
**Token hiện tại (description + parameters):** ~332 tokens (`o200k_base`)
...
| **Tổng** | **~332 tokens** | **~208 tokens** | **~37%** |

**Kết luận:** Tiết kiệm khoảng **37%** (~124 tokens). Restore WHEN TO USE riêng.
