...
**Token hiện tại (description + parameters):** ~445 tokens (Claude) / 532 tokens (o200k_base)
...
|---|---:|---:|---:|
| Description | ~210 tokens | ~185 tokens | -12% |
| Parameters (11) | ~235 tokens | ~120 tokens | -49% |
| **Tổng** | **~445 tokens** | **~305 tokens** | **~31%** |

**Kết luận:** Tiết kiệm khoảng **31%** (~140 tokens). Restore WHEN TO USE riêng. Gom 12 file types vào description, params chỉ trỏ đến. Thêm SAFETY block.
