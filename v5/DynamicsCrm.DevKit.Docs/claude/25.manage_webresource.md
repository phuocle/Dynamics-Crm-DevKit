...
|---|---:|---:|---:|
| Description | ~210 tokens | ~180 tokens | -14% |
| Parameters (11) | ~235 tokens | ~120 tokens | -49% |
| **Tổng** | **~445 tokens** | **~300 tokens** | **~33%** |

**Kết luận:** Tiết kiệm khoảng **33%** (~145 tokens). Restore WHEN TO USE riêng. Gom 12 file types vào description, params chỉ trỏ đến.
