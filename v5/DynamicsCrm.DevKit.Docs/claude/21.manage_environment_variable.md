...
**Token hiện tại (description + parameters):** ~400 tokens (`o200k_base`)
...
| **Tổng** | **~400 tokens** | **~206 tokens** | **~48%** |

**Kết luận:** Tiết kiệm khoảng **48%** (~194 tokens). Restore WHEN TO USE block riêng. Token estimate dùng `o200k_base` tokenizer.
