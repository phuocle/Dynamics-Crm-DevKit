...
|---|---:|---:|---:|
| Description | ~365 tokens | ~225 tokens | -38% |
| Parameters (7) | ~225 tokens | ~95 tokens | -58% |
| **Tổng** | **~590 tokens** | **~320 tokens** | **~46%** |

**Kết luận:** Tiết kiệm khoảng **46%** (~270 tokens). Bỏ 2 lần lặp "NEVER infer" trong params, giữ ngữ pháp đầy đủ của 6 operators.
