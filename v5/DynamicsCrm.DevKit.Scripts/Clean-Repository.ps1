...
Get-ChildItem -Path "$ProjectRoot\Published" -Directory -Recurse -Filter "*_extracted*" -ErrorAction SilentlyContinue | ForEach-Object {
...
Get-ChildItem -Path $ProjectRoot -Recurse -Filter "*.user" -ErrorAction SilentlyContinue | ForEach-Object {
    Write-Host "  Removing: $($_.FullName)" -ForegroundColor DarkGray
...
Get-ChildItem -Path $ProjectRoot -Recurse -Filter "*.suo" -Force -ErrorAction SilentlyContinue | ForEach-Object {
    Write-Host "  Removing: $($_.FullName)" -ForegroundColor DarkGray
    Remove-Item $_.FullName -Force -ErrorAction SilentlyContinue
}
