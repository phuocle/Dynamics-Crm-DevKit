    ...
    public static class SpectreLog
    {
        ...
        public static void WriteHelp()
        {
            var helpContent =
                ...
                "  devkit mcp                    18 tools + 6 resources: metadata, CRUD, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views\n" +
            ...
            var panel = new Panel(
                new Markup(
                    ...
                    "  devkit [cyan]mcp[/]                    18 tools + 6 resources: metadata, CRUD, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views\n" +
