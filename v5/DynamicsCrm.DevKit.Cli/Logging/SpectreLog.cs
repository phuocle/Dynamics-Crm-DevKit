    ...
    public static class SpectreLog
    {
        ...
        public static void WriteHelp()
        {
            var helpContent =
                ...
                "  devkit mcp                    17 tools + 6 resources: metadata, CRUD, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms\n" +
            ...
            var panel = new Panel(
                new Markup(
                    ...
                    "  devkit [cyan]mcp[/]                    17 tools + 6 resources: metadata, CRUD, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms\n" +
