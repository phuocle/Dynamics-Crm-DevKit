    ...
    public static class SpectreLog
    {
        ...
        public static void WriteHelp()
        {
            var helpContent =
                ...
                "  devkit mcp                    35 tools + 6 resources: metadata, upsert, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views, security, form builder, audit, sitemap, schema, env vars, business rules, workflows, Custom APIs, cloud flows, BPFs, system jobs, plugins, commands, web resources\n" +
            ...
            var panel = new Panel(
                new Markup(
                    ...
                    "  devkit [cyan]mcp[/]                    35 tools + 6 resources: metadata, upsert, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views, security, form builder, audit, sitemap, schema, env vars, business rules, workflows, Custom APIs, cloud flows, BPFs, system jobs, plugins, commands, web resources\n" +
