    ...
    public static class SpectreLog
    {
        ...
        public static void WriteHelp()
        {
            var helpContent =
                ...
                "  devkit mcp                    25 tools + 6 resources: metadata, upsert, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views, security, form builder, audit, sitemap, schema\n" +
            ...
            var panel = new Panel(
                new Markup(
                    ...
                    "  devkit [cyan]mcp[/]                    25 tools + 6 resources: metadata, upsert, FetchXML, search, WebAPI, publish, trace logs, URL parser, forms, views, security, form builder, audit, sitemap, schema\n" +
