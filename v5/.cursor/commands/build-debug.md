...
3. Run the PowerShell script: `DynamicsCrm.DevKit.Scripts\Debug-DynamicsCrm-DevKit.ps1`. If any errors occur, stop and fix them, then restart this workflow from the beginning.
