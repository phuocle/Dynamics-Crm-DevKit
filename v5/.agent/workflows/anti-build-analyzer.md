...
$nugetExe = ".\nuget.exe"
& $nugetExe pack "DynamicsCrm.DevKit.Analyzers.nuspec" -Version "4.99.99.99" -OutputDirectory "..\..\published\4.99.99.99"
```
...
- For full solution build with packaging, use `/anti-build-debug` workflow instead
