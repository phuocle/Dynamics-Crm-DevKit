...
Build **only** the Tool project (faster than `/anti-build-debug`), pack it as a .NET global tool, and install locally for testing.
...
- For full solution build, use `/anti-build-debug` workflow instead
