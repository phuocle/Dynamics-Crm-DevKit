...
namespace DynamicsCrm.DevKit.Cli.UnitTests.Cli.Mcp.ManageCommand;
...
public class ManageCommandToolTests
{
    ...
    public void Validation_AddFlyoutInputs_ReturnErrors()
    {
        ...
        StringAssert.Contains(GetText(tool.manage_command(action: "add_flyout", entity_name: "account", location: "form", label: "More", items: "{bad")), "JsonParseError");
    ...
    public void Validation_AddSplitButtonInputs_ReturnErrors()
    {
        ...
        StringAssert.Contains(GetText(tool.manage_command(action: "add_split_button", entity_name: "account", location: "form", label: "More", items: "{bad")), "JsonParseError");
