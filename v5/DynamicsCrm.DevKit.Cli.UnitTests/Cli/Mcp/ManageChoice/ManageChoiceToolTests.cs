...
namespace DynamicsCrm.DevKit.Cli.UnitTests.Cli.Mcp.ManageChoice;
...
public class ManageChoiceToolTests
{
    ...
    public void DryRunResult_ContainsDryRunPrefix()
    {
        ...
        Assert.IsTrue(result.StructuredContent!.Value.ToString().Contains("dryRun", StringComparison.OrdinalIgnoreCase));
