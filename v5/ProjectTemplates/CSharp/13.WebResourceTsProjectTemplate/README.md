...
# DynamicsCrm.DevKit WebResource TypeScript Project Template
...
* [Client-side scripting with JavaScript](https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/client-scripting)
