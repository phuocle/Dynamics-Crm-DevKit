...
namespace DevKit.Workflow._2
{
    [CrmPluginRegistration("SystemDebug", "SystemDebug", "", "DevKit.Workflow._2", IsolationModeEnum.Sandbox)]
    public class SystemDebug : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: SystemDebug");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: SystemDebug");
        }
    }
}
