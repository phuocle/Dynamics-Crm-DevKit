...
namespace Dev.DevKit.PluginTerritory
{
    ...
    /// </summary>
    [CrmPluginRegistration("Update", "territory", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "name", "Dev.DevKit.PluginTerritory.DEVKIT1015_BlockingAsync", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin)]
