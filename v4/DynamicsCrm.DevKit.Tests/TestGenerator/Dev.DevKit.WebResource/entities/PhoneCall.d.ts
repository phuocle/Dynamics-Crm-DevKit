...
declare namespace DevKit {
	export class PhoneCallApi {
		...
		*/
		constructor(entity?: Record<string, any>) : DevKit.PhoneCallApi;
		/**
		...
		regardingobjectid_account_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_adx_invitation_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_contact_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_knowledgearticle_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_knowledgebaserecord_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_adplacement_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_pollplacement_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_publishingstatetransitionrule_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_redirect_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_shortcut_phonecall: string | null;
		/** Choose the record that the phone call relates to. */
		regardingobjectid_mspp_website_phonecall: string | null;
