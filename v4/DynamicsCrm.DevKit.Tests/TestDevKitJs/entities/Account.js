...
var formAccount_DevKitV4 = (function () {
	...
	function TestWebResource() {
		...
		try {
			...
			// R5: ControlParent
			results.push({ Test: "R5", Property: "ControlParent", Value: form.Body.WebResource_DevKitV4.ControlParent ? "object" : "null", Status: form.Body.WebResource_DevKitV4.ControlParent ? "✓" : "⚠" });

			// R6: Src
			results.push({ Test: "R6", Property: "Src", Value: form.Body.WebResource_DevKitV4.Src ? form.Body.WebResource_DevKitV4.Src.substring(0, 60) + "..." : "null", Status: form.Body.WebResource_DevKitV4.Src !== undefined ? "✓" : "⚠" });

			// R7: Object (returns the WebResource HTML element)
			results.push({ Test: "R7", Property: "Object", Value: form.Body.WebResource_DevKitV4.Object ? "HTMLIFrameElement" : "null", Status: form.Body.WebResource_DevKitV4.Object !== undefined ? "✓" : "⚠" });

			// R8: ContentWindow (method that returns promise or uses callbacks)
			try {
				// Check if ContentWindow is a function
				results.push({ Test: "R8", Property: "ContentWindow", Value: typeof form.Body.WebResource_DevKitV4.ContentWindow === "function" ? "Method exists" : "Not a function", Status: typeof form.Body.WebResource_DevKitV4.ContentWindow === "function" ? "✓" : "⚠" });
			} catch (/** @type {any} */ e) {
				results.push({ Test: "R8", Property: "ContentWindow", Value: e.message, Status: "✗" });
			}
		} catch (/** @type {any} */ error) {
			results.push({ Test: "ERR", Property: "Props Error", Value: error.message, Status: "✗" });
		}
		...
		try {
			...
			const check = form.Body.WebResource_DevKitV4.Visible;
			form.Body.WebResource_DevKitV4.Visible = origVisible;
		...
		try {
			...
			const check = form.Body.WebResource_DevKitV4.Disabled;
			form.Body.WebResource_DevKitV4.Disabled = origDisabled;
