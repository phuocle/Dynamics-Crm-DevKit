...
(function (DevKit) {
	...
	DevKit.FormContact = function(executionContext, defaultWebResourceName) {
		const form = {
			...
			header: ["OwnerId"],
			navigation: ["account_primary_contact", "adx_contact_externalidentity", "adx_invitation_invitecontact", "adx_invitation_invitercontact", "adx_invitation_redeemedContact", "adx_webformsession_contact", "contact_adx_inviteredemptions", "contact_adx_portalcomments", "Contact_Appointments", "contact_customer_contacts", "contact_DeletedItemReferences", "Contact_Email_EmailSender", "Contact_Emails", "Contact_ExternalPartyItems", "Contact_Feedback", "Contact_Phonecalls", "Contact_Tasks", "lk_contact_feedback_createdby", "lk_contact_feedback_createdonbehalfby", "PowerPagesSiteAIFeedback_Contact_Contact"],
		};
