...
|---|-----------|--------------|---------|
| 13 | Decimal | `form.Body.v4_Latitude` | Min, Max, Precision |
| 14 | Double | `form.Body.v4_DiscountPercentage` | Min, Max, Precision |
| 15 | MultiOptionSet | `form.Body.v4_Categories` | Same as OptionSet but arrays |
