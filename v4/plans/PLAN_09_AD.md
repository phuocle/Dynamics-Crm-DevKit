...
Active Directory - maintain existing, no changes

## Reference Implementation

See `CONNECTION_TYPES_PRIORITY_ORDER.md` for detailed implementation specifications.

From Rnwood.Dataverse.Data.PowerShell, the pattern for AD:
...
### New Files
- `v4/DynamicsCrm.DevKit.Shared/ConnectionBuilder/ADConnectionBuilder.cs`
...
**Test File**: `v4/DynamicsCrm.DevKit.Shared.Tests/ADConnectionTests.cs`

AI Prompt:
```
Create unit tests for AD connection:
...
```csharp
[TestClass]
public class ADConnectionTests
{
    [TestMethod]
...
**Running Tests**:
```powershell
dotnet test --filter "FullyQualifiedName~ADConnection"
```
...
#### Test Scenario 1: On-premises with domain account

**Step 1**: Setup environment
- Configure AD in appropriate environment
...
#### Test Scenario 2: Windows authentication validation

**Step 1**: Configure second scenario
- Setup Windows authentication validation environment
