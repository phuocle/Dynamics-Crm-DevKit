...
(function (Rocket) {
	'use strict';
	Rocket.SystemUserApi = function (e) {
		var EMPTY_STRING = '';
		...
		var systemuser = {
			...
			BusinessUnitIdName: { a: 'businessunitidname', r: true },
			...
			DefaultMailboxName: { a: 'defaultmailboxname', r: true },
			...
			MobileOfflineProfileIdName: { a: 'mobileofflineprofileidname' },
			...
			OrganizationIdName: { a: 'organizationidname', r: true },
			...
			ParentSystemUserIdName: { a: 'parentsystemuseridname', r: true },
			...
			PositionIdName: { a: 'positionidname', r: true },
			...
			QueueIdName: { a: 'queueidname', r: true },
			...
			TerritoryIdName: { a: 'territoryidname', r: true },
