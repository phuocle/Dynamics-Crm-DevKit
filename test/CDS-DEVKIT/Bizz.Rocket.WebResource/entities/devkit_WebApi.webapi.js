...
(function (Rocket) {
	...
	Rocket.devkit_WebApiApi = function (e) {
		...
		var devkit_webapi = {
			...
			devkit_CustomerId_account: { b: 'devkit_CustomerId_account', a: '_devkit_value', c: 'accounts', d: 'account' },
			devkit_CustomerId_contact: { b: 'devkit_CustomerId_contact', a: '_devkit_value', c: 'contacts', d: 'contact' },
