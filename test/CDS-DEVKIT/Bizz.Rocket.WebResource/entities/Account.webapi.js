...
(function (Rocket) {
	...
	Rocket.AccountApi = function (e) {
		...
		var account = {
			...
			CreatedByExternalPartyName: { a: 'createdbyexternalpartyname', r: true },
			CreatedByExternalPartyYomiName: { a: 'createdbyexternalpartyyominame', r: true },
			...
			MasterAccountIdYomiName: { a: 'masteraccountidyominame', r: true },
			...
			ModifiedByExternalPartyName: { a: 'modifiedbyexternalpartyname', r: true },
			ModifiedByExternalPartyYomiName: { a: 'modifiedbyexternalpartyyominame', r: true },
			...
			ParentAccountIdName: { a: 'parentaccountidname', r: true },
			ParentAccountIdYomiName: { a: 'parentaccountidyominame', r: true },
			...
			PreferredSystemUserIdName: { a: 'preferredsystemuseridname', r: true },
			PreferredSystemUserIdYomiName: { a: 'preferredsystemuseridyominame', r: true },
			PrimaryContactId: { b: 'primarycontactid', a: '_primarycontactid_value', c: 'contacts', d: 'contact' },
			PrimaryContactIdName: { a: 'primarycontactidname', r: true },
			PrimaryContactIdYomiName: { a: 'primarycontactidyominame', r: true },
