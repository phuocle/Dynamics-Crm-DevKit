...
describe("devkit_WebApi.test", function () {
    var fakeUrl = "https://devkit.local";
    var xhr;
    ...
    describe("OnLoad", function () {
        it("Retrieve OptionSet", function () {
            //setup
            var data = {
                "@odata.context": "https://devkit.local/api/data/v9.1/$metadata#devkit_webapis(statecode,devkit_webapiid,devkit_singleoptionsetcodecalculated,devkit_singleoptionsetcode,devkit_multioptionsetcode,statuscode)",
