...
namespace Delta.Beta.WorkflowAccount
{
    [CrmPluginRegistration("ReCalculatedAllFields", "ReCalculatedAllFields", "", "Delta.Beta.WorkflowAccount", IsolationModeEnum.Sandbox)]
    public class ReCalculatedAllFields : CodeActivity
    {
