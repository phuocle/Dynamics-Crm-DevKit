...
namespace Dev.DevKit.CustomActionTest
{
    [TestClass]
    public class PostNonedevkit_CustomActionSyncSynchronousTest : FakeXrmEasyTestBase
    {
        private const StageEnum PLUGIN_STAGE = StageEnum.PostOperation;
        private const string PLUGIN_MESSAGE = "devkit_CustomActionSync";
        private const string PLUGIN_ENTITY_LOGICAL_NAME = "none";
        private const ExecutionModeEnum PLUGIN_EXECUTION_MODE = ExecutionModeEnum.Synchronous;

        [TestMethod]
        public void PostNonedevkit_CustomActionSyncSynchronousTest_00()
        {
            var pluginContext = _context.GetDefaultPluginContext();
            Assert.ThrowsException<InvalidPluginExecutionException>(() =>
            {
                _context.ExecutePluginWith<PostNonedevkit_CustomActionSyncSynchronous>(pluginContext);
            ...
            var @class = new PostNonedevkit_CustomActionSyncSynchronous();
        ...
        [TestMethod]
        public void PostNonedevkit_CustomActionSyncSynchronousTest_01()
        {
            ////setup
            //var json = @"";
