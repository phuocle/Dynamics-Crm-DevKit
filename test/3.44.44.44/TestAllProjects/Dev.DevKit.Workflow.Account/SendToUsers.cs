...
{
    [CrmPluginRegistration("SendToUsers", "SendToUsers", "", "Dev.DevKit.Workflow.Account", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class SendToUsers : CodeActivity
    {
