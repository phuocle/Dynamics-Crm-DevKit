...
(function (Tfsvn) {
	Tfsvn.AccountApi = function (e) {
		...
		const _account = {
			...
			hs_debug_context: { a: 'hs_debug_context' },
			hs_no_active_case_rollup: { a: 'hs_no_active_case_rollup', r: true, g: 'Integer' },
			hs_no_active_case_rollup_Date_UtcDateAndTime: { a: 'hs_no_active_case_rollup_date', r: true, g: 'DateTime' },
			hs_no_active_case_rollup_State: { a: 'hs_no_active_case_rollup_state', r: true, g: 'Integer' },
			hs_no_resolved_case_rollup: { a: 'hs_no_resolved_case_rollup', r: true, g: 'Integer' },
			hs_no_resolved_case_rollup_Date_UtcDateAndTime: { a: 'hs_no_resolved_case_rollup_date', r: true, g: 'DateTime' },
			hs_no_resolved_case_rollup_State: { a: 'hs_no_resolved_case_rollup_state', r: true, g: 'Integer' },
			hs_tax_id: { a: 'hs_tax_id' },
