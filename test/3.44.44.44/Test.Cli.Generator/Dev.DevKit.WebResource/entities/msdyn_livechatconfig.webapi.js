...
(function (DevKit) {
	...
	DevKit.msdyn_livechatconfigApi = function (e) {
		...
		var _msdyn_livechatconfig = {
			...
			msdyn_authenticatedsigninoptional: { a: 'msdyn_authenticatedsigninoptional' },
			...
			msdyn_botmcssurveyurl: { a: 'msdyn_botmcssurveyurl' },
			...
			msdyn_customanonymoustokenexpirationtime: { a: 'msdyn_customanonymoustokenexpirationtime' },
			...
			msdyn_mcssurveyurl: { a: 'msdyn_mcssurveyurl' },
