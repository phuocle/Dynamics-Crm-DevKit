...
declare namespace DevKit {
	namespace FormBusinessUnit_Information {
		...
		interface Navigation {
			...
			business_unit_equipment: DevKit.Controls.NavigationItem,
			business_unit_feedback: DevKit.Controls.NavigationItem,
			business_unit_mailmergetemplates: DevKit.Controls.NavigationItem,
			business_unit_msdynmkt_virtualsegment: DevKit.Controls.NavigationItem,
			...
			business_unit_resource_groups: DevKit.Controls.NavigationItem,
			business_unit_resources: DevKit.Controls.NavigationItem,
			...
			msdynmkt_businessunit_msdynmkt_virtualdomain_owningbusinessunit: DevKit.Controls.NavigationItem,
			msdynmkt_parentowningbusinessunit_businessunit: DevKit.Controls.NavigationItem
		}
	}
	class FormBusinessUnit_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form BusinessUnit_Information */
		Navigation: DevKit.FormBusinessUnit_Information.Navigation;
		/** The SidePanes of form BusinessUnit_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace FormTeam_Information {
		interface tab_addresses_Sections {
			bill_to_address: DevKit.Controls.Section;
			ship_to_address: DevKit.Controls.Section;
		}
		...
		interface Body {
			...
			msdyn_Team: DevKit.Controls.Lookup;
			/** Name of the business unit. */
			Name: DevKit.Controls.String;
			/** Unique identifier for the parent business unit. */
			ParentBusinessUnitId: DevKit.Controls.Lookup;
	...
	class FormTeam_Information extends DevKit.IForm {
		/**
		* Team Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form Team_Information */
		Body: DevKit.FormTeam_Information.Body;
		/** The Navigation of form Team_Information */
		Navigation: DevKit.FormTeam_Information.Navigation;
		/** The SidePanes of form Team_Information */
		SidePanes: DevKit.SidePanes;
	}
