...
(function (DevKit) {
	...
	DevKit.BusinessUnitApi = function (e) {
		...
		var _businessunit = {
			...
			msdyn_Team: { b: 'msdyn_Team', a: '_msdyn_team_value', c: 'teams', d: 'team' },
		...
		for (var field in _businessunit) {
			var a = _businessunit[field].a;
			var b = _businessunit[field].b;
			var c = _businessunit[field].c;
			var d = _businessunit[field].d;
			var g = _businessunit[field].g;
			var r = _businessunit[field].r;
			webApiField(businessunit, field, e, a, b, c, d, r, u, g);
		}
