...
declare namespace DevKit {
	namespace FormOpportunitySalesProcesses {
		interface tab_general_Sections {
			opportunitysalesprocessinformation: DevKit.Controls.Section;
		}
		...
		interface Navigation {
			lk_opportunitysalesprocess_workflowlogs: DevKit.Controls.NavigationItem
		}
	}
	class FormOpportunitySalesProcesses extends DevKit.IForm {
		/**
		* OpportunitySalesProcesses [Main Form]
		...
		*/
		...
		/** The Body section of form OpportunitySalesProcesses */
		Body: DevKit.FormOpportunitySalesProcesses.Body;
		/** The Navigation of form OpportunitySalesProcesses */
		Navigation: DevKit.FormOpportunitySalesProcesses.Navigation;
		/** The SidePanes of form OpportunitySalesProcesses */
		SidePanes: DevKit.SidePanes;
	}
	class OpportunitySalesProcessApi {
		/**
		* DynamicsCrm.DevKit OpportunitySalesProcessApi
