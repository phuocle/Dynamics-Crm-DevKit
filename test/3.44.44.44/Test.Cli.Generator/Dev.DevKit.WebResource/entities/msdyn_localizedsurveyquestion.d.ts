...
declare namespace DevKit {
	...
	class Formmsdyn_localizedsurveyquestion_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_localizedsurveyquestion_Information */
		Navigation: DevKit.Formmsdyn_localizedsurveyquestion_Information.Navigation;
		/** The SidePanes of form msdyn_localizedsurveyquestion_Information */
	...
	class msdyn_localizedsurveyquestionApi {
		...
		*/
		...
		msdyn_languagecode: OptionSet.msdyn_localizedsurveyquestion.msdyn_languagecode;
		...
		statecode: OptionSet.msdyn_localizedsurveyquestion.statecode;
		/** Reason for the status of the Localized Survey Question */
		statuscode: OptionSet.msdyn_localizedsurveyquestion.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyn_LocalizedQuestionText: string;
			/** Unique identifier for entity instances */
			readonly msdyn_localizedsurveyquestionId: string;
			/** The name of the custom entity. */
