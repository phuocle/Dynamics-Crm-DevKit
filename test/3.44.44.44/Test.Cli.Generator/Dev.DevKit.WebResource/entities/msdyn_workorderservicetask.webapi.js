...
(function (DevKit) {
	...
	DevKit.msdyn_workorderservicetaskApi = function (e) {
		...
		var _msdyn_workorderservicetask = {
		...
		msdyn_workorderservicetask.ODataEntity = e;
		msdyn_workorderservicetask.FormattedValue = {};
		for (var field in _msdyn_workorderservicetask) {
			var a = _msdyn_workorderservicetask[field].a;
			var b = _msdyn_workorderservicetask[field].b;
			var c = _msdyn_workorderservicetask[field].c;
			var d = _msdyn_workorderservicetask[field].d;
			var g = _msdyn_workorderservicetask[field].g;
			var r = _msdyn_workorderservicetask[field].r;
			webApiField(msdyn_workorderservicetask, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_workorderservicetask.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_workorderservicetask.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
