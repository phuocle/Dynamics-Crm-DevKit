...
(function (DevKit) {
	...
	DevKit.ContractApi = function (e) {
		...
		var u = {};
		var contract = {};
		contract.ODataEntity = e;
		contract.FormattedValue = {};
		for (var field in _contract) {
			var a = _contract[field].a;
			var b = _contract[field].b;
			var c = _contract[field].c;
			var d = _contract[field].d;
			var g = _contract[field].g;
			var r = _contract[field].r;
			webApiField(contract, field, e, a, b, c, d, r, u, g);
		}
		contract.Entity = u;
		contract.EntityName = 'contract';
		contract.EntityCollectionName = 'contracts';
		contract['@odata.etag'] = e['@odata.etag'];
		contract.getAliasedValue = function (alias, isMultiOptionSet = false) {
