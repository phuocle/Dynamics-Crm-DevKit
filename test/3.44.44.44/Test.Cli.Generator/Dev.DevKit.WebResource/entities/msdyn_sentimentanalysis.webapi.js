...
(function (DevKit) {
	...
	DevKit.msdyn_sentimentanalysisApi = function (e) {
		...
		msdyn_sentimentanalysis.ODataEntity = e;
		msdyn_sentimentanalysis.FormattedValue = {};
		for (var field in _msdyn_sentimentanalysis) {
			var a = _msdyn_sentimentanalysis[field].a;
			var b = _msdyn_sentimentanalysis[field].b;
			var c = _msdyn_sentimentanalysis[field].c;
			var d = _msdyn_sentimentanalysis[field].d;
			var g = _msdyn_sentimentanalysis[field].g;
			var r = _msdyn_sentimentanalysis[field].r;
			webApiField(msdyn_sentimentanalysis, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sentimentanalysis.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_sentimentanalysis.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
