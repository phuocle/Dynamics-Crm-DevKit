...
declare namespace DevKit {
	...
	class Formmsdyn_geofencingsettings_Main_Form extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_geofencingsettings_Main_Form */
		Navigation: DevKit.Formmsdyn_geofencingsettings_Main_Form.Navigation;
	...
	class msdyn_geofencingsettingsApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Generate event on geofence creation by default */
			readonly msdyn_GenerateEventOnGeofenceCreating: string;
			/** Unique identifier for entity instances */
			readonly msdyn_geofencingsettingsId: string;
			/** The minimum value that the radius of a geofence may be. */
			readonly msdyn_minradius: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Unit of measure that will be used for geofence distance calculations. */
			readonly msdyn_UnitOfMeasure: string;
			/** Date and time that the record was migrated. */
