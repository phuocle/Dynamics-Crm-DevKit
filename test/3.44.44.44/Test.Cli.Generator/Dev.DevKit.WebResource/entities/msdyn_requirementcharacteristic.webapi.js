...
(function (DevKit) {
	...
	DevKit.msdyn_requirementcharacteristicApi = function (e) {
		...
		var _msdyn_requirementcharacteristic = {
		...
		msdyn_requirementcharacteristic.ODataEntity = e;
		msdyn_requirementcharacteristic.FormattedValue = {};
		for (var field in _msdyn_requirementcharacteristic) {
			var a = _msdyn_requirementcharacteristic[field].a;
			var b = _msdyn_requirementcharacteristic[field].b;
			var c = _msdyn_requirementcharacteristic[field].c;
			var d = _msdyn_requirementcharacteristic[field].d;
			var g = _msdyn_requirementcharacteristic[field].g;
			var r = _msdyn_requirementcharacteristic[field].r;
			webApiField(msdyn_requirementcharacteristic, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_requirementcharacteristic.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_requirementcharacteristic.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
