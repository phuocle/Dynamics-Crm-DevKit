...
declare namespace DevKit {
	namespace Formmsdyn_ocfbpage_Information {
		...
		interface Navigation {
			msdyn_msdyn_ocfbpage_msdyn_ocprovisioningstate: DevKit.Controls.NavigationItem,
			msdyn_ocfbpage_msdyn_surveyconfig_msdyn_targetchannelid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_ocfbpage_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocfbpage_Information */
		Navigation: DevKit.Formmsdyn_ocfbpage_Information.Navigation;
	...
	class msdyn_ocfbpageApi {
		...
		*/
		...
		/** Mode of the survey to be sent */
		msdyn_PostConversationSurveyBotSurveyMode: OptionSet.msdyn_ocfbpage.msdyn_PostConversationSurveyBotSurveyMode;
		/** To enable or disable post conversation survey */
		...
		readonly FormattedValue: {
			...
			/** Turn on your Facebook human agent message tag */
			readonly msdyn_enablehumanagenttag: string;
			/** Access token for the Facebook page */
			readonly msdyn_fbpageaccesstoken: string;
			/** Page id of the Facebook page */
			readonly msdyn_fbpageid: string;
			/** The name of the Facebook page */
			readonly msdyn_fbpagename: string;
			/** Unique identifier for Work Stream associated with Facebook page */
