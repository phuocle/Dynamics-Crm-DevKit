...
declare namespace DevKit {
	namespace Formmsdyn_orderinvoicingproduct_Information {
		...
		interface Navigation {
			msdyn_msdyn_orderinvoicingproduct_invoicedetail_OrderInvoiceProduct: DevKit.Controls.NavigationItem
		}
	}
	...
	class Formmsdyn_orderinvoicingproduct_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_orderinvoicingproduct_Information2 */
		Navigation: DevKit.Formmsdyn_orderinvoicingproduct_Information2.Navigation;
	...
	class msdyn_orderinvoicingproductApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_orderinvoicingproductId: string;
			/** The invoicing setup this product belongs to. */
			readonly msdyn_OrderInvoicingSetup: string;
			/** The product associated with the transaction. */
