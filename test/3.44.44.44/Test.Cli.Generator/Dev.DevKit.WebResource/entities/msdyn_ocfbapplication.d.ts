...
declare namespace DevKit {
	namespace Formmsdyn_ocfbapplication_Information {
		...
		interface Navigation {
			msdyn_msdyn_ocfbapplication_msdyn_ocbotchannelregistration: DevKit.Controls.NavigationItem,
			msdyn_msdyn_ocfbapplication_msdyn_ocfbpage: DevKit.Controls.NavigationItem,
			msdyn_msdyn_ocfbapplication_msdyn_ocprovisioningstate: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_ocfbapplication_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocfbapplication_Information */
		Navigation: DevKit.Formmsdyn_ocfbapplication_Information.Navigation;
	...
	class msdyn_ocfbapplicationApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_ocfbapplication.statecode;
		/** Reason for the status of the Facebook Application */
		statuscode: OptionSet.msdyn_ocfbapplication.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Application Id of Facebook application */
			readonly msdyn_fbapplicationid: string;
			/** Application secret of the Facebook application */
			readonly msdyn_fbapplicationsecret: string;
			/** Callback Uri to be configured on the Facebook application */
			readonly msdyn_fbcallbackuri: string;
			/** Verify token to be configured on the Facebook application */
			readonly msdyn_fbverifytoken: string;
			/** The name of the custom entity. */
