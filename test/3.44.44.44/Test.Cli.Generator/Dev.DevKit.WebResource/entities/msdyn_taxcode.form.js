...
(function (DevKit) {
	...
	DevKit.Formmsdyn_taxcode_Information = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			...
			msdyn_msdyn_taxcode_msdyn_actual_TaxCode: {},
			msdyn_msdyn_taxcode_msdyn_agreement_SalesTaxCode: {},
			msdyn_msdyn_taxcode_msdyn_purchaseorderbill_TaxCode: {},
			msdyn_msdyn_taxcode_msdyn_rma_TaxCode: {},
			msdyn_msdyn_taxcode_msdyn_rtv_TaxCode: {},
			msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode: {},
			msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode: {},
