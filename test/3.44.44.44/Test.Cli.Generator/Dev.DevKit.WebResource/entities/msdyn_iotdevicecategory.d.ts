...
declare namespace DevKit {
	namespace Formmsdyn_iotdevicecategory_Information {
		...
		interface Navigation {
			msdyn_iotdevicevisualizationconfiguration_iotdevicecategory: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevicecategory_msdyn_iotdevice_Category: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevicecategory_msdyn_iotdeviceproperty_DeviceCategory: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_iotdevicecategory_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdevicecategory_Information */
		Navigation: DevKit.Formmsdyn_iotdevicecategory_Information.Navigation;
