...
(function (DevKit) {
	...
	DevKit.msdyn_liveworkstreamApi = function (e) {
		...
		var _msdyn_liveworkstream = {
			...
			msdyn_botfailureactionconfig: { b: 'msdyn_botfailureactionconfig', a: '_msdyn_botfailureactionconfig_value', c: 'msdyn_overflowactionconfigs', d: 'msdyn_overflowactionconfig' },
			...
			msdyn_CustomerDisconnectHoldDurationForOpenConversation: { a: 'msdyn_customerdisconnectholddurationforopenconversation' },
			...
			msdyn_enablevoicev2: { a: 'msdyn_enablevoicev2' },
			...
			msdyn_intentfeatureenabled: { a: 'msdyn_intentfeatureenabled' },
			msdyn_isdefault: { a: 'msdyn_isdefault' },
			msdyn_isICDEnabled: { a: 'msdyn_isicdenabled' },
			...
			msdyn_notificationtemplate_callback_previewdialing: { a: 'msdyn_notificationtemplate_callback_previewdialing' },
			...
			msdyn_notificationtemplate_returning_conv_assig: { a: 'msdyn_notificationtemplate_returning_conv_assig' },
			...
			msdyn_restrictdownloadrecording: { a: 'msdyn_restrictdownloadrecording' },
			msdyn_restrictdownloadtranscript: { a: 'msdyn_restrictdownloadtranscript' },
