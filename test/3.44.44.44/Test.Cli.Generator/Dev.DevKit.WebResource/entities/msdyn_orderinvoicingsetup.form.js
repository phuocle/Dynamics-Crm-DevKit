...
(function (DevKit) {
	...
	DevKit.Formmsdyn_orderinvoicingsetup_Information = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			...
			msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingsetupdate_InvoiceSetup: {}
		};
	...
	DevKit.Formmsdyn_orderinvoicingsetup_Information2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
