...
(function (DevKit) {
	'use strict';
	DevKit.Formmsdyn_ocsmschannelsetting_Information = function(executionContext, defaultWebResourceName) {
		...
		form.Body = body;
		var navigation = {
			msdyn_ocsmschannelsetting_msdyn_surveyconfig_msdyn_targetchannelid: {}
		};
