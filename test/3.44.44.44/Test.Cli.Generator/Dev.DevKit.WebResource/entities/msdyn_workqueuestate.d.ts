...
declare namespace DevKit {
	namespace Formmsdyn_workqueuestate_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyn_workqueuestate_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_workqueuestate_Information */
		Navigation: DevKit.Formmsdyn_workqueuestate_Information.Navigation;
		/** The SidePanes of form msdyn_workqueuestate_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_workqueuestateApi {
		/**
		* DynamicsCrm.DevKit msdyn_workqueuestateApi
		...
		*/
		...
		/** It store unique key for each record. */
		...
		/** Status of the workqueuestate */
		statecode: OptionSet.msdyn_workqueuestate.statecode;
		/** Reason for the status of the workqueuestate */
		statuscode: OptionSet.msdyn_workqueuestate.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances. */
			readonly msdyn_workqueuestateId: string;
			/** It store unique key for each record. */
			readonly msdyn_wqstateuniquekey: string;
			/** Date and time that the record was migrated. */
...
declare namespace OptionSet {
	namespace msdyn_workqueuestate {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
