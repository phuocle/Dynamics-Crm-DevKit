...
declare namespace DevKit {
	...
	class FormDeletedRecords extends DevKit.IForm {
		/**
		* DeletedRecords [Main Form]
		...
		*/
		...
		/** The Body section of form DeletedRecords */
		Body: DevKit.FormDeletedRecords.Body;
		/** The Navigation of form DeletedRecords */
		Navigation: DevKit.FormDeletedRecords.Navigation;
		/** The Grid of form DeletedRecords */
		Grid: DevKit.FormDeletedRecords.Grid;
		/** The SidePanes of form DeletedRecords */
	...
	namespace FormNew_Bulk_Cancel_Job_form {
		interface tab_NEW_JOB_TAB_Sections {
			NEW_BULK_CANCEL_JOB: DevKit.Controls.Section;
		}
		interface tab_NEW_JOB_TAB extends DevKit.Controls.ITab {
			Section: tab_NEW_JOB_TAB_Sections;
		}
		interface Tabs {
			NEW_JOB_TAB: tab_NEW_JOB_TAB;
		}
		interface Body {
			Tab: Tabs;
	...
	class FormNew_Bulk_Cancel_Job_form extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form New_Bulk_Cancel_Job_form */
		Navigation: DevKit.FormNew_Bulk_Cancel_Job_form.Navigation;
		/** The SidePanes of form New_Bulk_Cancel_Job_form */
		SidePanes: DevKit.SidePanes;
	}
	...
	class FormNew_Bulk_Pause_Job_form extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form New_Bulk_Pause_Job_form */
		Navigation: DevKit.FormNew_Bulk_Pause_Job_form.Navigation;
		/** The SidePanes of form New_Bulk_Pause_Job_form */
		SidePanes: DevKit.SidePanes;
	}
	...
	class FormNew_Bulk_Resume_Job_form extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form New_Bulk_Resume_Job_form */
		Navigation: DevKit.FormNew_Bulk_Resume_Job_form.Navigation;
		/** The SidePanes of form New_Bulk_Resume_Job_form */
		SidePanes: DevKit.SidePanes;
	}
	...
	class FormNew_Duplicate_Detection_Job_form extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form New_Duplicate_Detection_Job_form */
		Navigation: DevKit.FormNew_Duplicate_Detection_Job_form.Navigation;
		/** The SidePanes of form New_Duplicate_Detection_Job_form */
		SidePanes: DevKit.SidePanes;
	}
	namespace FormView_Duplicate_Detection_Job_details_form {
		...
		interface tab_detailstab_legacy_Sections {
			Message: DevKit.Controls.Section;
		}
		interface tab_generaltab_legacy_Sections {
			custom: DevKit.Controls.Section;
			general: DevKit.Controls.Section;
			systemlinksection: DevKit.Controls.Section;
		}
		interface tab_VIEW_DUPLICATES_TAB_Sections {
		...
		interface tab_detailstab_legacy extends DevKit.Controls.ITab {
			Section: tab_detailstab_legacy_Sections;
		}
		interface tab_generaltab_legacy extends DevKit.Controls.ITab {
			Section: tab_generaltab_legacy_Sections;
		}
		interface tab_VIEW_DUPLICATES_TAB extends DevKit.Controls.ITab {
			Section: tab_VIEW_DUPLICATES_TAB_Sections;
		}
		interface Tabs {
			DETAILS_TAB: tab_DETAILS_TAB;
			detailstab_legacy: tab_detailstab_legacy;
			generaltab_legacy: tab_generaltab_legacy;
			VIEW_DUPLICATES_TAB: tab_VIEW_DUPLICATES_TAB;
		}
		interface Body {
			Tab: Tabs;
	...
	class FormView_Duplicate_Detection_Job_details_form extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form View_Duplicate_Detection_Job_details_form */
		Navigation: DevKit.FormView_Duplicate_Detection_Job_details_form.Navigation;
		/** The SidePanes of form View_Duplicate_Detection_Job_details_form */
		SidePanes: DevKit.SidePanes;
	}
...
declare namespace OptionSet {
	namespace AsyncOperation {
		enum OperationType {
			...
			/** 103 */
			Cancel_Async_Operations_System,
			/** 105 */
			...
			/** 89 */
			Cascade_Merge_Async_Operation,
			/** 88 */
			Cascade_Reparent_DB_Async_Operation,
			/** 90 */
			CascadeAssign,
			/** 91 */
			CascadeDelete,
			...
			/** 320 */
			Catalog_Service_Generate_Package_Async_Operation,
			/** 322 */
			Catalog_Service_Install_Request_Async_Operation,
			/** 321 */
			Catalog_Service_Submit_Approval_Request_Async_Operation,
			/** 42 */
			...
			/** 207 */
			DeleteAndPromote_Async_Operation,
			/** 334 */
			Deletes_related_Elastic_or_SQL_Table_records_when_an_Elastic_Table_record_is_deleted,
			/** 333 */
			Deletes_related_Elastic_Table_records_when_a_SQL_record_is_deleted,
			/** 14 */
			Deletion_Service,
			/** 239 */
			...
			/** 306 */
			Execute_DataProcessing_Configuration,
			/** 202 */
			Export_Solution_Async_Operation,
			/** 308 */
			FinOps_DB_Sync_Async_Operation,
			/** 332 */
			FinOps_Deploy_Custom_Package_Async_Operation,
			/** 302 */
			FinOps_Deployment_Async_Operation,
			/** 309 */
			FinOps_Unit_Test_Async_Operation,
			/** 75 */
			Flow_Notification,
			/** 40 */
			Goal_Roll_Up,
			...
			Import_Translation,
			/** 210 */
			ImportTranslation_Async_Operation,
			/** 51 */
			...
			/** 209 */
			ProvisionLanguage_Async_Operation,
			/** 204 */
			...
			/** 305 */
			Register_Offering_Async_Operation,
			/** 30 */
			...
			SQM_Data_Collection,
			/** 211 */
			StageAndUpgrade_Async_Operation,
			/** 31 */
			Storage_Limit_Notification,
			/** 307 */
			Sync_Synapse_Tables_Schema,
			/** 1 */
			System_Event,
			/** 330 */
			TDS_endpoint_provisioning_new_TVF_functions_and_grant_permission_Async_Operation,
			/** 4 */
			Transform_Parse_Data,
			/** 208 */
			UninstallSolution_Async_Operation,
			/** 27 */
