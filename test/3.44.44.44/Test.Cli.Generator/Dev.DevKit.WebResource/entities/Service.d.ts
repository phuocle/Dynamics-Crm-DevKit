...
declare namespace DevKit {
	namespace FormService_Information {
		...
		interface Navigation {
			adx_inviteredemption_service_serviceid: DevKit.Controls.NavigationItem,
			adx_portalcomment_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_bookingalert_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_copilottranscript_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_ocliveworkitem_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_ocoutboundmessage_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_ocsession_service_serviceid: DevKit.Controls.NavigationItem,
			msdyn_ocvoicemail_service_serviceid: DevKit.Controls.NavigationItem,
			msfp_alert_service_serviceid: DevKit.Controls.NavigationItem,
			msfp_surveyinvite_service_serviceid: DevKit.Controls.NavigationItem,
			msfp_surveyresponse_service_serviceid: DevKit.Controls.NavigationItem,
			service_accounts: DevKit.Controls.NavigationItem,
			service_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			service_adx_portalcomments: DevKit.Controls.NavigationItem,
			service_appointments: DevKit.Controls.NavigationItem,
			service_calendar_rules: DevKit.Controls.NavigationItem,
			service_contacts: DevKit.Controls.NavigationItem,
			service_emails: DevKit.Controls.NavigationItem,
			service_incidentresolutions: DevKit.Controls.NavigationItem,
			service_phonecalls: DevKit.Controls.NavigationItem,
			service_service_appointments: DevKit.Controls.NavigationItem,
			service_tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormService_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Service_Information */
		Navigation: DevKit.FormService_Information.Navigation;
