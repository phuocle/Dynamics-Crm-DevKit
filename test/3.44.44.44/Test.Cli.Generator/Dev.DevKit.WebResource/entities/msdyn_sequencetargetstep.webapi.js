...
(function (DevKit) {
	...
	DevKit.msdyn_sequencetargetstepApi = function (e) {
		...
		var _msdyn_sequencetargetstep = {
			...
			msdyn_advancedfromstep: { b: 'msdyn_advancedfromstep', a: '_msdyn_advancedfromstep_value', c: 'msdyn_sequencetargetsteps', d: 'msdyn_sequencetargetstep' },
			msdyn_advancedfromwaitstate: { a: 'msdyn_advancedfromwaitstate' },
			...
			msdyn_snoozecount: { a: 'msdyn_snoozecount' },
			msdyn_subtype: { a: 'msdyn_subtype' },
			msdyn_triggeroutcome: { a: 'msdyn_triggeroutcome' },
			msdyn_type: { a: 'msdyn_type' },
			msdyn_waitskippedon_UtcDateAndTime: { a: 'msdyn_waitskippedon' },
		...
		msdyn_sequencetargetstep.ODataEntity = e;
		msdyn_sequencetargetstep.FormattedValue = {};
		for (var field in _msdyn_sequencetargetstep) {
			var a = _msdyn_sequencetargetstep[field].a;
			var b = _msdyn_sequencetargetstep[field].b;
			var c = _msdyn_sequencetargetstep[field].c;
			var d = _msdyn_sequencetargetstep[field].d;
			var g = _msdyn_sequencetargetstep[field].g;
			var r = _msdyn_sequencetargetstep[field].r;
			webApiField(msdyn_sequencetargetstep, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sequencetargetstep.getAliasedValue = function (alias, isMultiOptionSet = false) {
