...
declare namespace DevKit {
	...
	class Formmsdyn_unifiedroutingdiagnostic_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_unifiedroutingdiagnostic_Information */
		Navigation: DevKit.Formmsdyn_unifiedroutingdiagnostic_Information.Navigation;
	...
	class msdyn_unifiedroutingdiagnosticApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Diagnostics data */
			readonly msdyn_diagnosticdata: string;
			/** Diagnostic Data type */
			readonly msdyn_diagnosticdatatype: string;
			/** Evaluation */
			readonly msdyn_evaluation: string;
			/** Input data */
			...
			/** Unique identifier for entity instances */
			readonly msdyn_unifiedroutingdiagnosticId: string;
			/** Unique identifier for Unified routing run associated with Unified routing diagnostic. */
...
declare namespace OptionSet {
	namespace msdyn_unifiedroutingdiagnostic {
		...
		enum msdyn_ruletype {
			...
			/** 12 */
			Custom_API_Classification,
			/** 13 */
			Custom_API_Route_to_Queue,
			/** 1 */
