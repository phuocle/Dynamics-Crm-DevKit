...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_ocwhatsappchannelnumberApi = function (e) {
		...
		var _msdyn_ocwhatsappchannelnumber = {
			...
			msdyn_ocwhatsappaccountid: { b: 'msdyn_ocwhatsappaccountid', a: '_msdyn_ocwhatsappaccountid_value', c: 'msdyn_ocwhatsappchannelaccounts', d: 'msdyn_ocwhatsappchannelaccount' },
			msdyn_ocwhatsappchannelnumberId: { a: 'msdyn_ocwhatsappchannelnumberid' },
			msdyn_ocwidgetlanguage: { b: 'msdyn_ocwidgetlanguage', a: '_msdyn_ocwidgetlanguage_value', c: 'msdyn_oclanguages', d: 'msdyn_oclanguage' },
			msdyn_organizationphonenumber: { a: 'msdyn_organizationphonenumber' },
			...
			msdyn_ProviderChannelId: { a: 'msdyn_providerchannelid' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_ocwhatsappchannelnumber = {};
		msdyn_ocwhatsappchannelnumber.ODataEntity = e;
		msdyn_ocwhatsappchannelnumber.FormattedValue = {};
		for (var field in _msdyn_ocwhatsappchannelnumber) {
			var a = _msdyn_ocwhatsappchannelnumber[field].a;
			var b = _msdyn_ocwhatsappchannelnumber[field].b;
			var c = _msdyn_ocwhatsappchannelnumber[field].c;
			var d = _msdyn_ocwhatsappchannelnumber[field].d;
			var g = _msdyn_ocwhatsappchannelnumber[field].g;
			var r = _msdyn_ocwhatsappchannelnumber[field].r;
			webApiField(msdyn_ocwhatsappchannelnumber, field, e, a, b, c, d, r, u, g);
		}
		msdyn_ocwhatsappchannelnumber.Entity = u;
		msdyn_ocwhatsappchannelnumber.EntityName = 'msdyn_ocwhatsappchannelnumber';
		msdyn_ocwhatsappchannelnumber.EntityCollectionName = 'msdyn_ocwhatsappchannelnumbers';
		msdyn_ocwhatsappchannelnumber['@odata.etag'] = e['@odata.etag'];
		msdyn_ocwhatsappchannelnumber.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_ocwhatsappchannelnumber.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_ocwhatsappchannelnumber;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
