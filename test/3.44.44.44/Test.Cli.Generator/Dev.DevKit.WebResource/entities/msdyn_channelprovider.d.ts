...
declare namespace DevKit {
	namespace Formmsdyn_channelprovider_Information {
		...
		interface Body {
			...
			msdyn_channelurl: DevKit.Controls.ActionCards;
	...
	class Formmsdyn_channelprovider_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_channelprovider_Information */
		Navigation: DevKit.Formmsdyn_channelprovider_Information.Navigation;
