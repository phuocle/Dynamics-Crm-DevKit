...
declare namespace DevKit {
	...
	class Formmsdyn_notificationfield_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_notificationfield_Information.Body;
		/** The Navigation of form msdyn_notificationfield_Information */
		Navigation: DevKit.Formmsdyn_notificationfield_Information.Navigation;
		/** The SidePanes of form msdyn_notificationfield_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_notificationfieldApi {
		/**
		* DynamicsCrm.DevKit msdyn_notificationfieldApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_notificationfield.ComponentState;
		...
		/** Order of the notification field */
		msdyn_order: number;
		/** Field displayed on the notification. This is treated as the key on the basis of which the values are replaced on the notification template. */
		msdyn_title: string;
		/** Unique Name for the entity. */
		...
		statecode: OptionSet.msdyn_notificationfield.statecode;
		/** Reason for the status of the Notification Field */
		statuscode: OptionSet.msdyn_notificationfield.statuscode;
		/** For internal use only. */
