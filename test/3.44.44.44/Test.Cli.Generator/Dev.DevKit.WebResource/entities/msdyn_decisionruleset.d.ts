...
declare namespace DevKit {
	namespace Formmsdyn_decisionruleset_Information {
		...
		interface Navigation {
			msdyn_decisionruleset_msdyn_assignmentconfigurationstep_rulesetid: DevKit.Controls.NavigationItem,
			msdyn_decisionruleset_msdyn_routingconfigurationstep_rulesetid: DevKit.Controls.NavigationItem,
			msdyn_decisionruleset_queue_msdyn_inqueueoverflowrulesetid: DevKit.Controls.NavigationItem,
			msdyn_intentsolution_mappingconfiguration_rulesetid_msdyn_decisionruleset: DevKit.Controls.NavigationItem,
			msdyn_msdyn_decisionruleset_msdyn_masterentityroutingconfiguration_rulesetid: DevKit.Controls.NavigationItem,
			msdyn_msdyn_decisionruleset_msdyn_swarmtemplate_skillattachmentrulesetid: DevKit.Controls.NavigationItem,
			msdyn_msdyn_decisionruleset_msdyn_unifiedroutingdiagnostic_decisionrulesetid: DevKit.Controls.NavigationItem,
			msdyn_queue_decisionrulesetId: DevKit.Controls.NavigationItem,
			msdyn_rulesetdependencymapping_msdyn_decisionruleset_msdyn_referencedpolymorphicentityid: DevKit.Controls.NavigationItem,
			msdyn_rulesetdependencymapping_msdyn_decisionruleset_msdyn_referencingrulesetid: DevKit.Controls.NavigationItem,
			msdyn_templateruleset_draftruleset_msdyn_decisionruleset: DevKit.Controls.NavigationItem,
			msdyn_templateruleset_publishedruleset_msdyn_decisionruleset: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_decisionruleset_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_decisionruleset_Information */
		Navigation: DevKit.Formmsdyn_decisionruleset_Information.Navigation;
	...
	class msdyn_decisionrulesetApi {
		...
		*/
		...
		/** Defines the type for the dataverse component being used */
		msdyn_dataversecomponenttype: OptionSet.msdyn_decisionruleset.msdyn_dataversecomponenttype;
		/** Unique identifier for entity instances */
		msdyn_decisionrulesetId: string;
		/** Description of the rule set record */
		msdyn_description: string;
		/** FetchXML for ruleset */
		...
		/** Indicates whether to persist output data after rule evaluation */
		msdyn_persistoutputdata: boolean;
		/** Indicates whether to refresh input data before rule evaluation */
		...
		readonly FormattedValue: {
			...
			/** Defines the type for the dataverse component being used */
			readonly msdyn_dataversecomponenttype: string;
			/** Unique identifier for entity instances */
			readonly msdyn_decisionrulesetId: string;
			/** Description of the rule set record */
			readonly msdyn_description: string;
			/** FetchXML for ruleset */
			readonly msdyn_fetchxml: string;
			/** Input contract for the ruleset */
			...
			/** Indicates whether to persist output data after rule evaluation */
			readonly msdyn_persistoutputdata: string;
			/** Indicates whether to refresh input data before rule evaluation */
			readonly msdyn_refreshinputdata: string;
			/** Defines type of the rule set */
...
declare namespace OptionSet {
	namespace msdyn_decisionruleset {
		...
		enum msdyn_dataversecomponenttype {
			/** 192350000 */
			Custom_API,
			/** 0 */
			Unkown
		...
		enum msdyn_rulesettype {
			/** 192350002 */
			Dataverse_Components,
			/** 192350000 */
			Declarative,
			/** 192350003 */
			Intelligent_Conversation_Distribution,
			/** 192350001 */
			ML_model_based
		}
		enum statecode {
