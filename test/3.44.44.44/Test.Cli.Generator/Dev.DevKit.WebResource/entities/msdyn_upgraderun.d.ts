...
declare namespace DevKit {
	namespace Formmsdyn_upgraderun_Information {
		...
		interface Navigation {
			msdyn_msdyn_upgraderun_msdyn_upgradeversion_UpgradeRun: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_upgraderun_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_upgraderun_Information */
		Navigation: DevKit.Formmsdyn_upgraderun_Information.Navigation;
