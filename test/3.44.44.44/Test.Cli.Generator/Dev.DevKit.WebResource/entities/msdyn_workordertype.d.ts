...
declare namespace DevKit {
	namespace Formmsdyn_workordertype_Information {
		...
		interface Navigation {
			msdyn_msdyn_workordertype_msdyn_actual_WorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workordertype_msdyn_agreementbookingsetup_WorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workordertype_msdyn_incidenttype_DefaultWorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workordertype_msdyn_quotebookingsetup_WorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workordertype_msdyn_workorder_WorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workordertype_opportunity_WorkOrderType: DevKit.Controls.NavigationItem,
			msdyn_workordertype_msdyn_nottoexceed_workordertype: DevKit.Controls.NavigationItem
		}
	}
