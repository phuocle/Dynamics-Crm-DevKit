...
declare namespace DevKit {
	...
	class Formmsdyn_ocwechatchannelconfig_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocwechatchannelconfig_Information */
		Navigation: DevKit.Formmsdyn_ocwechatchannelconfig_Information.Navigation;
	...
	class msdyn_ocwechatchannelconfigApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocwechatchannelconfig.ComponentState;
		...
		/** Secure Application Secret of WeChat Channel */
		msdyn_secureapplicationsecret: string;
		/** Secure Message encryption key (EncodingAESKey) for WeChat */
		msdyn_secureencodingaeskey: string;
		/** Secure Token of WeChat Channel */
		msdyn_securetoken: string;
		/** Original ID of WeChat Channel */
		...
		readonly FormattedValue: {
			...
			/** Secure Application Secret of WeChat Channel */
			readonly msdyn_secureapplicationsecret: string;
			/** Secure Message encryption key (EncodingAESKey) for WeChat */
			readonly msdyn_secureencodingaeskey: string;
			/** Secure Token of WeChat Channel */
			readonly msdyn_securetoken: string;
			/** Original ID of WeChat Channel */
