...
declare namespace DevKit {
	namespace FormActivity_Form {
		...
		interface tab_properties_tab_Sections {
			...
			splittype_section: DevKit.Controls.Section;
		}
		...
		interface Body {
			...
			msdyncrm_splittersettings: DevKit.Controls.ActionCards;
			/** Type of splitter */
			msdyncrm_splittertype: DevKit.Controls.OptionSet;
		}
	...
	class msdyncrm_splitteractivityApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_splitteractivityApi
		...
		*/
		...
		msdyncrm_splitteractivityId: string;
		/** Splitter settings */
		msdyncrm_splittersettings: string;
		/** Type of splitter */
		msdyncrm_splittertype: OptionSet.msdyncrm_splitteractivity.msdyncrm_splittertype;
		...
		/** Status of the splitteractivity */
		statecode: OptionSet.msdyncrm_splitteractivity.statecode;
		/** Reason for the status of the splitteractivity */
		statuscode: OptionSet.msdyncrm_splitteractivity.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyncrm_splitteractivityId: string;
			/** Splitter settings */
			readonly msdyncrm_splittersettings: string;
			/** Type of splitter */
			readonly msdyncrm_splittertype: string;
			/** Date and time that the record was migrated. */
...
declare namespace OptionSet {
	namespace msdyncrm_splitteractivity {
		enum msdyncrm_splittertype {
			/** 192350000 */
			Percentage,
			/** 192350001 */
			Value
