...
declare namespace DevKit {
	namespace Formmsdynmkt_file_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynmkt_file_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynmkt_file_Information */
		Body: DevKit.Formmsdynmkt_file_Information.Body;
		/** The Navigation of form msdynmkt_file_Information */
		Navigation: DevKit.Formmsdynmkt_file_Information.Navigation;
		/** The SidePanes of form msdynmkt_file_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynmkt_fileApi {
		/**
		* DynamicsCrm.DevKit msdynmkt_fileApi
