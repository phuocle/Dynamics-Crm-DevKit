...
declare namespace DevKit {
	namespace Formpowerbireport_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formpowerbireport_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form powerbireport_Information */
		Body: DevKit.Formpowerbireport_Information.Body;
		/** The Navigation of form powerbireport_Information */
		Navigation: DevKit.Formpowerbireport_Information.Navigation;
		/** The SidePanes of form powerbireport_Information */
		SidePanes: DevKit.SidePanes;
	}
	class powerbireportApi {
		/**
		* DynamicsCrm.DevKit powerbireportApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.powerbireport.ComponentState;
		...
		statecode: OptionSet.powerbireport.statecode;
		/** Reason for the status of the Power BI Report */
		statuscode: OptionSet.powerbireport.statuscode;
		/** For internal use only. */
