...
declare namespace DevKit {
	namespace FormCustomAPI_Information {
		...
		interface Navigation {
			...
			customapi_msdyn_function_customapi: DevKit.Controls.NavigationItem,
			customapi_plugin_CustomAPI: DevKit.Controls.NavigationItem,
			customapi_serviceplanmapping: DevKit.Controls.NavigationItem,
			fabricaiskill_customapiid: DevKit.Controls.NavigationItem,
			msdyn_apirequestcache_CustomAPI_customapi: DevKit.Controls.NavigationItem,
			msdyn_customapi_msdyn_customapirulesetconfiguration_CustomAPI: DevKit.Controls.NavigationItem,
			msdyn_customapi_msdyn_pmbusinessruleautomationconfig_CustomApiId: DevKit.Controls.NavigationItem,
			msdyn_formmapping_customapiid: DevKit.Controls.NavigationItem,
			msdyn_knowledgeassetconfiguration_customapiid: DevKit.Controls.NavigationItem,
			msdynmkt_customapi_eventmetadata: DevKit.Controls.NavigationItem,
			msdynmkt_journeydependency_dependency_customapi: DevKit.Controls.NavigationItem
		}
	}
	class FormCustomAPI_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form CustomAPI_Information */
		Navigation: DevKit.FormCustomAPI_Information.Navigation;
