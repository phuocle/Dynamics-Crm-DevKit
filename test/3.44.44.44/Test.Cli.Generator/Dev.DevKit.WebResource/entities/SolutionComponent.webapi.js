...
(function (DevKit) {
	...
	DevKit.SolutionComponentApi = function (e) {
		...
		for (var field in _solutioncomponent) {
			var a = _solutioncomponent[field].a;
			var b = _solutioncomponent[field].b;
			var c = _solutioncomponent[field].c;
			var d = _solutioncomponent[field].d;
			var g = _solutioncomponent[field].g;
			var r = _solutioncomponent[field].r;
			webApiField(solutioncomponent, field, e, a, b, c, d, r, u, g);
		}
