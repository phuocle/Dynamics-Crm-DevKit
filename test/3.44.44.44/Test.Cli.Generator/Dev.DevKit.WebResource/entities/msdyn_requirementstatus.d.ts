...
declare namespace DevKit {
	namespace Formmsdyn_requirementstatus_Information {
		...
		interface Navigation {
			msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementActiveStatus: DevKit.Controls.NavigationItem,
			msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCanceledStatus: DevKit.Controls.NavigationItem,
			msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCompletedStatus: DevKit.Controls.NavigationItem,
			msdyn_requirementstatus_resourcerequirement_status: DevKit.Controls.NavigationItem
		}
	}
	...
	class Formmsdyn_requirementstatus_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_requirementstatus_Information2 */
		Navigation: DevKit.Formmsdyn_requirementstatus_Information2.Navigation;
