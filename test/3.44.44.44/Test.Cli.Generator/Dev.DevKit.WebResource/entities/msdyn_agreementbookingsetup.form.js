...
(function (DevKit) {
	...
	DevKit.FormAgreement_Booking_Setup = function(executionContext, defaultWebResourceName) {
		...
		form.Grid = grid;
		var navigation = {
			bpf_msdyn_agreementbookingsetup_msdyn_bpf_baa0a411a239410cb8bded8b5fdd88e3: {},
			msdyn_agreementbookingsetup_adx_inviteredemptions: {},
			msdyn_agreementbookingsetup_adx_portalcomments: {},
			msdyn_agreementbookingsetup_Appointments: {},
			msdyn_agreementbookingsetup_Emails: {},
			msdyn_agreementbookingsetup_msdyn_bookingalerts: {},
			msdyn_agreementbookingsetup_msdyn_copilottranscripts: {},
			msdyn_agreementbookingsetup_msdyn_ocliveworkitems: {},
			msdyn_agreementbookingsetup_msdyn_ocoutboundmessages: {},
			msdyn_agreementbookingsetup_msdyn_ocsessions: {},
			msdyn_agreementbookingsetup_msdyn_ocvoicemails: {},
			msdyn_agreementbookingsetup_msfp_alerts: {},
			msdyn_agreementbookingsetup_msfp_surveyinvites: {},
			msdyn_agreementbookingsetup_msfp_surveyresponses: {},
			msdyn_agreementbookingsetup_PhoneCalls: {},
			msdyn_agreementbookingsetup_QueueItems: {},
			msdyn_agreementbookingsetup_ServiceAppointments: {},
			msdyn_agreementbookingsetup_Tasks: {},
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingdate_BookingSetup: {},
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingincident_AgreementBookingSetup: {},
