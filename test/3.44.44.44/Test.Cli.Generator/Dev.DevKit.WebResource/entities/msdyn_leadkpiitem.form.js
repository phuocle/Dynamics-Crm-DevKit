...
(function (DevKit) {
	'use strict';
	DevKit.Formmsdyn_leadkpiitem_Information = function(executionContext, defaultWebResourceName) {
	...
	DevKit.Formmsdyn_leadkpiitem_Information2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
