...
declare namespace DevKit {
	namespace Formmsdyn_productivitymacroconnector_Information {
		...
		interface Navigation {
			msdyn_msdyn_Prod_macroconnector_msdyn_macroactiontemplate_macroconnector: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_productivitymacroconnector_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_productivitymacroconnector_Information */
		Navigation: DevKit.Formmsdyn_productivitymacroconnector_Information.Navigation;
		/** The SidePanes of form msdyn_productivitymacroconnector_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_productivitymacroconnectorApi {
		/**
		* DynamicsCrm.DevKit msdyn_productivitymacroconnectorApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_productivitymacroconnector.ComponentState;
		...
		statecode: OptionSet.msdyn_productivitymacroconnector.statecode;
		/** Reason for the status of the Macro Connector */
		statuscode: OptionSet.msdyn_productivitymacroconnector.statuscode;
		/** For internal use only. */
