...
declare namespace DevKit {
	namespace Formmsdyn_iotdevicecommand_Information {
		...
		interface Navigation {
			msdyn_msdyn_iotdevicecommand_msdyn_customerasset_LastCommandSent: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevicecommand_msdyn_iotalert_LastCommandSent: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevicecommand_msdyn_iotdevice_LastCommandSent: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_iotdevicecommand_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdevicecommand_Information */
		Navigation: DevKit.Formmsdyn_iotdevicecommand_Information.Navigation;
