...
declare namespace DevKit {
	namespace Formmsdyn_inventoryjournal_Information {
		...
		interface Navigation {
			msdyn_inventoryjournal_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_Appointments: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_Emails: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_inventoryjournal_Tasks: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inventoryjournal_msdyn_inventoryjournal_OriginatingJournal: DevKit.Controls.NavigationItem
		}
	}
