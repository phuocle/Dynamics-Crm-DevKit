...
declare namespace DevKit {
	namespace Formmsdyn_forecastinstance_Information {
		...
		interface Navigation {
			msdyn_msdyn_forecastinstance_msdyn_forecastinstance: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_forecastinstance_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_forecastinstance_Information */
		Navigation: DevKit.Formmsdyn_forecastinstance_Information.Navigation;
