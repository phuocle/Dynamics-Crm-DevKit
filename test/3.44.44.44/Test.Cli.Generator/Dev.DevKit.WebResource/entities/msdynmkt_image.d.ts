...
declare namespace DevKit {
	namespace Formmsdynmkt_image_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynmkt_image_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynmkt_image_Information */
		Body: DevKit.Formmsdynmkt_image_Information.Body;
		/** The Navigation of form msdynmkt_image_Information */
		Navigation: DevKit.Formmsdynmkt_image_Information.Navigation;
		/** The SidePanes of form msdynmkt_image_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynmkt_imageApi {
		/**
		* DynamicsCrm.DevKit msdynmkt_imageApi
