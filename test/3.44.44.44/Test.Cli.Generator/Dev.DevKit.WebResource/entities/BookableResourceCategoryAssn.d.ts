...
declare namespace DevKit {
	...
	class FormBookableResourceCategoryAssn_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form BookableResourceCategoryAssn_Information */
		Navigation: DevKit.FormBookableResourceCategoryAssn_Information.Navigation;
	...
	class BookableResourceCategoryAssnApi {
		...
		*/
		...
		readonly FormattedValue: {
			/** Unique identifier of the resource and category association. */
			readonly BookableResourceCategoryAssnId: string;
			/** Unique identifier of the user who created the record. */
			readonly CreatedBy: string;
			/** Date and time when the record was created. */
