...
declare namespace DevKit {
	namespace FormCampaign {
		...
		interface Navigation {
			campaign_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			campaign_adx_portalcomments: DevKit.Controls.NavigationItem,
			Campaign_Appointments: DevKit.Controls.NavigationItem,
			Campaign_CampaignActivities: DevKit.Controls.NavigationItem,
			Campaign_CampaignResponses: DevKit.Controls.NavigationItem,
			Campaign_Emails: DevKit.Controls.NavigationItem,
			campaign_IncidentResolutions: DevKit.Controls.NavigationItem,
			campaign_leads: DevKit.Controls.NavigationItem,
			campaign_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			campaign_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			campaign_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			campaign_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			campaign_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			campaign_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			campaign_msfp_alerts: DevKit.Controls.NavigationItem,
			campaign_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			campaign_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			campaign_opportunities: DevKit.Controls.NavigationItem,
			campaign_OpportunityCloses: DevKit.Controls.NavigationItem,
			campaign_OrderCloses: DevKit.Controls.NavigationItem,
			campaign_orders: DevKit.Controls.NavigationItem,
			Campaign_Phonecalls: DevKit.Controls.NavigationItem,
			campaign_QuoteCloses: DevKit.Controls.NavigationItem,
			campaign_quotes: DevKit.Controls.NavigationItem,
			Campaign_ServiceAppointments: DevKit.Controls.NavigationItem,
			Campaign_Tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormCampaign extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Campaign */
		Navigation: DevKit.FormCampaign.Navigation;
