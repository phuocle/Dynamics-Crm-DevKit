...
declare namespace DevKit {
	namespace FormDuplicate_Detection_Rule_main_form {
		...
		interface tab_rule_legacy_Sections {
		...
		interface tab_administration_legacy extends DevKit.Controls.ITab {
			Section: tab_administration_legacy_Sections;
		}
		interface tab_notes extends DevKit.Controls.ITab {
			Section: tab_notes_Sections;
		}
		interface tab_notes_legacy extends DevKit.Controls.ITab {
			Section: tab_notes_legacy_Sections;
		}
		interface tab_rule extends DevKit.Controls.ITab {
			Section: tab_rule_Sections;
		}
		interface tab_rule_legacy extends DevKit.Controls.ITab {
			Section: tab_rule_legacy_Sections;
		}
		interface Tabs {
			administration: tab_administration;
			administration_legacy: tab_administration_legacy;
			notes: tab_notes;
			notes_legacy: tab_notes_legacy;
			rule: tab_rule;
			rule_legacy: tab_rule_legacy;
		}
		interface Body {
			Tab: Tabs;
	...
	class FormDuplicate_Detection_Rule_main_form extends DevKit.IForm {
		/**
		* Duplicate Detection Rule main form [Main Form]
		...
		*/
		...
		/** The Body section of form Duplicate_Detection_Rule_main_form */
		Body: DevKit.FormDuplicate_Detection_Rule_main_form.Body;
		/** The Navigation of form Duplicate_Detection_Rule_main_form */
		Navigation: DevKit.FormDuplicate_Detection_Rule_main_form.Navigation;
		/** The SidePanes of form Duplicate_Detection_Rule_main_form */
	...
	class FormDuplicateRule_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form DuplicateRule_Information */
		Navigation: DevKit.FormDuplicateRule_Information.Navigation;
