...
declare namespace DevKit {
	namespace Formmsdyn_quotebookingservice_Information {
		...
		interface Navigation {
			msdyn_quotebookingservice_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_Appointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_Emails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingservice_Tasks: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_quotebookingservice_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_quotebookingservice_Information */
		Navigation: DevKit.Formmsdyn_quotebookingservice_Information.Navigation;
	...
	class Formmsdyn_quotebookingservice_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_quotebookingservice_Information2 */
		Navigation: DevKit.Formmsdyn_quotebookingservice_Information2.Navigation;
