...
declare namespace DevKit {
	namespace FormSocial_Profile {
		...
		interface Body {
			...
			/** Open ID field of social profile entity for WeChat channel. */
			msdyn_wechatopenid: DevKit.Controls.String;
	...
	class SocialProfileApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Open ID field of social profile entity for WeChat channel. */
			readonly msdyn_wechatopenid: string;
			/** Date and time that the record was migrated. */
