...
declare namespace DevKit {
	...
	class Formmsdyn_leadhygienesetting_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_leadhygienesetting_Information */
		Navigation: DevKit.Formmsdyn_leadhygienesetting_Information.Navigation;
	...
	class msdyn_leadhygienesettingApi {
		...
		*/
		...
		msdyn_lastschemapublishedtimestamp_UtcDateAndTime: Date;
		...
		statecode: OptionSet.msdyn_leadhygienesetting.statecode;
		/** Reason for the status of the Lead Hygiene Setting */
		statuscode: OptionSet.msdyn_leadhygienesetting.statuscode;
...
declare namespace OptionSet {
	namespace msdyn_leadhygienesetting {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
