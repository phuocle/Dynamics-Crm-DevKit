...
declare namespace DevKit {
	...
	class Formmarketingformdisplayattributes_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form marketingformdisplayattributes_Information */
		Navigation: DevKit.Formmarketingformdisplayattributes_Information.Navigation;
	...
	class marketingformdisplayattributesApi {
		...
		*/
		...
		statecode: OptionSet.marketingformdisplayattributes.statecode;
		/** Reason for the status of the Marketing Form Display Attribute Entity */
		statuscode: OptionSet.marketingformdisplayattributes.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly CreatedOnBehalfBy: string;
			/** List of attributes to be shown in custom form */
			readonly DisplayAttributeList: string;
			/** Name of the entity for custom form */
			readonly EntityLogicalName: string;
			/** Sequence number of the import that created this record. */
			readonly ImportSequenceNumber: string;
			/** Unique identifier for Marketing form display attributes settings */
			readonly marketingformdisplayattributesId: string;
			/** Unique identifier of the user who modified the record. */
			readonly ModifiedBy: string;
			/** Date and time when the record was modified. */
