...
declare namespace DevKit {
	namespace FormContractTemplate_Information {
		...
		interface Navigation {
			contract_template_contracts: DevKit.Controls.NavigationItem
		}
	}
	class FormContractTemplate_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form ContractTemplate_Information */
		Navigation: DevKit.FormContractTemplate_Information.Navigation;
