...
declare namespace DevKit {
	namespace Formmsdyn_mostcontactedby_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyn_mostcontactedby_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_mostcontactedby_Information */
		Body: DevKit.Formmsdyn_mostcontactedby_Information.Body;
		/** The Navigation of form msdyn_mostcontactedby_Information */
		Navigation: DevKit.Formmsdyn_mostcontactedby_Information.Navigation;
		/** The SidePanes of form msdyn_mostcontactedby_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_mostcontactedby_Information2 {
		interface Tabs {
		}
		interface Body {
			/** The primary name of the custom entity. */
	...
	class Formmsdyn_mostcontactedby_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		...
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form msdyn_mostcontactedby_Information2 */
		Body: DevKit.Formmsdyn_mostcontactedby_Information2.Body;
		/** The Navigation of form msdyn_mostcontactedby_Information2 */
		Navigation: DevKit.Formmsdyn_mostcontactedby_Information2.Navigation;
		/** The SidePanes of form msdyn_mostcontactedby_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_mostcontactedbyApi {
		/**
		* DynamicsCrm.DevKit msdyn_mostcontactedbyApi
		...
		*/
		...
		msdyn_computationaccuracy: OptionSet.msdyn_mostcontactedby.msdyn_computationaccuracy;
		/** Shows the related contact. */
		msdyn_contact_regardingObjectId: string;
		msdyn_entityid: string;
		/** Entity Image URL */
		msdyn_entityImage_url: string;
		/** The entity name of the most contacted by record. */
		msdyn_entityname: string;
		/** Most contacted by KPI data as JSON */
		...
		/** Status of the Most Contacted By */
		statecode: OptionSet.msdyn_mostcontactedby.statecode;
		/** Reason for the status of the Most Contacted By */
		statuscode: OptionSet.msdyn_mostcontactedby.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances. */
			readonly msdyn_mostcontactedbyId: string;
			/** The name of the custom entity. */
...
declare namespace OptionSet {
	namespace msdyn_mostcontactedby {
