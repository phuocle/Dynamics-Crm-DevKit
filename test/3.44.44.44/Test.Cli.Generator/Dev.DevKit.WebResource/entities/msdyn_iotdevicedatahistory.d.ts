...
declare namespace DevKit {
	...
	class Formmsdyn_iotdevicedatahistory_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdevicedatahistory_Information */
		Navigation: DevKit.Formmsdyn_iotdevicedatahistory_Information.Navigation;
	...
	class msdyn_iotdevicedatahistoryApi {
		...
		*/
		...
		/** Time when device connection status was last changed */
		msdyn_ConnectionStateUpdatedTime_UtcDateAndTime: Date;
		/** The device for which the device data is */
		msdyn_Device: string;
		/** Reported Properties from the Device */
		...
		msdyn_name: string;
		/** Device Status (Disabled, Enabled or Not Found) */
		msdyn_Status: OptionSet.msdyn_iotdevicedatahistory.msdyn_Status;
		/** A 128 character-long string that stores the reason for the device identity status. All UTF-8 characters are allowed. */
		...
		statecode: OptionSet.msdyn_iotdevicedatahistory.statecode;
		/** Reason for the status of the IoT Device Data History */
		statuscode: OptionSet.msdyn_iotdevicedatahistory.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Time when device connection status was last changed */
			readonly msdyn_ConnectionStateUpdatedTime_UtcDateAndTime: string;
			/** The device for which the device data is */
			readonly msdyn_Device: string;
			/** Reported Properties from the Device */
			readonly msdyn_DeviceReportedProperties: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotdevicedatahistoryId: string;
			/** Identifier for the device in the IoT provider */
			readonly msdyn_IoTHubDeviceId: string;
			/** The time of last device data pull */
			...
			/** A 128 character-long string that stores the reason for the device identity status. All UTF-8 characters are allowed. */
			readonly msdyn_StatusReason: string;
			/** Date and time that the record was migrated. */
