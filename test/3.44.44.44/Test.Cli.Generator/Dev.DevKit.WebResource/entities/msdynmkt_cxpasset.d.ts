...
declare namespace DevKit {
	namespace Formmsdynmkt_cxpasset_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynmkt_cxpasset_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynmkt_cxpasset_Information */
		Body: DevKit.Formmsdynmkt_cxpasset_Information.Body;
		/** The Navigation of form msdynmkt_cxpasset_Information */
		Navigation: DevKit.Formmsdynmkt_cxpasset_Information.Navigation;
		/** The SidePanes of form msdynmkt_cxpasset_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynmkt_cxpassetApi {
		/**
		* DynamicsCrm.DevKit msdynmkt_cxpassetApi
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdynmkt_cxpassetId: string;
