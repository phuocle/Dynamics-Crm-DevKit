...
declare namespace DevKit {
	namespace Formmsdyn_resolution_Information {
		...
		interface Navigation {
			msdyn_msdyn_resolution_msdyn_incidenttyperesolution_Resolution: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resolution_msdyn_workorder_PrimaryResolution: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resolution_msdyn_workorderincident_PrimaryResolution: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resolution_msdyn_workorderresolution_Resolution: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class msdyn_resolutionApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_resolution.statecode;
		/** Reason for the status of the Resolution */
		statuscode: OptionSet.msdyn_resolution.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_resolutionId: string;
			/** Date and time that the record was migrated. */
