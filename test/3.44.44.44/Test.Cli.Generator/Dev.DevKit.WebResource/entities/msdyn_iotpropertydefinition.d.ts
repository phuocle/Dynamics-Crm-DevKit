...
declare namespace DevKit {
	namespace Formmsdyn_iotpropertydefinition_Information {
		...
		interface Navigation {
			msdyn_iotdevicevisualizationconfiguration_measurement: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotpropertydefinition_msdyn_iotdeviceproperty_Property: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotpropertydefinition_msdyn_iotpropertydefinition_ParentParameter: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_iotpropertydefinition_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotpropertydefinition_Information */
		Navigation: DevKit.Formmsdyn_iotpropertydefinition_Information.Navigation;
	...
	class msdyn_iotpropertydefinitionApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly msdyn_Editable: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotpropertydefinitionId: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Refers to the parent property when building a nested property. */
			readonly msdyn_ParentProperty: string;
			/** The data type of the parameter. */
			readonly msdyn_Type: string;
			/** Unit String for property definition */
			readonly msdyn_unit: string;
			readonly msdyn_Visible: string;
			/** Date and time that the record was migrated. */
