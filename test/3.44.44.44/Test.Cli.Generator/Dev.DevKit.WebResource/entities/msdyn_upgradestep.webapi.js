...
(function (DevKit) {
	...
	DevKit.msdyn_upgradestepApi = function (e) {
		...
		msdyn_upgradestep.ODataEntity = e;
		msdyn_upgradestep.FormattedValue = {};
		for (var field in _msdyn_upgradestep) {
			var a = _msdyn_upgradestep[field].a;
			var b = _msdyn_upgradestep[field].b;
			var c = _msdyn_upgradestep[field].c;
			var d = _msdyn_upgradestep[field].d;
			var g = _msdyn_upgradestep[field].g;
			var r = _msdyn_upgradestep[field].r;
			webApiField(msdyn_upgradestep, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_upgradestep.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_upgradestep.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
