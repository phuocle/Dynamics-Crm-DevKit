...
declare namespace DevKit {
	...
	class Formmsdyn_iotdeviceproperty_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdeviceproperty_Information */
		Navigation: DevKit.Formmsdyn_iotdeviceproperty_Information.Navigation;
	...
	class msdyn_iotdevicepropertyApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_iotdeviceproperty.statecode;
		/** Reason for the status of the IoT Device Property */
		statuscode: OptionSet.msdyn_iotdeviceproperty.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the delegate user who modified the record. */
			readonly ModifiedOnBehalfBy: string;
			readonly msdyn_DeviceCategory: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotdevicepropertyId: string;
			/** True if this property is marked as a tag for the device; False if this property is a device property. */
			readonly msdyn_IsTag: string;
			/** The name of the custom entity. */
