...
declare namespace DevKit {
	class ServicePlanCustomControlApi {
		/**
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ServicePlanCustomControl.ComponentState;
		...
		statecode: OptionSet.ServicePlanCustomControl.statecode;
		/** Reason for the status of the Service Plan Custom Control */
		statuscode: OptionSet.ServicePlanCustomControl.statuscode;
		/** For internal use only. */
