...
(function (DevKit) {
	...
	DevKit.OpportunityCloseApi = function (e) {
		...
		var _opportunityclose = {
			...
			regardingobjectid_adx_invitation_opportunityclose: { b: 'regardingobjectid_adx_invitation_opportunityclose', a: '_regardingobjectid_value', c: 'adx_invitations', d: 'adx_invitation' },
			...
			regardingobjectid_mspp_adplacement_opportunityclose: { b: 'regardingobjectid_mspp_adplacement_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_adplacements', d: 'mspp_adplacement' },
			regardingobjectid_mspp_pollplacement_opportunityclose: { b: 'regardingobjectid_mspp_pollplacement_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_pollplacements', d: 'mspp_pollplacement' },
			regardingobjectid_mspp_publishingstatetransitionrule_opportunityclose: { b: 'regardingobjectid_mspp_publishingstatetransitionrule_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_publishingstatetransitionrules', d: 'mspp_publishingstatetransitionrule' },
			regardingobjectid_mspp_redirect_opportunityclose: { b: 'regardingobjectid_mspp_redirect_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_redirects', d: 'mspp_redirect' },
			regardingobjectid_mspp_shortcut_opportunityclose: { b: 'regardingobjectid_mspp_shortcut_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_shortcuts', d: 'mspp_shortcut' },
			regardingobjectid_mspp_website_opportunityclose: { b: 'regardingobjectid_mspp_website_opportunityclose', a: '_regardingobjectid_value', c: 'mspp_websites', d: 'mspp_website' },
