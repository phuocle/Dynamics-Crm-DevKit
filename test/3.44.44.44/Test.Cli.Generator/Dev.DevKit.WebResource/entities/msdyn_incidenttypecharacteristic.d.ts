...
declare namespace DevKit {
	namespace Formmsdyn_incidenttypecharacteristic_Information {
		...
		interface Navigation {
			msdyn_incidenttypecharacteristic_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_Appointments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_Emails: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypecharacteristic_Tasks: DevKit.Controls.NavigationItem
		}
	}
