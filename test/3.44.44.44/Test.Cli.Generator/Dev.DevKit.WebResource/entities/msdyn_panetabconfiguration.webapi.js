...
(function (DevKit) {
	...
	DevKit.msdyn_panetabconfigurationApi = function (e) {
		...
		var _msdyn_panetabconfiguration = {
		...
		msdyn_panetabconfiguration.ODataEntity = e;
		msdyn_panetabconfiguration.FormattedValue = {};
		for (var field in _msdyn_panetabconfiguration) {
			var a = _msdyn_panetabconfiguration[field].a;
			var b = _msdyn_panetabconfiguration[field].b;
			var c = _msdyn_panetabconfiguration[field].c;
			var d = _msdyn_panetabconfiguration[field].d;
			var g = _msdyn_panetabconfiguration[field].g;
			var r = _msdyn_panetabconfiguration[field].r;
			webApiField(msdyn_panetabconfiguration, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_panetabconfiguration.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_panetabconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
