...
declare namespace DevKit {
	namespace Formmsdyn_ocsmschannelsetting_Information {
		...
		interface Navigation {
			msdyn_ocsmschannelsetting_msdyn_surveyconfig_msdyn_targetchannelid: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ocsmschannelsetting_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocsmschannelsetting_Information */
		Navigation: DevKit.Formmsdyn_ocsmschannelsetting_Information.Navigation;
	...
	class msdyn_ocsmschannelsettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocsmschannelsetting.ComponentState;
