...
declare namespace DevKit {
	...
	class Formmsdyn_workqueuerecord_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_workqueuerecord_Information */
		Navigation: DevKit.Formmsdyn_workqueuerecord_Information.Navigation;
	...
	class msdyn_workqueuerecordApi {
		...
		*/
		...
		/** Sort field values for performing client side sorting. */
		...
		readonly FormattedValue: {
			...
			/** Sort field values for performing client side sorting. */
			readonly msdyn_sortattributes: string;
			/** Unique identifier for entity instances. */
