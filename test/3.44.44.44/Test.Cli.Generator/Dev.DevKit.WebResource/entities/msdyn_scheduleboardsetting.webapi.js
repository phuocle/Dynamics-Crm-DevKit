...
(function (DevKit) {
	...
	DevKit.msdyn_scheduleboardsettingApi = function (e) {
		...
		var _msdyn_scheduleboardsetting = {
		...
		msdyn_scheduleboardsetting.ODataEntity = e;
		msdyn_scheduleboardsetting.FormattedValue = {};
		for (var field in _msdyn_scheduleboardsetting) {
			var a = _msdyn_scheduleboardsetting[field].a;
			var b = _msdyn_scheduleboardsetting[field].b;
			var c = _msdyn_scheduleboardsetting[field].c;
			var d = _msdyn_scheduleboardsetting[field].d;
			var g = _msdyn_scheduleboardsetting[field].g;
			var r = _msdyn_scheduleboardsetting[field].r;
			webApiField(msdyn_scheduleboardsetting, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_scheduleboardsetting.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_scheduleboardsetting.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
