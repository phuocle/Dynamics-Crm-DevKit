...
declare namespace DevKit {
	...
	class Formmsdyn_occhannelstateconfiguration_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_occhannelstateconfiguration_Information */
		Navigation: DevKit.Formmsdyn_occhannelstateconfiguration_Information.Navigation;
		/** The SidePanes of form msdyn_occhannelstateconfiguration_Information */
	...
	class msdyn_occhannelstateconfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_occhannelstateconfiguration.ComponentState;
		...
		msdyn_ocliveworkitemstate: OptionSet.msdyn_occhannelstateconfiguration.msdyn_ocliveworkitemstate;
		/** (Currently unused) */
		...
		statecode: OptionSet.msdyn_occhannelstateconfiguration.statecode;
		/** Reason for the status of the Channel State Configuration */
		statuscode: OptionSet.msdyn_occhannelstateconfiguration.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Time duration in minutes after which the work item becomes target for auto closure */
			readonly msdyn_autocloseliveworkitemafter: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Unique Identifier of the associated channel configuration */
			readonly msdyn_occhannelconfigurationid: string;
			/** Unique identifier for entity instances */
			readonly msdyn_occhannelstateconfigurationId: string;
			/** State of the conversation where the config is applicable */
			readonly msdyn_ocliveworkitemstate: string;
			/** (Currently unused) */
			readonly msdyn_showconfirmationonsessionclose: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
