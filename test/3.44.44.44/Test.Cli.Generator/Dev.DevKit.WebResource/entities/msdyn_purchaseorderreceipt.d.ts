...
declare namespace DevKit {
	namespace FormPurchase_Order_Receipt {
		...
		interface Navigation {
			bpf_msdyn_purchaseorderreceipt_msdyn_bpf_2c5fe86acc8b414b8322ae571000c799: DevKit.Controls.NavigationItem,
			msdyn_msdyn_purchaseorderreceipt_msdyn_purchaseorderreceiptproduct_PurchaseOrderReceipt: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_Appointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_Emails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderreceipt_Tasks: DevKit.Controls.NavigationItem
		}
