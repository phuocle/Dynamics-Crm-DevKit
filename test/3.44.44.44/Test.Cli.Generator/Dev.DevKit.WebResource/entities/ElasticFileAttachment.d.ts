...
declare namespace DevKit {
	class ElasticFileAttachmentApi {
		/**
		* DynamicsCrm.DevKit ElasticFileAttachmentApi
		...
		*/
		...
		objectid: string;
		/** Unique identifier of the object with which the attachment is associated. */
		objectid_sourcecontrolcomponentpayload: string;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the object with which the attachment is associated. */
			readonly objectid_sourcecontrolcomponentpayload: string;
			/** Date and time that the record was migrated. */
...
declare namespace OptionSet {
	namespace ElasticFileAttachment {
