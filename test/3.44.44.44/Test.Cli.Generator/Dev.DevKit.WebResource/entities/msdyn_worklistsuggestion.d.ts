...
declare namespace DevKit {
	...
	class Formmsdyn_worklistsuggestion_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_worklistsuggestion_Information */
		Navigation: DevKit.Formmsdyn_worklistsuggestion_Information.Navigation;
	...
	class msdyn_worklistsuggestionApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Related Insights Custom Data */
			readonly msdyn_relatedinsights: string;
			/** Related record for Suggestion */
