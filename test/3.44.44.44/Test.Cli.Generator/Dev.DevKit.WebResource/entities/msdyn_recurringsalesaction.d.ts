...
declare namespace DevKit {
	namespace Formmsdyn_recurringsalesaction_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyn_recurringsalesaction_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_recurringsalesaction_Information */
		Body: DevKit.Formmsdyn_recurringsalesaction_Information.Body;
		/** The Navigation of form msdyn_recurringsalesaction_Information */
		Navigation: DevKit.Formmsdyn_recurringsalesaction_Information.Navigation;
		/** The SidePanes of form msdyn_recurringsalesaction_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_recurringsalesactionApi {
		/**
		* DynamicsCrm.DevKit msdyn_recurringsalesactionApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_recurringsalesaction.ComponentState;
		...
		msdyn_FeatureName: OptionSet.msdyn_recurringsalesaction.msdyn_FeatureName;
		...
		msdyn_RecordState: OptionSet.msdyn_recurringsalesaction.msdyn_RecordState;
		...
		/** Status of the Recurring Sales Action */
		statecode: OptionSet.msdyn_recurringsalesaction.statecode;
		/** Reason for the status of the Recurring Sales Action */
		statuscode: OptionSet.msdyn_recurringsalesaction.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_recurringsalesactionId: string;
			/** Retry Count is used to track the retry of job. */
...
declare namespace OptionSet {
	namespace msdyn_recurringsalesaction {
		enum ComponentState {
			/** 2 */
			Deleted,
			/** 3 */
