...
declare namespace DevKit {
	namespace FormQuick_Campaign {
		...
		interface Navigation {
			bulkoperation_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			bulkoperation_adx_portalcomments: DevKit.Controls.NavigationItem,
			BulkOperation_CampaignResponse: DevKit.Controls.NavigationItem,
			bulkoperation_IncidentResolutions: DevKit.Controls.NavigationItem,
			BulkOperation_logs: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			bulkoperation_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			bulkoperation_msfp_alerts: DevKit.Controls.NavigationItem,
			bulkoperation_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			bulkoperation_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			bulkoperation_OpportunityCloses: DevKit.Controls.NavigationItem,
			bulkoperation_OrderCloses: DevKit.Controls.NavigationItem,
			BulkOperation_QueueItem: DevKit.Controls.NavigationItem,
			bulkoperation_QuoteCloses: DevKit.Controls.NavigationItem,
			bulkoperation_ServiceAppointments: DevKit.Controls.NavigationItem,
			bulkoperation_Tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class BulkOperationApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly CreatedOnBehalfBy: string;
			/** Choose the activity to create that determines how target prospects or customers in this quick campaign are contacted. */
			readonly CreatedRecordTypeCode: string;
			/** Date and time when the delivery of the activity was last attempted. */
			...
			/** Choose the campaign from which the campaign activities were bulk-distributed. */
			readonly regardingobjectid_campaignactivity_bulkoperation: string;
			/** Choose the campaign from which the campaign activities were bulk-distributed. */
			...
			/** Select the type of records targeted in the quick campaign to identify the target audience. */
			readonly TargetedRecordTypeCode: string;
			/** Number of members to target. */
			readonly TargetMembersCount: string;
			/** For internal use only. */
