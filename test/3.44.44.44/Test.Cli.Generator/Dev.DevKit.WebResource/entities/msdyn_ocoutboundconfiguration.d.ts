...
declare namespace DevKit {
	namespace Formmsdyn_ocoutboundconfiguration_Information {
		...
		interface Navigation {
			msdyn_ocoutboundmessage_msdyn_ocoutbound: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ocoutboundconfiguration_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocoutboundconfiguration_Information */
		Navigation: DevKit.Formmsdyn_ocoutboundconfiguration_Information.Navigation;
