...
declare namespace DevKit {
	namespace FormAgreement_Booking_Product_Mobile {
		...
		interface Navigation {
			msdyn_agreementbookingproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingproduct_Tasks: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingproduct_msdyn_workorderproduct_AgreementBookingProduct: DevKit.Controls.NavigationItem
		}
	}
