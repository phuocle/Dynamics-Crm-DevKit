...
declare namespace DevKit {
	namespace FormActivity_monitor_main_form {
		...
		interface Body {
			...
			AdvancedSettings: DevKit.Controls.String;
			...
			/** A rich text field to display recommendation. */
			Recommendation: DevKit.Controls.String;
	...
	class FormActivity_monitor_main_form extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Activity_monitor_main_form */
		Navigation: DevKit.FormActivity_monitor_main_form.Navigation;
...
declare namespace OptionSet {
	namespace activitymonitor {
		...
		enum Reason {
			...
			/** 16 */
			Contact_creation_failed_for_this_sender,
			/** 7 */
			Email_is_coming_from_an_unknown_sender,
			/** 17 */
			Error_matching_conditions_Contact_Microsoft_support,
			/** 18 */
			Internal_failure_contact_Microsoft_support,
			/** 6 */
