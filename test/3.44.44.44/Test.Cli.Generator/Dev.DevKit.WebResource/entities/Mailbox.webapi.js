...
(function (DevKit) {
	...
	DevKit.MailboxApi = function (e) {
		...
		var _mailbox = {
			...
			EmailAddressApprovedOn_UtcDateAndTime: { a: 'emailaddressapprovedon', r: true },
			...
			LastIncomingEmailsRequestedFromEmailServerOn_UtcDateAndTime: { a: 'lastincomingemailsrequestedfromemailserveron' },
			...
			TestAndEnableLastAttemptedOn_UtcDateAndTime: { a: 'testandenablelastattemptedon', r: true },
