...
declare namespace DevKit {
	...
	class Formmsdyn_conversationactionlocale_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_conversationactionlocale_Information */
		Navigation: DevKit.Formmsdyn_conversationactionlocale_Information.Navigation;
	...
	class msdyn_conversationactionlocaleApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Conversation action Id */
			readonly msdyn_Conversationactionkey: string;
			/** Unique identifier for entity instances */
			readonly msdyn_conversationactionlocaleId: string;
			/** Label string for conversation action button */
			readonly msdyn_Label: string;
			/** Locale code for conversation action UI strings */
			readonly msdyn_Locale_picklist: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Slash commad string for conversation action button */
			readonly msdyn_SlashCommands: string;
			/** Tooltip for Conversation Action */
