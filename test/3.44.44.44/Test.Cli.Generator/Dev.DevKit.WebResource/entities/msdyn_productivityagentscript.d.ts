...
declare namespace DevKit {
	namespace Formmsdyn_productivityagentscript_Information {
		...
		interface Navigation {
			msdyn_msdyn_prod_agentscript_msdyn_prod_agentscriptstep_agentscriptid: DevKit.Controls.NavigationItem,
			msdyn_msdyn_prod_agentscript_msdyn_prod_agentscriptstep_routeactionid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_productivityagentscript_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_productivityagentscript_Information */
		Navigation: DevKit.Formmsdyn_productivityagentscript_Information.Navigation;
	...
	class msdyn_productivityagentscriptApi {
		/**
		* DynamicsCrm.DevKit msdyn_productivityagentscriptApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_productivityagentscript.ComponentState;
		...
		/** Status of the Agent script */
		statecode: OptionSet.msdyn_productivityagentscript.statecode;
		/** Reason for the status of the Agent script */
		statuscode: OptionSet.msdyn_productivityagentscript.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_productivityagentscriptId: string;
			/** Unique Name for the entity. */
