...
declare namespace DevKit {
	namespace FormEnvironmentVariableDefinition_Information {
		...
		interface Navigation {
			envdefinition_envdefinition: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_certificate: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_cyberarkobject: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_cyberarksafe: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_cyberarkusername: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_password: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_credential_username: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_environmentvariablevalue: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_flowmachinenetwork_domainpassword: DevKit.Controls.NavigationItem,
			environmentvariabledefinition_flowmachinenetwork_domainusername: DevKit.Controls.NavigationItem,
			EnvironmentVariableDefinition_ReportParameter_EvironmentVariableDefinitionId: DevKit.Controls.NavigationItem,
			envvardefinition_powerbimashupparameter: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormEnvironmentVariableDefinition_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form EnvironmentVariableDefinition_Information */
		Navigation: DevKit.FormEnvironmentVariableDefinition_Information.Navigation;
