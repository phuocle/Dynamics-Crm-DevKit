...
declare namespace DevKit {
	...
	class Formmsdyn_iotfieldmapping_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotfieldmapping_Information */
		Navigation: DevKit.Formmsdyn_iotfieldmapping_Information.Navigation;
	...
	class msdyn_iotfieldmappingApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** The direct path or the key path to retrieve the desired information for mapping. */
			readonly msdyn_DirectPathOrKeyPath: string;
			/** The data format of the field specified to map to. */
			readonly msdyn_FieldDataFormat: string;
			/** The field schema name to map to. */
			readonly msdyn_FieldName: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotfieldmappingId: string;
			/** The type of the mapping. */
			readonly msdyn_MappingType: string;
			/** The ML model's input field name. */
			readonly msdyn_ModelInputFieldName: string;
			/** The search type of this mapping. */
			readonly msdyn_SearchType: string;
			/** The path of the value to be retrieved. */
			readonly msdyn_ValuePath: string;
			/** Date and time that the record was migrated. */
