...
declare namespace DevKit {
	namespace Formmsdyn_iermlmodel_Information {
		...
		interface Navigation {
			msdyn_iermltraining_iermlmodel: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_iermlmodel_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iermlmodel_Information */
		Navigation: DevKit.Formmsdyn_iermlmodel_Information.Navigation;
