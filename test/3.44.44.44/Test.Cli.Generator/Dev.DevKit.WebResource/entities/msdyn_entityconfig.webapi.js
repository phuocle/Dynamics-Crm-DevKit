...
(function (DevKit) {
	...
	DevKit.msdyn_entityconfigApi = function (e) {
		...
		msdyn_entityconfig.ODataEntity = e;
		msdyn_entityconfig.FormattedValue = {};
		for (var field in _msdyn_entityconfig) {
			var a = _msdyn_entityconfig[field].a;
			var b = _msdyn_entityconfig[field].b;
			var c = _msdyn_entityconfig[field].c;
			var d = _msdyn_entityconfig[field].d;
			var g = _msdyn_entityconfig[field].g;
			var r = _msdyn_entityconfig[field].r;
			webApiField(msdyn_entityconfig, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_entityconfig.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_entityconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
