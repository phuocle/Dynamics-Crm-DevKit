...
declare namespace DevKit {
	namespace Formmsdyn_upgradeversion_Information {
		...
		interface Navigation {
			msdyn_msdyn_upgradeversion_msdyn_upgradestep_UpgradeVersion: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_upgradeversion_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_upgradeversion_Information */
		Navigation: DevKit.Formmsdyn_upgradeversion_Information.Navigation;
	...
	class msdyn_upgradeversionApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Date/time when a single-version upgrade finished */
			readonly msdyn_Finished_UtcDateAndTime: string;
			/** Version that was installed before a single-version upgrade */
			...
			/** Package deployer run that invoked a single-version upgrade */
			readonly msdyn_UpgradeRun: string;
			/** Unique identifier for entity instances */
			readonly msdyn_upgradeversionId: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
