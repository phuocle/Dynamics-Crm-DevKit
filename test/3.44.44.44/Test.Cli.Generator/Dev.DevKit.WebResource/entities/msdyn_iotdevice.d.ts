...
declare namespace DevKit {
	namespace Formmsdyn_iotdevice_Information {
		...
		interface Navigation {
			msdyn_iotdevicevisualizationconfiguration_iotdevice: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevice_msdyn_iotalert_Device: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevice_msdyn_iotdevicecommand_Device: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevice_msdyn_iotdevicedatahistory_Device: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotdevice_msdyn_iotdeviceregistrationhistory_Device: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_iotdevice_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdevice_Information */
		Navigation: DevKit.Formmsdyn_iotdevice_Information.Navigation;
	...
	class FormIoT_Device_MFD extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form IoT_Device_MFD */
		Navigation: DevKit.FormIoT_Device_MFD.Navigation;
	...
	class msdyn_iotdeviceApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Reported Properties data for Device */
			readonly msdyn_DeviceReportedProperties: string;
			/** The editable properties for a device. */
			readonly msdyn_DeviceSettings: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotdeviceId: string;
			/** The IoT Provider Instance to which this device belongs. */
			readonly msdyn_IoTProviderInstance: string;
			/** Select “Yes” if this device is simulated for testing and development purposes. Select “No” if this is a real device.​ */
			readonly msdyn_IsSimulated: string;
			/** The last activity time of the device */
			readonly msdyn_LastActivityTime_UtcDateAndTime: string;
			readonly msdyn_LastCommandSent: string;
			readonly msdyn_LastCommandSentTime_UtcDateAndTime: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** A message field that explains the IoT Registration Status. */
			readonly msdyn_RegistrationMessage: string;
			/** A status field that denotes whether the device is registered with the IoT provider. */
			readonly msdyn_RegistrationStatus: string;
			/** Identifying Tags for the Device */
			readonly msdyn_Tags: string;
			/** The device's time zone. */
