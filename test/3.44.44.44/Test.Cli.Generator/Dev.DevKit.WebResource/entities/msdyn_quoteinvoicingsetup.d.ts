...
declare namespace DevKit {
	namespace Formmsdyn_quoteinvoicingsetup_Information {
		...
		interface Navigation {
			msdyn_msdyn_quoteinvoicingsetup_msdyn_quoteinvoicingproduct_QuoteInvoicingSetup: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_quoteinvoicingsetup_Information extends DevKit.IForm {
		...
		*/
		...
		Navigation: DevKit.Formmsdyn_quoteinvoicingsetup_Information.Navigation;
