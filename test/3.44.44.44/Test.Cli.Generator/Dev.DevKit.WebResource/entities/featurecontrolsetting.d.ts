...
declare namespace DevKit {
	namespace Formfeaturecontrolsetting_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formfeaturecontrolsetting_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form featurecontrolsetting_Information */
		Navigation: DevKit.Formfeaturecontrolsetting_Information.Navigation;
	...
	class Formfeaturecontrolsetting_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form featurecontrolsetting_Information2 */
		Navigation: DevKit.Formfeaturecontrolsetting_Information2.Navigation;
		/** The SidePanes of form featurecontrolsetting_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class featurecontrolsettingApi {
		/**
		* DynamicsCrm.DevKit featurecontrolsettingApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.featurecontrolsetting.ComponentState;
		Content: string;
		CountOfFCS: number;
		...
		statecode: OptionSet.featurecontrolsetting.statecode;
		/** Reason for the status of the featurecontrolsetting */
		statuscode: OptionSet.featurecontrolsetting.statuscode;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace featurecontrolsetting {
		enum ComponentState {
			/** 2 */
			Deleted,
			/** 3 */
