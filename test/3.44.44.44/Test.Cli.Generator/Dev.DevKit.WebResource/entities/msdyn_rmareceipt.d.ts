...
declare namespace DevKit {
	namespace FormRMA_Receipt {
		...
		interface Navigation {
			msdyn_msdyn_rmareceipt_msdyn_rmareceiptproduct_RMAReceipt: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_Appointments: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_Emails: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_rmareceipt_Tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
