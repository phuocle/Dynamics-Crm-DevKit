...
declare namespace DevKit {
	namespace Formmsdyn_incidenttypeservice_Information {
		...
		interface Navigation {
			msdyn_incidenttypeservice_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_Appointments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_Emails: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_incidenttypeservice_Tasks: DevKit.Controls.NavigationItem
		}
	}
