...
declare namespace DevKit {
	class mobileofflineprofileextensionApi {
		/**
		...
		*/
		...
		statecode: OptionSet.mobileofflineprofileextension.statecode;
		/** Reason for the status of the MobileOfflineProfileExtension */
		statuscode: OptionSet.mobileofflineprofileextension.statuscode;
