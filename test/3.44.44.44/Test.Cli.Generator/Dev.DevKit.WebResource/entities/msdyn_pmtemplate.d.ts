...
declare namespace DevKit {
	...
	class Formmsdyn_pmtemplate_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form msdyn_pmtemplate_Information */
		Navigation: DevKit.Formmsdyn_pmtemplate_Information.Navigation;
		/** The SidePanes of form msdyn_pmtemplate_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_pmtemplateApi {
		/**
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_pmtemplate.ComponentState;
		...
		/** Status of the PM Template */
		statecode: OptionSet.msdyn_pmtemplate.statecode;
		/** Reason for the status of the PM Template */
		statuscode: OptionSet.msdyn_pmtemplate.statuscode;
		/** For internal use only. */
