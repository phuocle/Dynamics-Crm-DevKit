...
declare namespace DevKit {
	namespace FormProduct_Association {
		...
		interface Navigation {
			ProductAssociation_DynamicProperty: DevKit.Controls.NavigationItem,
			ProductAssociation_DynamicPropertyAssociation: DevKit.Controls.NavigationItem,
			productAssociation_invoice_details: DevKit.Controls.NavigationItem,
			productAssociation_opportunity_product: DevKit.Controls.NavigationItem,
			productAssociation_quote_details: DevKit.Controls.NavigationItem,
			productAssociation_salesorder_details: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormProduct_Association extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Product_Association */
		Navigation: DevKit.FormProduct_Association.Navigation;
