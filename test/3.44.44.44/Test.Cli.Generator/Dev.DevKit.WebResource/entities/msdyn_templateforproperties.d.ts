...
declare namespace DevKit {
	namespace Formmsdyn_templateforproperties_Information {
		interface tab__188F2590_F9AA_48C2_9541_97CD71121D0C_Sections {
			...
			locationsection: DevKit.Controls.Section;
		...
		interface Body {
			...
			/** Indicates the type this template is applied to. */
			msdyn_Type: DevKit.Controls.OptionSet;
			/** Owner Id */
			OwnerId: DevKit.Controls.Lookup;
		}
		interface Navigation {
			msdyn_msdyn_templateforproperties_msdyn_assetcategorytemplateassociation_propertytemplate: DevKit.Controls.NavigationItem,
			msdyn_msdyn_templateforproperties_msdyn_assettemplateassociation_propertytemplate: DevKit.Controls.NavigationItem,
			msdyn_msdyn_templateforproperties_msdyn_locationtemplateassociation_PropertyTemplate: DevKit.Controls.NavigationItem,
			msdyn_msdyn_templateforproperties_msdyn_locationtypetemplateassociation_propertytemplate: DevKit.Controls.NavigationItem,
			msdyn_msdyn_templateforproperties_msdyn_propertytemplateassociation_propertytemplate: DevKit.Controls.NavigationItem
		}
		interface Grid {
			AssetCategoriesSubgrid: DevKit.Controls.Grid;
			AssetsSubgrid: DevKit.Controls.Grid;
			LocationSubgrid: DevKit.Controls.Grid;
			LocationTypeSubgrid: DevKit.Controls.Grid;
	...
	class msdyn_templateforpropertiesApi {
		...
		*/
		...
		/** Indicates the type this template is applied to. */
		msdyn_Type: OptionSet.msdyn_templateforproperties.msdyn_Type;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_templateforpropertiesId: string;
			/** Indicates the type this template is applied to. */
