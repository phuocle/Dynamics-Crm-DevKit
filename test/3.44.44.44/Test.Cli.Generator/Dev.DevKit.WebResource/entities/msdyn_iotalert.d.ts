...
declare namespace DevKit {
	namespace Formmsdyn_iotalert_Information {
		...
		interface Navigation {
			bpf_msdyn_iotalert_msdyn_bpf_477c16f59170487b8b4dc895c5dcd09b: DevKit.Controls.NavigationItem,
			bpf_msdyn_iotalert_msdyn_iottocaseprocess: DevKit.Controls.NavigationItem,
			msdyn_iotalert_msdyn_iotalert: DevKit.Controls.NavigationItem,
			msdyn_iotalert_QueueItems: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotalert_incident_IoTAlert: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotalert_msdyn_iotdevicecommand_ParentAlert: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotalert_msdyn_workorder_IoTAlert: DevKit.Controls.NavigationItem
		}
	...
	class Formmsdyn_iotalert_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotalert_Information */
		Navigation: DevKit.Formmsdyn_iotalert_Information.Navigation;
