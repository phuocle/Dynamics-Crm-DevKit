...
declare namespace DevKit {
	namespace Formmsdyn_sequencetarget_Information {
		...
		interface Navigation {
			msdyn_sequencetarget_sequencetargetstep: DevKit.Controls.NavigationItem
		}
	}
	...
	class msdyn_sequencetargetApi {
		...
		*/
		...
		/** Definition id of the step that is currently in progress. */
		...
		/** Definition id of step in Sequence entity after completion of which sequence got disconnected. */
		...
		readonly FormattedValue: {
			...
			/** Definition id of the step that is currently in progress. */
			readonly msdyn_currentstepdefinitionid: string;
			/** The current step name of the Sequence Target Step entity. */
			...
			/** Definition id of step in Sequence entity after completion of which sequence got disconnected. */
			readonly msdyn_disconnectedafterstepdefinitionid: string;
			/** MS Flow Run Identifier */
