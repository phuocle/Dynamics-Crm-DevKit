...
declare namespace DevKit {
	namespace FormMetric_Information {
		...
		interface Navigation {
			...
			msdyn_metric_msdyn_forecastdefinition_metricid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormMetric_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Metric_Information */
		Navigation: DevKit.FormMetric_Information.Navigation;
