...
declare namespace DevKit {
	namespace FormSLA {
		...
		interface tab_tabUCMigration_Sections {
			Migration: DevKit.Controls.Section;
		}
		interface tab_tabUC extends DevKit.Controls.ITab {
			Section: tab_tabUC_Sections;
		}
		interface tab_tabUCMigration extends DevKit.Controls.ITab {
			Section: tab_tabUCMigration_Sections;
		}
		interface Tabs {
			tabUC: tab_tabUC;
			tabUCMigration: tab_tabUCMigration;
		}
		interface Body {
			Tab: Tabs;
		...
		interface Navigation {
			...
			bulkoperation_sla_slaid: DevKit.Controls.NavigationItem,
			bulkoperation_sla_slainvokedid: DevKit.Controls.NavigationItem,
			campaignactivity_sla_slaid: DevKit.Controls.NavigationItem,
			campaignactivity_sla_slainvokedid: DevKit.Controls.NavigationItem,
			campaignresponse_sla_slaid: DevKit.Controls.NavigationItem,
			campaignresponse_sla_slainvokedid: DevKit.Controls.NavigationItem,
			incidentresolution_sla_slaid: DevKit.Controls.NavigationItem,
			incidentresolution_sla_slainvokedid: DevKit.Controls.NavigationItem,
			manualsla_account: DevKit.Controls.NavigationItem,
			manualsla_appointment: DevKit.Controls.NavigationItem,
			manualsla_cases: DevKit.Controls.NavigationItem,
			manualsla_contact: DevKit.Controls.NavigationItem,
			manualsla_email: DevKit.Controls.NavigationItem,
			manualsla_invoice: DevKit.Controls.NavigationItem,
			manualsla_lead: DevKit.Controls.NavigationItem,
			manualsla_opportunity: DevKit.Controls.NavigationItem,
			manualsla_phonecall: DevKit.Controls.NavigationItem,
			manualsla_quote: DevKit.Controls.NavigationItem,
			manualsla_salesorder: DevKit.Controls.NavigationItem,
			manualsla_serviceappointment: DevKit.Controls.NavigationItem,
			manualsla_task: DevKit.Controls.NavigationItem,
			msdyn_bookingalert_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_bookingalert_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msdyn_copilottranscript_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_copilottranscript_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msdyn_migrationtracker_LegacySLA_sla: DevKit.Controls.NavigationItem,
			msdyn_migrationtracker_ModernSLA_sla: DevKit.Controls.NavigationItem,
			msdyn_ocliveworkitem_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_ocliveworkitem_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msdyn_ocoutboundmessage_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_ocoutboundmessage_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msdyn_ocsession_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_ocsession_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msdyn_ocvoicemail_sla_slaid: DevKit.Controls.NavigationItem,
			msdyn_ocvoicemail_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msfp_alert_sla_slaid: DevKit.Controls.NavigationItem,
			msfp_alert_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msfp_surveyinvite_sla_slaid: DevKit.Controls.NavigationItem,
			msfp_surveyinvite_sla_slainvokedid: DevKit.Controls.NavigationItem,
			msfp_surveyresponse_sla_slaid: DevKit.Controls.NavigationItem,
			msfp_surveyresponse_sla_slainvokedid: DevKit.Controls.NavigationItem,
			opportunityclose_sla_slaid: DevKit.Controls.NavigationItem,
			opportunityclose_sla_slainvokedid: DevKit.Controls.NavigationItem,
			orderclose_sla_slaid: DevKit.Controls.NavigationItem,
			orderclose_sla_slainvokedid: DevKit.Controls.NavigationItem,
			quoteclose_sla_slaid: DevKit.Controls.NavigationItem,
			quoteclose_sla_slainvokedid: DevKit.Controls.NavigationItem,
			sla_account: DevKit.Controls.NavigationItem,
			sla_appointment: DevKit.Controls.NavigationItem,
			sla_cases: DevKit.Controls.NavigationItem,
			sla_contact: DevKit.Controls.NavigationItem,
			sla_email: DevKit.Controls.NavigationItem,
			sla_entitlement: DevKit.Controls.NavigationItem,
			sla_entitlementtemplate: DevKit.Controls.NavigationItem,
			sla_invoice: DevKit.Controls.NavigationItem,
			sla_lead: DevKit.Controls.NavigationItem,
			sla_opportunity: DevKit.Controls.NavigationItem,
			sla_phonecall: DevKit.Controls.NavigationItem,
			sla_quote: DevKit.Controls.NavigationItem,
			sla_salesorder: DevKit.Controls.NavigationItem,
			sla_serviceappointment: DevKit.Controls.NavigationItem,
