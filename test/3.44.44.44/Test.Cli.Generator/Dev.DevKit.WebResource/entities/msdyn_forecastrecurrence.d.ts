...
declare namespace DevKit {
	namespace Formmsdyn_forecastrecurrence_Information {
		...
		interface Navigation {
			msdyn_msdyn_forecastrecurrence_msdyn_forecastinstance: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_forecastrecurrence_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_forecastrecurrence_Information */
		Navigation: DevKit.Formmsdyn_forecastrecurrence_Information.Navigation;
