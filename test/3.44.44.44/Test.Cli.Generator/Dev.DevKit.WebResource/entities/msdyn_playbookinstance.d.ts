...
declare namespace DevKit {
	namespace Formmsdyn_playbookinstance_Information {
		...
		interface Navigation {
			msdyn_playbookinstance_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_Appointments: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_Emails: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_OpportunityCloses: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_OrderCloses: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_QuoteCloses: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_playbookinstance_Tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_playbookinstance_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_playbookinstance_Information */
		Navigation: DevKit.Formmsdyn_playbookinstance_Information.Navigation;
