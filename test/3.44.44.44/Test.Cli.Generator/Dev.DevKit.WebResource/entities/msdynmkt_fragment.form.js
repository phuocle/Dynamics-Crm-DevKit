...
(function (DevKit) {
	'use strict';
	DevKit.FormContent_Block_Filter = function(executionContext, defaultWebResourceName) {
	...
	DevKit.FormGallery_Properties = function(executionContext, defaultWebResourceName) {
		...
		var body = {
			CreatedBy: {},
			msdynmkt_fragmentId: {},
			msdynmkt_linkedemails: {},
			msdynmkt_linkedtemplates: {},
			msdynmkt_name: {},
			msdynmkt_protected: {},
			msdynmkt_tags: {},
			OwningBusinessUnit: {},
	...
	DevKit.FormProperties = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	DevKit.FormSave_as_block_properties2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
