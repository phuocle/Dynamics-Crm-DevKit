...
(function (DevKit) {
	'use strict';
	DevKit.PostFollowApi = function (e) {
		...
		var u = {};
		var postfollow = {};
		postfollow.ODataEntity = e;
		postfollow.FormattedValue = {};
		for (var field in _postfollow) {
			var a = _postfollow[field].a;
			var b = _postfollow[field].b;
			var c = _postfollow[field].c;
			var d = _postfollow[field].d;
			var g = _postfollow[field].g;
			var r = _postfollow[field].r;
			webApiField(postfollow, field, e, a, b, c, d, r, u, g);
		}
		postfollow.Entity = u;
		postfollow.EntityName = 'postfollow';
		postfollow.EntityCollectionName = 'postfollows';
		postfollow['@odata.etag'] = e['@odata.etag'];
		postfollow.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		postfollow.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
