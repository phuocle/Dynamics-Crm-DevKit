...
declare namespace DevKit {
	namespace FormProperty {
		...
		interface Navigation {
			dynamicproperty_base_dynamicproperty: DevKit.Controls.NavigationItem,
			DynamicProperty_DynamicPropertyInstance: DevKit.Controls.NavigationItem,
			DynamicProperty_DynamicPropertyOptionSetItem: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormProperty extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Property */
		Navigation: DevKit.FormProperty.Navigation;
