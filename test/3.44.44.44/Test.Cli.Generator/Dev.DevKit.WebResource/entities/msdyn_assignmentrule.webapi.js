...
(function (DevKit) {
	...
	DevKit.msdyn_assignmentruleApi = function (e) {
		...
		var _msdyn_assignmentrule = {
			...
			msdyn_assignmentwindow: { a: 'msdyn_assignmentwindow' },
			...
			msdyn_distributewithrecordcreation: { a: 'msdyn_distributewithrecordcreation' },
			msdyn_DistributionType: { a: 'msdyn_distributiontype' },
			msdyn_entityfilter: { a: 'msdyn_entityfilter' },
			msdyn_evaluateentitymatchindataverse: { a: 'msdyn_evaluateentitymatchindataverse' },
			msdyn_evaluateownermatchindataverse: { a: 'msdyn_evaluateownermatchindataverse' },
			...
			msdyn_recordcreationwindow: { a: 'msdyn_recordcreationwindow' },
