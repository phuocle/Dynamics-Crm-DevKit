...
declare namespace DevKit {
	namespace Formmsdyn_inspectioninstance_Information {
		...
		interface Body {
			/** Unique identifier for Case associated with Inspection. */
			msdyn_caseid: DevKit.Controls.Lookup;
	...
	class Formmsdyn_inspectioninstance_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_inspectioninstance_Information */
		Navigation: DevKit.Formmsdyn_inspectioninstance_Information.Navigation;
		/** The SidePanes of form msdyn_inspectioninstance_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_inspectioninstanceApi {
		/**
		* DynamicsCrm.DevKit msdyn_inspectioninstanceApi
		...
		*/
		...
		/** Unique identifier for Inspection Template associated with Inspection. */
		msdyn_InspectionTemplateId: string;
		/** Unique identifier for Inspection Template Version associated with Inspection. */
		msdyn_InspectionTemplateVersionId: string;
		/** The name of the custom entity. */
		msdyn_name: string;
		...
		statecode: OptionSet.msdyn_inspectioninstance.statecode;
		/** Reason for the status of the Inspection */
		statuscode: OptionSet.msdyn_inspectioninstance.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyn_Completed: string;
			/** Unique identifier for Customer Asset associated with Inspection. */
			readonly msdyn_CustomerAssetId: string;
			/** Unique identifier for entity instances */
			readonly msdyn_inspectioninstanceId: string;
			/** Unique identifier for Inspection Response associated with Inspection. */
			readonly msdyn_inspectionresponseid: string;
			/** Unique identifier for Inspection Template associated with Inspection. */
			readonly msdyn_InspectionTemplateId: string;
			/** Unique identifier for Inspection Template Version associated with Inspection. */
			readonly msdyn_InspectionTemplateVersionId: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			readonly msdyn_surveybounded: string;
			/** Date and time that the record was migrated. */
