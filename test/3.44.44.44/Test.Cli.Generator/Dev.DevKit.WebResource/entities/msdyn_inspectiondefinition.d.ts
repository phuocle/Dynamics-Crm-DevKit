...
declare namespace DevKit {
	namespace Formmsdyn_inspectiondefinition_Information {
		...
		interface Navigation {
			msdyn_msdyn_inspectiondefinition_msdyn_inspectioninstance: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspectiondefinition_msdyn_inspectionresponse_InspectionDefinition: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspectiondefinition_msdyn_workorderservicetask_inspectiondefinitionid: DevKit.Controls.NavigationItem
		}
