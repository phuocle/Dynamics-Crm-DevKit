...
declare namespace DevKit {
	...
	class Formmsdyn_ocruleitem_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocruleitem_Information */
		Navigation: DevKit.Formmsdyn_ocruleitem_Information.Navigation;
	...
	class msdyn_ocruleitemApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocruleitem.ComponentState;
