...
declare namespace DevKit {
	...
	class Formmsdyn_duplicatedetectionpluginrun_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_duplicatedetectionpluginrun_Information */
		Navigation: DevKit.Formmsdyn_duplicatedetectionpluginrun_Information.Navigation;
	...
	class msdyn_duplicatedetectionpluginrunApi {
		...
		*/
		...
		/** Retry Count is used to track the retry runs */
		...
		statecode: OptionSet.msdyn_duplicatedetectionpluginrun.statecode;
		/** Reason for the status of the Duplicate Detection Plugin Run */
		statuscode: OptionSet.msdyn_duplicatedetectionpluginrun.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyn_messagename: string;
			/** The name of the custom entity. */
...
declare namespace OptionSet {
	namespace msdyn_duplicatedetectionpluginrun {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
