...
declare namespace DevKit {
	namespace FormSLAItem_Information {
		...
		interface Navigation {
			msdyn_migrationtracker_LegacySLAItem_slaitem: DevKit.Controls.NavigationItem,
			msdyn_migrationtracker_ModernSLAItem_slaitem: DevKit.Controls.NavigationItem
		}
	}
