...
declare namespace DevKit {
	namespace FormSalesLiterature_Information {
		...
		interface Navigation {
			sales_literature_items: DevKit.Controls.NavigationItem
		}
	}
	class FormSalesLiterature_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form SalesLiterature_Information */
		Navigation: DevKit.FormSalesLiterature_Information.Navigation;
