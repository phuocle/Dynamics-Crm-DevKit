...
(function (DevKit) {
	...
	DevKit.FormRMA = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			...
			msdyn_rma_adx_inviteredemptions: {},
			msdyn_rma_adx_portalcomments: {},
			msdyn_rma_Appointments: {},
			msdyn_rma_Emails: {},
			msdyn_rma_msdyn_bookingalerts: {},
			msdyn_rma_msdyn_copilottranscripts: {},
			msdyn_rma_msdyn_ocliveworkitems: {},
			msdyn_rma_msdyn_ocoutboundmessages: {},
			msdyn_rma_msdyn_ocsessions: {},
			msdyn_rma_msdyn_ocvoicemails: {},
			msdyn_rma_msfp_alerts: {},
			msdyn_rma_msfp_surveyinvites: {},
			msdyn_rma_msfp_surveyresponses: {},
			msdyn_rma_PhoneCalls: {},
			msdyn_rma_ServiceAppointments: {},
			msdyn_rma_Tasks: {}
		};
