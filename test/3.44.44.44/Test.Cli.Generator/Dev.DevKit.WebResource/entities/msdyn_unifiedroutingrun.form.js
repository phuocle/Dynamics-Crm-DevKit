...
(function (DevKit) {
	'use strict';
	DevKit.Formmsdyn_unifiedroutingrun_Information = function(executionContext, defaultWebResourceName) {
		...
		form.Body = body;
		var navigation = {
			msdyn_unifiedroutingrun_msdyn_unifiedroutingdiagnostic: {}
		};
	...
	DevKit.FormUnified_routing_run_diagnostics = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
