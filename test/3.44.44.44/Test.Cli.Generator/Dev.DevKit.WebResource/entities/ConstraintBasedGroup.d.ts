...
declare namespace DevKit {
	namespace FormConstraintBasedGroup_Information {
		...
		interface Navigation {
			business_map_constraint: DevKit.Controls.NavigationItem,
			constraint_based_group_resource_specs: DevKit.Controls.NavigationItem,
			constraintbasedgroup_resource_groups: DevKit.Controls.NavigationItem,
			constraintbasedgroup_virtualresourceg: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormConstraintBasedGroup_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form ConstraintBasedGroup_Information */
		Navigation: DevKit.FormConstraintBasedGroup_Information.Navigation;
