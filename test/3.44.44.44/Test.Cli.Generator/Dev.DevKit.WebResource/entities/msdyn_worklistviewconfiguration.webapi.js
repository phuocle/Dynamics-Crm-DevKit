...
(function (DevKit) {
	...
	DevKit.msdyn_worklistviewconfigurationApi = function (e) {
		...
		var _msdyn_worklistviewconfiguration = {
			...
			msdyn_adminsortconfiguration: { a: 'msdyn_adminsortconfiguration' },
			msdyn_autorefreshenable: { a: 'msdyn_autorefreshenable' },
			msdyn_autorefreshinterval: { a: 'msdyn_autorefreshinterval' },
			...
			msdyn_inheritrolesfromparentsettings: { a: 'msdyn_inheritrolesfromparentsettings' },
