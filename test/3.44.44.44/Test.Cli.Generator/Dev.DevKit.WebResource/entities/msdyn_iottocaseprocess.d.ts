...
declare namespace DevKit {
	namespace Formmsdyn_iottocaseprocess_Information {
		...
		interface Navigation {
			msdyn_iottocaseprocess_WorkflowLogs: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_iottocaseprocess_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iottocaseprocess_Information */
		Navigation: DevKit.Formmsdyn_iottocaseprocess_Information.Navigation;
