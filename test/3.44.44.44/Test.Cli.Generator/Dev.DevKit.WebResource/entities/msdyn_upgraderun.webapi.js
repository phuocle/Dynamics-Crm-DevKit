...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_upgraderunApi = function (e) {
		...
		msdyn_upgraderun.ODataEntity = e;
		msdyn_upgraderun.FormattedValue = {};
		for (var field in _msdyn_upgraderun) {
			var a = _msdyn_upgraderun[field].a;
			var b = _msdyn_upgraderun[field].b;
			var c = _msdyn_upgraderun[field].c;
			var d = _msdyn_upgraderun[field].d;
			var g = _msdyn_upgraderun[field].g;
			var r = _msdyn_upgraderun[field].r;
			webApiField(msdyn_upgraderun, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_upgraderun.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_upgraderun.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
