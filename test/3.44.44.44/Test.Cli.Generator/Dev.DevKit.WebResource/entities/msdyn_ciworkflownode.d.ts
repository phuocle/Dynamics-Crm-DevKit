...
declare namespace DevKit {
	class msdyn_ciworkflownodeApi {
		/**
		* DynamicsCrm.DevKit msdyn_ciworkflownodeApi
		...
		*/
		...
		msdyn_lastsuccessfultimestamp_UtcDateAndTime: Date;
		msdyn_lastsuccessjobidsserialized: string;
		msdyn_lastsuccesstaskid: string;
		msdyn_Name: string;
		msdyn_nodename: string;
		msdyn_nodeversion: number;
		msdyn_operationtype: string;
		msdyn_outputdataserialized: string;
		msdyn_selectionreasonserialized: string;
		...
		/** Status of the CIWorkflowNode */
		statecode: OptionSet.msdyn_ciworkflownode.statecode;
		/** Reason for the status of the CIWorkflowNode */
		statuscode: OptionSet.msdyn_ciworkflownode.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyn_additionalinfoserialized: string;
			readonly msdyn_cierrorserialized: string;
			readonly msdyn_cierrorsserialized: string;
			/** Unique identifier for entity instances */
			readonly msdyn_ciworkflownodeId: string;
			...
			readonly msdyn_lastsuccessfultimestamp_UtcDateAndTime: string;
			readonly msdyn_lastsuccessjobidsserialized: string;
			readonly msdyn_lastsuccesstaskid: string;
			...
			readonly msdyn_selectionreasonserialized: string;
...
declare namespace OptionSet {
	namespace msdyn_ciworkflownode {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
