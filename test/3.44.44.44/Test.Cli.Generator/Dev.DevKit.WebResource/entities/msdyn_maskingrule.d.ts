...
declare namespace DevKit {
	...
	class Formmsdyn_maskingrule_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_maskingrule_Information */
		Navigation: DevKit.Formmsdyn_maskingrule_Information.Navigation;
	...
	class msdyn_maskingruleApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_maskingrule.ComponentState;
		...
		readonly FormattedValue: {
			...
			/** Test data to evaluate a masking rule */
			readonly msdyn_enter_test_data: string;
			/** Character to be masked */
			readonly msdyn_masked_character: string;
			/** Test data evaluated by a masking rule */
			readonly msdyn_masked_test_data: string;
			/** Unique identifier for entity instances */
			readonly msdyn_maskingruleId: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Regular Expression in Javascript */
			readonly msdyn_regular_expression: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
