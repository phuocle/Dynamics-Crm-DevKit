...
declare namespace DevKit {
	namespace FormDiscountType_Information {
		...
		interface Navigation {
			discount_type_discounts: DevKit.Controls.NavigationItem,
			discount_type_product_price_levels: DevKit.Controls.NavigationItem
		}
	}
	class FormDiscountType_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form DiscountType_Information */
		Navigation: DevKit.FormDiscountType_Information.Navigation;
