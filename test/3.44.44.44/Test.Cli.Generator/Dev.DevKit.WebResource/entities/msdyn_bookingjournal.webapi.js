...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_bookingjournalApi = function (e) {
		...
		msdyn_bookingjournal.ODataEntity = e;
		msdyn_bookingjournal.FormattedValue = {};
		for (var field in _msdyn_bookingjournal) {
			var a = _msdyn_bookingjournal[field].a;
			var b = _msdyn_bookingjournal[field].b;
			var c = _msdyn_bookingjournal[field].c;
			var d = _msdyn_bookingjournal[field].d;
			var g = _msdyn_bookingjournal[field].g;
			var r = _msdyn_bookingjournal[field].r;
			webApiField(msdyn_bookingjournal, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_bookingjournal.getAliasedValue = function (alias, isMultiOptionSet = false) {
