...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_leadkpiitemApi = function (e) {
		...
		var _msdyn_leadkpiitem = {
			...
			msdyn_leadid: { b: 'msdyn_leadid', a: '_msdyn_leadid_value', c: 'leads', d: 'lead' },
			msdyn_leadkpiitemId: { a: 'msdyn_leadkpiitemid' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_leadkpiitem = {};
		msdyn_leadkpiitem.ODataEntity = e;
		msdyn_leadkpiitem.FormattedValue = {};
		for (var field in _msdyn_leadkpiitem) {
			var a = _msdyn_leadkpiitem[field].a;
			var b = _msdyn_leadkpiitem[field].b;
			var c = _msdyn_leadkpiitem[field].c;
			var d = _msdyn_leadkpiitem[field].d;
			var g = _msdyn_leadkpiitem[field].g;
			var r = _msdyn_leadkpiitem[field].r;
			webApiField(msdyn_leadkpiitem, field, e, a, b, c, d, r, u, g);
		}
		msdyn_leadkpiitem.Entity = u;
		msdyn_leadkpiitem.EntityName = 'msdyn_leadkpiitem';
		msdyn_leadkpiitem.EntityCollectionName = 'msdyn_leadkpiitems';
		msdyn_leadkpiitem['@odata.etag'] = e['@odata.etag'];
		msdyn_leadkpiitem.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_leadkpiitem.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_leadkpiitem;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyn_leadkpiitem = {
