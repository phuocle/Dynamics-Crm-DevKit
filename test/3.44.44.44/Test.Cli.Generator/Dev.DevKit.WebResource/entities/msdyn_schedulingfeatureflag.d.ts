...
declare namespace DevKit {
	...
	class Formmsdyn_schedulingfeatureflag_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_schedulingfeatureflag_Information */
		Navigation: DevKit.Formmsdyn_schedulingfeatureflag_Information.Navigation;
	...
	class FormTroubleshooting extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Troubleshooting */
		Navigation: DevKit.FormTroubleshooting.Navigation;
		/** The SidePanes of form Troubleshooting */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_schedulingfeatureflagApi {
		/**
		* DynamicsCrm.DevKit msdyn_schedulingfeatureflagApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_schedulingfeatureflag.ComponentState;
		...
		/** Whether or not this feature is active. */
		msdyn_Enabled: OptionSet.msdyn_schedulingfeatureflag.msdyn_Enabled;
		/** The name of the feature flag. */
		msdyn_name: string;
		...
		/** Status of the SchedulingFeatureFlag */
		statecode: OptionSet.msdyn_schedulingfeatureflag.statecode;
		/** Reason for the status of the SchedulingFeatureFlag */
		statuscode: OptionSet.msdyn_schedulingfeatureflag.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_schedulingfeatureflagId: string;
			/** Addition information related to feature flag */
