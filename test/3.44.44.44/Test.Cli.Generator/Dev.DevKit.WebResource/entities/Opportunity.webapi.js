...
(function (DevKit) {
	...
	DevKit.OpportunityApi = function (e) {
		...
		var _opportunity = {
			...
			msdyn_OpportunityGrade: { a: 'msdyn_opportunitygrade' },
			msdyn_opportunitykpiid: { b: 'msdyn_opportunitykpiid', a: '_msdyn_opportunitykpiid_value', c: 'msdyn_opportunitykpiitems', d: 'msdyn_opportunitykpiitem' },
			msdyn_OpportunityScore: { a: 'msdyn_opportunityscore' },
			msdyn_OpportunityScoreTrend: { a: 'msdyn_opportunityscoretrend' },
		...
		var u = {};
		var opportunity = {};
		opportunity.ODataEntity = e;
		opportunity.FormattedValue = {};
		for (var field in _opportunity) {
			var a = _opportunity[field].a;
			var b = _opportunity[field].b;
			var c = _opportunity[field].c;
			var d = _opportunity[field].d;
			var g = _opportunity[field].g;
			var r = _opportunity[field].r;
			webApiField(opportunity, field, e, a, b, c, d, r, u, g);
		}
		...
		opportunity.getAliasedValue = function (alias, isMultiOptionSet = false) {
