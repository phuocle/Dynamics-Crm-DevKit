...
declare namespace DevKit {
	namespace Formmsdyn_schedulingparameter_Information {
		...
		interface Body {
			...
			msdyn_enablesuggestschedule: DevKit.Controls.ActionCards;
	...
	class Formmsdyn_schedulingparameter_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_schedulingparameter_Information */
		Navigation: DevKit.Formmsdyn_schedulingparameter_Information.Navigation;
	...
	class Formmsdyn_schedulingparameter_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_schedulingparameter_Information2 */
		Navigation: DevKit.Formmsdyn_schedulingparameter_Information2.Navigation;
	...
	class msdyn_schedulingparameterApi {
		...
		*/
		...
		/** Enable Suggest Schedule */
		msdyn_EnableSuggestSchedule: string;
		...
		readonly FormattedValue: {
			...
			/** Enable Suggest Schedule */
			readonly msdyn_EnableSuggestSchedule: string;
