...
(function (DevKit) {
	...
	DevKit.msdyn_workorderresourcerestrictionApi = function (e) {
		...
		var _msdyn_workorderresourcerestriction = {
		...
		msdyn_workorderresourcerestriction.ODataEntity = e;
		msdyn_workorderresourcerestriction.FormattedValue = {};
		for (var field in _msdyn_workorderresourcerestriction) {
			var a = _msdyn_workorderresourcerestriction[field].a;
			var b = _msdyn_workorderresourcerestriction[field].b;
			var c = _msdyn_workorderresourcerestriction[field].c;
			var d = _msdyn_workorderresourcerestriction[field].d;
			var g = _msdyn_workorderresourcerestriction[field].g;
			var r = _msdyn_workorderresourcerestriction[field].r;
			webApiField(msdyn_workorderresourcerestriction, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_workorderresourcerestriction.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_workorderresourcerestriction.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
