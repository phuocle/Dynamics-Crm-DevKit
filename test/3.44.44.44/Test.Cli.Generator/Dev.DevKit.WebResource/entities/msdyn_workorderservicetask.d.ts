...
declare namespace DevKit {
	namespace Formmsdyn_workorderservicetask_Information {
		...
		interface Navigation {
			msdyn_workorderservicetask_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_Appointments: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_Emails: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_QueueItems: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_workorderservicetask_Tasks: DevKit.Controls.NavigationItem
		}
	}
	...
	namespace FormAdd_Task_Mobile {
		interface tab_tab_1_Sections {
			tab_1_column_2_section_1: DevKit.Controls.Section;
			tab_1_column_3_section_1: DevKit.Controls.Section;
			taskSection: DevKit.Controls.Section;
		}
	...
	class FormAdd_Task_Mobile extends DevKit.IForm {
		/**
		* Add Task Mobile [Quick Create]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form Add_Task_Mobile */
		Body: DevKit.FormAdd_Task_Mobile.Body;
	}
	class msdyn_workorderservicetaskApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Shows who last updated the record on behalf of another user. */
			readonly ModifiedOnBehalfBy: string;
			readonly msdyn_ActualDuration: string;
			/** Agreement Booking Service Task linked to this Work Order Service Task */
			readonly msdyn_AgreementBookingServiceTask: string;
			/** Unique identifier for Resource Booking associated with Work Order Service Task. */
			...
			/** Output of the Inspection. */
			readonly msdyn_InspectionResult: string;
			/** Depicts the result of Inspection that the user enters */
			readonly msdyn_inspectiontaskresult: string;
			/** For internal use only. */
			...
			/** For internal use only */
			readonly msdyn_surveyboundedoutput: string;
			/** Unique identifier for Service Task Type associated with Work Order Service Task. */
