...
(function (DevKit) {
	'use strict';
	DevKit.Formmsdyncrm_segmenttemplate_Information = function(executionContext, defaultWebResourceName) {
		...
		var tab = {
			definition_tab: {
				Section: {
					_65A9C7F2_83F0_4388_8364_6F3BA63B773A_SECTION_SEGMENTTEMPLATE_2: {}
				}
			},
			general_tab: {
				Section: {
		...
		form.Header = header;
		var navigation = {
			msdyncrm_msdyncrm_segmenttemplate_msdyncrm_segment_SegmentTemplate: {}
		};
	...
	DevKit.Formmsdyncrm_segmenttemplate_Quick_Create = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
...
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyncrm_segmenttemplate = {
		msdyncrm_Label : {
		...
		msdyncrm_Tag : {
			Behavioral: 192350002,
			Demographic: 192350000,
			Firmographic: 192350001
		},
		statecode : {
			Active: 0,
			Inactive: 1
