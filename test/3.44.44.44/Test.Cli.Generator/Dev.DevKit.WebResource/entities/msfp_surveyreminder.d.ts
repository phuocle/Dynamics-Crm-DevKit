...
declare namespace DevKit {
	...
	class Formmsfp_surveyreminder_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msfp_surveyreminder_Information */
		Navigation: DevKit.Formmsfp_surveyreminder_Information.Navigation;
	...
	class msfp_surveyreminderApi {
		...
		*/
		...
		msfp_scheduleddate_UtcDateAndTime: Date;
		/** Status of the survey reminder. */
		msfp_status: OptionSet.msfp_surveyreminder.msfp_status;
		...
		statecode: OptionSet.msfp_surveyreminder.statecode;
		/** Reason for the status of the Customer Voice survey reminder */
		statuscode: OptionSet.msfp_surveyreminder.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Email template used in the survey reminder. */
			readonly msfp_emailtemplate: string;
			/** Name of the survey reminder. */
			readonly msfp_name: string;
			/** Properties of the survey reminder. */
			readonly msfp_properties: string;
			/** Date and time for which the survey reminder is scheduled to be sent. */
			readonly msfp_scheduleddate_UtcDateAndTime: string;
			/** Status of the survey reminder. */
			readonly msfp_status: string;
			/** Survey for which the reminder was created. */
			readonly msfp_survey: string;
			/** Unique identifier for entity instances */
			readonly msfp_surveyreminderId: string;
			/** Type of the survey reminder. */
