...
declare namespace DevKit {
	namespace FormAzureServiceConnection_Information {
		...
		interface Navigation {
			azureserviceconnection_topicmodel: DevKit.Controls.NavigationItem
		}
	}
	class FormAzureServiceConnection_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form AzureServiceConnection_Information */
		Navigation: DevKit.FormAzureServiceConnection_Information.Navigation;
