...
declare namespace DevKit {
	...
	class Formmsdyn_problematicassetfeedback_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_problematicassetfeedback_Information */
		Navigation: DevKit.Formmsdyn_problematicassetfeedback_Information.Navigation;
	...
	class msdyn_problematicassetfeedbackApi {
		...
		*/
		...
		msdyn_ProblematicAssetFeedback2: OptionSet.msdyn_problematicassetfeedback.msdyn_ProblematicAssetFeedback2;
		...
		readonly FormattedValue: {
			...
			/** Flag value indicating user like/dislike the asset to be predicted as problematic asset */
			readonly msdyn_ProblematicAssetFeedback2: string;
			/** Unique identifier for entity instances */
...
declare namespace OptionSet {
	namespace msdyn_problematicassetfeedback {
		...
		enum msdyn_ProblematicAssetFeedback2 {
			/** 700610001 */
			Dislike,
			/** 700610000 */
			Like
