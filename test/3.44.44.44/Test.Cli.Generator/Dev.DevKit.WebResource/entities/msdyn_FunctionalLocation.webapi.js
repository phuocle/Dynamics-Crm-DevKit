...
(function (DevKit) {
	...
	DevKit.msdyn_FunctionalLocationApi = function (e) {
		...
		var _msdyn_functionallocation = {
			...
			msdyn_CostCenter: { a: 'msdyn_costcenter' },
			msdyn_Country: { a: 'msdyn_country' },
			msdyn_EmailAddress: { a: 'msdyn_emailaddress' },
			...
			msdyn_LocationOpenDate_UtcDateOnly: { a: 'msdyn_locationopendate' },
			...
			msdyn_ShortName: { a: 'msdyn_shortname' },
