...
declare namespace DevKit {
	namespace Formmsdyn_ocrichobject_Information {
		...
		interface Navigation {
			msdyn_ocrichobject_msdyn_ocrichobjectmap: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ocrichobject_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocrichobject_Information */
		Navigation: DevKit.Formmsdyn_ocrichobject_Information.Navigation;
	...
	class Formmsdyn_ocrichobject_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocrichobject_Information2 */
		Navigation: DevKit.Formmsdyn_ocrichobject_Information2.Navigation;
	...
	class msdyn_ocrichobjectApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocrichobject.ComponentState;
		...
		/** Use this field to store Object Json file to the system */
		readonly msdyn_objectjsonfile_name: string;
