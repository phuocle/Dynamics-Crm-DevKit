...
declare namespace DevKit {
	namespace FormActivity_Form {
		...
		interface Body {
			...
			msdyncrm_LastNamePlaceholder: DevKit.Controls.String;
	...
	class msdyncrm_createleadactivityApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_createleadactivityApi
		...
		*/
		...
		msdyncrm_createleadactivityId: string;
		msdyncrm_description: string;
		msdyncrm_EntityTarget: OptionSet.msdyncrm_createleadactivity.msdyncrm_EntityTarget;
		msdyncrm_insightsdata: string;
		msdyncrm_LastNamePlaceholder: string;
		/** The name of the custom entity. */
		...
		/** Status of the createleadactivity */
		statecode: OptionSet.msdyncrm_createleadactivity.statecode;
		/** Reason for the status of the createleadactivity */
		statuscode: OptionSet.msdyncrm_createleadactivity.statuscode;
...
declare namespace OptionSet {
	namespace msdyncrm_createleadactivity {
