...
declare namespace DevKit {
	namespace Formmsdyn_bookingsetupmetadata_Information {
		...
		interface Body {
			...
			/** Select whether, when moving open slots to the next day, to leave the old slots and change their status to "Canceled". This feature only applies when using the 'Move Bookings' option. */
		...
		interface Navigation {
			msdyn_msdyn_bookingsetupmetadata_bookableresourcebooking: DevKit.Controls.NavigationItem,
			msdyn_msdyn_bookingsetupmetadata_msdyn_resourcerequirement: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_bookingsetupmetadata_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_bookingsetupmetadata_Information */
		Navigation: DevKit.Formmsdyn_bookingsetupmetadata_Information.Navigation;
	...
	class Formmsdyn_bookingsetupmetadata_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_bookingsetupmetadata_Information2 */
		Navigation: DevKit.Formmsdyn_bookingsetupmetadata_Information2.Navigation;
