...
(function (DevKit) {
	...
	DevKit.QuoteDetailApi = function (e) {
		...
		var _quotedetail = {
			...
			Quantity: { a: 'quantity' },
			QuoteCreationMethod: { a: 'quotecreationmethod' },
		...
		var u = {};
		var quotedetail = {};
		quotedetail.ODataEntity = e;
		quotedetail.FormattedValue = {};
		for (var field in _quotedetail) {
			var a = _quotedetail[field].a;
			var b = _quotedetail[field].b;
			var c = _quotedetail[field].c;
			var d = _quotedetail[field].d;
			var g = _quotedetail[field].g;
			var r = _quotedetail[field].r;
			webApiField(quotedetail, field, e, a, b, c, d, r, u, g);
		}
		...
		quotedetail.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		quotedetail.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
