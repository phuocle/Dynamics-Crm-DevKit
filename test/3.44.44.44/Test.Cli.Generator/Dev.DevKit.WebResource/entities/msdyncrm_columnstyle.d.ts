...
declare namespace DevKit {
	namespace Formmsdyncrm_columnstyle_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyncrm_columnstyle_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyncrm_columnstyle_Information */
		Body: DevKit.Formmsdyncrm_columnstyle_Information.Body;
		/** The Navigation of form msdyncrm_columnstyle_Information */
		Navigation: DevKit.Formmsdyncrm_columnstyle_Information.Navigation;
		/** The SidePanes of form msdyncrm_columnstyle_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyncrm_columnstyle_Information2 {
		interface Tabs {
		}
		interface Body {
			msdyncrm_alignment: DevKit.Controls.String;
	...
	class Formmsdyncrm_columnstyle_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		...
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form msdyncrm_columnstyle_Information2 */
		Body: DevKit.Formmsdyncrm_columnstyle_Information2.Body;
		/** The Navigation of form msdyncrm_columnstyle_Information2 */
		Navigation: DevKit.Formmsdyncrm_columnstyle_Information2.Navigation;
		/** The SidePanes of form msdyncrm_columnstyle_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyncrm_columnstyleApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_columnstyleApi
		...
		*/
		...
		msdyncrm_assetsprovider: OptionSet.msdyncrm_columnstyle.msdyncrm_assetsprovider;
		...
		msdyncrm_backgroundsize: OptionSet.msdyncrm_columnstyle.msdyncrm_backgroundsize;
		...
		/** Status of the Column style */
		statecode: OptionSet.msdyncrm_columnstyle.statecode;
		/** Reason for the status of the Column style */
		statuscode: OptionSet.msdyncrm_columnstyle.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyncrm_columnstyleId: string;
			/** The colors present in the email body */
...
declare namespace OptionSet {
	namespace msdyncrm_columnstyle {
