...
declare namespace DevKit {
	namespace FormCustomAPIRequestParameter_Information {
		...
		interface Navigation {
			msdyn_customapirequestparameter_msdyn_customapirulesetconfiguration_CustomAPIRequestParameter: DevKit.Controls.NavigationItem,
			msdynmkt_customapirequestparameter_eventparameter: DevKit.Controls.NavigationItem
		}
	}
	class FormCustomAPIRequestParameter_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form CustomAPIRequestParameter_Information */
		Navigation: DevKit.FormCustomAPIRequestParameter_Information.Navigation;
