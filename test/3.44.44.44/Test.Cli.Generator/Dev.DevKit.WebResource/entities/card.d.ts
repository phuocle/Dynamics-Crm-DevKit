...
declare namespace DevKit {
	namespace Formcard_Information {
		...
		interface Navigation {
			msdyn_formmapping_cardid: DevKit.Controls.NavigationItem
		}
	}
	class Formcard_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Navigation of form card_Information */
		Navigation: DevKit.Formcard_Information.Navigation;
		/** The SidePanes of form card_Information */
