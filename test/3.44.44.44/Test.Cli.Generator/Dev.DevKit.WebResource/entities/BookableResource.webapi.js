...
(function (DevKit) {
	...
	DevKit.BookableResourceApi = function (e) {
		...
		var _bookableresource = {
			...
			msdyn_OptimalCrewSize: { a: 'msdyn_optimalcrewsize' },
		...
		bookableresource.ODataEntity = e;
		bookableresource.FormattedValue = {};
		for (var field in _bookableresource) {
			var a = _bookableresource[field].a;
			var b = _bookableresource[field].b;
			var c = _bookableresource[field].c;
			var d = _bookableresource[field].d;
			var g = _bookableresource[field].g;
			var r = _bookableresource[field].r;
			webApiField(bookableresource, field, e, a, b, c, d, r, u, g);
		}
		...
		bookableresource.getAliasedValue = function (alias, isMultiOptionSet = false) {
