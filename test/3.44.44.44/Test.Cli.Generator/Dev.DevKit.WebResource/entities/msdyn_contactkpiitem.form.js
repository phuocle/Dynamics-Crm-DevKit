...
(function (DevKit) {
	'use strict';
	DevKit.Formmsdyn_contactkpiitem_Information = function(executionContext, defaultWebResourceName) {
	...
	DevKit.Formmsdyn_contactkpiitem_Information2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
