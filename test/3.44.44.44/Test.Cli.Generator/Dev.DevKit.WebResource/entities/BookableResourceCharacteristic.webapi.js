...
(function (DevKit) {
	...
	DevKit.BookableResourceCharacteristicApi = function (e) {
		...
		var _bookableresourcecharacteristic = {
			...
			msdyn_CharacteristicSupportingInfoId: { a: 'msdyn_characteristicsupportinginfoid' },
			msdyn_Description: { a: 'msdyn_description' },
			msdyn_ExpirationDate_TimezoneDateOnly: { a: 'msdyn_expirationdate' },
			msdyn_IssueDate_TimezoneDateOnly: { a: 'msdyn_issuedate' },
			Name: { a: 'name' },
