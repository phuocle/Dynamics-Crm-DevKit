...
declare namespace DevKit {
	namespace Formmsdynmkt_experiment_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynmkt_experiment_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynmkt_experiment_Information */
		Body: DevKit.Formmsdynmkt_experiment_Information.Body;
		/** The Navigation of form msdynmkt_experiment_Information */
		Navigation: DevKit.Formmsdynmkt_experiment_Information.Navigation;
		/** The SidePanes of form msdynmkt_experiment_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynmkt_experimentApi {
		/**
		* DynamicsCrm.DevKit msdynmkt_experimentApi
		...
		*/
		...
		msdynmkt_status: OptionSet.msdynmkt_experiment.msdynmkt_status;
		...
		statecode: OptionSet.msdynmkt_experiment.statecode;
		/** Reason for the status of the Experiment */
		statuscode: OptionSet.msdynmkt_experiment.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdynmkt_experimentId: string;
