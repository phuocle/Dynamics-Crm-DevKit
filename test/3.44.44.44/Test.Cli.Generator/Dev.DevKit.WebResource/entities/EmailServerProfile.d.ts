...
declare namespace DevKit {
	...
	class FormEmailServerProfile_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form EmailServerProfile_Information */
		Navigation: DevKit.FormEmailServerProfile_Information.Navigation;
...
declare namespace OptionSet {
	namespace EmailServerProfile {
		...
		enum ServerAuthority {
			/** 3 */
			Automatic_determined_by_Dynamics_365_cloud,
			/** 2 */
			China_21Vianet_httpsloginchinacloudapicn,
			/** 0 */
			Public_GCC_httpsloginmicrosoftonlinecom,
			/** 1 */
			US_Government_GCC_High_and_DoD_httpsloginmicrosoftonlineus
		}
		enum ServerType {
			/** 3 */
