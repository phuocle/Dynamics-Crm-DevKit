...
declare namespace DevKit {
	...
	class FormAccount_form_for_Conversation_Customer_Card extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The SidePanes of form Account_form_for_Conversation_Customer_Card */
		SidePanes: DevKit.SidePanes;
	}
	...
	class FormAccount_form_for_Customer_Card extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The SidePanes of form Account_form_for_Customer_Card */
		SidePanes: DevKit.SidePanes;
	}
	...
	class AccountApi {
		...
		*/
		...
		msevtmgt_HotelGroup: OptionSet.Account.msevtmgt_HotelGroup;
		msevtmgt_RentalCarProvider: OptionSet.Account.msevtmgt_RentalCarProvider;
		/** Type the company or business name. */
		Name: string;
		/** Type the number of employees that work at the account for use in marketing segmentation and demographic analysis. */
		...
		readonly FormattedValue: {
			...
			readonly msevtmgt_RentalCarProvider: string;
			/** Type the company or business name. */
