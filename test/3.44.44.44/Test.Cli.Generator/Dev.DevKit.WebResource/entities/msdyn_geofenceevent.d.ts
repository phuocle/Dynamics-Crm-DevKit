...
declare namespace DevKit {
	...
	class Formmsdyn_geofenceevent_Main_Form extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_geofenceevent_Main_Form */
		Navigation: DevKit.Formmsdyn_geofenceevent_Main_Form.Navigation;
	...
	class msdyn_geofenceeventApi {
		...
		*/
		...
		msdyn_GeofenceStatus: OptionSet.msdyn_geofenceevent.msdyn_GeofenceStatus;
		/** The geofence status timestamp. */
		msdyn_GeofenceStatusTimestamp_UtcDateAndTime: Date;
		/** The entity type of the record that entered or exited the geofence. */
		...
		statecode: OptionSet.msdyn_geofenceevent.statecode;
		/** Reason for the status of the Geofence Event */
		statuscode: OptionSet.msdyn_geofenceevent.statuscode;
