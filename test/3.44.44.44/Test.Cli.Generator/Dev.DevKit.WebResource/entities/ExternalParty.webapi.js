...
(function (DevKit) {
	...
	DevKit.ExternalPartyApi = function (e) {
		...
		for (var field in _externalparty) {
			var a = _externalparty[field].a;
			var b = _externalparty[field].b;
			var c = _externalparty[field].c;
			var d = _externalparty[field].d;
			var g = _externalparty[field].g;
			var r = _externalparty[field].r;
			webApiField(externalparty, field, e, a, b, c, d, r, u, g);
		}
