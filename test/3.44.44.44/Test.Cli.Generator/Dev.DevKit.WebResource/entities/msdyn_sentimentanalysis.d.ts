...
declare namespace DevKit {
	...
	class Formmsdyn_sentimentanalysis_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_sentimentanalysis_Information */
		Navigation: DevKit.Formmsdyn_sentimentanalysis_Information.Navigation;
	...
	class msdyn_sentimentanalysisApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_sentimentanalysis.ComponentState;
		...
		/** (Deprecated) Whether multi-language support is enabled */
