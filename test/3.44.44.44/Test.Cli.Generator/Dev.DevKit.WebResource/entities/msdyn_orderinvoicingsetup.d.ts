...
declare namespace DevKit {
	namespace Formmsdyn_orderinvoicingsetup_Information {
		...
		interface Navigation {
			msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingproduct_OrderInvoicingSetup: DevKit.Controls.NavigationItem,
			msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingsetupdate_InvoiceSetup: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_orderinvoicingsetup_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_orderinvoicingsetup_Information2 */
		Navigation: DevKit.Formmsdyn_orderinvoicingsetup_Information2.Navigation;
