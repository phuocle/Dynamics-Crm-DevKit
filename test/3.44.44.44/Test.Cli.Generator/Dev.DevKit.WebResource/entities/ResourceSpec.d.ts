...
declare namespace DevKit {
	namespace FormResourceSpec_Information {
		...
		interface Navigation {
			resource_spec_services: DevKit.Controls.NavigationItem,
			resourcespec_resources: DevKit.Controls.NavigationItem
		}
	}
	class FormResourceSpec_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form ResourceSpec_Information */
		Body: DevKit.FormResourceSpec_Information.Body;
		/** The Navigation of form ResourceSpec_Information */
		Navigation: DevKit.FormResourceSpec_Information.Navigation;
		/** The SidePanes of form ResourceSpec_Information */
		SidePanes: DevKit.SidePanes;
	}
	class ResourceSpecApi {
		/**
		* DynamicsCrm.DevKit ResourceSpecApi
