...
declare namespace DevKit {
	namespace FormActivity_Form {
		...
		interface tab_schedule_tab_Sections {
			_2BD38113_0183_4222_A8A9_791BAB4450C7: DevKit.Controls.Section;
		...
		interface Body {
			Tab: Tabs;
			info_duration: DevKit.Controls.ActionCards;
			...
			msdyncrm_durationamount: DevKit.Controls.Integer;
			msdyncrm_durationunit: DevKit.Controls.OptionSet;
	...
	class msdyncrm_delaydurationactivityApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_delaydurationactivityApi
		...
		*/
		...
		msdyncrm_delaydurationactivityId: string;
		msdyncrm_description: string;
		msdyncrm_durationamount: number;
		msdyncrm_durationunit: OptionSet.msdyncrm_delaydurationactivity.msdyncrm_durationunit;
		...
		msdyncrm_permitteddays: Array<OptionSet.msdyncrm_delaydurationactivity.msdyncrm_permitteddays>;
		...
		/** Status of the delayactivity */
		statecode: OptionSet.msdyncrm_delaydurationactivity.statecode;
		/** Reason for the status of the delayactivity */
		statuscode: OptionSet.msdyncrm_delaydurationactivity.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyncrm_delaydurationactivityId: string;
			readonly msdyncrm_description: string;
			readonly msdyncrm_durationamount: string;
			readonly msdyncrm_durationunit: string;
...
declare namespace OptionSet {
	namespace msdyncrm_delaydurationactivity {
		enum msdyncrm_durationunit {
			/** 192350002 */
			Day,
			/** 192350001 */
			Hour,
