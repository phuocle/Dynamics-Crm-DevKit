...
declare namespace DevKit {
	...
	class Formmsdyn_analysisresultdetail_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_analysisresultdetail_Information */
		Navigation: DevKit.Formmsdyn_analysisresultdetail_Information.Navigation;
	...
	class msdyn_analysisresultdetailApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_analysisresultdetail.statecode;
		/** Reason for the status of the Analysis Result Detail */
		statuscode: OptionSet.msdyn_analysisresultdetail.statuscode;
