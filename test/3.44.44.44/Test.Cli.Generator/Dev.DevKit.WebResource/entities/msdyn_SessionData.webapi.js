...
(function (DevKit) {
	...
	DevKit.msdyn_SessionDataApi = function (e) {
		...
		msdyn_sessiondata.ODataEntity = e;
		msdyn_sessiondata.FormattedValue = {};
		for (var field in _msdyn_sessiondata) {
			var a = _msdyn_sessiondata[field].a;
			var b = _msdyn_sessiondata[field].b;
			var c = _msdyn_sessiondata[field].c;
			var d = _msdyn_sessiondata[field].d;
			var g = _msdyn_sessiondata[field].g;
			var r = _msdyn_sessiondata[field].r;
			webApiField(msdyn_sessiondata, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sessiondata.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_sessiondata.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
