...
(function (DevKit) {
	...
	DevKit.ServiceAppointmentApi = function (e) {
		...
		var _serviceappointment = {
			...
			regardingobjectid_adx_invitation_serviceappointment: { b: 'regardingobjectid_adx_invitation_serviceappointment', a: '_regardingobjectid_value', c: 'adx_invitations', d: 'adx_invitation' },
			...
			regardingobjectid_msdyncrm_contentsettings_serviceappointment: { b: 'regardingobjectid_msdyncrm_contentsettings_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_contentsettingses', d: 'msdyncrm_contentsettings' },
			regardingobjectid_msdyncrm_customerjourney_serviceappointment: { b: 'regardingobjectid_msdyncrm_customerjourney_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_customerjourneies', d: 'msdyncrm_customerjourney' },
			regardingobjectid_msdyncrm_leadscoremodel_serviceappointment: { b: 'regardingobjectid_msdyncrm_leadscoremodel_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_leadscoremodels', d: 'msdyncrm_leadscoremodel' },
			regardingobjectid_msdyncrm_linkedinaccount_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinaccount_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinaccounts', d: 'msdyncrm_linkedinaccount' },
			regardingobjectid_msdyncrm_linkedinactivity_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinactivity_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinactivities', d: 'msdyncrm_linkedinactivity' },
			regardingobjectid_msdyncrm_linkedinfieldmapping_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinfieldmapping_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinfieldmappings', d: 'msdyncrm_linkedinfieldmapping' },
			regardingobjectid_msdyncrm_linkedinform_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinform_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinforms', d: 'msdyncrm_linkedinform' },
			regardingobjectid_msdyncrm_linkedinformanswer_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinformanswer_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformanswers', d: 'msdyncrm_linkedinformanswer' },
			regardingobjectid_msdyncrm_linkedinformquestion_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinformquestion_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformquestions', d: 'msdyncrm_linkedinformquestion' },
			regardingobjectid_msdyncrm_linkedinformsubmission_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinformsubmission_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformsubmissions', d: 'msdyncrm_linkedinformsubmission' },
			regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinleadmatchingstrategies', d: 'msdyncrm_linkedinleadmatchingstrategy' },
			regardingobjectid_msdyncrm_linkedinuserprofile_serviceappointment: { b: 'regardingobjectid_msdyncrm_linkedinuserprofile_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinuserprofiles', d: 'msdyncrm_linkedinuserprofile' },
			regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_serviceappointment: { b: 'regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_marketingdynamiccontentmetadatas', d: 'msdyncrm_marketingdynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_serviceappointment: { b: 'regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemaildynamiccontentmetadatas', d: 'msdyncrm_marketingemaildynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemailtestsend_serviceappointment: { b: 'regardingobjectid_msdyncrm_marketingemailtestsend_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemailtestsends', d: 'msdyncrm_marketingemailtestsend' },
			regardingobjectid_msdyncrm_migration_serviceappointment: { b: 'regardingobjectid_msdyncrm_migration_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_migrations', d: 'msdyncrm_migration' },
			regardingobjectid_msdyncrm_uicconfig_serviceappointment: { b: 'regardingobjectid_msdyncrm_uicconfig_serviceappointment', a: '_regardingobjectid_value', c: 'msdyncrm_uicconfigs', d: 'msdyncrm_uicconfig' },
			...
			regardingobjectid_msdyn_swarm_serviceappointment: { b: 'regardingobjectid_msdyn_swarm_serviceappointment', a: '_regardingobjectid_value', c: 'msdyn_swarms', d: 'msdyn_swarm' },
			...
			regardingobjectid_msevtmgt_checkin_serviceappointment: { b: 'regardingobjectid_msevtmgt_checkin_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_checkins', d: 'msevtmgt_checkin' },
			regardingobjectid_msevtmgt_event_serviceappointment: { b: 'regardingobjectid_msevtmgt_event_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_events', d: 'msevtmgt_event' },
			regardingobjectid_msevtmgt_eventpurchase_serviceappointment: { b: 'regardingobjectid_msevtmgt_eventpurchase_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchases', d: 'msevtmgt_eventpurchase' },
			regardingobjectid_msevtmgt_eventpurchaseattendee_serviceappointment: { b: 'regardingobjectid_msevtmgt_eventpurchaseattendee_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchaseattendees', d: 'msevtmgt_eventpurchaseattendee' },
			regardingobjectid_msevtmgt_eventpurchasepass_serviceappointment: { b: 'regardingobjectid_msevtmgt_eventpurchasepass_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchasepasses', d: 'msevtmgt_eventpurchasepass' },
			regardingobjectid_msevtmgt_eventregistration_serviceappointment: { b: 'regardingobjectid_msevtmgt_eventregistration_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_eventregistrations', d: 'msevtmgt_eventregistration' },
			regardingobjectid_msevtmgt_hotel_serviceappointment: { b: 'regardingobjectid_msevtmgt_hotel_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_hotels', d: 'msevtmgt_hotel' },
			regardingobjectid_msevtmgt_hotelroomallocation_serviceappointment: { b: 'regardingobjectid_msevtmgt_hotelroomallocation_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomallocations', d: 'msevtmgt_hotelroomallocation' },
			regardingobjectid_msevtmgt_hotelroomreservation_serviceappointment: { b: 'regardingobjectid_msevtmgt_hotelroomreservation_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomreservations', d: 'msevtmgt_hotelroomreservation' },
			regardingobjectid_msevtmgt_layout_serviceappointment: { b: 'regardingobjectid_msevtmgt_layout_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_layouts', d: 'msevtmgt_layout' },
			regardingobjectid_msevtmgt_room_serviceappointment: { b: 'regardingobjectid_msevtmgt_room_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_rooms', d: 'msevtmgt_room' },
			regardingobjectid_msevtmgt_session_serviceappointment: { b: 'regardingobjectid_msevtmgt_session_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_sessions', d: 'msevtmgt_session' },
			regardingobjectid_msevtmgt_sessionregistration_serviceappointment: { b: 'regardingobjectid_msevtmgt_sessionregistration_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_sessionregistrations', d: 'msevtmgt_sessionregistration' },
			regardingobjectid_msevtmgt_sessiontrack_serviceappointment: { b: 'regardingobjectid_msevtmgt_sessiontrack_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_sessiontracks', d: 'msevtmgt_sessiontrack' },
			regardingobjectid_msevtmgt_speaker_serviceappointment: { b: 'regardingobjectid_msevtmgt_speaker_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_speakers', d: 'msevtmgt_speaker' },
			regardingobjectid_msevtmgt_speakerengagement_serviceappointment: { b: 'regardingobjectid_msevtmgt_speakerengagement_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_speakerengagements', d: 'msevtmgt_speakerengagement' },
			regardingobjectid_msevtmgt_sponsorablearticle_serviceappointment: { b: 'regardingobjectid_msevtmgt_sponsorablearticle_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorablearticles', d: 'msevtmgt_sponsorablearticle' },
			regardingobjectid_msevtmgt_sponsorship_serviceappointment: { b: 'regardingobjectid_msevtmgt_sponsorship_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorships', d: 'msevtmgt_sponsorship' },
			regardingobjectid_msevtmgt_venue_serviceappointment: { b: 'regardingobjectid_msevtmgt_venue_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_venues', d: 'msevtmgt_venue' },
			regardingobjectid_msevtmgt_webinarconfiguration_serviceappointment: { b: 'regardingobjectid_msevtmgt_webinarconfiguration_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_webinarconfigurations', d: 'msevtmgt_webinarconfiguration' },
			regardingobjectid_msevtmgt_webinarprovider_serviceappointment: { b: 'regardingobjectid_msevtmgt_webinarprovider_serviceappointment', a: '_regardingobjectid_value', c: 'msevtmgt_webinarproviders', d: 'msevtmgt_webinarprovider' },
			regardingobjectid_mspp_adplacement_serviceappointment: { b: 'regardingobjectid_mspp_adplacement_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_adplacements', d: 'mspp_adplacement' },
			regardingobjectid_mspp_pollplacement_serviceappointment: { b: 'regardingobjectid_mspp_pollplacement_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_pollplacements', d: 'mspp_pollplacement' },
			regardingobjectid_mspp_publishingstatetransitionrule_serviceappointment: { b: 'regardingobjectid_mspp_publishingstatetransitionrule_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_publishingstatetransitionrules', d: 'mspp_publishingstatetransitionrule' },
			regardingobjectid_mspp_redirect_serviceappointment: { b: 'regardingobjectid_mspp_redirect_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_redirects', d: 'mspp_redirect' },
			regardingobjectid_mspp_shortcut_serviceappointment: { b: 'regardingobjectid_mspp_shortcut_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_shortcuts', d: 'mspp_shortcut' },
			regardingobjectid_mspp_website_serviceappointment: { b: 'regardingobjectid_mspp_website_serviceappointment', a: '_regardingobjectid_value', c: 'mspp_websites', d: 'mspp_website' },
