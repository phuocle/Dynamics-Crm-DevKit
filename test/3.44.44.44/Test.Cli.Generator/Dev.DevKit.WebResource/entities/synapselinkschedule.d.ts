...
declare namespace DevKit {
	class synapselinkscheduleApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.synapselinkschedule.ComponentState;
		...
		/** Recurrence unit */
		RecurrenceUnit: OptionSet.synapselinkschedule.RecurrenceUnit;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string;
		/** Start time */
		StartTime_UtcDateAndTime: Date;
		/** Status of the Synapse Link Schedule */
		statecode: OptionSet.synapselinkschedule.statecode;
		/** Reason for the status of the Synapse Link Schedule */
		statuscode: OptionSet.synapselinkschedule.statuscode;
		/** For internal use only. */
		...
		/** Schedule type */
		Type: OptionSet.synapselinkschedule.Type;
		/** Unique name */
		UniqueName: string;
