...
declare namespace DevKit {
	namespace Formmsdyn_workorderproduct_Information {
		...
		interface Navigation {
			msdyn_msdyn_workorderproduct_invoicedetail: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workorderproduct_msdyn_customerasset_WorkOrderProduct: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workorderproduct_msdyn_inventoryjournal_WorkOrderProduct: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workorderproduct_msdyn_rmaproduct_WOProduct: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workorderproduct_msdyn_rtvproduct_WorkOrderProduct: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_workorderproduct_Tasks: DevKit.Controls.NavigationItem
		}
	}
	...
	namespace FormAdd_Product_Mobile {
		interface tab_tab_1_Sections {
			sectionProduct: DevKit.Controls.Section;
	...
	class FormAdd_Product_Mobile extends DevKit.IForm {
		/**
		* Add Product Mobile [Quick Create]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form Add_Product_Mobile */
		Body: DevKit.FormAdd_Product_Mobile.Body;
	}
