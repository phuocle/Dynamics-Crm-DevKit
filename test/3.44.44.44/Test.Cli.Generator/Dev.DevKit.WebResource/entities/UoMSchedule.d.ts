...
declare namespace DevKit {
	namespace FormUoMSchedule_Information {
		...
		interface Navigation {
			contract_detail_unit_of_measure_schedule: DevKit.Controls.NavigationItem,
			msdyn_uomschedule_msdyn_actual_UnitSchedule: DevKit.Controls.NavigationItem,
			unit_of_measure_schedule_conversions: DevKit.Controls.NavigationItem,
			unit_of_measure_schedule_product_price_level: DevKit.Controls.NavigationItem,
			unit_of_measurement_schedule_products: DevKit.Controls.NavigationItem
		}
	}
	class FormUoMSchedule_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form UoMSchedule_Information */
		Navigation: DevKit.FormUoMSchedule_Information.Navigation;
