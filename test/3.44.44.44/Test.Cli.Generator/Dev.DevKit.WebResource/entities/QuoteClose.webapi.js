...
(function (DevKit) {
	...
	DevKit.QuoteCloseApi = function (e) {
		...
		var _quoteclose = {
			...
			regardingobjectid_adx_invitation_quoteclose: { b: 'regardingobjectid_adx_invitation_quoteclose', a: '_regardingobjectid_value', c: 'adx_invitations', d: 'adx_invitation' },
			...
			regardingobjectid_mspp_adplacement_quoteclose: { b: 'regardingobjectid_mspp_adplacement_quoteclose', a: '_regardingobjectid_value', c: 'mspp_adplacements', d: 'mspp_adplacement' },
			regardingobjectid_mspp_pollplacement_quoteclose: { b: 'regardingobjectid_mspp_pollplacement_quoteclose', a: '_regardingobjectid_value', c: 'mspp_pollplacements', d: 'mspp_pollplacement' },
			regardingobjectid_mspp_publishingstatetransitionrule_quoteclose: { b: 'regardingobjectid_mspp_publishingstatetransitionrule_quoteclose', a: '_regardingobjectid_value', c: 'mspp_publishingstatetransitionrules', d: 'mspp_publishingstatetransitionrule' },
			regardingobjectid_mspp_redirect_quoteclose: { b: 'regardingobjectid_mspp_redirect_quoteclose', a: '_regardingobjectid_value', c: 'mspp_redirects', d: 'mspp_redirect' },
			regardingobjectid_mspp_shortcut_quoteclose: { b: 'regardingobjectid_mspp_shortcut_quoteclose', a: '_regardingobjectid_value', c: 'mspp_shortcuts', d: 'mspp_shortcut' },
			regardingobjectid_mspp_website_quoteclose: { b: 'regardingobjectid_mspp_website_quoteclose', a: '_regardingobjectid_value', c: 'mspp_websites', d: 'mspp_website' },
