...
(function (DevKit) {
	'use strict';
	DevKit.CampaignResponseApi = function (e) {
		...
		campaignresponse.ODataEntity = e;
		campaignresponse.FormattedValue = {};
		for (var field in _campaignresponse) {
			var a = _campaignresponse[field].a;
			var b = _campaignresponse[field].b;
			var c = _campaignresponse[field].c;
			var d = _campaignresponse[field].d;
			var g = _campaignresponse[field].g;
			var r = _campaignresponse[field].r;
			webApiField(campaignresponse, field, e, a, b, c, d, r, u, g);
		}
		...
		campaignresponse.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		campaignresponse.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
