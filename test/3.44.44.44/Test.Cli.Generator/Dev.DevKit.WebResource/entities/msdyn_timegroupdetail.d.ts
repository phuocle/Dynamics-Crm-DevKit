...
declare namespace DevKit {
	namespace Formmsdyn_timegroupdetail_Information {
		...
		interface Navigation {
			msdyn_msdyn_timegroupdetail_bookableresourcebooking_TimeGroupDetailSelected: DevKit.Controls.NavigationItem,
			msdyn_msdyn_timegroupdetail_msdyn_workorder_TimeGroupDetailSelected: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_Appointments: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_Emails: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_QueueItems: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_timegroupdetail_Tasks: DevKit.Controls.NavigationItem
		}
	}
	...
	class msdyn_timegroupdetailApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Shows the entity instances. */
			readonly msdyn_timegroupdetailId: string;
			/** Unique identifier for Time Group associated with Time Group Detail. */
