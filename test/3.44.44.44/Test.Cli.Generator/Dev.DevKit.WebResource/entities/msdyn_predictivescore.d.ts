...
declare namespace DevKit {
	namespace Formmsdyn_predictivescore_Information {
		...
		interface Navigation {
			msdyn_msdyn_predictivescore_lead: DevKit.Controls.NavigationItem,
			msdyn_msdyn_predictivescore_opportunity: DevKit.Controls.NavigationItem,
			msdyn_PS_PMS: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_predictivescore_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_predictivescore_Information */
		Navigation: DevKit.Formmsdyn_predictivescore_Information.Navigation;
