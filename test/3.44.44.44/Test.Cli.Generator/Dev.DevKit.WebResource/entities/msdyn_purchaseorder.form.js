...
(function (DevKit) {
	...
	DevKit.FormPurchase_Order = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			...
			msdyn_msdyn_purchaseorder_msdyn_purchaseorderbill_PurchaseOrder: {},
			msdyn_msdyn_purchaseorder_msdyn_purchaseorderproduct_PurchaseOrder: {},
			msdyn_msdyn_purchaseorder_msdyn_purchaseorderreceipt_PurchaseOrder: {},
			msdyn_msdyn_purchaseorder_msdyn_purchaseorderreceiptproduct_PurchaseOrder: {},
			msdyn_msdyn_purchaseorder_msdyn_rtv_OriginalPO: {},
			msdyn_purchaseorder_adx_inviteredemptions: {},
			msdyn_purchaseorder_adx_portalcomments: {},
			msdyn_purchaseorder_Appointments: {},
			msdyn_purchaseorder_Emails: {},
			msdyn_purchaseorder_msdyn_bookingalerts: {},
			msdyn_purchaseorder_msdyn_copilottranscripts: {},
			msdyn_purchaseorder_msdyn_ocliveworkitems: {},
			msdyn_purchaseorder_msdyn_ocoutboundmessages: {},
			msdyn_purchaseorder_msdyn_ocsessions: {},
			msdyn_purchaseorder_msdyn_ocvoicemails: {},
			msdyn_purchaseorder_msfp_alerts: {},
			msdyn_purchaseorder_msfp_surveyinvites: {},
			msdyn_purchaseorder_msfp_surveyresponses: {},
			msdyn_purchaseorder_PhoneCalls: {},
			msdyn_purchaseorder_ServiceAppointments: {},
			msdyn_purchaseorder_Tasks: {}
		};
