...
declare namespace DevKit {
	class BookableResourceBookingExchangeSyncIdMappingApi {
		/**
		* DynamicsCrm.DevKit BookableResourceBookingExchangeSyncIdMappingApi
		...
		*/
		...
		Retries: number;
		SyncStatus: OptionSet.BookableResourceBookingExchangeSyncIdMapping.SyncStatus;
		...
		readonly FormattedValue: {
			readonly BookableResourceBookingExchangeSyncIdMappingId: string;
			...
			readonly SyncVersionNumber: string;
			/** For internal use only. */
