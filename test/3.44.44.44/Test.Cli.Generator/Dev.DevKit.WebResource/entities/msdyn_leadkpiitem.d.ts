...
declare namespace DevKit {
	namespace Formmsdyn_leadkpiitem_Information {
		interface Tabs {
		}
		interface Body {
		...
		interface Navigation {
			msdyn_msdyn_leadkpiitem_lead_leadkpiid: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_leadkpiitem_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_leadkpiitem_Information */
		Body: DevKit.Formmsdyn_leadkpiitem_Information.Body;
		/** The Navigation of form msdyn_leadkpiitem_Information */
		Navigation: DevKit.Formmsdyn_leadkpiitem_Information.Navigation;
		/** The SidePanes of form msdyn_leadkpiitem_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_leadkpiitem_Information2 {
		interface Tabs {
		}
		interface Body {
			/** The name of the custom entity. */
	...
	class Formmsdyn_leadkpiitem_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		...
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form msdyn_leadkpiitem_Information2 */
		Body: DevKit.Formmsdyn_leadkpiitem_Information2.Body;
		/** The Navigation of form msdyn_leadkpiitem_Information2 */
		Navigation: DevKit.Formmsdyn_leadkpiitem_Information2.Navigation;
		/** The SidePanes of form msdyn_leadkpiitem_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_leadkpiitemApi {
		/**
		* DynamicsCrm.DevKit msdyn_leadkpiitemApi
		...
		*/
		...
		msdyn_computationaccuracy: OptionSet.msdyn_leadkpiitem.msdyn_computationaccuracy;
		...
		msdyn_lastactivitydirection: OptionSet.msdyn_leadkpiitem.msdyn_lastactivitydirection;
		...
		msdyn_nextactivitydirection: OptionSet.msdyn_leadkpiitem.msdyn_nextactivitydirection;
		...
		/** KPI health score. */
		msdyn_relationshiphealthscorestate: OptionSet.msdyn_leadkpiitem.msdyn_relationshiphealthscorestate;
		/** Health score for the lead. */
		msdyn_relationshiphealthscorevalue: number;
		/** Direction the relationship health is moving. */
		msdyn_relationshiphealthtrend: OptionSet.msdyn_leadkpiitem.msdyn_relationshiphealthtrend;
		...
		/** Status of the Lead KPI. */
		statecode: OptionSet.msdyn_leadkpiitem.statecode;
		/** Reason for the status of the Lead KPI. */
		statuscode: OptionSet.msdyn_leadkpiitem.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Parent lead ID. */
			readonly msdyn_leadid: string;
			/** Unique identifier for entity instances. */
			readonly msdyn_leadkpiitemId: string;
