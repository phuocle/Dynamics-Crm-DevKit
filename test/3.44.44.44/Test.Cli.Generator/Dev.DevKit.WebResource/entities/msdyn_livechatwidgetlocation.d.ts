...
declare namespace DevKit {
	...
	class Formmsdyn_livechatwidgetlocation_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_livechatwidgetlocation_Information */
		Navigation: DevKit.Formmsdyn_livechatwidgetlocation_Information.Navigation;
	...
	class Formmsdyn_livechatwidgetlocation_New_Form extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_livechatwidgetlocation_New_Form.Body;
	}
	class msdyn_livechatwidgetlocationApi {
		/**
		* DynamicsCrm.DevKit msdyn_livechatwidgetlocationApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_livechatwidgetlocation.ComponentState;
		...
		/** URL where chat widget is configured to work. Can be a wild card entry */
		msdyn_locationurlwildcard: string;
		/** The name of the custom entity. */
		msdyn_name: string;
		/** Include/Exclude rule for Widget Location */
		msdyn_RuleType: OptionSet.msdyn_livechatwidgetlocation.msdyn_RuleType;
		...
		/** Status of the Chat widget location */
		statecode: OptionSet.msdyn_livechatwidgetlocation.statecode;
		/** Reason for the status of the Chat widget location */
		statuscode: OptionSet.msdyn_livechatwidgetlocation.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Domain on which the chat should be available */
			readonly msdyn_domainValue: string;
			/** Identifier of the chat widget that this location entity controls */
			readonly msdyn_livechatconfigid: string;
			/** Unique identifier for entity instances */
			readonly msdyn_livechatwidgetlocationId: string;
			/** URL where chat widget is configured to work. Can be a wild card entry */
			readonly msdyn_locationurlwildcard: string;
			/** The name of the custom entity. */
