...
(function (DevKit) {
	'use strict';
	DevKit.FormDEPRECATED_Information = function(executionContext, defaultWebResourceName) {
		...
		form.Grid = grid;
		var navigation = {
			msdyn_playbooktemplate_msdyn_playbookactivity: {},
			msdyn_playbooktemplate_msdyn_playbookinstance: {}
		};
