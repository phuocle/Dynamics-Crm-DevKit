...
declare namespace DevKit {
	namespace FormActivity_Form {
		...
		interface tab_main_tab_Sections {
			_6C23B9F9_BC4E_4EDB_9508_50F0D22D9D70_SECTION_2: DevKit.Controls.Section;
			_D907109B_6B63_402F_9D1E_F35E1867D01E: DevKit.Controls.Section;
			description_section: DevKit.Controls.Section;
			details_section: DevKit.Controls.Section;
		}
		...
		interface Body {
			Tab: Tabs;
			/** Unique identifier for Process associated with linkedincampaignactivity. */
			msdyncrm_campaignid: DevKit.Controls.Lookup;
			insights_data: DevKit.Controls.ActionCards;
			/** Unique identifier for Process associated with linkedincampaignactivity. */
			msdyncrm_campaignid1: DevKit.Controls.Lookup;
	...
	class msdyncrm_linkedincampaignactivityApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_linkedincampaignactivityApi
		...
		*/
		...
		/** Unique identifier for Process associated with linkedincampaignactivity. */
		msdyncrm_campaignid: string;
		msdyncrm_description: string;
		msdyncrm_insightsdata: string;
		/** Unique identifier for entity instances */
		msdyncrm_linkedincampaignactivityId: string;
		/** The name of the custom entity. */
		...
		/** Status of the linkedincampaignactivity */
		statecode: OptionSet.msdyncrm_linkedincampaignactivity.statecode;
		/** Reason for the status of the linkedincampaignactivity */
		statuscode: OptionSet.msdyncrm_linkedincampaignactivity.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for Process associated with linkedincampaignactivity. */
			readonly msdyncrm_campaignid: string;
			readonly msdyncrm_description: string;
			readonly msdyncrm_insightsdata: string;
			/** Unique identifier for entity instances */
			readonly msdyncrm_linkedincampaignactivityId: string;
			/** The name of the custom entity. */
...
declare namespace OptionSet {
	namespace msdyncrm_linkedincampaignactivity {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
