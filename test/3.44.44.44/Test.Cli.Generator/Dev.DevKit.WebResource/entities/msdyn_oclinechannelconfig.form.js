...
(function (DevKit) {
	...
	DevKit.Formmsdyn_oclinechannelconfig_Information = function(executionContext, defaultWebResourceName) {
		...
		form.Grid = grid;
		var navigation = {
			msdyn_oclinechannelconfig_msdyn_ocbotchannelregistration_msdyn_oclinechannelconfigid: {},
			msdyn_oclinechannelconfig_msdyn_ocprovisioningstate_oclinechannelconfigid: {},
			msdyn_oclinechannelconfig_msdyn_surveyconfig_msdyn_targetchannelid: {}
		};
