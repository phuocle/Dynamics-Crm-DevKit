...
declare namespace DevKit {
	namespace Formmsdyn_timelinepin_Information {
		interface Tabs {
		}
		interface Body {
			/** Name */
	...
	class Formmsdyn_timelinepin_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_timelinepin_Information */
		Body: DevKit.Formmsdyn_timelinepin_Information.Body;
		/** The Navigation of form msdyn_timelinepin_Information */
		Navigation: DevKit.Formmsdyn_timelinepin_Information.Navigation;
		/** The SidePanes of form msdyn_timelinepin_Information */
