...
(function (DevKit) {
	...
	DevKit.msdyn_ocwechatchannelconfigApi = function (e) {
		...
		var _msdyn_ocwechatchannelconfig = {
			...
			msdyn_secureapplicationsecret: { a: 'msdyn_secureapplicationsecret' },
			msdyn_secureencodingaeskey: { a: 'msdyn_secureencodingaeskey' },
			msdyn_securetoken: { a: 'msdyn_securetoken' },
		...
		msdyn_ocwechatchannelconfig.ODataEntity = e;
		msdyn_ocwechatchannelconfig.FormattedValue = {};
		for (var field in _msdyn_ocwechatchannelconfig) {
			var a = _msdyn_ocwechatchannelconfig[field].a;
			var b = _msdyn_ocwechatchannelconfig[field].b;
			var c = _msdyn_ocwechatchannelconfig[field].c;
			var d = _msdyn_ocwechatchannelconfig[field].d;
			var g = _msdyn_ocwechatchannelconfig[field].g;
			var r = _msdyn_ocwechatchannelconfig[field].r;
			webApiField(msdyn_ocwechatchannelconfig, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocwechatchannelconfig.getAliasedValue = function (alias, isMultiOptionSet = false) {
