...
declare namespace DevKit {
	namespace Formmsdyn_iotdevicecommanddefinition_Information {
		...
		interface Navigation {
			msdyn_msdyn_iotdevicecommanddefinition_msdyn_iotdevicecommand_Command: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_iotdevicecommanddefinition_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotdevicecommanddefinition_Information */
		Navigation: DevKit.Formmsdyn_iotdevicecommanddefinition_Information.Navigation;
	...
	class msdyn_iotdevicecommanddefinitionApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_iotdevicecommanddefinition.statecode;
		/** Reason for the status of the IoT Device Command Definition */
		statuscode: OptionSet.msdyn_iotdevicecommanddefinition.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotdevicecommanddefinitionId: string;
			/** The name of the custom entity. */
