...
(function (DevKit) {
	...
	DevKit.InvoiceApi = function (e) {
		...
		var u = {};
		var invoice = {};
		invoice.ODataEntity = e;
		invoice.FormattedValue = {};
		for (var field in _invoice) {
			var a = _invoice[field].a;
			var b = _invoice[field].b;
			var c = _invoice[field].c;
			var d = _invoice[field].d;
			var g = _invoice[field].g;
			var r = _invoice[field].r;
			webApiField(invoice, field, e, a, b, c, d, r, u, g);
		}
		invoice.Entity = u;
		invoice.EntityName = 'invoice';
		invoice.EntityCollectionName = 'invoices';
		invoice['@odata.etag'] = e['@odata.etag'];
		invoice.getAliasedValue = function (alias, isMultiOptionSet = false) {
