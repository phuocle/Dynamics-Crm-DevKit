...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_contactkpiitemApi = function (e) {
		...
		var _msdyn_contactkpiitem = {
			...
			msdyn_contactid: { b: 'msdyn_contactid', a: '_msdyn_contactid_value', c: 'contacts', d: 'contact' },
			msdyn_contactkpiitemId: { a: 'msdyn_contactkpiitemid' },
			...
			msdyn_numberofopportunities: { a: 'msdyn_numberofopportunities' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_contactkpiitem = {};
		msdyn_contactkpiitem.ODataEntity = e;
		msdyn_contactkpiitem.FormattedValue = {};
		for (var field in _msdyn_contactkpiitem) {
			var a = _msdyn_contactkpiitem[field].a;
			var b = _msdyn_contactkpiitem[field].b;
			var c = _msdyn_contactkpiitem[field].c;
			var d = _msdyn_contactkpiitem[field].d;
			var g = _msdyn_contactkpiitem[field].g;
			var r = _msdyn_contactkpiitem[field].r;
			webApiField(msdyn_contactkpiitem, field, e, a, b, c, d, r, u, g);
		}
		msdyn_contactkpiitem.Entity = u;
		msdyn_contactkpiitem.EntityName = 'msdyn_contactkpiitem';
		msdyn_contactkpiitem.EntityCollectionName = 'msdyn_contactkpiitems';
		msdyn_contactkpiitem['@odata.etag'] = e['@odata.etag'];
		msdyn_contactkpiitem.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_contactkpiitem.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_contactkpiitem;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyn_contactkpiitem = {
