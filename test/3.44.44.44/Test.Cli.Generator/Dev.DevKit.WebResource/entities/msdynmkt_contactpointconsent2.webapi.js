...
(function (DevKit) {
	'use strict';
	DevKit.msdynmkt_contactpointconsent2Api = function (e) {
		...
		var _msdynmkt_contactpointconsent2 = {
			...
			msdynmkt_contactpointconsent2Id: { a: 'msdynmkt_contactpointconsent2id' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdynmkt_contactpointconsent2 = {};
		msdynmkt_contactpointconsent2.ODataEntity = e;
		msdynmkt_contactpointconsent2.FormattedValue = {};
		for (var field in _msdynmkt_contactpointconsent2) {
			var a = _msdynmkt_contactpointconsent2[field].a;
			var b = _msdynmkt_contactpointconsent2[field].b;
			var c = _msdynmkt_contactpointconsent2[field].c;
			var d = _msdynmkt_contactpointconsent2[field].d;
			var g = _msdynmkt_contactpointconsent2[field].g;
			var r = _msdynmkt_contactpointconsent2[field].r;
			webApiField(msdynmkt_contactpointconsent2, field, e, a, b, c, d, r, u, g);
		}
		msdynmkt_contactpointconsent2.Entity = u;
		msdynmkt_contactpointconsent2.EntityName = 'msdynmkt_contactpointconsent2';
		msdynmkt_contactpointconsent2.EntityCollectionName = 'msdynmkt_contactpointconsent2s';
		msdynmkt_contactpointconsent2['@odata.etag'] = e['@odata.etag'];
		msdynmkt_contactpointconsent2.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdynmkt_contactpointconsent2.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdynmkt_contactpointconsent2;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdynmkt_contactpointconsent2 = {
