...
declare namespace DevKit {
	namespace Formmsdyn_requirementgroup_Information {
		...
		interface Navigation {
			msdyn_requirementgroup_bookableresourcebooking_requirementgroupid: DevKit.Controls.NavigationItem,
			msdyn_requirementgroup_incidenttype_reqgroup: DevKit.Controls.NavigationItem,
			msdyn_requirementgroup_requirementgroup_requirementgrouptemplateid: DevKit.Controls.NavigationItem,
			msdyn_requirementgroup_requirementrelationship_requirementgroupid: DevKit.Controls.NavigationItem,
			msdyn_requirementgroup_resourcerequirement_requirementgroupid: DevKit.Controls.NavigationItem,
			msdyn_requirementgroup_service: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class msdyn_requirementgroupApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Auto Group Type */
			readonly msdyn_autogrouptype: string;
			/** Whether this offering is a template or not. */
			...
			/** Requirement Group Template Reference */
			readonly msdyn_requirementgrouptemplateid: string;
			/** Date and time that the record was migrated. */
