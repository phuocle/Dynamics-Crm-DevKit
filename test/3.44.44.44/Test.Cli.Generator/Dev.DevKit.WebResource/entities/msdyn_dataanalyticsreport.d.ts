...
declare namespace DevKit {
	namespace FormAnalytics_Report_Record {
		...
		interface Navigation {
			msdyn_dataanalyticsreport_dataanalyticscustomizedreport_dataanalyticsreportid: DevKit.Controls.NavigationItem
		}
	}
	class FormAnalytics_Report_Record extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Analytics_Report_Record */
		Navigation: DevKit.FormAnalytics_Report_Record.Navigation;
	...
	class msdyn_dataanalyticsreportApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Power BI Dataset Id */
			readonly msdyn_datasetid: string;
			/** Report Id of dataverse report entity */
