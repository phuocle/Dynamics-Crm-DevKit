...
declare namespace DevKit {
	namespace Formmsdyn_suggestionrequestpayload_Information {
		...
		interface Navigation {
			msdyn_msdyn_suggestionrequestpayload_msdyn_suggestioninteraction_SuggestionRequestPayload: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_suggestionrequestpayload_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_suggestionrequestpayload_Information */
		Navigation: DevKit.Formmsdyn_suggestionrequestpayload_Information.Navigation;
	...
	class msdyn_suggestionrequestpayloadApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_suggestionrequestpayload.statecode;
		/** Reason for the status of the Suggestion request payload */
		statuscode: OptionSet.msdyn_suggestionrequestpayload.statuscode;
