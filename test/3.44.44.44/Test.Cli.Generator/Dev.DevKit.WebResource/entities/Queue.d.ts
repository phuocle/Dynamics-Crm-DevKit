...
declare namespace DevKit {
	namespace FormQueue_Information {
		...
		interface Navigation {
			...
			msdyn_liveworkstream_defaultqueue_Queue: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_assignmentconfiguration_queueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_liveconversation: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_liveworkstream_msdyn_bot_queue: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_liveworkstream_queueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_ocliveworkitem_queueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_ocsession_queueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_originatingqueue_queueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_salesroutingrun_ownerassigned: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_salesroutingrun_previousowner: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_sessionparticipant_msdyn_cdsqueueid: DevKit.Controls.NavigationItem,
			msdyn_queue_msdyn_unifiedroutingrun_queue: DevKit.Controls.NavigationItem,
			msdyn_queue_ocruleitem: DevKit.Controls.NavigationItem,
			msdyn_rulesetdependencymapping_queue_msdyn_referencedpolymorphicentityid: DevKit.Controls.NavigationItem,
			...
			queue_msdyn_entityId_msdyn_activeicdextension: DevKit.Controls.NavigationItem,
			queue_msdyn_entityId_msdyn_entityWorkstreamMap: DevKit.Controls.NavigationItem,
			queue_msdyn_entityId_msdyn_icdextension: DevKit.Controls.NavigationItem
		}
	}
	class FormQueue_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Queue_Information */
		Navigation: DevKit.FormQueue_Information.Navigation;
	...
	class FormOmnichannel_queue extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Omnichannel_queue */
		Navigation: DevKit.FormOmnichannel_queue.Navigation;
	...
	namespace FormQueue {
		...
		interface Body {
			...
			/** Email address that is associated with the queue. */
			EMailAddress: DevKit.Controls.String;
			EmailSignature: DevKit.Controls.Lookup;
			/** Convert Incoming Email To Activities */
			IncomingEmailFilteringMethod: DevKit.Controls.OptionSet;
			/** Name of the queue. */
			Name: DevKit.Controls.String;
	...
	class FormQueue extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Queue */
		Navigation: DevKit.FormQueue.Navigation;
	...
	class FormQueue_Hub_Form extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Queue_Hub_Form */
		Navigation: DevKit.FormQueue_Hub_Form.Navigation;
	...
	class QueueApi {
		...
		*/
		...
		msdyn_inqueueoverflowrulesetid: string;
		...
		msdyn_prequeueoverflowrulesetid: string;
		/** Priority of the queue to indicate conversation assignment order to the agent. */
		...
		readonly FormattedValue: {
			...
			/** Define overflow rules for work items after it enters queue */
			readonly msdyn_inqueueoverflowrulesetid: string;
			...
			/** Setting to enable/disable periodic processing of a queue */
			readonly msdyn_operatinghoursbasedassignment: string;
			/** Define overflow rules for work items before it enters queue */
			readonly msdyn_prequeueoverflowrulesetid: string;
			/** Priority of the queue to indicate conversation assignment order to the agent. */
			readonly msdyn_priority: string;
			/** Setting to enable/disable periodic processing of a queue */
			readonly msdyn_processqueueperiodically: string;
			/** Defines the type of channels handled by this queue */
