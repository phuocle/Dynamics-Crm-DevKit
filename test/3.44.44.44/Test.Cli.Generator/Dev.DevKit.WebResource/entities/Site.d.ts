...
declare namespace DevKit {
	namespace FormSite_Information {
		...
		interface Navigation {
			site_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			site_adx_portalcomments: DevKit.Controls.NavigationItem,
			site_Appointments: DevKit.Controls.NavigationItem,
			site_Emails: DevKit.Controls.NavigationItem,
			site_equipment: DevKit.Controls.NavigationItem,
			site_internal_addresses: DevKit.Controls.NavigationItem,
			site_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			site_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			site_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			site_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			site_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			site_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			site_msfp_alerts: DevKit.Controls.NavigationItem,
			site_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			site_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			site_OpportunityCloses: DevKit.Controls.NavigationItem,
			site_OrderCloses: DevKit.Controls.NavigationItem,
			site_PhoneCalls: DevKit.Controls.NavigationItem,
			site_QuoteCloses: DevKit.Controls.NavigationItem,
			site_resources: DevKit.Controls.NavigationItem,
			site_service_appointments: DevKit.Controls.NavigationItem,
			site_ServiceAppointments: DevKit.Controls.NavigationItem,
			site_system_users: DevKit.Controls.NavigationItem,
			site_Tasks: DevKit.Controls.NavigationItem
		}
	}
	class FormSite_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Site_Information */
		Navigation: DevKit.FormSite_Information.Navigation;
