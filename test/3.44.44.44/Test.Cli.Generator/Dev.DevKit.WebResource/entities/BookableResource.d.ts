...
declare namespace DevKit {
	namespace FormBookable_Resource_Mobile {
		...
		interface Navigation {
			bookableresource_bookableresourcebooking_Resource: DevKit.Controls.NavigationItem,
			bookableresource_bookableresourcecategoryassn_Resource: DevKit.Controls.NavigationItem,
			bookableresource_bookableresourcecharacteristic_Resource: DevKit.Controls.NavigationItem,
			bookableresource_bookableresourcegroup_ChildResource: DevKit.Controls.NavigationItem,
			bookableresource_bookableresourcegroup_ParentResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_account_PreferredResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_bookableresourcebooking_Crew: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_bookableresourcebooking_ResourceGroup: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_bookableresourcebookingheader_bookableresourceid: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_actual_bookableresource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_agreementbookingdate_Resource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_agreementbookingsetup_PreferredResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_bookableresourceassociation_Resource1: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_bookableresourceassociation_Resource2: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_bookableresourcecapacityprofile: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_inventoryadjustment_AdjustedByResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_inventoryadjustment_RequestedByResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_inventorytransfer_TransferredByResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_purchaseorder_RequestedByResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_quotebookingsetup_PreferredResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_requirementresourcepreference_BookableResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_resourceterritory_Resource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_timeentry_bookableresource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_timeoffrequest_Resource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_workhourtemplate_bookableresourceid: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_workorder_PreferredResource: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_workorder_SupportContact: DevKit.Controls.NavigationItem,
			msdyn_bookableresource_msdyn_workorderresourcerestriction_Resource: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	namespace FormBookableResource_Information {
		...
		interface Body {
			...
			msdyn_GenericType: DevKit.Controls.OptionSet;
			msdyn_HourlyRate: DevKit.Controls.Money;
			msdyn_OptimalCrewSize: DevKit.Controls.Integer;
	...
	class BookableResourceApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly msdyn_OptimalCrewSize: string;
			/** Organizational Unit that resource belong to */
