...
declare namespace DevKit {
	namespace Formmsdyn_purchaseorderbill_Information {
		...
		interface Navigation {
			bpf_msdyn_purchaseorderbill_msdyn_bpf_2c5fe86acc8b414b8322ae571000c799: DevKit.Controls.NavigationItem,
			msdyn_msdyn_purchaseorderbill_msdyn_purchaseorderreceiptproduct_PurchaseOrderBill: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_Appointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_Emails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderbill_Tasks: DevKit.Controls.NavigationItem
		}
