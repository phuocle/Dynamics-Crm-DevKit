...
declare namespace DevKit {
	...
	class Formmsdyn_routingconfigurationstep_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_routingconfigurationstep_Information */
		Navigation: DevKit.Formmsdyn_routingconfigurationstep_Information.Navigation;
	...
	class msdyn_routingconfigurationstepApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_routingconfigurationstep.ComponentState;
		...
		/** Defines the purpose of routing configuration step */
		msdyn_type: OptionSet.msdyn_routingconfigurationstep.msdyn_type;
		/** Unique name for the routing configuration step record */
		...
		statecode: OptionSet.msdyn_routingconfigurationstep.statecode;
		/** Reason for the status of the Routing configuration step */
		statuscode: OptionSet.msdyn_routingconfigurationstep.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_routingconfigurationstepId: string;
			/** Rule set for the routing configuration step */
