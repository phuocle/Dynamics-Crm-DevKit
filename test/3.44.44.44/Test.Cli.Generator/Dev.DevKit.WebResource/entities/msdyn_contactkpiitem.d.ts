...
declare namespace DevKit {
	namespace Formmsdyn_contactkpiitem_Information {
		interface Tabs {
		}
		interface Body {
		...
		interface Navigation {
			msdyn_msdyn_contactkpiitem_contact_contactkpiid: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_contactkpiitem_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyn_contactkpiitem_Information */
		Body: DevKit.Formmsdyn_contactkpiitem_Information.Body;
		/** The Navigation of form msdyn_contactkpiitem_Information */
		Navigation: DevKit.Formmsdyn_contactkpiitem_Information.Navigation;
		/** The SidePanes of form msdyn_contactkpiitem_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_contactkpiitem_Information2 {
		interface Tabs {
		}
		interface Body {
			/** Name of the custom entity. */
	...
	class Formmsdyn_contactkpiitem_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		...
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form msdyn_contactkpiitem_Information2 */
		Body: DevKit.Formmsdyn_contactkpiitem_Information2.Body;
		/** The Navigation of form msdyn_contactkpiitem_Information2 */
		Navigation: DevKit.Formmsdyn_contactkpiitem_Information2.Navigation;
		/** The SidePanes of form msdyn_contactkpiitem_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_contactkpiitemApi {
		/**
		* DynamicsCrm.DevKit msdyn_contactkpiitemApi
		...
		*/
		...
		msdyn_computationaccuracy: OptionSet.msdyn_contactkpiitem.msdyn_computationaccuracy;
		/** Parent Contact ID */
		...
		/** Name of the custom entity. */
		msdyn_name: string;
		/** Number of open opportunities linked to this contact from the primary contact. */
		...
		/** KPI health score. */
		msdyn_relationshiphealthscorestate: OptionSet.msdyn_contactkpiitem.msdyn_relationshiphealthscorestate;
		/** Health score for the contact. */
		msdyn_relationshiphealthscorevalue: number;
		/** Direction the relationship health is moving. */
		msdyn_relationshiphealthtrend: OptionSet.msdyn_contactkpiitem.msdyn_relationshiphealthtrend;
		...
		/** Status of the Contact KPI. */
		statecode: OptionSet.msdyn_contactkpiitem.statecode;
		/** Reason for the status of the Contact KPI. */
		statuscode: OptionSet.msdyn_contactkpiitem.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique Identifier for Entity Instances */
			readonly msdyn_contactkpiitemId: string;
			...
			/** Number of open opportunities linked to this contact from the primary contact. */
			readonly msdyn_numberofopportunities: string;
			/** Shows the rate of opening followed emails. */
...
declare namespace OptionSet {
	namespace msdyn_contactkpiitem {
