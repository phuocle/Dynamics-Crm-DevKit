...
(function (DevKit) {
	...
	DevKit.EntitlementApi = function (e) {
		...
		var u = {};
		var entitlement = {};
		entitlement.ODataEntity = e;
		entitlement.FormattedValue = {};
		for (var field in _entitlement) {
			var a = _entitlement[field].a;
			var b = _entitlement[field].b;
			var c = _entitlement[field].c;
			var d = _entitlement[field].d;
			var g = _entitlement[field].g;
			var r = _entitlement[field].r;
			webApiField(entitlement, field, e, a, b, c, d, r, u, g);
		}
		...
		entitlement.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		entitlement.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
