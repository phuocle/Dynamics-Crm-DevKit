...
(function (DevKit) {
	...
	DevKit.msdyn_ocskillidentmlmodelApi = function (e) {
		...
		var _msdyn_ocskillidentmlmodel = {
		...
		msdyn_ocskillidentmlmodel.ODataEntity = e;
		msdyn_ocskillidentmlmodel.FormattedValue = {};
		for (var field in _msdyn_ocskillidentmlmodel) {
			var a = _msdyn_ocskillidentmlmodel[field].a;
			var b = _msdyn_ocskillidentmlmodel[field].b;
			var c = _msdyn_ocskillidentmlmodel[field].c;
			var d = _msdyn_ocskillidentmlmodel[field].d;
			var g = _msdyn_ocskillidentmlmodel[field].g;
			var r = _msdyn_ocskillidentmlmodel[field].r;
			webApiField(msdyn_ocskillidentmlmodel, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocskillidentmlmodel.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_ocskillidentmlmodel.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
