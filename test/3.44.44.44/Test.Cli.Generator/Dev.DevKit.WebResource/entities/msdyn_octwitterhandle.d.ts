...
declare namespace DevKit {
	namespace Formmsdyn_octwitterhandle_Information {
		...
		interface Navigation {
			msdyn_msdyn_octwitterhandle_msdyn_octwitterhandlesecret_octwitterhandleid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_octwitterhandle_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_octwitterhandle_Information */
		Navigation: DevKit.Formmsdyn_octwitterhandle_Information.Navigation;
