...
declare namespace DevKit {
	namespace FormMarketing_list {
		...
		interface tab_SummarySubscriptionListTab_Sections {
			Information2SL: DevKit.Controls.Section;
			InformationSL: DevKit.Controls.Section;
		}
		...
		interface tab_SummarySubscriptionListTab extends DevKit.Controls.ITab {
			Section: tab_SummarySubscriptionListTab_Sections;
		}
		interface Tabs {
			members: tab_members;
			notes: tab_notes;
			Summary: tab_Summary;
			SummarySubscriptionListTab: tab_SummarySubscriptionListTab;
		}
		interface Body {
			Tab: Tabs;
			...
			/** Select the type of members that this marketing list will contain: accounts, contacts, or leads. Each list can have only one member type and this value can't be changed after the marketing list is created. */
			CreatedFromCode1: DevKit.Controls.OptionSet;
			...
			/** Type a name for the marketing list so that it is identified correctly in lists. */
			ListName1: DevKit.Controls.String;
			/** Select whether the marketing list is locked. If Yes is selected, no additional members can be added to the marketing list. */
			LockStatus: DevKit.Controls.Boolean;
			/** Select whether the marketing list is locked. If Yes is selected, no additional members can be added to the marketing list. */
			LockStatus1: DevKit.Controls.Boolean;
			...
			msdyncrm_issubscription: DevKit.Controls.Boolean;
			msdyncrm_issubscription1: DevKit.Controls.Boolean;
			...
			/** Type the intended use of the marketing list to identify its key segments, target offers, or business group. */
			Purpose1: DevKit.Controls.String;
			...
			/** Type the source of the marketing list, such as a third-party supplier or internal database. */
			Source1: DevKit.Controls.String;
			...
			/** Select whether you want the marketing list to be static or dynamic. The members in a static marketing list are unchanging. A dynamic marketing list is based on a dynamic query that retrieves the updated list of members */
			Type1: DevKit.Controls.Boolean;
		}
		interface Navigation {
			list_listoperation_ListId: DevKit.Controls.NavigationItem,
			msdyncrm_list_msdyncrm_listform: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormMarketing_list extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Marketing_list */
		Navigation: DevKit.FormMarketing_list.Navigation;
	...
	class FormMarketing_List_Light extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Marketing_List_Light */
		Navigation: DevKit.FormMarketing_List_Light.Navigation;
	...
	class ListApi {
		...
		*/
		...
		msdyncrm_issubscription: boolean;
		...
		readonly FormattedValue: {
			...
			/** Shows who last updated the record on behalf of another user. */
			readonly ModifiedOnBehalfBy: string;
			readonly msdyncrm_issubscription: string;
			/** Date and time that the record was migrated. */
