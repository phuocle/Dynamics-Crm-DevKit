...
(function (DevKit) {
	...
	DevKit.msdyn_ocliveworkitemApi = function (e) {
		...
		var _msdyn_ocliveworkitem = {
			...
			msdyn_activeagentgroupid: { b: 'msdyn_activeagentgroupid', a: '_msdyn_activeagentgroupid_value', c: 'msdyn_agentgroups', d: 'msdyn_agentgroup' },
			msdyn_activeagentid: { b: 'msdyn_activeagentid', a: '_msdyn_activeagentid_value', c: 'systemusers', d: 'systemuser' },
			msdyn_activeintentfamilyid: { b: 'msdyn_activeintentfamilyid', a: '_msdyn_activeintentfamilyid_value', c: 'msdyn_intentfamilies', d: 'msdyn_intentfamily' },
			msdyn_activeintentgroupid: { b: 'msdyn_activeintentgroupid', a: '_msdyn_activeintentgroupid_value', c: 'msdyn_intents', d: 'msdyn_intent' },
			msdyn_activeintentid: { b: 'msdyn_activeintentid', a: '_msdyn_activeintentid_value', c: 'msdyn_intents', d: 'msdyn_intent' },
			msdyn_activeintentstring: { a: 'msdyn_activeintentstring' },
			...
			msdyn_averageresponsetimeinmsadjforoh: { a: 'msdyn_averageresponsetimeinmsadjforoh' },
			msdyn_casefieldsupdatedbyAI: { a: 'msdyn_casefieldsupdatedbyAI' },
			msdyn_cdsqueueid: { b: 'msdyn_cdsqueueid', a: '_msdyn_cdsqueueid_value', c: 'queues', d: 'queue' },
			msdyn_channel: { a: 'msdyn_channel', g: true },
			msdyn_channelconnectionid: { a: 'msdyn_channelconnectionid' },
			msdyn_channelinstanceid: { b: 'msdyn_channelinstanceid', a: '_msdyn_channelinstanceid_value', c: 'msdyn_channelinstances', d: 'msdyn_channelinstance' },
			msdyn_channelproviderName: { a: 'msdyn_channelproviderName' },
			msdyn_closedon_UtcDateAndTime: { a: 'msdyn_closedon' },
			msdyn_conversationactivechattimeinseconds: { a: 'msdyn_conversationactivechattimeinseconds' },
			msdyn_conversationactivewrapuptimeinseconds: { a: 'msdyn_conversationactivewrapuptimeinseconds' },
			msdyn_conversationactivitystate: { a: 'msdyn_conversationactivitystate' },
			msdyn_conversationfirstwaittimeinseconds: { a: 'msdyn_conversationfirstwaittimeinseconds' },
			msdyn_conversationhandletimeinseconds: { a: 'msdyn_conversationhandletimeinseconds' },
			msdyn_conversationholdtimeinseconds: { a: 'msdyn_conversationholdtimeinseconds' },
			msdyn_ConversationSummaryField: { a: 'msdyn_conversationsummaryfield' },
			msdyn_conversationtalktimeinseconds: { a: 'msdyn_conversationtalktimeinseconds' },
			msdyn_conversationwrapuptimeinseconds: { a: 'msdyn_conversationwrapuptimeinseconds' },
			...
			msdyn_externalcontext: { b: 'msdyn_externalcontext', a: '_msdyn_externalcontext_value', c: 'msdyn_ocexternalcontexts', d: 'msdyn_ocexternalcontext' },
			msdyn_firstresponsetimeinmsadjforoh: { a: 'msdyn_firstresponsetimeinmsadjforoh' },
			msdyn_firstwaitstartedon_UtcDateAndTime: { a: 'msdyn_firstwaitstartedon' },
			msdyn_infracreatedby: { a: 'msdyn_infracreatedby' },
			msdyn_initiatedon_UtcDateAndTime: { a: 'msdyn_initiatedon' },
			msdyn_intent: { a: 'msdyn_intent' },
			msdyn_isabandoned: { a: 'msdyn_isabandoned' },
			msdyn_isagentaccepted: { a: 'msdyn_isagentaccepted' },
			msdyn_isagentsession: { a: 'msdyn_isagentsession' },
			...
			msdyn_ocliveworkitemid2: { a: 'msdyn_ocliveworkitemid' },
			msdyn_overflowtransfercount: { a: 'msdyn_overflowtransfercount' },
			...
			msdyn_routableobjectid_msdyn_ocvoicemail_msdyn_ocliveworkitem_msdyn_ocvoicemail: { b: 'msdyn_routableobjectid_msdyn_ocvoicemail_msdyn_ocliveworkitem_msdyn_ocvoicemail', a: '_msdyn_routableobjectid_value', c: 'msdyn_ocvoicemails', d: 'msdyn_ocvoicemail' },
			msdyn_msdyn_routableobjectid_msdyn_ocliveworkitem_task: { b: 'msdyn_msdyn_routableobjectid_msdyn_ocliveworkitem_task', a: '_msdyn_routableobjectid_value', c: 'tasks', d: 'task' },
			msdyn_routableobjectlogicalname: { a: 'msdyn_routableobjectlogicalname' },
			...
			msdyn_statereason: { a: 'msdyn_statereason' },
			msdyn_statuschangereason: { a: 'msdyn_statuschangereason' },
			...
			regardingobjectid_adx_invitation_msdyn_ocliveworkitem: { b: 'regardingobjectid_adx_invitation_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'adx_invitations', d: 'adx_invitation' },
			...
			regardingobjectid_msdyncrm_contentsettings_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_contentsettings_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_contentsettingses', d: 'msdyncrm_contentsettings' },
			regardingobjectid_msdyncrm_customerjourney_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_customerjourney_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_customerjourneies', d: 'msdyncrm_customerjourney' },
			regardingobjectid_msdyncrm_leadscoremodel_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_leadscoremodel_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_leadscoremodels', d: 'msdyncrm_leadscoremodel' },
			regardingobjectid_msdyncrm_linkedinaccount_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinaccount_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinaccounts', d: 'msdyncrm_linkedinaccount' },
			regardingobjectid_msdyncrm_linkedinactivity_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinactivity_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinactivities', d: 'msdyncrm_linkedinactivity' },
			regardingobjectid_msdyncrm_linkedinfieldmapping_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinfieldmapping_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinfieldmappings', d: 'msdyncrm_linkedinfieldmapping' },
			regardingobjectid_msdyncrm_linkedinform_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinform_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinforms', d: 'msdyncrm_linkedinform' },
			regardingobjectid_msdyncrm_linkedinformanswer_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinformanswer_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformanswers', d: 'msdyncrm_linkedinformanswer' },
			regardingobjectid_msdyncrm_linkedinformquestion_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinformquestion_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformquestions', d: 'msdyncrm_linkedinformquestion' },
			regardingobjectid_msdyncrm_linkedinformsubmission_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinformsubmission_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformsubmissions', d: 'msdyncrm_linkedinformsubmission' },
			regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinleadmatchingstrategies', d: 'msdyncrm_linkedinleadmatchingstrategy' },
			regardingobjectid_msdyncrm_linkedinuserprofile_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_linkedinuserprofile_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinuserprofiles', d: 'msdyncrm_linkedinuserprofile' },
			regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_marketingdynamiccontentmetadatas', d: 'msdyncrm_marketingdynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemaildynamiccontentmetadatas', d: 'msdyncrm_marketingemaildynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemailtestsend_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_marketingemailtestsend_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemailtestsends', d: 'msdyncrm_marketingemailtestsend' },
			regardingobjectid_msdyncrm_migration_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_migration_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_migrations', d: 'msdyncrm_migration' },
			regardingobjectid_msdyncrm_uicconfig_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyncrm_uicconfig_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyncrm_uicconfigs', d: 'msdyncrm_uicconfig' },
			...
			regardingobjectid_msdyn_salessuggestion_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyn_salessuggestion_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyn_salessuggestions', d: 'msdyn_salessuggestion' },
			...
			regardingobjectid_msdyn_swarm_msdyn_ocliveworkitem: { b: 'regardingobjectid_msdyn_swarm_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msdyn_swarms', d: 'msdyn_swarm' },
			...
			regardingobjectid_msevtmgt_checkin_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_checkin_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_checkins', d: 'msevtmgt_checkin' },
			regardingobjectid_msevtmgt_event_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_event_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_events', d: 'msevtmgt_event' },
			regardingobjectid_msevtmgt_eventpurchase_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_eventpurchase_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchases', d: 'msevtmgt_eventpurchase' },
			regardingobjectid_msevtmgt_eventpurchaseattendee_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_eventpurchaseattendee_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchaseattendees', d: 'msevtmgt_eventpurchaseattendee' },
			regardingobjectid_msevtmgt_eventpurchasepass_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_eventpurchasepass_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchasepasses', d: 'msevtmgt_eventpurchasepass' },
			regardingobjectid_msevtmgt_eventregistration_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_eventregistration_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_eventregistrations', d: 'msevtmgt_eventregistration' },
			regardingobjectid_msevtmgt_hotel_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_hotel_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_hotels', d: 'msevtmgt_hotel' },
			regardingobjectid_msevtmgt_hotelroomallocation_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_hotelroomallocation_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomallocations', d: 'msevtmgt_hotelroomallocation' },
			regardingobjectid_msevtmgt_hotelroomreservation_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_hotelroomreservation_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomreservations', d: 'msevtmgt_hotelroomreservation' },
			regardingobjectid_msevtmgt_layout_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_layout_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_layouts', d: 'msevtmgt_layout' },
			regardingobjectid_msevtmgt_room_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_room_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_rooms', d: 'msevtmgt_room' },
			regardingobjectid_msevtmgt_session_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_session_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_sessions', d: 'msevtmgt_session' },
			regardingobjectid_msevtmgt_sessionregistration_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_sessionregistration_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_sessionregistrations', d: 'msevtmgt_sessionregistration' },
			regardingobjectid_msevtmgt_sessiontrack_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_sessiontrack_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_sessiontracks', d: 'msevtmgt_sessiontrack' },
			regardingobjectid_msevtmgt_speaker_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_speaker_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_speakers', d: 'msevtmgt_speaker' },
			regardingobjectid_msevtmgt_speakerengagement_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_speakerengagement_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_speakerengagements', d: 'msevtmgt_speakerengagement' },
			regardingobjectid_msevtmgt_sponsorablearticle_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_sponsorablearticle_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorablearticles', d: 'msevtmgt_sponsorablearticle' },
			regardingobjectid_msevtmgt_sponsorship_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_sponsorship_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorships', d: 'msevtmgt_sponsorship' },
			regardingobjectid_msevtmgt_venue_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_venue_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_venues', d: 'msevtmgt_venue' },
			regardingobjectid_msevtmgt_webinarconfiguration_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_webinarconfiguration_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_webinarconfigurations', d: 'msevtmgt_webinarconfiguration' },
			regardingobjectid_msevtmgt_webinarprovider_msdyn_ocliveworkitem: { b: 'regardingobjectid_msevtmgt_webinarprovider_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'msevtmgt_webinarproviders', d: 'msevtmgt_webinarprovider' },
			regardingobjectid_mspp_adplacement_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_adplacement_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_adplacements', d: 'mspp_adplacement' },
			regardingobjectid_mspp_pollplacement_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_pollplacement_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_pollplacements', d: 'mspp_pollplacement' },
			regardingobjectid_mspp_publishingstatetransitionrule_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_publishingstatetransitionrule_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_publishingstatetransitionrules', d: 'mspp_publishingstatetransitionrule' },
			regardingobjectid_mspp_redirect_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_redirect_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_redirects', d: 'mspp_redirect' },
			regardingobjectid_mspp_shortcut_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_shortcut_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_shortcuts', d: 'mspp_shortcut' },
			regardingobjectid_mspp_website_msdyn_ocliveworkitem: { b: 'regardingobjectid_mspp_website_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'mspp_websites', d: 'mspp_website' },
		...
		msdyn_ocliveworkitem.ODataEntity = e;
		msdyn_ocliveworkitem.FormattedValue = {};
		for (var field in _msdyn_ocliveworkitem) {
			var a = _msdyn_ocliveworkitem[field].a;
			var b = _msdyn_ocliveworkitem[field].b;
			var c = _msdyn_ocliveworkitem[field].c;
			var d = _msdyn_ocliveworkitem[field].d;
			var g = _msdyn_ocliveworkitem[field].g;
			var r = _msdyn_ocliveworkitem[field].r;
			webApiField(msdyn_ocliveworkitem, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocliveworkitem.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_ocliveworkitem.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
