...
declare namespace DevKit {
	namespace FormAgreement_Booking_Service_Mobile {
		...
		interface Navigation {
			msdyn_agreementbookingservice_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_Appointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_Emails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingservice_Tasks: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingservice_msdyn_workorderservice_AgreementBookingService: DevKit.Controls.NavigationItem
		}
	}
