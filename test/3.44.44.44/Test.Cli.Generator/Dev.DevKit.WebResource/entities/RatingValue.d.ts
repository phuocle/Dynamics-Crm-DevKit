...
declare namespace DevKit {
	namespace FormRatingValue_Information {
		...
		interface Navigation {
			msdyn_ratingvalue_msdyn_incidenttypecharacteristic_RatingValue: DevKit.Controls.NavigationItem,
			msdyn_ratingvalue_msdyn_ocliveworkitemcharacteristic_ratingvalue: DevKit.Controls.NavigationItem,
			msdyn_ratingvalue_msdyn_requirementcharacteristic_ratingvalue: DevKit.Controls.NavigationItem,
			msdyn_ratingvalue_msdyn_workordercharacteristic_RatingValue: DevKit.Controls.NavigationItem,
			msdyn_ratingvalue_skillattachmenttarget: DevKit.Controls.NavigationItem,
			msdyn_rulesetdependencymapping_ratingvalue_msdyn_referencedpolymorphicentityid: DevKit.Controls.NavigationItem,
			ratingvalue_bookableresourcecharacteristic_RatingValue: DevKit.Controls.NavigationItem
		}
	}
	class FormRatingValue_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form RatingValue_Information */
		Navigation: DevKit.FormRatingValue_Information.Navigation;
	...
	class FormRatingValue_Omnichannel_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form RatingValue_Omnichannel_Information */
		Navigation: DevKit.FormRatingValue_Omnichannel_Information.Navigation;
