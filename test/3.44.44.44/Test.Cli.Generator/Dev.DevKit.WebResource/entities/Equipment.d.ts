...
declare namespace DevKit {
	namespace FormEquipment_Information {
		...
		interface Navigation {
			business_map_equipment: DevKit.Controls.NavigationItem,
			equipment_accounts: DevKit.Controls.NavigationItem,
			equipment_contacts: DevKit.Controls.NavigationItem,
			Equipment_Email_EmailSender: DevKit.Controls.NavigationItem,
			equipment_resources: DevKit.Controls.NavigationItem,
			msdyn_equipment_bookableresource_FacilityEquipmentId: DevKit.Controls.NavigationItem
		}
	}
	class FormEquipment_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Equipment_Information */
		Navigation: DevKit.FormEquipment_Information.Navigation;
