...
declare namespace DevKit {
	namespace Formmsdynmkt_contactpointconsent3_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynmkt_contactpointconsent3_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynmkt_contactpointconsent3_Information */
		Body: DevKit.Formmsdynmkt_contactpointconsent3_Information.Body;
		/** The Navigation of form msdynmkt_contactpointconsent3_Information */
		Navigation: DevKit.Formmsdynmkt_contactpointconsent3_Information.Navigation;
		/** The SidePanes of form msdynmkt_contactpointconsent3_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynmkt_contactpointconsent3Api {
		/**
		* DynamicsCrm.DevKit msdynmkt_contactpointconsent3Api
		...
		*/
		...
		msdynmkt_consenttypevalue: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_consenttypevalue;
		/** Unique identifier for entity instances */
		msdynmkt_contactpointconsent3Id: string;
		msdynmkt_contactpointtype: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_contactpointtype;
		msdynmkt_contactpointvalue: string;
		msdynmkt_logicalreason: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_logicalreason;
		msdynmkt_migrationtimestamp_TimezoneDateAndTime: Date;
		msdynmkt_modifiedonbehalf: string;
		msdynmkt_reason: string;
		msdynmkt_source: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_source;
		msdynmkt_uionly_value_marketingmessage: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_uionly_value_marketingmessage;
		msdynmkt_uionly_value_tracking: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_uionly_value_tracking;
		msdynmkt_value: OptionSet.msdynmkt_contactpointconsent3.msdynmkt_value;
		...
		statecode: OptionSet.msdynmkt_contactpointconsent3.statecode;
		/** Reason for the status of the Contact Point Consent */
		statuscode: OptionSet.msdynmkt_contactpointconsent3.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdynmkt_contactpointconsent3Id: string;
...
declare namespace OptionSet {
	namespace msdynmkt_contactpointconsent3 {
