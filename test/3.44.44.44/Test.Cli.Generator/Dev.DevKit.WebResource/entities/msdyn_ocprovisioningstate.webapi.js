...
(function (DevKit) {
	...
	DevKit.msdyn_ocprovisioningstateApi = function (e) {
		...
		var _msdyn_ocprovisioningstate = {
			...
			msdyn_AutomatedCallingStatus: { a: 'msdyn_automatedcallingstatus' },
			...
			msdyn_gatekeeperstatus: { a: 'msdyn_gatekeeperstatus' },
			msdyn_gatekeeperstatusreason: { a: 'msdyn_gatekeeperstatusreason' },
			...
			msdyn_voicechannelsettingid: { b: 'msdyn_voicechannelsettingid', a: '_msdyn_voicechannelsettingid_value', c: 'msdyn_ocvoicechannelsettings', d: 'msdyn_ocvoicechannelsetting' },
