...
declare namespace DevKit {
	...
	class Formmsdyn_unifiedroutingsetuptracker_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_unifiedroutingsetuptracker_Information */
		Navigation: DevKit.Formmsdyn_unifiedroutingsetuptracker_Information.Navigation;
	...
	class msdyn_unifiedroutingsetuptrackerApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the delegate user who modified the record. */
			readonly ModifiedOnBehalfBy: string;
			readonly msdyn_enableunifiedrouting: string;
			readonly msdyn_errorcode: string;
			readonly msdyn_errormessage: string;
			/** Execution Status */
			readonly msdyn_executionstatus: string;
			readonly msdyn_issuccessnotificationdisplayed: string;
			readonly msdyn_isTeachingBubbleDisplayed: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			readonly msdyn_servicerequestid: string;
			/** Skip Provisioning */
			readonly msdyn_skipProvisioning: string;
			readonly msdyn_token: string;
			readonly msdyn_transactionid: string;
			/** Unique identifier for entity instances */
			readonly msdyn_unifiedroutingsetuptrackerId: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
