...
declare namespace DevKit {
	...
	class Formmsdyn_ocliveworkitemsentiment_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocliveworkitemsentiment_Information */
		Navigation: DevKit.Formmsdyn_ocliveworkitemsentiment_Information.Navigation;
	...
	class msdyn_ocliveworkitemsentimentApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_ocliveworkitemsentiment.statecode;
		/** Reason for the status of the Conversation Sentiment */
		statuscode: OptionSet.msdyn_ocliveworkitemsentiment.statuscode;
