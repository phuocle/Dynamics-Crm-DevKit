...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_accountkpiitemApi = function (e) {
		...
		var _msdyn_accountkpiitem = {
			...
			msdyn_accountid: { b: 'msdyn_accountid', a: '_msdyn_accountid_value', c: 'accounts', d: 'account' },
			msdyn_accountkpiitemId: { a: 'msdyn_accountkpiitemid' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_accountkpiitem = {};
		msdyn_accountkpiitem.ODataEntity = e;
		msdyn_accountkpiitem.FormattedValue = {};
		for (var field in _msdyn_accountkpiitem) {
			var a = _msdyn_accountkpiitem[field].a;
			var b = _msdyn_accountkpiitem[field].b;
			var c = _msdyn_accountkpiitem[field].c;
			var d = _msdyn_accountkpiitem[field].d;
			var g = _msdyn_accountkpiitem[field].g;
			var r = _msdyn_accountkpiitem[field].r;
			webApiField(msdyn_accountkpiitem, field, e, a, b, c, d, r, u, g);
		}
		msdyn_accountkpiitem.Entity = u;
		msdyn_accountkpiitem.EntityName = 'msdyn_accountkpiitem';
		msdyn_accountkpiitem.EntityCollectionName = 'msdyn_accountkpiitems';
		msdyn_accountkpiitem['@odata.etag'] = e['@odata.etag'];
		msdyn_accountkpiitem.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_accountkpiitem.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_accountkpiitem;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyn_accountkpiitem = {
