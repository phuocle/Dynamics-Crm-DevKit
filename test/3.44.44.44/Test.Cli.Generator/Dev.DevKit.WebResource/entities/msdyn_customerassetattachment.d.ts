...
declare namespace DevKit {
	...
	class Formmsdyn_customerassetattachment_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_customerassetattachment_Information */
		Navigation: DevKit.Formmsdyn_customerassetattachment_Information.Navigation;
	...
	class msdyn_customerassetattachmentApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Type of file attachment. */
			readonly msdyn_AttachmentType: string;
			readonly msdyn_Category: string;
			/** Customer Asset to which the attachment belongs. */
			readonly msdyn_CustomerAsset: string;
			/** Unique identifier for entity instances */
			readonly msdyn_customerassetattachmentId: string;
			/** Field to attach Video for Customer Asset */
			readonly msdyn_File_name: string;
			/** Image attachment for Customer Asset */
