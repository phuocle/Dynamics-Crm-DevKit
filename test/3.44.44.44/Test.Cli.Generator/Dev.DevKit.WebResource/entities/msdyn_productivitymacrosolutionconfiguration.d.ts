...
declare namespace DevKit {
	...
	class Formmsdyn_productivitymacrosolutionconfiguration_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_productivitymacrosolutionconfiguration_Information */
		Navigation: DevKit.Formmsdyn_productivitymacrosolutionconfiguration_Information.Navigation;
	...
	class msdyn_productivitymacrosolutionconfigurationApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Sets designer fallback url */
			readonly msdyn_designerfallbackurl: string;
			/** Sets the entity from which to read designer URL */
			readonly msdyn_designerurlconfigentity: string;
			/** Sets the attributes of designer url config entity */
			readonly msdyn_designerurlconfigentityattrib: string;
			/** Sets the id from which to read designer URL */
			readonly msdyn_designerurlconfigentityid: string;
			/** An OData query to retrieve record from which to read designer URL */
			readonly msdyn_designerurlconfigentityquery: string;
			/** Sets the path to designer blob with designer URL */
			readonly msdyn_designerurlrelativepath: string;
			/** Macro solution version */
			readonly msdyn_macrosversion: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Unique identifier for entity instances */
			readonly msdyn_productivitymacrosolutionconfigurationId: string;
			/** Sets the value for serach hint */
			readonly msdyn_searchhint: string;
			/** Unique Name for the entity. */
			readonly msdyn_UniqueName: string;
			/** Sets the value for user voice link */
			readonly msdyn_uservoicelink: string;
			/** Sets the value for user voice text */
			readonly msdyn_uservoicetext: string;
			/** Date and time that the record was migrated. */
