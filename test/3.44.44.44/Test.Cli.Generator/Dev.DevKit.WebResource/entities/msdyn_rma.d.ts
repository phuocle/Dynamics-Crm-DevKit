...
declare namespace DevKit {
	namespace FormRMA {
		...
		interface Navigation {
			msdyn_msdyn_rma_msdyn_rmaproduct_RMA: DevKit.Controls.NavigationItem,
			msdyn_msdyn_rma_msdyn_rmareceipt_RMA: DevKit.Controls.NavigationItem,
			msdyn_msdyn_rma_msdyn_rmareceiptproduct_RMA: DevKit.Controls.NavigationItem,
			msdyn_msdyn_rma_msdyn_rtv_OriginatingRMA: DevKit.Controls.NavigationItem,
			msdyn_msdyn_rma_msdyn_rtvproduct_RMA: DevKit.Controls.NavigationItem,
			msdyn_rma_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_rma_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_rma_Appointments: DevKit.Controls.NavigationItem,
			msdyn_rma_Emails: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_rma_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_rma_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_rma_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_rma_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_rma_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_rma_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_rma_Tasks: DevKit.Controls.NavigationItem
		}
		interface Grid {
