...
declare namespace DevKit {
	namespace Formmsdyn_ciprovider_Information {
		...
		interface Body {
			...
			msdyn_channelprovidericon: DevKit.Controls.ELSE3???;//msdyn_channelprovidericon - C2A23B4D-103C-4F11-AC89-2EF879C9912D -- FOR DEBUG 
			/** API Version */
			...
			/** Custom sandbox properties for the widget */
			msdyn_sandboxconfiguration: DevKit.Controls.String;
			/** Select Channel Order as 0 for this Channel to take precedence over others. */
			msdyn_SortOrder: DevKit.Controls.Integer;
			/** Domain to be added to inclusion list */
			msdyn_trusteddomain: DevKit.Controls.String;
		}
		interface Navigation {
			msdyn_msdyn_ciprovider_msdyn_channel: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ciprovider_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ciprovider_Information */
		Navigation: DevKit.Formmsdyn_ciprovider_Information.Navigation;
	...
	class msdyn_ciproviderApi {
		...
		*/
		...
		/** Customize channel provider icon */
		msdyn_channelprovidericon: string;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Select Unified Interface Apps for the Channel */
			readonly msdyn_AppSelector: string;
			/** Customize channel provider icon */
			readonly msdyn_channelprovidericon: string;
			/** Version of the CIF Solution */
			readonly msdyn_cifsolversion: string;
			/** API Version */
			readonly msdyn_ciproviderapiversion: string;
			/** Unique identifier for CIProvider records */
			readonly msdyn_ciproviderId: string;
			/** Enable Outbound Communication */
			readonly msdyn_ClickToAct: string;
			/** Custom Parameters for the Widget to load */
			...
			/** URL for the Channel provider */
			readonly msdyn_LandingUrl: string;
			/** Name of the Channel provider */
			readonly msdyn_name: string;
			/** Select the Roles for the Channel */
			readonly msdyn_RoleSelector: string;
			/** Custom sandbox properties for the widget */
			readonly msdyn_sandboxconfiguration: string;
			/** Select Channel Order as 0 for this Channel to take precedence over others. */
