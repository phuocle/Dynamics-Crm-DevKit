...
(function (DevKit) {
	...
	DevKit.msdyn_segmentApi = function (e) {
		...
		var _msdyn_segment = {
			...
			msdyn_evaluateindataverse: { a: 'msdyn_evaluateindataverse' },
			msdyn_isresegmentationenabled: { a: 'msdyn_isresegmentationenabled' },
			msdyn_isroutingenabledforresegmentation: { a: 'msdyn_isroutingenabledforresegmentation' },
