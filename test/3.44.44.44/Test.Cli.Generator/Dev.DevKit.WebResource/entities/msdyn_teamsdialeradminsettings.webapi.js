...
(function (DevKit) {
	...
	DevKit.msdyn_teamsdialeradminsettingsApi = function (e) {
		...
		var _msdyn_teamsdialeradminsettings = {
			...
			msdyn_addparticipantenabled: { a: 'msdyn_addparticipantenabled' },
			msdyn_answerexternalincomingcalls: { a: 'msdyn_answerexternalincomingcalls' },
			msdyn_AppModules: { a: 'msdyn_appmodules' },
			msdyn_CICallPaneEntryPoints: { a: 'msdyn_cicallpaneentrypoints' },
			msdyn_ignoreinternalincomingcalls: { a: 'msdyn_ignoreinternalincomingcalls' },
			...
			msdyn_transfercallsenabled: { a: 'msdyn_transfercallsenabled' },
			msdyn_valuesjson: { a: 'msdyn_valuesjson' },
