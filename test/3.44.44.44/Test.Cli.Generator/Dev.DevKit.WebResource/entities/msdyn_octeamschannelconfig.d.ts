...
declare namespace DevKit {
	namespace Formmsdyn_octeamschannelconfig_Information {
		...
		interface Navigation {
			msdyn_octeamschannelconfig_msdyn_ocbotchannelregistration_msdyn_octeamschannelconfigid: DevKit.Controls.NavigationItem,
			msdyn_octeamschannelconfig_msdyn_ocprovisioningstate_octeamschannelconfigid: DevKit.Controls.NavigationItem,
			msdyn_octeamschannelconfig_msdyn_surveyconfig_msdyn_targetchannelid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_octeamschannelconfig_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_octeamschannelconfig_Information */
		Navigation: DevKit.Formmsdyn_octeamschannelconfig_Information.Navigation;
	...
	class msdyn_octeamschannelconfigApi {
		...
		*/
		...
		/** Bot ID is of Teams Channel */
		msdyn_botid: string;
		/** List of calling options available for the Teams channel */
		msdyn_callingoptions: OptionSet.msdyn_octeamschannelconfig.msdyn_callingoptions;
		/** Option set to enable or disable attachments for agents */
		...
		/** Mode of the survey to be sent */
		msdyn_PostConversationSurveyBotSurveyMode: OptionSet.msdyn_octeamschannelconfig.msdyn_PostConversationSurveyBotSurveyMode;
		/** To enable or disable post conversation survey */
		...
		readonly FormattedValue: {
			...
			/** Teams App Name or Teams Channel */
			readonly msdyn_teamsappname: string;
			/** Date and time that the record was migrated. */
