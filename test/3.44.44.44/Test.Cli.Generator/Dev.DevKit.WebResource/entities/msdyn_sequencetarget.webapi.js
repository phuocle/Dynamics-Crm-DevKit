...
(function (DevKit) {
	...
	DevKit.msdyn_sequencetargetApi = function (e) {
		...
		var _msdyn_sequencetarget = {
			...
			msdyn_currentstepdefinitionid: { a: 'msdyn_currentstepdefinitionid' },
			...
			msdyn_disconnectedafterstepdefinitionid: { a: 'msdyn_disconnectedafterstepdefinitionid' },
		...
		msdyn_sequencetarget.ODataEntity = e;
		msdyn_sequencetarget.FormattedValue = {};
		for (var field in _msdyn_sequencetarget) {
			var a = _msdyn_sequencetarget[field].a;
			var b = _msdyn_sequencetarget[field].b;
			var c = _msdyn_sequencetarget[field].c;
			var d = _msdyn_sequencetarget[field].d;
			var g = _msdyn_sequencetarget[field].g;
			var r = _msdyn_sequencetarget[field].r;
			webApiField(msdyn_sequencetarget, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sequencetarget.getAliasedValue = function (alias, isMultiOptionSet = false) {
