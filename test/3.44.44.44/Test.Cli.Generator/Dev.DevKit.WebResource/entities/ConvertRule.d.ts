...
declare namespace DevKit {
	namespace FormRecord_Creation_and_Update_Rule_UCI {
		...
		interface Navigation {
			convertrule_activitymonitor: DevKit.Controls.NavigationItem,
			convertrule_convertruleitem: DevKit.Controls.NavigationItem,
			msdyn_migrationtracker_LegacyConvertRule_convertrule: DevKit.Controls.NavigationItem,
			msdyn_migrationtracker_ModernConvertRule_convertrule: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormRecord_Creation_and_Update_Rule_UCI extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Record_Creation_and_Update_Rule_UCI */
		Navigation: DevKit.FormRecord_Creation_and_Update_Rule_UCI.Navigation;
	...
	class FormRecord_Creation_and_Update_Rule_Web_Client extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Record_Creation_and_Update_Rule_Web_Client */
		Navigation: DevKit.FormRecord_Creation_and_Update_Rule_Web_Client.Navigation;
