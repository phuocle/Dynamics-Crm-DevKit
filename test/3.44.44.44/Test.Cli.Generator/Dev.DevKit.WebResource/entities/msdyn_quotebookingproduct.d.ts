...
declare namespace DevKit {
	namespace Formmsdyn_quotebookingproduct_Information {
		...
		interface Navigation {
			msdyn_quotebookingproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingproduct_Tasks: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_quotebookingproduct_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_quotebookingproduct_Information */
		Navigation: DevKit.Formmsdyn_quotebookingproduct_Information.Navigation;
	...
	class Formmsdyn_quotebookingproduct_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_quotebookingproduct_Information2 */
		Navigation: DevKit.Formmsdyn_quotebookingproduct_Information2.Navigation;
