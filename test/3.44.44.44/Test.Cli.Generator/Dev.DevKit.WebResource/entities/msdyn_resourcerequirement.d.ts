...
declare namespace DevKit {
	namespace Formmsdyn_resourcerequirement_Information {
		...
		interface Navigation {
			msdyn_msdyn_resourcerequirement_msdyn_requirementcharacteristic_RequirementSystemUse: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcerequirement_msdyn_workorderincident_ResourceRequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_bookableresourcebooking_ResourceRequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_bookableresourcebookingheader_ResourceRequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_details: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementcharacteristic_resourcerequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementdependency_dependentrequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementdependency_resourcerequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementorganizationunit_ResourceRequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementresourcecategory_resourcerequirement: DevKit.Controls.NavigationItem,
			msdyn_resourcerequirement_requirementresourcepreference_ResourceRequirement: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_resourcerequirement_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_resourcerequirement_Information */
		Navigation: DevKit.Formmsdyn_resourcerequirement_Information.Navigation;
