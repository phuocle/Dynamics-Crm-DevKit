...
declare namespace DevKit {
	namespace Formmsfp_alertrule_Information {
		...
		interface Navigation {
			msfp_msfp_alertrule_msfp_alert_alertrule: DevKit.Controls.NavigationItem
		}
	}
	class Formmsfp_alertrule_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msfp_alertrule_Information */
		Navigation: DevKit.Formmsfp_alertrule_Information.Navigation;
		/** The SidePanes of form msfp_alertrule_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msfp_alertruleApi {
		/**
		* DynamicsCrm.DevKit msfp_alertruleApi
		...
		*/
		...
		/** Status of the Customer Voice alert rule */
		statecode: OptionSet.msfp_alertrule.statecode;
		/** Reason for the status of the Customer Voice alert rule */
		statuscode: OptionSet.msfp_alertrule.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msfp_alertruleId: string;
			/** Condition to run the alert rule. */
			readonly msfp_expression: string;
			/** Name of the alert rule. */
