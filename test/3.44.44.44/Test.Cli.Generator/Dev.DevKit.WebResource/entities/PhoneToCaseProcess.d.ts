...
declare namespace DevKit {
	namespace FormPhoneToCaseProcess {
		...
		interface Navigation {
			lk_phonetocaseprocess_workflowlogs: DevKit.Controls.NavigationItem
		}
	}
	class FormPhoneToCaseProcess extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form PhoneToCaseProcess */
		Navigation: DevKit.FormPhoneToCaseProcess.Navigation;
