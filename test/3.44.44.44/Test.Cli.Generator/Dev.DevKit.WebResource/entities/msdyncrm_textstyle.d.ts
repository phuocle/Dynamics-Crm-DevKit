...
declare namespace DevKit {
	namespace Formmsdyncrm_textstyle_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyncrm_textstyle_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdyncrm_textstyle_Information */
		Body: DevKit.Formmsdyncrm_textstyle_Information.Body;
		/** The Navigation of form msdyncrm_textstyle_Information */
		Navigation: DevKit.Formmsdyncrm_textstyle_Information.Navigation;
		/** The SidePanes of form msdyncrm_textstyle_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyncrm_textstyleApi {
		/**
		* DynamicsCrm.DevKit msdyncrm_textstyleApi
		...
		*/
		...
		/** Status of the Text style */
		statecode: OptionSet.msdyncrm_textstyle.statecode;
		/** Reason for the status of the Text style */
		statuscode: OptionSet.msdyncrm_textstyle.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyncrm_textstyleId: string;
			/** Date and time that the record was migrated. */
