...
(function (DevKit) {
	...
	DevKit.msdyn_omnichannelconfigurationApi = function (e) {
		...
		var _msdyn_omnichannelconfiguration = {
			...
			msdyn_delegated_prioritization_migration: { a: 'msdyn_delegated_prioritization_migration' },
			...
			msdyn_enable_preferred_agent_routing: { a: 'msdyn_enable_preferred_agent_routing' },
			msdyn_enable_supervisor_assign: { a: 'msdyn_enable_supervisor_assign' },
			msdyn_enable_supervisor_forceclose: { a: 'msdyn_enable_supervisor_forceclose' },
			...
			msdyn_number_of_declines_allowed: { a: 'msdyn_number_of_declines_allowed' },
			msdyn_omnichannelconfigurationId: { a: 'msdyn_omnichannelconfigurationid' },
			msdyn_preferredagentbackupmode: { a: 'msdyn_preferredagentbackupmode' },
...
(function (OptionSet) {
	OptionSet.msdyn_omnichannelconfiguration = {
		...
		msdyn_preferredagentbackupmode : {
