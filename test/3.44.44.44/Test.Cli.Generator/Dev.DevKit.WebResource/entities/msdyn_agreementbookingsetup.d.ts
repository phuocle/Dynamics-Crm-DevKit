...
declare namespace DevKit {
	namespace FormAgreement_Booking_Setup {
		...
		interface Navigation {
			bpf_msdyn_agreementbookingsetup_msdyn_bpf_baa0a411a239410cb8bded8b5fdd88e3: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_Appointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_Emails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_QueueItems: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_agreementbookingsetup_Tasks: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingdate_BookingSetup: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingincident_AgreementBookingSetup: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingproduct_AgreementBookingSetup: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingservice_AgreementBookingSetup: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementbookingsetup_msdyn_agreementbookingservicetask_AgreementBookingSetup: DevKit.Controls.NavigationItem
		}
