...
(function (DevKit) {
	...
	DevKit.LeadApi = function (e) {
		...
		var _lead = {
			...
			msdyn_leadkpiid: { b: 'msdyn_leadkpiid', a: '_msdyn_leadkpiid_value', c: 'msdyn_leadkpiitems', d: 'msdyn_leadkpiitem' },
			...
			msdyncrm_code: { a: 'msdyncrm_code' },
			msdyncrm_companysize: { a: 'msdyncrm_companysize' },
			msdyncrm_Contactid: { a: 'msdyncrm_contactid' },
			...
			msdyncrm_degree: { a: 'msdyncrm_degree' },
			msdyncrm_emailid: { b: 'msdyncrm_emailid', a: '_msdyncrm_emailid_value', c: 'msdyncrm_marketingemails', d: 'msdyncrm_marketingemail' },
			msdyncrm_fieldofstudy: { a: 'msdyncrm_fieldofstudy' },
			msdyncrm_graduationdate: { a: 'msdyncrm_graduationdate' },
			msdyncrm_industry: { a: 'msdyncrm_industry' },
			msdyncrm_insights_placeholder: { a: 'msdyncrm_insights_placeholder' },
			msdyncrm_jobfunction: { a: 'msdyncrm_jobfunction' },
			msdyncrm_latestsubmissiondate_UtcDateAndTime: { a: 'msdyncrm_latestsubmissiondate' },
			msdyncrm_Leadid: { a: 'msdyncrm_leadid' },
			msdyncrm_leadsourcetype: { a: 'msdyncrm_leadsourcetype' },
			...
			msdyncrm_linkedinsubmissioncount: { a: 'msdyncrm_linkedinsubmissioncount', r: true },
			msdyncrm_linkedinsubmissioncount_Date_UtcDateAndTime: { a: 'msdyncrm_linkedinsubmissioncount_date', r: true },
			msdyncrm_linkedinsubmissioncount_State: { a: 'msdyncrm_linkedinsubmissioncount_state', r: true },
			...
			msdyncrm_Profileid: { a: 'msdyncrm_profileid' },
			msdyncrm_PurchaseNeed: { a: 'msdyncrm_purchaseneed' },
			msdyncrm_Recycled: { a: 'msdyncrm_recycled' },
			msdyncrm_SalesAccepted: { a: 'msdyncrm_salesaccepted' },
			msdyncrm_SalesReady: { a: 'msdyncrm_salesready' },
			msdyncrm_sasToken: { a: 'msdyncrm_sastoken' },
			msdyncrm_school: { a: 'msdyncrm_school' },
			msdyncrm_scores: { a: 'msdyncrm_scores' },
			msdyncrm_scoringgrade: { a: 'msdyncrm_scoringgrade' },
			msdyncrm_seniority: { a: 'msdyncrm_seniority' },
			msdyncrm_sourceform: { b: 'msdyncrm_sourceform', a: '_msdyncrm_sourceform_value', c: 'msdyncrm_linkedinforms', d: 'msdyncrm_linkedinform' },
			msdyncrm_startdate: { a: 'msdyncrm_startdate' },
			msdyncrm_TeleProspectAccepted: { a: 'msdyncrm_teleprospectaccepted' },
			msdyncrm_TeleProspectReady: { a: 'msdyncrm_teleprospectready' },
			msdyncrm_TriggerRecycle: { a: 'msdyncrm_triggerrecycle' },
			...
			msdynmkt_issalesreadysetmanually: { a: 'msdynmkt_issalesreadysetmanually' },
