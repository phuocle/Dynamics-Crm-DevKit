...
declare namespace DevKit {
	namespace Formmsdynci_PersonalizationView_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynci_PersonalizationView_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynci_PersonalizationView_Information */
		Body: DevKit.Formmsdynci_PersonalizationView_Information.Body;
		/** The Navigation of form msdynci_PersonalizationView_Information */
		Navigation: DevKit.Formmsdynci_PersonalizationView_Information.Navigation;
		/** The SidePanes of form msdynci_PersonalizationView_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynci_PersonalizationViewApi {
		/**
		* DynamicsCrm.DevKit msdynci_PersonalizationViewApi
		...
		*/
		...
		msdynci_PersonalizationViewId: string;
		msdynci_ReferrerPageTitle: string;
		...
		msdynci_UserTimeSinceVisit: number;
		msdynci_UserTimeSinceVisitMs: number;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdynci_PersonalizationViewId: string;
			readonly msdynci_ReferrerPageTitle: string;
			...
			readonly msdynci_UserTimeSinceVisit: string;
			readonly msdynci_UserTimeSinceVisitMs: string;
...
declare namespace OptionSet {
	namespace msdynci_PersonalizationView {
		enum RollupState {
