...
declare namespace DevKit {
	namespace FormEntitlement_Template {
		...
		interface Navigation {
			entitlementtemplate_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			entitlementtemplate_adx_portalcomments: DevKit.Controls.NavigationItem,
			entitlementtemplate_Appointments: DevKit.Controls.NavigationItem,
			entitlementtemplate_Emails: DevKit.Controls.NavigationItem,
			entitlementtemplate_entitlementchannel_entitlementtemplateid: DevKit.Controls.NavigationItem,
			entitlementtemplate_IncidentResolutions: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			entitlementtemplate_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			entitlementtemplate_msfp_alerts: DevKit.Controls.NavigationItem,
			entitlementtemplate_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			entitlementtemplate_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			entitlementtemplate_OpportunityCloses: DevKit.Controls.NavigationItem,
			entitlementtemplate_OrderCloses: DevKit.Controls.NavigationItem,
			entitlementtemplate_PhoneCalls: DevKit.Controls.NavigationItem,
			entitlementtemplate_QuoteCloses: DevKit.Controls.NavigationItem,
			entitlementtemplate_ServiceAppointments: DevKit.Controls.NavigationItem,
			entitlementtemplate_Tasks: DevKit.Controls.NavigationItem,
			entitlementtemplateid_RelationShip: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class FormEntitlement_Template extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Entitlement_Template */
		Navigation: DevKit.FormEntitlement_Template.Navigation;
