...
declare namespace DevKit {
	...
	class Formmsdyn_kbkeywordsdescsuggestionsetting_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_kbkeywordsdescsuggestionsetting_Information */
		Navigation: DevKit.Formmsdyn_kbkeywordsdescsuggestionsetting_Information.Navigation;
	...
	class msdyn_kbkeywordsdescsuggestionsettingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_kbkeywordsdescsuggestionsetting.ComponentState;
		...
		/** Is keywords and description suggestions default setting is overridden at org level. Default is No */
		...
		statecode: OptionSet.msdyn_kbkeywordsdescsuggestionsetting.statecode;
		/** Reason for the status of the kbkeywordsdescsuggestionsetting */
		statuscode: OptionSet.msdyn_kbkeywordsdescsuggestionsetting.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Is keywords and description suggestions default setting is overridden at org level. Default is No */
			readonly msdyn_IsOverridden: string;
			/** Knowledge attribute which describes Content mapping */
			readonly msdyn_KbContentMapping: string;
			/** Unique identifier for entity instances */
			readonly msdyn_kbkeywordsdescsuggestionsettingId: string;
			/** Knowledge attribute which describes Title mapping */
