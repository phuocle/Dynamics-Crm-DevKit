...
declare namespace DevKit {
	class msdyn_historicalcaseharvestbatchApi {
		/**
		* DynamicsCrm.DevKit msdyn_historicalcaseharvestbatchApi
		...
		*/
		...
		msdyn_batchprocessingcompletedon_UtcDateAndTime: Date;
		...
		statecode: OptionSet.msdyn_historicalcaseharvestbatch.statecode;
		/** Reason for the status of the msdyn_historicalcaseharvestbatch */
		statuscode: OptionSet.msdyn_historicalcaseharvestbatch.statuscode;
...
declare namespace OptionSet {
	namespace msdyn_historicalcaseharvestbatch {
		enum statecode {
			/** 1 */
			Completed,
			/** 0 */
