...
declare namespace DevKit {
	namespace FormRelationshipRole_Information {
		...
		interface Navigation {
			relationship_role_customer_opportunity_roles: DevKit.Controls.NavigationItem
		}
	}
	class FormRelationshipRole_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form RelationshipRole_Information */
		Navigation: DevKit.FormRelationshipRole_Information.Navigation;
