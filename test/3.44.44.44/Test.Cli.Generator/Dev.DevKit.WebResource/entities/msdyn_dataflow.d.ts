...
declare namespace DevKit {
	class msdyn_dataflowApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dataflow.ComponentState;
		...
		statecode: OptionSet.msdyn_dataflow.statecode;
		/** Reason for the status of the Dataflow */
		statuscode: OptionSet.msdyn_dataflow.statuscode;
		/** For internal use only. */
