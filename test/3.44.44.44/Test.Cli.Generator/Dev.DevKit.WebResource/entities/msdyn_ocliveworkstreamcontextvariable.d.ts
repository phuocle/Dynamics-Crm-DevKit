...
declare namespace DevKit {
	namespace Formmsdyn_ocliveworkstreamcontextvariable_Information {
		...
		interface Navigation {
			msdyn_msdyn_lwscv_msdyn_ocliveworkitemcontextitem_ocliveworkstreamcontextvariableid: DevKit.Controls.NavigationItem,
			msdyn_rulesetdependencymapping_ocliveworkstreamcontextvariable_referencedpolymorphicentityid: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ocliveworkstreamcontextvariable_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocliveworkstreamcontextvariable_Information */
		Navigation: DevKit.Formmsdyn_ocliveworkstreamcontextvariable_Information.Navigation;
	...
	class msdyn_ocliveworkstreamcontextvariableApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocliveworkstreamcontextvariable.ComponentState;
