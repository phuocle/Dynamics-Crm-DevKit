...
declare namespace DevKit {
	namespace Formmsdyn_purchaseorderproduct_Information {
		...
		interface Navigation {
			msdyn_msdyn_purchaseorderproduct_msdyn_inventoryjournal_POProduct: DevKit.Controls.NavigationItem,
			msdyn_msdyn_purchaseorderproduct_msdyn_purchaseorderreceiptproduct_POProduct: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_purchaseorderproduct_Tasks: DevKit.Controls.NavigationItem
		}
	}
