...
declare namespace DevKit {
	class msdyn_historicalcaseharvestrunApi {
		/**
		...
		*/
		...
		msdyn_caseidentificationcompletedon_UtcDateAndTime: Date;
		...
		statecode: OptionSet.msdyn_historicalcaseharvestrun.statecode;
		/** Reason for the status of the historical case harvest run */
		statuscode: OptionSet.msdyn_historicalcaseharvestrun.statuscode;
...
declare namespace OptionSet {
	namespace msdyn_historicalcaseharvestrun {
		...
		enum statuscode {
			/** 3 */
			CaseIdentificationCompleted,
			/** 5 */
			CaseIdentificationFailed,
			/** 2 */
			CaseIndentificationInProgress,
			/** 4 */
			Completed,
			/** 1 */
			Ready
