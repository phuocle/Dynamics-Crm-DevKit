...
(function (DevKit) {
	...
	DevKit.PhoneCallApi = function (e) {
		...
		var _phonecall = {
			...
			regardingobjectid_msdyncrm_contentsettings_phonecall: { b: 'regardingobjectid_msdyncrm_contentsettings_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_contentsettingses', d: 'msdyncrm_contentsettings' },
			regardingobjectid_msdyncrm_customerjourney_phonecall: { b: 'regardingobjectid_msdyncrm_customerjourney_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_customerjourneies', d: 'msdyncrm_customerjourney' },
			regardingobjectid_msdyncrm_leadscoremodel_phonecall: { b: 'regardingobjectid_msdyncrm_leadscoremodel_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_leadscoremodels', d: 'msdyncrm_leadscoremodel' },
			regardingobjectid_msdyncrm_linkedinaccount_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinaccount_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinaccounts', d: 'msdyncrm_linkedinaccount' },
			regardingobjectid_msdyncrm_linkedinactivity_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinactivity_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinactivities', d: 'msdyncrm_linkedinactivity' },
			regardingobjectid_msdyncrm_linkedinfieldmapping_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinfieldmapping_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinfieldmappings', d: 'msdyncrm_linkedinfieldmapping' },
			regardingobjectid_msdyncrm_linkedinform_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinform_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinforms', d: 'msdyncrm_linkedinform' },
			regardingobjectid_msdyncrm_linkedinformanswer_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinformanswer_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformanswers', d: 'msdyncrm_linkedinformanswer' },
			regardingobjectid_msdyncrm_linkedinformquestion_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinformquestion_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformquestions', d: 'msdyncrm_linkedinformquestion' },
			regardingobjectid_msdyncrm_linkedinformsubmission_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinformsubmission_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinformsubmissions', d: 'msdyncrm_linkedinformsubmission' },
			regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinleadmatchingstrategies', d: 'msdyncrm_linkedinleadmatchingstrategy' },
			regardingobjectid_msdyncrm_linkedinuserprofile_phonecall: { b: 'regardingobjectid_msdyncrm_linkedinuserprofile_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_linkedinuserprofiles', d: 'msdyncrm_linkedinuserprofile' },
			regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_phonecall: { b: 'regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_marketingdynamiccontentmetadatas', d: 'msdyncrm_marketingdynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_phonecall: { b: 'regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemaildynamiccontentmetadatas', d: 'msdyncrm_marketingemaildynamiccontentmetadata' },
			regardingobjectid_msdyncrm_marketingemailtestsend_phonecall: { b: 'regardingobjectid_msdyncrm_marketingemailtestsend_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_marketingemailtestsends', d: 'msdyncrm_marketingemailtestsend' },
			regardingobjectid_msdyncrm_migration_phonecall: { b: 'regardingobjectid_msdyncrm_migration_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_migrations', d: 'msdyncrm_migration' },
			regardingobjectid_msdyncrm_uicconfig_phonecall: { b: 'regardingobjectid_msdyncrm_uicconfig_phonecall', a: '_regardingobjectid_value', c: 'msdyncrm_uicconfigs', d: 'msdyncrm_uicconfig' },
			...
			regardingobjectid_msdyn_swarm_phonecall: { b: 'regardingobjectid_msdyn_swarm_phonecall', a: '_regardingobjectid_value', c: 'msdyn_swarms', d: 'msdyn_swarm' },
			...
			regardingobjectid_msevtmgt_checkin_phonecall: { b: 'regardingobjectid_msevtmgt_checkin_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_checkins', d: 'msevtmgt_checkin' },
			regardingobjectid_msevtmgt_event_phonecall: { b: 'regardingobjectid_msevtmgt_event_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_events', d: 'msevtmgt_event' },
			regardingobjectid_msevtmgt_eventpurchase_phonecall: { b: 'regardingobjectid_msevtmgt_eventpurchase_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchases', d: 'msevtmgt_eventpurchase' },
			regardingobjectid_msevtmgt_eventpurchaseattendee_phonecall: { b: 'regardingobjectid_msevtmgt_eventpurchaseattendee_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchaseattendees', d: 'msevtmgt_eventpurchaseattendee' },
			regardingobjectid_msevtmgt_eventpurchasepass_phonecall: { b: 'regardingobjectid_msevtmgt_eventpurchasepass_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_eventpurchasepasses', d: 'msevtmgt_eventpurchasepass' },
			regardingobjectid_msevtmgt_eventregistration_phonecall: { b: 'regardingobjectid_msevtmgt_eventregistration_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_eventregistrations', d: 'msevtmgt_eventregistration' },
			regardingobjectid_msevtmgt_hotel_phonecall: { b: 'regardingobjectid_msevtmgt_hotel_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_hotels', d: 'msevtmgt_hotel' },
			regardingobjectid_msevtmgt_hotelroomallocation_phonecall: { b: 'regardingobjectid_msevtmgt_hotelroomallocation_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomallocations', d: 'msevtmgt_hotelroomallocation' },
			regardingobjectid_msevtmgt_hotelroomreservation_phonecall: { b: 'regardingobjectid_msevtmgt_hotelroomreservation_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_hotelroomreservations', d: 'msevtmgt_hotelroomreservation' },
			regardingobjectid_msevtmgt_layout_phonecall: { b: 'regardingobjectid_msevtmgt_layout_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_layouts', d: 'msevtmgt_layout' },
			regardingobjectid_msevtmgt_room_phonecall: { b: 'regardingobjectid_msevtmgt_room_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_rooms', d: 'msevtmgt_room' },
			regardingobjectid_msevtmgt_session_phonecall: { b: 'regardingobjectid_msevtmgt_session_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_sessions', d: 'msevtmgt_session' },
			regardingobjectid_msevtmgt_sessionregistration_phonecall: { b: 'regardingobjectid_msevtmgt_sessionregistration_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_sessionregistrations', d: 'msevtmgt_sessionregistration' },
			regardingobjectid_msevtmgt_sessiontrack_phonecall: { b: 'regardingobjectid_msevtmgt_sessiontrack_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_sessiontracks', d: 'msevtmgt_sessiontrack' },
			regardingobjectid_msevtmgt_speaker_phonecall: { b: 'regardingobjectid_msevtmgt_speaker_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_speakers', d: 'msevtmgt_speaker' },
			regardingobjectid_msevtmgt_speakerengagement_phonecall: { b: 'regardingobjectid_msevtmgt_speakerengagement_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_speakerengagements', d: 'msevtmgt_speakerengagement' },
			regardingobjectid_msevtmgt_sponsorablearticle_phonecall: { b: 'regardingobjectid_msevtmgt_sponsorablearticle_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorablearticles', d: 'msevtmgt_sponsorablearticle' },
			regardingobjectid_msevtmgt_sponsorship_phonecall: { b: 'regardingobjectid_msevtmgt_sponsorship_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_sponsorships', d: 'msevtmgt_sponsorship' },
			regardingobjectid_msevtmgt_venue_phonecall: { b: 'regardingobjectid_msevtmgt_venue_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_venues', d: 'msevtmgt_venue' },
			regardingobjectid_msevtmgt_webinarconfiguration_phonecall: { b: 'regardingobjectid_msevtmgt_webinarconfiguration_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_webinarconfigurations', d: 'msevtmgt_webinarconfiguration' },
			regardingobjectid_msevtmgt_webinarprovider_phonecall: { b: 'regardingobjectid_msevtmgt_webinarprovider_phonecall', a: '_regardingobjectid_value', c: 'msevtmgt_webinarproviders', d: 'msevtmgt_webinarprovider' },
