...
declare namespace DevKit {
	namespace Formmsdyn_ocwhatsappchannelnumber_Information {
		...
		interface Navigation {
			msdyn_ocwhatsappchannelnumber_msdyn_surveyconfig_msdyn_targetchannelid: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_ocwhatsappchannelnumber_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocwhatsappchannelnumber_Information */
		Navigation: DevKit.Formmsdyn_ocwhatsappchannelnumber_Information.Navigation;
	...
	class msdyn_ocwhatsappchannelnumberApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_ocwhatsappchannelnumber.ComponentState;
		...
		/** Mode of the survey to be sent */
		msdyn_PostConversationSurveyBotSurveyMode: OptionSet.msdyn_ocwhatsappchannelnumber.msdyn_PostConversationSurveyBotSurveyMode;
		/** To enable or disable post conversation survey */
		...
		/** WhatsApp Provider Channel Id */
		msdyn_ProviderChannelId: string;
		...
		readonly FormattedValue: {
			...
			/** Identity of associated WhatsApp account */
			readonly msdyn_ocwhatsappaccountid: string;
			/** Unique identifier for WhatsApp entity instances */
			readonly msdyn_ocwhatsappchannelnumberId: string;
			/** The language setting for the WhatsApp number */
			readonly msdyn_ocwidgetlanguage: string;
			/** Phone number for a WhatsApp account */
			readonly msdyn_organizationphonenumber: string;
			/** Lookup to Dynamics 365 Customer Voice survey field */
			...
			/** WhatsApp Provider Channel Id */
			readonly msdyn_ProviderChannelId: string;
			/** Date and time that the record was migrated. */
