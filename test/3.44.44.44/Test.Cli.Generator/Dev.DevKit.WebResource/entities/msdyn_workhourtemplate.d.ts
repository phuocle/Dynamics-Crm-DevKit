...
declare namespace DevKit {
	namespace Formmsdyn_workhourtemplate_Information {
		...
		interface Navigation {
			msdyn_msdyn_workhourtemplate_account_workhourtemplate: DevKit.Controls.NavigationItem,
			msdyn_msdyn_workhourtemplate_msdyn_workorder_workhourtemplate: DevKit.Controls.NavigationItem,
			msdyn_workhourtemplate_msdyn_resourcerequirement_workhourtemplate: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_workhourtemplate_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_workhourtemplate_Information */
		Navigation: DevKit.Formmsdyn_workhourtemplate_Information.Navigation;
		/** The SidePanes of form msdyn_workhourtemplate_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_workhourtemplate_Information2 {
		interface Tabs {
		}
		interface Body {
			/** The name of the custom entity. */
	...
	class Formmsdyn_workhourtemplate_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_workhourtemplate_Information2 */
		Navigation: DevKit.Formmsdyn_workhourtemplate_Information2.Navigation;
		/** The SidePanes of form msdyn_workhourtemplate_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_workhourtemplateApi {
		/**
		* DynamicsCrm.DevKit msdyn_workhourtemplateApi
		...
		*/
		...
		statecode: OptionSet.msdyn_workhourtemplate.statecode;
		/** Reason for the status of the Work Template */
		statuscode: OptionSet.msdyn_workhourtemplate.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_workhourtemplateId: string;
			/** Date and time that the record was migrated. */
