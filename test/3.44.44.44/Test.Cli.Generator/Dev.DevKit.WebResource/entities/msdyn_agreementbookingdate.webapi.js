...
(function (DevKit) {
	...
	DevKit.msdyn_agreementbookingdateApi = function (e) {
		...
		var _msdyn_agreementbookingdate = {
		...
		msdyn_agreementbookingdate.ODataEntity = e;
		msdyn_agreementbookingdate.FormattedValue = {};
		for (var field in _msdyn_agreementbookingdate) {
			var a = _msdyn_agreementbookingdate[field].a;
			var b = _msdyn_agreementbookingdate[field].b;
			var c = _msdyn_agreementbookingdate[field].c;
			var d = _msdyn_agreementbookingdate[field].d;
			var g = _msdyn_agreementbookingdate[field].g;
			var r = _msdyn_agreementbookingdate[field].r;
			webApiField(msdyn_agreementbookingdate, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementbookingdate.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_agreementbookingdate.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
