...
(function (DevKit) {
	...
	DevKit.SystemUserApi = function (e) {
		...
		var _systemuser = {
			...
			msdyn_callforwardingnumber: { a: 'msdyn_callforwardingnumber' },
			msdyn_Capacity: { a: 'msdyn_capacity' },
			msdyn_cognitiveservicesregion: { a: 'msdyn_cognitiveservicesregion' },
			msdyn_cognitiveservicessubscriptionkey: { a: 'msdyn_cognitiveservicessubscriptionkey' },
			...
			msdyn_emergencyemailrecipients: { a: 'msdyn_emergencyemailrecipients' },
			msdyn_gdproptout: { a: 'msdyn_gdproptout' },
			msdyn_gridwrappercontrolfield: { a: 'msdyn_gridwrappercontrolfield' },
			msdyn_isexpertenabledforswarm: { a: 'msdyn_isexpertenabledforswarm' },
