...
declare namespace DevKit {
	namespace Formmsdyn_productivitymacroactiontemplate_Information {
		...
		interface Navigation {
			msdyn_msdyn_prod_macroactiontemplate_msdyn_actioninput: DevKit.Controls.NavigationItem,
			msdyn_msdyn_prod_macroactiontemplate_msdyn_actionout: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_productivitymacroactiontemplate_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_productivitymacroactiontemplate_Information.Body;
		/** The Navigation of form msdyn_productivitymacroactiontemplate_Information */
		Navigation: DevKit.Formmsdyn_productivitymacroactiontemplate_Information.Navigation;
		/** The SidePanes of form msdyn_productivitymacroactiontemplate_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_productivitymacroactiontemplateApi {
		/**
		* DynamicsCrm.DevKit msdyn_productivitymacroactiontemplateApi
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** The description of this macro action. */
			readonly msdyn_actionDescription: string;
			/** Unique value to set the brand color */
			...
			/** Kind is either 'TRIGGERS' or 'ACTIONS' */
			readonly msdyn_kind: string;
			/** Sets the value of macro connector */
			readonly msdyn_macroconnector: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Output parameters for macro action template entity */
			readonly msdyn_outputparameters: string;
			/** Unique identifier for entity instances */
			readonly msdyn_productivitymacroactiontemplateId: string;
			/** Function to be executed at runtime */
			readonly msdyn_runtimeapi: string;
			/** Unique value to set the subtitle value */
			readonly msdyn_subtitle: string;
			/** Unique value to set the summary */
