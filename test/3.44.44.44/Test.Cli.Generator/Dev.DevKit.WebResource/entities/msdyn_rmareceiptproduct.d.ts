...
declare namespace DevKit {
	namespace Formmsdyn_rmareceiptproduct_Information {
		...
		interface Navigation {
			msdyn_msdyn_rmareceiptproduct_msdyn_inventoryjournal_RMAReceiptProduct: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_rmareceiptproduct_Tasks: DevKit.Controls.NavigationItem
		}
	}
