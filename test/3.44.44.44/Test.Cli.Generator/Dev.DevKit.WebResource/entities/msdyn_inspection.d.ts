...
declare namespace DevKit {
	namespace Formmsdyn_inspection_Information {
		...
		interface Navigation {
			msdyn_msdyn_inspection_msdyn_agreementbookingservicetask_Inspection: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msdyn_incidenttypeservicetask_Inspection: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msdyn_inspectiondefinition: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msdyn_inspectioninstance: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msdyn_servicetasktype_Inspection: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msdyn_workorderservicetask_Inspection: DevKit.Controls.NavigationItem,
			msdyn_msdyn_inspection_msfp_survey_Inspection: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_inspection_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_inspection_Information */
		Navigation: DevKit.Formmsdyn_inspection_Information.Navigation;
