...
declare namespace DevKit {
	namespace Formmsdyn_liveconversation_Information {
		...
		interface Navigation {
			msdyn_liveconversation_Feedback: DevKit.Controls.NavigationItem,
			msdyn_liveconversation_QueueItems: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_liveconversation_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_liveconversation_Information */
		Navigation: DevKit.Formmsdyn_liveconversation_Information.Navigation;
	...
	class FormOngoing_Conversation_Main_Form extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form Ongoing_Conversation_Main_Form */
		Navigation: DevKit.FormOngoing_Conversation_Main_Form.Navigation;
