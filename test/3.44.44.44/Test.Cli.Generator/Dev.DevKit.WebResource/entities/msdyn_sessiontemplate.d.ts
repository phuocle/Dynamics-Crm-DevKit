...
declare namespace DevKit {
	namespace Formmsdyn_sessiontemplate_Information {
		...
		interface Body {
			...
			msdyn_EnableTitleSync: DevKit.Controls.Boolean;
			...
			/** Custom icon of the session */
			msdyn_sessionicon: DevKit.Controls.Lookup;
	...
	class Formmsdyn_sessiontemplate_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_sessiontemplate_Information */
		Navigation: DevKit.Formmsdyn_sessiontemplate_Information.Navigation;
	...
	class msdyn_sessiontemplateApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique value to enable or disable build expression */
			readonly msdyn_enablebuildexpression: string;
			readonly msdyn_EnableTitleSync: string;
			readonly msdyn_entity: string;
			/** Stores expression JSON */
			readonly msdyn_expressiondata: string;
			/** The name of the session. */
			readonly msdyn_name: string;
			readonly msdyn_panelstate: string;
			/** Custom icon of the session */
			readonly msdyn_sessionicon: string;
			/** Unique identifier for entity instances */
			readonly msdyn_sessiontemplateId: string;
			readonly msdyn_sessiontype: string;
			/** Title of the session. */
