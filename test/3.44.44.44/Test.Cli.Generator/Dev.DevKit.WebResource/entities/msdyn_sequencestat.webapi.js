...
(function (DevKit) {
	...
	DevKit.msdyn_sequencestatApi = function (e) {
		...
		msdyn_sequencestat.ODataEntity = e;
		msdyn_sequencestat.FormattedValue = {};
		for (var field in _msdyn_sequencestat) {
			var a = _msdyn_sequencestat[field].a;
			var b = _msdyn_sequencestat[field].b;
			var c = _msdyn_sequencestat[field].c;
			var d = _msdyn_sequencestat[field].d;
			var g = _msdyn_sequencestat[field].g;
			var r = _msdyn_sequencestat[field].r;
			webApiField(msdyn_sequencestat, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sequencestat.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_sequencestat.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
