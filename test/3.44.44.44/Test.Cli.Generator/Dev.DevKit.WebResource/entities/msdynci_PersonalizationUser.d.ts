...
declare namespace DevKit {
	namespace Formmsdynci_PersonalizationUser_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdynci_PersonalizationUser_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		/** The Body section of form msdynci_PersonalizationUser_Information */
		Body: DevKit.Formmsdynci_PersonalizationUser_Information.Body;
		/** The Navigation of form msdynci_PersonalizationUser_Information */
		Navigation: DevKit.Formmsdynci_PersonalizationUser_Information.Navigation;
		/** The SidePanes of form msdynci_PersonalizationUser_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdynci_PersonalizationUserApi {
		/**
		* DynamicsCrm.DevKit msdynci_PersonalizationUserApi
		...
		*/
		...
		msdynci_PersonalizationUserId: string;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdynci_PersonalizationUserId: string;
...
declare namespace OptionSet {
	namespace msdynci_PersonalizationUser {
		enum RollupState {
