...
declare namespace DevKit {
	namespace FormBooking_Timestamp_Mobile {
		...
		interface Navigation {
			msdyn_bookingtimestamp_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_Appointments: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_Emails: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_bookingtimestamp_Tasks: DevKit.Controls.NavigationItem
		}
	}
	...
	class msdyn_bookingtimestampApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Shows the entity instances. */
			readonly msdyn_bookingtimestampId: string;
			/** System internal field. Indicates that journals must be generated after saving timestamp from mobile. */
			readonly msdyn_GenerateJournals: string;
			/** Enter the name of the custom entity. */
			readonly msdyn_name: string;
			readonly msdyn_SystemStatus: string;
			readonly msdyn_TimestampSource: string;
			readonly msdyn_TimestampTime_UtcDateAndTime: string;
			/** Shows the date and time that the record was migrated. */
