...
declare namespace DevKit {
	namespace FormAgreement_Invoice_Product_Mobile {
		...
		interface Navigation {
			msdyn_agreementinvoiceproduct_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_Appointments: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_Emails: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_agreementinvoiceproduct_Tasks: DevKit.Controls.NavigationItem,
			msdyn_msdyn_agreementinvoiceproduct_invoicedetail_AgreementInvoiceProduct: DevKit.Controls.NavigationItem
		}
	}
	...
	class msdyn_agreementinvoiceproductApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Shows the entity instances. */
			readonly msdyn_agreementinvoiceproductId: string;
			/** Unique identifier for Agreement Invoice Setup associated with Agreement Invoice Product. */
			readonly msdyn_AgreementInvoiceSetup: string;
			/** Shows the order of this product within the agreement invoice setup. */
