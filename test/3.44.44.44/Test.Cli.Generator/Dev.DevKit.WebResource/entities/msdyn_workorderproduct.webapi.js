...
(function (DevKit) {
	...
	DevKit.msdyn_workorderproductApi = function (e) {
		...
		msdyn_workorderproduct.ODataEntity = e;
		msdyn_workorderproduct.FormattedValue = {};
		for (var field in _msdyn_workorderproduct) {
			var a = _msdyn_workorderproduct[field].a;
			var b = _msdyn_workorderproduct[field].b;
			var c = _msdyn_workorderproduct[field].c;
			var d = _msdyn_workorderproduct[field].d;
			var g = _msdyn_workorderproduct[field].g;
			var r = _msdyn_workorderproduct[field].r;
			webApiField(msdyn_workorderproduct, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_workorderproduct.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_workorderproduct.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
