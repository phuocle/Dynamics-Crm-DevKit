...
(function (DevKit) {
	...
	DevKit.FormTerritory_Information = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			...
			msdyn_territory_msdyn_actual_ServiceTerritory: {},
			msdyn_territory_msdyn_agreement_ServiceTerritory: {},
			msdyn_territory_msdyn_postalcode_ServiceTerritory: {},
			msdyn_territory_msdyn_resourcerequirement_Territory: {},
			msdyn_territory_msdyn_resourceterritory_Territory: {},
	...
	DevKit.FormTerritory_Quick_Create = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
