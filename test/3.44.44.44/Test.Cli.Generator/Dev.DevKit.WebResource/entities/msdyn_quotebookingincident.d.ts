...
declare namespace DevKit {
	namespace Formmsdyn_quotebookingincident_Information {
		...
		interface Navigation {
			msdyn_msdyn_quotebookingincident_msdyn_quotebookingproduct_QuoteBookingIncident: DevKit.Controls.NavigationItem,
			msdyn_msdyn_quotebookingincident_msdyn_quotebookingservice_QuoteBookingIncident: DevKit.Controls.NavigationItem,
			msdyn_msdyn_quotebookingincident_msdyn_quotebookingservicetask_QuoteBookingIncident: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_adx_inviteredemptions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_adx_portalcomments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_Appointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_Emails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_bookingalerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_copilottranscripts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_ocliveworkitems: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_ocoutboundmessages: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_ocsessions: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msdyn_ocvoicemails: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msfp_alerts: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msfp_surveyinvites: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_msfp_surveyresponses: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_PhoneCalls: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_ServiceAppointments: DevKit.Controls.NavigationItem,
			msdyn_quotebookingincident_Tasks: DevKit.Controls.NavigationItem
		}
	}
	...
	class Formmsdyn_quotebookingincident_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_quotebookingincident_Information2 */
		Navigation: DevKit.Formmsdyn_quotebookingincident_Information2.Navigation;
	...
	class msdyn_quotebookingincidentApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_quotebookingincidentId: string;
			/** Shows the quote booking setup associated with the quote booking incident. */
