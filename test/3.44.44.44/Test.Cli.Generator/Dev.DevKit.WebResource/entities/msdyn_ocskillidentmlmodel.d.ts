...
declare namespace DevKit {
	namespace Formmsdyn_ocskillidentmlmodel_Information {
		...
		interface Navigation {
			msdyn_ocsimltraining_ocskillidentmlmodeli: DevKit.Controls.NavigationItem,
			msdyn_ocsitdimportconfig_ocskillidentmlmo: DevKit.Controls.NavigationItem,
			msdyn_ocsitrainingdata_ocskillidentmlmode: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_ocskillidentmlmodel_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocskillidentmlmodel_Information */
		Navigation: DevKit.Formmsdyn_ocskillidentmlmodel_Information.Navigation;
	...
	class msdyn_ocskillidentmlmodelApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Indicates model's status */
			readonly msdyn_ocskillidentmlmodelstatus: string;
			/** Indicates model's recent training status */
			readonly msdyn_ocskillidentmlmodeltrainingstatus: string;
			/** Training configuration */
			readonly msdyn_trainingconfiguration: string;
			/** Unique Name for the entity. */
			readonly msdyn_UniqueName: string;
			/** Attribute to map UI data */
			readonly msdyn_wizzarddata: string;
			/** Date and time that the record was migrated. */
