...
declare namespace DevKit {
	class msdyn_salesforcestructuredobjectApi {
		/**
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_salesforcestructuredobject.ComponentState;
		...
		statecode: OptionSet.msdyn_salesforcestructuredobject.statecode;
		/** Reason for the status of the Salesforce Structured Object. */
		statuscode: OptionSet.msdyn_salesforcestructuredobject.statuscode;
		/** For internal use only. */
