...
(function (DevKit) {
	...
	DevKit.SocialProfileApi = function (e) {
		...
		var _socialprofile = {
			...
			msdyn_customeroptout: { a: 'msdyn_customeroptout' },
			...
			msdyn_wechatopenid: { a: 'msdyn_wechatopenid' },
		...
		for (var field in _socialprofile) {
			var a = _socialprofile[field].a;
			var b = _socialprofile[field].b;
			var c = _socialprofile[field].c;
			var d = _socialprofile[field].d;
			var g = _socialprofile[field].g;
			var r = _socialprofile[field].r;
			webApiField(socialprofile, field, e, a, b, c, d, r, u, g);
		}
