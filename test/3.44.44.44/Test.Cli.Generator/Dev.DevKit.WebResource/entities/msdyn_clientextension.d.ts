...
declare namespace DevKit {
	namespace Formmsdyn_clientextension_Information {
		interface Tabs {
		}
		interface Body {
			msdyn_extensiontype: DevKit.Controls.OptionSet;
			/** The name of the custom entity. */
			msdyn_name: DevKit.Controls.String;
			/** Processing order within the same extension type. */
			msdyn_rank: DevKit.Controls.Integer;
			msdyn_scheduleboardsettingid: DevKit.Controls.Lookup;
	...
	class Formmsdyn_clientextension_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_clientextension_Information */
		Navigation: DevKit.Formmsdyn_clientextension_Information.Navigation;
		/** The SidePanes of form msdyn_clientextension_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_clientextension_Information2 {
		interface Tabs {
		}
		interface Body {
			/** The name of the custom entity. */
	...
	class Formmsdyn_clientextension_Information2 extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_clientextension_Information2 */
		Navigation: DevKit.Formmsdyn_clientextension_Information2.Navigation;
		/** The SidePanes of form msdyn_clientextension_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_clientextensionApi {
		/**
		* DynamicsCrm.DevKit msdyn_clientextensionApi
		...
		*/
		...
		msdyn_extensiontype: OptionSet.msdyn_clientextension.msdyn_extensiontype;
		/** The name of the custom entity. */
		msdyn_name: string;
		/** Processing order within the same extension type. */
		msdyn_rank: number;
		...
		statecode: OptionSet.msdyn_clientextension.statecode;
		/** Reason for the status of the Client Extension */
		statuscode: OptionSet.msdyn_clientextension.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyn_clientextensionId: string;
			readonly msdyn_extensiontype: string;
			/** The name of the custom entity. */
...
declare namespace OptionSet {
	namespace msdyn_clientextension {
		enum msdyn_extensiontype {
			/** 192350002 */
			Localization,
			/** 192350000 */
			Script,
