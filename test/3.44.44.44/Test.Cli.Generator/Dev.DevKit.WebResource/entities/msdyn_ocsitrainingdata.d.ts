...
declare namespace DevKit {
	namespace Formmsdyn_ocsitrainingdata_Information {
		...
		interface Navigation {
			msdyn_ocsitdskill_ocsitrainingdataid: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_ocsitrainingdata_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_ocsitrainingdata_Information */
		Navigation: DevKit.Formmsdyn_ocsitrainingdata_Information.Navigation;
		/** The SidePanes of form msdyn_ocsitrainingdata_Information */
	...
	class msdyn_ocsitrainingdataApi {
		...
		*/
		...
		/** Approved on */
		msdyn_approvedon_UtcDateAndTime: Date;
		/** The name of the training record. */
		msdyn_name: string;
		/** Data loading config */
		...
		/** Approval status */
		msdyn_ocsitrainingdatastatus: OptionSet.msdyn_ocsitrainingdata.msdyn_ocsitrainingdatastatus;
		/** Skill finder model */
		...
		statecode: OptionSet.msdyn_ocsitrainingdata.statecode;
		/** Reason for the status of the ocsitrainingdata */
		statuscode: OptionSet.msdyn_ocsitrainingdata.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Approved on */
			readonly msdyn_approvedon_UtcDateAndTime: string;
			/** The name of the training record. */
			...
			/** Approval status */
			readonly msdyn_ocsitrainingdatastatus: string;
			/** Skill finder model */
			readonly msdyn_ocskillidentmlmodelid: string;
			/** Input data */
			readonly msdyn_phrase: string;
			/** List of skill IDs */
			readonly msdyn_skillidscsv: string;
			/** Tags */
			readonly msdyn_skillscsv: string;
			/** Date and time that the record was migrated. */
