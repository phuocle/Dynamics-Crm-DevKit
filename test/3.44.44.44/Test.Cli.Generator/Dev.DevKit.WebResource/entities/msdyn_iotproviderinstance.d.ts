...
declare namespace DevKit {
	namespace Formmsdyn_iotproviderinstance_Information {
		...
		interface Navigation {
			msdyn_msdyn_iotproviderinstance_msdyn_iotdevice_IoTProviderInstance: DevKit.Controls.NavigationItem,
			msdyn_msdyn_iotproviderinstance_msdyn_iotsettings_DefaultIoTProviderInstance: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class Formmsdyn_iotproviderinstance_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Navigation of form msdyn_iotproviderinstance_Information */
		Navigation: DevKit.Formmsdyn_iotproviderinstance_Information.Navigation;
	...
	class msdyn_iotproviderinstanceApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_iotproviderinstance.statecode;
		/** Reason for the status of the IoT Provider Instance */
		statuscode: OptionSet.msdyn_iotproviderinstance.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** The IoT Provider of which this record is an instance. */
			readonly msdyn_IoTProvider: string;
			/** Unique identifier for entity instances */
			readonly msdyn_iotproviderinstanceId: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** The ID of the provider instance. */
			readonly msdyn_ProviderInstanceId: string;
			/** The URL of the Time Series Insights connected to the IoT Hub provider instance to get device readings from. */
			readonly msdyn_TimeSeriesInsightsURL: string;
			/** The URL of the provider instance. */
