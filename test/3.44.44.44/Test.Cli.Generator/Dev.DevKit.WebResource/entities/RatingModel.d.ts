...
declare namespace DevKit {
	namespace FormRatingModel_Information {
		...
		interface Navigation {
			ratingmodel_ratingvalue_RatingModel: DevKit.Controls.NavigationItem
		}
	}
	...
	class RatingModelApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Enter the maximum rating value. */
			readonly MaxRatingValue: string;
			/** Enter the minimum rating value. */
			readonly MinRatingValue: string;
			/** Unique identifier of the user who modified the record. */
			readonly ModifiedBy: string;
			/** Date and time when the record was modified. */
