...
declare namespace DevKit {
	namespace Formmsdyn_resourcepaytype_Information {
		...
		interface Navigation {
			msdyn_msdyn_resourcepaytype_msdyn_bookingjournal_PayType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcepaytype_msdyn_fieldservicesetting_BreakPayType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcepaytype_msdyn_fieldservicesetting_BusinessClosurePayType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcepaytype_msdyn_fieldservicesetting_OvertimePayType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcepaytype_msdyn_fieldservicesetting_TravelPayType: DevKit.Controls.NavigationItem,
			msdyn_msdyn_resourcepaytype_msdyn_fieldservicesetting_WorkPayType: DevKit.Controls.NavigationItem
		}
	}
	...
	class msdyn_resourcepaytypeApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Enter the markup percentage on the resource hourly cost. Use a value greater than 100% to mark it up and a value less than 100% to mark it down. */
			readonly msdyn_HourlyMarkup: string;
			/** Enter the resource pay type name. */
			readonly msdyn_name: string;
			/** Shows the entity instances. */
			readonly msdyn_resourcepaytypeId: string;
			/** Shows the date and time that the record was migrated. */
