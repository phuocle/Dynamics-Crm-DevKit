...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class PostRegarding : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Post Regarding";
		public const string DisplayName = "Post Regarding";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Latest Auto Post</para>
		/// <para><strong>Description</strong>: Date of Latest Auto Post on the Regarding entity</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Latest Manual Post</para>
		/// <para><strong>Description</strong>: Date of Latest Manual Post on the Regarding entity</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the ID of the record that the post is referring to.</para>
		...
		/// <para><strong>Description</strong>: Select the business unit that owns the regarding object.</para>
		...
		/// <para><strong>Description</strong>: Indicates the entity type of the regarding object for sharing.</para>
