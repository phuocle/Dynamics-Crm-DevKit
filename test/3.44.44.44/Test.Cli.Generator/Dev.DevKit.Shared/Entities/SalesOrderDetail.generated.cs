...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class SalesOrderDetail : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "SalesOrderDetails";
		public const string EntityDisplayCollectionName = "Order Lines";
		public const string DisplayName = "Order Line";
		public const string EntitySetName = "salesorderdetails";
		public const string EntityLogicalCollectionName = "salesorderdetails";
		public const string EntityPrimaryIdAttribute = "salesorderdetailid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "salesorderdetailname";
		...
		/// <summary>
		/// Instance new late bound class <see cref="SalesOrderDetail"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public SalesOrderDetail(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="SalesOrderDetail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public SalesOrderDetail(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new SalesOrderDetail(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="SalesOrderDetail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public SalesOrderDetail(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new SalesOrderDetail(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Shows the total price of the order product, based on the price per unit, volume discount, and quantity.</para>
		...
		/// <para><strong>Description</strong>: Type additional information to describe the order product, such as manufacturing details or acceptable substitutions.</para>
		...
		/// <para><strong>Description</strong>: Shows the total amount due for the order product, based on the sum of the unit price, quantity, discounts, and tax.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Select whether the invoice line item is copied from another item or data source.</para>
		...
		/// <para><strong>Description</strong>: Select whether the price per unit is fixed at the value in the specified price list or can be overridden by users who have edit rights to the order product.</para>
		...
		/// <para><strong>Description</strong>: Select whether the product exists in the Microsoft Dynamics 365 product catalog or is a write-in product specific to the order.</para>
		...
		/// <para><strong>Description</strong>: Type the line item number for the order product to easily identify the product in the order and make sure it&apos;s listed in the correct sequence.</para>
		...
		/// <para><strong>Description</strong>: Type the manual discount amount for the order product to deduct any negotiated or other savings from the product total on the order.</para>
		...
		/// <para><strong>Description</strong>: Select a Agreement for this order line</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.msdyn_LineType"/></para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.OrderCreationMethod"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.OrderCreationMethod.Unknown"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.OrderCreationMethod? OrderCreationMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OrderCreationMethod);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.OrderCreationMethod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type the price per unit of the order product. The default is the value in the price list specified on the order for existing products.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.PricingErrorCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.PricingErrorCode.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the product line item association with bundle in the sales order</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a name or description to identify the type of write-in product included in the order.</para>
		...
		/// <para><strong>Description</strong>: Choose the product to include on the order to link the product&apos;s pricing and other information to the parent order.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.ProductTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.ProductTypeCode.Product"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.PropertyConfigurationStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.PropertyConfigurationStatus.Not_Configured"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the amount or quantity of the product ordered by the customer.</para>
		...
		/// <para><strong>Description</strong>: Type the amount or quantity of the product that is back ordered for the order.</para>
		...
		/// <para><strong>Description</strong>: Type the amount or quantity of the product that was canceled.</para>
		/// <para><strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the amount or quantity of the product that was shipped for the order.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quote Product Id</para>
		/// <para><strong>Description</strong>: Unique identifier for Quote Line associated with Order Line.</para>
		...
		/// <para><strong>Description</strong>: Enter the delivery date requested by the customer for the order product.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Order Product</para>
		/// <para><strong>Description</strong>: Unique identifier of the product specified in the order.</para>
		...
		/// <para><strong>Description</strong>: Sales Order Detail Name. Added for 1:n referential relationship (internal purposes only)</para>
		...
		/// <para><strong>Description</strong>: Shows the order for the product. The ID is used to link product pricing and other details to the total amounts and other information on the order.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Order Is Price Locked</para>
		/// <para><strong>Description</strong>: Tells whether product pricing is locked for the order.</para>
		...
		/// <para><strong>Description</strong>: Choose the user responsible for the sale of the order product.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.ShipTo_FreightTermsCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Skip the price calculation</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.SkipPriceCalculation"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.SalesOrderDetailOptionSets.SkipPriceCalculation.DoPriceCalcAlways"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the tax amount for the order product.</para>
		...
		/// <para><strong>Description</strong>: Select whether the order product should be shipped to the specified address or held until the customer calls with further pick up or delivery instructions.</para>
