...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_purchaseorderproduct : EntityBase
	{
		...
		public const int EntityTypeCode = 11635;
		public const string EntityCollectionSchemaName = "msdyn_purchaseorderproducts";
		public const string EntityDisplayCollectionName = "Purchase Order Products";
		public const string DisplayName = "Purchase Order Product";
		public const string EntitySetName = "msdyn_purchaseorderproducts";
		public const string EntityLogicalCollectionName = "msdyn_purchaseorderproducts";
		public const string EntityPrimaryIdAttribute = "msdyn_purchaseorderproductid";
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_purchaseorderproduct"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_purchaseorderproduct(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_purchaseorderproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_purchaseorderproduct(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_purchaseorderproduct(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_purchaseorderproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_purchaseorderproduct(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_purchaseorderproduct(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Associate To Booking</para>
		/// <para><strong>Description</strong>: Link this product to Booking. If specified and warehouse is not set then product will be added to Resource Booking</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Associate To Warehouse</para>
		/// <para><strong>Description</strong>: Warehouse to which this product should be received to</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Associate To Work Order</para>
		/// <para><strong>Description</strong>: Link this product to Work Order. If specified and warehouse is not set then product will be added to work order</para>
		...
		/// <para><strong>Description</strong>: Enter the date you expect this product to arrive to the shipping address. This value defaults to the date set on the PO.</para>
		...
		/// <para><strong>Description</strong>: Enter the product description to display for the vendor.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Is Ordered</para>
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_purchaseorderproductOptionSets.msdyn_ItemStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_purchaseorderproductOptionSets.msdyn_ItemStatus.Pending"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the order of this product within the purchase order.</para>
		...
		/// <para><strong>Description</strong>: Product to order</para>
		...
		/// <para><strong>Description</strong>: Purchase order this line item relates to</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quantity Billed</para>
		/// <para><strong>Description</strong>: Enter the quantity currently billed.</para>
		...
		/// <para><strong>Description</strong>: Enter the quantity ordered.</para>
		...
		/// <para><strong>Description</strong>: Enter the cost of this product per unit.</para>
		...
		/// <para><strong>Description</strong>: Status of the Purchase Order Product</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_purchaseorderproductOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Purchase Order Product</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_purchaseorderproductOptionSets.statuscode"/></para>
