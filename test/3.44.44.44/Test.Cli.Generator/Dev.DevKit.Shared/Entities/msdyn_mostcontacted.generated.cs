...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_mostcontacted : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_lastcontactedby = "msdyn_lastcontactedby";
			...
			public const string msdyn_mostcontactedId = "msdyn_mostcontactedid";
			...
			public const string msdyn_relationshiphealthscorecolor = "msdyn_relationshiphealthscorecolor";
		...
		public const string EntityLogicalName = "msdyn_mostcontacted";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 10572;
		public const string EntityCollectionSchemaName = "msdyn_mostcontacteds";
		public const string EntityDisplayCollectionName = "Most Contacted";
		public const string DisplayName = "Most Contacted";
		public const string EntitySetName = "msdyn_mostcontacteds";
		public const string EntityLogicalCollectionName = "msdyn_mostcontacteds";
		public const string EntityPrimaryIdAttribute = "msdyn_mostcontactedid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_primaryname";
		public const string EntitySchemaName = "msdyn_mostcontacted";
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(Guid msdyn_mostcontactedId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_mostcontactedId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_mostcontacted"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_mostcontacted"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_mostcontacted(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_mostcontacted"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_mostcontacted(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_mostcontacted(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.msdyn_computationaccuracy"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.msdyn_computationaccuracy.Complete"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.msdyn_computationaccuracy? msdyn_computationaccuracy
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_computationaccuracy);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.msdyn_computationaccuracy)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Regarding</para>
		/// <para><strong>Description</strong>: Shows related contact.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Most Contacted Entity Name</para>
		/// <para><strong>Description</strong>: The entity name of the most contacted record.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Most contacted KPIs</para>
		/// <para><strong>Description</strong>: Most contacted KPI data as JSON</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Last Contacted By</para>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_lastcontactedby); }
			set { Entity.Attributes[Fields.msdyn_lastcontactedby] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Time</para>
		/// <para><strong>Description</strong>: Shows when the contact was last contacted.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		public Guid msdyn_mostcontactedId
		{
			...
			set
			{
				Entity.Attributes[Fields.msdyn_mostcontactedId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Shows the primary name of the custom entity.</para>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_relationshiphealthscorecolor); }
			set { Entity.Attributes[Fields.msdyn_relationshiphealthscorecolor] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Relationship Health</para>
		/// <para><strong>Description</strong>: Health score for the account.</para>
		...
		/// <para><strong>Description</strong>: Shows unique identifier for the organization.</para>
		...
		/// <para><strong>Description</strong>: Status of the Most Contacted</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Most Contacted</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_mostcontactedOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
