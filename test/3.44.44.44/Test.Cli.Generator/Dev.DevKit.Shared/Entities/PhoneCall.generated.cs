...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class PhoneCall : EntityBase
	{
		...
		/// <para>Required - <strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="lead"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: The Journey action id in which the phonecall is created.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: The journey id in which the phonecall is created</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.PhoneCallOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.PhoneCallOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
