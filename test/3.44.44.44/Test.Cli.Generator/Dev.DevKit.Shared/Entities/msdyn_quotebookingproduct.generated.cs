...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_quotebookingproduct : EntityBase
	{
		...
		public const int EntityTypeCode = 11687;
		public const string EntityCollectionSchemaName = "msdyn_quotebookingproducts";
		public const string EntityDisplayCollectionName = "Quote Booking Products";
		public const string DisplayName = "Quote Booking Product";
		public const string EntitySetName = "msdyn_quotebookingproducts";
		public const string EntityLogicalCollectionName = "msdyn_quotebookingproducts";
		public const string EntityPrimaryIdAttribute = "msdyn_quotebookingproductid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_quotebookingproduct";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingproduct"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingproduct(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingproduct(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_quotebookingproduct(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingproduct(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_quotebookingproduct(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: The currency that will be used to charge this product</para>
		...
		/// <para><strong>Description</strong>: The estimated cost of this quote booking product</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: The estimated sales amount of this quote booking product</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: EstimatedSalesAmount (Base)</para>
		/// <para><strong>Description</strong>: Value of the EstimatedSalesAmount in base currency.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the order of this task within the quote booking products.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Product/Service associated with Quote Booking Product.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Quote associated with Quote Booking Product.</para>
		...
		/// <para><strong>Description</strong>: The Quote Booking Incident related to this product</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Quote Booking Setup associated with Quote  Booking Product.</para>
		...
		/// <para><strong>Description</strong>: Enter the  unit cost amount. This field is optional.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Status of the Quote Booking Product</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_quotebookingproductOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Quote Booking Product</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_quotebookingproductOptionSets.statuscode"/></para>
