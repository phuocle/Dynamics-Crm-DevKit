...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdynci_PersonalizationActionOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdynci_PersonalizationAction : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdynci_ActionElapsedTime = "msdynci_actionelapsedtime";
			public const string msdynci_ActionElapsedTimeMs = "msdynci_actionelapsedtimems";
			public const string msdynci_ActionElementId = "msdynci_actionelementid";
			public const string msdynci_ActionIsOutbound = "msdynci_actionisoutbound";
			public const string msdynci_ActionName = "msdynci_actionname";
			public const string msdynci_ActionTarget = "msdynci_actiontarget";
			public const string msdynci_ActionType = "msdynci_actiontype";
			public const string msdynci_AlternateKeyReference = "msdynci_alternatekeyreference";
			public const string msdynci_ClickCoordinates = "msdynci_clickcoordinates";
			...
			public const string msdynci_PersonalizationActionId = "msdynci_personalizationactionid";
		...
		public const string EntityLogicalName = "msdynci_personalizationaction";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11479;
		public const string EntityCollectionSchemaName = "msdynci_PersonalizationActions";
		public const string EntityDisplayCollectionName = "PersonalizationActions";
		public const string DisplayName = "PersonalizationAction";
		public const string EntitySetName = "msdynci_personalizationactions";
		public const string EntityLogicalCollectionName = "msdynci_personalizationactions";
		public const string EntityPrimaryIdAttribute = "msdynci_personalizationactionid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdynci_signalid";
		public const string EntitySchemaName = "msdynci_PersonalizationAction";
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(Guid msdynci_PersonalizationActionId)
		{
			Entity = new Entity(EntityLogicalName, msdynci_PersonalizationActionId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationAction"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationAction"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynci_PersonalizationAction(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationAction"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynci_PersonalizationAction(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationAction(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionElapsedTime_Deprecated</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public int? msdynci_ActionElapsedTime
		{
			get { return Entity.GetAttributeValue<int?>(Fields.msdynci_ActionElapsedTime); }
			set { Entity.Attributes[Fields.msdynci_ActionElapsedTime] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionElapsedTimeMs</para>
		/// <para><strong>BigInt</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public long? msdynci_ActionElapsedTimeMs
		{
			get { return Entity.GetAttributeValue<long?>(Fields.msdynci_ActionElapsedTimeMs); }
			set { Entity.Attributes[Fields.msdynci_ActionElapsedTimeMs] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionElementId</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdynci_ActionElementId
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdynci_ActionElementId); }
			set { Entity.Attributes[Fields.msdynci_ActionElementId] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionIsOutbound</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdynci_ActionIsOutbound
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdynci_ActionIsOutbound); }
			set { Entity.Attributes[Fields.msdynci_ActionIsOutbound] = value; }
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdynci_ActionName
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdynci_ActionName); }
			set { Entity.Attributes[Fields.msdynci_ActionName] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionTarget</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 300</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdynci_ActionTarget
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdynci_ActionTarget); }
			set { Entity.Attributes[Fields.msdynci_ActionTarget] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ActionType</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdynci_ActionType
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdynci_ActionType); }
			set { Entity.Attributes[Fields.msdynci_ActionType] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ClickCoordinates</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdynci_ClickCoordinates
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdynci_ClickCoordinates); }
			set { Entity.Attributes[Fields.msdynci_ClickCoordinates] = value; }
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdynci_PersonalizationActionId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdynci_PersonalizationActionId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
