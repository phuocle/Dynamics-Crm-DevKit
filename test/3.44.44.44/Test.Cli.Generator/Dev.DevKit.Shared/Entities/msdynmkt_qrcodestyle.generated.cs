...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets
{
	public enum msdynmkt_emailstatuscode
	{
		/// <summary>
...
{
	[DebuggerNonUserCode()]
	public partial class msdynmkt_qrcodestyle : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdynmkt_emailstatuscode = "msdynmkt_emailstatuscode";
			...
			public const string msdynmkt_qrcodestyleId = "msdynmkt_qrcodestyleid";
		...
		public const string EntityLogicalName = "msdynmkt_qrcodestyle";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11324;
		public const string EntityCollectionSchemaName = "msdynmkt_qrcodestyles";
		public const string EntityDisplayCollectionName = "QR code styles";
		public const string DisplayName = "QR code style";
		public const string EntitySetName = "msdynmkt_qrcodestyles";
		public const string EntityLogicalCollectionName = "msdynmkt_qrcodestyles";
		public const string EntityPrimaryIdAttribute = "msdynmkt_qrcodestyleid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdynmkt_name";
		public const string EntitySchemaName = "msdynmkt_qrcodestyle";
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(Guid msdynmkt_qrcodestyleId)
		{
			Entity = new Entity(EntityLogicalName, msdynmkt_qrcodestyleId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_qrcodestyle"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_qrcodestyle"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_qrcodestyle(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_qrcodestyle"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_qrcodestyle(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdynmkt_qrcodestyle(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Email status code</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.msdynmkt_emailstatuscode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.msdynmkt_emailstatuscode.Draft"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.msdynmkt_emailstatuscode? msdynmkt_emailstatuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdynmkt_emailstatuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.msdynmkt_emailstatuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.msdynmkt_emailstatuscode] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.msdynmkt_emailstatuscode] = null;
			}
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdynmkt_qrcodestyleId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdynmkt_qrcodestyleId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Status of the QR code style</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the QR code style</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_qrcodestyleOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
