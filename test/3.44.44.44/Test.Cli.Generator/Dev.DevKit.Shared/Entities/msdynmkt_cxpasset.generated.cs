...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdynmkt_cxpassetOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdynmkt_cxpasset : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdynmkt_cxpassetId = "msdynmkt_cxpassetid";
		...
		public const string EntityLogicalName = "msdynmkt_cxpasset";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11311;
		public const string EntityCollectionSchemaName = "msdynmkt_cxpassets";
		public const string EntityDisplayCollectionName = "Assets";
		public const string DisplayName = "Asset";
		public const string EntitySetName = "msdynmkt_cxpassets";
		public const string EntityLogicalCollectionName = "msdynmkt_cxpassets";
		public const string EntityPrimaryIdAttribute = "msdynmkt_cxpassetid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdynmkt_name";
		public const string EntitySchemaName = "msdynmkt_cxpasset";
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(Guid msdynmkt_cxpassetId)
		{
			Entity = new Entity(EntityLogicalName, msdynmkt_cxpassetId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_cxpasset"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_cxpasset"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_cxpasset(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_cxpasset"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_cxpasset(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdynmkt_cxpasset(KeyAttributeCollection keys)
		{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdynmkt_cxpassetId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdynmkt_cxpassetId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
