...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class flowmachinenetwork : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: AD domain name</para>
		/// <para><strong>Description</strong>: The DNS name of the Active Directory domain that will be used in hybrid Entra join configurations.</para>
		...
		/// <para><strong>Description</strong>: If provided, the organizational unit (OU) that will be used in hybrid Entra join configurations.</para>
