...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_quotebookingincident : EntityBase
	{
		...
		public const int EntityTypeCode = 11686;
		public const string EntityCollectionSchemaName = "msdyn_quotebookingincidents";
		public const string EntityDisplayCollectionName = "Quote Booking Incidents";
		public const string DisplayName = "Quote Booking Incident";
		public const string EntitySetName = "msdyn_quotebookingincidents";
		public const string EntityLogicalCollectionName = "msdyn_quotebookingincidents";
		public const string EntityPrimaryIdAttribute = "msdyn_quotebookingincidentid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_quotebookingincident";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingincident"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingincident(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingincident"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingincident(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_quotebookingincident(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_quotebookingincident"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_quotebookingincident(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_quotebookingincident(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Enter the description of the incident</para>
		...
		/// <para><strong>Description</strong>: If &quot;yes&quot;, copied  service task, products, and services that are associated with the incident to quote booking setup</para>
		...
		/// <para><strong>Description</strong>: Shows the incident type associated with the quote booking incident.</para>
		...
		/// <para><strong>Description</strong>: Displays name of the quote booking incident</para>
		...
		/// <para><strong>Description</strong>: Shows the quote associated with the agreement booking incident.</para>
		...
		/// <para><strong>Description</strong>: Shows the quote booking setup associated with the quote booking incident.</para>
		...
		/// <para><strong>Description</strong>: Status of the Quote Booking Incident</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_quotebookingincidentOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Quote Booking Incident</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_quotebookingincidentOptionSets.statuscode"/></para>
