...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RoutingRule : EntityBase
	{
		...
		/// <para><strong>Description</strong>: Provide a description about the objective of the routing rule.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Entity (Deprecated)</para>
		/// <para><strong>Description</strong>: Logical name of the entity (deprecated).</para>
		...
		/// <para><strong>Description</strong>: Provide a name for the routing rule.</para>
