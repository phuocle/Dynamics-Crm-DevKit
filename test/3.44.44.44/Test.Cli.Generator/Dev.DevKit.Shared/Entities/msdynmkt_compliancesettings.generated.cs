...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdynmkt_compliancesettings : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdynmkt_compliancesettingsId = "msdynmkt_compliancesettingsid";
			...
			public const string msdynmkt_marketinglogconsentchangesswitch = "msdynmkt_marketinglogconsentchangesswitch";
			public const string msdynmkt_marketingrespectconsentswitch = "msdynmkt_marketingrespectconsentswitch";
		...
		public const string EntityLogicalName = "msdynmkt_compliancesettings";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11265;
		public const string EntityCollectionSchemaName = "msdynmkt_compliancesettingses";
		...
		public const string EntitySetName = "msdynmkt_compliancesettingses";
		public const string EntityLogicalCollectionName = "msdynmkt_compliancesettingses";
		public const string EntityPrimaryIdAttribute = "msdynmkt_compliancesettingsid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdynmkt_name";
		public const string EntitySchemaName = "msdynmkt_compliancesettings";
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(Guid msdynmkt_compliancesettingsId)
		{
			Entity = new Entity(EntityLogicalName, msdynmkt_compliancesettingsId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_compliancesettings"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_compliancesettings"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_compliancesettings(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdynmkt_compliancesettings"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynmkt_compliancesettings(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdynmkt_compliancesettings(KeyAttributeCollection keys)
		{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdynmkt_compliancesettingsId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdynmkt_compliancesettingsId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentlinktype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentlinktype.Preference_page"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentlinktype? msdynmkt_consentlinktype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdynmkt_consentlinktype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentlinktype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentmodel"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentmodel.Restrictive"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentmodel? msdynmkt_consentmodel
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdynmkt_consentmodel);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_consentmodel)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_jurisdiction"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_jurisdiction? msdynmkt_jurisdiction
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdynmkt_jurisdiction);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.msdynmkt_jurisdiction)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Marketing Log Consent Changes Switch</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdynmkt_marketinglogconsentchangesswitch
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdynmkt_marketinglogconsentchangesswitch); }
			set { Entity.Attributes[Fields.msdynmkt_marketinglogconsentchangesswitch] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Marketing Respect Consent Switch</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdynmkt_marketingrespectconsentswitch
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdynmkt_marketingrespectconsentswitch); }
			set { Entity.Attributes[Fields.msdynmkt_marketingrespectconsentswitch] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdynmkt_compliancesettingsOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
