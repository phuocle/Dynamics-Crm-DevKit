...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_ConversationSignal : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_ActualText = "msdyn_actualtext";
			...
			public const string msdyn_ConversationSignalId = "msdyn_conversationsignalid";
		...
		public const string EntityLogicalName = "msdyn_conversationsignal";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 10775;
		public const string EntityCollectionSchemaName = "msdyn_ConversationSignals";
		public const string EntityDisplayCollectionName = "Conversation Signals";
		public const string DisplayName = "Conversation Signal";
		public const string EntitySetName = "msdyn_conversationsignals";
		public const string EntityLogicalCollectionName = "msdyn_conversationsignals";
		public const string EntityPrimaryIdAttribute = "msdyn_conversationsignalid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_ConversationSignal";
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(Guid msdyn_ConversationSignalId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_ConversationSignalId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ConversationSignal"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ConversationSignal"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ConversationSignal(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ConversationSignal"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ConversationSignal(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_ConversationSignal(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ActualText</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 4,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_ActualText
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_ActualText); }
			set { Entity.Attributes[Fields.msdyn_ActualText] = value; }
		}
		/// <summary>
		...
		public Guid msdyn_ConversationSignalId
		{
			...
			set
			{
				Entity.Attributes[Fields.msdyn_ConversationSignalId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.msdyn_Locale"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.msdyn_Locale? msdyn_Locale
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_Locale);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.msdyn_Locale)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Status of the Conversation Signal</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Conversation Signal</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ConversationSignalOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
