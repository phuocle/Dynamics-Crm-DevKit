...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_conversationactionlocale : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "msdyn_conversationactionlocales";
		public const string EntityDisplayCollectionName = "Conversation Action Locale";
		public const string DisplayName = "Conversation Action Locale";
		public const string EntitySetName = "msdyn_conversationactionlocales";
		public const string EntityLogicalCollectionName = "msdyn_conversationactionlocales";
		public const string EntityPrimaryIdAttribute = "msdyn_conversationactionlocaleid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_conversationactionlocale";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_conversationactionlocale"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_conversationactionlocale(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_conversationactionlocale"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_conversationactionlocale(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_conversationactionlocale(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_conversationactionlocale"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_conversationactionlocale(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_conversationactionlocale(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Conversation Action key</para>
		/// <para><strong>Description</strong>: Conversation action Id</para>
		/// <para>Required - <strong>Lookup</strong>: <see cref="msdyn_conversationaction"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Label string for conversation action button</para>
		...
		/// <para><strong>Description</strong>: Locale code for conversation action UI strings</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_conversationactionlocaleOptionSets.msdyn_Locale_picklist"/></para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Slash Commands</para>
		/// <para><strong>Description</strong>: Slash commad string for conversation action button</para>
		...
		/// <para><strong>Description</strong>: Tooltip for Conversation Action</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Status of the Conversation Action Locale</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_conversationactionlocaleOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Conversation Action Locale</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_conversationactionlocaleOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
