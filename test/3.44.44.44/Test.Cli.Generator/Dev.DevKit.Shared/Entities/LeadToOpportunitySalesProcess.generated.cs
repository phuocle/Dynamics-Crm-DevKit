...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class LeadToOpportunitySalesProcess : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "LeadToOpportunitySalesProcesses";
		public const string EntityDisplayCollectionName = "Lead To Opportunity Sales Process";
		public const string DisplayName = "Lead To Opportunity Sales Process";
		...
		/// <summary>
		/// Instance new late bound class <see cref="LeadToOpportunitySalesProcess"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public LeadToOpportunitySalesProcess(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="LeadToOpportunitySalesProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public LeadToOpportunitySalesProcess(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new LeadToOpportunitySalesProcess(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="LeadToOpportunitySalesProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public LeadToOpportunitySalesProcess(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new LeadToOpportunitySalesProcess(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Lead To Opportunity Sales Process Instance Id</para>
		/// <para><strong>Description</strong>: Unique identifier for Lead To Opportunity Sales Process bpf entity instances</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.LeadToOpportunitySalesProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
