...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.BulkOperationOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Create Activities</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Create_Activities = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: Create Opportunities</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Create_Opportunities = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Distribute</para>
		/// <para><strong>Value</strong>: 4</para>
		/// </summary>
		Distribute = 4,
		/// <summary>
		/// <para><strong>Display Name</strong>: Execute</para>
		/// <para><strong>Value</strong>: 5</para>
		/// </summary>
		Execute = 5,
		/// <summary>
		...
		Quick_Campaign = 7,
		/// <summary>
		/// <para><strong>Display Name</strong>: Send Direct Mail</para>
		/// <para><strong>Value</strong>: 3</para>
		/// </summary>
		Send_Direct_Mail = 3
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class BulkOperation : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "BulkOperations";
		public const string EntityDisplayCollectionName = "Quick Campaigns";
		public const string DisplayName = "Quick Campaign";
		...
		/// <summary>
		/// Instance new late bound class <see cref="BulkOperation"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public BulkOperation(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="BulkOperation"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public BulkOperation(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new BulkOperation(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="BulkOperation"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public BulkOperation(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new BulkOperation(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Unique identifier of the bulk operation.</para>
		...
		/// <para><strong>Description</strong>: Actual duration of the bulk operation in minutes.</para>
		...
		/// <para><strong>Description</strong>: Shows the date and time when the quick campaign was completed or canceled.</para>
		...
		/// <para><strong>Description</strong>: Shows the date and time when the activity was started or created.</para>
		...
		/// <para><strong>Description</strong>: Shows the number for the quick campaign record, used to identify the quick campaign.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 32</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who created the bulk operation.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Activity Type</para>
		/// <para><strong>Description</strong>: Choose the activity to create that determines how target prospects or customers in this quick campaign are contacted.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.CreatedRecordTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.CreatedRecordTypeCode.Phone_Call"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.CreatedRecordTypeCode? CreatedRecordTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CreatedRecordTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.CreatedRecordTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.DeliveryPriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type additional information to describe the quick campaign, such as the products or services offered.</para>
		...
		/// <para><strong>Description</strong>: Shows the error code that is used to troubleshoot issues in the quick campaign.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: No. of Failures</para>
		/// <para><strong>Description</strong>: Number of records which failed in the bulk operation.</para>
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Specifies if the bulk operation was created from a workflow rule.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Date and time when the bulk operation was last modified.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who last modified the bulk operation.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Select the type of bulk operation process, such as quick campaign or campaign activity distribution.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.OperationTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.OperationTypeCode.Create_Opportunities"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.OperationTypeCode? OperationTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.OperationTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameters</para>
		/// <para><strong>Description</strong>: XML string that contains the parameters to the bulk operation.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Import File Name</para>
		/// <para><strong>Description</strong>: Choose the campaign from which the campaign activities were bulk-distributed.</para>
		/// <para><strong>Lookup</strong>: <see cref="campaignactivity"/>, <see cref="list"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Scheduled duration of the bulk operation, specified in minutes.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Scheduled end date and time of the bulk operation.</para>
		...
		/// <para><strong>Description</strong>: Scheduled start date and time of the bulk operation.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows whether the quick campaign is open, closed, or canceled.  Closed or canceled quick campaigns are read-only and can&apos;t be edited.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StateCode)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Status Reason</para>
		/// <para><strong>Description</strong>: Select the quick campaign&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type a short description about the objective or primary topic of the quick campaign.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: No. of Successes</para>
		/// <para><strong>Description</strong>: Number of records which succeeded in the bulk operation.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Members Type</para>
		/// <para><strong>Description</strong>: Select the type of records targeted in the quick campaign to identify the target audience.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.TargetedRecordTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.BulkOperationOptionSets.TargetedRecordTypeCode.Account"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.BulkOperationOptionSets.TargetedRecordTypeCode? TargetedRecordTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TargetedRecordTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.BulkOperationOptionSets.TargetedRecordTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Total Members</para>
		/// <para><strong>Description</strong>: Number of members to target.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Workflow information</para>
		/// <para><strong>Description</strong>: Information for bulk operation workflow.</para>
