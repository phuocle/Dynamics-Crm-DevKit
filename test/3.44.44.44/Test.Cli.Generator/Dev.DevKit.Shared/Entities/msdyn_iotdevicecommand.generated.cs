...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_iotdevicecommand : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "msdyn_iotdevicecommands";
		public const string EntityDisplayCollectionName = "IoT Device Commands";
		public const string DisplayName = "IoT Device Command";
		public const string EntitySetName = "msdyn_iotdevicecommands";
		public const string EntityLogicalCollectionName = "msdyn_iotdevicecommands";
		public const string EntityPrimaryIdAttribute = "msdyn_iotdevicecommandid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_iotdevicecommand";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_iotdevicecommand"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_iotdevicecommand(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_iotdevicecommand"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_iotdevicecommand(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_iotdevicecommand(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_iotdevicecommand"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_iotdevicecommand(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_iotdevicecommand(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Command</para>
		/// <para><strong>Description</strong>: This optional field denotes the command definition that is used to construct the command string.</para>
		/// <para><strong>Lookup</strong>: <see cref="msdyn_iotdevicecommanddefinition"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Command Status</para>
		/// <para><strong>Description</strong>: Describes the status of the command. If this stays at &quot;In Progress&quot; for a long time, verify the IoT endpoint configuration.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_iotdevicecommandOptionSets.msdyn_CommandStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_iotdevicecommandOptionSets.msdyn_CommandStatus.In_Progress"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Command Status Reason</para>
		/// <para><strong>Description</strong>: A reason field that explains the command status.</para>
		...
		/// <para><strong>Description</strong>: The command will be sent to a device connected to this asset.</para>
		...
		/// <para><strong>Description</strong>: IoT device to send the message to.</para>
		...
		/// <para><strong>Description</strong>: The ID of the IoT device to send the message to.</para>
		...
		/// <para><strong>Description</strong>: Message to send to the IoT device. E.g.: A Json string.</para>
		...
		/// <para><strong>Description</strong>: Reference to a primary alert in response to which the message is being sent.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Send To All Connected Devices</para>
		/// <para><strong>Description</strong>: Yes, if a copy of the command should be sent to all registered devices connected under the parent entity of the selected device. No, if this command needs to be sent only to the selected device.</para>
		...
		/// <para><strong>Description</strong>: Status of the IoT Device Command</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_iotdevicecommandOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the IoT Device Command</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_iotdevicecommandOptionSets.statuscode"/></para>
