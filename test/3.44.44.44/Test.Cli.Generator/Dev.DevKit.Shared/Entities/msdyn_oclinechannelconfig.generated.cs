...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_oclinechannelconfig : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_channelaccesstoken = "msdyn_channelaccesstoken";
			public const string msdyn_channelid = "msdyn_channelid";
			public const string msdyn_channelsecret = "msdyn_channelsecret";
			...
			public const string msdyn_webhookurl = "msdyn_webhookurl";
		...
		public const string EntityCollectionSchemaName = "msdyn_oclinechannelconfigs";
		public const string EntityDisplayCollectionName = "LINE accounts";
		public const string DisplayName = "LINE account";
		public const string EntitySetName = "msdyn_oclinechannelconfigs";
		public const string EntityLogicalCollectionName = "msdyn_oclinechannelconfigs";
		public const string EntityPrimaryIdAttribute = "msdyn_oclinechannelconfigid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_oclinechannelconfig";
		[DebuggerNonUserCode()]
		...
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(Guid msdyn_oclinechannelconfigId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_oclinechannelconfigId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_oclinechannelconfig"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_oclinechannelconfig"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_oclinechannelconfig(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_oclinechannelconfig"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_oclinechannelconfig(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_oclinechannelconfig(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Channel Access Token</para>
		/// <para><strong>Description</strong>: Channel Access Token is of Line Channel</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 1,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_channelaccesstoken
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_channelaccesstoken); }
			set { Entity.Attributes[Fields.msdyn_channelaccesstoken] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Channel ID</para>
		/// <para><strong>Description</strong>: Channel ID of Line Channel</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Channel Secret</para>
		/// <para><strong>Description</strong>: Channel secret of the Line Channel</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 225</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_channelsecret
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_channelsecret); }
			set { Entity.Attributes[Fields.msdyn_channelsecret] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Line Channel identifies Line Channel</para>
		/// <para><strong>Description</strong>: Unique identifier for entity instances</para>
		/// <para><strong>Primary Key</strong>: <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdyn_oclinechannelconfigId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdyn_oclinechannelconfigId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: LINE account language</para>
		/// <para><strong>Description</strong>: The language setting for the LINE account</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyBotSurveyMode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyBotSurveyMode? msdyn_PostConversationSurveyBotSurveyMode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_PostConversationSurveyBotSurveyMode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyBotSurveyMode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Display Name</strong>: Survey Mode</para>
		/// <para><strong>Description</strong>: Mode of the survey to be sent</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyMode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyMode? msdyn_PostConversationSurveyMode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_PostConversationSurveyMode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.msdyn_PostConversationSurveyMode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Webhook URL</para>
		/// <para><strong>Description</strong>: Webhook URL of Line Channel</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 500</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_webhookurl
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_webhookurl); }
			set { Entity.Attributes[Fields.msdyn_webhookurl] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Line Channel</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_oclinechannelconfigOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
