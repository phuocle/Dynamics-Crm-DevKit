...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets
{
	public enum msdyncrm_email_contentlanguage
	{
		/// <summary>
...
{
	[DebuggerNonUserCode()]
	public partial class msdyncrm_marketingemail : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyncrm_ClickMap = "msdyncrm_clickmap";
			public const string msdyncrm_contentsettingscompanyaddress = "msdyncrm_contentsettingscompanyaddress";
			...
			public const string msdyncrm_email_contentlanguage = "msdyncrm_email_contentlanguage";
			...
			public const string msdyncrm_FromUser = "msdyncrm_fromuser";
			public const string msdyncrm_insights_placeholder = "msdyncrm_insights_placeholder";
			public const string msdyncrm_Istemplategalleryneeded = "msdyncrm_istemplategalleryneeded";
			...
			public const string msdyncrm_TemplateId = "msdyncrm_templateid";
			public const string msdyncrm_testconfiguration = "msdyncrm_testconfiguration";
			public const string msdyncrm_textpart = "msdyncrm_textpart";
			public const string msdyncrm_To = "msdyncrm_to";
			public const string msdyncrm_uicentityid = "msdyncrm_uicentityid";
		...
		public const string EntityLogicalName = "msdyncrm_marketingemail";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11158;
		public const string EntityCollectionSchemaName = "msdyncrm_marketingemails";
		public const string EntityDisplayCollectionName = "Marketing emails";
		public const string DisplayName = "Marketing email";
		public const string EntitySetName = "msdyncrm_marketingemails";
		public const string EntityLogicalCollectionName = "msdyncrm_marketingemails";
		public const string EntityPrimaryIdAttribute = "msdyncrm_marketingemailid";
		public const string EntityPrimaryImageAttribute = "entityimage";
		public const string EntityPrimaryNameAttribute = "msdyncrm_name";
		public const string EntitySchemaName = "msdyncrm_marketingemail";
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(Guid msdyncrm_marketingemailId)
		{
			Entity = new Entity(EntityLogicalName, msdyncrm_marketingemailId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_marketingemail"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_marketingemail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_marketingemail(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_marketingemail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_marketingemail(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyncrm_marketingemail(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Automatically generate plain text</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Click map</para>
		/// <para><strong>Multiple Lines of Text</strong> - <strong>MaxLength</strong>: 1,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_ClickMap
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_ClickMap); }
			set { Entity.Attributes[Fields.msdyncrm_ClickMap] = value; }
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_contentsettingscompanyaddress
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_contentsettingscompanyaddress); }
			set { Entity.Attributes[Fields.msdyncrm_contentsettingscompanyaddress] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: The language to be used for email content.</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contentlanguage"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contentlanguage.English"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contentlanguage? msdyncrm_email_contentlanguage
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_email_contentlanguage);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contentlanguage)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.msdyncrm_email_contentlanguage] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.msdyncrm_email_contentlanguage] = null;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Content type</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contenttype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contenttype.Default"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contenttype? msdyncrm_email_contenttype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_email_contenttype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_email_contenttype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: The body of the email</para>
		/// <para><strong>Multiple Lines of Text</strong> - <strong>MaxLength</strong>: 1,048,576</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Email from address</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Email from name</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 500</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: From user</para>
		/// <para><strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyncrm_FromUser
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyncrm_FromUser); }
			set { Entity.Attributes[Fields.msdyncrm_FromUser] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Is template gallery needed</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdyncrm_Istemplategalleryneeded
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdyncrm_Istemplategalleryneeded); }
			set { Entity.Attributes[Fields.msdyncrm_Istemplategalleryneeded] = value; }
		}
		/// <summary>
		...
		public Guid msdyncrm_marketingemailId
		{
			...
			set
			{
				Entity.Attributes[Fields.msdyncrm_marketingemailId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Legal designation</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_messagedesignation"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_messagedesignation.Commercial"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_messagedesignation? msdyncrm_messagedesignation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_messagedesignation);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.msdyncrm_messagedesignation)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: The preview (pre-header) text for marketing email</para>
		...
		/// <para><strong>Description</strong>: The subject of the marketing email</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 256</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Lookup</strong>: <see cref="msdyncrm_marketingemailtemplate"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyncrm_TemplateId
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyncrm_TemplateId); }
			set { Entity.Attributes[Fields.msdyncrm_TemplateId] = value; }
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_testconfiguration
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_testconfiguration); }
			set { Entity.Attributes[Fields.msdyncrm_testconfiguration] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: UIC entity ID</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_uicentityid
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_uicentityid); }
			set { Entity.Attributes[Fields.msdyncrm_uicentityid] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Status of the marketing email</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Marketing email status reason</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_marketingemailOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
