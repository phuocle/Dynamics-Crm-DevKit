...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.LeadAddressOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class LeadAddress : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "LeadAddresses";
		public const string EntityDisplayCollectionName = "Lead Addresses";
		public const string DisplayName = "Lead Address";
		public const string EntitySetName = "leadaddresses";
		public const string EntityLogicalCollectionName = "leadaddresses";
		public const string EntityPrimaryIdAttribute = "leadaddressid";
		...
		[DebuggerNonUserCode()]
		public LeadAddress(Guid LeadAddressId)
		{
			Entity = new Entity(EntityLogicalName, LeadAddressId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public LeadAddress(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="LeadAddress"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public LeadAddress(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="LeadAddress"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public LeadAddress(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new LeadAddress(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="LeadAddress"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public LeadAddress(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new LeadAddress(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public LeadAddress(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>Description</strong>: Information about the address for the lead.</para>
		...
		/// <para><strong>Description</strong>: City name in the address for the lead.</para>
		...
		/// <para><strong>Description</strong>: Country/region name in the address for the lead.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 80</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: County name in the address for the lead.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the user who created the lead address.</para>
		...
		/// <para><strong>Description</strong>: Date and time when the lead address was created.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who created the leadaddress.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Exchange rate for the currency associated with the leadaddress with respect to the base currency.</para>
		...
		/// <para><strong>Description</strong>: Fax number for the address for the lead.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string Fax
		...
		/// <para><strong>Description</strong>: Latitude for the address for the lead.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Address</para>
		/// <para><strong>Description</strong>: Unique identifier of the lead address.</para>
		...
		public Guid LeadAddressId
		{
			...
			set
			{
				Entity.Attributes[Fields.LeadAddressId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Longitude for the address for the lead.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the user who last modified the lead address.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Date and time when the lead address was last modified.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who last modified the leadaddress.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Name used to identify the lead address.</para>
		...
		public Guid? OwnerId
		{
			get { return Entity.GetAttributeValue<Guid?>(Fields.OwnerId); }
		}
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		...
		/// <para><strong>Description</strong>: Unique identifier of the parent object with which the lead address is associated.</para>
		...
		/// <para><strong>Description</strong>: ZIP Code or postal code in the address for the lead.</para>
		...
		/// <para><strong>Description</strong>: Post office box number in the address for the lead.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 20</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: State or province in the address for the lead.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: First telephone number for the lead address.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Second telephone number for the lead address.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Third telephone number for the lead address.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the currency associated with the leadaddress.</para>
		...
		/// <para><strong>Description</strong>: United Parcel Service (UPS) zone for the address of the lead.</para>
		...
		/// <para><strong>Description</strong>: UTC offset for the lead address. This is the difference between local time and standard Coordinated Universal Time.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
