...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_ocfbpage : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_enablehumanagenttag = "msdyn_enablehumanagenttag";
			public const string msdyn_fbpageaccesstoken = "msdyn_fbpageaccesstoken";
			public const string msdyn_fbpageid = "msdyn_fbpageid";
			public const string msdyn_fbpagename = "msdyn_fbpagename";
		...
		public const string EntityLogicalName = "msdyn_ocfbpage";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11047;
		public const string EntityCollectionSchemaName = "msdyn_ocfbpages";
		public const string EntityDisplayCollectionName = "Facebook Pages";
		public const string DisplayName = "Facebook Page";
		public const string EntitySetName = "msdyn_ocfbpages";
		public const string EntityLogicalCollectionName = "msdyn_ocfbpages";
		public const string EntityPrimaryIdAttribute = "msdyn_ocfbpageid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_fbpagename";
		public const string EntitySchemaName = "msdyn_ocfbpage";
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(Guid msdyn_ocfbpageId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_ocfbpageId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocfbpage"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocfbpage"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocfbpage(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocfbpage"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocfbpage(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_ocfbpage(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Turn on your Facebook human agent message tag</para>
		/// <para><strong>Description</strong>: Turn on your Facebook human agent message tag</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdyn_enablehumanagenttag
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdyn_enablehumanagenttag); }
			set { Entity.Attributes[Fields.msdyn_enablehumanagenttag] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Page Access Token</para>
		/// <para><strong>Description</strong>: Access token for the Facebook page</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 500</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_fbpageaccesstoken
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_fbpageaccesstoken); }
			set { Entity.Attributes[Fields.msdyn_fbpageaccesstoken] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Page Id</para>
		/// <para><strong>Description</strong>: Page id of the Facebook page</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_fbpageid
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_fbpageid); }
			set { Entity.Attributes[Fields.msdyn_fbpageid] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Name</para>
		/// <para><strong>Description</strong>: The name of the Facebook page</para>
		/// <para><strong>Primary Name</strong>: Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_fbpagename
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_fbpagename); }
			set { Entity.Attributes[Fields.msdyn_fbpagename] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Work Stream</para>
		/// <para><strong>Description</strong>: Unique identifier for Work Stream associated with Facebook page</para>
		...
		/// <para>Required - <strong>Lookup</strong>: <see cref="msdyn_ocfbapplication"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdyn_ocfbpageId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdyn_ocfbpageId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Facebook page language</para>
		/// <para><strong>Description</strong>: The language setting for the Facebook page</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyBotSurveyMode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyBotSurveyMode? msdyn_PostConversationSurveyBotSurveyMode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_PostConversationSurveyBotSurveyMode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyBotSurveyMode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Display Name</strong>: Survey Mode</para>
		/// <para><strong>Description</strong>: Mode of the survey to be sent</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyMode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyMode? msdyn_PostConversationSurveyMode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_PostConversationSurveyMode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.msdyn_PostConversationSurveyMode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Status of the Facebook Page</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Facebook Page</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocfbpageOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
