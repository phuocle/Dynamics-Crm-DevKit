...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class PhoneToCaseProcess : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "PhoneToCaseProcesses";
		public const string EntityDisplayCollectionName = "Phone To Case Process";
		public const string DisplayName = "Phone To Case Process";
		public const string EntitySetName = "phonetocaseprocesses";
		public const string EntityLogicalCollectionName = "phonetocaseprocesses";
		...
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(Guid PhoneToCaseProcessId)
		{
			Entity = new Entity(EntityLogicalName, PhoneToCaseProcessId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="PhoneToCaseProcess"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="PhoneToCaseProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new PhoneToCaseProcess(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="PhoneToCaseProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new PhoneToCaseProcess(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public PhoneToCaseProcess(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phone To Case Process Instance Id</para>
		/// <para><strong>Description</strong>: Unique identifier for Phone To Case Process bpf entity instances</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.PhoneToCaseProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
