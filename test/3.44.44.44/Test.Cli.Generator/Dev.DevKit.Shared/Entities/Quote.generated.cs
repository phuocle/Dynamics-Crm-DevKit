...
namespace Dev.DevKit.Shared.Entities.QuoteOptionSets
{
	...
	public enum StatusCode
	{
		...
		Open = 3,
		/// <summary>
		/// <para><strong>Display Name</strong>: Revised</para>
		/// <para><strong>Value</strong>: 7</para>
		/// <para><strong>StateCode.Closed</strong></para>
		/// </summary>
		Revised = 7,
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class Quote : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "Quotes";
		public const string EntityDisplayCollectionName = "Quotes";
		...
		public const string EntityPrimaryIdAttribute = "quoteid";
		...
		/// <summary>
		/// Instance new late bound class <see cref="Quote"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public Quote(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="Quote"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public Quote(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new Quote(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="Quote"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public Quote(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new Quote(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Unique identifier of the account with which the quote is associated.</para>
		...
		/// <para><strong>Description</strong>: Enter the date when the quote was closed to indicate the expiration, revision, or cancellation date.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the contact associated with the quote.</para>
		...
		/// <para><strong>Description</strong>: Type additional information to describe the quote, such as the products or services offered or details about the customer&apos;s product preferences.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quote Discount Amount</para>
		/// <para><strong>Description</strong>: Type the discount amount for the quote if the customer is eligible for special savings.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quote Discount Amount (Base)</para>
		/// <para><strong>Description</strong>: Value of the Quote Discount Amount in base currency.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quote Discount (%)</para>
		/// <para><strong>Description</strong>: Type the discount rate that should be applied to the Detail Amount field to include additional savings for the customer in the quote.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Effective from</para>
		/// <para><strong>Description</strong>: Enter the date when the quote pricing is effective or was first communicated to the customer.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Effective to</para>
		/// <para><strong>Description</strong>: Enter the expiration date or last day the quote pricing is effective for the customer.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Due By</para>
		/// <para><strong>Description</strong>: Enter the date a decision or order is due from the customer to indicate the expiration date of the quote.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: DateOnly - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the cost of freight or shipping for the products included in the quote for use in calculating the Total Amount field.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.FreightTermsCode"/></para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Potential Customer</para>
		/// <para><strong>Description</strong>: Customer Account associated with this Quote</para>
		...
		/// <para><strong>Description</strong>: The estimated cost of this quote</para>
		...
		/// <para><strong>Description</strong>: Estimated Margin of this quote</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Invoice Setup Totals</para>
		/// <para><strong>Description</strong>: The totals of all assigned Invoice Setups</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Invoice Setup Totals (Base)</para>
		/// <para><strong>Description</strong>: Value of the Invoice Setup Totals in base currency.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.msdyn_OrderType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.msdyn_OrderType.Item_based"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Latest Quote Line End Date</para>
		/// <para><strong>Description</strong>: The latest end date of all associated quote lines</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Earliest Quote Line Start Date</para>
		/// <para><strong>Description</strong>: The earliest Start Date of all Quote Lines that are associated to this quote</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: TotalAmount</para>
		/// <para><strong>ReadOnly</strong> - <strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// <para><strong>Calculated Field</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: TotalAmount (Base)</para>
		/// <para><strong>Description</strong>: Value of the TotalAmount in base currency.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// <para><strong>Calculated Field</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a descriptive name for the quote.</para>
		...
		/// <para><strong>Description</strong>: Shows the duration in minutes for which the quote was on hold.</para>
		...
		/// <para><strong>Description</strong>: Choose the opportunity that the quote is related to for reporting and analytics.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.PaymentTermsCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Pricing error for the quote.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.PricingErrorCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.PricingErrorCode.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.QuoteCreationMethod"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.QuoteCreationMethod.Unknown"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.QuoteOptionSets.QuoteCreationMethod? QuoteCreationMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.QuoteCreationMethod);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.QuoteOptionSets.QuoteCreationMethod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Unique identifier of the quote.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Quote ID</para>
		/// <para><strong>Description</strong>: Shows the quote number for customer reference and searching capabilities. The number cannot be modified.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Enter the delivery date requested by the customer for all products in the quote.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Revision ID</para>
		/// <para><strong>Description</strong>: Shows the version number of the quote for revision history tracking.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.ShippingMethodCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.ShipTo_FreightTermsCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.SkipPriceCalculation"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.SkipPriceCalculation.DoPriceCalcAlways"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Choose the service level agreement (SLA) that you want to apply to the quote record.</para>
		...
		/// <para><strong>Description</strong>: Last SLA that was applied to this quote. This field is for internal use only.</para>
		...
		/// <para><strong>Description</strong>: Shows whether the quote is draft, active, won, or closed. Only draft quotes can be edited.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.StateCode.Draft"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Select the quote&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.QuoteOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the total amount due, calculated as the sum of the products, discounts, freight, and taxes for the quote.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the total product amount for the quote, minus any discounts. This value is added to freight and tax amounts in the calculation for the total amount due for the quote.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the total discount amount, based on the discount price and rate entered on the quote.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the sum of all existing and write-in products included on the quote, based on the specified price list and quantities.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the total of the Manual Discount amounts specified on all products included in the quote. This value is reflected in the Detail Amount field on the quote and is added to any discount amount or rate specified on the quote</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows the total of the Tax amounts specified on all products included in the quote, included in the Total Amount due calculation for the quote.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>: -922,337,203,685,477 - <strong>MaxValue</strong>: 922,337,203,685,477</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Unique Dsc ID</para>
		/// <para><strong>Description</strong>: For internal use only.</para>
		...
		/// <para><strong>Description</strong>: Select whether the products included in the quote should be shipped to the specified address or held until the customer calls with further pick up or delivery instructions.</para>
