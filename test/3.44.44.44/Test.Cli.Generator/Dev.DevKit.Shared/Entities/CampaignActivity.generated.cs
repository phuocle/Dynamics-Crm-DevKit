...
namespace Dev.DevKit.Shared.Entities.CampaignActivityOptionSets
{
	...
	public enum ChannelTypeCode
	{
		...
		Email = 7,
		/// <summary>
		/// <para><strong>Display Name</strong>: Email via Mail Merge(deprecated)</para>
		...
		Fax = 5,
		/// <summary>
		/// <para><strong>Display Name</strong>: Fax via Mail Merge(deprecated)</para>
		...
		Letter = 3,
		/// <summary>
		/// <para><strong>Display Name</strong>: Letter via Mail Merge(deprecated)</para>
	...
	public enum StatusCode
	{
		...
		Proposed = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: System Aborted</para>
		/// <para><strong>Value</strong>: 5</para>
		/// <para><strong>StateCode.Open</strong></para>
		/// </summary>
		System_Aborted = 5
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Content Distribution</para>
		/// <para><strong>Value</strong>: 5</para>
		/// </summary>
		Content_Distribution = 5,
		/// <summary>
		/// <para><strong>Display Name</strong>: Content Preparation</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Content_Preparation = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: Direct Follow-Up Contact</para>
		/// <para><strong>Value</strong>: 7</para>
		/// </summary>
		Direct_Follow_Up_Contact = 7,
		/// <summary>
		/// <para><strong>Display Name</strong>: Direct Initial Contact</para>
		/// <para><strong>Value</strong>: 6</para>
		/// </summary>
		Direct_Initial_Contact = 6,
		/// <summary>
		/// <para><strong>Display Name</strong>: Lead Qualification</para>
		/// <para><strong>Value</strong>: 4</para>
		/// </summary>
		Lead_Qualification = 4,
		/// <summary>
		/// <para><strong>Display Name</strong>: Reminder Distribution</para>
		/// <para><strong>Value</strong>: 8</para>
		/// </summary>
		...
		Research = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Target Marketing List Creation</para>
		/// <para><strong>Value</strong>: 3</para>
		/// </summary>
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class CampaignActivity : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "CampaignActivities";
		public const string EntityDisplayCollectionName = "Campaign Activities";
		public const string DisplayName = "Campaign Activity";
		...
		/// <summary>
		/// Instance new late bound class <see cref="CampaignActivity"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public CampaignActivity(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="CampaignActivity"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public CampaignActivity(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new CampaignActivity(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="CampaignActivity"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public CampaignActivity(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new CampaignActivity(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Campaign Activity</para>
		/// <para><strong>Description</strong>: Unique identifier of the campaign activity.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Actual Cost</para>
		/// <para><strong>Description</strong>: Type the actual cost of the campaign activity. The value entered is rolled up to the related campaign in the total cost calculations.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Actual Cost (Base)</para>
		/// <para><strong>Description</strong>: Value of the Actual Cost in base currency.</para>
		...
		/// <para><strong>Description</strong>: Shows the value selected in the Duration field on the campaign activity. The duration is used to report the time spent on the activity.</para>
		...
		/// <para><strong>Description</strong>: Enter the date when the campaign activity was actually  completed.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual start date and time for the campaign activity to determine if the campaign activity started on the scheduled time.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the allocated budget of the campaign activity for estimated versus actual cost reporting.</para>
		/// <para><strong>Currency</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a category to identify the campaign activity type, such as new business development or customer retention, to tie the campaign activity to a business group or function.</para>
		...
		/// <para><strong>Description</strong>: Select how communications for this activity will be sent, such as phone, letter, fax, or email.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.ChannelTypeCode"/></para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.DeliveryPriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type additional information to describe the campaign activity, such as key talking points, objectives, or details about the target audience.</para>
		...
		/// <para><strong>Description</strong>: Select whether to override the opt-out settings on leads, contacts, and accounts for the members of the target marketing lists of the campaign activity. If No is selected, marketing materials will be sent to members who have opted out.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: No. of Days</para>
		/// <para><strong>Description</strong>: Limits the frequency (in days) of marketing activities directed at any contact. Contacts that have been contacted more recently than this will be excluded from new campaign activity distributions. Enter a value of zero to disable the limit.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Ignore Inactive Marketing List Members</para>
		/// <para><strong>Description</strong>: Select whether inactive marketing list members will be excluded from the campaign activity distribution.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Yes</strong>]: true</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Information regarding whether the campaign activity was billed as part of resolving a case.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		...
		/// <para><strong>Description</strong>: Information about whether the campaign activity is created by a workflow rule.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Choose the parent campaign so that the campaign activity costs reflect in the correct campaign for reporting.</para>
		/// <para>Required - <strong>Lookup</strong>: <see cref="campaign"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Scheduled duration, specified in minutes, of the campaign activity.</para>
		...
		/// <para><strong>Description</strong>: Enter the expected due date and time for the activity to be completed to provide details about the timing of the campaign activity.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Enter the expected start date and time for the activity to provide details about timing of the campaign activity.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows whether the campaign activity is open, completed, or canceled. Completed and canceled campaign activities are read-only and can&apos;t be edited.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Select the campaign activity&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a subcategory to identify the campaign activity type and relate the activity to a specific product, sales region, business group, or other function.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a short description about the objective or primary topic of the campaign activity.</para>
		...
		/// <para><strong>Description</strong>: Select the type of campaign activity to indicate the purpose of the activity.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.TypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignActivityOptionSets.TypeCode.Research"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
