...
namespace Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Many</para>
		/// <para><strong>Value</strong>: 387,300,001</para>
		/// </summary>
		Many = 387_300_001,
		/// <summary>
		/// <para><strong>Display Name</strong>: One</para>
		/// <para><strong>Value</strong>: 387,300,000</para>
		/// </summary>
		One = 387_300_000
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_applicationextension : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "msdyn_applicationextensions";
		public const string EntityDisplayCollectionName = "Application Extensions";
		public const string DisplayName = "Application Extension";
		public const string EntitySetName = "msdyn_applicationextensions";
		public const string EntityLogicalCollectionName = "msdyn_applicationextensions";
		public const string EntityPrimaryIdAttribute = "msdyn_applicationextensionid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_applicationextension";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_applicationextension"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_applicationextension(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_applicationextension"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_applicationextension(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_applicationextension(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_applicationextension"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_applicationextension(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_applicationextension(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.ComponentState"/></para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Relationship Cardinality</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.msdyn_relationship_cardinality"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.msdyn_relationship_cardinality.Many"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.msdyn_type"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.msdyn_type.Custom"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Webresource Url</para>
		...
		/// <para><strong>Description</strong>: Status of the Application Extension</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Application Extension</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_applicationextensionOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
