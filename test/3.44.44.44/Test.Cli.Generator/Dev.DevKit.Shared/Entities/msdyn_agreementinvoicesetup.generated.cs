...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_agreementinvoicesetup : EntityBase
	{
		...
		public const int EntityTypeCode = 11651;
		public const string EntityCollectionSchemaName = "msdyn_agreementinvoicesetups";
		public const string EntityDisplayCollectionName = "Agreement Invoice Setups";
		public const string DisplayName = "Agreement Invoice Setup";
		public const string EntitySetName = "msdyn_agreementinvoicesetups";
		public const string EntityLogicalCollectionName = "msdyn_agreementinvoicesetups";
		public const string EntityPrimaryIdAttribute = "msdyn_agreementinvoicesetupid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_agreementinvoicesetup";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoicesetup"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoicesetup(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoicesetup"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoicesetup(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementinvoicesetup(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoicesetup"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoicesetup(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementinvoicesetup(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Agreement this Invoice Setup relates to</para>
		...
		/// <para><strong>Description</strong>: Status of the Agreement Invoice Setup</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementinvoicesetupOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Agreement Invoice Setup</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementinvoicesetupOptionSets.statuscode"/></para>
