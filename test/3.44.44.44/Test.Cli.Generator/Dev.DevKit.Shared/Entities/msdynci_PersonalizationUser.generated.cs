...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdynci_PersonalizationUserOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdynci_PersonalizationUser : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdynci_PersonalizationUserId = "msdynci_personalizationuserid";
		...
		public const string EntityLogicalName = "msdynci_personalizationuser";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11481;
		public const string EntityCollectionSchemaName = "msdynci_PersonalizationUsers";
		public const string EntityDisplayCollectionName = "PersonalizationUsers";
		public const string DisplayName = "PersonalizationUser";
		public const string EntitySetName = "msdynci_personalizationusers";
		public const string EntityLogicalCollectionName = "msdynci_personalizationusers";
		public const string EntityPrimaryIdAttribute = "msdynci_personalizationuserid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdynci_signalid";
		public const string EntitySchemaName = "msdynci_PersonalizationUser";
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(Guid msdynci_PersonalizationUserId)
		{
			Entity = new Entity(EntityLogicalName, msdynci_PersonalizationUserId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationUser"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationUser"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynci_PersonalizationUser(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdynci_PersonalizationUser"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdynci_PersonalizationUser(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdynci_PersonalizationUser(KeyAttributeCollection keys)
		{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdynci_PersonalizationUserId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdynci_PersonalizationUserId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
