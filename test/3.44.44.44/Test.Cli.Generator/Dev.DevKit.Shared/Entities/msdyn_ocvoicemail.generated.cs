...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets
{
	...
	public enum msdyn_voicemailtype
	{
		/// <summary>
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_ocvoicemail : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_missedconversationid = "msdyn_missedconversationid";
			public const string msdyn_orgphonenumber = "msdyn_orgphonenumber";
			public const string msdyn_sourcephonenumber = "msdyn_sourcephonenumber";
			public const string msdyn_voicemailpreview = "msdyn_voicemailpreview";
			public const string msdyn_voicemailtype = "msdyn_voicemailtype";
		...
		public const string EntityLogicalName = "msdyn_ocvoicemail";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11070;
		public const string EntityCollectionSchemaName = "msdyn_ocvoicemails";
		public const string EntityDisplayCollectionName = "Voicemails";
		public const string DisplayName = "Voicemail";
		public const string EntitySetName = "msdyn_ocvoicemails";
		public const string EntityLogicalCollectionName = "msdyn_ocvoicemails";
		public const string EntityPrimaryIdAttribute = "activityid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "subject";
		public const string EntitySchemaName = "msdyn_ocvoicemail";
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(Guid msdyn_ocvoicemailId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_ocvoicemailId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocvoicemail"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocvoicemail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocvoicemail(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocvoicemail"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocvoicemail(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_ocvoicemail(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.DeliveryPriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Missed Conversation</para>
		/// <para><strong>Description</strong>: Missed conversation</para>
		/// <para><strong>Lookup</strong>: <see cref="msdyn_ocliveworkitem"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyn_missedconversationid
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyn_missedconversationid); }
			set { Entity.Attributes[Fields.msdyn_missedconversationid] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Organization phone number</para>
		/// <para><strong>Description</strong>: Phone number of the organization which was called when the voicemail was left</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Source phone number</para>
		/// <para><strong>Description</strong>: Phone number from which the voicemail was received</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_sourcephonenumber
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_sourcephonenumber); }
			set { Entity.Attributes[Fields.msdyn_sourcephonenumber] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Voicemail preview</para>
		/// <para><strong>Description</strong>: Preview of the voicemail</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 4,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_voicemailpreview
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_voicemailpreview); }
			set { Entity.Attributes[Fields.msdyn_voicemailpreview] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: VoicemailType</para>
		/// <para><strong>Description</strong>: Type of voicemail activity.</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.msdyn_voicemailtype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.msdyn_voicemailtype.Group"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.msdyn_voicemailtype? msdyn_voicemailtype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_voicemailtype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.msdyn_voicemailtype)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.msdyn_voicemailtype] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.msdyn_voicemailtype] = null;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Voicemail Status</para>
		/// <para><strong>Description</strong>: Status of the voicemail.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the voicemail.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocvoicemailOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
