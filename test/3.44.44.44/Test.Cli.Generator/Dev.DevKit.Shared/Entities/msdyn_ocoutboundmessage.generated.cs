...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets
{
	...
	public enum msdyn_occhanneltype
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Apple Messages for Business</para>
	...
	public enum msdyn_ocmessagetype
	{
		/// <summary>
...
{
	[DebuggerNonUserCode()]
	public partial class msdyn_ocoutboundmessage : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_failurereason = "msdyn_failurereason";
			public const string msdyn_failurestatuscode = "msdyn_failurestatuscode";
			public const string msdyn_occhannelprovidername = "msdyn_occhannelprovidername";
			public const string msdyn_occhanneltype = "msdyn_occhanneltype";
			public const string msdyn_occustomerlocale = "msdyn_occustomerlocale";
			public const string msdyn_ocliveworkstreamid = "msdyn_ocliveworkstreamid";
			public const string msdyn_ocmessagetext = "msdyn_ocmessagetext";
			public const string msdyn_ocmessagetype = "msdyn_ocmessagetype";
			public const string msdyn_ocoutboundconfiguration = "msdyn_ocoutboundconfiguration";
			public const string msdyn_ocReceiverChannelId = "msdyn_ocreceiverchannelid";
			public const string msdyn_ocsenderChannelId = "msdyn_ocsenderchannelid";
		...
		public const int EntityTypeCode = 11063;
		public const string EntityCollectionSchemaName = "msdyn_ocoutboundmessages";
		public const string EntityDisplayCollectionName = "Outbound messages";
		public const string DisplayName = "Outbound message";
		public const string EntitySetName = "msdyn_ocoutboundmessages";
		public const string EntityLogicalCollectionName = "msdyn_ocoutboundmessages";
		public const string EntityPrimaryIdAttribute = "activityid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "subject";
		public const string EntitySchemaName = "msdyn_ocoutboundmessage";
		[DebuggerNonUserCode()]
		...
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(Guid msdyn_ocoutboundmessageId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_ocoutboundmessageId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocoutboundmessage"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocoutboundmessage"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocoutboundmessage(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_ocoutboundmessage"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_ocoutboundmessage(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyn_ocoutboundmessage(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.DeliveryPriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Reason for outbound message delivery</para>
		/// <para><strong>Description</strong>: Outbound message delivery failure reason.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 1,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_failurereason
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_failurereason); }
			set { Entity.Attributes[Fields.msdyn_failurereason] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Failure status code of outbound message</para>
		/// <para><strong>Description</strong>: Failure status code of outbound message</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public int? msdyn_failurestatuscode
		{
			get { return Entity.GetAttributeValue<int?>(Fields.msdyn_failurestatuscode); }
			set { Entity.Attributes[Fields.msdyn_failurestatuscode] = value; }
		}
		/// <summary>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_occhannelprovidername
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_occhannelprovidername); }
			set { Entity.Attributes[Fields.msdyn_occhannelprovidername] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Channel Type</para>
		/// <para><strong>Description</strong>: The channel(s) in the conversation.</para>
		/// <para><strong>MultiSelect OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_occhanneltype"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public System.Collections.Generic.List<Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_occhanneltype> msdyn_occhanneltype
		{
			get
			{
				var data = new System.Collections.Generic.List<Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_occhanneltype>();
				var items = Entity.GetAttributeValue<OptionSetValueCollection>(Fields.msdyn_occhanneltype);
				if (items != null)
				{
					foreach (OptionSetValue item in items)
					{
						data.Add((Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_occhanneltype)item.Value);
					}
				}
				return data;
			}
			set
			{
				...
				if (data.Count == 0)
				{
					Entity.Attributes[Fields.msdyn_occhanneltype] = null;
				}
				else
				{
					Entity.Attributes[Fields.msdyn_occhanneltype] = data;
				}
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Customer locale</para>
		/// <para><strong>Description</strong>: Customer preferred locale</para>
		/// <para><strong>Lookup</strong>: <see cref="msdyn_oclanguage"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyn_occustomerlocale
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyn_occustomerlocale); }
			set { Entity.Attributes[Fields.msdyn_occustomerlocale] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Live Work Stream</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyn_ocliveworkstreamid
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyn_ocliveworkstreamid); }
			set { Entity.Attributes[Fields.msdyn_ocliveworkstreamid] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Message text</para>
		/// <para><strong>Description</strong>: Message text.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 2,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_ocmessagetext
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_ocmessagetext); }
			set { Entity.Attributes[Fields.msdyn_ocmessagetext] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Type</para>
		/// <para><strong>Description</strong>: Message type</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_ocmessagetype"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_ocmessagetype? msdyn_ocmessagetype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_ocmessagetype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.msdyn_ocmessagetype)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.msdyn_ocmessagetype] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.msdyn_ocmessagetype] = null;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Outbound Configuration</para>
		/// <para><strong>Description</strong>: Associated Outbound Configuration.</para>
		/// <para>Required - <strong>Lookup</strong>: <see cref="msdyn_ocoutboundconfiguration"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference msdyn_ocoutboundconfiguration
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.msdyn_ocoutboundconfiguration); }
			set { Entity.Attributes[Fields.msdyn_ocoutboundconfiguration] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Receiver channel ID</para>
		/// <para><strong>Description</strong>: This can be an SMS number, Facebook page id, etc.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_ocReceiverChannelId
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_ocReceiverChannelId); }
			set { Entity.Attributes[Fields.msdyn_ocReceiverChannelId] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Sender channel ID</para>
		/// <para><strong>Description</strong>: This can be an SMS number, Facebook page id, etc.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_ocsenderChannelId
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_ocsenderChannelId); }
			set { Entity.Attributes[Fields.msdyn_ocsenderChannelId] = value; }
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_ocoutboundmessageOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
