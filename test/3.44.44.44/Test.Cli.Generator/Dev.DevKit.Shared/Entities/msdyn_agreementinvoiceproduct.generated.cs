...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_agreementinvoiceproduct : EntityBase
	{
		...
		public const int EntityTypeCode = 11650;
		public const string EntityCollectionSchemaName = "msdyn_agreementinvoiceproducts";
		public const string EntityDisplayCollectionName = "Agreement Invoice Products";
		public const string DisplayName = "Agreement Invoice Product";
		public const string EntitySetName = "msdyn_agreementinvoiceproducts";
		public const string EntityLogicalCollectionName = "msdyn_agreementinvoiceproducts";
		public const string EntityPrimaryIdAttribute = "msdyn_agreementinvoiceproductid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_agreementinvoiceproduct";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoiceproduct"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoiceproduct(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoiceproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoiceproduct(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementinvoiceproduct(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementinvoiceproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementinvoiceproduct(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementinvoiceproduct(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Unique identifier for Agreement associated with Agreement Invoice Product.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Agreement Invoice Setup associated with Agreement Invoice Product.</para>
		...
		/// <para><strong>Description</strong>: Shows the order of this product within the agreement invoice setup.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier for Price List associated with Agreement Invoice Product.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Product/Service associated with Agreement Invoice Product.</para>
		...
		/// <para><strong>Description</strong>: Status of the Agreement Invoice Product</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementinvoiceproductOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the Agreement Invoice Product</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementinvoiceproductOptionSets.statuscode"/></para>
