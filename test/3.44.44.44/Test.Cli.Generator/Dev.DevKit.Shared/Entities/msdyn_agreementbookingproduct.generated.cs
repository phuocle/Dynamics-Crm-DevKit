...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_agreementbookingproduct : EntityBase
	{
		...
		public const int EntityTypeCode = 11645;
		public const string EntityCollectionSchemaName = "msdyn_agreementbookingproducts";
		public const string EntityDisplayCollectionName = "Agreement Booking Products";
		public const string DisplayName = "Agreement Booking Product";
		public const string EntitySetName = "msdyn_agreementbookingproducts";
		public const string EntityLogicalCollectionName = "msdyn_agreementbookingproducts";
		public const string EntityPrimaryIdAttribute = "msdyn_agreementbookingproductid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_agreementbookingproduct";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementbookingproduct"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_agreementbookingproduct(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementbookingproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementbookingproduct(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementbookingproduct(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_agreementbookingproduct"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_agreementbookingproduct(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_agreementbookingproduct(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Unique identifier for Agreement associated with Agreement Booking Product.</para>
		...
		/// <para><strong>Description</strong>: The Agreement Booking Incident related to this product</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Agreement Booking Setup associated with Agreement Booking Product.</para>
		...
		/// <para><strong>Description</strong>: Customer asset related to this Product</para>
		...
		/// <para><strong>Description</strong>: Shows the order of this task within the agreement booking products.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Optionally set Price List that will determine the pricing for this product on the Work Order</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Product/Service associated with Agreement Booking Product.</para>
		...
		/// <para><strong>Description</strong>: The unit that determines the pricing for this product when Price List is set</para>
		...
		/// <para><strong>Description</strong>: Status of the Agreement Booking Product</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Agreement Booking Product</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyn_agreementbookingproductOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
