...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyncrm_taskactivitymarketingtemplate : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyncrm_taskactivitymarketingtemplateId = "msdyncrm_taskactivitymarketingtemplateid";
		...
		public const string EntityLogicalName = "msdyncrm_taskactivitymarketingtemplate";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11182;
		public const string EntityCollectionSchemaName = "msdyncrm_taskactivitymarketingtemplates";
		public const string EntityDisplayCollectionName = "Task activity marketing templates";
		public const string DisplayName = "Task activity marketing template";
		public const string EntitySetName = "msdyncrm_taskactivitymarketingtemplates";
		public const string EntityLogicalCollectionName = "msdyncrm_taskactivitymarketingtemplates";
		public const string EntityPrimaryIdAttribute = "msdyncrm_taskactivitymarketingtemplateid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyncrm_name";
		public const string EntitySchemaName = "msdyncrm_taskactivitymarketingtemplate";
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(Guid msdyncrm_taskactivitymarketingtemplateId)
		{
			Entity = new Entity(EntityLogicalName, msdyncrm_taskactivitymarketingtemplateId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_taskactivitymarketingtemplate"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_taskactivitymarketingtemplate"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_taskactivitymarketingtemplate(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_taskactivitymarketingtemplate"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_taskactivitymarketingtemplate(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyncrm_taskactivitymarketingtemplate(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>Description</strong>: Enter additional information to describe the task</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_prioritycode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_prioritycode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_prioritycode? msdyncrm_prioritycode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_prioritycode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_prioritycode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Shows the expected duration of the task, in minutes.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_scheduletype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_scheduletype.Fixed_date"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_scheduletype? msdyncrm_scheduletype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_scheduletype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_scheduletype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimehour"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimehour? msdyncrm_starttimehour
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_starttimehour);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimehour)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute? msdyncrm_starttimeminute
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_starttimeminute);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Enter a short description about the objective or primary topic of the task</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdyncrm_taskactivitymarketingtemplateId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdyncrm_taskactivitymarketingtemplateId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Status of the task activity marketing template</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the task activity marketing template</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_taskactivitymarketingtemplateOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
