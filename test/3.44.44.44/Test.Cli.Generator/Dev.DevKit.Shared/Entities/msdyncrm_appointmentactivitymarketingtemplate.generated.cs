...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets
{
...
{
	[DebuggerNonUserCode()]
	public partial class msdyncrm_appointmentactivitymarketingtemplate : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyncrm_appointmentactivitymarketingtemplateId = "msdyncrm_appointmentactivitymarketingtemplateid";
			public const string msdyncrm_description = "msdyncrm_description";
			public const string msdyncrm_isalldayevent = "msdyncrm_isalldayevent";
			public const string msdyncrm_location = "msdyncrm_location";
		...
		public const string EntityLogicalName = "msdyncrm_appointmentactivitymarketingtemplate";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 11138;
		public const string EntityCollectionSchemaName = "msdyncrm_appointmentactivitymarketingtemplates";
		public const string EntityDisplayCollectionName = "Appointment activity marketing templates";
		public const string DisplayName = "Appointment activity marketing template";
		public const string EntitySetName = "msdyncrm_appointmentactivitymarketingtemplates";
		public const string EntityLogicalCollectionName = "msdyncrm_appointmentactivitymarketingtemplates";
		public const string EntityPrimaryIdAttribute = "msdyncrm_appointmentactivitymarketingtemplateid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyncrm_name";
		public const string EntitySchemaName = "msdyncrm_appointmentactivitymarketingtemplate";
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(Guid msdyncrm_appointmentactivitymarketingtemplateId)
		{
			Entity = new Entity(EntityLogicalName, msdyncrm_appointmentactivitymarketingtemplateId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_appointmentactivitymarketingtemplate"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_appointmentactivitymarketingtemplate"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_appointmentactivitymarketingtemplate(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_appointmentactivitymarketingtemplate"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_appointmentactivitymarketingtemplate(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyncrm_appointmentactivitymarketingtemplate(KeyAttributeCollection keys)
		{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdyncrm_appointmentactivitymarketingtemplateId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdyncrm_appointmentactivitymarketingtemplateId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Description</para>
		/// <para><strong>Description</strong>: Enter additional information to describe this appointment</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? msdyncrm_isalldayevent
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.msdyncrm_isalldayevent); }
			set { Entity.Attributes[Fields.msdyncrm_isalldayevent] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Location</para>
		/// <para><strong>Description</strong>: Enter the location where the appointment will take place, such as a conference room or customer office</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 200</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_location
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_location); }
			set { Entity.Attributes[Fields.msdyncrm_location] = value; }
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_prioritycode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_prioritycode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_prioritycode? msdyncrm_prioritycode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_prioritycode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_prioritycode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		public int? msdyncrm_scheduleddurationminutes
		{
			...
			set { Entity.Attributes[Fields.msdyncrm_scheduleddurationminutes] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Schedule type</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_scheduletype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_scheduletype.Fixed_date"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_scheduletype? msdyncrm_scheduletype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_scheduletype);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_scheduletype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimehour"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimehour? msdyncrm_starttimehour
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_starttimehour);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimehour)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute? msdyncrm_starttimeminute
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_starttimeminute);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.msdyncrm_starttimeminute)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Enter a short description about the objective or primary topic of the appointment</para>
		...
		/// <para><strong>Description</strong>: Status of the appointment activity marketing template</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Status of the appointment activity marketing template</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_appointmentactivitymarketingtemplateOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
