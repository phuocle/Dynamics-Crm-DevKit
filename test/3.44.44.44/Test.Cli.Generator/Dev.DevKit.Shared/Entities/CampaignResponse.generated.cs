...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.CampaignResponseOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Do Not Send Marketing Materials</para>
		/// <para><strong>Value</strong>: 3</para>
		/// </summary>
		...
		Error = 4,
		/// <summary>
		/// <para><strong>Display Name</strong>: Interested</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Interested = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Not Interested</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Not_Interested = 2
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class CampaignResponse : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "CampaignResponses";
		public const string EntityDisplayCollectionName = "Campaign Responses";
		public const string DisplayName = "Campaign Response";
		...
		/// <summary>
		/// Instance new late bound class <see cref="CampaignResponse"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public CampaignResponse(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="CampaignResponse"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public CampaignResponse(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new CampaignResponse(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="CampaignResponse"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public CampaignResponse(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new CampaignResponse(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Campaign Response</para>
		/// <para><strong>Description</strong>: Unique identifier of the campaign response.</para>
		...
		/// <para><strong>Description</strong>: Type the number of minutes spent on this activity. The duration is used in reporting.</para>
		...
		/// <para><strong>Description</strong>: Enter the date when the campaign response was actually completed.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual start date and time for the campaign response.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a category to identify the campaign response type, such as new business development or customer retention, to tie the campaign response to a business group or function.</para>
		...
		/// <para><strong>Description</strong>: Select how the response was received, such as phone, letter, fax, or email.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ChannelTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ChannelTypeCode? ChannelTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ChannelTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ChannelTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type the name of the company if the campaign response was received from a new prospect or customer.</para>
		...
		/// <para><strong>Description</strong>: Enter the account, contact, or lead that submitted the campaign response, if it was received from an existing prospect or customer.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.DeliveryPriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type additional information to describe the campaign response, such as key discussion points or objectives.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Email</para>
		/// <para><strong>Description</strong>: Type the responder&apos;s email address.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Fax</para>
		/// <para><strong>Description</strong>: Type the responder&apos;s fax number.</para>
		...
		/// <para><strong>Description</strong>: Type the responder&apos;s first name if the campaign response was received from a new prospect or customer.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Is Billed</para>
		/// <para><strong>Description</strong>: Specifies whether the campaign response was billed as part of resolving a case.</para>
		...
		/// <para><strong>Description</strong>: Specifies whether the campaign response is created by a workflow rule.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the responder&apos;s last name if the campaign response was received from a new prospect or customer.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Originating Activity</para>
		/// <para><strong>Description</strong>: Choose the phone call, email, fax, letter, or appointment activity that led the prospect or customer to respond to the campaign.</para>
		/// <para><strong>Lookup</strong>: <see cref="appointment"/>, <see cref="email"/>, <see cref="fax"/>, <see cref="letter"/>, <see cref="phonecall"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Outsource Vendor</para>
		/// <para><strong>Description</strong>: Enter the vendor account or contact to capture any third-party used to obtain the campaign response.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type a promotional code to track sales related to the campaign response or to allow the responder to redeem a discount offer.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Received On</para>
		/// <para><strong>Description</strong>: Enter the date when the campaign response was received.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parent Campaign</para>
		/// <para><strong>Description</strong>: Choose the parent campaign so that the campaign&apos;s response rate is tracked correctly.</para>
		/// <para>Required - <strong>Lookup</strong>: <see cref="bulkoperation"/>, <see cref="campaign"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Response Code</para>
		/// <para><strong>Description</strong>: Select the type of response from the prospect or customer to indicate their interest in the campaign.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ResponseCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ResponseCode.Interested"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ResponseCode? ResponseCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ResponseCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.ResponseCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Scheduled duration of the campaign response in minutes.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Close By</para>
		/// <para><strong>Description</strong>: Enter the expected due date and time for the activity to be completed to provide details about the timing of the campaign response.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Enter the expected start date and time for the activity to provide details about the timing of the campaign response.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Shows whether the campaign response is open, closed, or canceled. Closed and canceled campaign responses are read-only and can&apos;t be edited.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Select the campaign response&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.CampaignResponseOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type a subcategory to identify the campaign response type and relate the activity to a specific product, sales region, business group, or other function.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a short description about the objective or primary topic of the campaign response.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phone</para>
		/// <para><strong>Description</strong>: Type the responder&apos;s primary phone number.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the phonetic spelling of the campaign responder&apos;s first name, if specified in Japanese, to make sure the name is pronounced correctly in phone calls and other communications.</para>
		...
		/// <para><strong>Description</strong>: Type the phonetic spelling of the campaign responder&apos;s last name, if specified in Japanese, to make sure the name is pronounced correctly in phone calls and other communications.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 150</para>
		/// </summary>
		[DebuggerNonUserCode()]
