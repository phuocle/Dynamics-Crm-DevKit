...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_smsengagementctx : EntityBase
	{
		...
		public const int EntityTypeCode = 11042;
		public const string EntityCollectionSchemaName = "msdyn_smsengagementctxes";
		public const string EntityDisplayCollectionName = "SMS Engagement Contexts";
		public const string DisplayName = "SMS Engagement Context";
		public const string EntitySetName = "msdyn_smsengagementctxes";
		public const string EntityLogicalCollectionName = "msdyn_smsengagementctxes";
		public const string EntityPrimaryIdAttribute = "msdyn_smsengagementctxid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyn_name";
		public const string EntitySchemaName = "msdyn_smsengagementctx";
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_smsengagementctx"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyn_smsengagementctx(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_smsengagementctx"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_smsengagementctx(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_smsengagementctx(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyn_smsengagementctx"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyn_smsengagementctx(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyn_smsengagementctx(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <para><strong>Description</strong>: Country code of the customer&apos;s (C2) phone number. For instance, US will be &quot;1&quot;, India will be &quot;91&quot;</para>
		...
		/// <para><strong>Description</strong>: Phone number of the customer (C2)</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier for Conversation associated with SMS Engagement Context.</para>
		...
		/// <para><strong>Description</strong>: Phone number of the organization (C1)</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: SMS Engagement Id</para>
		/// <para><strong>Description</strong>: Engagement ID for the SMS context</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_smsengagementctxOptionSets.msdyn_smsprovider"/></para>
		...
		/// <para><strong>Description</strong>: Status of the SMS Engagement Context</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_smsengagementctxOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Reason for the status of the SMS Engagement Context</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyn_smsengagementctxOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
