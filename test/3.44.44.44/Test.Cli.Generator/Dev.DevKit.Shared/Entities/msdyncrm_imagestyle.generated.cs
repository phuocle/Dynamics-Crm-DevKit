...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets
{
	public enum msdyncrm_fit
	{
		/// <summary>
...
{
	[DebuggerNonUserCode()]
	public partial class msdyncrm_imagestyle : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyncrm_emailtext = "msdyncrm_emailtext";
			public const string msdyncrm_fileid = "msdyncrm_fileid";
			public const string msdyncrm_fit = "msdyncrm_fit";
			public const string msdyncrm_height = "msdyncrm_height";
			public const string msdyncrm_imagesource = "msdyncrm_imagesource";
			public const string msdyncrm_imagestyleId = "msdyncrm_imagestyleid";
			public const string msdyncrm_link = "msdyncrm_link";
		...
		public const string EntityLogicalName = "msdyncrm_imagestyle";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 10623;
		public const string EntityCollectionSchemaName = "msdyncrm_imagestyles";
		public const string EntityDisplayCollectionName = "imagestyle";
		public const string DisplayName = "imagestyle";
		public const string EntitySetName = "msdyncrm_imagestyles";
		public const string EntityLogicalCollectionName = "msdyncrm_imagestyles";
		public const string EntityPrimaryIdAttribute = "msdyncrm_imagestyleid";
		public const string EntityPrimaryImageAttribute = "";
		public const string EntityPrimaryNameAttribute = "msdyncrm_name";
		public const string EntitySchemaName = "msdyncrm_imagestyle";
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(Guid msdyncrm_imagestyleId)
		{
			Entity = new Entity(EntityLogicalName, msdyncrm_imagestyleId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_imagestyle"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_imagestyle"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_imagestyle(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="msdyncrm_imagestyle"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new msdyncrm_imagestyle(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public msdyncrm_imagestyle(KeyAttributeCollection keys)
		{
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_align); }
			set { Entity.Attributes[Fields.msdyncrm_align] = value; }
		}
		/// <summary>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_emailtext); }
			set { Entity.Attributes[Fields.msdyncrm_emailtext] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Image file id</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 1,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyncrm_fileid
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_fileid); }
			set { Entity.Attributes[Fields.msdyncrm_fileid] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Fit</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.msdyncrm_fit"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.msdyncrm_fit.Fill"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.msdyncrm_fit? msdyncrm_fit
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyncrm_fit);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.msdyncrm_fit)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.msdyncrm_fit] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.msdyncrm_fit] = null;
			}
		}
		/// <summary>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_imagesource); }
			set { Entity.Attributes[Fields.msdyncrm_imagesource] = value; }
		}
		/// <summary>
		...
		public Guid msdyncrm_imagestyleId
		{
			...
			set
			{
				Entity.Attributes[Fields.msdyncrm_imagestyleId] = value;
				Entity.Id = value;
			}
		}
		/// <summary>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyncrm_link); }
			set { Entity.Attributes[Fields.msdyncrm_link] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.msdyncrm_imagestyleOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
