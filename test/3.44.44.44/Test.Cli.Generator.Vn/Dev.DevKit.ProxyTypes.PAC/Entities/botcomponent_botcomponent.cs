...
namespace Dev.DevKit.ProxyTypes
{
	...
	public partial class botcomponent_botcomponent : Microsoft.Xrm.Sdk.Entity
	{
		
		/// <summary>
		/// Available fields, a the time of codegen, for the botcomponent_botcomponent entity
		/// </summary>
		...
		public System.Collections.Generic.IEnumerable<Dev.DevKit.ProxyTypes.botcomponent> botcomponent_botcomponent1
		{
			get
			{
				return this.GetRelatedEntities<Dev.DevKit.ProxyTypes.botcomponent>("botcomponent_botcomponent", null);
			}
			set
			{
				this.SetRelatedEntities<Dev.DevKit.ProxyTypes.botcomponent>("botcomponent_botcomponent", null, value);
			}
		}
	}
}
