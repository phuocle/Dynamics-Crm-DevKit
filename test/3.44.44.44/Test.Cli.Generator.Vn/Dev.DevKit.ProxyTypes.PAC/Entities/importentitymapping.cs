...
namespace Dev.DevKit.ProxyTypes
{
	...
	/// <summary>
	/// Sẽ kiểm soát việc có loại bỏ sự trùng lặp đối với thực thể đã cho không
	/// </summary>
	...
	public partial class ImportEntityMapping : Microsoft.Xrm.Sdk.Entity
	{
		
		/// <summary>
		/// Available fields, a the time of codegen, for the importentitymapping entity
		/// </summary>
		...
		/// <summary>
		/// Tên cho Bản ghi Trùng lặp
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dedupename")]
		public string DeDupeName
		{
			get
			{
				if (this.FormattedValues.Contains("dedupe"))
				{
					return this.FormattedValues["dedupe"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Tên trạng thái của ánh xạ thực thể nhập.
		/// </summary>
		...
		/// <summary>
		/// Tên lý do dẫn đến trạng thái của ánh xạ thực thể nhập.
		/// </summary>
		...
		public System.Collections.Generic.IEnumerable<Dev.DevKit.ProxyTypes.UserEntityInstanceData> userentityinstancedata_importentitymapping
		{
			get
			{
				return this.GetRelatedEntities<Dev.DevKit.ProxyTypes.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null);
			}
			set
			{
				this.SetRelatedEntities<Dev.DevKit.ProxyTypes.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null, value);
			}
		}
		...
		public Dev.DevKit.ProxyTypes.ImportMap ImportEntityMapping_ImportMap
		{
			get
			{
				return this.GetRelatedEntity<Dev.DevKit.ProxyTypes.ImportMap>("ImportEntityMapping_ImportMap", null);
			}
			set
			{
				this.SetRelatedEntity<Dev.DevKit.ProxyTypes.ImportMap>("ImportEntityMapping_ImportMap", null, value);
			}
		}
		...
		public Dev.DevKit.ProxyTypes.SystemUser lk_importentitymapping_createdby
		{
			get
			{
				return this.GetRelatedEntity<Dev.DevKit.ProxyTypes.SystemUser>("lk_importentitymapping_createdby", null);
			}
		}
		...
		public Dev.DevKit.ProxyTypes.SystemUser lk_importentitymapping_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Dev.DevKit.ProxyTypes.SystemUser>("lk_importentitymapping_createdonbehalfby", null);
			}
		}
		...
		public Dev.DevKit.ProxyTypes.SystemUser lk_importentitymapping_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Dev.DevKit.ProxyTypes.SystemUser>("lk_importentitymapping_modifiedby", null);
			}
		}
		...
		public Dev.DevKit.ProxyTypes.SystemUser lk_importentitymapping_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Dev.DevKit.ProxyTypes.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null);
			}
		}
	}
}
