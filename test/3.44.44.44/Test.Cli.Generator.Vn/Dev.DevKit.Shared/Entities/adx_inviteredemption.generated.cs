...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class adx_inviteredemption : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Quy đổi Lời mời";
		public const string DisplayName = "Quy đổi Lời mời";
		...
		/// <para><strong>Description</strong>: Hiển thị hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Nhập khoảng thời gian thực tế của hoạt động tính bằng phút.</para>
		...
		/// <para><strong>Description</strong>: Nhập thời gian kết thúc thực tế của hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Nhập thời gian bắt đầu thực tế của hoạt động.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Địa chỉ IP</para>
		...
		/// <para><strong>Description</strong>: Nhập người nhận bản sao ẩn (bcc) của hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Nhập người nhận bản sao (cc) của hoạt động.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Cho biết người tạo hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị ngày và giờ tạo hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Cho biết người tạo con trỏ hoạt động thay mặt cho người dùng khác.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị ngày và giờ của lần gửi hoạt động cuối cùng.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị ưu tiên gửi hoạt động đến máy chủ email.</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.adx_inviteredemptionOptionSets.DeliveryPriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập người bắt đầu hoạt động.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị loại phiên bản của chuỗi lặp lại.</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.adx_inviteredemptionOptionSets.InstanceTypeCode.Khong_Lap_lai"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Cho biết hoạt động có được xuất hóa đơn như một phần trong việc giải quyết trường hợp hay không.</para>
		...
		/// <para><strong>Description</strong>: Cho biết hoạt động là loại hoạt động thông thường hay loại sự kiện.</para>
		...
		/// <para><strong>Description</strong>: Cho biết hoạt động có được tạo từ quy tắc quy trình hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Chọn xem thư thoại có được để lại hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Cho biết người đã cập nhật hoạt động sau cùng.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị ngày và giờ sửa đổi hoạt động lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Cho biết người cập nhật con trỏ hoạt động lần cuối thay mặt cho người dùng khác.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập người tổ chức hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Nhập người dùng hoặc nhóm đã gán quản lý hoặc duy trì hoạt động. Trường này sẽ cập nhật mỗi lần gán hoạt động cho một người dùng khác.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị đơn vị kinh doanh sở hữu hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị nhà cung cấp thuê ngoài liên kết với hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị ưu tiên của hoạt động.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.adx_inviteredemptionOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.adx_inviteredemptionOptionSets.PriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị quy trình.</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập người dùng hoặc cơ sở/thiết bị cần thiết cho hoạt động.</para>
		/// <para><strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập khoảng thời gian đã lên lịch của hoạt động tính bằng phút.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập thời gian kết thúc đã lên lịch của hoạt động.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị ngày và giờ gửi hoạt động.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Hiển thị ID chuỗi lặp lại của phiên bản.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị giai đoạn.</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid? StageId
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.adx_inviteredemptionOptionSets.StateCode.Mo"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Chọn trạng thái của hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Nhập người nhận hoạt động.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
