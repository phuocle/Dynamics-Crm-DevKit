...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class TranslationProcess : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Quy trình Dịch thuật";
		public const string DisplayName = "Quy trình Dịch thuật";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Phiên bản Quy trình Dịch thuật</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của phiên bản thực thể Dòng Quy trình Công việc trong Quy trình Dịch thuật</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.TranslationProcessOptionSets.StateCode.Hien_hoat"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
