...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class mspp_weblink : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Liên kết web";
		public const string DisplayName = "Liên kết web";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tắt xác thực trang</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chỉ hiển thị hình ảnh</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Hiển thị liên kết con của trang</para>
		/// <para><strong>Description</strong>: Chọn xem có hiển thị nội dung con của trang dưới dạng các liên kết con cho liên kết này hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Văn bản thay thế của hình ảnh</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chiều cao hình ảnh</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chiều rộng hình ảnh</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Mở trong cửa sổ mới</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho trang web được liên kết với liên kết web.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Liên kết web chính</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho liên kết web chính được liên kết với liên kết web.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho trạng thái phát hành được liên kết với liên kết web.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Người máy dõi theo liên kết</para>
		/// <para>Required - <strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho bộ liên kết web được liên kết với liên kết web.</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của liên kết web</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của liên kết web</para>
