...
namespace Dev.DevKit.Shared.Entities.mspp_redirectOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: 301 (Chuyển hướng cố định)</para>
		/// <para><strong>Value</strong>: 301</para>
		/// </summary>
		_301_Chuyen_huong_co_dinh = 301,
		/// <summary>
		/// <para><strong>Display Name</strong>: 302 (Chuyển hướng tạm thời)</para>
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class mspp_redirect : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Chuyển hướng";
		public const string DisplayName = "Chuyển hướng";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: URL đến</para>
		/// <para><strong>Description</strong>: Đường dẫn để chuyển hướng khách truy cập từ</para>
		...
		/// <para><strong>Description</strong>: Đường dẫn để chuyển hướng khách truy cập tới</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho công cụ đánh dấu trang được liên kết với lệnh chuyển hướng.</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.mspp_redirectOptionSets.mspp_statuscode._302_Chuyen_huong_tam_thoi"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho trang web được liên kết với lệnh chuyển hướng.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho website liên kết với lệnh chuyển hướng.</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của lệnh chuyển hướng</para>
		...
		/// <para><strong>Description</strong>: Lý do cho trạng thái của lệnh chuyển hướng</para>
