...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class UserFiscalCalendar : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Các lịch tài chính người dùng";
		public const string DisplayName = "Lịch tài chính người dùng";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của bơn vị kinh doanh liên kết lịch tài chính người dùng.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Ngày và giờ tạo lịch tài chính.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đại diện đã tạo userfiscalcalendar.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Ngày và giờ lịch tài chính có hiệu lực.</para>
		...
		/// <para><strong>Description</strong>: Tỷ giá của loại tiền liên kết với lịch tài chính người dùng theo loại tiền gốc.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Loại kỳ tài chính được dùng trong lịch tài chính.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sửa đổi lịch tài chính lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Ngày và giờ sửa đổi lịch tài chính lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đại diện đã sửa đổi userfiscalcalendar lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của nhân viên bán hàng đã gán lịch tài chính.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của loại tiền liên kết với lịch tài chính người dùng.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho lịch tài chính.</para>
