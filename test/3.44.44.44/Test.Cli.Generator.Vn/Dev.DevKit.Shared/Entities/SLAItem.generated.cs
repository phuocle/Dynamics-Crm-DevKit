...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class SLAItem : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Mục SLA";
		public const string DisplayName = "Mục SLA";
		...
		/// <para><strong>Description</strong>: Điều kiện cho mục SLA</para>
		...
		/// <para><strong>Description</strong>: Nhập thông tin thêm để mô tả mục SLA</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Tỷ giá giữa loại tiền đã liên kết với Mục SLA và loại tiền gốc.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Lỗi sau</para>
		/// <para><strong>Description</strong>: Chọn tốc độ phải đáp ứng tiêu chí thành công đến khi hệ thống xem mục SLA là không thành công và khởi tạo hành động lỗi. Khoảng thời gian thực tế sẽ dựa trên giờ hoạt động như đã chỉ định trong bản ghi SLA đã liên kết.</para>
		...
		/// <para><strong>Description</strong>: Nhập tên mô tả của mục thỏa thuận cấp độ dịch vụ (SLA).</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sở hữu bản ghi Mục SLA.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Trường của trường hợp liên quan</para>
		/// <para><strong>Description</strong>: Chọn Chỉ số Đo lường Hiệu suất Chính (KPI) của thỏa thuận cấp độ dịch vụ (SLA) đã tạo Mục SLA này.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho SLA đã liên kết với Mục SLA.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của Mục SLA.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của loại tiền đã liên kết với bản ghi Mục SLA.</para>
		...
		/// <para><strong>Description</strong>: Số phiên bản của Mục SLA.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cảnh báo sau</para>
		/// <para><strong>Description</strong>: Chọn tốc độ phải đáp ứng tiêu chí thành công trước khi khởi tạo hành động cảnh báo. Khoảng thời gian thực tế sẽ dựa trên giờ hoạt động như đã chỉ định trong bản ghi SLA đã liên kết.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Quy trình làm việc đã liên kết với Mục SLA.</para>
		/// <para><strong>Lookup</strong>: <see cref="workflow"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
