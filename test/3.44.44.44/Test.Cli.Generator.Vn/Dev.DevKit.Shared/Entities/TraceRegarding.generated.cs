...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class TraceRegarding : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Truy vết có liên quan";
		public const string DisplayName = "Truy vết có liên quan";
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của đối tượng có liên quan.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại đối tượng liên quan để chia sẻ</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của bản ghi truy vết có liên quan.</para>
