...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ReplicationBacklog : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Tồn đọng sao chép";
		public const string DisplayName = "Tồn đọng sao chép";
		...
		/// <para><strong>Description</strong>: Dữ liệu bổ sung liên quan đến mục nhập tồn đọng sao chép. Chỉ sử dụng nội bộ.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của mục nhập tồn đọng sao chép.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại tồn đọng sao chép</para>
		/// <para><strong>Description</strong>: Loại của tồn đọng sao chép.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID trung tâm dữ liệu mục tiêu</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID đối tượng mục tiêu</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của đối tượng mục tiêu</para>
