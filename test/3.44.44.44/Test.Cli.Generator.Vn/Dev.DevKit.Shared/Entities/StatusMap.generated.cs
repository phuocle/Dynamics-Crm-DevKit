...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class StatusMap : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Ánh xạ trạng thái";
		public const string DisplayName = "Ánh xạ trạng thái";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của ánh xạ trạng thái.</para>
