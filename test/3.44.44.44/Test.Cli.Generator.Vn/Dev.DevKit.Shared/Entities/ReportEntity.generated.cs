...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ReportEntity : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Thực thể liên quan của báo cáo";
		public const string DisplayName = "Thực thể liên quan của báo cáo";
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.ReportEntityOptionSets.ComponentState"/></para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đã tạo bản ghi báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Ngày và giờ tạo bản ghi báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đại diện đã tạo reportentity.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Có thể lọc</para>
		/// <para><strong>Description</strong>: Thông tin về khả năng có thể lọc báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sửa đổi bản ghi báo cáo lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Ngày và giờ sửa đổi bản ghi báo cáo lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đại diện đã sửa đổi reportentity lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Loại bản ghi liên kết với báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng hoặc nhóm sở hữu thực thể báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của bơn vị kinh doanh sở hữu bản ghi báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sở hữu bản ghi báo cáo.</para>
		/// <para><strong>ReadOnly</strong> - Required - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Thực thể liên quan của báo cáo</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của bản ghi báo cáo.</para>
