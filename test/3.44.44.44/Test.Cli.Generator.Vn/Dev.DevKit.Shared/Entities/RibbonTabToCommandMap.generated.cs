...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RibbonTabToCommandMap : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Bản đồ thẻ ruy băng đến lệnh";
		public const string DisplayName = "Ánh xạ thẻ ruy băng đến lệnh";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Id lệnh của kiểm soát trong thẻ đó.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Id kiểm soát trong thẻ đó.</para>
		/// <para><strong>Multiple Lines of Text</strong> - <strong>MaxLength</strong>: 200</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Id của thẻ</para>
