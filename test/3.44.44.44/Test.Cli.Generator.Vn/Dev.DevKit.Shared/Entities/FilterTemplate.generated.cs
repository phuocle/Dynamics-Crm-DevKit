...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class FilterTemplate : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Mẫu Bộ lọc";
		public const string DisplayName = "Mẫu Bộ lọc";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Chuỗi chỉ định mẫu bộ lọc bằng ngôn ngữ XML Tìm nạp dữ liệu.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của mẫu bộ lọc.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Tên mẫu bộ lọc.</para>
