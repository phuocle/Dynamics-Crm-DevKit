...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ManagedProperty : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Thuộc tính Được quản lý";
		public const string DisplayName = "Thuộc tính Được quản lý";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Bật Tên Thuộc tính</para>
		/// <para><strong>Description</strong>: Bật Tên Thuộc tính của Thuộc tính Được quản lý này.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Bật Tên Thực thể</para>
		/// <para><strong>Description</strong>: Bật Tên Thực thể của Thuộc tính Được quản lý này.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 128</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Tên logic của Thuộc tính Được quản lý này.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Id Thuộc tính Được quản lý</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của khóa thuộc tính được quản lý.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Id Hàng Thuộc tính Được quản lý</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của Thuộc tính Được quản lý</para>
