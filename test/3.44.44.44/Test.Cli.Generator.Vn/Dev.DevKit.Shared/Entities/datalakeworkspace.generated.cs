...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class datalakeworkspace : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Không gian làm việc Data Lake";
		public const string DisplayName = "Không gian làm việc Data Lake";
		...
		/// <para><strong>Description</strong>: Điểm cuối bộ chứa Azure Data Lake cho không gian làm việc này.</para>
		...
		/// <para><strong>Description</strong>: Cho biết liệu bộ lưu trữ dữ liệu không gian làm việc có sử dụng dung lượng của khách hàng hay không.</para>
		...
		/// <para><strong>Description</strong>: Cho biết bản sao sâu có được bật cho không gian làm việc hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		...
		/// <para><strong>Description</strong>: Cho biết siêu dữ liệu và dữ liệu không gian làm việc hiển thị với tất cả các ứng dụng hay chỉ hiển thị với chủ sở hữu không gian làm việc và các ứng dụng có quyền rõ ràng đối với không gian làm việc.</para>
		...
		/// <para><strong>Description</strong>: ID ứng dụng sở hữu không gian làm việc này. ID ứng dụng sở hữu có toàn quyền kiểm soát, tức là quyền đọc, ghi và thực thi trên thư mục ADLS.</para>
		...
		/// <para><strong>Description</strong>: Đường dẫn đến không gian làm việc trong bộ chứa Azure Data Lake.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string path
		...
		/// <para><strong>Description</strong>: Trạng thái của Không gian làm việc Data Lake</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của Không gian làm việc Data Lake</para>
		...
		/// <para><strong>Description</strong>: ID đối tượng thuê AAD nơi ID ứng dụng sở hữu được đăng ký.</para>
		/// <para>Required - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
