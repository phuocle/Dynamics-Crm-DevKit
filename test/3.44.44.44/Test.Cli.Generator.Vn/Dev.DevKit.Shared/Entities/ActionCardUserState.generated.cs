...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ActionCardUserState : EntityBase
	{
		...
		/// <para><strong>Description</strong>: ID ActionCard Mẹ.</para>
		...
		/// <para><strong>Description</strong>: Tỷ giá của loại tiền được liên kết với ActionCardUserState theo loại tiền gốc.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng hoặc nhóm sở hữu trạng thái của thẻ hành động này.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của bộ phận kinh doanh sở hữu bản ghi</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.ActionCardUserStateOptionSets.State.Hien_hoat"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
