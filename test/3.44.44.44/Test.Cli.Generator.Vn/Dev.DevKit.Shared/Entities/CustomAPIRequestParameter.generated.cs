...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class CustomAPIRequestParameter : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Tham số yêu cầu API tùy chỉnh";
		public const string DisplayName = "Tham số yêu cầu API tùy chỉnh";
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho API tùy chỉnh sở hữu tham số yêu cầu API tùy chỉnh này</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của các phiên bản tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Thông tin mô tả đã bản địa hóa của các phiên bản tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Tên hiển thị đã bản địa hóa của các phiên bản tham số yêu cầu API tùy chỉnh</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Là tùy chọn</para>
		/// <para><strong>Description</strong>: Cho biết tham số yêu cầu API tùy chỉnh có phải là tùy chọn hay không</para>
		...
		/// <para><strong>Description</strong>: Tên logic của thực thể ràng buộc với tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Tên chính của tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Trạng thái Tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái Tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Kiểu dữ liệu của tham số yêu cầu API tùy chỉnh</para>
		...
		/// <para><strong>Description</strong>: Tên duy nhất của tham số yêu cầu API tùy chỉnh</para>
