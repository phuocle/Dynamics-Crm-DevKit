...
using System.Linq;
namespace Dev.DevKit.Shared.Entities.chatOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Chưa bật</para>
		/// <para><strong>Value</strong>: 0</para>
		/// </summary>
		Chua_bat = 0,
		/// <summary>
		...
		Da_bat = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: Đang chờ xử lý</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Dang_cho_xu_ly = 1
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class chat : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "chats";
		public const string EntityDisplayCollectionName = "Trò chuyện qua Teams";
		public const string DisplayName = "Trò chuyện qua Teams";
		...
		{
			Entity = new Entity(EntityLogicalName, chatId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// Instance new late bound class <see cref="chat"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public chat(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="chat"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public chat(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new chat(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="chat"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public chat(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new chat(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public chat(KeyAttributeCollection keys)
		{
		...
		/// <para><strong>Description</strong>: Thông tin bổ sung được cung cấp bởi ứng dụng bên ngoài là JSON. Chỉ sử dụng nội bộ.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.Community"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngày Gửi Cuối cùng</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.DeliveryPriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.DeliveryPriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Mô tả của hoạt động.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tóm tắt sự kiện</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Một trường tính toán dạng văn bản đa dạng thức để hiển thị bản tóm tắt các sự kiện.</para>
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.EventsSummary); }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Hạng mục Exchange</para>
		/// <para><strong>Description</strong>: ID thư của hoạt động được trả về từ Exchange Server.</para>
		...
		/// <para><strong>Description</strong>: Hiển thị liên kết web Hoạt động của email thể loại.</para>
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.InstanceTypeCode.Khong_Lap_lai"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Lỗi đồng bộ hóa gần đây nhất</para>
		/// <para><strong>Description</strong>: Lỗi đồng bộ hóa xảy ra gần đây nhất với cuộc trò chuyện.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public int? LastSyncError
		{
			get { return Entity.GetAttributeValue<int?>(Fields.LastSyncError); }
			set { Entity.Attributes[Fields.LastSyncError] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Để lại Thư Thoại</para>
		/// <para><strong>Description</strong>: Để lại Thư Thoại</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Người liên kết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Mã định danh duy nhất của người dùng đã liên kết bản ghi.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference LinkedBy
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.LinkedBy); }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngày liên kết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Ngày và giờ liên kết bản ghi.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public DateTime? LinkedOnUtc
		{
			get { return Entity.GetAttributeValue<DateTime?>(Fields.LinkedOn); }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Người Sửa đổi</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sửa đổi hoạt động lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Người sửa đổi (Teams)</para>
		/// <para><strong>Description</strong>: Người cập nhật cuộc trò chuyện lần gần nhất trong Teams.</para>
		/// <para><strong>Lookup</strong>:</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public System.Collections.Generic.List<ActivityParty> ModifiedInTeamsBy
		{
			get
			{
				var data = new System.Collections.Generic.List<ActivityParty>();
				foreach (var item in Entity.GetAttributeValue<EntityCollection>(Fields.ModifiedInTeamsBy).Entities)
					data.Add(new ActivityParty(item));
				return data;
			}
			set
			{
				...
				foreach (var item in value)
					data.Entities.Add(item.Entity);
				Entity.Attributes[Fields.ModifiedInTeamsBy] = data;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Người sửa đổi (Teams)</para>
		...
		{
			get { return Entity.GetAttributeValue<Guid?>(Fields.ModifiedInTeamsByActivityPartyId); }
			set { Entity.Attributes[Fields.ModifiedInTeamsByActivityPartyId] = value; }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngày sửa đổi (Teams)</para>
		/// <para><strong>Description</strong>: Ngày và giờ cuộc trò chuyện được cập nhật lần gần nhất trong Teams. Trường này sử dụng múi giờ được chọn trong các tùy chọn Dynamics 365.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public DateTime? ModifiedInTeamsOnUtc
		{
			get { return Entity.GetAttributeValue<DateTime?>(Fields.ModifiedInTeamsOn); }
			set { Entity.Attributes[Fields.ModifiedInTeamsOn] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng đại diện đã sửa đổi activitypointer lần cuối.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.PriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của hộp thư liên kết với người gửi thư qua email.</para>
		...
		/// <para><strong>Description</strong>: Uniqueidentifier chỉ định id chuỗi lặp lại của phiên bản.</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.StateCode.Mo"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Lý do cho trạng thái của hoạt động.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Chủ đề</para>
		...
		/// <para><strong>Description</strong>: Hiển thị trạng thái đồng bộ hóa.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.SyncStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.chatOptionSets.SyncStatus.Chua_bat"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.chatOptionSets.SyncStatus? SyncStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SyncStatus);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.chatOptionSets.SyncStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.SyncStatus] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.SyncStatus] = null;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: ID trò chuyện Teams</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. ID trò chuyện Teams</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string teamschatid
		{
			get { return Entity.GetAttributeValue<string>(Fields.teamschatid); }
			set { Entity.Attributes[Fields.teamschatid] = value; }
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Người hủy liên kết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Mã định danh duy nhất của người dùng đã hủy liên kết bản ghi.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference UnLinkedBy
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.UnLinkedBy); }
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngày hủy liên kết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ. Ngày và giờ hủy liên kết bản ghi.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public DateTime? UnLinkedOnUtc
		{
			get { return Entity.GetAttributeValue<DateTime?>(Fields.UnLinkedOn); }
		}
		/// <summary>
