...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class Letter : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Thư tín";
		public const string DisplayName = "Thư tín";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Thư tín</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của hoạt động thư tín.</para>
		...
		/// <para><strong>Description</strong>: Nhập số phút cần để tạo và gửi thư tín. Lượng thời gian này được sử dụng trong báo cáo.</para>
		...
		/// <para><strong>Description</strong>: Nhập ngày và giờ kết thúc thư tín thực tế. Theo mặc định, trường này hiển thị ngày và giờ hoàn thành hoặc hủy hoạt động, nhưng có thể chỉnh sửa được để thu thập thời gian tạo và gửi thư tín thực tế.</para>
		...
		/// <para><strong>Description</strong>: Nhập ngày và giờ bắt đầu thực tế cho thư tín. Theo mặc định, trường này hiển thị ngày và giờ tạo hoạt động, nhưng có thể chỉnh sửa được để thu thập thời gian tạo và gửi thư tín thực tế.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập địa chỉ đầy đủ của người nhận thư tín để đảm bảo gửi đến kịp thời.</para>
		...
		/// <para><strong>Description</strong>: Nhập người nhận được bao gồm trong danh sách gửi thư tín, nhưng không hiển thị cho người nhận khác.</para>
		...
		/// <para><strong>Description</strong>: Nhập một thể loại để xác định loại thư tín, chẳng hạn như chào bán hoặc thông báo quá hạn, nhằm liên kết thư tín với chức năng hoặc nhóm kinh doanh.</para>
		...
		/// <para><strong>Description</strong>: Nhập người nhận sẽ được sao chép trên thư tín.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập nội dung thư tín hoặc thông tin bổ sung để mô tả thư tín, chẳng hạn như thông điệp chính hoặc sản phẩm và dịch vụ được mô tả.</para>
		...
		/// <para><strong>Description</strong>: Chọn hướng của thư tín là đến hoặc đi.</para>
		...
		/// <para><strong>Description</strong>: Nhập khách hàng, người liên hệ, khách hàng tiềm năng hoặc người dùng đã gửi thư tín.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Cho biết hoạt động thư tín có được xuất hóa đơn như một phần trong việc giải quyết trường hợp hay không.</para>
		...
		/// <para><strong>Description</strong>: Cho biết hoạt động thư tín có được tạo bởi quy tắc quy trình hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của đơn vị kinh doanh sở hữu hoạt động thư tín.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của nhóm sở hữu hoạt động thư tín.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của người dùng sở hữu hoạt động thư tín.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.LetterOptionSets.PriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Chọn bản ghi liên quan đến thư tín.</para>
		...
		/// <para><strong>Description</strong>: Lượng thời gian theo lịch của hoạt động thư tín, tính bằng phút.</para>
		...
		/// <para><strong>Description</strong>: Chọn thỏa thuận cấp độ dịch vụ (SLA) mà bạn muốn áp dụng cho bản ghi Thư tín.</para>
		...
		/// <para><strong>Description</strong>: Thỏa thuận Cấp độ Dịch vụ lần cuối đã được áp dụng cho Thư này. Chỉ sử dụng nội bộ trường này.</para>
		...
		/// <para><strong>Description</strong>: Cho biết thư tín đang ở trạng thái mở, đã hoàn thành hay bị hủy. Các thư tín đã hoàn thành hoặc bị hủy ở trạng thái chỉ đọc và không chỉnh sửa được.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.LetterOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.LetterOptionSets.StateCode.Mo"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Chọn trạng thái của thư tín.</para>
		...
		/// <para><strong>Description</strong>: Nhập thể loại phụ để xác định loại thư tín và liên kết hoạt động với sản phẩm cụ thể, khu vực bán hàng, nhóm kinh doanh hoặc chức năng khác.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập mô tả ngắn về mục tiêu hoặc chủ đề chính của thư tín.</para>
		...
		/// <para><strong>Description</strong>: Nhập khách hàng, người liên hệ, khách hàng tiềm năng hoặc người dùng nhận thư tín.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Số phiên bản của thư tín.</para>
