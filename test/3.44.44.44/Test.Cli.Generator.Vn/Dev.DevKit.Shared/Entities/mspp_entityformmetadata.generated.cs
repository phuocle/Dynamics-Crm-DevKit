...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class mspp_entityformmetadata : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Siêu dữ liệu biểu mẫu cơ bản";
		public const string DisplayName = "Siêu dữ liệu biểu mẫu cơ bản";
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.mspp_entityformmetadataOptionSets.mspp_descriptionposition.Ben_tren_truong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho biểu mẫu thực thể liên kết với siêu dữ liệu biểu mẫu thực thể.</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của siêu dữ liệu biểu mẫu cơ bản</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của siêu dữ liệu biểu mẫu cơ bản</para>
