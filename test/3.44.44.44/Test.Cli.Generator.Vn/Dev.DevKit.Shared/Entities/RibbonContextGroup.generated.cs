...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RibbonContextGroup : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Nhóm bối cảnh ruy băng";
		public const string DisplayName = "Nhóm bối cảnh ruy băng";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Id của nhóm thẻ ngữ cảnh.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: XML bố cục dành cho đề mục nhóm bối cảnh</para>
