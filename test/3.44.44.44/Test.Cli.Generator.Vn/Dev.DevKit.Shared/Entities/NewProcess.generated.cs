...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class NewProcess : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "NewProcesses";
		public const string EntityDisplayCollectionName = "Quy trình mới";
		public const string DisplayName = "Quy trình mới";
		...
		/// <summary>
		/// Instance new late bound class <see cref="NewProcess"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public NewProcess(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="NewProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public NewProcess(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new NewProcess(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="NewProcess"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public NewProcess(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new NewProcess(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Phiên bản Quy trình Mới</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của phiên bản thực thể Dòng Quy trình Công việc trong Quy trình Mới</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của Bài viết trong Cơ sở kiến thức liên kết với phiên bản Dòng Quy trình Công việc.</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKit.Shared.Entities.NewProcessOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.NewProcessOptionSets.StateCode.Hien_hoat"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKit.Shared.Entities.NewProcessOptionSets.StatusCode"/></para>
