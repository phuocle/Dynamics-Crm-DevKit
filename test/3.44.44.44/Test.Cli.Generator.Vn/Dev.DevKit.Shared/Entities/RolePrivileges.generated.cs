...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RolePrivileges : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Description</strong>: Thuộc tính do hệ thống tạo ra, lưu trữ quyền liên kết đến vai trò.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của quyền đã liên kết với vai trò.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của vai trò đã liên kết với quyền vai trò.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid? RoleId
		...
		/// <summary>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của quyền vai trò.</para>
