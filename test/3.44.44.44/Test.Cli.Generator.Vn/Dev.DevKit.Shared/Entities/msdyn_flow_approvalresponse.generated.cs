...
namespace Dev.DevKit.Shared.Entities.msdyn_flow_approvalresponseOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Đã cam kết</para>
		/// <para><strong>Value</strong>: 192,350,002</para>
		/// <para><strong>StateCode.Khong_hoat_dong</strong></para>
		/// </summary>
		Da_cam_ket = 192_350_002,
		/// <summary>
		/// <para><strong>Display Name</strong>: Đã lưu</para>
		/// <para><strong>Value</strong>: 192,350,001</para>
		/// <para><strong>StateCode.Hien_hoat</strong></para>
		/// </summary>
		Da_luu = 192_350_001,
		/// <summary>
		/// <para><strong>Display Name</strong>: Đang đánh giá</para>
		/// <para><strong>Value</strong>: 192,350,000</para>
		/// <para><strong>StateCode.Hien_hoat</strong></para>
		/// </summary>
		Dang_danh_gia = 192_350_000
	}
}
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_flow_approvalresponse : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Phản hồi Phê duyệt";
		public const string DisplayName = "Phản hồi Phê duyệt";
		...
		/// <para><strong>Description</strong>: Nhận xét của chủ sở hữu.</para>
		...
		/// <para><strong>Description</strong>: Tên phản hồi phê duyệt.</para>
		...
		/// <para><strong>Description</strong>: Phản hồi của chủ sở hữu.</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Trạng thái của Phản hồi Phê duyệt</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của phản hồi.</para>
