...
namespace Dev.DevKit.Shared.Entities.ConvertRuleOptionSets
{
	...
	public enum SourceTypeCode
	{
		...
		Email = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: Giám sát mạng xã hội</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ConvertRule : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Quy tắc tạo và cập nhật bản ghi";
		public const string DisplayName = "Quy tắc tạo và cập nhật bản ghi";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cho phép Người gửi Không xác định</para>
		/// <para><strong>Description</strong>: Chọn có chuyển đổi thành bản ghi hay không cho những mục từ người gửi không xác định.</para>
		...
		/// <para><strong>Description</strong>: nhóm thuộc tính kênh được liên kết với quy tắc chuyển đổi.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Kiểm tra Thỏa thuận Cấp độ Dịch vụ Hiện hoạt</para>
		/// <para><strong>Description</strong>: Chọn có tạo trường hợp hay không cho khách hàng có quyền được hưởng hiện hoạt.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chọn hồ sơ xã hội trong danh sách bị chặn</para>
		/// <para><strong>Description</strong>: Thông tin về việc có cần tạo bản ghi hay không cho các hồ sơ thuộc mạng xã hội bị ghi vào danh sách bị chặn.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chỉ tạo bản ghi cho thư cá nhân</para>
		/// <para><strong>Description</strong>: Thông tin về việc có cần tạo bản ghi hay không cho thư trực tiếp.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chọn Nếu đã Giải quyết</para>
		/// <para><strong>Description</strong>: Chọn chuyển đổi thành trường hợp hay không cho mục liên quan đến trường hợp đã giải quyết.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhập thông tin bổ sung để mô tả quy tắc tạo bản ghi tự động.</para>
		...
		/// <para><strong>Description</strong>: Nhập tiêu đề hoặc tên của hàng đợi có thiết đặt được xác định.</para>
		...
		/// <para><strong>Description</strong>: Cho biết đơn vị kinh doanh của chủ sở hữu quy tắc chuyển đổi.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phiên bản bản ghi</para>
		/// <para><strong>Description</strong>: Phiên bản bản ghi</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Đã giải quyết Kể từ</para>
		/// <para><strong>Description</strong>: Nếu bạn muốn tạo trường hợp mới cho một mục kết hợp với trường hợp đã được giải quyết, hãy nhập khoảng thời gian trường hợp phải duy trì trạng thái đã giải quyết trước khi tạo trường hợp mới cho mục được liên kết.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Mẫu Email Phản hồi</para>
		/// <para><strong>Description</strong>: Chọn mẫu email để sử dụng cho việc tạo phản hồi tự động cho khách hàng.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Gửi Phản hồi Tự động</para>
		/// <para><strong>Description</strong>: Chọn có gửi phản hồi email tự động cho khách hàng sau khi tạo bản ghi hay không.</para>
		/// <para><strong>Two Option</strong> - [<strong>Có</strong>]: true - [<strong>Không</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Không</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Xác định hoạt động Dynamics 365 là nguồn của bản ghi.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại nguồn</para>
		/// <para><strong>Description</strong>: Nguồn của bản ghi.</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của Quy tắc Chuyển đổi.</para>
		...
		/// <para><strong>Description</strong>: Lý do cho trạng thái của Quy tắc Chuyển đổi</para>
		...
		/// <para><strong>Description</strong>: Số phiên bản của quy tắc chuyển đổi.</para>
