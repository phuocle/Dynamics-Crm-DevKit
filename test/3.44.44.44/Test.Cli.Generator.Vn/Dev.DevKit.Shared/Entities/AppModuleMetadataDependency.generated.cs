...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class AppModuleMetadataDependency : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Bộ sưu tập Quan hệ phụ thuộc Siêu dữ liệu AppModule";
		public const string DisplayName = "Quan hệ phụ thuộc Siêu dữ liệu AppModule";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Quan hệ phụ thuộc Siêu dữ liệu AppModule</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Thành phần Phụ thuộc</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Nội bộ của Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại phụ của Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phiên bản Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Chỉ sử dụng nội bộ.</para>
