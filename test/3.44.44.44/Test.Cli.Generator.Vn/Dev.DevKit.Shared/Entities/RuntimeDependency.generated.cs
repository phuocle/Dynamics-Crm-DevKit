...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class RuntimeDependency : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại Nút Thành phần Phụ thuộc</para>
		/// <para><strong>Description</strong>: Loại Nút Thành phần Phụ thuộc</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngày tạo</para>
		/// <para><strong>Description</strong>: Ngày và giờ sửa đổi cấu phần cần thiết.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của nút cấu phần cần thiết.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại Nút Cấu phần Cần thiết</para>
		/// <para><strong>Description</strong>: Loại Nút Cấu phần Cần thiết</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
