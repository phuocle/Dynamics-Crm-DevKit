...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class workflowbinary : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Dữ liệu nhị phân quy trình làm việc";
		public const string DisplayName = "Dữ liệu nhị phân quy trình làm việc";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Id phiên dòng</para>
		/// <para><strong>Description</strong>: ID được liên kết với hoạt động chạy quy trình</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của dữ liệu nhị phân quy trình làm việc</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của dữ liệu nhị phân quy trình làm việc</para>
