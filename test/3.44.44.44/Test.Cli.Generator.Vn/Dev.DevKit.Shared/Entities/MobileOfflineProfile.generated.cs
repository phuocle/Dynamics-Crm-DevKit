...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class MobileOfflineProfile : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Các cấu hình Mobile Offline";
		public const string DisplayName = "Cấu hình Mobile Offline";
		...
		/// <para><strong>Description</strong>: Nhập mô tả của cấu hình Mobile Offline.</para>
		...
		/// <para><strong>Description</strong>: Phiên bản trong đó Cấu hình Mobile Offline được giới thiệu.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Đã được xác thực chưa</para>
		/// <para><strong>Description</strong>: Thông tin về việc cấu hình đã được xác thực hay chưa</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của cấu hình Mobile Offline.</para>
		...
		/// <para><strong>Description</strong>: Nhập tên của cấu hình Mobile Offline.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất của tổ chức liên kết với Cấu hình Mobile Offline.</para>
		...
		/// <para><strong>Description</strong>: Số phiên bản của Cấu hình Mobile Offline.</para>
