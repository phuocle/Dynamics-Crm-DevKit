...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class mspp_website : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Các website";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Ngôn ngữ mặc định</para>
		/// <para><strong>Description</strong>: Tra cứu ngôn ngữ website – ngôn ngữ mặc định hiện tại của website</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Mẫu chân trang</para>
		/// <para><strong>Description</strong>: Mẫu web để dùng làm nội dung chân trang của website.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Mẫu đầu trang</para>
		/// <para><strong>Description</strong>: Mẫu web để dùng làm nội dung đầu trang của website.</para>
		/// <para><strong>Lookup</strong>: <see cref="mspp_webtemplate"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Website chính</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho website được liên kết với website.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phiên bản website</para>
		/// <para><strong>Description</strong>: Phiên bản của bản ghi website</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của website</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của website</para>
