...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ActivityPointer : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Hoạt động";
		public const string DisplayName = "Hoạt động";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tất cả Bên Hoạt động</para>
		/// <para><strong>Description</strong>: Tất cả các bên hoạt động liên kết với hoạt động này.</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.ActivityPointerOptionSets.DeliveryPriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Thời gian kết thúc đã lên lịch đã được định dạng của hoạt động.</para>
		...
		/// <para><strong>Description</strong>: Thời gian bắt đầu đã lên lịch đã được định dạng của hoạt động.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: TimeZoneIndependent - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.ActivityPointerOptionSets.InstanceTypeCode.Khong_Lap_lai"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.ActivityPointerOptionSets.PriorityCode.Binh_thuong"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.ActivityPointerOptionSets.StateCode.Mo"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
