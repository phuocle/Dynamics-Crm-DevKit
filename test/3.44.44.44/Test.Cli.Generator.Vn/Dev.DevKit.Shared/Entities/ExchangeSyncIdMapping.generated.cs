...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class ExchangeSyncIdMapping : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Ánh xạ Id Đồng bộ Exchange";
		public const string DisplayName = "Ánh xạ Id Đồng bộ Exchange";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Exchange</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Chủ đề mục</para>
		...
		/// <para><strong>Description</strong>: Thời gian Lỗi Đồng bộ Lần cuối</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID CRM</para>
