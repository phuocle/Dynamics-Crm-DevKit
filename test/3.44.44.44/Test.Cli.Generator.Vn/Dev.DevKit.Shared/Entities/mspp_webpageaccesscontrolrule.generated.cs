...
namespace Dev.DevKit.Shared.Entities.mspp_webpageaccesscontrolruleOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Cho phép thay đổi</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Cho_phep_thay_doi = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Hạn chế đọc</para>
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Loại trừ các tệp web con trực tiếp</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Loai_tru_cac_tep_web_con_truc_tiep = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: Tất cả nội dung</para>
		/// <para><strong>Value</strong>: 1</para>
		/// </summary>
		Tat_ca_noi_dung = 1
	}
...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class mspp_webpageaccesscontrolrule : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Quy tắc kiểm soát quyền truy cập trang web";
		public const string DisplayName = "Quy tắc kiểm soát quyền truy cập trang web";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Có quyền</para>
		...
		/// <para><strong>Description</strong>: Tất cả các tệp web con có liên quan trực tiếp đến trang web này sẽ bị loại trừ khỏi quá trình xác thực bảo mật. Điều này không loại trừ hậu duệ của nội dung con.</para>
		...
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Shared.Entities.mspp_webpageaccesscontrolruleOptionSets.mspp_scope.Tat_ca_noi_dung"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho trang web được liên kết với quy tắc kiểm soát quyền truy cập trang web.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho website được liên kết với quy tắc kiểm soát quyền truy cập trang web.</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của quy tắc kiểm soát quyền truy cập trang web</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của quy tắc kiểm soát quyền truy cập trang web</para>
