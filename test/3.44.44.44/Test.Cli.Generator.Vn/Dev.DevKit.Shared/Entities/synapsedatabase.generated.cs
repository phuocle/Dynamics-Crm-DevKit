...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class synapsedatabase : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Cơ sở dữ liệu Synapse";
		public const string DisplayName = "Cơ sở dữ liệu Synapse";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tên cơ sở dữ liệu</para>
		/// <para><strong>Description</strong>: Tên cơ sở dữ liệu Synapse.</para>
		...
		/// <para><strong>Description</strong>: Mã định danh duy nhất cho Thư mục Data Lake liên kết với Cơ sở dữ liệu Synapse.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Điểm cuối phát triển</para>
		/// <para><strong>Description</strong>: Điểm cuối phát triển cho cơ sở dữ liệu Synapse này.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID kết nối Kho dữ liệu</para>
		/// <para><strong>Description</strong>: ID kết nối cho Kho dữ liệu chứa lối tắt đến bảng.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID Kho dữ liệu</para>
		/// <para><strong>Description</strong>: ID cho Kho dữ liệu chứa lối tắt đến bảng.</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: ID không gian làm việc Kho dữ liệu</para>
		/// <para><strong>Description</strong>: ID cho không gian làm việc Power BI chứa Kho dữ liệu</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhóm nguồn lực Azure của cơ sở dữ liệu Synapse.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tiền tố sơ đồ</para>
		/// <para><strong>Description</strong>: Tiền tố sơ đồ để sử dụng cho tên bảng</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Điểm cuối Sql không máy chủ</para>
		/// <para><strong>Description</strong>: Điểm cuối Sql không máy chủ của cơ sở dữ liệu Synapse.</para>
		/// <para>Required - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cấu hình cụm tác vụ Spark</para>
		/// <para><strong>Description</strong>: Cấu hình cụm tác vụ Spark</para>
		...
		/// <para><strong>Description</strong>: Trạng thái của Cơ sở dữ liệu Synapse</para>
		...
		/// <para><strong>Description</strong>: Lý do dẫn đến trạng thái của Cơ sở dữ liệu Synapse</para>
		...
		/// <para><strong>Description</strong>: Gói đăng ký Azure cho cơ sở dữ liệu Synapse</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Azure Tenant của cơ sở dữ liệu Synapse</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tên không gian làm việc</para>
		/// <para><strong>Description</strong>: Tên không gian làm việc của cơ sở dữ liệu Synapse.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
