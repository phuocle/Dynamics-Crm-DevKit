...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class EntityDataProvider : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Nhà cung cấp Dữ liệu Thực thể Ảo";
		public const string DisplayName = "Nhà cung cấp Dữ liệu Thực thể Ảo";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tạo Phần bổ trợ</para>
		/// <para><strong>Description</strong>: Tạo Phần bổ trợ</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Tên lôgic của Thực thể Nguồn Dữ liệu</para>
		/// <para><strong>Description</strong>: Khi tạo một Nhà cung cấp Dữ liệu, người dùng cuối phải kiểm tra tên của thực thể Nguồn Dữ liệu sẽ được tạo cho nhà cung cấp.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Xóa Phần bổ trợ</para>
		/// <para><strong>Description</strong>: Xóa Phần bổ trợ</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Nhà cung cấp Dữ liệu này được dùng để làm gì và các công nghệ kho dữ liệu mà nhà cung cấp đó nhắm tới là gì?</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Nhà cung cấp Dữ liệu</para>
		/// <para><strong>Description</strong>: Mã định danh duy nhất của nhà cung cấp dữ liệu.</para>
		...
		/// <para><strong>Description</strong>: Tên của Nhà cung cấp Dữ liệu. Tên này xuất hiện trong danh sách thả xuống khi tạo một thực thể mới.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Đa Truy xuất Phần bổ trợ</para>
		/// <para><strong>Description</strong>: Đa Truy xuất Phần bổ trợ</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Truy xuất Phần bổ trợ</para>
		/// <para><strong>Description</strong>: Truy xuất Phần bổ trợ</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cập nhật Phần bổ trợ</para>
		/// <para><strong>Description</strong>: Cập nhật Phần bổ trợ</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
