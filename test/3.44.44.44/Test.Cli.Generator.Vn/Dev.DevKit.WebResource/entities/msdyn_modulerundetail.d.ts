...
declare namespace DevKit {
	class msdyn_modulerundetailApi {
		/**
		* DynamicsCrm.DevKit msdyn_modulerundetailApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_modulerundetail.ComponentState;
		...
		msdyn_QueuedTime_UtcDateAndTime: Date;
		...
		statecode: OptionSet.msdyn_modulerundetail.statecode;
		/** Reason for the status of the ModuleRunDetail */
		statuscode: OptionSet.msdyn_modulerundetail.statuscode;
		/** For internal use only. */
...
declare namespace OptionSet {
	namespace msdyn_modulerundetail {
		enum ComponentState {
			/** 0 */
			Da_phat_hanh,
			/** 2 */
