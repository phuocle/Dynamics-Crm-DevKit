...
(function (DevKit) {
	...
	DevKit.packageApi = function (e) {
		...
		for (var field in _package) {
			var a = _package[field].a;
			var b = _package[field].b;
			var c = _package[field].c;
			var d = _package[field].d;
			var g = _package[field].g;
			var r = _package[field].r;
			webApiField(package, field, e, a, b, c, d, r, u, g);
		}
		package.Entity = u;
