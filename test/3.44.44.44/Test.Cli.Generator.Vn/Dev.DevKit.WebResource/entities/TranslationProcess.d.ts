...
declare namespace DevKit {
	namespace FormTranslationProcess {
		...
		interface Navigation {
			lk_translationprocess_workflowlogs: DevKit.Controls.NavigationItem
		}
	}
	class FormTranslationProcess extends DevKit.IForm {
		/**
		* TranslationProcess [Main Form]
		...
		*/
		...
		/** The Navigation of form TranslationProcess */
		Navigation: DevKit.FormTranslationProcess.Navigation;
	...
	class TranslationProcessApi {
		...
		*/
		...
		StateCode: OptionSet.TranslationProcess.StateCode;
		/** Chọn trạng thái bản ghi hành động delve. */
		StatusCode: OptionSet.TranslationProcess.StatusCode;
