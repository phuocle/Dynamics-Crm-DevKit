...
declare namespace DevKit {
	class msdyn_AITemplateApi {
		...
		*/
		...
		readonly ComponentState: OptionSet.msdyn_AITemplate.ComponentState;
		...
		statecode: OptionSet.msdyn_AITemplate.statecode;
		/** Reason for the status of the AITemplate */
		statuscode: OptionSet.msdyn_AITemplate.statuscode;
		/** For internal use only. */
