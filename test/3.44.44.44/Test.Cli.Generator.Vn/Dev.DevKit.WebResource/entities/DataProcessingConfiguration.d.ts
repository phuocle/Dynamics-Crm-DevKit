...
declare namespace DevKit {
	class DataProcessingConfigurationApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.DataProcessingConfiguration.ComponentState;
		...
		ModuleType: OptionSet.DataProcessingConfiguration.ModuleType;
		...
		statecode: OptionSet.DataProcessingConfiguration.statecode;
		/** Lý do dẫn đến trạng thái của cấu hình Xử lý dữ liệu */
		statuscode: OptionSet.DataProcessingConfiguration.statuscode;
		/** For internal use only. */
