...
declare namespace DevKit {
	class componentversionnrddatasourceApi {
		/**
		* DynamicsCrm.DevKit componentversionnrddatasourceApi
		...
		*/
		...
		Operation: OptionSet.componentversionnrddatasource.Operation;
...
declare namespace OptionSet {
	namespace componentversionnrddatasource {
