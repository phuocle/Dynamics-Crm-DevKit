...
declare namespace DevKit {
	class msdyn_dmssyncstatusApi {
		/**
		* DynamicsCrm.DevKit msdyn_dmssyncstatusApi
		...
		*/
		...
		msdyn_lookupfield_dmssyncrequest: string;
		/** Sync Start Time */
		...
		statecode: OptionSet.msdyn_dmssyncstatus.statecode;
		/** Reason for the status of the DMS Sync Status */
		statuscode: OptionSet.msdyn_dmssyncstatus.statuscode;
