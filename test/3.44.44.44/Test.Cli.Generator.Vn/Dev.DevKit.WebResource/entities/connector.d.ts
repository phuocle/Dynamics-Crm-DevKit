...
declare namespace DevKit {
	namespace FormThong_tin {
		...
		interface Navigation {
			AIPlugin_connector_connector: DevKit.Controls.NavigationItem,
			connector_connectionreference: DevKit.Controls.NavigationItem,
			lk_connectioninstance_connectorid: DevKit.Controls.NavigationItem
		}
	}
