...
declare namespace DevKit {
	class msdyn_dataflow_datalakefolderApi {
		/**
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dataflow_datalakefolder.ComponentState;
		...
		statecode: OptionSet.msdyn_dataflow_datalakefolder.statecode;
		/** Reason for the status of the Dataflow DatalakeFolder */
		statuscode: OptionSet.msdyn_dataflow_datalakefolder.statuscode;
		/** For internal use only. */
