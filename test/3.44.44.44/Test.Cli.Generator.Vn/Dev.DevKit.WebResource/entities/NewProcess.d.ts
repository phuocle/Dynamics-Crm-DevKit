...
declare namespace DevKit {
	namespace FormNewProcesses {
		...
		interface Navigation {
			lk_newprocess_workflowlogs: DevKit.Controls.NavigationItem
		}
	}
	class FormNewProcesses extends DevKit.IForm {
		/**
		* NewProcesses [Main Form]
		...
		*/
		...
		/** The Body section of form NewProcesses */
		Body: DevKit.FormNewProcesses.Body;
		/** The Navigation of form NewProcesses */
		Navigation: DevKit.FormNewProcesses.Navigation;
		/** The SidePanes of form NewProcesses */
		SidePanes: DevKit.SidePanes;
	}
	class NewProcessApi {
		/**
		* DynamicsCrm.DevKit NewProcessApi
		...
		*/
		...
		/** Mã định danh duy nhất của phiên bản thực thể Dòng Quy trình Công việc trong Quy trình Mới */
		...
		/** Mã định danh duy nhất của Bài viết trong Cơ sở kiến thức liên kết với phiên bản Dòng Quy trình Công việc. */
		...
		StateCode: OptionSet.NewProcess.StateCode;
		/** Chọn trạng thái bản ghi hành động delve. */
		StatusCode: OptionSet.NewProcess.StatusCode;
