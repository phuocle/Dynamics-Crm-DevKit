...
(function (DevKit) {
	...
	DevKit.InvalidDependencyApi = function (e) {
		...
		for (var field in _invaliddependency) {
			var a = _invaliddependency[field].a;
			var b = _invaliddependency[field].b;
			var c = _invaliddependency[field].c;
			var d = _invaliddependency[field].d;
			var g = _invaliddependency[field].g;
			var r = _invaliddependency[field].r;
			webApiField(invaliddependency, field, e, a, b, c, d, r, u, g);
		}
