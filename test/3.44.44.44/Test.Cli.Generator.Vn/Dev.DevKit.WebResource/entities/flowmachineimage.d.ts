...
declare namespace DevKit {
	class flowmachineimageApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.flowmachineimage.ComponentState;
		...
		/** Nguồn của hình ảnh */
		source: OptionSet.flowmachineimage.source;
		/** Trạng thái của Hình ảnh máy trong dòng quy trình */
		statecode: OptionSet.flowmachineimage.statecode;
		/** Lý do dẫn đến trạng thái của Hình ảnh máy trong dòng quy trình */
		statuscode: OptionSet.flowmachineimage.statuscode;
		/** For internal use only. */
