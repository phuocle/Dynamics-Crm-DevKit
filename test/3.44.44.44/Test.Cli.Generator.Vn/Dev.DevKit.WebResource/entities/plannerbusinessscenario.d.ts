...
declare namespace DevKit {
	class plannerbusinessscenarioApi {
		/**
		* DynamicsCrm.DevKit plannerbusinessscenarioApi
		...
		*/
		...
		statecode: OptionSet.plannerbusinessscenario.statecode;
		/** Reason for the status of the Planner Business Scenario */
		statuscode: OptionSet.plannerbusinessscenario.statuscode;
		SyncEnabled: boolean;
...
declare namespace OptionSet {
	namespace plannerbusinessscenario {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
