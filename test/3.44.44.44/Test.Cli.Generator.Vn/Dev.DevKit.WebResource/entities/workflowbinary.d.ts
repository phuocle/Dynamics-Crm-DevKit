...
declare namespace DevKit {
	class workflowbinaryApi {
		/**
		* DynamicsCrm.DevKit workflowbinaryApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.workflowbinary.ComponentState;
		...
		statecode: OptionSet.workflowbinary.statecode;
		/** Lý do dẫn đến trạng thái của dữ liệu nhị phân quy trình làm việc */
		statuscode: OptionSet.workflowbinary.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Mã định danh duy nhất của phiên bản thực thể */
			readonly workflowbinaryId: string;
		}
	}
}
declare namespace OptionSet {
	namespace workflowbinary {
		enum ComponentState {
			/** 0 */
			Da_phat_hanh,
			/** 2 */
