...
declare namespace DevKit {
	namespace FormThong_tin {
		...
		interface Body {
			...
			/** Nhập thông tin bổ sung để mô tả bản đồ dữ liệu, chẳng hạn như mục đích sử dụng hoặc nguồn dữ liệu. */
			...
			/** Nhập tên mô tả cho bản đồ dữ liệu. */
		...
		interface Navigation {
			ImportMap_ImportFile: DevKit.Controls.NavigationItem
		}
	}
	...
	class ImportMapApi {
		...
		*/
		...
		"@odata.etag": string;
		/** Chỉ sử dụng nội bộ. */
		readonly ComponentState: OptionSet.ImportMap.ComponentState;
		/** Cho biết người tạo bản ghi. */
		...
		/** Nhập thông tin bổ sung để mô tả bản đồ dữ liệu, chẳng hạn như mục đích sử dụng hoặc nguồn dữ liệu. */
		Description: string;
		/** Chọn liệu tệp dữ liệu có thể chứa dữ liệu cho một hoặc nhiều loại bản ghi không. */
		EntitiesPerFile: OptionSet.ImportMap.EntitiesPerFile;
		/** Mã định danh duy nhất của bản đồ dữ liệu. */
		ImportMapId: string;
		/** Mã định danh duy nhất của ImportMap. */
		readonly ImportMapIdUnique: string;
		/** Chọn loại bản đồ dữ liệu để phân biệt bản đồ dữ liệu dùng ngay với bản đồ tùy chỉnh. */
		ImportMapType: OptionSet.ImportMap.ImportMapType;
		/** Phiên bản có thành phần được đưa vào. */
		IntroducedVersion: string;
		/** Thông tin chỉ định khả năng quản lý thành phần này. */
		readonly IsManaged: boolean;
		/** Thông tin về việc liệu bản đồ dữ liệu có hợp lệ để sử dụng với công việc nhập dữ liệu hay không. */
		readonly IsValidForImport: boolean;
		/** Thông tin về việc liệu bản đồ dữ liệu này có được tạo bởi Trình quản lý Di chuyển Dữ liệu không. */
		...
		OwnerId_team: string;
		/** Đơn vị kinh doanh sở hữu bản đồ dữ liệu. */
		readonly OwningBusinessUnit: string;
		/** Mã định danh duy nhất của nhóm sở hữu bản đồ dữ liệu. */
		readonly OwningTeam: string;
		/** Mã định danh duy nhất của người dùng sở hữu bản đồ dữ liệu. */
		readonly OwningUser: string;
		/** Mã định danh duy nhất của giải pháp được liên kết. */
		readonly SolutionId: string;
		/** Nhập tên của nguồn di chuyển sử dụng bản đồ dữ liệu này. */
		Source: string;
		/** Chọn loại nguồn di chuyển sử dụng bản đồ dữ liệu này. */
		SourceType: OptionSet.ImportMap.SourceType;
		...
		/** Cột trong tệp nguồn xác định duy nhất người dùng. */
		SourceUserIdentifierForSourceDataSourceUserLink: string;
		/** Cho biết bản đồ dữ liệu đang ở trạng thái hiện hoạt hay không hoạt động. Các bản đồ dữ liệu không hoạt động ở dạng chỉ đọc và không thể chỉnh sửa được. */
		StateCode: OptionSet.ImportMap.StateCode;
		/** Chọn trạng thái của bản đồ dữ liệu. */
		StatusCode: OptionSet.ImportMap.StatusCode;
		/** Chỉ sử dụng nội bộ. */
		readonly SupportingSolutionId: string;
		/** Chọn tên của loại bản ghi Microsoft Dynamics 365 mà bản đồ dữ liệu này được xác định cho loại đó. */
		readonly TargetEntity: OptionSet.ImportMap.TargetEntity;
		/** Người dùng Microsoft Dynamics 365. */
...
declare namespace OptionSet {
	namespace ImportMap {
		...
		enum EntitiesPerFile {
			/** 1 */
			Mot_Thuc_the_moi_Tep,
			/** 2 */
			Nhieu_Thuc_the_moi_Tep
		}
		enum ImportMapType {
			/** 1 */
			Chuan,
		...
		enum SourceType {
			/** 5 */
			Ban_do_Chung_cho_Nguoi_lien_he_va_Khach_hang,
			/** 3 */
			Ban_do_de_Xuat_Bao_cao_Nguoi_lien_he_va_Khach_hang_tren_SalesForcecom,
			/** 2 */
			Ban_do_de_Xuat_Bao_cao_tren_SalesForcecom,
			/** 1 */
			Ban_do_de_Xuat_Du_lieu_Day_du_tren_SalesForcecom,
			/** 4 */
			Microsoft_Office_Outlook_2010_kem_Business_Contact_Manager
		}
		enum StateCode {
			/** 0 */
			Hien_hoat,
