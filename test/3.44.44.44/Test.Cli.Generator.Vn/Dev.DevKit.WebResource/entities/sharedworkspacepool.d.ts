...
declare namespace DevKit {
	class sharedworkspacepoolApi {
		/**
		* DynamicsCrm.DevKit sharedworkspacepoolApi
		...
		*/
		...
		statecode: OptionSet.sharedworkspacepool.statecode;
		/** Reason for the status of the Shared Workspace Pool */
		statuscode: OptionSet.sharedworkspacepool.statuscode;
		/** Storage Endpoint */
