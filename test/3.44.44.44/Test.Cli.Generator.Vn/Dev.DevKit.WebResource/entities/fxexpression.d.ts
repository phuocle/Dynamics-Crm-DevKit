...
declare namespace DevKit {
	class fxexpressionApi {
		...
		*/
		...
		"@odata.etag": string;
		Category: OptionSet.fxexpression.Category;
		CompiledExpression: string;
		/** For internal use only. */
		readonly ComponentIdUnique: string;
		/** For internal use only. */
		readonly ComponentState: OptionSet.fxexpression.ComponentState;
		Context: string;
		...
		statecode: OptionSet.fxexpression.statecode;
		/** Reason for the status of the FxExpression */
		statuscode: OptionSet.fxexpression.statuscode;
		/** For internal use only. */
