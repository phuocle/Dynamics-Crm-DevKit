...
declare namespace DevKit {
	class msdyn_dmsrequestApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_dmsrequest.ComponentState;
		...
		statecode: OptionSet.msdyn_dmsrequest.statecode;
		/** Reason for the status of the msdyn_dmsrequest */
		statuscode: OptionSet.msdyn_dmsrequest.statuscode;
		/** For internal use only. */
