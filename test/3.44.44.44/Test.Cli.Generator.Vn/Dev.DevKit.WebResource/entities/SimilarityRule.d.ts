...
declare namespace DevKit {
	class SimilarityRuleApi {
		...
		*/
		...
		/** Loại bản ghi của bản ghi đang được đánh giá về khả năng tương tự. */
		readonly BaseEntityTypeCode: OptionSet.SimilarityRule.BaseEntityTypeCode;
		/** Chỉ sử dụng nội bộ. */
		readonly ComponentState: OptionSet.SimilarityRule.ComponentState;
		...
		/** Loại bản ghi của bản ghi đang được đánh giá là bản ghi có khả năng tương tự. */
		readonly MatchingEntityTypeCode: OptionSet.SimilarityRule.MatchingEntityTypeCode;
		...
		statecode: OptionSet.SimilarityRule.statecode;
		/** Lý do cho trạng thái của Quy tắc Tương tự */
		statuscode: OptionSet.SimilarityRule.statuscode;
		/** Chỉ sử dụng nội bộ. */
