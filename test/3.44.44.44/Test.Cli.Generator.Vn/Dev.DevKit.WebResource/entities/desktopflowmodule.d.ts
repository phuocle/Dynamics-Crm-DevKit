...
declare namespace DevKit {
	class desktopflowmoduleApi {
		/**
		* DynamicsCrm.DevKit desktopflowmoduleApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.desktopflowmodule.ComponentState;
		...
		statecode: OptionSet.desktopflowmodule.statecode;
		/** Lý do dẫn đến trạng thái của DesktopFlowModule */
		statuscode: OptionSet.desktopflowmodule.statuscode;
		/** For internal use only. */
		readonly SupportingSolutionId: string;
		/** Chỉ sử dụng nội bộ. */
		TimeZoneRuleVersionNumber: number;
		/** Loại mô đun Dòng màn hình nền. */
		Type: OptionSet.desktopflowmodule.Type;
