...
declare namespace DevKit {
	class fabricaiskillApi {
		/**
		* DynamicsCrm.DevKit fabricaiskillApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.fabricaiskill.ComponentState;
		...
		statecode: OptionSet.fabricaiskill.statecode;
		/** Reason for the status of the Fabric AISkill. */
		statuscode: OptionSet.fabricaiskill.statuscode;
		/** For internal use only. */
