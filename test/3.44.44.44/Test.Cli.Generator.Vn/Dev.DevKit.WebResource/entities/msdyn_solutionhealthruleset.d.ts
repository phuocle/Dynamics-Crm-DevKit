...
declare namespace DevKit {
	namespace FormThong_tin {
		...
		interface Navigation {
			msdyn_msdyn_solutionhealthruleset_msdyn_analysi: DevKit.Controls.NavigationItem,
			msdyn_msdyn_solutionhealthruleset_msdyn_solutio: DevKit.Controls.NavigationItem
		}
		interface Grid {
	...
	class msdyn_solutionhealthrulesetApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_solutionhealthruleset.statecode;
		/** Lý do dẫn đến trạng thái của Bộ Quy tắc Tình trạng Giải pháp */
		statuscode: OptionSet.msdyn_solutionhealthruleset.statuscode;
		/** Chỉ sử dụng nội bộ. */
