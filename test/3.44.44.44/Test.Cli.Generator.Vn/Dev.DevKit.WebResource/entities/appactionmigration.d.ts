...
declare namespace DevKit {
	class appactionmigrationApi {
		/**
		* DynamicsCrm.DevKit appactionmigrationApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.appactionmigration.ComponentState;
		...
		statecode: OptionSet.appactionmigration.statecode;
		/** Lý do dẫn đến trạng thái appactionmigration */
		statuscode: OptionSet.appactionmigration.statuscode;
		/** For internal use only. */
