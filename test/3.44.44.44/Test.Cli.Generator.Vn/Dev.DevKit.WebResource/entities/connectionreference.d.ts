...
declare namespace DevKit {
	class connectionreferenceApi {
		/**
		* DynamicsCrm.DevKit connectionreferenceApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.connectionreference.ComponentState;
		...
		PromptingBehavior: OptionSet.connectionreference.PromptingBehavior;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string;
		/** Trạng thái của tham chiếu kết nối */
		statecode: OptionSet.connectionreference.statecode;
		/** Lý do dẫn đến trạng thái của Tham chiếu kết nối */
		statuscode: OptionSet.connectionreference.statuscode;
		/** For internal use only. */
