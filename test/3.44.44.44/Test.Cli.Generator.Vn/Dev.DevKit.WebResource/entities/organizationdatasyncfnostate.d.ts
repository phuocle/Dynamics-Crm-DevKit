...
declare namespace DevKit {
	class organizationdatasyncfnostateApi {
		/**
		...
		*/
		...
		statecode: OptionSet.organizationdatasyncfnostate.statecode;
		/** Reason for the status of the OrganizationDataSyncFnoState */
		statuscode: OptionSet.organizationdatasyncfnostate.statuscode;
