...
declare namespace DevKit {
	namespace Formmsdyn_slakpi_Information {
		...
		interface Body {
			...
			WebResource_preview: DevKit.Controls.ELSE3???;//WebResource_preview - 6DC0B71D-E1F9-4118-8347-1CF35C38954D -- FOR DEBUG 
	...
	namespace FormSLA_KPI_Quick_Create {
		...
		interface Body {
			...
			/** Owner Id */
			OwnerId: DevKit.Controls.Lookup;
			WebResource_preview: DevKit.Controls.ELSE3???;//WebResource_preview - 6E4367D6-894A-42A1-BD75-BAE93B2F823D -- FOR DEBUG 
			WebResource_preview: DevKit.Controls.ELSE3???;//WebResource_preview - 9FDF5F91-88B1-47F4-AD53-C11EFC01A01E -- FOR DEBUG 
		}
	}
