...
declare namespace DevKit {
	class organizationdatasyncsubscriptionfnotableApi {
		/**
		...
		*/
		...
		"@odata.etag": string;
		BlobPartitionBy: OptionSet.organizationdatasyncsubscriptionfnotable.BlobPartitionBy;
		...
		statecode: OptionSet.organizationdatasyncsubscriptionfnotable.statecode;
		/** Reason for the status of the OrganizationDataSyncSubscriptionFnoTable */
		statuscode: OptionSet.organizationdatasyncsubscriptionfnotable.statuscode;
