...
declare namespace DevKit {
	...
	class AIPluginInstanceApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.AIPluginInstance.ComponentState;
		...
		/** Status of the AIPluginInstance */
		statecode: OptionSet.AIPluginInstance.statecode;
		/** Reason for the status of the AIPluginInstance */
		statuscode: OptionSet.AIPluginInstance.statuscode;
		/** For internal use only. */
