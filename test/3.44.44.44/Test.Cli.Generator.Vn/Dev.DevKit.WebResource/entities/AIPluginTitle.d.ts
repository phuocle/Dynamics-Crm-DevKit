...
declare namespace DevKit {
	class AIPluginTitleApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.AIPluginTitle.ComponentState;
		...
		statecode: OptionSet.AIPluginTitle.statecode;
		/** Reason for the status of the AIPluginTitle */
		statuscode: OptionSet.AIPluginTitle.statuscode;
		/** For internal use only. */
