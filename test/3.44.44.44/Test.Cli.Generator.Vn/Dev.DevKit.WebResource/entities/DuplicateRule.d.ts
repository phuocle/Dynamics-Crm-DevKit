...
declare namespace DevKit {
	namespace FormThong_tin {
		...
		interface Body {
			Tab: Tabs;
			/** Loại bản ghi của bản ghi đang được đánh giá về khả năng trùng lặp. */
			BaseEntityTypeCode: DevKit.Controls.OptionSet;
			/** Mã định danh duy nhất của người dùng đã tạo quy tắc phát hiện sự trùng lặp. */
			CreatedBy: DevKit.Controls.Lookup;
			/** Ngày và giờ tạo quy tắc phát hiện sự trùng lặp. */
			CreatedOn: DevKit.Controls.DateTime;
			/** Mô tả về quy tắc phát hiện sự trùng lặp. */
			Description: DevKit.Controls.String;
			/** Xác định có gắn cờ cho bản ghi không hoạt động là trùng lặp hay không */
			ExcludeInactiveRecords: DevKit.Controls.Boolean;
			/** Cho biết toán tử có phân biệt chữ hoa chữ thường hay không. */
			IsCaseSensitive: DevKit.Controls.Boolean;
			/** Loại bản ghi của bản ghi đang được đánh giá là bản ghi có khả năng trùng lặp. */
			MatchingEntityTypeCode: DevKit.Controls.OptionSet;
			/** Mã định danh duy nhất của người dùng đã sửa đổi quy tắc phát hiện sự trùng lặp lần cuối. */
			ModifiedBy: DevKit.Controls.Lookup;
			/** Ngày và giờ sửa đổi quy tắc phát hiện sự trùng lặp lần cuối. */
			ModifiedOn: DevKit.Controls.DateTime;
			/** Tên quy tắc phát hiện sự trùng lặp. */
			Name: DevKit.Controls.String;
			notescontrol: DevKit.Controls.Note;
			/** Mã định danh duy nhất của người dùng hoặc nhóm sở hữu quy tắc phát hiện sự trùng lặp. */
			OwnerId: DevKit.Controls.Lookup;
			ruleconditioncontrol: DevKit.Controls.IFrame;
			/** Lý do cho trạng thái của quy tắc phát hiện sự trùng lặp. */
	...
	class DuplicateRuleApi {
		...
		*/
		...
		"@odata.etag": string;
		/** Bảng cơ sở dữ liệu lưu trữ các mã đối chiếu cho loại bản ghi đang được đánh giá về khả năng trùng lặp. */
		readonly BaseEntityMatchCodeTable: string;
		/** Loại bản ghi của bản ghi đang được đánh giá về khả năng trùng lặp. */
		BaseEntityName: string;
		/** Loại bản ghi của bản ghi đang được đánh giá về khả năng trùng lặp. */
		readonly BaseEntityTypeCode: OptionSet.DuplicateRule.BaseEntityTypeCode;
		/** For internal use only. */
		readonly ComponentIdUnique: string;
		/** For internal use only. */
		readonly ComponentState: OptionSet.DuplicateRule.ComponentState;
		/** Mã định danh duy nhất của người dùng đã tạo quy tắc phát hiện sự trùng lặp. */
		readonly CreatedBy: string;
		/** Ngày và giờ tạo quy tắc phát hiện sự trùng lặp. */
		readonly CreatedOn_UtcDateAndTime: Date;
		/** Mã định danh duy nhất của người dùng đại diện đã tạo duplicaterule. */
		readonly CreatedOnBehalfBy: string;
		/** Mô tả về quy tắc phát hiện sự trùng lặp. */
		Description: string;
		/** Mã định danh duy nhất của quy tắc phát hiện sự trùng lặp. */
		...
		/** Bảng cơ sở dữ liệu lưu trữ các mã đối chiếu cho bản ghi có khả năng trùng lặp. */
		readonly MatchingEntityMatchCodeTable: string;
		/** Loại bản ghi của bản ghi đang được đánh giá là bản ghi có khả năng trùng lặp. */
		MatchingEntityName: string;
		/** Loại bản ghi của bản ghi đang được đánh giá là bản ghi có khả năng trùng lặp. */
		readonly MatchingEntityTypeCode: OptionSet.DuplicateRule.MatchingEntityTypeCode;
		/** Mã định danh duy nhất của người dùng đã sửa đổi quy tắc phát hiện sự trùng lặp lần cuối. */
		readonly ModifiedBy: string;
		/** Ngày và giờ sửa đổi quy tắc phát hiện sự trùng lặp lần cuối. */
		readonly ModifiedOn_UtcDateAndTime: Date;
		/** Mã định danh duy nhất của người dùng đại diện đã sửa đổi duplicaterule lần cuối. */
		...
		OwnerId_team: string;
		/** Mã định danh duy nhất của đơn vị kinh doanh sở hữu quy tắc phát hiện sự trùng lặp. */
		readonly OwningBusinessUnit: string;
		/** Mã định danh duy nhất của nhóm sở hữu quy tắc phát hiện sự trùng lặp. */
		readonly OwningTeam: string;
		/** Mã định danh duy nhất của người dùng sở hữu quy tắc phát hiện sự trùng lặp. */
		readonly OwningUser: string;
		/** Unique identifier of the associated solution. */
		readonly SolutionId: string;
		/** Trạng thái của quy tắc phát hiện sự trùng lặp. */
		readonly StateCode: OptionSet.DuplicateRule.StateCode;
		/** Lý do cho trạng thái của quy tắc phát hiện sự trùng lặp. */
		StatusCode: OptionSet.DuplicateRule.StatusCode;
		/** For internal use only. */
