...
declare namespace DevKit {
	class EntityImageConfigApi {
		/**
		* DynamicsCrm.DevKit EntityImageConfigApi
		...
		*/
		...
		/** Chỉ sử dụng nội bộ. */
		readonly ComponentState: OptionSet.EntityImageConfig.ComponentState;
