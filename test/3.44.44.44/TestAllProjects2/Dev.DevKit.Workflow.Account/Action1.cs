...
{
    [CrmPluginRegistration("Action1", "Action1", "", "Dev.DevKit.Workflow.Account", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class Action1 : CodeActivity
    {
