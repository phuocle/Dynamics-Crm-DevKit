...
{
    [CrmPluginRegistration("Action2", "Action2", "", "Dev.DevKit.Workflow.Account", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class Action2 : CodeActivity
    {
