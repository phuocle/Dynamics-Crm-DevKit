...
{
    [CrmPluginRegistration("devkit_DebugCustomAction", "none", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.CustomAction.Account.PostNonedevkit_DebugCustomActionAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
    public class PostNonedevkit_DebugCustomActionAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostNonedevkit_DebugCustomActionAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
