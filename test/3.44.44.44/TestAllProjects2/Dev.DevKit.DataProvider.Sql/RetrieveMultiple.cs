...
namespace Dev.DevKit.DataProvider.Sql
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider.Sql.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "devkit_sqldatasource")]
