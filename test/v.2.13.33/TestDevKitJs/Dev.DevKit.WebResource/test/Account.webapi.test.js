...
define(['xrm-mock', 'sinon'], function () {
    ...
    describe('WebApi Retreive', () => {
        ...
        it('WebApi Retreive', async () => {
            //setup
            var json = "{\"entities\":[{\"@odata.etag\":\"W/\\\"1012533\\\"\",\"telephone1\":\"555-0158\",\"numberofemployees@OData.Community.Display.V1.FormattedValue\":\"6,200\",\"numberofemployees\":6200,\"industrycode@OData.Community.Display.V1.FormattedValue\":\"Brokers\",\"industrycode\":4,\"statecode@OData.Community.Display.V1.FormattedValue\":\"Active\",\"statecode\":0,\"statuscode@OData.Community.Display.V1.FormattedValue\":\"Active\",\"statuscode\":1,\"donotemail@OData.Community.Display.V1.FormattedValue\":\"Allow\",\"donotemail\":false,\"accountid\":\"e295f09c-2aab-eb11-8236-000d3a808ce1\",\"creditlimit@OData.Community.Display.V1.FormattedValue\":\"$5,000.00\",\"creditlimit\":5000,\"_ownerid_value@OData.Community.Display.V1.FormattedValue\":\"DEV 2\",\"_ownerid_value@Microsoft.Dynamics.CRM.associatednavigationproperty\":\"ownerid\",\"_ownerid_value@Microsoft.Dynamics.CRM.lookuplogicalname\":\"systemuser\",\"_ownerid_value\":\"27ae35af-15ab-eb11-8236-000d3a80893f\",\"devkit_categorycode@OData.Community.Display.V1.FormattedValue\":\"Business; Family\",\"devkit_categorycode\":\"1,2\",\"emailaddress1\":\"someone9@example.com\",\"modifiedon@OData.Community.Display.V1.FormattedValue\":\"5/11/2021 8:41 AM\",\"modifiedon\":\"2021-05-11T01:41:28Z\",\"name\":\"A. Datum Corporation (sample)\",\"_transactioncurrencyid_value@OData.Community.Display.V1.FormattedValue\":\"US Dollar\",\"_transactioncurrencyid_value@Microsoft.Dynamics.CRM.associatednavigationproperty\":\"transactioncurrencyid\",\"_transactioncurrencyid_value@Microsoft.Dynamics.CRM.lookuplogicalname\":\"transactioncurrency\",\"_transactioncurrencyid_value\":\"e39879d5-29ab-eb11-8236-000d3a80893f\",\"c.devkit_categorycode@OData.Community.Display.V1.AttributeName\":\"devkit_categorycode\",\"c.devkit_categorycode@OData.Community.Display.V1.FormattedValue\":\"Business; Social\",\"c.devkit_categorycode\":\"1,3\",\"c.telephone1@OData.Community.Display.V1.AttributeName\":\"telephone1\",\"c.telephone1\":\"555-0108\",\"c.emailaddress1@OData.Community.Display.V1.AttributeName\":\"emailaddress1\",\"c.emailaddress1\":\"someone_i@example.com\",\"c.birthdate@OData.Community.Display.V1.AttributeName\":\"birthdate\",\"c.birthdate@OData.Community.Display.V1.FormattedValue\":\"11/22/1984\",\"c.birthdate\":\"1984-11-22\"}]}";
...
`;
            ...
            expect(webapi.AccountId.Value).toBe("e295f09c-2aab-eb11-8236-000d3a808ce1");

            expect(webapi.Name.Value).toBe("A. Datum Corporation (sample)");

            expect(webapi.OwnerId_team).toBeDefined();
            expect(webapi.OwnerId_team.Value).toBeNull();
            expect(webapi.OwnerId_team.FormattedValue).toBe("");
            expect(webapi.OwnerId_systemuser).toBeDefined();
            expect(webapi.OwnerId_systemuser.Value).toBe("27ae35af-15ab-eb11-8236-000d3a80893f");
            expect(webapi.OwnerId_systemuser.FormattedValue).toBe("DEV 2");

            expect(webapi.IndustryCode).toBeDefined();
            expect(webapi.IndustryCode.Value).toBe(OptionSet.Account.IndustryCode.Brokers);
            expect(webapi.IndustryCode.FormattedValue).toBe("Brokers");
            ...
            expect(webapi.CreditLimit.Value).toBe(5000);
            expect(webapi.CreditLimit.FormattedValue).toBe("$5,000.00");

            expect(webapi.DoNotEMail).toBeDefined();
            expect(webapi.DoNotEMail.Value).toBeFalsy();
            expect(webapi.DoNotEMail.FormattedValue).toBe("Allow");

            expect(webapi.EMailAddress1).toBeDefined();
            expect(webapi.EMailAddress1.Value).toBe("someone9@example.com");

            expect(webapi.ModifiedOn_UtcDateAndTime).toBeDefined();
            expect(webapi.ModifiedOn_UtcDateAndTime.Value).toBe("2021-05-11T01:41:28Z");
            expect(webapi.ModifiedOn_UtcDateAndTime.FormattedValue).toBe("5/11/2021 8:41 AM");

            expect(webapi.Telephone1).toBeDefined();
            expect(webapi.Telephone1.Value).toBe("555-0158");

            expect(webapi.StateCode).toBeDefined();
            expect(webapi.StateCode.Value).toBe(OptionSet.Account.StateCode.Active);
            expect(webapi.StateCode.FormattedValue).toBe("Active");

            expect(webapi.StatusCode).toBeDefined();
            expect(webapi.StatusCode.Value).toBe(OptionSet.Account.StatusCode.Active);
            expect(webapi.StatusCode.FormattedValue).toBe("Active");

            expect(webapi.NumberOfEmployees).toBeDefined();
            expect(webapi.NumberOfEmployees.Value).toBe(6200);
            expect(webapi.NumberOfEmployees.FormattedValue).toBe("6,200");

            expect(webapi.Fax).toBeDefined();
            expect(webapi.Fax.Value).toBeNull();
