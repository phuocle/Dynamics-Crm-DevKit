...
{
    [CrmPluginRegistration("ToUpperCase", "ToUpperCase", "", "Dev.DevKit.Server.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class ToUpperCase : CodeActivity
    {
