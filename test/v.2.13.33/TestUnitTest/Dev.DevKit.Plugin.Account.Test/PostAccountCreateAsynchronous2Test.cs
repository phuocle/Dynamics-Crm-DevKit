...
{
    [TestClass]
    public class PostAccountCreateAsynchronous2Test
    {
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostAccountCreateAsynchronous2>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PostAccountCreateAsynchronous2>(plugin);
        ...
        {
            var @class = new PostAccountCreateAsynchronous2();
