...
namespace Dev.DevKit.PluginActivities.Test.Task
{
    ...
    public class PostTaskHandleAsynchronousTest
    {
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostTaskHandleAsynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PostTaskHandleAsynchronous>(plugin);
        ...
        {
            var @class = new PostTaskHandleAsynchronous();
