...
using Dev.DevKit.Server.CustomActions;
...
namespace Dev.DevKit.Server.Test.CustomActions
{
    [TestClass]
    public class PostNonedevkit_AjaxSynchronousTest
    {
        ...
        private static string PrimaryEntityName { get; set; } = "none";
        private static string MessageName { get; set; } = "devkit_Ajax";
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostNonedevkit_AjaxSynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        {
            var @class = new PostNonedevkit_AjaxSynchronous();
