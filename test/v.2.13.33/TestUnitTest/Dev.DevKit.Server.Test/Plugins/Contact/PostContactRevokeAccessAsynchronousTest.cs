...
{
    [TestClass]
    public class PostContactRevokeAccessAsynchronousTest
    {
        ...
        private static string MessageName { get; set; } = "RevokeAccess";
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostContactRevokeAccessAsynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PostContactRevokeAccessAsynchronous>(plugin);
        ...
        {
            var @class = new PostContactRevokeAccessAsynchronous();
