...
{
    [TestClass]
    public class PostContactMergeAsynchronousTest
    {
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostContactMergeAsynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        {
            var @class = new PostContactMergeAsynchronous();
