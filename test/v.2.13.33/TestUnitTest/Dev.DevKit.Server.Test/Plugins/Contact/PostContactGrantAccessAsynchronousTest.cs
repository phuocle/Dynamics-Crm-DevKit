...
{
    [TestClass]
    public class PostContactGrantAccessAsynchronousTest
    {
        ...
        private static string MessageName { get; set; } = "GrantAccess";
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostContactGrantAccessAsynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PostContactGrantAccessAsynchronous>(plugin);
        ...
        {
            var @class = new PostContactGrantAccessAsynchronous();
