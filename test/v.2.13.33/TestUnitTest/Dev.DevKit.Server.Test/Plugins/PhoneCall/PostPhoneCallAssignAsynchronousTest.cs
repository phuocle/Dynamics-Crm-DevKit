...
using Dev.DevKit.Server.Plugins.PhoneCall;
...
namespace Dev.DevKit.Server.Test.Plugins.PhoneCall
{
    [TestClass]
    public class PostPhoneCallAssignAsynchronousTest
    {
        public static XrmFakedContext Context { get; set; }
        public static XrmFakedPluginExecutionContext Plugin { get; set; }
        private static string PrimaryEntityName { get; set; } = "phonecall";
        private static string MessageName { get; set; } = "Assign";
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostPhoneCallAssignAsynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PostPhoneCallAssignAsynchronous>(plugin);
        ...
        {
            var @class = new PostPhoneCallAssignAsynchronous();
