...
{
    [TestClass]
    public class PreValidationPhoneCallDeleteSynchronousTest
    {
        ...
        private static string MessageName { get; set; } = "Delete";
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PreValidationPhoneCallDeleteSynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        {
            var @class = new PreValidationPhoneCallDeleteSynchronous();
