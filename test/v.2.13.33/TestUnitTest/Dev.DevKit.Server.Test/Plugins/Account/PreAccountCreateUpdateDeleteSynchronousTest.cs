...
{
    [TestClass]
    public class PreAccountCreateUpdateDeleteSynchronousTest
    {
        ...
        public void _00_Check_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PreAccountCreateUpdateDeleteSynchronous>(Plugin, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Check_Stage()
        {
            ...
            {
                context.ExecutePluginWith<PreAccountCreateUpdateDeleteSynchronous>(plugin);
        ...
        {
            var @class = new PreAccountCreateUpdateDeleteSynchronous();
