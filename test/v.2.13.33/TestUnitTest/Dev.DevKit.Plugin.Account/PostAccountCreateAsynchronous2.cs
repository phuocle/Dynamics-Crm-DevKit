...
namespace Dev.DevKit.PluginAccount
{
    ...
    "Dev.DevKit.PluginAccount.PostAccountCreateAsynchronous2", 2/*ExecutionOrder*/, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true,
