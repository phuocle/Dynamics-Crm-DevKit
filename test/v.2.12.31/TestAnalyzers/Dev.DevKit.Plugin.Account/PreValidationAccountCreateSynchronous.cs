...
namespace Dev.DevKit.PluginAccount
{
    ...
    "Dev.DevKit.PluginAccount.PreValidationAccountCreateSynchronous", 1/*ExecutionOrder*/, IsolationModeEnum.Sandbox,
    ...
    public class PreValidationAccountCreateSynchronous : IPlugin
    {
        ...
        */
        ...
        //public PreValidationAccountCreateSynchronous(string unsecureString, string secureString)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Plugin: Dev.DevKit.PluginAccount.PreValidationAccountCreateSynchronous");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing);

            //tracing.DebugMessage("End Plugin: Dev.DevKit.PluginAccount.PreValidationAccountCreateSynchronous");
        }
