...
namespace Dev.DevKit.CustomApi
{
    ...
    public class devkit_CustomApiEntityRequest : IPlugin
    {
        ...
        */
        ...
        //public PostAccountdevkit_CustomApiEntitySynchronous(string unsecureString, string secureString)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.MessageName.ToLower() != "devkit_CustomApiEntity".ToLower()) throw new InvalidPluginExecutionException("MessageName does not equals devkit_CustomApiEntity");
            if (context.Mode != (int)ExecutionModeEnum.Synchronous) throw new InvalidPluginExecutionException("Execution does not equals Synchronous");

            //tracing.DebugMessage("Begin Custom Action: Dev.DevKit.CustomApi.PostAccountdevkit_CustomApiEntitySynchronous");
            ...
            //tracing.DebugMessage("End Custom Action: Dev.DevKit.CustomApi.PostAccountdevkit_CustomApiEntitySynchronous");
        }
