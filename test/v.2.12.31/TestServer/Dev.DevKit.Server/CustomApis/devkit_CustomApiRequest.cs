...
namespace Dev.DevKit.Server.CustomApis
{
    ...
    public class devkit_CustomApiRequest : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Custom Api: Dev.DevKit.Server.CustomApis.devkit_CustomApiRequest");
            ...
            //tracing.DebugMessage("End Custom Api: Dev.DevKit.Server.CustomApis.devkit_CustomApiRequest");
        }
