...
{
    [CrmPluginRegistration("Dev.DevKit.Server.DataProviders.SqlServer.Create", "Create", PluginType.DataProvider, DataSource = "devkit_datasource2")]
    public class Create : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            tracing.DebugMessage("Begin Data Provider: Dev.DevKit.Server.DataProviders.SqlServer.Create");
            tracing.DebugContext(context);
            tracing.DebugMessage(dataSource.ToDebug());

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            tracing.DebugMessage("End Data Provider: Dev.DevKit.Server.DataProviders.SqlServer.Create");
        }
