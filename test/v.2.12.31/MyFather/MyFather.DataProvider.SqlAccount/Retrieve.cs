...
{
    [CrmPluginRegistration("MyFather.DataProvider.SqlAccount.Retrieve", VirtualTablePlugin.Retrieve)]
    public class Retrieve : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: MyFather.DataProvider.SqlAccount.Retrieve");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: MyFather.DataProvider.SqlAccount.Retrieve");
        }
