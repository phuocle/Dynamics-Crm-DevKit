...
{
    [CrmPluginRegistration("MyFather.DataProvider.SqlAccount.Delete", VirtualTablePlugin.Delete)]
    public class Delete : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: MyFather.DataProvider.SqlAccount.Delete");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: MyFather.DataProvider.SqlAccount.Delete");
        }
