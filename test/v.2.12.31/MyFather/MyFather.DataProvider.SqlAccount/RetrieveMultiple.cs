...
{
    [CrmPluginRegistration("MyFather.DataProvider.SqlAccount.RetrieveMultiple", VirtualTablePlugin.RetrieveMultiple)]
    public class RetrieveMultiple : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: MyFather.DataProvider.SqlAccount.RetrieveMultiple");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: MyFather.DataProvider.SqlAccount.RetrieveMultiple");
        }
