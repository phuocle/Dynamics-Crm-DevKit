...
{
    [CrmPluginRegistration("MyFather.DataProvider.SqlAccount.Create", VirtualTablePlugin.Create)]
    public class Create : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: MyFather.DataProvider.SqlAccount.Create");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: MyFather.DataProvider.SqlAccount.Create");
        }
