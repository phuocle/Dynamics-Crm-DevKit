...
{
    [CrmPluginRegistration("MyFather.DataProvider.SqlAccount.Update", VirtualTablePlugin.Update)]
    public class Update : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: MyFather.DataProvider.SqlAccount.Update");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: MyFather.DataProvider.SqlAccount.Update");
        }
