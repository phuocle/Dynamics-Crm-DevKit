...
namespace AccountPlugin
{
    ...
    "AccountPlugin.PreAccountMergeSynchronous", 1/*ExecutionOrder*/, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin,
    UnSecureConfiguration = "AccountPlugin.PreAccountMergeSynchronous Configuration",
