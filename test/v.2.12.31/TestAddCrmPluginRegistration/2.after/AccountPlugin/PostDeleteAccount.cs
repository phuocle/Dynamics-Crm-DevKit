...
namespace AccountPlugin
{
    ...
    "AccountPlugin.PostDeleteAccount", 1/*ExecutionOrder*/, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin,
    DeleteAsyncOperation = true, Description = "AccountPlugin.PostDeleteAccount", UnSecureConfiguration = "AccountPlugin.PostDeleteAccount Configuration",
