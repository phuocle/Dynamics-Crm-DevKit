...
declare namespace DevKit {
	...
	class OpportunityCloseApi {
		...
		*/
		...
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_msdyn_customerasset_opportunityclose: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
...
//{'JsForm':['Information','Opportunity Close'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}