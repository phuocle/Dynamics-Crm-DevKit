...
(function (DevKit) {
	...
	DevKit.msdyn_twitterengagementctxApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_twitterengagementctx) {
			var a = msdyn_twitterengagementctx[field].a;
			var b = msdyn_twitterengagementctx[field].b;
			var c = msdyn_twitterengagementctx[field].c;
			var d = msdyn_twitterengagementctx[field].d;
			var g = msdyn_twitterengagementctx[field].g;
			var r = msdyn_twitterengagementctx[field].r;
			msdyn_twitterengagementctx[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_twitterengagementctx.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_twitterengagementctx.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
