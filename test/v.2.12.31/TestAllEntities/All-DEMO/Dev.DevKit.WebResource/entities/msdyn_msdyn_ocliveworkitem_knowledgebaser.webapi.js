...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_ocliveworkitem_knowledgebaserApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_ocliveworkitem_knowledgebaser) {
			var a = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].a;
			var b = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].b;
			var c = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].c;
			var d = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].d;
			var g = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].g;
			var r = msdyn_msdyn_ocliveworkitem_knowledgebaser[field].r;
			msdyn_msdyn_ocliveworkitem_knowledgebaser[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_ocliveworkitem_knowledgebaser.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_ocliveworkitem_knowledgebaser.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
