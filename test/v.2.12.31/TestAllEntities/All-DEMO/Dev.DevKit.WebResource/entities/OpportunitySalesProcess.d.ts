...
declare namespace DevKit {
	...
	class FormOpportunitySalesProcesses extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form OpportunitySalesProcesses
...
//{'JsForm':['OpportunitySalesProcesses'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}