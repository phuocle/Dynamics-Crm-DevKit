...
namespace Dev.DevKit.Shared.Entities
{
	public partial class QuoteDetail : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.QuoteDetailOptionSets.msdyn_BillingMethod? msdyn_BillingMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_BillingMethod);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.QuoteDetailOptionSets.msdyn_BillingMethod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.QuoteDetailOptionSets.QuoteStateCode? QuoteStateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.QuoteStateCode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.QuoteDetailOptionSets.QuoteStateCode)value.Value;
			}
		}
