...
namespace Dev.DevKit.Shared.Entities.devkit_AzureAccountOptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	public partial class devkit_AzureAccount : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.devkit_AzureAccountOptionSets.devkit_Category? devkit_Category
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.devkit_Category);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.devkit_AzureAccountOptionSets.devkit_Category)value.Value;
			}
			set
			{
				if (value.HasValue)
