...
namespace Dev.DevKit.Shared.Entities
{
	public partial class FileAttachment : EntityBase
	{
		...
		/// <para>Lookup to activityfileattachment;asyncoperation;canvasapp;cascadegrantrevokeaccessrecordstracker;exportsolutionupload;flowsession;imagedescriptor;mailbox;msdyn_aibfile;msdyn_aiconfiguration;msdyn_knowledgearticleimage;revokeinheritedaccessrecordstracker;ribbonclientmetadata;solution;stagesolutionupload;webresource;workflowbinary;workflowlog</para>
		/// <para>Regarding</para>
		/// </summary>
		[DebuggerNonUserCode()]
