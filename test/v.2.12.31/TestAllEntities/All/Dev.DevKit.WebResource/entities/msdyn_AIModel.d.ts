...
declare namespace DevKit {
	class msdyn_AIModelApi {
		...
		*/
		...
		msdyn_ActiveRunConfigurationId: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyn_AIModelId: DevKit.WebApi.GuidValue;
		/** For internal use only. */
		msdyn_AIModelIdUnique: DevKit.WebApi.GuidValueReadonly;
		msdyn_ModelCreationContext: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_Name: DevKit.WebApi.StringValue;
		/** Unique identifier for Retrain Process associated with AI Model. */
		msdyn_RetrainWorkflowId: DevKit.WebApi.LookupValue;
		/** Unique identifier for Schedule Inference Process associated with AI Model. */
		msdyn_ScheduleInferenceWorkflowId: DevKit.WebApi.LookupValue;
		msdyn_ShareWithOrganizationOnCreate: DevKit.WebApi.BooleanValue;
		/** Unique identifier for AITemplate associated with AIModel. */
		msdyn_TemplateId: DevKit.WebApi.LookupValue;
