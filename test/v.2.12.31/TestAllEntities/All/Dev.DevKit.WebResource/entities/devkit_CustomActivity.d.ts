...
declare namespace DevKit {
	namespace FormCustom_Activity {
		...
		interface tab_tabGeneral extends DevKit.Controls.ITab {
	...
	class FormCustom_Activity extends DevKit.IForm {
		/**
		...
		*/
		...
		Body: DevKit.FormCustom_Activity.Body;
		/** The Header section of form Custom_Activity */
		Header: DevKit.FormCustom_Activity.Header;
	}
	class devkit_CustomActivityApi {
		/**
		* DynamicsCrm.DevKit devkit_CustomActivityApi
		...
		*/
		...
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_devkit_azureaccount_devkit_customactivity: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
...
//{'JsForm':['Custom Activity'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}