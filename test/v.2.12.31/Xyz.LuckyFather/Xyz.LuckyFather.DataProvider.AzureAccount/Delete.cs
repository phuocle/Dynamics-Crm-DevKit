...
{
    [CrmPluginRegistration("Xyz.LuckyFather.DataProvider.AzureAccount.Delete", VirtualTablePlugin.Delete)]
    public class Delete : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Delete");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Delete");
        }
