...
{
    [CrmPluginRegistration("Xyz.LuckyFather.DataProvider.AzureAccount.Create", VirtualTablePlugin.Create)]
    public class Create : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Create");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Create");
        }
