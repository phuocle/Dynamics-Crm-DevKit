...
{
    [CrmPluginRegistration("Xyz.LuckyFather.DataProvider.AzureAccount.Retrieve", VirtualTablePlugin.Retrieve)]
    public class Retrieve : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Retrieve");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Retrieve");
        }
