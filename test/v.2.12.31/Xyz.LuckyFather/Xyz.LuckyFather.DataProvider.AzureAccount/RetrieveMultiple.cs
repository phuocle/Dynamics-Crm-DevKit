...
using System;
using Xyz.LuckyFather.Shared;

namespace Xyz.LuckyFather.DataProvider.AzureAccount
{
    [CrmPluginRegistration("Xyz.LuckyFather.DataProvider.AzureAccount.RetrieveMultiple", VirtualTablePlugin.RetrieveMultiple)]
    public class RetrieveMultiple : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.RetrieveMultiple");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.RetrieveMultiple");
        }
