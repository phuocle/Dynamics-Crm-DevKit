...
{
    [CrmPluginRegistration("Xyz.LuckyFather.DataProvider.AzureAccount.Update", VirtualTablePlugin.Update)]
    public class Update : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Update");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Xyz.LuckyFather.DataProvider.AzureAccount.Update");
        }
