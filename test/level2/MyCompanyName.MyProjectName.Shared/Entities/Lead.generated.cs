...
using MyCompanyName.MyProjectName.Shared.Entities.LeadOptionSets;

namespace MyCompanyName.MyProjectName.Shared.Entities.LeadOptionSets
{
...
namespace MyCompanyName.MyProjectName.Shared.Entities
{
    public partial class Lead : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public Lead(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
