...
namespace NT.BTT.Workflow
{
    [CrmPluginRegistration("String", "String", "", "NT.BTT.Workflow", IsolationModeEnum.Sandbox)]
    public class String : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: String");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: String");
        }
    }
}