...
namespace MyCompanyName.MyProjectName.Workflow
{
    [CrmPluginRegistration("Common", "Common", "", "MyCompanyName.MyProjectName.Workflow", IsolationModeEnum.Sandbox)]
    public class Common : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: Common");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: Common");
        }
    }
}