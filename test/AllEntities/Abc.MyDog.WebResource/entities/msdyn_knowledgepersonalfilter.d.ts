...
declare namespace MyDog {
	...
	class Formmsdyn_knowledgepersonalfilter_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_knowledgepersonalfilter_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_knowledgepersonalfilter_Information.Body;
	}
	class msdyn_knowledgepersonalfilterApi {
		...
		*/
		...
		msdyn_knowledgepersonalfilterId: DevKit.WebApi.GuidValue;
		/** The name of the entity. */
		...
		msdyn_PreferredValues: DevKit.WebApi.StringValue;
