...
declare namespace MyDog {
	namespace Formmsdyn_analysisjob_Information {
		...
		interface Body {
			...
			msdyn_ErrorCount_1: DevKit.Form.Controls.ControlInteger;
	...
	class Formmsdyn_analysisjob_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_analysisjob_Information.Body;
		/** The Header section of form msdyn_analysisjob_Information */
		Header: MyDog.Formmsdyn_analysisjob_Information.Header;
	}
