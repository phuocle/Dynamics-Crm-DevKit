...
declare namespace MyDog {
	namespace Formorganizationdatasyncsubscriptionentity_Information {
		interface Tabs {
		}
		interface Body {
	...
	class Formorganizationdatasyncsubscriptionentity_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.Formorganizationdatasyncsubscriptionentity_Information.Body;
	}
	class organizationdatasyncsubscriptionentityApi {
		...
		*/
		...
		InheritsFromOtc: DevKit.WebApi.IntegerValue;
		IsActivity: DevKit.WebApi.BooleanValue;
