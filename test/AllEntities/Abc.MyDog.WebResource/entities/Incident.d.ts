...
declare namespace MyDog {
	...
	class FormCase extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCase.Body;
		/** The Header section of form Case */
		Header: MyDog.FormCase.Header;
		/** The Navigation of form Case */
		Navigation: MyDog.FormCase.Navigation;
		/** The QuickForm of form Case */
		QuickForm: MyDog.FormCase.QuickForm;
		/** The Process of form Case */
		Process: MyDog.FormCase.Process;
		/** The Grid of form Case */
		Grid: MyDog.FormCase.Grid;
	}
	...
	class FormCase_for_Interactive_experience extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCase_for_Interactive_experience.Body;
		/** The Header section of form Case_for_Interactive_experience */
		Header: MyDog.FormCase_for_Interactive_experience.Header;
		/** The QuickForm of form Case_for_Interactive_experience */
		QuickForm: MyDog.FormCase_for_Interactive_experience.QuickForm;
		/** The Process of form Case_for_Interactive_experience */
		Process: MyDog.FormCase_for_Interactive_experience.Process;
		/** The Grid of form Case_for_Interactive_experience */
		Grid: MyDog.FormCase_for_Interactive_experience.Grid;
	}
	...
	class FormCase_for_Multisession_experience extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCase_for_Multisession_experience.Body;
		/** The Header section of form Case_for_Multisession_experience */
		Header: MyDog.FormCase_for_Multisession_experience.Header;
		/** The Navigation of form Case_for_Multisession_experience */
		Navigation: MyDog.FormCase_for_Multisession_experience.Navigation;
		/** The Process of form Case_for_Multisession_experience */
		Process: MyDog.FormCase_for_Multisession_experience.Process;
		/** The Grid of form Case_for_Multisession_experience */
		Grid: MyDog.FormCase_for_Multisession_experience.Grid;
	}
	...
	class FormIncident_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormIncident_Information.Body;
		/** The Navigation of form Incident_Information */
		Navigation: MyDog.FormIncident_Information.Navigation;
		/** The Process of form Incident_Information */
		Process: MyDog.FormIncident_Information.Process;
	}
	...
	class FormTimelineWallControl_Case_Main extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormTimelineWallControl_Case_Main.Body;
		/** The Header section of form TimelineWallControl_Case_Main */
		Header: MyDog.FormTimelineWallControl_Case_Main.Header;
		/** The Navigation of form TimelineWallControl_Case_Main */
		Navigation: MyDog.FormTimelineWallControl_Case_Main.Navigation;
		/** The Process of form TimelineWallControl_Case_Main */
		Process: MyDog.FormTimelineWallControl_Case_Main.Process;
	}
	...
	class FormCase_Quick_Create_for_Multisession extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCase_Quick_Create_for_Multisession.Body;
	}
	...
	class FormApp_for_Outlook_Case_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormApp_for_Outlook_Case_Quick_Create.Body;
	}
	...
	class FormCase_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCase_Quick_Create.Body;
	}
	class IncidentApi {
		/**
