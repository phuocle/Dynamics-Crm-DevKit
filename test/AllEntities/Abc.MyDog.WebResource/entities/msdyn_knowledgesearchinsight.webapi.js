...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_knowledgesearchinsightApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_knowledgesearchinsight) {
			var a = msdyn_knowledgesearchinsight[field].a;
			var b = msdyn_knowledgesearchinsight[field].b;
			var c = msdyn_knowledgesearchinsight[field].c;
			var d = msdyn_knowledgesearchinsight[field].d;
			var g = msdyn_knowledgesearchinsight[field].g;
			var r = msdyn_knowledgesearchinsight[field].r;
			msdyn_knowledgesearchinsight[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_knowledgesearchinsight.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_knowledgesearchinsight.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
