...
declare namespace MyDog {
	...
	class FormAgreement_Booking_Service_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAgreement_Booking_Service_Mobile.Body;
		/** The Navigation of form Agreement_Booking_Service_Mobile */
		Navigation: MyDog.FormAgreement_Booking_Service_Mobile.Navigation;
	}
	...
	class Formmsdyn_agreementbookingservice_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_agreementbookingservice_Information.Body;
		/** The Footer section of form msdyn_agreementbookingservice_Information */
		Footer: MyDog.Formmsdyn_agreementbookingservice_Information.Footer;
		/** The Navigation of form msdyn_agreementbookingservice_Information */
		Navigation: MyDog.Formmsdyn_agreementbookingservice_Information.Navigation;
	}
...
//{'JsForm':['Agreement Booking Service - Mobile','Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}