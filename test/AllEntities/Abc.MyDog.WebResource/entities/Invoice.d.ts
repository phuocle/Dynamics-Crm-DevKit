...
declare namespace MyDog {
	...
	class FormInvoice_Field_Service_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormInvoice_Field_Service_Information.Body;
		/** The Header section of form Invoice_Field_Service_Information */
		Header: MyDog.FormInvoice_Field_Service_Information.Header;
		/** The Navigation of form Invoice_Field_Service_Information */
		Navigation: MyDog.FormInvoice_Field_Service_Information.Navigation;
		/** The Process of form Invoice_Field_Service_Information */
		Process: MyDog.FormInvoice_Field_Service_Information.Process;
		/** The Grid of form Invoice_Field_Service_Information */
		Grid: MyDog.FormInvoice_Field_Service_Information.Grid;
	}
	...
	class FormInvoice_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormInvoice_Information.Body;
		/** The Process of form Invoice_Information */
		Process: MyDog.FormInvoice_Information.Process;
	}
	...
	class FormInvoice extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormInvoice.Body;
		/** The Header section of form Invoice */
		Header: MyDog.FormInvoice.Header;
		/** The Process of form Invoice */
		Process: MyDog.FormInvoice.Process;
		/** The Grid of form Invoice */
		Grid: MyDog.FormInvoice.Grid;
	}
	...
	class FormProject_Invoice extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormProject_Invoice.Body;
		/** The Header section of form Project_Invoice */
		Header: MyDog.FormProject_Invoice.Header;
		/** The Process of form Project_Invoice */
		Process: MyDog.FormProject_Invoice.Process;
		/** The Grid of form Project_Invoice */
		Grid: MyDog.FormProject_Invoice.Grid;
	}
	class InvoiceApi {
		/**
