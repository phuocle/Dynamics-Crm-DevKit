...
declare namespace MyDog {
	...
	class FormPersonalization_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Personalization_settings
		...
		*/
		...
		Body: MyDog.FormPersonalization_settings.Body;
		/** The Grid of form Personalization_settings */
		Grid: MyDog.FormPersonalization_settings.Grid;
	}
}
...
//{'JsForm':['Personalization settings'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false,'Version':'2.12.31','JsFormVersion':'v2'}