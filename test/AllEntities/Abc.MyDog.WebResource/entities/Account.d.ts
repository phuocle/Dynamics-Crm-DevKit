...
declare namespace MyDog {
	...
	class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAccount.Body;
		/** The Header section of form Account */
		Header: MyDog.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: MyDog.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: MyDog.FormAccount.QuickForm;
		/** The Process of form Account */
		Process: MyDog.FormAccount.Process;
		/** The Grid of form Account */
		Grid: MyDog.FormAccount.Grid;
	}
	...
	class FormAccount_for_Interactive_experience extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAccount_for_Interactive_experience.Body;
		/** The Header section of form Account_for_Interactive_experience */
		Header: MyDog.FormAccount_for_Interactive_experience.Header;
		/** The QuickForm of form Account_for_Interactive_experience */
		QuickForm: MyDog.FormAccount_for_Interactive_experience.QuickForm;
		/** The Process of form Account_for_Interactive_experience */
		Process: MyDog.FormAccount_for_Interactive_experience.Process;
		/** The Grid of form Account_for_Interactive_experience */
		Grid: MyDog.FormAccount_for_Interactive_experience.Grid;
	}
	...
	class FormAccount_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Account_Information
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: MyDog.FormAccount_Information.Body;
		/** The Header section of form Account_Information */
		Header: MyDog.FormAccount_Information.Header;
		/** The Navigation of form Account_Information */
		Navigation: MyDog.FormAccount_Information.Navigation;
		/** The Process of form Account_Information */
		Process: MyDog.FormAccount_Information.Process;
		/** The Grid of form Account_Information */
		Grid: MyDog.FormAccount_Information.Grid;
	}
	...
	class FormAccount_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAccount_Quick_Create.Body;
	}
	class AccountApi {
		/**
...
//{'JsForm':['Account','Account for Interactive experience','Information','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}