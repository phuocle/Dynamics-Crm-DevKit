...
declare namespace MyDog {
	...
	class FormTemplate_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTemplate_Information.Body;
	}
	namespace FormTemplate {
		...
		interface tab_Template_Sections {
			...
			Template_editor: DevKit.Form.Controls.ControlSection;
		}
		interface tab_Template extends DevKit.Form.Controls.IControlTab {
		...
		interface Body {
			...
			SafeHtml: DevKit.Form.Controls.ControlString;
			/** Safe html of email template subject. */
			SubjectSafeHtml: DevKit.Form.Controls.ControlString;
			category: DevKit.Form.Controls.ControlActionCards;
			/** Title of the template. */
			Title: DevKit.Form.Controls.ControlString;
		}
	}
	class FormTemplate extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form Template
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: MyDog.FormTemplate.Body;
		/** The Header section of form Template */
		Header: MyDog.FormTemplate.Header;
	}
	class TemplateApi {
		/**
...
//{'JsForm':['Information','Template'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}