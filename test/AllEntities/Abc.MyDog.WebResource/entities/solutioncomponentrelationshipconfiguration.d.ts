...
declare namespace MyDog {
	...
	class Formsolutioncomponentrelationshipconfiguration_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.Formsolutioncomponentrelationshipconfiguration_Information.Body;
	}
