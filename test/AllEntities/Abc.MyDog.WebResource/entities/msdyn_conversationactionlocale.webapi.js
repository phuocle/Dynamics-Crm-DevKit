...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_conversationactionlocaleApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_conversationactionlocale) {
			var a = msdyn_conversationactionlocale[field].a;
			var b = msdyn_conversationactionlocale[field].b;
			var c = msdyn_conversationactionlocale[field].c;
			var d = msdyn_conversationactionlocale[field].d;
			var g = msdyn_conversationactionlocale[field].g;
			var r = msdyn_conversationactionlocale[field].r;
			msdyn_conversationactionlocale[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_conversationactionlocale.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_conversationactionlocale.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
