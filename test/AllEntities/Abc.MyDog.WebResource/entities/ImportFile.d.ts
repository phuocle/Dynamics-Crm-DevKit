...
declare namespace MyDog {
	namespace FormImportfile {
		...
		interface Body {
			Tab: Tabs;
			import_Logs_Failures: DevKit.Form.Controls.ControlActionCards;
	...
	class FormImportfile extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormImportfile.Body;
		/** The Footer section of form Importfile */
		Footer: MyDog.FormImportfile.Footer;
	}
	class ImportFileApi {
		/**
...
//{'JsForm':['Importfile'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}