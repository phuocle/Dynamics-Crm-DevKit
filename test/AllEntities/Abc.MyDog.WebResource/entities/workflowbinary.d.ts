...
declare namespace MyDog {
	class workflowbinaryApi {
		...
		*/
		...
		Data_Name: DevKit.WebApi.StringValueReadonly;
		/** The ID associated with the flow run */
		FlowSessionId: DevKit.WebApi.LookupValue;
		...
		Process: DevKit.WebApi.LookupValue;
		/** A reference name for the workflow binary */
		ReferenceName: DevKit.WebApi.StringValue;
		...
		workflowbinaryId: DevKit.WebApi.GuidValue;
	}
}
