...
(function (MyDog) {
	'use strict';
	MyDog.FormProductPriceLevel_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormProduct_Price_List = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
