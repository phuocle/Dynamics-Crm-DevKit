...
declare namespace MyDog {
	namespace FormExpiredProcess {
		interface tab_general_Sections {
			expiredprocessinformation: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormExpiredProcess extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form ExpiredProcess
		...
		*/
		...
		Body: MyDog.FormExpiredProcess.Body;
	}
...
//{'JsForm':['ExpiredProcess'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}