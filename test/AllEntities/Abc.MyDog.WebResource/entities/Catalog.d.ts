...
declare namespace MyDog {
	namespace FormCatalog_Information {
		...
		interface Body {
			...
			ParentCatalogId: DevKit.Form.Controls.ControlLookup;
			/** Unique name for the catalog */
			UniqueName: DevKit.Form.Controls.ControlString;
		}
	}
	class FormCatalog_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form Catalog_Information
		...
		*/
		...
		Body: MyDog.FormCatalog_Information.Body;
	}
	class CatalogApi {
		/**
		...
		*/
		...
		CatalogId: DevKit.WebApi.GuidValue;
		...
		/** Unique identifier for the Parent Catalog */
		ParentCatalogId: DevKit.WebApi.LookupValue;
