...
declare namespace MyDog {
	namespace Formmsdyn_iotpropertydefinition_Information {
		...
		interface Body {
			...
			msdyn_AdditionalProperties_1: DevKit.Controls.String;
	...
	class Formmsdyn_iotpropertydefinition_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_iotpropertydefinition_Information.Body;
		/** The Header section of form msdyn_iotpropertydefinition_Information */
		Header: MyDog.Formmsdyn_iotpropertydefinition_Information.Header;
		/** The Grid of form msdyn_iotpropertydefinition_Information */
		Grid: MyDog.Formmsdyn_iotpropertydefinition_Information.Grid;
	}
}
