...
(function (MyDog) {
	'use strict';
	MyDog.RelationshipAttributeApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in relationshipattribute) {
			var a = relationshipattribute[field].a;
			var b = relationshipattribute[field].b;
			var c = relationshipattribute[field].c;
			var d = relationshipattribute[field].d;
			var g = relationshipattribute[field].g;
			var r = relationshipattribute[field].r;
			relationshipattribute[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		relationshipattribute.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		relationshipattribute.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
