...
declare namespace MyDog {
	...
	class FormSocial_Profile extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSocial_Profile.Body;
		/** The Header section of form Social_Profile */
		Header: MyDog.FormSocial_Profile.Header;
	}
	...
	class FormSocial_Profile_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSocial_Profile_for_Interactive_experience.Body;
		/** The Header section of form Social_Profile_for_Interactive_experience */
		Header: MyDog.FormSocial_Profile_for_Interactive_experience.Header;
	}
...
//{'JsForm':['Social Profile','Social Profile for Interactive experience'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}