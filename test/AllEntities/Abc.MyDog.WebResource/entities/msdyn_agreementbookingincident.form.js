...
(function (MyDog) {
	'use strict';
	MyDog.FormAgreement_Booking_Incident_Mobile = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_agreementbookingincident_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
