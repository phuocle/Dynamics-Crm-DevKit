...
(function (MyDog) {
	...
	MyDog.CustomAPIApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in customapi) {
			var a = customapi[field].a;
			var b = customapi[field].b;
			var c = customapi[field].c;
			var d = customapi[field].d;
			var g = customapi[field].g;
			var r = customapi[field].r;
			customapi[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		customapi.Entity = u;
		customapi.EntityName = 'customapi';
		customapi.EntityCollectionName = 'customapis';
		customapi['@odata.etag'] = e['@odata.etag'];
		customapi.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		customapi.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
