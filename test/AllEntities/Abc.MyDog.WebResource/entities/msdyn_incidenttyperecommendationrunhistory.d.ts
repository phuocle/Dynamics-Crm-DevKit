...
declare namespace MyDog {
	...
	class Formmsdyn_incidenttyperecommendationrunhistory_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_incidenttyperecommendationrunhistory_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_incidenttyperecommendationrunhistory_Information.Body;
		/** The Grid of form msdyn_incidenttyperecommendationrunhistory_Information */
		Grid: MyDog.Formmsdyn_incidenttyperecommendationrunhistory_Information.Grid;
	}
