...
declare namespace MyDog {
	...
	class FormAnalytics_Report_Record extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAnalytics_Report_Record.Body;
	}
	class msdyn_dataanalyticsreportApi {
		...
		*/
		...
		/** Report Entity Name */
		msdyn_reportentityname: DevKit.WebApi.StringValue;
		/** Report Group */
		msdyn_reportgroup: DevKit.WebApi.StringValue;
		/** Power BI Report ID */
		msdyn_reportid: DevKit.WebApi.StringValue;
		/** Report Page */
		msdyn_reportpage: DevKit.WebApi.StringValue;
...
//{'JsForm':['Analytics Report Record'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}