...
(function (MyDog) {
	'use strict';
	MyDog.FormPurchase_Order_Receipt = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormPurchase_Order_Receipt_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
