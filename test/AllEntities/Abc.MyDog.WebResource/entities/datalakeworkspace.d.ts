...
declare namespace MyDog {
	...
	class Formdatalakeworkspace_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form datalakeworkspace_Information
		...
		*/
		...
		Body: MyDog.Formdatalakeworkspace_Information.Body;
	}
