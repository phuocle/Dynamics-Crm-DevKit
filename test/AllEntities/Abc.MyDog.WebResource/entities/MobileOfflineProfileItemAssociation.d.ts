...
declare namespace MyDog {
	...
	class FormMobile_Offline_Profile_Item_Association extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormMobile_Offline_Profile_Item_Association.Body;
	}
...
//{'JsForm':['Mobile Offline Profile Item Association'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}