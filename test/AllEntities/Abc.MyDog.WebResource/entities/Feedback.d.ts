...
declare namespace MyDog {
	...
	class FormFeedback_Quick_Create extends DevKit.Form.IForm {
		/**
...
//{'JsForm':['Feedback','Feedback MainIC','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}