...
(function (MyDog) {
	'use strict';
	MyDog.Formmsdyn_appconfiguration_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormUsers = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
