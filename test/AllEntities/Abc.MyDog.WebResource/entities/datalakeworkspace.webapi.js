...
(function (MyDog) {
	'use strict';
	MyDog.datalakeworkspaceApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in datalakeworkspace) {
			var a = datalakeworkspace[field].a;
			var b = datalakeworkspace[field].b;
			var c = datalakeworkspace[field].c;
			var d = datalakeworkspace[field].d;
			var g = datalakeworkspace[field].g;
			var r = datalakeworkspace[field].r;
			datalakeworkspace[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		datalakeworkspace.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		datalakeworkspace.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
