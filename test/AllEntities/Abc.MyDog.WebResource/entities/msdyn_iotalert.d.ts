...
declare namespace MyDog {
	...
	class Formmsdyn_iotalert_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_iotalert_Information.Body;
		/** The Header section of form msdyn_iotalert_Information */
		Header: MyDog.Formmsdyn_iotalert_Information.Header;
		/** The QuickForm of form msdyn_iotalert_Information */
		QuickForm: MyDog.Formmsdyn_iotalert_Information.QuickForm;
		/** The Process of form msdyn_iotalert_Information */
		Process: MyDog.Formmsdyn_iotalert_Information.Process;
		/** The Grid of form msdyn_iotalert_Information */
		Grid: MyDog.Formmsdyn_iotalert_Information.Grid;
	}
}
