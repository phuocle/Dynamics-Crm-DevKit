...
declare namespace MyDog {
	namespace FormEmail_signature {
		...
		interface tab_general_Sections {
			...
			Details_UCI: DevKit.Form.Controls.ControlSection;
			Signature_Editor: DevKit.Form.Controls.ControlSection;
		}
		...
		interface Body {
			...
			/** Language of the email signature. */
			LanguageCode_1: DevKit.Form.Controls.ControlInteger;
			/** Unique identifier of the user or team who owns the email signature for the email activity. */
			OwnerId: DevKit.Form.Controls.ControlLookup;
	...
	class FormEmail_signature extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEmail_signature.Body;
		/** The Header section of form Email_signature */
		Header: MyDog.FormEmail_signature.Header;
	}
...
//{'JsForm':['Email signature'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}