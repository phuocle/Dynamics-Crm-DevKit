...
declare namespace MyDog {
	namespace FormCustomAPIResponseProperty_Information {
		...
		interface Body {
			...
			CustomAPIId: DevKit.Form.Controls.ControlLookup;
			...
			LogicalEntityName: DevKit.Form.Controls.ControlString;
	...
	class FormCustomAPIResponseProperty_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form CustomAPIResponseProperty_Information
		...
		*/
		...
		Body: MyDog.FormCustomAPIResponseProperty_Information.Body;
	}
	class CustomAPIResponsePropertyApi {
		...
		*/
		...
		CustomAPIResponsePropertyId: DevKit.WebApi.GuidValue;
		/** Localized description for custom API response property instances */
