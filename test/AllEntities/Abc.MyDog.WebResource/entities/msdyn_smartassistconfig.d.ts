...
declare namespace MyDog {
	namespace Formmsdyn_smartassistconfig_Information {
		...
		interface Body {
			...
			msdyn_sourceentityname: DevKit.Controls.ELSE3???;//msdyn_sourceentityname - 0C93C5E4-B63C-4C23-B1C2-7B0AE0A526AA -- FOR DEBUG 
	...
	class Formmsdyn_smartassistconfig_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_smartassistconfig_Information.Body;
	}
}
