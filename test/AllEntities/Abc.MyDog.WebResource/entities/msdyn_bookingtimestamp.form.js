...
(function (MyDog) {
	'use strict';
	MyDog.FormBooking_Timestamp_Mobile = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_bookingtimestamp_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
