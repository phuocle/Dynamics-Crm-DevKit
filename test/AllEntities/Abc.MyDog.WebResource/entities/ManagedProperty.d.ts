...
declare namespace MyDog {
	class ManagedPropertyApi {
		/**
		* DynamicsCrm.DevKit ManagedPropertyApi
		...
		*/
		...
		EnablesAttributeName: DevKit.WebApi.StringValue;
		/** Enables Entity Name of this Managed Property. */
		EnablesEntityName: DevKit.WebApi.StringValue;
		...
		ManagedPropertyId: DevKit.WebApi.GuidValue;
		/** Unique identifier of the Managed Property */
		ManagedPropertyRowId: DevKit.WebApi.GuidValue;
		/** For internal use only. */
