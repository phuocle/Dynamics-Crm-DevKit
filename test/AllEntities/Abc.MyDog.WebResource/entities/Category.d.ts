...
declare namespace MyDog {
	...
	class FormCategory extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCategory.Body;
		/** The Grid of form Category */
		Grid: MyDog.FormCategory.Grid;
	}
	...
	class FormCategory_Main_Interactive extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCategory_Main_Interactive.Body;
	}
	...
	class FormCategory_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormCategory_Quick_Create.Body;
	}
	class CategoryApi {
		/**
...
//{'JsForm':['Category','Category Main Interactive','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}