...
declare namespace MyDog {
	...
	class Formmsdyn_workorderproduct_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_workorderproduct_Information.Body;
		/** The Footer section of form msdyn_workorderproduct_Information */
		Footer: MyDog.Formmsdyn_workorderproduct_Information.Footer;
		/** The Navigation of form msdyn_workorderproduct_Information */
		Navigation: MyDog.Formmsdyn_workorderproduct_Information.Navigation;
	}
	...
	class FormWork_Order_Product_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormWork_Order_Product_Mobile.Body;
	}
}
...
//{'JsForm':['Information','Work Order Product - Mobile'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false,'Version':'2.12.31','JsFormVersion':'v2'}