...
(function (MyDog) {
	'use strict';
	MyDog.FormPurchase_Order = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormPurchase_Order_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
