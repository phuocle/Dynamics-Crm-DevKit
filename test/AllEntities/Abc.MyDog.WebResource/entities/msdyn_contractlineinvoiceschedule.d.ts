...
declare namespace MyDog {
	...
	class Formmsdyn_contractlineinvoiceschedule_Project_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_contractlineinvoiceschedule_Project_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_contractlineinvoiceschedule_Project_Information.Body;
	}
	...
	class Formmsdyn_contractlineinvoiceschedule_Project_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_contractlineinvoiceschedule_Project_Quick_Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: MyDog.Formmsdyn_contractlineinvoiceschedule_Project_Quick_Create.Body;
	}
