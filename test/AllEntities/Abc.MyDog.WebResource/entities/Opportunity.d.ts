...
declare namespace MyDog {
	...
	class FormOpportunity_AI_for_Sales extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormOpportunity_AI_for_Sales.Body;
		/** The Header section of form Opportunity_AI_for_Sales */
		Header: MyDog.FormOpportunity_AI_for_Sales.Header;
		/** The Navigation of form Opportunity_AI_for_Sales */
		Navigation: MyDog.FormOpportunity_AI_for_Sales.Navigation;
		/** The Process of form Opportunity_AI_for_Sales */
		Process: MyDog.FormOpportunity_AI_for_Sales.Process;
		/** The Grid of form Opportunity_AI_for_Sales */
		Grid: MyDog.FormOpportunity_AI_for_Sales.Grid;
	}
	...
	class FormOpportunity_Field_Service_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormOpportunity_Field_Service_Information.Body;
		/** The Header section of form Opportunity_Field_Service_Information */
		Header: MyDog.FormOpportunity_Field_Service_Information.Header;
		/** The Navigation of form Opportunity_Field_Service_Information */
		Navigation: MyDog.FormOpportunity_Field_Service_Information.Navigation;
		/** The Process of form Opportunity_Field_Service_Information */
		Process: MyDog.FormOpportunity_Field_Service_Information.Process;
		/** The Grid of form Opportunity_Field_Service_Information */
		Grid: MyDog.FormOpportunity_Field_Service_Information.Grid;
	}
	...
	class FormOpportunity_Project_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormOpportunity_Project_Information.Body;
		/** The Header section of form Opportunity_Project_Information */
		Header: MyDog.FormOpportunity_Project_Information.Header;
		/** The Navigation of form Opportunity_Project_Information */
		Navigation: MyDog.FormOpportunity_Project_Information.Navigation;
		/** The Process of form Opportunity_Project_Information */
		Process: MyDog.FormOpportunity_Project_Information.Process;
		/** The Grid of form Opportunity_Project_Information */
		Grid: MyDog.FormOpportunity_Project_Information.Grid;
	}
	...
	class FormOpportunity extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormOpportunity.Body;
	}
}
