...
(function (MyDog) {
	'use strict';
	MyDog.Formmsdyn_project_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormCreate_Project = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
