...
(function (MyDog) {
	'use strict';
	MyDog.FormInvoiceDetail_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormProject = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	MyDog.FormInvoiceDetail = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
