...
(function (MyDog) {
	'use strict';
	MyDog.flowmachinegroupApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in flowmachinegroup) {
			var a = flowmachinegroup[field].a;
			var b = flowmachinegroup[field].b;
			var c = flowmachinegroup[field].c;
			var d = flowmachinegroup[field].d;
			var g = flowmachinegroup[field].g;
			var r = flowmachinegroup[field].r;
			flowmachinegroup[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		flowmachinegroup.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		flowmachinegroup.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
