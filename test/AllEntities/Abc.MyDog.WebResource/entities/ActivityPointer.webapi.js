...
(function (MyDog) {
	'use strict';
	MyDog.ActivityPointerApi = function (e) {
		var EMPTY_STRING = '';
		...
		var activitypointer = {
			...
			regardingobjectid_devkit_azureaccount: { b: 'regardingobjectid_devkit_azureaccount', a: '_regardingobjectid_value', c: 'devkit_azureaccounts', d: 'devkit_azureaccount' },
