...
declare namespace MyDog {
	...
	class Formmsdyn_estimate_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_estimate_Information.Body;
		/** The Grid of form msdyn_estimate_Information */
		Grid: MyDog.Formmsdyn_estimate_Information.Grid;
	}
	class msdyn_estimateApi {
		...
		*/
		...
		msdyn_estimateheadertype: DevKit.WebApi.OptionSetValue;
		/** Unique identifier for entity instances */
		msdyn_estimateId: DevKit.WebApi.GuidValue;
		/** Select the name of the project. */
