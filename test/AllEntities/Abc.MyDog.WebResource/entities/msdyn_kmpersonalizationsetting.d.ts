...
declare namespace MyDog {
	namespace Formmsdyn_kmpersonalizationsetting_Information {
		...
		interface tab__ADE28570_C803_4349_927A_9A1B2269450E extends DevKit.Form.Controls.IControlTab {
			Section: tab__ADE28570_C803_4349_927A_9A1B2269450E_Sections;
		}
		interface tab_knowledge_filter_settings extends DevKit.Form.Controls.IControlTab {
			Section: tab_knowledge_filter_settings_Sections;
		}
		interface tab_knowledge_authoring_language_settings extends DevKit.Form.Controls.IControlTab {
		...
		interface Body {
			Tab: Tabs;
			msdyn_filtercontroldata: DevKit.Form.Controls.ControlString;
			msdyn_languagecontrol: DevKit.Form.Controls.ControlString;
			/** The name of the custom entity. */
			msdyn_name: DevKit.Form.Controls.ControlString;
		}
	}
	class Formmsdyn_kmpersonalizationsetting_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.Formmsdyn_kmpersonalizationsetting_Information.Body;
	}
