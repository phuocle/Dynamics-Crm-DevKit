...
(function (MyDog) {
	...
	MyDog.TaskApi = function (e) {
		...
		var task = {
			...
			regardingobjectid_devkit_azureaccount_task: { b: 'regardingobjectid_devkit_azureaccount_task', a: '_regardingobjectid_value', c: 'devkit_azureaccounts', d: 'devkit_azureaccount' },
