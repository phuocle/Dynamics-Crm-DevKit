...
declare namespace MyDog {
	...
	class Formpackage_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form package_Information
		...
		*/
		...
		Body: MyDog.Formpackage_Information.Body;
	}
	class packageApi {
		/**
		...
		*/
		...
		InstalledOn_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		...
		packageId: DevKit.WebApi.GuidValue;
		PackageInstanceId: DevKit.WebApi.GuidValue;
		PackageInstanceOperationId: DevKit.WebApi.GuidValue;
		/** The unique name of the package. */
		PackageUniqueName: DevKit.WebApi.StringValue;
		...
		TPSPackageId: DevKit.WebApi.GuidValue;
