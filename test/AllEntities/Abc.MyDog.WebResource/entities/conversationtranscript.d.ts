...
declare namespace MyDog {
	namespace Formconversationtranscript_Information {
		...
		interface Body {
			...
			ConversationStartTime: DevKit.Form.Controls.ControlDateTime;
			...
			metadata: DevKit.Form.Controls.ControlString;
			...
			SchemaType: DevKit.Form.Controls.ControlString;
			/** The version of the conversation transcript content schema that is used. */
			SchemaVersion: DevKit.Form.Controls.ControlString;
		}
	}
	class Formconversationtranscript_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.Formconversationtranscript_Information.Body;
	}
