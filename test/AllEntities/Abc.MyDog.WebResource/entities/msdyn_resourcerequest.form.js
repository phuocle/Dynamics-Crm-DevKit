...
(function (MyDog) {
	'use strict';
	MyDog.Formmsdyn_resourcerequest_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_resourcerequest_Quick_Create = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
