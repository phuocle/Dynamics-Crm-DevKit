...
(function (MyDog) {
	'use strict';
	MyDog.FormOpportunityClose_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormOpportunity_Close = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
