...
(function (MyDog) {
	'use strict';
	MyDog.FormAgreement_Invoice_Setup_Mobile = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_agreementinvoicesetup_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
