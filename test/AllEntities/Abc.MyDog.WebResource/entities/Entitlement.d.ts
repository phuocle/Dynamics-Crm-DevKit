...
declare namespace MyDog {
	...
	class FormEntitlement extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormEntitlement.Body;
		/** The Header section of form Entitlement */
		Header: MyDog.FormEntitlement.Header;
		/** The Navigation of form Entitlement */
		Navigation: MyDog.FormEntitlement.Navigation;
		/** The Grid of form Entitlement */
		Grid: MyDog.FormEntitlement.Grid;
	}
...
//{'JsForm':['Entitlement'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}