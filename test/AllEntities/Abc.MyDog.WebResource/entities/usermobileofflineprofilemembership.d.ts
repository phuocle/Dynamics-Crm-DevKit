...
declare namespace MyDog {
	...
	class Formusermobileofflineprofilemembership_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form usermobileofflineprofilemembership_Information
		...
		*/
		...
		Body: MyDog.Formusermobileofflineprofilemembership_Information.Body;
	}
	class usermobileofflineprofilemembershipApi {
		...
		*/
		...
		HasMobileOfflineProfileIdConflict: DevKit.WebApi.BooleanValue;
		...
		SystemUserId: DevKit.WebApi.LookupValue;
		/** For internal use only. */
		TimeZoneRuleVersionNumber: DevKit.WebApi.IntegerValue;
		/** Unique identifier for entity instances */
		usermobileofflineprofilemembershipId: DevKit.WebApi.GuidValue;
