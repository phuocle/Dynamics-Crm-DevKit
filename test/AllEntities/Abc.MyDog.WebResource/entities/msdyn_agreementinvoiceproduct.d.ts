...
declare namespace MyDog {
	...
	class FormAgreement_Invoice_Product_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAgreement_Invoice_Product_Mobile.Body;
		/** The Navigation of form Agreement_Invoice_Product_Mobile */
		Navigation: MyDog.FormAgreement_Invoice_Product_Mobile.Navigation;
	}
	...
	class Formmsdyn_agreementinvoiceproduct_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_agreementinvoiceproduct_Information.Body;
		/** The Footer section of form msdyn_agreementinvoiceproduct_Information */
		Footer: MyDog.Formmsdyn_agreementinvoiceproduct_Information.Footer;
		/** The Navigation of form msdyn_agreementinvoiceproduct_Information */
		Navigation: MyDog.Formmsdyn_agreementinvoiceproduct_Information.Navigation;
	}
...
//{'JsForm':['Agreement Invoice Product - Mobile','Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}