...
declare namespace MyDog {
	...
	class Formmsdyn_geolocationtracking_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_geolocationtracking_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_geolocationtracking_Information.Body;
	}
	class msdyn_geolocationtrackingApi {
		...
		*/
		...
		msdyn_Date_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** Unique identifier for entity instances */
		msdyn_geolocationtrackingId: DevKit.WebApi.GuidValue;
		msdyn_Latitude: DevKit.WebApi.DecimalValue;
		msdyn_Longitude: DevKit.WebApi.DecimalValue;
		/** The name of the custom entity. */
