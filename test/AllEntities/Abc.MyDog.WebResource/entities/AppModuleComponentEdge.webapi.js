...
(function (MyDog) {
	'use strict';
	MyDog.AppModuleComponentEdgeApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in appmodulecomponentedge) {
			var a = appmodulecomponentedge[field].a;
			var b = appmodulecomponentedge[field].b;
			var c = appmodulecomponentedge[field].c;
			var d = appmodulecomponentedge[field].d;
			var g = appmodulecomponentedge[field].g;
			var r = appmodulecomponentedge[field].r;
			appmodulecomponentedge[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		appmodulecomponentedge.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		appmodulecomponentedge.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
