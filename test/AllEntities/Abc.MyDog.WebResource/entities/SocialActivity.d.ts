...
declare namespace MyDog {
	...
	class FormSocial_Activity extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSocial_Activity.Body;
		/** The Header section of form Social_Activity */
		Header: MyDog.FormSocial_Activity.Header;
	}
	...
	class FormSocial_Activity_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSocial_Activity_for_Interactive_experience.Body;
		/** The Header section of form Social_Activity_for_Interactive_experience */
		Header: MyDog.FormSocial_Activity_for_Interactive_experience.Header;
	}
...
//{'JsForm':['Social Activity','Social Activity for Interactive experience'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}