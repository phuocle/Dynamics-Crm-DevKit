...
declare namespace MyDog {
	...
	class FormPosition extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormPosition.Body;
		/** The Grid of form Position */
		Grid: MyDog.FormPosition.Grid;
	}
	class PositionApi {
		/**
...
//{'JsForm':['Position'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}