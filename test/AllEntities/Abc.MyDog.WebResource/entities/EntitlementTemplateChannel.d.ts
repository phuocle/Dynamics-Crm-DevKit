...
declare namespace MyDog {
	...
	class FormEntitlement_Template_Channel extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormEntitlement_Template_Channel.Body;
	}
...
//{'JsForm':['Entitlement Template Channel'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}