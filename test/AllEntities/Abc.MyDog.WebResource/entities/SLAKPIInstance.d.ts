...
declare namespace MyDog {
	...
	class FormSLA_KPI_Instance extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSLA_KPI_Instance.Body;
		/** The Header section of form SLA_KPI_Instance */
		Header: MyDog.FormSLA_KPI_Instance.Header;
	}
...
//{'JsForm':['SLA KPI Instance'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}