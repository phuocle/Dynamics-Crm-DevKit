...
declare namespace MyDog {
	...
	class Formmsdyn_agreementsubstatus_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_agreementsubstatus_Information.Body;
		/** The Footer section of form msdyn_agreementsubstatus_Information */
		Footer: MyDog.Formmsdyn_agreementsubstatus_Information.Footer;
		/** The Navigation of form msdyn_agreementsubstatus_Information */
		Navigation: MyDog.Formmsdyn_agreementsubstatus_Information.Navigation;
	}
	class msdyn_agreementsubstatusApi {
		...
		*/
		...
		msdyn_agreementsubstatusId: DevKit.WebApi.GuidValue;
		/** Specify whether this status should be the default substatus for this status type */
