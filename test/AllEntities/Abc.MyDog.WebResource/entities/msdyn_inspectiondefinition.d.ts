...
declare namespace MyDog {
	namespace Formmsdyn_inspectiondefinition_Information {
		...
		interface Body {
			...
			/** Shows the date and time when the Inspection would be Effective. By default its the Inspection published date. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options. */
			msdyn_EffectiveDate: DevKit.Controls.DateTime;
			/** Depicts whether the record has required question at the time of creation of Inspection. */
			...
			/** Unique identifier for Inspection associated with InspectionDefinition. */
	...
	class Formmsdyn_inspectiondefinition_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_inspectiondefinition_Information.Body;
		/** The Header section of form msdyn_inspectiondefinition_Information */
		Header: MyDog.Formmsdyn_inspectiondefinition_Information.Header;
		/** The QuickForm of form msdyn_inspectiondefinition_Information */
		QuickForm: MyDog.Formmsdyn_inspectiondefinition_Information.QuickForm;
	}
}
