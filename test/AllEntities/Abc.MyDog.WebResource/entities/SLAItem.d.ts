...
declare namespace MyDog {
	namespace FormSLAItem_Information {
		...
		interface Body {
			Tab: Tabs;
			WebResource_slaitem_applicablewhen_notification: DevKit.Form.Controls.ControlWebResource;
			applicablewhencontrol: DevKit.Form.Controls.ControlActionCards;
			WebResource_slaitem_success_notification: DevKit.Form.Controls.ControlWebResource;
	...
	class FormSLAItem_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormSLAItem_Information.Body;
		/** The Header section of form SLAItem_Information */
		Header: MyDog.FormSLAItem_Information.Header;
	}
	class SLAItemApi {
		/**
