...
declare namespace MyDog {
	namespace FormCatalogAssignment_Information {
		interface Tabs {
		}
		interface Body {
			/** Unique identifier for the catalog associated with the catalog assignment */
			CatalogId: DevKit.Form.Controls.ControlLookup;
			/** The primary name of the catalog assignment */
			Name: DevKit.Form.Controls.ControlString;
			/** Unique identifier for the object associated with the catalog assignment */
			Object: DevKit.Form.Controls.ControlLookup;
		}
	}
	class FormCatalogAssignment_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form CatalogAssignment_Information
		...
		*/
		...
		Body: MyDog.FormCatalogAssignment_Information.Body;
	}
	class CatalogAssignmentApi {
		...
		*/
		...
		CatalogAssignmentId: DevKit.WebApi.GuidValue;
		/** Unique identifier for the catalog associated with the catalog assignment */
