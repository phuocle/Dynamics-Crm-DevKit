...
declare namespace MyDog {
	...
	class Formmsdyn_invoicefrequency_Project_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_invoicefrequency_Project_Information.Body;
		/** The Navigation of form msdyn_invoicefrequency_Project_Information */
		Navigation: MyDog.Formmsdyn_invoicefrequency_Project_Information.Navigation;
		/** The Grid of form msdyn_invoicefrequency_Project_Information */
		Grid: MyDog.Formmsdyn_invoicefrequency_Project_Information.Grid;
	}
}
