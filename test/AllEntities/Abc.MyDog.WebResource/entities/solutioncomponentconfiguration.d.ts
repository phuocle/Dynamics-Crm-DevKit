...
declare namespace MyDog {
	namespace Formsolutioncomponentconfiguration_Information {
		...
		interface Body {
			FileFormat: DevKit.Form.Controls.ControlOptionSet;
			FileScope: DevKit.Form.Controls.ControlOptionSet;
			/** The name of the custom entity. */
			name: DevKit.Form.Controls.ControlString;
		}
	}
	class Formsolutioncomponentconfiguration_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form solutioncomponentconfiguration_Information
		...
		*/
		...
		Body: MyDog.Formsolutioncomponentconfiguration_Information.Body;
	}
	class solutioncomponentconfigurationApi {
		...
		*/
		...
		EntityId: DevKit.WebApi.LookupValue;
		FileFormat: DevKit.WebApi.OptionSetValue;
		FileScope: DevKit.WebApi.OptionSetValue;
		...
		IsSoftDeleteEnabled: DevKit.WebApi.BooleanValue;
		/** Boolean that indicates if the component should retain its unmanaged customization after conversion. */
		KeepActiveCustomizationAfterConversion: DevKit.WebApi.BooleanValue;
		...
		solutioncomponentconfigurationId: DevKit.WebApi.GuidValue;
