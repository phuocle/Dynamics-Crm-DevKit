...
(function (MyDog) {
	'use strict';
	MyDog.usermobileofflineprofilemembershipApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in usermobileofflineprofilemembership) {
			var a = usermobileofflineprofilemembership[field].a;
			var b = usermobileofflineprofilemembership[field].b;
			var c = usermobileofflineprofilemembership[field].c;
			var d = usermobileofflineprofilemembership[field].d;
			var g = usermobileofflineprofilemembership[field].g;
			var r = usermobileofflineprofilemembership[field].r;
			usermobileofflineprofilemembership[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		usermobileofflineprofilemembership.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		usermobileofflineprofilemembership.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
