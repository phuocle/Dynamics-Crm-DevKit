...
(function (MyDog) {
	'use strict';
	MyDog.FormAgreement_Booking_Service_Task_Mobile = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_agreementbookingservicetask_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
