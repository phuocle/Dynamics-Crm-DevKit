...
declare namespace MyDog {
	namespace Formappnotification_Information {
		...
		interface Body {
			...
			Body: DevKit.Form.Controls.ControlString;
			...
			IconType: DevKit.Form.Controls.ControlOptionSet;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
			/** Title for the notification */
			Title: DevKit.Form.Controls.ControlString;
			/** Type of toast behavior for the notification */
			ToastType: DevKit.Form.Controls.ControlOptionSet;
		}
	}
	class Formappnotification_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.Formappnotification_Information.Body;
	}
	class appnotificationApi {
		...
		*/
		...
		appnotificationId: DevKit.WebApi.GuidValue;
		/** Body of the notification */
