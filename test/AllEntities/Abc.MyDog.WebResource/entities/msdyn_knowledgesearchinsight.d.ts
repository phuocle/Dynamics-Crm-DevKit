...
declare namespace MyDog {
	namespace Formmsdyn_knowledgesearchinsight_Information {
		...
		interface Body {
			...
			msdyn_SearchTerm: DevKit.Form.Controls.ControlString;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_knowledgesearchinsight_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_knowledgesearchinsight_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_knowledgesearchinsight_Information.Body;
	}
