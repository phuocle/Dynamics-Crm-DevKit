...
declare namespace MyDog {
	...
	class FormAgreement_Booking_Incident_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAgreement_Booking_Incident_Mobile.Body;
		/** The Navigation of form Agreement_Booking_Incident_Mobile */
		Navigation: MyDog.FormAgreement_Booking_Incident_Mobile.Navigation;
	}
	namespace Formmsdyn_agreementbookingincident_Information {
		...
		interface Navigation {
			nav_msdyn_msdyn_agreementbookingincident_msdyn_agreementbookingproduct_AgreementBookingIncident: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_agreementbookingincident_msdyn_workorderincident_AgreementBookingIncident: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_agreementbookingincident_msdyn_agreementbookingservice_AgreementBookingIncident: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_agreementbookingincident_msdyn_agreementbookingservicetask_AgreementBookingIncident: DevKit.Controls.NavigationItem,
			navProcessSessions: DevKit.Controls.NavigationItem
		}
	}
	class Formmsdyn_agreementbookingincident_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_agreementbookingincident_Information.Body;
		/** The Footer section of form msdyn_agreementbookingincident_Information */
		Footer: MyDog.Formmsdyn_agreementbookingincident_Information.Footer;
		/** The Navigation of form msdyn_agreementbookingincident_Information */
		Navigation: MyDog.Formmsdyn_agreementbookingincident_Information.Navigation;
	}
