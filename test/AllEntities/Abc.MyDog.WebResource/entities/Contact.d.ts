...
declare namespace MyDog {
	...
	class FormContact extends DevKit.Form.IForm {
		...
		*/
		...
		Navigation: MyDog.FormContact.Navigation;
	}
	...
	class FormContact_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormContact_Information.Body;
		/** The Header section of form Contact_Information */
		Header: MyDog.FormContact_Information.Header;
		/** The Navigation of form Contact_Information */
		Navigation: MyDog.FormContact_Information.Navigation;
	}
	...
	class FormContact_Quick_Create extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormContact_Quick_Create.Body;
	}
	class ContactApi {
		/**
...
//{'JsForm':['Contact','Information','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}