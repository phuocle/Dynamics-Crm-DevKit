...
declare namespace MyDog {
	namespace Formdevkit_bpfaccount1_Information {
		...
		interface tab_StageStep9_Sections {
			StageStep9_section1: DevKit.Form.Controls.ControlSection;
		}
		interface tab_StageStep13_Sections {
			StageStep13_section1: DevKit.Form.Controls.ControlSection;
		}
		interface tab_StageStep3 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep3_Sections;
		}
		interface tab_StageStep9 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep9_Sections;
		}
		interface tab_StageStep13 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep13_Sections;
		}
		interface Tabs {
			StageStep3: tab_StageStep3;
			StageStep9: tab_StageStep9;
			StageStep13: tab_StageStep13;
		}
		interface Body {
			Tab: Tabs;
	...
	class Formdevkit_bpfaccount1_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form devkit_bpfaccount1_Information
		...
		*/
		...
		/** The Body section of form devkit_bpfaccount1_Information */
		Body: MyDog.Formdevkit_bpfaccount1_Information.Body;
	}
	class devkit_bpfaccount1Api {
		/**
		* DynamicsCrm.DevKit devkit_bpfaccount1Api
		...
		*/
		...
		/** Status of the BPF Account 1 */
		statecode: DevKit.WebApi.OptionSetValue;
		/** Reason for the status of the BPF Account 1 */
