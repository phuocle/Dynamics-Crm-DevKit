...
declare namespace MyDog {
	class activityfileattachmentApi {
		...
		*/
		...
		activityfileattachmentId: DevKit.WebApi.GuidValue;
		...
		FileContent_Name: DevKit.WebApi.StringValueReadonly;
		...
		parentid_post: DevKit.WebApi.LookupValue;
		/** Unique identifier of the entity with which the attachment is associated. */
		parentid_postcomment: DevKit.WebApi.LookupValue;
