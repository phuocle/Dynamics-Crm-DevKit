...
declare namespace MyDog {
	...
	class FormPurchase_Order extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormPurchase_Order.Body;
		/** The Navigation of form Purchase_Order */
		Navigation: MyDog.FormPurchase_Order.Navigation;
		/** The Process of form Purchase_Order */
		Process: MyDog.FormPurchase_Order.Process;
		/** The Grid of form Purchase_Order */
		Grid: MyDog.FormPurchase_Order.Grid;
	}
	...
	class FormPurchase_Order_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormPurchase_Order_Mobile.Body;
		/** The Navigation of form Purchase_Order_Mobile */
		Navigation: MyDog.FormPurchase_Order_Mobile.Navigation;
		/** The Process of form Purchase_Order_Mobile */
		Process: MyDog.FormPurchase_Order_Mobile.Process;
		/** The Grid of form Purchase_Order_Mobile */
		Grid: MyDog.FormPurchase_Order_Mobile.Grid;
	}
}
