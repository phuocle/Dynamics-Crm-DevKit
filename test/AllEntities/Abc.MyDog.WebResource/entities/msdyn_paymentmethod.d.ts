...
declare namespace MyDog {
	...
	class Formmsdyn_paymentmethod_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_paymentmethod_Information.Body;
		/** The Footer section of form msdyn_paymentmethod_Information */
		Footer: MyDog.Formmsdyn_paymentmethod_Information.Footer;
		/** The Navigation of form msdyn_paymentmethod_Information */
		Navigation: MyDog.Formmsdyn_paymentmethod_Information.Navigation;
	}
}
