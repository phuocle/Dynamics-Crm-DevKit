...
(function (MyDog) {
	'use strict';
	MyDog.FormQuote_Field_Service_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormQuote_Project_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	MyDog.FormQuote = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
