...
declare namespace MyDog {
	...
	class FormApplication_User extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormApplication_User.Body;
		/** The Footer section of form Application_User */
		Footer: MyDog.FormApplication_User.Footer;
	}
	namespace FormUser {
		interface tab_SUMMARY_TAB_Sections {
			onpremise_account_information: DevKit.Form.Controls.ControlSection;
	...
	class FormUser extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormUser.Body;
		/** The Footer section of form User */
		Footer: MyDog.FormUser.Footer;
	}
	...
	class FormUser_form_Business extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormUser_form_Business.Body;
		/** The Footer section of form User_form_Business */
		Footer: MyDog.FormUser_form_Business.Footer;
		/** The Navigation of form User_form_Business */
		Navigation: MyDog.FormUser_form_Business.Navigation;
	}
	class SystemUserApi {
		/**
...
//{'JsForm':['Application User','User','User form – Business'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}