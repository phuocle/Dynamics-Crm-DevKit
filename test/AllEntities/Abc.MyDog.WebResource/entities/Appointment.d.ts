...
declare namespace MyDog {
	...
	class FormAppointment extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAppointment.Body;
		/** The Header section of form Appointment */
		Header: MyDog.FormAppointment.Header;
	}
	...
	class FormAppointment_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAppointment_for_Interactive_experience.Body;
		/** The Header section of form Appointment_for_Interactive_experience */
		Header: MyDog.FormAppointment_for_Interactive_experience.Header;
	}
	...
	class FormAppointment_Wizard extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAppointment_Wizard.Body;
		/** The Header section of form Appointment_Wizard */
		Header: MyDog.FormAppointment_Wizard.Header;
	}
	...
	class FormAppointment_quick_create_form extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAppointment_quick_create_form.Body;
	}
...
//{'JsForm':['Appointment','Appointment for Interactive experience','Appointment quick create form.','Wizard'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}