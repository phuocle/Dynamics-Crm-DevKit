...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_FunctionalLocationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_functionallocation) {
			var a = msdyn_functionallocation[field].a;
			var b = msdyn_functionallocation[field].b;
			var c = msdyn_functionallocation[field].c;
			var d = msdyn_functionallocation[field].d;
			var g = msdyn_functionallocation[field].g;
			var r = msdyn_functionallocation[field].r;
			msdyn_functionallocation[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_functionallocation.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_functionallocation.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
