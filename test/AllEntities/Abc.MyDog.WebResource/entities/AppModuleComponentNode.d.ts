...
declare namespace MyDog {
	class AppModuleComponentNodeApi {
		...
		*/
		...
		AppModuleComponentNodeId: DevKit.WebApi.GuidValue;
		ComponentDatabaseVersion: DevKit.WebApi.StringValue;
		/** Unique identifier for Model-Driven App component. */
		ComponentObjectId: DevKit.WebApi.StringValue;
		...
		SnapshotVersionNumber: DevKit.WebApi.IntegerValue;
		...
		ValidationResult: DevKit.WebApi.StringValue;
