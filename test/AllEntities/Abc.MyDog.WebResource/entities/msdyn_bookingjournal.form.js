...
(function (MyDog) {
	'use strict';
	MyDog.FormBooking_Journal_Mobile = function(executionContext, defaultWebResourceName) {
	...
	MyDog.Formmsdyn_bookingjournal_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
