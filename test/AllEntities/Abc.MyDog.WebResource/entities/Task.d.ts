...
declare namespace MyDog {
	...
	class FormTask extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTask.Body;
		/** The Header section of form Task */
		Header: MyDog.FormTask.Header;
	}
	...
	class FormTask_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTask_for_Interactive_experience.Body;
		/** The Header section of form Task_for_Interactive_experience */
		Header: MyDog.FormTask_for_Interactive_experience.Header;
	}
	...
	class FormTask_quick_create_form extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTask_quick_create_form.Body;
	}
	class TaskApi {
		/**
...
//{'JsForm':['Task','Task for Interactive experience','Task quick create form.'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}