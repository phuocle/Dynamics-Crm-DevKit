...
declare namespace MyDog {
	namespace FormNewProcesses {
		interface tab_general_Sections {
			newprocessinformation: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormNewProcesses extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form NewProcesses
		...
		*/
		...
		Body: MyDog.FormNewProcesses.Body;
	}
	class NewProcessApi {
		/**
...
//{'JsForm':['NewProcesses'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}