...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_customengagementctxApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_customengagementctx) {
			var a = msdyn_customengagementctx[field].a;
			var b = msdyn_customengagementctx[field].b;
			var c = msdyn_customengagementctx[field].c;
			var d = msdyn_customengagementctx[field].d;
			var g = msdyn_customengagementctx[field].g;
			var r = msdyn_customengagementctx[field].r;
			msdyn_customengagementctx[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_customengagementctx.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_customengagementctx.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
