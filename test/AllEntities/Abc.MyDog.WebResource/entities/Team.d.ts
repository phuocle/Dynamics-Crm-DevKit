...
declare namespace MyDog {
	namespace FormTeam {
		...
		interface Body {
			...
			MembershipType: DevKit.Form.Controls.ControlOptionSet;
			/** Name of the team. */
	...
	class FormTeam extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTeam.Body;
		/** The Header section of form Team */
		Header: MyDog.FormTeam.Header;
	}
	...
	class FormTeam_form_Business extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormTeam_form_Business.Body;
		/** The Navigation of form Team_form_Business */
		Navigation: MyDog.FormTeam_form_Business.Navigation;
	}
	class TeamApi {
		/**
...
//{'JsForm':['Team','Team form – Business'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}