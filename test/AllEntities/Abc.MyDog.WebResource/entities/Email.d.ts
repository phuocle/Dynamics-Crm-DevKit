...
declare namespace MyDog {
	...
	class FormEmail extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEmail.Body;
		/** The Footer section of form Email */
		Footer: MyDog.FormEmail.Footer;
		/** The Header section of form Email */
		Header: MyDog.FormEmail.Header;
	}
	...
	class FormEmail_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEmail_for_Interactive_experience.Body;
		/** The Header section of form Email_for_Interactive_experience */
		Header: MyDog.FormEmail_for_Interactive_experience.Header;
	}
	...
	class FormEnhanced_Email extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEnhanced_Email.Body;
		/** The Footer section of form Enhanced_Email */
		Footer: MyDog.FormEnhanced_Email.Footer;
		/** The Header section of form Enhanced_Email */
		Header: MyDog.FormEnhanced_Email.Header;
	}
	...
	class FormEmail_Wizard extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEmail_Wizard.Body;
		/** The Header section of form Email_Wizard */
		Header: MyDog.FormEmail_Wizard.Header;
	}
	class EmailApi {
		/**
...
//{'JsForm':['Email','Email for Interactive experience','Enhanced Email','Wizard'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}