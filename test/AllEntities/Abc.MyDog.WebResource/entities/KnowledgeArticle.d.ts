...
declare namespace MyDog {
	namespace FormKnowledge_Article {
		...
		interface Body {
			...
			: DevKit.Form.Controls.ELSE2???;//RelatedTranslationsGrid - 02D4264B-47E2-4B4C-AA95-F439F3F4D458 -- FOR DEBUG 
			: DevKit.Form.Controls.ELSE2???;//RelatedCategoriesGrid - 02D4264B-47E2-4B4C-AA95-F439F3F4D458 -- FOR DEBUG 
	...
	class FormKnowledge_Article extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormKnowledge_Article.Body;
		/** The Footer section of form Knowledge_Article */
		Footer: MyDog.FormKnowledge_Article.Footer;
		/** The Header section of form Knowledge_Article */
		Header: MyDog.FormKnowledge_Article.Header;
		/** The Process of form Knowledge_Article */
		Process: MyDog.FormKnowledge_Article.Process;
	}
	...
	class FormKnowledge_Article_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormKnowledge_Article_for_Interactive_experience.Body;
		/** The Footer section of form Knowledge_Article_for_Interactive_experience */
		Footer: MyDog.FormKnowledge_Article_for_Interactive_experience.Footer;
		/** The Header section of form Knowledge_Article_for_Interactive_experience */
		Header: MyDog.FormKnowledge_Article_for_Interactive_experience.Header;
		/** The Process of form Knowledge_Article_for_Interactive_experience */
		Process: MyDog.FormKnowledge_Article_for_Interactive_experience.Process;
	}
	...
	class FormKnowledge_Article_Quick_Create extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: MyDog.FormKnowledge_Article_Quick_Create.Body;
	}
...
//{'JsForm':['Knowledge Article','Knowledge Article for Interactive experience','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}