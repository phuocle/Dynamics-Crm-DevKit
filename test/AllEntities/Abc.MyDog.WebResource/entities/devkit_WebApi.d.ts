...
declare namespace MyDog {
	...
	class FormWebApi_2 extends DevKit.Form.IForm {
		...
		*/
		...
		Navigation: MyDog.FormWebApi_2.Navigation;
...
//{'JsForm':['Quick Create','WebApi','WebApi 2'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}