...
declare namespace MyDog {
	namespace Formdevkit_bpf_location_1_Information {
	...
	class Formdevkit_bpf_location_1_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form devkit_bpf_location_1_Information
		...
		*/
		...
		/** The Body section of form devkit_bpf_location_1_Information */
		Body: MyDog.Formdevkit_bpf_location_1_Information.Body;
	}
	class devkit_bpf_location_1Api {
		/**
		* DynamicsCrm.DevKit devkit_bpf_location_1Api
		...
		*/
		...
		/** Status of the BPF-Location-1 */
		statecode: DevKit.WebApi.OptionSetValue;
		/** Reason for the status of the BPF-Location-1 */
...
declare namespace OptionSet {
	namespace devkit_bpf_location_1 {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
