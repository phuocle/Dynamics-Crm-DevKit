...
declare namespace MyDog {
	...
	class FormLead extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormLead.Body;
		/** The Header section of form Lead */
		Header: MyDog.FormLead.Header;
		/** The Navigation of form Lead */
		Navigation: MyDog.FormLead.Navigation;
		/** The Process of form Lead */
		Process: MyDog.FormLead.Process;
		/** The Grid of form Lead */
		Grid: MyDog.FormLead.Grid;
	}
	...
	class FormLead_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormLead_Quick_Create.Body;
	}
	class LeadApi {
		/**
