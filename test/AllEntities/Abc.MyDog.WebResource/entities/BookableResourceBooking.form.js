...
(function (MyDog) {
	'use strict';
	MyDog.FormBooking_and_Work_Order = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormBookableResourceBooking_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	MyDog.FormResource_Booking_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
