...
declare namespace MyDog {
	namespace Formmsdyn_problematicasset_Information {
		...
		interface Body {
			...
			/** Probablity of predicting customer asset to be problematic in current date */
	...
	class Formmsdyn_problematicasset_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_problematicasset_Information.Body;
		/** The Navigation of form msdyn_problematicasset_Information */
		Navigation: MyDog.Formmsdyn_problematicasset_Information.Navigation;
	}
}
