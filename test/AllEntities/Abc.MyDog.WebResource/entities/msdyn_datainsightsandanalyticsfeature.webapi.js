...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_datainsightsandanalyticsfeatureApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_datainsightsandanalyticsfeature) {
			var a = msdyn_datainsightsandanalyticsfeature[field].a;
			var b = msdyn_datainsightsandanalyticsfeature[field].b;
			var c = msdyn_datainsightsandanalyticsfeature[field].c;
			var d = msdyn_datainsightsandanalyticsfeature[field].d;
			var g = msdyn_datainsightsandanalyticsfeature[field].g;
			var r = msdyn_datainsightsandanalyticsfeature[field].r;
			msdyn_datainsightsandanalyticsfeature[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_datainsightsandanalyticsfeature.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_datainsightsandanalyticsfeature.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
