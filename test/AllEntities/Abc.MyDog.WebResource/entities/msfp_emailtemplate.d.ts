...
declare namespace MyDog {
	...
	class Formmsfp_emailtemplate_New_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msfp_emailtemplate_New_Form
		...
		*/
		...
		Body: MyDog.Formmsfp_emailtemplate_New_Form.Body;
	}
}
...
//{'JsForm':['msfp_emailtemplate New_Form'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false,'Version':'2.12.31','JsFormVersion':'v2'}