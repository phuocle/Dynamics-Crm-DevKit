...
declare namespace MyDog {
	namespace Formmsdyn_sentimentanalysis_Information {
		...
		interface Body {
			...
			msdyn_driversenableddisclaimer: DevKit.Controls.ActionCards;
			...
			/** Specifies whether sentiment drivers are reported in Omnichannel Insights */
			msdyn_driversenabled: DevKit.Controls.Boolean;
	...
	class Formmsdyn_sentimentanalysis_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_sentimentanalysis_Information.Body;
	}
}
