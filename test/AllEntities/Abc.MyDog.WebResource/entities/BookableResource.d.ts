...
declare namespace MyDog {
	...
	class FormBookable_Resource_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormBookable_Resource_Mobile.Body;
		/** The Navigation of form Bookable_Resource_Mobile */
		Navigation: MyDog.FormBookable_Resource_Mobile.Navigation;
		/** The Grid of form Bookable_Resource_Mobile */
		Grid: MyDog.FormBookable_Resource_Mobile.Grid;
	}
	...
	class FormBookableResource_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormBookableResource_Information.Body;
		/** The Navigation of form BookableResource_Information */
		Navigation: MyDog.FormBookableResource_Information.Navigation;
		/** The Grid of form BookableResource_Information */
		Grid: MyDog.FormBookableResource_Information.Grid;
	}
