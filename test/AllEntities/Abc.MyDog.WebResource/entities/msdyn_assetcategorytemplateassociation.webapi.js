...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_assetcategorytemplateassociationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_assetcategorytemplateassociation) {
			var a = msdyn_assetcategorytemplateassociation[field].a;
			var b = msdyn_assetcategorytemplateassociation[field].b;
			var c = msdyn_assetcategorytemplateassociation[field].c;
			var d = msdyn_assetcategorytemplateassociation[field].d;
			var g = msdyn_assetcategorytemplateassociation[field].g;
			var r = msdyn_assetcategorytemplateassociation[field].r;
			msdyn_assetcategorytemplateassociation[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_assetcategorytemplateassociation.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_assetcategorytemplateassociation.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
