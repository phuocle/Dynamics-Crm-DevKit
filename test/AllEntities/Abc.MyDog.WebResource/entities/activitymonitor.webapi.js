...
(function (MyDog) {
	'use strict';
	MyDog.activitymonitorApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in activitymonitor) {
			var a = activitymonitor[field].a;
			var b = activitymonitor[field].b;
			var c = activitymonitor[field].c;
			var d = activitymonitor[field].d;
			var g = activitymonitor[field].g;
			var r = activitymonitor[field].r;
			activitymonitor[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		activitymonitor.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		activitymonitor.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
