...
declare namespace MyDog {
	...
	class FormKnowledge_Base_Articles extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormKnowledge_Base_Articles.Body;
		/** The Header section of form Knowledge_Base_Articles */
		Header: MyDog.FormKnowledge_Base_Articles.Header;
	}
...
//{'JsForm':['Knowledge Base Articles'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}