...
declare namespace MyDog {
	...
	class FormProperty extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormProperty.Body;
		/** The Grid of form Property */
		Grid: MyDog.FormProperty.Grid;
	}
	...
	class FormProperty_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Property_Quick_Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: MyDog.FormProperty_Quick_Create.Body;
	}
...
//{'JsForm':['Property','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}