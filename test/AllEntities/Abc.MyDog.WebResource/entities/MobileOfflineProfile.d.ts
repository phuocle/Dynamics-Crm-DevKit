...
declare namespace MyDog {
	...
	class FormMobile_Offline_Profile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormMobile_Offline_Profile.Body;
		/** The Grid of form Mobile_Offline_Profile */
		Grid: MyDog.FormMobile_Offline_Profile.Grid;
	}
...
//{'JsForm':['Mobile Offline Profile'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}