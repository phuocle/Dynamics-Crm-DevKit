...
(function (MyDog) {
	'use strict';
	MyDog.msdyn_agreementbookingincidentApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_agreementbookingincident) {
			var a = msdyn_agreementbookingincident[field].a;
			var b = msdyn_agreementbookingincident[field].b;
			var c = msdyn_agreementbookingincident[field].c;
			var d = msdyn_agreementbookingincident[field].d;
			var g = msdyn_agreementbookingincident[field].g;
			var r = msdyn_agreementbookingincident[field].r;
			msdyn_agreementbookingincident[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementbookingincident.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_agreementbookingincident.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
