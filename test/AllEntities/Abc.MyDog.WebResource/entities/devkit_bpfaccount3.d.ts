...
declare namespace MyDog {
	namespace Formdevkit_bpfaccount3_Information {
		interface tab_StageStep3_Sections {
			StageStep3_section1: DevKit.Form.Controls.ControlSection;
		}
		interface tab_StageStep7_Sections {
			StageStep7_section1: DevKit.Form.Controls.ControlSection;
		}
		interface tab_StageStep3 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep3_Sections;
		}
		interface tab_StageStep7 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep7_Sections;
		}
		interface Tabs {
			StageStep3: tab_StageStep3;
			StageStep7: tab_StageStep7;
		}
		interface Body {
			Tab: Tabs;
	...
	class Formdevkit_bpfaccount3_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form devkit_bpfaccount3_Information
		...
		*/
		...
		/** The Body section of form devkit_bpfaccount3_Information */
		Body: MyDog.Formdevkit_bpfaccount3_Information.Body;
	}
	class devkit_bpfaccount3Api {
		/**
		* DynamicsCrm.DevKit devkit_bpfaccount3Api
		...
		*/
		...
		/** Status of the BPF Account 3 */
		statecode: DevKit.WebApi.OptionSetValue;
		/** Reason for the status of the BPF Account 3 */
