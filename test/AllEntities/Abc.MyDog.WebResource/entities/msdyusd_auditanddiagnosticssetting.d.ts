...
declare namespace MyDog {
	...
	class Formmsdyusd_auditanddiagnosticssetting_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyusd_auditanddiagnosticssetting_Information.Body;
		/** The Navigation of form msdyusd_auditanddiagnosticssetting_Information */
		Navigation: MyDog.Formmsdyusd_auditanddiagnosticssetting_Information.Navigation;
		/** The Grid of form msdyusd_auditanddiagnosticssetting_Information */
		Grid: MyDog.Formmsdyusd_auditanddiagnosticssetting_Information.Grid;
	}
}
