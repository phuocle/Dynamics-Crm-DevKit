...
declare namespace MyDog {
	namespace FormAgreement_Booking_Service_Task_Mobile {
		...
		interface Body {
			...
			/** Unique identifier for Inspection associated with Agreement Booking Service Task. */
			msdyn_Inspection: DevKit.Controls.Lookup;
			/** Unique identifier for Inspection associated with Agreement Booking Service Task. */
			msdyn_Inspection_1: DevKit.Controls.Lookup;
			/** Depicts whether inspection is enabled for Agreement Booking Service Task */
	...
	class FormAgreement_Booking_Service_Task_Mobile extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.FormAgreement_Booking_Service_Task_Mobile.Body;
		/** The Navigation of form Agreement_Booking_Service_Task_Mobile */
		Navigation: MyDog.FormAgreement_Booking_Service_Task_Mobile.Navigation;
	}
	...
	class Formmsdyn_agreementbookingservicetask_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_agreementbookingservicetask_Information.Body;
		/** The Footer section of form msdyn_agreementbookingservicetask_Information */
		Footer: MyDog.Formmsdyn_agreementbookingservicetask_Information.Footer;
		/** The Navigation of form msdyn_agreementbookingservicetask_Information */
		Navigation: MyDog.Formmsdyn_agreementbookingservicetask_Information.Navigation;
	}
	class msdyn_agreementbookingservicetaskApi {
		...
		*/
		...
		msdyn_agreementbookingservicetaskId: DevKit.WebApi.GuidValue;
		/** Unique identifier for Agreement Booking Setup associated with Agreement Booking Service Task. */
