...
declare namespace MyDog {
	...
	class Formmsdyn_purchaseordersubstatus_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_purchaseordersubstatus_Information.Body;
		/** The Footer section of form msdyn_purchaseordersubstatus_Information */
		Footer: MyDog.Formmsdyn_purchaseordersubstatus_Information.Footer;
		/** The Navigation of form msdyn_purchaseordersubstatus_Information */
		Navigation: MyDog.Formmsdyn_purchaseordersubstatus_Information.Navigation;
	}
}
