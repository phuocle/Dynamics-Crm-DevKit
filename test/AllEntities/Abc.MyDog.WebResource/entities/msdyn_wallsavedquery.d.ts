...
declare namespace MyDog {
	...
	class Formmsdyn_wallsavedquery_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_wallsavedquery_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_wallsavedquery_Information.Body;
		/** The Footer section of form msdyn_wallsavedquery_Information */
		Footer: MyDog.Formmsdyn_wallsavedquery_Information.Footer;
	}
}
