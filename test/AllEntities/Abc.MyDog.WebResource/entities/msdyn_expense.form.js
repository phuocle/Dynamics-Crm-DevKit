...
(function (MyDog) {
	'use strict';
	MyDog.Formmsdyn_expense_Information = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormCreate_Expense = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
