...
declare namespace MyDog {
	namespace FormEmailServerProfile_Information {
		...
		interface Body {
			...
			OauthClientId: DevKit.Form.Controls.ControlString;
			/** Client secret used for the OAuth authentication scheme */
			OauthClientSecret: DevKit.Form.Controls.ControlString;
	...
	class FormEmailServerProfile_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormEmailServerProfile_Information.Body;
		/** The Footer section of form EmailServerProfile_Information */
		Footer: MyDog.FormEmailServerProfile_Information.Footer;
	}
