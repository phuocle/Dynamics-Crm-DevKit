...
declare namespace MyDog {
	namespace FormCustomAPIRequestParameter_Information {
		...
		interface Body {
			...
			IsOptional: DevKit.Form.Controls.ControlBoolean;
	...
	class FormCustomAPIRequestParameter_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form CustomAPIRequestParameter_Information
		...
		*/
		...
		Body: MyDog.FormCustomAPIRequestParameter_Information.Body;
	}
