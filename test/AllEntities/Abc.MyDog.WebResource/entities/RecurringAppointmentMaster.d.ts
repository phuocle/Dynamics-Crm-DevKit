...
declare namespace MyDog {
	...
	class FormRecurring_Appointment extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormRecurring_Appointment.Body;
		/** The Header section of form Recurring_Appointment */
		Header: MyDog.FormRecurring_Appointment.Header;
	}
...
//{'JsForm':['Recurring Appointment'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}