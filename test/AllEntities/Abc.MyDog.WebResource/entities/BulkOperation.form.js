...
(function (MyDog) {
	'use strict';
	MyDog.FormQuick_Campaign = function(executionContext, defaultWebResourceName) {
	...
	MyDog.FormQuick_Campaign_deprecated = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
