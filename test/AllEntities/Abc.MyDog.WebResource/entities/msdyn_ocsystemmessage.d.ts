...
declare namespace MyDog {
	...
	class Formmsdyn_ocsystemmessage_Information extends DevKit.IForm {
		...
		*/
		...
		Body: MyDog.Formmsdyn_ocsystemmessage_Information.Body;
		/** The Grid of form msdyn_ocsystemmessage_Information */
		Grid: MyDog.Formmsdyn_ocsystemmessage_Information.Grid;
	}
}
declare namespace OptionSet {
	namespace msdyn_ocsystemmessage {
		...
		enum msdyn_systemmessageeventtype {
			...
			Consult_started,
			/** 192350037 */
			Couldn’t_find_the_channel_account_in_Omnichannel,
			/** 192350020 */
			...
			/** 192350041 */
			Leave_as_many_messages_as_you’d_like_and_we’ll_get_back_to_you_as_soon_as_possible_We’ll_save_your_chat_history_so_you_can_leave_and_come_back_anytime,
			/** 192350034 */
			Message_couldn’t_be_sent_A_channel_account_can’t_message_another_account_within_Omnichannel,
			/** 192350040 */
			Message_couldn’t_be_sent_File_couldn’t_be_attached,
			/** 192350025 */
