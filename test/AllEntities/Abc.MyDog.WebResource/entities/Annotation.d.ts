...
declare namespace MyDog {
	namespace FormAnnotation_Information {
		interface tab_general_Sections {
			...
			attachment_information: DevKit.Form.Controls.ControlSection;
			content_information: DevKit.Form.Controls.ControlSection;
		}
		...
		interface Body {
			Tab: Tabs;
			regardingobject: DevKit.Form.Controls.ControlActionCards;
			filenameattachment: DevKit.Form.Controls.ControlActionCards;
			...
			notetext: DevKit.Form.Controls.ControlActionCards;
	...
	class FormAnnotation_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAnnotation_Information.Body;
	}
	...
	class FormNote_Quick_Create_Form extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormNote_Quick_Create_Form.Body;
	}
	class AnnotationApi {
		/**
...
//{'JsForm':['Information','Quick Create Form'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':null}