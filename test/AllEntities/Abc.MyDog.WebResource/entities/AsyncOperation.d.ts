...
declare namespace MyDog {
	namespace FormAsyncOperation_Information {
		interface tab_generaltab_Sections {
			...
			systemlinksection: DevKit.Form.Controls.ControlSection;
			custom: DevKit.Form.Controls.ControlSection;
		}
		...
		interface Body {
			Tab: Tabs;
			WebResource_systemjob: DevKit.Form.Controls.ControlWebResource;
	...
	class FormAsyncOperation_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: MyDog.FormAsyncOperation_Information.Body;
	}
