...
declare namespace MyDog {
	namespace Formmsdyn_slakpi_Information {
		interface tab_General_Sections {
			PauseConfiguration: DevKit.Form.Controls.ControlSection;
		}
		...
		interface Body {
			...
			msdyn_AdvancedPauseConfiguration: DevKit.Form.Controls.ControlBoolean;
			msdyn_ApplicableFromField: DevKit.Form.Controls.ControlString;
			msdyn_EntityName: DevKit.Form.Controls.ControlString;
			msdyn_KPIField: DevKit.Form.Controls.ControlString;
			/** The name of the custom entity. */
			msdyn_name: DevKit.Form.Controls.ControlString;
			msdyn_pauseconfigurationxml: DevKit.Form.Controls.ControlActionCards;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_slakpi_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_slakpi_Information
		...
		*/
		...
		Body: MyDog.Formmsdyn_slakpi_Information.Body;
	}
	class msdyn_slakpiApi {
		...
		*/
		...
		msdyn_ApplicableFromDisplayName: DevKit.WebApi.StringValue;
		msdyn_ApplicableFromField: DevKit.WebApi.StringValue;
		msdyn_Description: DevKit.WebApi.StringValue;
		msdyn_EntityDisplayName: DevKit.WebApi.StringValue;
		msdyn_EntityName: DevKit.WebApi.StringValue;
		msdyn_KPIField: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_PauseConfigurationXml: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_slakpiId: DevKit.WebApi.GuidValue;
		msdyn_WorkflowInfo: DevKit.WebApi.StringValue;
