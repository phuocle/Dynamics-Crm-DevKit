...
declare namespace MyDog {
	namespace FormApplicationUser_Information {
		interface Tabs {
		}
		interface Body {
			/** Application Name of the application user */
			ApplicationName: DevKit.Form.Controls.ControlString;
		}
	}
	class FormApplicationUser_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form ApplicationUser_Information
		...
		*/
		...
		Body: MyDog.FormApplicationUser_Information.Body;
	}
	class ApplicationUserApi {
		/**
		* DynamicsCrm.DevKit ApplicationUserApi
		...
		*/
		...
		/** Application Name of the application user */
		ApplicationName: DevKit.WebApi.StringValue;
		ApplicationType: DevKit.WebApi.OptionSetValue;
		/** Unique identifier for entity instances */
		ApplicationUserId: DevKit.WebApi.GuidValue;
		/** Business Unit Id */
		BusinessUnitId: DevKit.WebApi.LookupValue;
		/** Indicates whether the application user can impersonate system user */
		CanImpersonateAsSystemUser: DevKit.WebApi.BooleanValue;
