...
namespace Abc.MyDog.Shared.Entities.SdkMessageOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SdkMessage : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SdkMessageOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SdkMessageOptionSets.ComponentState)value.Value;
			}
		}
