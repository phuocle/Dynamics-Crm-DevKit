...
namespace Abc.MyDog.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class BookableResourceBookingExchangeSyncIdMapping : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets.SyncStatus? SyncStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SyncStatus);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets.SyncStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
