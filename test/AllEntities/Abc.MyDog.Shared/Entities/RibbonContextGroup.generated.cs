...
namespace Abc.MyDog.Shared.Entities.RibbonContextGroupOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class RibbonContextGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.RibbonContextGroupOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.RibbonContextGroupOptionSets.ComponentState)value.Value;
			}
		}
