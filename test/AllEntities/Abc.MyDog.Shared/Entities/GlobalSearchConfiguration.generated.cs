...
namespace Abc.MyDog.Shared.Entities.GlobalSearchConfigurationOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class GlobalSearchConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState)value.Value;
			}
		}
