...
namespace Abc.MyDog.Shared.Entities.msdyn_appconfiguration_sessiontemplateOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_appconfiguration_sessiontemplate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_appconfiguration_sessiontemplateOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_appconfiguration_sessiontemplateOptionSets.ComponentState)value.Value;
			}
		}
