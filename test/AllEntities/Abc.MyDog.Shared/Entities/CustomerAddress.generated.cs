...
namespace Abc.MyDog.Shared.Entities.CustomerAddressOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class CustomerAddress : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.AddressTypeCode? AddressTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AddressTypeCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.AddressTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.FreightTermsCode? FreightTermsCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FreightTermsCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.FreightTermsCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.ShippingMethodCode? ShippingMethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShippingMethodCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.CustomerAddressOptionSets.ShippingMethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
