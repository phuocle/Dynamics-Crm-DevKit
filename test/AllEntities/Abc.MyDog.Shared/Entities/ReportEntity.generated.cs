...
namespace Abc.MyDog.Shared.Entities.ReportEntityOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ReportEntity : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ReportEntityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ReportEntityOptionSets.ComponentState)value.Value;
			}
		}
