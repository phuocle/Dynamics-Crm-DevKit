...
namespace Abc.MyDog.Shared.Entities.SolutionComponentOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SolutionComponent : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SolutionComponentOptionSets.ComponentType? ComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SolutionComponentOptionSets.ComponentType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SolutionComponentOptionSets.RootComponentBehavior? RootComponentBehavior
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RootComponentBehavior);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SolutionComponentOptionSets.RootComponentBehavior)value.Value;
			}
		}
