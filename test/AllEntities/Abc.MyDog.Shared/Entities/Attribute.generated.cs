...
namespace Abc.MyDog.Shared.Entities.AttributeOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Attribute : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.AttributeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.AttributeOptionSets.ComponentState)value.Value;
			}
		}
