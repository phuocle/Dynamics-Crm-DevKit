...
namespace Abc.MyDog.Shared.Entities.msdyn_odatav4dsOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_odatav4ds : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype? msdyn_paginationtype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_paginationtype);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype)value.Value;
			}
			set
	{
