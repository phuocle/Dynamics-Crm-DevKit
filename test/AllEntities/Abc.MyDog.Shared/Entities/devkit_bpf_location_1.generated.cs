...
namespace Abc.MyDog.Shared.Entities.devkit_bpf_location_1OptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class devkit_bpf_location_1 : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.devkit_bpf_location_1OptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.devkit_bpf_location_1OptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.devkit_bpf_location_1OptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.devkit_bpf_location_1OptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
