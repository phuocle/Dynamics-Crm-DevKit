...
namespace Abc.MyDog.Shared.Entities.msdyn_msdyn_prod_agentscript_msdyn_sessiontemplOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_msdyn_prod_agentscript_msdyn_sessiontempl : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_msdyn_prod_agentscript_msdyn_sessiontemplOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_msdyn_prod_agentscript_msdyn_sessiontemplOptionSets.ComponentState)value.Value;
			}
		}
