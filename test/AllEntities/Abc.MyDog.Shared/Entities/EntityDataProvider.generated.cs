...
namespace Abc.MyDog.Shared.Entities.EntityDataProviderOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class EntityDataProvider : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.EntityDataProviderOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.EntityDataProviderOptionSets.ComponentState)value.Value;
			}
		}
