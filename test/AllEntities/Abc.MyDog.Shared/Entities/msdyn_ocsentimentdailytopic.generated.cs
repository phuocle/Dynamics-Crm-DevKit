...
namespace Abc.MyDog.Shared.Entities.msdyn_ocsentimentdailytopicOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_ocsentimentdailytopic : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_ocsentimentdailytopicOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_ocsentimentdailytopicOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_ocsentimentdailytopicOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_ocsentimentdailytopicOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
