...
namespace Abc.MyDog.Shared.Entities.ResourceGroupOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ResourceGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ResourceGroupOptionSets.GroupTypeCode? GroupTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.GroupTypeCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ResourceGroupOptionSets.GroupTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
