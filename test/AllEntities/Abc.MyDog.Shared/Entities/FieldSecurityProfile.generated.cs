...
namespace Abc.MyDog.Shared.Entities.FieldSecurityProfileOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class FieldSecurityProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState)value.Value;
			}
		}
