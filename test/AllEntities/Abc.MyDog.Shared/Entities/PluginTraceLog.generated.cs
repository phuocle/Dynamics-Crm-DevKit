...
namespace Abc.MyDog.Shared.Entities.PluginTraceLogOptionSets
{
	public enum Mode
	{
		/// <summary>
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class PluginTraceLog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.PluginTraceLogOptionSets.Mode? Mode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Mode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.PluginTraceLogOptionSets.Mode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.PluginTraceLogOptionSets.OperationType? OperationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.PluginTraceLogOptionSets.OperationType)value.Value;
			}
		}
