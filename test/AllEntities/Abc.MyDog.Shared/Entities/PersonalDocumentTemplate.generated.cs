...
namespace Abc.MyDog.Shared.Entities.PersonalDocumentTemplateOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class PersonalDocumentTemplate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.PersonalDocumentTemplateOptionSets.DocumentType? DocumentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.PersonalDocumentTemplateOptionSets.DocumentType)value.Value;
			}
			set
			{
				if (value.HasValue)
