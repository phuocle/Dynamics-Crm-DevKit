...
namespace Abc.MyDog.Shared.Entities.TeamOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Team : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.TeamOptionSets.MembershipType? MembershipType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MembershipType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.TeamOptionSets.MembershipType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.TeamOptionSets.TeamType? TeamType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TeamType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.TeamOptionSets.TeamType)value.Value;
			}
			set
			{
				if (value.HasValue)
