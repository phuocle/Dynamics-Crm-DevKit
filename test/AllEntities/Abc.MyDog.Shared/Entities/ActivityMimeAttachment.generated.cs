...
namespace Abc.MyDog.Shared.Entities.ActivityMimeAttachmentOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ActivityMimeAttachment : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState)value.Value;
			}
		}
