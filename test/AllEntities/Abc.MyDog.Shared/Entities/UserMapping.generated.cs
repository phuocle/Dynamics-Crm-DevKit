...
namespace Abc.MyDog.Shared.Entities.UserMappingOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class UserMapping : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.UserMappingOptionSets.PartnerApplicationType? PartnerApplicationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PartnerApplicationType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.UserMappingOptionSets.PartnerApplicationType)value.Value;
			}
			set
			{
				if (value.HasValue)
