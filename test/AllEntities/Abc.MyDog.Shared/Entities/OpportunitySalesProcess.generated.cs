...
namespace Abc.MyDog.Shared.Entities.OpportunitySalesProcessOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class OpportunitySalesProcess : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.OpportunitySalesProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.OpportunitySalesProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.OpportunitySalesProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.OpportunitySalesProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
