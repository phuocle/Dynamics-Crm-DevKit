...
namespace Abc.MyDog.Shared.Entities.ServicePlanAppModulesOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ServicePlanAppModules : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState)value.Value;
			}
		}
