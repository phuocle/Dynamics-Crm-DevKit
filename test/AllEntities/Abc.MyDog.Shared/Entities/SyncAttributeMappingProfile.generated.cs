...
namespace Abc.MyDog.Shared.Entities.SyncAttributeMappingProfileOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SyncAttributeMappingProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState)value.Value;
			}
		}
