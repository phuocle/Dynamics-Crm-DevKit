...
namespace Abc.MyDog.Shared.Entities.BusinessUnitNewsArticleOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class BusinessUnitNewsArticle : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode? ArticleTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ArticleTypeCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
