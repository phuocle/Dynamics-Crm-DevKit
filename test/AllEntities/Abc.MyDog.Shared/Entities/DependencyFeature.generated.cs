...
namespace Abc.MyDog.Shared.Entities.DependencyFeatureOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class DependencyFeature : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DependencyFeatureOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DependencyFeatureOptionSets.ComponentState)value.Value;
			}
		}
