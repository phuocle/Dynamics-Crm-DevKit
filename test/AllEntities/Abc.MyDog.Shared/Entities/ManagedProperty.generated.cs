...
namespace Abc.MyDog.Shared.Entities.ManagedPropertyOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ManagedProperty : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ManagedPropertyOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ManagedPropertyOptionSets.ComponentState)value.Value;
			}
		}
