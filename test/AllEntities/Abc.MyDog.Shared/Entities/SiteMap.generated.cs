...
namespace Abc.MyDog.Shared.Entities.SiteMapOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SiteMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SiteMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SiteMapOptionSets.ComponentState)value.Value;
			}
		}
