...
namespace Abc.MyDog.Shared.Entities.OrganizationUIOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class OrganizationUI : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.OrganizationUIOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.OrganizationUIOptionSets.ComponentState)value.Value;
			}
		}
