...
namespace Abc.MyDog.Shared.Entities.SalesLiteratureItemOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SalesLiteratureItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SalesLiteratureItemOptionSets.FileTypeCode? FileTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FileTypeCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SalesLiteratureItemOptionSets.FileTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
