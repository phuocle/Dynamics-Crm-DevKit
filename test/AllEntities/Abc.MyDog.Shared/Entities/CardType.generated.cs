...
namespace Abc.MyDog.Shared.Entities.CardTypeOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class CardType : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.CardTypeOptionSets.ClientAvailability? ClientAvailability
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ClientAvailability);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.CardTypeOptionSets.ClientAvailability)value.Value;
			}
			set
			{
				if (value.HasValue)
