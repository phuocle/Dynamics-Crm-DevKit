...
namespace Abc.MyDog.Shared.Entities.MailboxStatisticsOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class MailboxStatistics : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId? OperationTypeId
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationTypeId);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId)value.Value;
			}
		}
