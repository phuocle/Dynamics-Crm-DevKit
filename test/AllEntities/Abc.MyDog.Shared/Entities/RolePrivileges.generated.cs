...
namespace Abc.MyDog.Shared.Entities.RolePrivilegesOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class RolePrivileges : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.RolePrivilegesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.RolePrivilegesOptionSets.ComponentState)value.Value;
			}
		}
