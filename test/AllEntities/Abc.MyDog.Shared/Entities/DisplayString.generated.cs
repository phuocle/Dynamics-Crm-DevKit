...
namespace Abc.MyDog.Shared.Entities.DisplayStringOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class DisplayString : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DisplayStringOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DisplayStringOptionSets.ComponentState)value.Value;
			}
		}
