...
namespace Abc.MyDog.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ChannelAccessProfileEntityAccessLevel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState)value.Value;
			}
		}
