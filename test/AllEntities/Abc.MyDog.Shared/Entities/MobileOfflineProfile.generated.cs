...
namespace Abc.MyDog.Shared.Entities.MobileOfflineProfileOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class MobileOfflineProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState)value.Value;
			}
		}
