...
namespace Abc.MyDog.Shared.Entities.RibbonCommandOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class RibbonCommand : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.RibbonCommandOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.RibbonCommandOptionSets.ComponentState)value.Value;
			}
		}
