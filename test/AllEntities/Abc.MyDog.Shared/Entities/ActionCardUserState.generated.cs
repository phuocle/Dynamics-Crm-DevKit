...
namespace Abc.MyDog.Shared.Entities.ActionCardUserStateOptionSets
{
	public enum State
	{
		/// <summary>
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ActionCardUserState : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ActionCardUserStateOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ActionCardUserStateOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
