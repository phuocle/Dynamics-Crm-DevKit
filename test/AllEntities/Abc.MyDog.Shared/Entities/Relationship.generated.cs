...
namespace Abc.MyDog.Shared.Entities.RelationshipOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Relationship : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.RelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.RelationshipOptionSets.ComponentState)value.Value;
			}
		}
