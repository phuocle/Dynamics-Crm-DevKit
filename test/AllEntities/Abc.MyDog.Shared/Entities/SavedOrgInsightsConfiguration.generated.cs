...
namespace Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SavedOrgInsightsConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.Lookback? Lookback
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Lookback);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.Lookback)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.MetricType? MetricType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MetricType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.MetricType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.PlotOption? PlotOption
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PlotOption);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SavedOrgInsightsConfigurationOptionSets.PlotOption)value.Value;
			}
			set
			{
				if (value.HasValue)
