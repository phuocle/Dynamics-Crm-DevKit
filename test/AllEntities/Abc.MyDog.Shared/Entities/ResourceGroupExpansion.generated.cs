...
namespace Abc.MyDog.Shared.Entities.ResourceGroupExpansionOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ResourceGroupExpansion : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ResourceGroupExpansionOptionSets.MethodCode? MethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MethodCode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ResourceGroupExpansionOptionSets.MethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
