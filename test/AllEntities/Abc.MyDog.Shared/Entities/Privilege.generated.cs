...
namespace Abc.MyDog.Shared.Entities.PrivilegeOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Privilege : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.PrivilegeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.PrivilegeOptionSets.ComponentState)value.Value;
			}
		}
