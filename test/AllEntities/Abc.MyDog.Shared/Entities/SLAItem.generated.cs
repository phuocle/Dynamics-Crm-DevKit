...
namespace Abc.MyDog.Shared.Entities.SLAItemOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SLAItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SLAItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SLAItemOptionSets.ComponentState)value.Value;
			}
		}
