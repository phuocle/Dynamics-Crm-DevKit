...
namespace Abc.MyDog.Shared.Entities.EntitlementChannelOptionSets
{
	public enum Channel
	{
		/// <summary>
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class EntitlementChannel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.EntitlementChannelOptionSets.Channel? Channel
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Channel);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.EntitlementChannelOptionSets.Channel)value.Value;
			}
			set
			{
				if (value.HasValue)
