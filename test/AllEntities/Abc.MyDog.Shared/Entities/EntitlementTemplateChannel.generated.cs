...
namespace Abc.MyDog.Shared.Entities.EntitlementTemplateChannelOptionSets
{
	public enum Channel
	{
		/// <summary>
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class EntitlementTemplateChannel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.EntitlementTemplateChannelOptionSets.Channel? Channel
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Channel);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.EntitlementTemplateChannelOptionSets.Channel)value.Value;
			}
			set
			{
				if (value.HasValue)
