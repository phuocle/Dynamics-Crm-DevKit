...
namespace Abc.MyDog.Shared.Entities.msdyn_quotebookingincidentOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_quotebookingincident : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_quotebookingincidentOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_quotebookingincidentOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_quotebookingincidentOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_quotebookingincidentOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
