...
namespace Abc.MyDog.Shared.Entities.AttributeImageConfigOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class AttributeImageConfig : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.AttributeImageConfigOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.AttributeImageConfigOptionSets.ComponentState)value.Value;
			}
		}
