...
namespace Abc.MyDog.Shared.Entities.AppConfigInstanceOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class AppConfigInstance : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.AppConfigInstanceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.AppConfigInstanceOptionSets.ComponentState)value.Value;
			}
		}
