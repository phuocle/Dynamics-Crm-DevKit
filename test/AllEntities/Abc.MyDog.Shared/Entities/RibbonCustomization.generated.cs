...
namespace Abc.MyDog.Shared.Entities.RibbonCustomizationOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class RibbonCustomization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.RibbonCustomizationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.RibbonCustomizationOptionSets.ComponentState)value.Value;
			}
		}
