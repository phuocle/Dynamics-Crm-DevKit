...
namespace Abc.MyDog.Shared.Entities.UserQueryVisualizationOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class UserQueryVisualization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.UserQueryVisualizationOptionSets.ChartType? ChartType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ChartType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.UserQueryVisualizationOptionSets.ChartType)value.Value;
			}
			set
	{
