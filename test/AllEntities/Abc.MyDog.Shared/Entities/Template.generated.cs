...
namespace Abc.MyDog.Shared.Entities.TemplateOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Template : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.TemplateOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.TemplateOptionSets.ComponentState)value.Value;
			}
		}
