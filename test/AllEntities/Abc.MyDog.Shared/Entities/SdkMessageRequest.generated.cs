...
namespace Abc.MyDog.Shared.Entities.SdkMessageRequestOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SdkMessageRequest : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SdkMessageRequestOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SdkMessageRequestOptionSets.ComponentState)value.Value;
			}
		}
