...
namespace Abc.MyDog.Shared.Entities.EntityDataSourceOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class EntityDataSource : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.EntityDataSourceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.EntityDataSourceOptionSets.ComponentState)value.Value;
			}
		}
