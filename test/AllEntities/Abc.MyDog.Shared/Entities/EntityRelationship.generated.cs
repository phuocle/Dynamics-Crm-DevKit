...
namespace Abc.MyDog.Shared.Entities.EntityRelationshipOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class EntityRelationship : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.EntityRelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.EntityRelationshipOptionSets.ComponentState)value.Value;
			}
		}
