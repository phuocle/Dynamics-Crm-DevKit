...
namespace Abc.MyDog.Shared.Entities.DependencyNodeOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class DependencyNode : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DependencyNodeOptionSets.ComponentType? ComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DependencyNodeOptionSets.ComponentType)value.Value;
			}
		}
