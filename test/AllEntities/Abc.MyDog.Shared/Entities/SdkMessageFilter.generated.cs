...
namespace Abc.MyDog.Shared.Entities.SdkMessageFilterOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SdkMessageFilter : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SdkMessageFilterOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SdkMessageFilterOptionSets.ComponentState)value.Value;
			}
		}
