...
namespace Abc.MyDog.Shared.Entities.msdyn_ocprovisioningstateOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class msdyn_ocprovisioningstate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_ocprovisioningstateOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_ocprovisioningstateOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.msdyn_ocprovisioningstateOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.msdyn_ocprovisioningstateOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
