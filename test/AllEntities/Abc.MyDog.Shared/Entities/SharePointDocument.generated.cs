...
namespace Abc.MyDog.Shared.Entities.SharePointDocumentOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class SharePointDocument : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SharePointDocumentOptionSets.DocumentLocationType? DocumentLocationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentLocationType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SharePointDocumentOptionSets.DocumentLocationType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.SharePointDocumentOptionSets.ServiceType? ServiceType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ServiceType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.SharePointDocumentOptionSets.ServiceType)value.Value;
			}
			set
			{
				if (value.HasValue)
