...
namespace Abc.MyDog.Shared.Entities.ConvertRuleItemOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ConvertRuleItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ConvertRuleItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ConvertRuleItemOptionSets.ComponentState)value.Value;
			}
		}
