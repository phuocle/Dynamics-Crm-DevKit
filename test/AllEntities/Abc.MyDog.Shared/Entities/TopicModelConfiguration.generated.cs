...
namespace Abc.MyDog.Shared.Entities.TopicModelConfigurationOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class TopicModelConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.TopicModelConfigurationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.TopicModelConfigurationOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.TopicModelConfigurationOptionSets.TimeFilter? TimeFilter
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TimeFilter);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.TopicModelConfigurationOptionSets.TimeFilter)value.Value;
			}
			set
	{
