...
namespace Abc.MyDog.Shared.Entities.ProvisionLanguageForUserOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class ProvisionLanguageForUser : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus? OperationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationStatus);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
