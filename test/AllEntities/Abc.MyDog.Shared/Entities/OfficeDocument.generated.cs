...
namespace Abc.MyDog.Shared.Entities.OfficeDocumentOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class OfficeDocument : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.OfficeDocumentOptionSets.DocumentType? DocumentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.OfficeDocumentOptionSets.DocumentType)value.Value;
			}
			set
			{
				if (value.HasValue)
