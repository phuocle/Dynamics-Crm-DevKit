...
namespace Abc.MyDog.Shared.Entities.CalendarOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Calendar : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.CalendarOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.CalendarOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
