...
namespace Abc.MyDog.Shared.Entities.OrgInsightsMetricOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class OrgInsightsMetric : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.OrgInsightsMetricOptionSets.MetricType? MetricType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MetricType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.OrgInsightsMetricOptionSets.MetricType)value.Value;
			}
			set
			{
				if (value.HasValue)
