...
namespace Abc.MyDog.Shared.Entities.DependencyOptionSets
{
...
namespace Abc.MyDog.Shared.Entities
{
	public partial class Dependency : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DependencyOptionSets.DependencyType? DependencyType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DependencyType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DependencyOptionSets.DependencyType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DependencyOptionSets.DependentComponentType? DependentComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DependentComponentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DependencyOptionSets.DependentComponentType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.MyDog.Shared.Entities.DependencyOptionSets.RequiredComponentType? RequiredComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RequiredComponentType);
				if (value == null) return null;
				return (Abc.MyDog.Shared.Entities.DependencyOptionSets.RequiredComponentType)value.Value;
			}
		}
