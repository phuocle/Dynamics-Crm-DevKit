...
WebResource.FormLeadQuickCreate = function (executionContext, defaultWebResourceName) {
	var lead = intellisense.FormQuickCreate;
	lead.Utility = intellisense.Utility;
...
WebResource.LeadApi = function (entity) {
	return {
...
//{'JsForm':['Lead','Lead Quick Create'],'JsWebApi':true,'IsDebugForm':false,'IsDebugWebApi':false}