...
namespace DevKitLevel1.PluginOpportunity
{
    ...
    "DevKitLevel1.PluginOpportunity.PostOpportunityLoseAsynchronous", 1, IsolationModeEnum.Sandbox,
    ...
    public class PostOpportunityLoseAsynchronous : IPlugin
    {
        ...
        */
        ...
        public PostOpportunityLoseAsynchronous(string unsecureString, string secureString)
        {
