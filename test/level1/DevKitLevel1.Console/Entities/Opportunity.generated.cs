...
using DevKitLevel1.Console.Entities.OpportunityOptionSets;

namespace DevKitLevel1.Console.Entities.OpportunityOptionSets
{
...
namespace DevKitLevel1.Console.Entities
{
    public partial class Opportunity : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public Opportunity(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public OpportunityRatingCode? OpportunityRatingCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OpportunityRatingCode);
                if (value == null) return null;
                return (OpportunityRatingCode)value.Value;
            }
            set
            {
                if (value.HasValue)
