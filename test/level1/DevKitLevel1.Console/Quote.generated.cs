...
//		Generated by PL.DynamicsCrm.DevKit 1.2.0 - https://github.com/phuocle/Dynamics-Crm-DevKit
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
using DevKitLevel1.Console.QuoteOptionSets;

namespace DevKitLevel1.Console.QuoteOptionSets
{
...
namespace DevKitLevel1.Console
{
    public partial class Quote : EntityBase
    {
        ...
        [DebuggerNonUserCode()]
        public Quote(Entity entity, Entity preEntity)
        {
            Entity = entity;
            PreEntity = preEntity;
        }
        ...
        public FreightTermsCode? FreightTermsCode
        {
            get
            {
                ...
                if (value == null) return null;
                return (FreightTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public PricingErrorCode? PricingErrorCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PricingErrorCode);
                if (value == null) return null;
                return (PricingErrorCode)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// </summary>
        [DebuggerNonUserCode()]
        public ShipTo_FreightTermsCode? ShipTo_FreightTermsCode
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShipTo_FreightTermsCode);
                if (value == null) return null;
                return (ShipTo_FreightTermsCode)value.Value;
            }
            set
            {
                if (value.HasValue)
