...
{
    [CrmPluginRegistration("Update", "account", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "name,accountcategorycode,telephone1",
    "DevKitLevel1.PluginAccount.PreAccountUpdateSynchronous", 1, IsolationModeEnum.Sandbox,
    Image1Name = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "name,accountcategorycode,telephone1",
