...
namespace DevKitLevel1.Workflow.Administrator
{
    [CrmPluginRegistration("HasRole", "HasRole", "", "DevKitLevel1.Workflow.Administrator", IsolationModeEnum.Sandbox)]
    public class HasRole : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: HasRole");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: HasRole");
        }
    }
}