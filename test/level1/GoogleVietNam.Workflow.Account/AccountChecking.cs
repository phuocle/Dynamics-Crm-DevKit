...
namespace GoogleVietNam.WorkflowAccount
{
    [CrmPluginRegistration("AccountChecking", "AccountChecking", "", "GoogleVietNam.WorkflowAccount", IsolationModeEnum.Sandbox)]
    public class AccountChecking : CodeActivity
    {
        ...
        {
            Debugger.Trace(tracing, "Begin Execute Workflow: AccountChecking");
            //YOUR CUSTOM-WORKFLOW-CODE GO HERE

            Debugger.Trace(tracing, "End Execute Workflow: AccountChecking");
        }
    }
}