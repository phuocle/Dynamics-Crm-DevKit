...
{
    [CrmPluginRegistration("RetrieveMultiple", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.PluginAccount.PostAccountRetrieveMultipleAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true)]
    public class PostAccountRetrieveMultipleAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostAccountRetrieveMultipleAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
