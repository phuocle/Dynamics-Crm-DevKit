...
{
    [CrmPluginRegistration("devkit_Ajax", "none", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "", "Dev.DevKit.CustomAction.PostNonedevkit_AjaxSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction)]
