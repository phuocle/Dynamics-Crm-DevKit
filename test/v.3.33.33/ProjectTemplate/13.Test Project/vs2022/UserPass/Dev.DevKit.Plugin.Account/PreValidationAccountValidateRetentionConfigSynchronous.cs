...
{
    [CrmPluginRegistration("PreValidation", "account", StageEnum.PreValidation, ExecutionModeEnum.Synchronous, "", "Dev.DevKit.PluginAccount.PreValidationAccountValidateRetentionConfigSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Image1Name = "", Image1Alias = "", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "")]
    public class PreValidationAccountValidateRetentionConfigSynchronous : IPlugin
    {
        /*
          InputParameters:
           ...
           OutputParameters:
              IsValidationSuccessful    System.Boolean - require
              ErrorMessage              System.String - require
        */

        //private readonly string unSecureConfiguration = null;
        //private readonly string secureConfiguration = null;

        //public PreValidationAccountValidateRetentionConfigSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.MessageName.ToLower() != "PreValidation".ToLower()) throw new InvalidPluginExecutionException("MessageName does not equals PreValidation");
