...
{
    [CrmPluginRegistration("PreValidation", "account", StageEnum.PreValidation, ExecutionModeEnum.Synchronous, "", "Dev.DevKit.PluginAccount.PreValidationAccountRetrieveSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Image1Name = "", Image1Alias = "", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "")]
    public class PreValidationAccountRetrieveSynchronous : IPlugin
    {
        /*
          InputParameters:
        ...
        */
        ...
        //public PreValidationAccountRetrieveSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
