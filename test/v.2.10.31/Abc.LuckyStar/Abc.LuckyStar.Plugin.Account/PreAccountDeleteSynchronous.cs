...
namespace Abc.LuckyStar.PluginAccount
{
    ...
    "Abc.LuckyStar.PluginAccount.PreAccountDeleteSynchronous", 1, IsolationModeEnum.Sandbox,
    ...
    public class PreAccountDeleteSynchronous : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("End Plugin: Abc.LuckyStar.PluginAccount.PreAccountDeleteSynchronous");
        }
