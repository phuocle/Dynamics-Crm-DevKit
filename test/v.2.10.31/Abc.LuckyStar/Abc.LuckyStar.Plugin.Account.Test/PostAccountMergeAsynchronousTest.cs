...
namespace Abc.LuckyStar.PluginAccount.Test
{
    ...
    public class PostAccountMergeAsynchronousTest
    {
        ...
        public void _00_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostAccountMergeAsynchronous>(PluginContext, unsecureString, secureString);
        ...
        */
        ...
        public void _01_Stage_Does_Not_Equals_PostOperation()
        {
            ...
            {
                context.ExecutePluginWith<PostAccountMergeAsynchronous>(plugin);
        ...
        [TestMethod]
        public void _03_MessageName_Does_Not_Equals_Merge()
        {
            var context = new XrmFakedContext();
            var plugin = context.GetDefaultPluginContext();
            plugin.Stage = (int)StageEnum.PostOperation;
            ...
            {
                context.ExecutePluginWith<PostAccountMergeAsynchronous>(plugin);
            }, "MessageName does not equals Merge");
        }
        ...
        {
            var @class = new PostAccountMergeAsynchronous();
