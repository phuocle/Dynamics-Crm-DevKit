...
namespace Abc.LuckyStar.PluginAccount.Test
{
    ...
    public class PreAccountRetrieveMultipleSynchronousTest
    {
        ...
        */
        ...
        [TestMethod]
        public void _03_MessageName_Does_Not_Equals_RetrieveMultiple()
        {
            var context = new XrmFakedContext();
            var plugin = context.GetDefaultPluginContext();
            plugin.Stage = (int)StageEnum.PreOperation;
            ...
            {
                context.ExecutePluginWith<PreAccountRetrieveMultipleSynchronous>(plugin);
            }, "MessageName does not equals RetrieveMultiple");
        }
        ...
        {
            var @class = new PreAccountRetrieveMultipleSynchronous();
