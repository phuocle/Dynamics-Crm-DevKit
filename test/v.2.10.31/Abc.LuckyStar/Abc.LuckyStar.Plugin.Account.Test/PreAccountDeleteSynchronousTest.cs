...
{
    [TestClass]
    public class PreAccountDeleteSynchronousTest
    {
        ...
        public void _00_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PreAccountDeleteSynchronous>(PluginContext, unsecureString, secureString);
        ...
        */
        ...
        {
            var @class = new PreAccountDeleteSynchronous();
