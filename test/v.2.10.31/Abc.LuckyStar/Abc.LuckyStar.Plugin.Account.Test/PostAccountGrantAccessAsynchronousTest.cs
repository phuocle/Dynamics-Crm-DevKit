...
{
    [TestClass]
    public class PostAccountGrantAccessAsynchronousTest
    {
        ...
        public static void ClassInit(TestContext context)
        {
            ...
            PluginContext.MessageName = "GrantAccess";
        ...
        public void _00_UnsecureString_And_SecureString()
        {
            ...
            Context.ExecutePluginWithConfigurations<PostAccountGrantAccessAsynchronous>(PluginContext, unsecureString, secureString);
        ...
        */
        ...
        public void _04_Mode_Does_Not_Equals_Asynchronous()
        {
            ...
            plugin.Stage = (int)StageEnum.PostOperation;
            plugin.PrimaryEntityName = "account";
            plugin.MessageName = "GrantAccess";
            plugin.Mode = -1;
            Assert.ThrowsException<InvalidPluginExecutionException>(() =>
            {
                context.ExecutePluginWith<PostAccountGrantAccessAsynchronous>(plugin);
        ...
        {
            var @class = new PostAccountGrantAccessAsynchronous();
