'use strict';
/** @namespace LuckyStar2 */
var LuckyStar2;
(function (LuckyStar2) {
	'use strict';
	LuckyStar2.FormAccount = function(executionContext, defaultWebResourceName) {
	...
	LuckyStar2.FormAccount_Information = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	LuckyStar2.FormAccount_Quick_Create = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
