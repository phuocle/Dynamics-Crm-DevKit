...
declare namespace LuckyStar2 {
	...
	class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: LuckyStar2.FormAccount.Body;
		/** The Header section of form Account */
		Header: LuckyStar2.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: LuckyStar2.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: LuckyStar2.FormAccount.QuickForm;
		/** The Process of form Account */
		Process: LuckyStar2.FormAccount.Process;
		/** The Grid of form Account */
		Grid: LuckyStar2.FormAccount.Grid;
	}
	...
	class FormAccount_Information extends DevKit.IForm {
		...
		*/
		...
		Body: LuckyStar2.FormAccount_Information.Body;
		/** The Header section of form Account_Information */
		Header: LuckyStar2.FormAccount_Information.Header;
		/** The Navigation of form Account_Information */
		Navigation: LuckyStar2.FormAccount_Information.Navigation;
		/** The Process of form Account_Information */
		Process: LuckyStar2.FormAccount_Information.Process;
		/** The Grid of form Account_Information */
		Grid: LuckyStar2.FormAccount_Information.Grid;
	}
	...
	class FormAccount_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: LuckyStar2.FormAccount_Quick_Create.Body;
	}
	class AccountApi {
		/**
...
//{'JsForm':['Account','Information','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.10.31','JsFormVersion':'v2'}