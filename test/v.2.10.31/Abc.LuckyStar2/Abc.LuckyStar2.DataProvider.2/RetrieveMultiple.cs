...
namespace Abc.LuckyStar2.DataProvider._2
{
    public class RetrieveMultiple : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Abc.LuckyStar2.DataProvider._2.RetrieveMultiple");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Abc.LuckyStar2.DataProvider._2.RetrieveMultiple");
        }
