...
namespace Abc.LuckyStar2.Plugin
{
    [CrmPluginRegistration("Create", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "",
    "Abc.LuckyStar2.Plugin.PostAccountCreateAsynchronous2", 2, IsolationModeEnum.Sandbox, DeleteAsyncOperation = true,
    ...
    public class PostAccountCreateAsynchronous2 : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Plugin: Abc.LuckyStar2.Plugin.PostAccountCreateAsynchronous2");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing);

            //tracing.DebugMessage("End Plugin: Abc.LuckyStar2.Plugin.PostAccountCreateAsynchronous2");
        }
