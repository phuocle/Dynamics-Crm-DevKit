...
namespace Abc.LuckyStar2.Plugin
{
    ...
    "Abc.LuckyStar2.Plugin.PostAccountUpdateAsynchronous", 1, IsolationModeEnum.Sandbox, DeleteAsyncOperation = true,
    ...
    public class PostAccountUpdateAsynchronous : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Plugin: Abc.LuckyStar2.Plugin.PostAccountUpdateAsynchronous");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing);

            //tracing.DebugMessage("End Plugin: Abc.LuckyStar2.Plugin.PostAccountUpdateAsynchronous");
        }
