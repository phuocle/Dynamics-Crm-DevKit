...
namespace Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class MobileOfflineProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState)value.Value;
			}
		}
