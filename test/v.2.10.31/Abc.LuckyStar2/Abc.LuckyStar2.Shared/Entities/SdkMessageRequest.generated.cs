...
namespace Abc.LuckyStar2.Shared.Entities.SdkMessageRequestOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SdkMessageRequest : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SdkMessageRequestOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SdkMessageRequestOptionSets.ComponentState)value.Value;
			}
		}
