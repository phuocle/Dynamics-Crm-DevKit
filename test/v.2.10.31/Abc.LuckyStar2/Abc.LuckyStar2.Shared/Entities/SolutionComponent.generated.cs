...
namespace Abc.LuckyStar2.Shared.Entities.SolutionComponentOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SolutionComponent : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SolutionComponentOptionSets.ComponentType? ComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SolutionComponentOptionSets.ComponentType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SolutionComponentOptionSets.RootComponentBehavior? RootComponentBehavior
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RootComponentBehavior);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SolutionComponentOptionSets.RootComponentBehavior)value.Value;
			}
		}
