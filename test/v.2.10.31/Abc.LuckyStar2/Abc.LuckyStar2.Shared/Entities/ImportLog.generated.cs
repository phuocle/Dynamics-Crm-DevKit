...
namespace Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ImportLog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.LogPhaseCode? LogPhaseCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LogPhaseCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.LogPhaseCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.StateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportLogOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
