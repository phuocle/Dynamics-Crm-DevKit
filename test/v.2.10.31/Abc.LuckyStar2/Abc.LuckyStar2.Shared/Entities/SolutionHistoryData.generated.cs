...
namespace Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SolutionHistoryData : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.Operation? Operation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Operation);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.Operation)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.Status? Status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Status);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.Status)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.SubOperation? SubOperation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SubOperation);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SolutionHistoryDataOptionSets.SubOperation)value.Value;
			}
			set
			{
				if (value.HasValue)
