...
namespace Abc.LuckyStar2.Shared.Entities.OrganizationUIOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class OrganizationUI : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.OrganizationUIOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.OrganizationUIOptionSets.ComponentState)value.Value;
			}
		}
