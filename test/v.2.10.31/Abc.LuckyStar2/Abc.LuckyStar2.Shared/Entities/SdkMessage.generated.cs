...
namespace Abc.LuckyStar2.Shared.Entities.SdkMessageOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SdkMessage : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SdkMessageOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SdkMessageOptionSets.ComponentState)value.Value;
			}
		}
