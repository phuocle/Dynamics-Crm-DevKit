...
namespace Abc.LuckyStar2.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ChannelAccessProfileEntityAccessLevel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState)value.Value;
			}
		}
