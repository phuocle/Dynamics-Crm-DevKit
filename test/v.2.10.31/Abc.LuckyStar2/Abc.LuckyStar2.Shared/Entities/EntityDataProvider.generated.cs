...
namespace Abc.LuckyStar2.Shared.Entities.EntityDataProviderOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class EntityDataProvider : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.EntityDataProviderOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.EntityDataProviderOptionSets.ComponentState)value.Value;
			}
		}
