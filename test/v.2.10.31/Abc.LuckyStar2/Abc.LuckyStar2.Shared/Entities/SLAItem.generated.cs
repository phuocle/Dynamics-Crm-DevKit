...
namespace Abc.LuckyStar2.Shared.Entities.SLAItemOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SLAItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SLAItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SLAItemOptionSets.ComponentState)value.Value;
			}
		}
