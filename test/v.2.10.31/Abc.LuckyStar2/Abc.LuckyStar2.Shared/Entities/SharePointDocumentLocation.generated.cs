...
namespace Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SharePointDocumentLocation : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.LocationType? LocationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LocationType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.LocationType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.ServiceType? ServiceType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ServiceType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.ServiceType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointDocumentLocationOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
