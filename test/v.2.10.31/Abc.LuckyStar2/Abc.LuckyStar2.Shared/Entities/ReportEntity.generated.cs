...
namespace Abc.LuckyStar2.Shared.Entities.ReportEntityOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ReportEntity : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReportEntityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReportEntityOptionSets.ComponentState)value.Value;
			}
		}
