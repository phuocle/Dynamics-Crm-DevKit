...
namespace Abc.LuckyStar2.Shared.Entities.DependencyOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Dependency : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.DependencyType? DependencyType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DependencyType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.DependencyType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.DependentComponentType? DependentComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DependentComponentType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.DependentComponentType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.RequiredComponentType? RequiredComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RequiredComponentType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DependencyOptionSets.RequiredComponentType)value.Value;
			}
		}
