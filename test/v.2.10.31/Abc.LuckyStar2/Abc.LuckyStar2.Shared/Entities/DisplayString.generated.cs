...
namespace Abc.LuckyStar2.Shared.Entities.DisplayStringOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class DisplayString : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DisplayStringOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DisplayStringOptionSets.ComponentState)value.Value;
			}
		}
