...
namespace Abc.LuckyStar2.Shared.Entities.RibbonRuleOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RibbonRule : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonRuleOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonRuleOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonRuleOptionSets.RuleType? RuleType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RuleType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonRuleOptionSets.RuleType)value.Value;
			}
			set
			{
				if (value.HasValue)
