...
namespace Abc.LuckyStar2.Shared.Entities.ActivityMimeAttachmentOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ActivityMimeAttachment : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState)value.Value;
			}
		}
