...
namespace Abc.LuckyStar2.Shared.Entities.ReportVisibilityOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ReportVisibility : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReportVisibilityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReportVisibilityOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReportVisibilityOptionSets.VisibilityCode? VisibilityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.VisibilityCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReportVisibilityOptionSets.VisibilityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
