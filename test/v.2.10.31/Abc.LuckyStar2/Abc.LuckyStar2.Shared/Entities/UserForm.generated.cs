...
namespace Abc.LuckyStar2.Shared.Entities.UserFormOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class UserForm : EntityBase
	{
		...
		/// <summary>
		/// <para>Shows the record type (entity) code that the form applies to.</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.UserFormOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.UserFormOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
