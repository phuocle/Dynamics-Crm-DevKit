...
namespace Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets
{
	...
	public enum TargetEntity
	{
		...
		Team_template = 92,
		/// <summary>
		/// TeamMobileOfflineProfileMembership = 10102
		/// </summary>
		TeamMobileOfflineProfileMembership = 10102,
		/// <summary>
		/// Territory = 2013
		...
		User_Settings = 150,
		/// <summary>
		/// UserMobileOfflineProfileMembership = 10103
		/// </summary>
		UserMobileOfflineProfileMembership = 10103,
		/// <summary>
		/// View = 1039
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ImportMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.EntitiesPerFile? EntitiesPerFile
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EntitiesPerFile);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.EntitiesPerFile)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.ImportMapType? ImportMapType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ImportMapType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.ImportMapType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.SourceType? SourceType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SourceType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.SourceType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.TargetEntity? TargetEntity
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TargetEntity);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportMapOptionSets.TargetEntity)value.Value;
			}
		}
