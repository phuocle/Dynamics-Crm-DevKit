...
namespace Abc.LuckyStar2.Shared.Entities.msdyn_odatav4dsOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class msdyn_odatav4ds : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype? msdyn_paginationtype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_paginationtype);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype)value.Value;
			}
			set
	{
