...
namespace Abc.LuckyStar2.Shared.Entities.ActionCardOptionSets
{
	public enum Source
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ActionCard : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ActionCardOptionSets.Source? Source
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Source);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ActionCardOptionSets.Source)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ActionCardOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ActionCardOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
