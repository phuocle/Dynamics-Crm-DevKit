...
namespace Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RollupProperties : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.AggregateType? AggregateType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AggregateType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.AggregateType)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.InitialValueCalculationStatus? InitialValueCalculationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InitialValueCalculationStatus);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.InitialValueCalculationStatus)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.StateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RollupPropertiesOptionSets.StatusCode)value.Value;
			}
		}
