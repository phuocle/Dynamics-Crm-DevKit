...
namespace Abc.LuckyStar2.Shared.Entities.PostRoleOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class PostRole : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PostRoleOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PostRoleOptionSets.Type)value.Value;
			}
			set
	{
