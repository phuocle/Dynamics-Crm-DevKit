...
namespace Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SharePointSite : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ServiceType? ServiceType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ServiceType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ServiceType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ValidationStatus? ValidationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ValidationStatus);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ValidationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ValidationStatusErrorCode? ValidationStatusErrorCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ValidationStatusErrorCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SharePointSiteOptionSets.ValidationStatusErrorCode)value.Value;
			}
			set
			{
				if (value.HasValue)
