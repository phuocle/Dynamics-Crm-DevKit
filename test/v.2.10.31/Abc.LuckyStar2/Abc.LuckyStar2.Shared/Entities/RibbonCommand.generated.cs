...
namespace Abc.LuckyStar2.Shared.Entities.RibbonCommandOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RibbonCommand : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonCommandOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonCommandOptionSets.ComponentState)value.Value;
			}
		}
