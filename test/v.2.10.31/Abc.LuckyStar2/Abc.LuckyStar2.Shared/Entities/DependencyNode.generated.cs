...
namespace Abc.LuckyStar2.Shared.Entities.DependencyNodeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class DependencyNode : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DependencyNodeOptionSets.ComponentType? ComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DependencyNodeOptionSets.ComponentType)value.Value;
			}
		}
