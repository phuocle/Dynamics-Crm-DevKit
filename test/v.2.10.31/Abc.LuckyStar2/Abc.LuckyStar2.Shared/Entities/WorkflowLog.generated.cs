...
namespace Abc.LuckyStar2.Shared.Entities.WorkflowLogOptionSets
{
	public enum Status
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class WorkflowLog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.WorkflowLogOptionSets.Status? Status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Status);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.WorkflowLogOptionSets.Status)value.Value;
			}
			set
			{
				if (value.HasValue)
