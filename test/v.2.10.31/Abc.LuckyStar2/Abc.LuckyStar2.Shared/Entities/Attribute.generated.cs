...
namespace Abc.LuckyStar2.Shared.Entities.AttributeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Attribute : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AttributeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AttributeOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// <summary>
		/// <para>The version number of this attribute.</para>
