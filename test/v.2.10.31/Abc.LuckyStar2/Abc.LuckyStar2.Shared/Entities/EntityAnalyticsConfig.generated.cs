...
namespace Abc.LuckyStar2.Shared.Entities.EntityAnalyticsConfigOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class EntityAnalyticsConfig : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState)value.Value;
			}
		}
