...
namespace Abc.LuckyStar2.Shared.Entities.ManagedPropertyOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ManagedProperty : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ManagedPropertyOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ManagedPropertyOptionSets.ComponentState)value.Value;
			}
		}
