...
namespace Abc.LuckyStar2.Shared.Entities.SiteMapOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SiteMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SiteMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SiteMapOptionSets.ComponentState)value.Value;
			}
		}
