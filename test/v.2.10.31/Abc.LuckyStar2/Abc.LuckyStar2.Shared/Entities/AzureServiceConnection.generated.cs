...
namespace Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class AzureServiceConnection : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.ConnectionType? ConnectionType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ConnectionType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.ConnectionType)value.Value;
			}
			set
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.LastConnectionStatusCode? LastConnectionStatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LastConnectionStatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.LastConnectionStatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AzureServiceConnectionOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
