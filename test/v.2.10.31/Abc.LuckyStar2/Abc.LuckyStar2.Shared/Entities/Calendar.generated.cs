...
namespace Abc.LuckyStar2.Shared.Entities.CalendarOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Calendar : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.CalendarOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.CalendarOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
