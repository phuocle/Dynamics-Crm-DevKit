...
namespace Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class TransformationParameterMapping : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.DataTypeCode? DataTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DataTypeCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.DataTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.ParameterTypeCode? ParameterTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ParameterTypeCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TransformationParameterMappingOptionSets.ParameterTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
