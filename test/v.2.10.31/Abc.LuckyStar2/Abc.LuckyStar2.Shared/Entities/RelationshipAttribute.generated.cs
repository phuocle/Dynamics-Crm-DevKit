...
namespace Abc.LuckyStar2.Shared.Entities.RelationshipAttributeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RelationshipAttribute : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RelationshipAttributeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RelationshipAttributeOptionSets.ComponentState)value.Value;
			}
		}
