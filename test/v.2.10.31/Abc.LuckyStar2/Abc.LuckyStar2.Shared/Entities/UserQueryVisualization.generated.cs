...
namespace Abc.LuckyStar2.Shared.Entities.UserQueryVisualizationOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class UserQueryVisualization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.UserQueryVisualizationOptionSets.ChartType? ChartType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ChartType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.UserQueryVisualizationOptionSets.ChartType)value.Value;
			}
			set
	{
