...
namespace Abc.LuckyStar2.Shared.Entities.SyncAttributeMappingProfileOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SyncAttributeMappingProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState)value.Value;
			}
		}
