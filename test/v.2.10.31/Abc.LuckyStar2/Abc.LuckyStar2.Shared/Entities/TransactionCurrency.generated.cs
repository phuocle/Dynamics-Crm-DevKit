...
namespace Abc.LuckyStar2.Shared.Entities.TransactionCurrencyOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class TransactionCurrency : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TransactionCurrencyOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TransactionCurrencyOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TransactionCurrencyOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TransactionCurrencyOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
