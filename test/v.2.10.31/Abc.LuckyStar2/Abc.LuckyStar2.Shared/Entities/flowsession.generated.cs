...
namespace Abc.LuckyStar2.Shared.Entities.flowsessionOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class flowsession : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.flowsessionOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.flowsessionOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.flowsessionOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.flowsessionOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
