...
namespace Abc.LuckyStar2.Shared.Entities.SdkMessageFilterOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SdkMessageFilter : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SdkMessageFilterOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SdkMessageFilterOptionSets.ComponentState)value.Value;
			}
		}
