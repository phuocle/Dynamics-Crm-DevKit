...
namespace Abc.LuckyStar2.Shared.Entities.ServicePlanOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ServicePlan : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ServicePlanOptionSets.AccessMode? AccessMode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AccessMode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ServicePlanOptionSets.AccessMode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ServicePlanOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ServicePlanOptionSets.ComponentState)value.Value;
			}
		}
