...
namespace Abc.LuckyStar2.Shared.Entities.RibbonTabToCommandMapOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RibbonTabToCommandMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState)value.Value;
			}
		}
