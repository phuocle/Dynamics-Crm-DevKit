...
namespace Abc.LuckyStar2.Shared.Entities.ImportOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Import : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportOptionSets.ModeCode? ModeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ModeCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportOptionSets.ModeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportOptionSets.StateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ImportOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ImportOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
