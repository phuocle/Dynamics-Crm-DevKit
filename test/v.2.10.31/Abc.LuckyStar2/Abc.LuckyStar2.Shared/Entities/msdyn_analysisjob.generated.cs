...
namespace Abc.LuckyStar2.Shared.Entities.msdyn_analysisjobOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class msdyn_analysisjob : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_analysisjobOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_analysisjobOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_analysisjobOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_analysisjobOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
