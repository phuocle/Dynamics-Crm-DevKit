...
namespace Abc.LuckyStar2.Shared.Entities.OfficeDocumentOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class OfficeDocument : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.OfficeDocumentOptionSets.DocumentType? DocumentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.OfficeDocumentOptionSets.DocumentType)value.Value;
			}
			set
			{
				if (value.HasValue)
