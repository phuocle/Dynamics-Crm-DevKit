...
namespace Abc.LuckyStar2.Shared.Entities.ExternalPartyItemOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ExternalPartyItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ExternalPartyItemOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ExternalPartyItemOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ExternalPartyItemOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ExternalPartyItemOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
