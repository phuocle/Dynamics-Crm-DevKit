...
namespace Abc.LuckyStar2.Shared.Entities.RibbonContextGroupOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RibbonContextGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonContextGroupOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonContextGroupOptionSets.ComponentState)value.Value;
			}
		}
