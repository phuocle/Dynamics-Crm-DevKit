...
namespace Abc.LuckyStar2.Shared.Entities.ReplicationBacklogOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ReplicationBacklog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType? ReplicationBacklogType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReplicationBacklogType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType)value.Value;
			}
		}
