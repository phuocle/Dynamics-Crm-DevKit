...
namespace Abc.LuckyStar2.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets
{
...
{
	public partial class new_bpf_301232cf016d4faebcee80f57b143c69 : EntityBase
	{
		public struct Fields
		{
			...
			public const string bpf_devkit_locationid = "bpf_devkit_locationid";
		...
		public const string EntityLogicalName = "new_bpf_301232cf016d4faebcee80f57b143c69";

		public const int EntityTypeCode = 10071;

		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69()
		{
		...
		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69(Guid new_bpf_301232cf016d4faebcee80f57b143c69Id)
		{
			Entity = new Entity(EntityLogicalName, new_bpf_301232cf016d4faebcee80f57b143c69Id);
			PreEntity = CloneThisEntity(Entity);
		}

		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69(string keyName, object keyValue)
		{
		...
		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		[DebuggerNonUserCode()]
		public new_bpf_301232cf016d4faebcee80f57b143c69(KeyAttributeCollection keys)
		{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference bpf_contactid
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.bpf_contactid); }
			set { Entity.Attributes[Fields.bpf_contactid] = value; }
		}

		/// <summary>
		/// <para>Lookup</para>
		/// <para>Devkit_Location</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public EntityReference bpf_devkit_locationid
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.bpf_devkit_locationid); }
			set { Entity.Attributes[Fields.bpf_devkit_locationid] = value; }
		}
		...
		/// <summary>
		/// <para>Status of the BPF-Location-2</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Reason for the status of the BPF-Location-2</para>
		/// <para>Status</para>
		/// <para>Status Reason</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
