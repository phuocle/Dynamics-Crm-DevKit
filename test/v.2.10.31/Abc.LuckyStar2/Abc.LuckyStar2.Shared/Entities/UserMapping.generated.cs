...
namespace Abc.LuckyStar2.Shared.Entities.UserMappingOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class UserMapping : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.UserMappingOptionSets.PartnerApplicationType? PartnerApplicationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PartnerApplicationType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.UserMappingOptionSets.PartnerApplicationType)value.Value;
			}
			set
			{
				if (value.HasValue)
