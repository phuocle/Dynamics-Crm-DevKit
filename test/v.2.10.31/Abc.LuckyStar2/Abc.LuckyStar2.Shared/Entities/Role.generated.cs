...
namespace Abc.LuckyStar2.Shared.Entities.RoleOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Role : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RoleOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RoleOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RoleOptionSets.IsInherited? IsInherited
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.IsInherited);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RoleOptionSets.IsInherited)value.Value;
			}
			set
			{
				if (value.HasValue)
