...
namespace Abc.LuckyStar2.Shared.Entities.AppModuleRolesOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class AppModuleRoles : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.AppModuleRolesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.AppModuleRolesOptionSets.ComponentState)value.Value;
			}
		}
