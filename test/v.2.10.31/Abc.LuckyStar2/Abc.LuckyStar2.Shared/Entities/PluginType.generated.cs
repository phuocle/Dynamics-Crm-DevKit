...
namespace Abc.LuckyStar2.Shared.Entities.PluginTypeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class PluginType : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PluginTypeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PluginTypeOptionSets.ComponentState)value.Value;
			}
		}
