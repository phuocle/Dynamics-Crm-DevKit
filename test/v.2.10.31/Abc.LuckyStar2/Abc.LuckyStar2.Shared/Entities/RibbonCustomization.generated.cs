...
namespace Abc.LuckyStar2.Shared.Entities.RibbonCustomizationOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RibbonCustomization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RibbonCustomizationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RibbonCustomizationOptionSets.ComponentState)value.Value;
			}
		}
