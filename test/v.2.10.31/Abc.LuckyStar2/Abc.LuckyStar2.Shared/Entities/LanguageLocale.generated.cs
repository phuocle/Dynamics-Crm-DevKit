...
namespace Abc.LuckyStar2.Shared.Entities.LanguageLocaleOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class LanguageLocale : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.LanguageLocaleOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.LanguageLocaleOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.LanguageLocaleOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.LanguageLocaleOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
