...
namespace Abc.LuckyStar2.Shared.Entities.WebResourceOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class WebResource : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.WebResourceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.WebResourceOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.WebResourceOptionSets.WebResourceType? WebResourceType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.WebResourceType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.WebResourceOptionSets.WebResourceType)value.Value;
			}
			set
			{
				if (value.HasValue)
