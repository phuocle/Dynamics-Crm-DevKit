...
namespace Abc.LuckyStar2.Shared.Entities.DuplicateRuleConditionOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class DuplicateRuleCondition : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode? OperatorCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperatorCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode)value.Value;
			}
			set
			{
				if (value.HasValue)
