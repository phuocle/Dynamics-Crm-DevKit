...
namespace Abc.LuckyStar2.Shared.Entities.ClientUpdateOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ClientUpdate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ClientUpdateOptionSets.WhenExecute? WhenExecute
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.WhenExecute);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ClientUpdateOptionSets.WhenExecute)value.Value;
			}
			set
			{
				if (value.HasValue)
