...
namespace Abc.LuckyStar2.Shared.Entities.ReportOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Report : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReportOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReportOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ReportOptionSets.ReportTypeCode? ReportTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReportTypeCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ReportOptionSets.ReportTypeCode)value.Value;
			}
			set
	{
