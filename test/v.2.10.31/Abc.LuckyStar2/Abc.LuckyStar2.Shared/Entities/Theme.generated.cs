...
namespace Abc.LuckyStar2.Shared.Entities.ThemeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Theme : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ThemeOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ThemeOptionSets.statecode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ThemeOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ThemeOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
