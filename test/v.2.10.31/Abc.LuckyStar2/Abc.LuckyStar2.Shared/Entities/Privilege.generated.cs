...
namespace Abc.LuckyStar2.Shared.Entities.PrivilegeOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Privilege : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PrivilegeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PrivilegeOptionSets.ComponentState)value.Value;
			}
		}
