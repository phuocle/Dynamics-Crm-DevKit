...
namespace Abc.LuckyStar2.Shared.Entities.SdkMessageProcessingStepImageOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class SdkMessageProcessingStepImage : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType? ImageType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ImageType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType)value.Value;
			}
			set
			{
				if (value.HasValue)
