...
namespace Abc.LuckyStar2.Shared.Entities.ConvertRuleItemOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ConvertRuleItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ConvertRuleItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ConvertRuleItemOptionSets.ComponentState)value.Value;
			}
		}
