...
namespace Abc.LuckyStar2.Shared.Entities.TranslationProcessOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class TranslationProcess : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public TranslationProcess(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public TranslationProcess(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Unique identifier for Translation Process bpf entity instances</para>
		/// <para>Uniqueidentifier</para>
		/// <para>Translation Process Instance Id</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TranslationProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TranslationProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TranslationProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TranslationProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
