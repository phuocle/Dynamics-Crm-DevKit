...
namespace Abc.LuckyStar2.Shared.Entities.TraceLogOptionSets
{
	public enum Level
	{
		/// <summary>
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class TraceLog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.TraceLogOptionSets.Level? Level
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Level);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.TraceLogOptionSets.Level)value.Value;
			}
			set
	{
