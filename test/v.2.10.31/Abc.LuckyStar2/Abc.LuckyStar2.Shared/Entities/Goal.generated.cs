...
namespace Abc.LuckyStar2.Shared.Entities.GoalOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class Goal : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.GoalOptionSets.AmountDataType? AmountDataType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AmountDataType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.GoalOptionSets.AmountDataType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.GoalOptionSets.FiscalPeriod? FiscalPeriod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FiscalPeriod);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.GoalOptionSets.FiscalPeriod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.GoalOptionSets.FiscalYear? FiscalYear
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FiscalYear);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.GoalOptionSets.FiscalYear)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.GoalOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.GoalOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.GoalOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.GoalOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
