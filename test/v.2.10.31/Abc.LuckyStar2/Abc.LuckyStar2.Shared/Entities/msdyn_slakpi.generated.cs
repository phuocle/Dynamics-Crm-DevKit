...
namespace Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class msdyn_slakpi : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public msdyn_slakpi(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public msdyn_slakpi(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// <summary>
		/// <para>Boolean</para>
		/// <para>Override entity pause configurations?</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Status of the SLAKPI</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Reason for the status of the SLAKPI</para>
		/// <para>Status</para>
		/// <para>Status Reason</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_slakpiOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
