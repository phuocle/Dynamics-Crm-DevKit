...
namespace Abc.LuckyStar2.Shared.Entities.msdyn_solutionhealthruleOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class msdyn_solutionhealthrule : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_solutionhealthruleOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_solutionhealthruleOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.msdyn_solutionhealthruleOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.msdyn_solutionhealthruleOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
