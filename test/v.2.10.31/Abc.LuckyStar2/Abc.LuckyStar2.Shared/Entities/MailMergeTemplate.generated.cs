...
namespace Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class MailMergeTemplate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.DocumentFormat? DocumentFormat
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentFormat);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.DocumentFormat)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.MailMergeType? MailMergeType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MailMergeType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.MailMergeType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MailMergeTemplateOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
