...
namespace Abc.LuckyStar2.Shared.Entities.FieldSecurityProfileOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class FieldSecurityProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState)value.Value;
			}
		}
