...
namespace Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class PrincipalAttributeAccessMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.CreateAccess? CreateAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CreateAccess);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.CreateAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadAccess? ReadAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReadAccess);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.UpdateAccess? UpdateAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.UpdateAccess);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PrincipalAttributeAccessMapOptionSets.UpdateAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
