...
namespace Abc.LuckyStar2.Shared.Entities.ProvisionLanguageForUserOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class ProvisionLanguageForUser : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus? OperationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationStatus);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
