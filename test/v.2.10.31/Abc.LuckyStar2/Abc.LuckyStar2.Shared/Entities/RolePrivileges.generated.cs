...
namespace Abc.LuckyStar2.Shared.Entities.RolePrivilegesOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class RolePrivileges : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.RolePrivilegesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.RolePrivilegesOptionSets.ComponentState)value.Value;
			}
		}
