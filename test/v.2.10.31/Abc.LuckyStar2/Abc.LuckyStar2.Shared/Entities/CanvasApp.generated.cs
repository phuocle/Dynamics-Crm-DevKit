...
namespace Abc.LuckyStar2.Shared.Entities.CanvasAppOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class CanvasApp : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.CanvasAppOptionSets.CanvasAppType? CanvasAppType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CanvasAppType);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.CanvasAppOptionSets.CanvasAppType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.CanvasAppOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.CanvasAppOptionSets.ComponentState)value.Value;
			}
		}
