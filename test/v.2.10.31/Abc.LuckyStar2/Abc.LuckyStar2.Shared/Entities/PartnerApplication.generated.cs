...
namespace Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class PartnerApplication : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.ApplicationRole? ApplicationRole
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ApplicationRole);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.ApplicationRole)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.StateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.PartnerApplicationOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
