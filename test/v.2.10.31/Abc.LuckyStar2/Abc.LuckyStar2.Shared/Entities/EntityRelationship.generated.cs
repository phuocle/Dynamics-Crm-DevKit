...
namespace Abc.LuckyStar2.Shared.Entities.EntityRelationshipOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class EntityRelationship : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.EntityRelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.EntityRelationshipOptionSets.ComponentState)value.Value;
			}
		}
