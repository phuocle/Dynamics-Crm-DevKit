...
namespace Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets
{
...
namespace Abc.LuckyStar2.Shared.Entities
{
	public partial class MobileOfflineProfileItemAssociation : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.SelectedRelationShipsSchema? SelectedRelationShipsSchema
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SelectedRelationShipsSchema);
				if (value == null) return null;
				return (Abc.LuckyStar2.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.SelectedRelationShipsSchema)value.Value;
			}
			set
			{
				if (value.HasValue)
