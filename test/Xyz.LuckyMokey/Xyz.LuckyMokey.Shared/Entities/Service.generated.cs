...
namespace Xyz.LuckyMokey.Shared.Entities.ServiceOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Service : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ServiceOptionSets.InitialStatusCode? InitialStatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InitialStatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ServiceOptionSets.InitialStatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ServiceOptionSets.msdyn_SchedulingEngine? msdyn_SchedulingEngine
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_SchedulingEngine);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ServiceOptionSets.msdyn_SchedulingEngine)value.Value;
			}
			set
			{
				if (value.HasValue)
