...
namespace Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class msdyn_opportunitylinetransaction : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public msdyn_opportunitylinetransaction(Guid msdyn_opportunitylinetransactionId)
		{
			Entity = new Entity(EntityLogicalName, msdyn_opportunitylinetransactionId);
			PreEntity = CloneThisEntity(Entity);
		}

		[DebuggerNonUserCode()]
		public msdyn_opportunitylinetransaction(string keyName, object keyValue)
		{
		...
		[DebuggerNonUserCode()]
		public msdyn_opportunitylinetransaction(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public msdyn_opportunitylinetransaction(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		[DebuggerNonUserCode()]
		public msdyn_opportunitylinetransaction(KeyAttributeCollection keys)
		{
		...
		/// <summary>
		/// <para>Select the name of the customer to which this opportunity belongs.</para>
		/// <para>Lookup</para>
		/// <para>Customer</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Enter the amount on the estimate line.</para>
		...
		/// <summary>
		/// <para>Select the calculation method used to determine the amount on the estimate line.</para>
		/// <para>Picklist</para>
		/// <para>Amount Method</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_AmountMethod? msdyn_AmountMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_AmountMethod);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_AmountMethod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Enter the quantity used as basis for calculating quantity on this estimate line.</para>
		...
		/// <summary>
		/// <para>Select whether this estimate line would be charged to the customer or not. Only chargeable transactions will add to the invoice total when an invoices are created</para>
		/// <para>Picklist</para>
		/// <para>Billing Type</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_BillingType? msdyn_BillingType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_BillingType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_BillingType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Select the customer contact of this opportunity.</para>
		/// <para>Lookup</para>
		/// <para>Customer</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select whether the customer identified on the opportunity was an account or a contact</para>
		/// <para>Picklist</para>
		/// <para>Customer Type</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_CustomerType? msdyn_CustomerType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_CustomerType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_CustomerType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Type a description of the opportunity line estimate.</para>
		...
		/// <summary>
		/// <para>Enter the document date. The document date is only relevant for actuals and invoiced transactions; does not apply to opportunity line estimates.</para>
		...
		/// <summary>
		/// <para>Enter the end time of the opportunity line estimate.</para>
		...
		/// <summary>
		/// <para>Shows the opportunity line that this estimate line belongs to.</para>
		...
		/// <para>Opportunity Line Detail</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Guid msdyn_opportunitylinetransactionId
		{
			get { return Id; }
			set
			{
				Entity.Attributes[Fields.msdyn_opportunitylinetransactionId] = value;
				Entity.Id = value;
			}
		}

		/// <summary>
		/// <para>Relevant when amount calculation method on the opportunity line transactions is "Multiply basis amount by percent"</para>
		/// <para>Decimal - MinValue: -100,000,000,000 - MaxValue: 100,000,000,000</para>
		/// <para>Percent</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Enter the price on the estimate line.</para>
		/// <para>Money - MinValue: -922,337,203,685,477 - MaxValue: 922,337,203,685,477</para>
		/// <para>Price</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select the price list used on the opportunity line estimate.</para>
		/// <para>Lookup</para>
		...
		/// <summary>
		/// <para>Select the product on the estimate line.</para>
		/// <para>Lookup</para>
		/// <para>Product</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select the name of the Project that this estimate line is for.</para>
		/// <para>Lookup</para>
		/// <para>Project</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Enter the quantity of the opportunity estimate line.</para>
		/// <para>Decimal - MinValue: -100,000,000,000 - MaxValue: 100,000,000,000</para>
		/// <para>Quantity</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select the role that is estimated to perform the work.</para>
		/// <para>Lookup</para>
		/// <para>Role</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Enter the start date of the opportunity line estimate.</para>
		/// <para>Required - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		...
		/// <summary>
		/// <para>Select the name of the project task for which this estimate line was created.</para>
		/// <para>Lookup</para>
		/// <para>Task</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Transaction classification of the Opportunity line transaction</para>
		/// <para>Required - Picklist</para>
		/// <para>Transaction Class</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_TransactionClassification? msdyn_TransactionClassification
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_TransactionClassification);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_TransactionClassification)value.Value;
			}
			set
	{
		...
		/// <summary>
		/// <para>Transaction type for the opportunity line.</para>
		/// <para>Required - Picklist</para>
		/// <para>Transaction Type</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_TransactionTypeCode? msdyn_TransactionTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_TransactionTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_TransactionTypeCode)value.Value;
			}
			set
	{
		...
		/// <summary>
		/// <para>Select the unit of the estimate quantity.</para>
		/// <para>Lookup</para>
		/// <para>Unit</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select the unit group of the opportunity line estimate.</para>
		/// <para>Lookup</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_VendorType? msdyn_VendorType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_VendorType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.msdyn_VendorType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Status of the Opportunity Line Detail</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Reason for the status of the Opportunity Line Detail</para>
		/// <para>Status</para>
		/// <para>Status Reason</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_opportunitylinetransactionOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
