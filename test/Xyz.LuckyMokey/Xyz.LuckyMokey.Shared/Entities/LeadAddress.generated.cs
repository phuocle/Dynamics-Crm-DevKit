...
namespace Xyz.LuckyMokey.Shared.Entities.LeadAddressOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class LeadAddress : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public LeadAddress(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public LeadAddress(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Information about the address for the lead.</para>
		...
		/// <summary>
		/// <para>Type of address for the lead address.</para>
		/// <para>Picklist</para>
		/// <para>Address Type</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.LeadAddressOptionSets.AddressTypeCode? AddressTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AddressTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.LeadAddressOptionSets.AddressTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>City name in the address for the lead.</para>
		...
		/// <summary>
		/// <para>Country/region name in the address for the lead.</para>
		/// <para>String - MaxLength: 80</para>
		...
		/// <summary>
		/// <para>County name in the address for the lead.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the user who created the lead address.</para>
		...
		/// <summary>
		/// <para>Date and time when the lead address was created.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who created the leadaddress.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Exchange rate for the currency associated with the leadaddress with respect to the base currency.</para>
		...
		/// <summary>
		/// <para>Fax number for the address for the lead.</para>
		/// <para>String - MaxLength: 50</para>
		/// <para>Fax</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Latitude for the address for the lead.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the lead address.</para>
		...
		/// <summary>
		/// <para>Longitude for the address for the lead.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the user who last modified the lead address.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Date and time when the lead address was last modified.</para>
		/// <para>ReadOnly - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who last modified the leadaddress.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Name used to identify the lead address.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the parent object with which the lead address is associated.</para>
		/// <para>Lookup</para>
		/// <para>Parent</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>ZIP Code or postal code in the address for the lead.</para>
		...
		/// <summary>
		/// <para>Post office box number in the address for the lead.</para>
		/// <para>String - MaxLength: 20</para>
		...
		/// <summary>
		/// <para>Method of shipment for the lead.</para>
		/// <para>Picklist</para>
		/// <para>Shipping Method</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.LeadAddressOptionSets.ShippingMethodCode? ShippingMethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShippingMethodCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.LeadAddressOptionSets.ShippingMethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>State or province in the address for the lead.</para>
		/// <para>String - MaxLength: 50</para>
		...
		/// <summary>
		/// <para>First telephone number for the lead address.</para>
		/// <para>String - MaxLength: 50</para>
		...
		/// <summary>
		/// <para>Second telephone number for the lead address.</para>
		/// <para>String - MaxLength: 50</para>
		/// <para>Phone 2</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Third telephone number for the lead address.</para>
		/// <para>String - MaxLength: 50</para>
		...
		/// <summary>
		/// <para>Unique identifier of the currency associated with the leadaddress.</para>
		/// <para>Lookup</para>
		/// <para>Currency</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>United Parcel Service (UPS) zone for the address of the lead.</para>
		...
		/// <summary>
		/// <para>UTC offset for the lead address. This is the difference between local time and standard Coordinated Universal Time.</para>
		/// <para>Integer - MinValue: -2,147,483,648 - MaxValue: 2,147,483,647</para>
