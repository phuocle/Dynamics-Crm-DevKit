...
namespace Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class OrderClose : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public OrderClose(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public OrderClose(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Unique identifier of the order close activity.</para>
		/// <para>Uniqueidentifier</para>
		/// <para>Order Close</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Actual duration of the order close activity in minutes.</para>
		...
		/// <summary>
		/// <para>Actual end time of the order close activity.</para>
		/// <para>DateTimeBehavior: UserLocal - DateTimeFormat: DateOnly</para>
		/// <para>Closed Date</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Actual start time of the order close activity.</para>
		/// <para>DateTimeBehavior: UserLocal - DateTimeFormat: DateOnly</para>
		...
		/// <summary>
		/// <para>Category of the order close activity.</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.Community? Community
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Community);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.Community)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Unique identifier of the user who created the order close activity.</para>
		...
		/// <summary>
		/// <para>Date and time when the order close activity was created.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who created the orderclose.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Activity generated automatically when an order is closed.</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.InstanceTypeCode)value.Value;
			}
		}

		/// <summary>
		/// <para>Information about whether the order close activity was billed as part of resolving a case.</para>
		/// <para>Boolean</para>
		/// <para>Is Billed</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Information that specifies if the order close activity was created from a workflow rule.</para>
		/// <para>Boolean</para>
		...
		/// <summary>
		/// <para>Unique identifier of the user who last modified the order close activity.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Date and time when the order close activity was last modified.</para>
		/// <para>ReadOnly - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who last modified the orderclose.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Order revision number.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the order with which the order close activity is associated.</para>
		/// <para>Lookup</para>
		/// <para>Order</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Scheduled duration of the order close activity, specified in minutes.</para>
		...
		/// <summary>
		/// <para>Scheduled end time of the order close activity.</para>
		/// <para>DateTimeBehavior: UserLocal - DateTimeFormat: DateOnly</para>
		...
		/// <summary>
		/// <para>Scheduled start time of the order close activity.</para>
		/// <para>DateTimeBehavior: UserLocal - DateTimeFormat: DateOnly</para>
		...
		/// <summary>
		/// <para>Unique identifier of the service with which the order close activity is associated.</para>
		/// <para>Lookup</para>
		/// <para>Service</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Shows whether the order close activity is open, completed, or canceled.  By default, order close activities are completed.</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Reason for the status of the order close activity.</para>
		/// <para>Status</para>
		/// <para>Status Reason</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrderCloseOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Subcategory of the order close activity.</para>
		/// <para>String - MaxLength: 250</para>
		...
		/// <summary>
		/// <para>Subject associated with the order close activity.</para>
		/// <para>String - MaxLength: 200</para>
		/// <para>Subject</para>
		/// </summary>
		[DebuggerNonUserCode()]
