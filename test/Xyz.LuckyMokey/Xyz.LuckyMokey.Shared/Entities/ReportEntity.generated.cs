...
namespace Xyz.LuckyMokey.Shared.Entities.ReportEntityOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ReportEntity : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ReportEntityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ReportEntityOptionSets.ComponentState)value.Value;
			}
		}
