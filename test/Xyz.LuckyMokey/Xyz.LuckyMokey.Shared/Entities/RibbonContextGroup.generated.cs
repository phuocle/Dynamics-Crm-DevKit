...
namespace Xyz.LuckyMokey.Shared.Entities.RibbonContextGroupOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class RibbonContextGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.RibbonContextGroupOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.RibbonContextGroupOptionSets.ComponentState)value.Value;
			}
		}
