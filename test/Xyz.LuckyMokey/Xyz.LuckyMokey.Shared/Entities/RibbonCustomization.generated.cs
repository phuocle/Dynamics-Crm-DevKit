...
namespace Xyz.LuckyMokey.Shared.Entities.RibbonCustomizationOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class RibbonCustomization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.RibbonCustomizationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.RibbonCustomizationOptionSets.ComponentState)value.Value;
			}
		}
