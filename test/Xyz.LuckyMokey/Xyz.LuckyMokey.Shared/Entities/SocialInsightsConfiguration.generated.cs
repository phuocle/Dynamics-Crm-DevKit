...
namespace Xyz.LuckyMokey.Shared.Entities.SocialInsightsConfigurationOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SocialInsightsConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType? SocialDataItemType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SocialDataItemType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType)value.Value;
			}
			set
			{
				if (value.HasValue)
