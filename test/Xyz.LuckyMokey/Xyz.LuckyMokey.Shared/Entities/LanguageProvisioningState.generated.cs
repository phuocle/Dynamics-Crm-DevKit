...
namespace Xyz.LuckyMokey.Shared.Entities.LanguageProvisioningStateOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class LanguageProvisioningState : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage? ProvisioningStage
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ProvisioningStage);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage)value.Value;
			}
			set
			{
				if (value.HasValue)
