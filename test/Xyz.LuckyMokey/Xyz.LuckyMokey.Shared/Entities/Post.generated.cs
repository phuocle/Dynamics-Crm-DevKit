...
namespace Xyz.LuckyMokey.Shared.Entities.PostOptionSets
{
	public enum Source
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Post : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.PostOptionSets.Source? Source
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Source);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.PostOptionSets.Source)value.Value;
			}
			set
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.PostOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.PostOptionSets.Type)value.Value;
			}
			set
	{
