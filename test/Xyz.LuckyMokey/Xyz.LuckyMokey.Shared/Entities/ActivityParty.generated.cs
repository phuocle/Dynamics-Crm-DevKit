...
namespace Xyz.LuckyMokey.Shared.Entities.ActivityPartyOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ActivityParty : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ActivityPartyOptionSets.ParticipationTypeMask? ParticipationTypeMask
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ParticipationTypeMask);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ActivityPartyOptionSets.ParticipationTypeMask)value.Value;
			}
			set
			{
				if (value.HasValue)
