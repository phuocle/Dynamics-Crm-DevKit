...
namespace Xyz.LuckyMokey.Shared.Entities.AppConfigInstanceOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class AppConfigInstance : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppConfigInstanceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppConfigInstanceOptionSets.ComponentState)value.Value;
			}
		}
