...
namespace Xyz.LuckyMokey.Shared.Entities.EntityDataProviderOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntityDataProvider : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntityDataProviderOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntityDataProviderOptionSets.ComponentState)value.Value;
			}
		}
