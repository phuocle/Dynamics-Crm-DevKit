...
namespace Xyz.LuckyMokey.Shared.Entities.msdyn_quotebookingproductOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class msdyn_quotebookingproduct : EntityBase
	{
		...
		/// <para>Money - MinValue: 0 - MaxValue: 922,337,203,685,477</para>
		/// <para>EstimatedSalesAmount</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_quotebookingproductOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_quotebookingproductOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_quotebookingproductOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_quotebookingproductOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
