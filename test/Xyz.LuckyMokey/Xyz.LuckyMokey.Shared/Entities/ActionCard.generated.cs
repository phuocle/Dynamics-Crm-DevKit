...
namespace Xyz.LuckyMokey.Shared.Entities.ActionCardOptionSets
{
	public enum Source
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ActionCard : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ActionCardOptionSets.Source? Source
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Source);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ActionCardOptionSets.Source)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ActionCardOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ActionCardOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
