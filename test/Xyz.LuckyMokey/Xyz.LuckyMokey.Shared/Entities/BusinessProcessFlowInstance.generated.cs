...
namespace Xyz.LuckyMokey.Shared.Entities.BusinessProcessFlowInstanceOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class BusinessProcessFlowInstance : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
