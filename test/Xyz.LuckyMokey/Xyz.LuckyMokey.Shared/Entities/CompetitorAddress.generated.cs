...
namespace Xyz.LuckyMokey.Shared.Entities.CompetitorAddressOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class CompetitorAddress : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public CompetitorAddress(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public CompetitorAddress(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Information about which competitor address is applicable.</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CompetitorAddressOptionSets.AddressTypeCode? AddressTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AddressTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CompetitorAddressOptionSets.AddressTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>City name in the competitor address.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the competitor address.</para>
		/// <para>Primary Key - Uniqueidentifier</para>
		/// <para>Competitor Address</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Country/region name in the competitor address.</para>
		/// <para>String - MaxLength: 80</para>
		...
		/// <summary>
		/// <para>County name in the competitor address.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the user who created the competitor address.</para>
		...
		/// <summary>
		/// <para>Date and time when the competitor address was created.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who created the competitor address.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Fax number for the competitor address.</para>
		/// <para>String - MaxLength: 50</para>
		/// <para>Fax</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Latitude for the competitor address.</para>
		...
		/// <summary>
		/// <para>Longitude for the address for the competitor.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the user who last modified the competitor address.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Date and time when the competitor address was last modified.</para>
		/// <para>ReadOnly - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		...
		/// <summary>
		/// <para>Unique identifier of the delegate user who last modified the competitor address.</para>
		/// <para>ReadOnly - Lookup</para>
		...
		/// <summary>
		/// <para>Name used to identify the competitor address.</para>
		...
		/// <summary>
		/// <para>Unique identifier of the parent object with which the competitor address is associated.</para>
		/// <para>Lookup</para>
		/// <para>Parent</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>ZIP Code or postal code in the competitor address.</para>
		...
		/// <summary>
		/// <para>Post office box number in the competitor address.</para>
		/// <para>String - MaxLength: 20</para>
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CompetitorAddressOptionSets.ShippingMethodCode? ShippingMethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShippingMethodCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CompetitorAddressOptionSets.ShippingMethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>State or province in the competitor address.</para>
		/// <para>String - MaxLength: 50</para>
		...
		/// <summary>
		/// <para>First telephone number for the competitor address.</para>
		/// <para>String - MaxLength: 50</para>
		...
		/// <summary>
		/// <para>Second telephone number for the competitor address.</para>
		/// <para>String - MaxLength: 50</para>
		/// <para>Phone 2</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Third telephone number for the competitor address.</para>
		/// <para>String - MaxLength: 50</para>
		/// <para>Phone 3</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>United Parcel Service (UPS) zone for the address of the competitor.</para>
