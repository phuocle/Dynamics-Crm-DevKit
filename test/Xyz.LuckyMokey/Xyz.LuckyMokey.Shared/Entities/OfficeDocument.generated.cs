...
namespace Xyz.LuckyMokey.Shared.Entities.OfficeDocumentOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class OfficeDocument : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OfficeDocumentOptionSets.DocumentType? DocumentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OfficeDocumentOptionSets.DocumentType)value.Value;
			}
			set
			{
				if (value.HasValue)
