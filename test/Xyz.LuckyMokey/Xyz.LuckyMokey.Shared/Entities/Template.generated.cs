...
namespace Xyz.LuckyMokey.Shared.Entities.TemplateOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Template : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.TemplateOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.TemplateOptionSets.ComponentState)value.Value;
			}
		}
