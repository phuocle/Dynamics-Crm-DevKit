...
namespace Xyz.LuckyMokey.Shared.Entities.ResourceGroupOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ResourceGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ResourceGroupOptionSets.GroupTypeCode? GroupTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.GroupTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ResourceGroupOptionSets.GroupTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
