...
namespace Xyz.LuckyMokey.Shared.Entities.CampaignActivityItemOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class CampaignActivityItem : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public CampaignActivityItem(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public CampaignActivityItem(Entity entity, Entity merge)
		{
			Entity = entity;
