...
namespace Xyz.LuckyMokey.Shared.Entities.SubscriptionSyncEntryOfflineOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SubscriptionSyncEntryOffline : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public SubscriptionSyncEntryOffline(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public SubscriptionSyncEntryOffline(Entity entity, Entity merge)
		{
			Entity = entity;
