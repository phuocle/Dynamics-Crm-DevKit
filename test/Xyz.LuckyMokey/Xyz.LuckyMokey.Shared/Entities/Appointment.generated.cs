...
namespace Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Appointment : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.AttachmentErrors? AttachmentErrors
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AttachmentErrors);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.AttachmentErrors)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.InstanceTypeCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppointmentOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
