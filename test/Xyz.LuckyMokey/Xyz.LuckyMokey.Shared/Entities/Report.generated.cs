...
namespace Xyz.LuckyMokey.Shared.Entities.ReportOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Report : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ReportOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ReportOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ReportOptionSets.ReportTypeCode? ReportTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReportTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ReportOptionSets.ReportTypeCode)value.Value;
			}
			set
	{
