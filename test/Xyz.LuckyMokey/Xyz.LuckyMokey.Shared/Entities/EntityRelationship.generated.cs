...
namespace Xyz.LuckyMokey.Shared.Entities.EntityRelationshipOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntityRelationship : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntityRelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntityRelationshipOptionSets.ComponentState)value.Value;
			}
		}
