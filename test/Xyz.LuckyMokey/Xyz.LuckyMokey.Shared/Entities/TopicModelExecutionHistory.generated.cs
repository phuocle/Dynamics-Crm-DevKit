...
namespace Xyz.LuckyMokey.Shared.Entities.TopicModelExecutionHistoryOptionSets
{
	public enum Status
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class TopicModelExecutionHistory : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.TopicModelExecutionHistoryOptionSets.Status? Status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Status);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.TopicModelExecutionHistoryOptionSets.Status)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.TopicModelExecutionHistoryOptionSets.StatusReason? StatusReason
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusReason);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.TopicModelExecutionHistoryOptionSets.StatusReason)value.Value;
			}
			set
			{
				if (value.HasValue)
