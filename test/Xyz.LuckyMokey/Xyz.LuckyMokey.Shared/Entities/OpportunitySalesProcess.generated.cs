...
namespace Xyz.LuckyMokey.Shared.Entities.OpportunitySalesProcessOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class OpportunitySalesProcess : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OpportunitySalesProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OpportunitySalesProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OpportunitySalesProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OpportunitySalesProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
