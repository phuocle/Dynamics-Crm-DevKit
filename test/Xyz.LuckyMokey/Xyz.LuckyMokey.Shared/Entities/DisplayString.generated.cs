...
namespace Xyz.LuckyMokey.Shared.Entities.DisplayStringOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class DisplayString : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.DisplayStringOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.DisplayStringOptionSets.ComponentState)value.Value;
			}
		}
