...
namespace Xyz.LuckyMokey.Shared.Entities.ExpiredProcessOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ExpiredProcess : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public ExpiredProcess(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public ExpiredProcess(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Unique identifier for Expired Process bpf entity instances</para>
		/// <para>Uniqueidentifier</para>
		/// <para>Expired Process Instance Id</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ExpiredProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ExpiredProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ExpiredProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ExpiredProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
