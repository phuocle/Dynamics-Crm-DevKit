...
namespace Xyz.LuckyMokey.Shared.Entities.CardTypeOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class CardType : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CardTypeOptionSets.ClientAvailability? ClientAvailability
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ClientAvailability);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CardTypeOptionSets.ClientAvailability)value.Value;
			}
			set
			{
				if (value.HasValue)
