...
namespace Xyz.LuckyMokey.Shared.Entities.UserQueryVisualizationOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class UserQueryVisualization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.UserQueryVisualizationOptionSets.ChartType? ChartType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ChartType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.UserQueryVisualizationOptionSets.ChartType)value.Value;
			}
			set
	{
