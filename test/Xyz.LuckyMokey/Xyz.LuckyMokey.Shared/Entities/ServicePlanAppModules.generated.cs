...
namespace Xyz.LuckyMokey.Shared.Entities.ServicePlanAppModulesOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ServicePlanAppModules : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState)value.Value;
			}
		}
