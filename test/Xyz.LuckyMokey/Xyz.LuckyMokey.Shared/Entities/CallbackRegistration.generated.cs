...
namespace Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets
{
	public enum Message
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class CallbackRegistration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Message? Message
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Message);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Message)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.RunAs? RunAs
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RunAs);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.RunAs)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Scope? Scope
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Scope);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Scope)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Version? Version
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Version);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.CallbackRegistrationOptionSets.Version)value.Value;
			}
			set
			{
				if (value.HasValue)
