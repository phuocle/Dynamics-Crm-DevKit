...
namespace Xyz.LuckyMokey.Shared.Entities.SalesLiteratureOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SalesLiterature : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SalesLiteratureOptionSets.LiteratureTypeCode? LiteratureTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LiteratureTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SalesLiteratureOptionSets.LiteratureTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
