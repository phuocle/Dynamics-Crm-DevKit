...
namespace Xyz.LuckyMokey.Shared.Entities.SiteMapOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SiteMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SiteMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SiteMapOptionSets.ComponentState)value.Value;
			}
		}
