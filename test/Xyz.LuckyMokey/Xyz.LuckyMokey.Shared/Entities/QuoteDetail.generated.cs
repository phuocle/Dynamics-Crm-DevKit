...
namespace Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class QuoteDetail : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public QuoteDetail(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public QuoteDetail(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Billing method for the project quote line. Valid values are Time and Material and Fixed Price</para>
		/// <para>Picklist</para>
		/// <para>Billing Method</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.msdyn_BillingMethod? msdyn_BillingMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_BillingMethod);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.msdyn_BillingMethod)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Enter the estimated start date for the billing frequency on the project.</para>
		...
		/// <summary>
		/// <para>Enter the amount the customer has set aside or is willing to pay for the quote component.</para>
		/// <para>Money - MinValue: -922,337,203,685,477 - MaxValue: 922,337,203,685,477</para>
		...
		/// <summary>
		/// <para>Value of the CostAmount in base currency.</para>
		/// <para>ReadOnly - Money - MinValue: -922,337,203,685,477 - MaxValue: 922,337,203,685,477</para>
		/// <para>CostAmount (Base)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para>ReadOnly - Money - MinValue: -922,337,203,685,477 - MaxValue: 922,337,203,685,477</para>
		/// <para>EstimatedRevenue (Base)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Boolean</para>
		/// <para>ImportDetailsFromAgreement</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Select whether to include expenses in the quote line.</para>
		/// <para>Boolean</para>
		...
		/// <summary>
		/// <para>Select whether to include fees in the quote line.</para>
		/// <para>Boolean</para>
		...
		/// <summary>
		/// <para>Select whether to include materials in the quote line.</para>
		/// <para>Boolean</para>
		...
		/// <summary>
		/// <para>Select whether to include time transactions in the quote line.</para>
		/// <para>Boolean</para>
		...
		/// <summary>
		/// <para>abstracts description for product based lines vs write-in products or project based lines</para>
		/// <para>ReadOnly - String - MaxLength: 4000</para>
		/// <para>Quote Line Description</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public string msdyn_linedescription
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_linedescription); }
		}

		/// <summary>
		/// <para>The field to distinguish the quote lines to be of project service or field service</para>
		/// <para>Picklist</para>
		/// <para>Line Type</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.msdyn_LineType? msdyn_LineType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_LineType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.msdyn_LineType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Shows the opportunity line related to this quote line.</para>
		...
		/// <summary>
		/// <para>Select the project related to this quote line.</para>
		/// <para>Lookup</para>
		/// <para>Project</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.PricingErrorCode? PricingErrorCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PricingErrorCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.PricingErrorCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.ProductTypeCode? ProductTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ProductTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.ProductTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.PropertyConfigurationStatus? PropertyConfigurationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PropertyConfigurationStatus);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.PropertyConfigurationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para>Quote Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.QuoteStateCode? QuoteStateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.QuoteStateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.QuoteStateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.ShipTo_FreightTermsCode? ShipTo_FreightTermsCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShipTo_FreightTermsCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.ShipTo_FreightTermsCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Skip the price</para>
		/// <para>Picklist</para>
		/// <para>Skip Price Calculation</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.SkipPriceCalculation? SkipPriceCalculation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SkipPriceCalculation);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.QuoteDetailOptionSets.SkipPriceCalculation)value.Value;
			}
			set
			{
				if (value.HasValue)
