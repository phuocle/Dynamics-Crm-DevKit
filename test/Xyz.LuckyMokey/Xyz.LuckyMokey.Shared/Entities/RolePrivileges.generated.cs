...
namespace Xyz.LuckyMokey.Shared.Entities.RolePrivilegesOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class RolePrivileges : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.RolePrivilegesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.RolePrivilegesOptionSets.ComponentState)value.Value;
			}
		}
