...
namespace Xyz.LuckyMokey.Shared.Entities.EntityAnalyticsConfigOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntityAnalyticsConfig : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState)value.Value;
			}
		}
