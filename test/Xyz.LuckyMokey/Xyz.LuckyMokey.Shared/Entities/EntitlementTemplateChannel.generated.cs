...
namespace Xyz.LuckyMokey.Shared.Entities.EntitlementTemplateChannelOptionSets
{
	public enum Channel
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntitlementTemplateChannel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntitlementTemplateChannelOptionSets.Channel? Channel
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Channel);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntitlementTemplateChannelOptionSets.Channel)value.Value;
			}
			set
			{
				if (value.HasValue)
