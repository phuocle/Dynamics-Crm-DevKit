...
namespace Xyz.LuckyMokey.Shared.Entities.AttributeOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Attribute : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AttributeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AttributeOptionSets.ComponentState)value.Value;
			}
		}
