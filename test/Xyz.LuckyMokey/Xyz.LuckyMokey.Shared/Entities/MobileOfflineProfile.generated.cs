...
namespace Xyz.LuckyMokey.Shared.Entities.MobileOfflineProfileOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class MobileOfflineProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState)value.Value;
			}
		}
