...
namespace Xyz.LuckyMokey.Shared.Entities.SalesLiteratureItemOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SalesLiteratureItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SalesLiteratureItemOptionSets.FileTypeCode? FileTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.FileTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SalesLiteratureItemOptionSets.FileTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
