...
namespace Xyz.LuckyMokey.Shared.Entities.RibbonCommandOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class RibbonCommand : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.RibbonCommandOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.RibbonCommandOptionSets.ComponentState)value.Value;
			}
		}
