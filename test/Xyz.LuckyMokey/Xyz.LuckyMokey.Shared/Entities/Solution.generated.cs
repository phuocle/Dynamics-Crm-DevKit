...
namespace Xyz.LuckyMokey.Shared.Entities.SolutionOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Solution : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SolutionOptionSets.SolutionType? SolutionType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SolutionType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SolutionOptionSets.SolutionType)value.Value;
			}
			set
			{
				if (value.HasValue)
