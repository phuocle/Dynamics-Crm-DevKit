...
namespace Xyz.LuckyMokey.Shared.Entities.RibbonTabToCommandMapOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class RibbonTabToCommandMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.RibbonTabToCommandMapOptionSets.ComponentState)value.Value;
			}
		}
