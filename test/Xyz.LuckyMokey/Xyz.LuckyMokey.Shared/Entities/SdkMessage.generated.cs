...
namespace Xyz.LuckyMokey.Shared.Entities.SdkMessageOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SdkMessage : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SdkMessageOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SdkMessageOptionSets.ComponentState)value.Value;
			}
		}
