...
namespace Xyz.LuckyMokey.Shared.Entities.SdkMessageFilterOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SdkMessageFilter : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SdkMessageFilterOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SdkMessageFilterOptionSets.ComponentState)value.Value;
			}
		}
