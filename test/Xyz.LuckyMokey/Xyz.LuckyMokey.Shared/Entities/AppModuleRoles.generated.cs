...
namespace Xyz.LuckyMokey.Shared.Entities.AppModuleRolesOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class AppModuleRoles : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppModuleRolesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppModuleRolesOptionSets.ComponentState)value.Value;
			}
		}
