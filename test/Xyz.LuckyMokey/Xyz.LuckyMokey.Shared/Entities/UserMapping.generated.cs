...
namespace Xyz.LuckyMokey.Shared.Entities.UserMappingOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class UserMapping : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.UserMappingOptionSets.PartnerApplicationType? PartnerApplicationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PartnerApplicationType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.UserMappingOptionSets.PartnerApplicationType)value.Value;
			}
			set
			{
				if (value.HasValue)
