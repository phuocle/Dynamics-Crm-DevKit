...
namespace Xyz.LuckyMokey.Shared.Entities.GlobalSearchConfigurationOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class GlobalSearchConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState)value.Value;
			}
		}
