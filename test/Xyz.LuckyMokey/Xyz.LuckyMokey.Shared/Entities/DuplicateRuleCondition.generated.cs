...
namespace Xyz.LuckyMokey.Shared.Entities.DuplicateRuleConditionOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class DuplicateRuleCondition : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode? OperatorCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperatorCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode)value.Value;
			}
			set
			{
				if (value.HasValue)
