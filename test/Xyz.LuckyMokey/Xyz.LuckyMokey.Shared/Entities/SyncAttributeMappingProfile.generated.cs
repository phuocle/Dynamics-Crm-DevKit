...
namespace Xyz.LuckyMokey.Shared.Entities.SyncAttributeMappingProfileOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class SyncAttributeMappingProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.SyncAttributeMappingProfileOptionSets.ComponentState)value.Value;
			}
		}
