...
namespace Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ContractDetail : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.ContractStateCode? ContractStateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ContractStateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.ContractStateCode)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.ServiceContractUnitsCode? ServiceContractUnitsCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ServiceContractUnitsCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.ServiceContractUnitsCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ContractDetailOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
