...
namespace Xyz.LuckyMokey.Shared.Entities.EntitlementChannelOptionSets
{
	public enum Channel
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntitlementChannel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntitlementChannelOptionSets.Channel? Channel
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Channel);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntitlementChannelOptionSets.Channel)value.Value;
			}
			set
			{
				if (value.HasValue)
