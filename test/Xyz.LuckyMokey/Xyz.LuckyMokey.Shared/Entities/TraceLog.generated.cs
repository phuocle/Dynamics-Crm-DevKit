...
namespace Xyz.LuckyMokey.Shared.Entities.TraceLogOptionSets
{
	public enum Level
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class TraceLog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.TraceLogOptionSets.Level? Level
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Level);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.TraceLogOptionSets.Level)value.Value;
			}
			set
	{
