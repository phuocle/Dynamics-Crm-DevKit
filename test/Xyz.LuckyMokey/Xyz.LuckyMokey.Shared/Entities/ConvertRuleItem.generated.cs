...
namespace Xyz.LuckyMokey.Shared.Entities.ConvertRuleItemOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ConvertRuleItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ConvertRuleItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ConvertRuleItemOptionSets.ComponentState)value.Value;
			}
		}
