...
namespace Xyz.LuckyMokey.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class BookableResourceBookingExchangeSyncIdMapping : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public BookableResourceBookingExchangeSyncIdMapping(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public BookableResourceBookingExchangeSyncIdMapping(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets.SyncStatus? SyncStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SyncStatus);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.BookableResourceBookingExchangeSyncIdMappingOptionSets.SyncStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
