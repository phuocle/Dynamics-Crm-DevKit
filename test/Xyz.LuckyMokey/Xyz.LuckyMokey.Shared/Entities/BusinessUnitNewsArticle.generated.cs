...
namespace Xyz.LuckyMokey.Shared.Entities.BusinessUnitNewsArticleOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class BusinessUnitNewsArticle : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode? ArticleTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ArticleTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
