...
namespace Xyz.LuckyMokey.Shared.Entities.msdyn_bpf_989e9b1857e24af18787d5143b67523bOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class msdyn_bpf_989e9b1857e24af18787d5143b67523b : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public msdyn_bpf_989e9b1857e24af18787d5143b67523b(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public msdyn_bpf_989e9b1857e24af18787d5143b67523b(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <para>Case to Work Order Business Process</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Status of the Case to Work Order Business Process</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_bpf_989e9b1857e24af18787d5143b67523bOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_bpf_989e9b1857e24af18787d5143b67523bOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para>Reason for the status of the Case to Work Order Business Process</para>
		/// <para>Status</para>
		/// <para>Status Reason</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.msdyn_bpf_989e9b1857e24af18787d5143b67523bOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.msdyn_bpf_989e9b1857e24af18787d5143b67523bOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
