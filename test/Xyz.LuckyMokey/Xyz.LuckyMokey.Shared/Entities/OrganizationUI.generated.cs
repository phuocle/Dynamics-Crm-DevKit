...
namespace Xyz.LuckyMokey.Shared.Entities.OrganizationUIOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class OrganizationUI : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrganizationUIOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrganizationUIOptionSets.ComponentState)value.Value;
			}
		}
