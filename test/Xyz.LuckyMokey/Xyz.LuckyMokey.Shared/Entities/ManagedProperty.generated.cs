...
namespace Xyz.LuckyMokey.Shared.Entities.ManagedPropertyOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ManagedProperty : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ManagedPropertyOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ManagedPropertyOptionSets.ComponentState)value.Value;
			}
		}
