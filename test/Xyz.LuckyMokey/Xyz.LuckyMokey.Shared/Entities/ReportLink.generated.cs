...
namespace Xyz.LuckyMokey.Shared.Entities.ReportLinkOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ReportLink : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ReportLinkOptionSets.LinkTypeCode? LinkTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LinkTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ReportLinkOptionSets.LinkTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
