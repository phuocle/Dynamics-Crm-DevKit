...
namespace Xyz.LuckyMokey.Shared.Entities.EntityDataSourceOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntityDataSource : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntityDataSourceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntityDataSourceOptionSets.ComponentState)value.Value;
			}
		}
