...
namespace Xyz.LuckyMokey.Shared.Entities.PostRoleOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class PostRole : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.PostRoleOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.PostRoleOptionSets.Type)value.Value;
			}
			set
	{
