...
namespace Xyz.LuckyMokey.Shared.Entities.DynamicPropertyAssociationOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class DynamicPropertyAssociation : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.DynamicPropertyAssociationOptionSets.AssociationStatus? AssociationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AssociationStatus);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.DynamicPropertyAssociationOptionSets.AssociationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.DynamicPropertyAssociationOptionSets.InheritanceState? InheritanceState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InheritanceState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.DynamicPropertyAssociationOptionSets.InheritanceState)value.Value;
			}
			set
			{
				if (value.HasValue)
