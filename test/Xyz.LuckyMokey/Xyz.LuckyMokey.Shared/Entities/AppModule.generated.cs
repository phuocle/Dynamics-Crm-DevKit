...
namespace Xyz.LuckyMokey.Shared.Entities.AppModuleOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class AppModule : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppModuleOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppModuleOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.AppModuleOptionSets.NavigationType? NavigationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.NavigationType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.AppModuleOptionSets.NavigationType)value.Value;
			}
			set
			{
				if (value.HasValue)
