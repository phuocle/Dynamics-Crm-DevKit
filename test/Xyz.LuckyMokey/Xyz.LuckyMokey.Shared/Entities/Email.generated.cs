...
namespace Xyz.LuckyMokey.Shared.Entities.EmailOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class Email : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.CorrelationMethod? CorrelationMethod
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CorrelationMethod);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.CorrelationMethod)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.DeliveryPriorityCode? DeliveryPriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DeliveryPriorityCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.DeliveryPriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.EmailReminderStatus? EmailReminderStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EmailReminderStatus);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.EmailReminderStatus)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.EmailReminderType? EmailReminderType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EmailReminderType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.EmailReminderType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.Notifications? Notifications
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Notifications);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.Notifications)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EmailOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
