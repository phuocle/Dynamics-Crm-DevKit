...
namespace Xyz.LuckyMokey.Shared.Entities.ReplicationBacklogOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ReplicationBacklog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType? ReplicationBacklogType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReplicationBacklogType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType)value.Value;
			}
		}
