...
namespace Xyz.LuckyMokey.Shared.Entities.ClientUpdateOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ClientUpdate : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ClientUpdateOptionSets.WhenExecute? WhenExecute
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.WhenExecute);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ClientUpdateOptionSets.WhenExecute)value.Value;
			}
			set
			{
				if (value.HasValue)
