...
namespace Xyz.LuckyMokey.Shared.Entities.ConstraintBasedGroupOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ConstraintBasedGroup : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ConstraintBasedGroupOptionSets.GroupTypeCode? GroupTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.GroupTypeCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ConstraintBasedGroupOptionSets.GroupTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
