...
namespace Xyz.LuckyMokey.Shared.Entities.ResourceGroupExpansionOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ResourceGroupExpansion : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ResourceGroupExpansionOptionSets.MethodCode? MethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MethodCode);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ResourceGroupExpansionOptionSets.MethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
