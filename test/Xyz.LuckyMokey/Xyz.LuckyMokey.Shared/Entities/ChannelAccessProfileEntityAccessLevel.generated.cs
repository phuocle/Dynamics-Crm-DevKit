...
namespace Xyz.LuckyMokey.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ChannelAccessProfileEntityAccessLevel : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState)value.Value;
			}
		}
