...
namespace Xyz.LuckyMokey.Shared.Entities.OrgInsightsMetricOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class OrgInsightsMetric : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.OrgInsightsMetricOptionSets.MetricType? MetricType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MetricType);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.OrgInsightsMetricOptionSets.MetricType)value.Value;
			}
			set
			{
				if (value.HasValue)
