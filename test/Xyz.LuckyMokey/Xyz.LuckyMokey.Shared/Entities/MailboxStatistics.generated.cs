...
namespace Xyz.LuckyMokey.Shared.Entities.MailboxStatisticsOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class MailboxStatistics : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId? OperationTypeId
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationTypeId);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId)value.Value;
			}
		}
