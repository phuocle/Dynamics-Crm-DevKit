...
namespace Xyz.LuckyMokey.Shared.Entities.ComplexControlOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class ComplexControl : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ComplexControlOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ComplexControlOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.ComplexControlOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.ComplexControlOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
