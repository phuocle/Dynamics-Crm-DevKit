...
namespace Xyz.LuckyMokey.Shared.Entities.EntityMapOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class EntityMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.EntityMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.EntityMapOptionSets.ComponentState)value.Value;
			}
		}
