...
namespace Xyz.LuckyMokey.Shared.Entities.DependencyFeatureOptionSets
{
...
namespace Xyz.LuckyMokey.Shared.Entities
{
	public partial class DependencyFeature : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Xyz.LuckyMokey.Shared.Entities.DependencyFeatureOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Xyz.LuckyMokey.Shared.Entities.DependencyFeatureOptionSets.ComponentState)value.Value;
			}
		}
