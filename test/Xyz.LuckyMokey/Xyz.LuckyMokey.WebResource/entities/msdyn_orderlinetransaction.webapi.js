...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_orderlinetransactionApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_orderlinetransaction) {
			var a = msdyn_orderlinetransaction[field].a;
			var b = msdyn_orderlinetransaction[field].b;
			var c = msdyn_orderlinetransaction[field].c;
			var d = msdyn_orderlinetransaction[field].d;
			var g = msdyn_orderlinetransaction[field].g;
			var r = msdyn_orderlinetransaction[field].r;
			msdyn_orderlinetransaction[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_orderlinetransaction.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_orderlinetransaction.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
