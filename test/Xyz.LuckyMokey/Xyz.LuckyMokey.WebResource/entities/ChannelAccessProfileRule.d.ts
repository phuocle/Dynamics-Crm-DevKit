...
declare namespace LuckyMokey {
	...
	class FormChannelAccessProfileRule_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormChannelAccessProfileRule_Information.Body;
		/** The Header section of form ChannelAccessProfileRule_Information */
		Header: LuckyMokey.FormChannelAccessProfileRule_Information.Header;
	}
}
