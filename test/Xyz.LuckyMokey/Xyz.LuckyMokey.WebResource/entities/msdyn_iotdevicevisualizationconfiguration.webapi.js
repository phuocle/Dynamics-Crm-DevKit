...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_iotdevicevisualizationconfigurationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_iotdevicevisualizationconfiguration) {
			var a = msdyn_iotdevicevisualizationconfiguration[field].a;
			var b = msdyn_iotdevicevisualizationconfiguration[field].b;
			var c = msdyn_iotdevicevisualizationconfiguration[field].c;
			var d = msdyn_iotdevicevisualizationconfiguration[field].d;
			var g = msdyn_iotdevicevisualizationconfiguration[field].g;
			var r = msdyn_iotdevicevisualizationconfiguration[field].r;
			msdyn_iotdevicevisualizationconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_iotdevicevisualizationconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_iotdevicevisualizationconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
