...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_agreementbookingservicetaskApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_agreementbookingservicetask) {
			var a = msdyn_agreementbookingservicetask[field].a;
			var b = msdyn_agreementbookingservicetask[field].b;
			var c = msdyn_agreementbookingservicetask[field].c;
			var d = msdyn_agreementbookingservicetask[field].d;
			var g = msdyn_agreementbookingservicetask[field].g;
			var r = msdyn_agreementbookingservicetask[field].r;
			msdyn_agreementbookingservicetask[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementbookingservicetask.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_agreementbookingservicetask.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
