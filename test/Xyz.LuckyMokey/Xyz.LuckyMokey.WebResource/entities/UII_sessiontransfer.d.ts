...
declare namespace LuckyMokey {
	...
	class FormUII_sessiontransfer_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form UII_sessiontransfer_Information
		...
		*/
		...
		Body: LuckyMokey.FormUII_sessiontransfer_Information.Body;
		/** The Footer section of form UII_sessiontransfer_Information */
		Footer: LuckyMokey.FormUII_sessiontransfer_Information.Footer;
	}
	class UII_sessiontransferApi {
		...
		*/
		...
		UII_SessionInformation: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		UII_sessiontransferId: DevKit.WebApi.GuidValue;
		/** Captures the agent information to whom the session is transferred */
		uii_toagentid: DevKit.WebApi.LookupValue;
