...
declare namespace LuckyMokey {
	namespace Formmsdyn_oclocalizationdata_Information {
		...
		interface Body {
			...
			msdyn_localizedtext: DevKit.Form.Controls.ControlString;
		}
	}
	class Formmsdyn_oclocalizationdata_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_oclocalizationdata_Information.Body;
	}
}
