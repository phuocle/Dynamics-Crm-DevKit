...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_contractlineinvoicescheduleApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_contractlineinvoiceschedule) {
			var a = msdyn_contractlineinvoiceschedule[field].a;
			var b = msdyn_contractlineinvoiceschedule[field].b;
			var c = msdyn_contractlineinvoiceschedule[field].c;
			var d = msdyn_contractlineinvoiceschedule[field].d;
			var g = msdyn_contractlineinvoiceschedule[field].g;
			var r = msdyn_contractlineinvoiceschedule[field].r;
			msdyn_contractlineinvoiceschedule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_contractlineinvoiceschedule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_contractlineinvoiceschedule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
