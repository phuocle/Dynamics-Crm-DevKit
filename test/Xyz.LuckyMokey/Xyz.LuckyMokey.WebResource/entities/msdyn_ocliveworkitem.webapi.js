...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_ocliveworkitemApi = function (e) {
		var EMPTY_STRING = '';
		...
		var msdyn_ocliveworkitem = {
			...
			regardingobjectid_adobe_migratedrecord_msdyn_ocliveworkitem: { b: 'regardingobjectid_adobe_migratedrecord_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_msdyn_ocliveworkitem: { b: 'regardingobjectid_adobe_templatedocument_msdyn_ocliveworkitem', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
