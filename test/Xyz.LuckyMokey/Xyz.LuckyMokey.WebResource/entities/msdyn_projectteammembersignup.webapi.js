...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_projectteammembersignupApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_projectteammembersignup) {
			var a = msdyn_projectteammembersignup[field].a;
			var b = msdyn_projectteammembersignup[field].b;
			var c = msdyn_projectteammembersignup[field].c;
			var d = msdyn_projectteammembersignup[field].d;
			var g = msdyn_projectteammembersignup[field].g;
			var r = msdyn_projectteammembersignup[field].r;
			msdyn_projectteammembersignup[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projectteammembersignup.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_projectteammembersignup.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
