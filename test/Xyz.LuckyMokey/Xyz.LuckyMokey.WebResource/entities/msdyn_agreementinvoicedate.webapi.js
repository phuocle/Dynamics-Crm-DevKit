...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_agreementinvoicedateApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_agreementinvoicedate) {
			var a = msdyn_agreementinvoicedate[field].a;
			var b = msdyn_agreementinvoicedate[field].b;
			var c = msdyn_agreementinvoicedate[field].c;
			var d = msdyn_agreementinvoicedate[field].d;
			var g = msdyn_agreementinvoicedate[field].g;
			var r = msdyn_agreementinvoicedate[field].r;
			msdyn_agreementinvoicedate[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementinvoicedate.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_agreementinvoicedate.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
