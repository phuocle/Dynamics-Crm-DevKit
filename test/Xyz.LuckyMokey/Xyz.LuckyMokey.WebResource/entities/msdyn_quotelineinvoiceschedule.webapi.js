...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotelineinvoicescheduleApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotelineinvoiceschedule) {
			var a = msdyn_quotelineinvoiceschedule[field].a;
			var b = msdyn_quotelineinvoiceschedule[field].b;
			var c = msdyn_quotelineinvoiceschedule[field].c;
			var d = msdyn_quotelineinvoiceschedule[field].d;
			var g = msdyn_quotelineinvoiceschedule[field].g;
			var r = msdyn_quotelineinvoiceschedule[field].r;
			msdyn_quotelineinvoiceschedule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotelineinvoiceschedule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotelineinvoiceschedule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
