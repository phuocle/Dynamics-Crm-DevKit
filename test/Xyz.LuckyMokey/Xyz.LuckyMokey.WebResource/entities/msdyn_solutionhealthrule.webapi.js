...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_solutionhealthruleApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_solutionhealthrule) {
			var a = msdyn_solutionhealthrule[field].a;
			var b = msdyn_solutionhealthrule[field].b;
			var c = msdyn_solutionhealthrule[field].c;
			var d = msdyn_solutionhealthrule[field].d;
			var g = msdyn_solutionhealthrule[field].g;
			var r = msdyn_solutionhealthrule[field].r;
			msdyn_solutionhealthrule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_solutionhealthrule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_solutionhealthrule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
