...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_facebookengagementctxApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_facebookengagementctx) {
			var a = msdyn_facebookengagementctx[field].a;
			var b = msdyn_facebookengagementctx[field].b;
			var c = msdyn_facebookengagementctx[field].c;
			var d = msdyn_facebookengagementctx[field].d;
			var g = msdyn_facebookengagementctx[field].g;
			var r = msdyn_facebookengagementctx[field].r;
			msdyn_facebookengagementctx[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_facebookengagementctx.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_facebookengagementctx.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
