...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyusd_sessiontransferApi = function (e) {
		var EMPTY_STRING = '';
		...
		var msdyusd_sessiontransfer = {
			...
			msdyusd_SessionInformation: { a: 'msdyusd_sessioninformation' },
			msdyusd_sessiontransferId: { a: 'msdyusd_sessiontransferid' },
		...
		return msdyusd_sessiontransfer;
	};
})(LuckyMokey || (LuckyMokey = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyusd_sessiontransfer = {
		statecode : {
			Active: 0,
			Inactive: 1
		},
