...
declare namespace LuckyMokey {
	namespace Formmsdyn_solutionhealthrule_Information {
		...
		interface Body {
			...
			msdyn_OwningSolutionId: DevKit.Form.Controls.ControlString;
			msdyn_ResolutionAction: DevKit.Form.Controls.ControlLookup;
			/** This message will be visible to end use when he/she tried to resolve rule failure. */
			msdyn_resolutionmessage: DevKit.Form.Controls.ControlString;
			/** Rule set to which the rule belongs to. */
			msdyn_solutionhealthrulesetId: DevKit.Form.Controls.ControlLookup;
			msdyn_Workflow: DevKit.Form.Controls.ControlLookup;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_solutionhealthrule_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_solutionhealthrule_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_solutionhealthrule_Information.Body;
	}
