...
declare namespace LuckyMokey {
	...
	class Formmsdyn_SessionParticipantData_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_SessionParticipantData_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_SessionParticipantData_Information.Body;
	}
	class msdyn_SessionParticipantDataApi {
		...
		*/
		...
		msdyn_ParticipantAddedTimestamp_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** Rason for which the participant was added to the session */
		msdyn_ParticipantAssignReason: DevKit.WebApi.StringValue;
		/** Identifier of the session participant */
		msdyn_ParticipantId: DevKit.WebApi.StringValue;
		/** Session participant mode */
		msdyn_ParticipantMode: DevKit.WebApi.StringValue;
		/** Name of the session participant */
		msdyn_ParticipantName: DevKit.WebApi.StringValue;
		/** Type of the session participant */
		msdyn_ParticipantType: DevKit.WebApi.StringValue;
		msdyn_ProviderSessionId: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_SessionParticipantDataId: DevKit.WebApi.GuidValue;
