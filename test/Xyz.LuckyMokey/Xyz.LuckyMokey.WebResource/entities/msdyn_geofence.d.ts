...
declare namespace LuckyMokey {
	namespace Formmsdyn_geofence_Main_Form {
		...
		interface Body {
			...
			msdyn_GeotrackedRecordStatus: DevKit.Form.Controls.ControlOptionSet;
	...
	class Formmsdyn_geofence_Main_Form extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_geofence_Main_Form
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_geofence_Main_Form.Body;
	}
}
