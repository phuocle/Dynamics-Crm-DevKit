...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_ocruleitemApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocruleitem) {
			var a = msdyn_ocruleitem[field].a;
			var b = msdyn_ocruleitem[field].b;
			var c = msdyn_ocruleitem[field].c;
			var d = msdyn_ocruleitem[field].d;
			var g = msdyn_ocruleitem[field].g;
			var r = msdyn_ocruleitem[field].r;
			msdyn_ocruleitem[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocruleitem.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocruleitem.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
