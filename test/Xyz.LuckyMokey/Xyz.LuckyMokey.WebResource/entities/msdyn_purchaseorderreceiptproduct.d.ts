...
//{'JsForm':['Information','Purchase Order Receipt Product - Mobile','Quick Create Purchase Order Receipt Product'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}