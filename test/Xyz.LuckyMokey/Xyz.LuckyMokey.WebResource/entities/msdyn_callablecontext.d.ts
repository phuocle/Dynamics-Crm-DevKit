...
declare namespace LuckyMokey {
	...
	class Formmsdyn_callablecontext_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_callablecontext_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_callablecontext_Information.Body;
	}
