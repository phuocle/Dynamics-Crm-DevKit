...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_inventoryadjustmentproductApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_inventoryadjustmentproduct) {
			var a = msdyn_inventoryadjustmentproduct[field].a;
			var b = msdyn_inventoryadjustmentproduct[field].b;
			var c = msdyn_inventoryadjustmentproduct[field].c;
			var d = msdyn_inventoryadjustmentproduct[field].d;
			var g = msdyn_inventoryadjustmentproduct[field].g;
			var r = msdyn_inventoryadjustmentproduct[field].r;
			msdyn_inventoryadjustmentproduct[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_inventoryadjustmentproduct.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_inventoryadjustmentproduct.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
