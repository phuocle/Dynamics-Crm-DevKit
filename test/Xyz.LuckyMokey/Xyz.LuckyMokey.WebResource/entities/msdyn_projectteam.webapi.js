...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_projectteamApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_projectteam) {
			var a = msdyn_projectteam[field].a;
			var b = msdyn_projectteam[field].b;
			var c = msdyn_projectteam[field].c;
			var d = msdyn_projectteam[field].d;
			var g = msdyn_projectteam[field].g;
			var r = msdyn_projectteam[field].r;
			msdyn_projectteam[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projectteam.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_projectteam.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
