...
declare namespace LuckyMokey {
	...
	class FormEmail extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyMokey.FormEmail.Body;
		/** The Footer section of form Email */
		Footer: LuckyMokey.FormEmail.Footer;
		/** The Header section of form Email */
		Header: LuckyMokey.FormEmail.Header;
	}
	...
	class FormEmail_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyMokey.FormEmail_for_Interactive_experience.Body;
		/** The Header section of form Email_for_Interactive_experience */
		Header: LuckyMokey.FormEmail_for_Interactive_experience.Header;
	}
	namespace FormEnhanced_Email {
		...
		interface tab_Properties_Sections {
			properties_section: DevKit.Form.Controls.ControlSection;
		}
		interface tab_Attachments_Sections {
			attachments: DevKit.Form.Controls.ControlSection;
		}
		interface tab_EmailEngagementTab_Sections {
			emailengagementactions: DevKit.Form.Controls.ControlSection;
			Emailrecipient_section_6: DevKit.Form.Controls.ControlSection;
		}
		interface tab_Email extends DevKit.Form.Controls.IControlTab {
		...
		interface tab_Attachments extends DevKit.Form.Controls.IControlTab {
			Section: tab_Attachments_Sections;
		}
		interface tab_EmailEngagementTab extends DevKit.Form.Controls.IControlTab {
			Section: tab_EmailEngagementTab_Sections;
		}
		interface Tabs {
			Email: tab_Email;
			Properties: tab_Properties;
			Attachments: tab_Attachments;
			EmailEngagementTab: tab_EmailEngagementTab;
		}
		interface Body {
			Tab: Tabs;
			attachmentsGrid: DevKit.Form.Controls.ControlGrid;
	...
	class FormEnhanced_Email extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormEnhanced_Email.Body;
	}
	...
	class FormEmail_Wizard extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyMokey.FormEmail_Wizard.Body;
		/** The Header section of form Email_Wizard */
		Header: LuckyMokey.FormEmail_Wizard.Header;
	}
	class EmailApi {
		/**
		...
		*/
		...
		/** Unique identifier of the object with which the e-mail is associated. */
		regardingobjectid_adobe_migratedrecord_email: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the e-mail is associated. */
		regardingobjectid_adobe_templatedocument_email: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the e-mail is associated. */
...
//{'JsForm':['Email','Email for Interactive experience','Enhanced Email','Wizard'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}