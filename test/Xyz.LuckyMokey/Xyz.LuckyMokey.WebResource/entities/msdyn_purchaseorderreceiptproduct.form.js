...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.Formmsdyn_purchaseorderreceiptproduct_Information = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormPurchase_Order_Receipt_Product_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	LuckyMokey.FormQuick_Create_Purchase_Order_Receipt_Product = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
