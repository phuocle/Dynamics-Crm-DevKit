...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quoteinvoicingsetupApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quoteinvoicingsetup) {
			var a = msdyn_quoteinvoicingsetup[field].a;
			var b = msdyn_quoteinvoicingsetup[field].b;
			var c = msdyn_quoteinvoicingsetup[field].c;
			var d = msdyn_quoteinvoicingsetup[field].d;
			var g = msdyn_quoteinvoicingsetup[field].g;
			var r = msdyn_quoteinvoicingsetup[field].r;
			msdyn_quoteinvoicingsetup[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quoteinvoicingsetup.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quoteinvoicingsetup.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
