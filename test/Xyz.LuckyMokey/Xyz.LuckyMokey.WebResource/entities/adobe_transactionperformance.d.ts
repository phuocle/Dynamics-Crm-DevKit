...
declare namespace LuckyMokey {
	...
	class adobe_transactionperformanceApi {
		/**
		* DynamicsCrm.DevKit adobe_transactionperformanceApi
		...
		*/
		...
		adobe_TransactionDuration: DevKit.WebApi.DecimalValue;
		/** Unique identifier for entity instances */
		adobe_transactionperformanceId: DevKit.WebApi.GuidValue;
		adobe_TransactionType: DevKit.WebApi.OptionSetValue;
		...
		/** Status of the Transaction Performance */
		statecode: DevKit.WebApi.OptionSetValue;
		/** Reason for the status of the Transaction Performance */
