...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_occhannelstateconfigurationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_occhannelstateconfiguration) {
			var a = msdyn_occhannelstateconfiguration[field].a;
			var b = msdyn_occhannelstateconfiguration[field].b;
			var c = msdyn_occhannelstateconfiguration[field].c;
			var d = msdyn_occhannelstateconfiguration[field].d;
			var g = msdyn_occhannelstateconfiguration[field].g;
			var r = msdyn_occhannelstateconfiguration[field].r;
			msdyn_occhannelstateconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_occhannelstateconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_occhannelstateconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
