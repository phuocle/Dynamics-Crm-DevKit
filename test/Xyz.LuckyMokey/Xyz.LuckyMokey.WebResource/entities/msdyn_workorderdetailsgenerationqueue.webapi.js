...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_workorderdetailsgenerationqueueApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_workorderdetailsgenerationqueue) {
			var a = msdyn_workorderdetailsgenerationqueue[field].a;
			var b = msdyn_workorderdetailsgenerationqueue[field].b;
			var c = msdyn_workorderdetailsgenerationqueue[field].c;
			var d = msdyn_workorderdetailsgenerationqueue[field].d;
			var g = msdyn_workorderdetailsgenerationqueue[field].g;
			var r = msdyn_workorderdetailsgenerationqueue[field].r;
			msdyn_workorderdetailsgenerationqueue[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_workorderdetailsgenerationqueue.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_workorderdetailsgenerationqueue.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
