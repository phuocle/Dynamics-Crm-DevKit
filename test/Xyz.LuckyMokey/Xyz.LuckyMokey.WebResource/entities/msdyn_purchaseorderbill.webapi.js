...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_purchaseorderbillApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_purchaseorderbill) {
			var a = msdyn_purchaseorderbill[field].a;
			var b = msdyn_purchaseorderbill[field].b;
			var c = msdyn_purchaseorderbill[field].c;
			var d = msdyn_purchaseorderbill[field].d;
			var g = msdyn_purchaseorderbill[field].g;
			var r = msdyn_purchaseorderbill[field].r;
			msdyn_purchaseorderbill[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_purchaseorderbill.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_purchaseorderbill.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
