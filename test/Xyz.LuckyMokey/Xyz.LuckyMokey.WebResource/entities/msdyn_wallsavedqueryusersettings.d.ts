...
declare namespace LuckyMokey {
	...
	class Formmsdyn_wallsavedqueryusersettings_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_wallsavedqueryusersettings_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_wallsavedqueryusersettings_Information.Body;
		/** The Footer section of form msdyn_wallsavedqueryusersettings_Information */
		Footer: LuckyMokey.Formmsdyn_wallsavedqueryusersettings_Information.Footer;
	}
