...
declare namespace LuckyMokey {
	...
	class Formmsdyn_wallsavedquery_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_wallsavedquery_Information.Body;
		/** The Footer section of form msdyn_wallsavedquery_Information */
		Footer: LuckyMokey.Formmsdyn_wallsavedquery_Information.Footer;
	}
}
