...
declare namespace LuckyMokey {
	...
	class Formmsdyn_occhannelstateconfiguration_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_occhannelstateconfiguration_Information.Body;
	}
}
