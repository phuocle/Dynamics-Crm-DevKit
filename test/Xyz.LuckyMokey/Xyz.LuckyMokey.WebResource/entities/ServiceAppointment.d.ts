...
declare namespace LuckyMokey {
	...
	class ServiceAppointmentApi {
		...
		*/
		...
		/** Unique identifier of the object with which the service activity is associated. */
		regardingobjectid_adobe_migratedrecord_serviceappointment: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the service activity is associated. */
		regardingobjectid_adobe_templatedocument_serviceappointment: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the service activity is associated. */
