...
declare namespace LuckyMokey {
	...
	class Formmsdyusd_scriptlet_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyusd_scriptlet_Information.Body;
		/** The Footer section of form msdyusd_scriptlet_Information */
		Footer: LuckyMokey.Formmsdyusd_scriptlet_Information.Footer;
	}
	class msdyusd_scriptletApi {
		/**
		* DynamicsCrm.DevKit msdyusd_scriptletApi
		...
		*/
		...
		msdyusd_scriptletId: DevKit.WebApi.GuidValue;
		msdyusd_ScriptText: DevKit.WebApi.StringValue;
		...
		/** Reason for the status of the ScriptLet */
