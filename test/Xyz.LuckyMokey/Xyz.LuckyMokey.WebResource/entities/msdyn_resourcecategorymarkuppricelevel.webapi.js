...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_resourcecategorymarkuppricelevelApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_resourcecategorymarkuppricelevel) {
			var a = msdyn_resourcecategorymarkuppricelevel[field].a;
			var b = msdyn_resourcecategorymarkuppricelevel[field].b;
			var c = msdyn_resourcecategorymarkuppricelevel[field].c;
			var d = msdyn_resourcecategorymarkuppricelevel[field].d;
			var g = msdyn_resourcecategorymarkuppricelevel[field].g;
			var r = msdyn_resourcecategorymarkuppricelevel[field].r;
			msdyn_resourcecategorymarkuppricelevel[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_resourcecategorymarkuppricelevel.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_resourcecategorymarkuppricelevel.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
