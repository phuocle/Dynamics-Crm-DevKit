...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_authenticationsettingsApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_authenticationsettings) {
			var a = msdyn_authenticationsettings[field].a;
			var b = msdyn_authenticationsettings[field].b;
			var c = msdyn_authenticationsettings[field].c;
			var d = msdyn_authenticationsettings[field].d;
			var g = msdyn_authenticationsettings[field].g;
			var r = msdyn_authenticationsettings[field].r;
			msdyn_authenticationsettings[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_authenticationsettings.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_authenticationsettings.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
