...
declare namespace LuckyMokey {
	namespace FormCampaign_Response {
		...
		interface tab_campaign_response_Sections {
			...
			received_from: DevKit.Form.Controls.ControlSection;
			description: DevKit.Form.Controls.ControlSection;
			details: DevKit.Form.Controls.ControlSection;
		}
		interface tab_campaign_response extends DevKit.Form.Controls.IControlTab {
		...
		interface Body {
			...
			Partner: DevKit.Form.Controls.ControlLookup;
			...
			PromotionCodeName: DevKit.Form.Controls.ControlString;
			/** Enter the date when the campaign response was received. */
			ReceivedOn: DevKit.Form.Controls.ControlDate;
			/** Choose the parent campaign so that the campaign's response rate is tracked correctly. */
			RegardingObjectId: DevKit.Form.Controls.ControlLookup;
			/** Select the type of response from the prospect or customer to indicate their interest in the campaign. */
			ResponseCode: DevKit.Form.Controls.ControlOptionSet;
			...
			Telephone: DevKit.Form.Controls.ControlString;
		}
	...
	class FormCampaign_Response extends DevKit.Form.IForm {
		...
		*/
		...
		Header: LuckyMokey.FormCampaign_Response.Header;
		/** The Navigation of form Campaign_Response */
		Navigation: LuckyMokey.FormCampaign_Response.Navigation;
	}
	namespace FormCampaign_Response {
...
//{'JsForm':['Campaign Response','Campaign Response'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}