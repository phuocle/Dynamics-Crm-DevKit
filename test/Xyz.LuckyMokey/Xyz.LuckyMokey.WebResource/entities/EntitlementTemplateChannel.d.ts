...
declare namespace LuckyMokey {
	...
	class FormEntitlement_Template_Channel extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form Entitlement_Template_Channel
		...
		*/
		...
		Body: LuckyMokey.FormEntitlement_Template_Channel.Body;
	}
}
...
//{'JsForm':['Entitlement Template Channel'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false}