...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.FormQuoteDetail_Information = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormQuoteDetail = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
