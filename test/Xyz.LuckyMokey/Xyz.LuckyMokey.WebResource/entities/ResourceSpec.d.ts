...
declare namespace LuckyMokey {
	...
	class FormResourceSpec_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form ResourceSpec_Information
		...
		*/
		...
		Body: LuckyMokey.FormResourceSpec_Information.Body;
	}
