...
declare namespace LuckyMokey {
	namespace Formmsdyusd_sessioninformation_Information {
		...
		interface Body {
			...
			msdyusd_Display: DevKit.Form.Controls.ControlString;
			...
			msdyusd_SelectedEntity: DevKit.Form.Controls.ControlLookup;
			msdyusd_type: DevKit.Form.Controls.ControlOptionSet;
			/** Owner Id */
	...
	class Formmsdyusd_sessioninformation_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyusd_sessioninformation_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyusd_sessioninformation_Information.Body;
		/** The Footer section of form msdyusd_sessioninformation_Information */
		Footer: LuckyMokey.Formmsdyusd_sessioninformation_Information.Footer;
	}
	class msdyusd_sessioninformationApi {
		...
		*/
		...
		msdyusd_Display: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyusd_name: DevKit.WebApi.StringValue;
		msdyusd_Order: DevKit.WebApi.IntegerValue;
		/** Unique identifier for Entity Numeric Mapping associated with Session Information. */
		msdyusd_SelectedEntity: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyusd_sessioninformationId: DevKit.WebApi.GuidValue;
		msdyusd_type: DevKit.WebApi.OptionSetValue;
