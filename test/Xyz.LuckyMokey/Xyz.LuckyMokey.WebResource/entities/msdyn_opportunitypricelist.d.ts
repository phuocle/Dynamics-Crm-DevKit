...
declare namespace LuckyMokey {
	namespace Formmsdyn_opportunitypricelist_Information {
		...
		interface Body {
			...
			msdyn_Opportunity: DevKit.Form.Controls.ControlLookup;
	...
	class Formmsdyn_opportunitypricelist_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_opportunitypricelist_Information.Body;
	}
