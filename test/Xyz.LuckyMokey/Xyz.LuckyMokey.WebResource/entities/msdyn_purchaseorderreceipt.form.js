...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.FormPurchase_Order_Receipt = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormPurchase_Order_Receipt_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
