...
declare namespace LuckyMokey {
	namespace Formmsfp_questionresponse_Information {
		...
		interface Body {
			...
			msfp_keyphrases: DevKit.Form.Controls.ControlString;
			/** The name of the custom entity. */
			msfp_name: DevKit.Form.Controls.ControlString;
			/** Question associated with the question response. */
			msfp_questionid: DevKit.Form.Controls.ControlLookup;
			/** Question response value as string. */
			msfp_response: DevKit.Form.Controls.ControlString;
			/** Sentiment of the question response. */
			msfp_Sentimentvalue: DevKit.Form.Controls.ControlDecimal;
			/** Survey response associated with the question response. */
			msfp_surveyresponseid: DevKit.Form.Controls.ControlLookup;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsfp_questionresponse_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsfp_questionresponse_Information.Body;
	}
