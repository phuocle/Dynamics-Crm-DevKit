...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_ocliveworkitemcharacteristicApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocliveworkitemcharacteristic) {
			var a = msdyn_ocliveworkitemcharacteristic[field].a;
			var b = msdyn_ocliveworkitemcharacteristic[field].b;
			var c = msdyn_ocliveworkitemcharacteristic[field].c;
			var d = msdyn_ocliveworkitemcharacteristic[field].d;
			var g = msdyn_ocliveworkitemcharacteristic[field].g;
			var r = msdyn_ocliveworkitemcharacteristic[field].r;
			msdyn_ocliveworkitemcharacteristic[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocliveworkitemcharacteristic.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocliveworkitemcharacteristic.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
