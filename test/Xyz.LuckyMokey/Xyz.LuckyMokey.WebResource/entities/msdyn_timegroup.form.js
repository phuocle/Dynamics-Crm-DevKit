...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.Formmsdyn_timegroup_Information = function(executionContext, defaultWebResourceName) {
		...
		var navigation = {
			nav_msdyn_msdyn_timegroup_msdyn_timegroupdetail: {},
			navProcessSessions: {}
		};
	...
	LuckyMokey.FormFulfillment_Preference_Quick_Create_Form = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
