...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.Formmsdyn_agreement_Agreement = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormAgreement_Mobile = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
