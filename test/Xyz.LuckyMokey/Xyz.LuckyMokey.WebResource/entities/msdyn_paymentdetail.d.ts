...
declare namespace LuckyMokey {
	namespace Formmsdyn_paymentdetail_Information {
		...
		interface Body {
			...
			msdyn_Payment: DevKit.Form.Controls.ControlLookup;
			msdyn_PaymentAmount: DevKit.Form.Controls.ControlMoney;
			/** Owner Id */
	...
	class Formmsdyn_paymentdetail_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_paymentdetail_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_paymentdetail_Information.Body;
		/** The Footer section of form msdyn_paymentdetail_Information */
		Footer: LuckyMokey.Formmsdyn_paymentdetail_Information.Footer;
		/** The Navigation of form msdyn_paymentdetail_Information */
		Navigation: LuckyMokey.Formmsdyn_paymentdetail_Information.Navigation;
	}
