...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.FormOpportunityProduct_Information = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormOpportunityProduct = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
