...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.FormOpportunity_AI_for_Sales = function(executionContext, defaultWebResourceName) {
	...
	LuckyMokey.FormOpportunity = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
