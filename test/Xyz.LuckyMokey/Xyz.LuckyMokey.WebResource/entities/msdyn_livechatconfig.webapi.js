...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_livechatconfigApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_livechatconfig) {
			var a = msdyn_livechatconfig[field].a;
			var b = msdyn_livechatconfig[field].b;
			var c = msdyn_livechatconfig[field].c;
			var d = msdyn_livechatconfig[field].d;
			var g = msdyn_livechatconfig[field].g;
			var r = msdyn_livechatconfig[field].r;
			msdyn_livechatconfig[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_livechatconfig.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_livechatconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
