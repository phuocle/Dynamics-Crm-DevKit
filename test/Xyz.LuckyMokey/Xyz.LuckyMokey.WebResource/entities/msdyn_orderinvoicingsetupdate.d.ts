...
declare namespace LuckyMokey {
	...
	class Formmsdyn_orderinvoicingsetupdate_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_orderinvoicingsetupdate_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_orderinvoicingsetupdate_Information.Body;
	}
	namespace Formmsdyn_orderinvoicingsetupdate_Information {
		interface Tabs {
		}
