...
declare namespace LuckyMokey {
	...
	class Formmsdyn_incidenttypecharacteristic_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_incidenttypecharacteristic_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_incidenttypecharacteristic_Information.Body;
		/** The Footer section of form msdyn_incidenttypecharacteristic_Information */
		Footer: LuckyMokey.Formmsdyn_incidenttypecharacteristic_Information.Footer;
		/** The Navigation of form msdyn_incidenttypecharacteristic_Information */
		Navigation: LuckyMokey.Formmsdyn_incidenttypecharacteristic_Information.Navigation;
	}
	class msdyn_incidenttypecharacteristicApi {
		...
		*/
		...
		msdyn_incidenttypecharacteristicId: DevKit.WebApi.GuidValue;
		/** Enter the name of the custom entity. */
