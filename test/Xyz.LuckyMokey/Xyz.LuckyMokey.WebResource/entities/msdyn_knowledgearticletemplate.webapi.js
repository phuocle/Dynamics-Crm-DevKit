...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_knowledgearticletemplateApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_knowledgearticletemplate) {
			var a = msdyn_knowledgearticletemplate[field].a;
			var b = msdyn_knowledgearticletemplate[field].b;
			var c = msdyn_knowledgearticletemplate[field].c;
			var d = msdyn_knowledgearticletemplate[field].d;
			var g = msdyn_knowledgearticletemplate[field].g;
			var r = msdyn_knowledgearticletemplate[field].r;
			msdyn_knowledgearticletemplate[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_knowledgearticletemplate.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_knowledgearticletemplate.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
