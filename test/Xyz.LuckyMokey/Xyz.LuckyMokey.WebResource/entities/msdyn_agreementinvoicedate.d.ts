...
declare namespace LuckyMokey {
	namespace Formmsdyn_agreementinvoicedate_Information {
		...
		interface Body {
			...
			msdyn_InvoiceSetup: DevKit.Form.Controls.ControlLookup;
	...
	class Formmsdyn_agreementinvoicedate_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_agreementinvoicedate_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_agreementinvoicedate_Information.Body;
		/** The Footer section of form msdyn_agreementinvoicedate_Information */
		Footer: LuckyMokey.Formmsdyn_agreementinvoicedate_Information.Footer;
		/** The Navigation of form msdyn_agreementinvoicedate_Information */
		Navigation: LuckyMokey.Formmsdyn_agreementinvoicedate_Information.Navigation;
	}
	class msdyn_agreementinvoicedateApi {
		...
		*/
		...
		msdyn_agreementinvoicedateId: DevKit.WebApi.GuidValue;
