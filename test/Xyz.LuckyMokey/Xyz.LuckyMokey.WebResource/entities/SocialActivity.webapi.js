...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.SocialActivityApi = function (e) {
		var EMPTY_STRING = '';
		...
		var socialactivity = {
			...
			regardingobjectid_adobe_migratedrecord_socialactivity: { b: 'regardingobjectid_adobe_migratedrecord_socialactivity', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_socialactivity: { b: 'regardingobjectid_adobe_templatedocument_socialactivity', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
