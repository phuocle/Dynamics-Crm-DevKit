...
declare namespace LuckyMokey {
	...
	class Formmsdyn_quotelineanalyticsbreakdown_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_quotelineanalyticsbreakdown_Information
