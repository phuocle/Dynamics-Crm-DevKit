...
declare namespace LuckyMokey {
	namespace FormOpportunitySalesProcesses {
		interface tab_general_Sections {
			opportunitysalesprocessinformation: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormOpportunitySalesProcesses extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormOpportunitySalesProcesses.Body;
	}
...
//{'JsForm':['OpportunitySalesProcesses'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}