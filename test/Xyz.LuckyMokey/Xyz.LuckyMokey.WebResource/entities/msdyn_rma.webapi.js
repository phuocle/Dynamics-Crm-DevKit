...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_rmaApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_rma) {
			var a = msdyn_rma[field].a;
			var b = msdyn_rma[field].b;
			var c = msdyn_rma[field].c;
			var d = msdyn_rma[field].d;
			var g = msdyn_rma[field].g;
			var r = msdyn_rma[field].r;
			msdyn_rma[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		msdyn_rma.Entity = u;
		msdyn_rma.EntityName = 'msdyn_rma';
		msdyn_rma.EntityCollectionName = 'msdyn_rmas';
		msdyn_rma['@odata.etag'] = e['@odata.etag'];
		msdyn_rma.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_rma.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
