...
declare namespace LuckyMokey {
	namespace Formmsdyusd_customizationfiles_Information {
		...
		interface Body {
			IFRAME_CustomizationFiles: DevKit.Form.Controls.ControlIFrame;
			/** Type the version number of the customization file. This number is used to identify customization files for updates. */
			msdyusd_CustomizationVersion: DevKit.Form.Controls.ControlString;
	...
	class Formmsdyusd_customizationfiles_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyusd_customizationfiles_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyusd_customizationfiles_Information.Body;
	}
	class msdyusd_customizationfilesApi {
		...
		*/
		...
		/** Customization Files */
		msdyusd_customizationfilesId: DevKit.WebApi.GuidValue;
		/** Type the version number of the customization file. This number is used to identify customization files for updates. */
		msdyusd_CustomizationVersion: DevKit.WebApi.StringValue;
		/** Type a description for the customization file. */
