...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.LetterApi = function (e) {
		var EMPTY_STRING = '';
		...
		var letter = {
			...
			regardingobjectid_adobe_migratedrecord_letter: { b: 'regardingobjectid_adobe_migratedrecord_letter', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_letter: { b: 'regardingobjectid_adobe_templatedocument_letter', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
