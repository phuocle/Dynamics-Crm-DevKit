...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_purchaseorderreceiptproductApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_purchaseorderreceiptproduct) {
			var a = msdyn_purchaseorderreceiptproduct[field].a;
			var b = msdyn_purchaseorderreceiptproduct[field].b;
			var c = msdyn_purchaseorderreceiptproduct[field].c;
			var d = msdyn_purchaseorderreceiptproduct[field].d;
			var g = msdyn_purchaseorderreceiptproduct[field].g;
			var r = msdyn_purchaseorderreceiptproduct[field].r;
			msdyn_purchaseorderreceiptproduct[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_purchaseorderreceiptproduct.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_purchaseorderreceiptproduct.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
