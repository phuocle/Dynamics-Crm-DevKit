...
declare namespace LuckyMokey {
	...
	class Formmsdyn_suggestedactivitydatasource_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_suggestedactivitydatasource_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_suggestedactivitydatasource_Information.Body;
	}
	namespace Formmsdyn_suggestedactivitydatasource_Information {
		interface Tabs {
		}
	...
	class msdyn_suggestedactivitydatasourceApi {
		...
		*/
		...
		msdyn_suggestedactivitydatasourceId: DevKit.WebApi.GuidValue;
	}
}
