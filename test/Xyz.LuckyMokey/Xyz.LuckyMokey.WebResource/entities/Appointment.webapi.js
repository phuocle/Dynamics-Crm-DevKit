...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.AppointmentApi = function (e) {
		var EMPTY_STRING = '';
		...
		var appointment = {
			...
			regardingobjectid_adobe_migratedrecord_appointment: { b: 'regardingobjectid_adobe_migratedrecord_appointment', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_appointment: { b: 'regardingobjectid_adobe_templatedocument_appointment', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
