...
declare namespace LuckyMokey {
	...
	class msdyn_ocsessionApi {
		...
		*/
		...
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_adobe_migratedrecord_msdyn_ocsession: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_adobe_templatedocument_msdyn_ocsession: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
...
//{'JsForm':['Omnichannel session form'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}