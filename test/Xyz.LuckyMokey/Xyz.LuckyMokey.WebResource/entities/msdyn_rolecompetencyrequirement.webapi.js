...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_rolecompetencyrequirementApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_rolecompetencyrequirement) {
			var a = msdyn_rolecompetencyrequirement[field].a;
			var b = msdyn_rolecompetencyrequirement[field].b;
			var c = msdyn_rolecompetencyrequirement[field].c;
			var d = msdyn_rolecompetencyrequirement[field].d;
			var g = msdyn_rolecompetencyrequirement[field].g;
			var r = msdyn_rolecompetencyrequirement[field].r;
			msdyn_rolecompetencyrequirement[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_rolecompetencyrequirement.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_rolecompetencyrequirement.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
