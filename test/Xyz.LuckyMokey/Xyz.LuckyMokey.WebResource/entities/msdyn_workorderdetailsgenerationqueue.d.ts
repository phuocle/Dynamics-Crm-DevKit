...
declare namespace LuckyMokey {
	namespace Formmsdyn_workorderdetailsgenerationqueue_Information {
		...
		interface Body {
			...
			msdyn_Processed: DevKit.Form.Controls.ControlBoolean;
			msdyn_WorkOrderDetails: DevKit.Form.Controls.ControlString;
		}
		interface Footer {
	...
	class Formmsdyn_workorderdetailsgenerationqueue_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_workorderdetailsgenerationqueue_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_workorderdetailsgenerationqueue_Information.Body;
		/** The Footer section of form msdyn_workorderdetailsgenerationqueue_Information */
		Footer: LuckyMokey.Formmsdyn_workorderdetailsgenerationqueue_Information.Footer;
		/** The Navigation of form msdyn_workorderdetailsgenerationqueue_Information */
		Navigation: LuckyMokey.Formmsdyn_workorderdetailsgenerationqueue_Information.Navigation;
	}
	class msdyn_workorderdetailsgenerationqueueApi {
		...
		*/
		...
		msdyn_Booking: DevKit.WebApi.StringValue;
		msdyn_ExceptionMessage: DevKit.WebApi.StringValue;
		msdyn_ExceptionTrace: DevKit.WebApi.StringValue;
		/** Enter the name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_Processed: DevKit.WebApi.BooleanValue;
		msdyn_SchDateOwnerId: DevKit.WebApi.StringValue;
		msdyn_WorkOrderDetails: DevKit.WebApi.StringValue;
		/** Shows the entity instances. */
		msdyn_workorderdetailsgenerationqueueId: DevKit.WebApi.GuidValue;
		msdyn_WorkorderId: DevKit.WebApi.StringValue;
