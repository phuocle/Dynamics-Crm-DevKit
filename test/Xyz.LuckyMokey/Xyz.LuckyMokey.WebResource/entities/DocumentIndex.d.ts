...
declare namespace LuckyMokey {
	namespace FormDocumentIndex_Information {
		interface tab_general_Sections {
			document_index: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormDocumentIndex_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormDocumentIndex_Information.Body;
	}
