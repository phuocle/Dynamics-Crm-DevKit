...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotebookingincidentApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotebookingincident) {
			var a = msdyn_quotebookingincident[field].a;
			var b = msdyn_quotebookingincident[field].b;
			var c = msdyn_quotebookingincident[field].c;
			var d = msdyn_quotebookingincident[field].d;
			var g = msdyn_quotebookingincident[field].g;
			var r = msdyn_quotebookingincident[field].r;
			msdyn_quotebookingincident[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotebookingincident.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotebookingincident.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
