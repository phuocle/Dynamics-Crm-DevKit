...
declare namespace LuckyMokey {
	namespace Formmsdyn_orderinvoicingdate_Information {
		...
		interface Navigation {
			nav_msdyn_msdyn_orderinvoicingdate_msdyn_orderinvoicingsetupdate_OrderInvoicingDate: DevKit.Form.Controls.ControlNavigationItem
		}
	}
	class Formmsdyn_orderinvoicingdate_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_orderinvoicingdate_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_orderinvoicingdate_Information.Body;
		/** The Navigation of form msdyn_orderinvoicingdate_Information */
		Navigation: LuckyMokey.Formmsdyn_orderinvoicingdate_Information.Navigation;
	}
	namespace Formmsdyn_orderinvoicingdate_Information {
		interface Tabs {
		}
