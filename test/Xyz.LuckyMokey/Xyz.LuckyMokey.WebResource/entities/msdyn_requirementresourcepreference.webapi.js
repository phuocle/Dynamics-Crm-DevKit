...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_requirementresourcepreferenceApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_requirementresourcepreference) {
			var a = msdyn_requirementresourcepreference[field].a;
			var b = msdyn_requirementresourcepreference[field].b;
			var c = msdyn_requirementresourcepreference[field].c;
			var d = msdyn_requirementresourcepreference[field].d;
			var g = msdyn_requirementresourcepreference[field].g;
			var r = msdyn_requirementresourcepreference[field].r;
			msdyn_requirementresourcepreference[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_requirementresourcepreference.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_requirementresourcepreference.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
