...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_smsnumberApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_smsnumber) {
			var a = msdyn_smsnumber[field].a;
			var b = msdyn_smsnumber[field].b;
			var c = msdyn_smsnumber[field].c;
			var d = msdyn_smsnumber[field].d;
			var g = msdyn_smsnumber[field].g;
			var r = msdyn_smsnumber[field].r;
			msdyn_smsnumber[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_smsnumber.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_smsnumber.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
