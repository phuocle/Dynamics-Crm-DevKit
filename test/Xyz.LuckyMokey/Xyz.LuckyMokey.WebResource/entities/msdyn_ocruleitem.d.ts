...
declare namespace LuckyMokey {
	namespace Formmsdyn_ocruleitem_Information {
		...
		interface Body {
			...
			/** Assigned Queue Id */
			msdyn_cdsqueueassignid: DevKit.Form.Controls.ControlLookup;
	...
	class Formmsdyn_ocruleitem_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocruleitem_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_ocruleitem_Information.Body;
		/** The Header section of form msdyn_ocruleitem_Information */
		Header: LuckyMokey.Formmsdyn_ocruleitem_Information.Header;
	}
}
