/** DynamicsCrm.DevKit for namespace LuckyMokey */
...
declare namespace WebApiClient {
     ...
     * @param request the LuckyMokey.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: LuckyMokey.WebApi.RetrieveRequest): RetrieveResponse;
    /**
     * Retrieves records from CRM (async = false).
     * @param request the LuckyMokey.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: LuckyMokey.WebApi.RetrieveRequest): void;
    /**
     * Creates a given record in CRM (async = true).
     * @param request The LuckyMokey.WebApi.CreateRequest object.
     */
    function Create(request: LuckyMokey.WebApi.CreateRequest): CreateResponse;
    /**
     * Creates a given record in CRM (async = false).
     * @param request The LuckyMokey.WebApi.CreateRequest object.
     */
    function Create(request: LuckyMokey.WebApi.CreateRequest): void;
    /**
     * Updates a given record in CRM (async = true).
     * @param request the LuckyMokey.WebApi.UpdateRequest object.
     */
    function Update(request: LuckyMokey.WebApi.UpdateRequest): UpdateResponse;
    /**
     * Updates a given record in CRM (async = false).
     * @param request the LuckyMokey.WebApi.UpdateRequest object.
     */
    function Update(request: LuckyMokey.WebApi.UpdateRequest): void;
    /**
     * Deletes a given record in CRM (async = true).
     * @param request the LuckyMokey.WebApi.DeleteRequest object.
     */
    function Delete(request: LuckyMokey.WebApi.DeleteRequest): DeleteResponse;
    /**
     * Deletes a given record in CRM (async = false).
     * @param request the LuckyMokey.WebApi.DeleteRequest object.
     */
    function Delete(request: LuckyMokey.WebApi.DeleteRequest): void;
    /**
     * Associates given records in CRM (async = true).
     * @param request the LuckyMokey.WebApi.AssociateRequest object.
     */
    function Associate(request: LuckyMokey.WebApi.AssociateRequest): AssociateResponse;
    /**
     * Associates given records in CRM (async = false).
     * @param request the LuckyMokey.WebApi.AssociateRequest object.
     */
    function Associate(request: LuckyMokey.WebApi.AssociateRequest): void;
    /**
     * Disassociates given records in CRM (async = true).
     * @param request the LuckyMokey.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: LuckyMokey.WebApi.DisassociateRequest): DisassociateResponse;
    /**
     * Disassociates given records in CRM (async = false).
     * @param request the LuckyMokey.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: LuckyMokey.WebApi.DisassociateRequest): void;
    /**
