...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_opportunitylinetransactionApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_opportunitylinetransaction) {
			var a = msdyn_opportunitylinetransaction[field].a;
			var b = msdyn_opportunitylinetransaction[field].b;
			var c = msdyn_opportunitylinetransaction[field].c;
			var d = msdyn_opportunitylinetransaction[field].d;
			var g = msdyn_opportunitylinetransaction[field].g;
			var r = msdyn_opportunitylinetransaction[field].r;
			msdyn_opportunitylinetransaction[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_opportunitylinetransaction.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_opportunitylinetransaction.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
