...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_approvalApi = function (e) {
		var EMPTY_STRING = '';
		...
		var msdyn_approval = {
			...
			regardingobjectid_adobe_migratedrecord_msdyn_approval: { b: 'regardingobjectid_adobe_migratedrecord_msdyn_approval', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_msdyn_approval: { b: 'regardingobjectid_adobe_templatedocument_msdyn_approval', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
