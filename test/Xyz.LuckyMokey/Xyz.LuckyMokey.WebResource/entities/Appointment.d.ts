...
declare namespace LuckyMokey {
	...
	class AppointmentApi {
		...
		*/
		...
		/** Unique identifier of the object with which the appointment is associated. */
		regardingobjectid_adobe_migratedrecord_appointment: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the appointment is associated. */
		regardingobjectid_adobe_templatedocument_appointment: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the appointment is associated. */
