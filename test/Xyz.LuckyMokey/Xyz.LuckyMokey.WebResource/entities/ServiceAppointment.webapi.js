...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.ServiceAppointmentApi = function (e) {
		var EMPTY_STRING = '';
		...
		var serviceappointment = {
			...
			regardingobjectid_adobe_migratedrecord_serviceappointment: { b: 'regardingobjectid_adobe_migratedrecord_serviceappointment', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_serviceappointment: { b: 'regardingobjectid_adobe_templatedocument_serviceappointment', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
