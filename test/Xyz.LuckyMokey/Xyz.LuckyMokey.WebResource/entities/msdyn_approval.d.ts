...
declare namespace LuckyMokey {
	...
	class msdyn_approvalApi {
		...
		*/
		...
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_adobe_migratedrecord_msdyn_approval: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
		regardingobjectid_adobe_templatedocument_msdyn_approval: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the activity is associated. */
