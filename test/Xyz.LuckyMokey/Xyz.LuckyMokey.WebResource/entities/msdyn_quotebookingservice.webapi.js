...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotebookingserviceApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotebookingservice) {
			var a = msdyn_quotebookingservice[field].a;
			var b = msdyn_quotebookingservice[field].b;
			var c = msdyn_quotebookingservice[field].c;
			var d = msdyn_quotebookingservice[field].d;
			var g = msdyn_quotebookingservice[field].g;
			var r = msdyn_quotebookingservice[field].r;
			msdyn_quotebookingservice[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotebookingservice.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotebookingservice.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
