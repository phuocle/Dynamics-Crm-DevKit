...
declare namespace LuckyMokey {
	...
	class Formmsdyn_timeoffrequest_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_timeoffrequest_Information.Body;
		/** The Footer section of form msdyn_timeoffrequest_Information */
		Footer: LuckyMokey.Formmsdyn_timeoffrequest_Information.Footer;
		/** The Navigation of form msdyn_timeoffrequest_Information */
		Navigation: LuckyMokey.Formmsdyn_timeoffrequest_Information.Navigation;
	}
	...
	class FormTime_Off_Request_Mobile extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormTime_Off_Request_Mobile.Body;
		/** The Navigation of form Time_Off_Request_Mobile */
		Navigation: LuckyMokey.FormTime_Off_Request_Mobile.Navigation;
	}
}
...
//{'JsForm':['Information','Time Off Request - Mobile'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false}