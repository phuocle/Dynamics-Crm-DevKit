...
declare namespace LuckyMokey {
	...
	class PhoneCallApi {
		...
		*/
		...
		/** Unique identifier of the object with which the phone call activity is associated. */
		regardingobjectid_adobe_migratedrecord_phonecall: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the phone call activity is associated. */
		regardingobjectid_adobe_templatedocument_phonecall: DevKit.WebApi.LookupValue;
		/** Unique identifier of the object with which the phone call activity is associated. */
