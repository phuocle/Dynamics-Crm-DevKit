...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_ocsessionApi = function (e) {
		var EMPTY_STRING = '';
		...
		var msdyn_ocsession = {
			...
			regardingobjectid_adobe_migratedrecord_msdyn_ocsession: { b: 'regardingobjectid_adobe_migratedrecord_msdyn_ocsession', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_msdyn_ocsession: { b: 'regardingobjectid_adobe_templatedocument_msdyn_ocsession', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocsession) {
			var a = msdyn_ocsession[field].a;
			var b = msdyn_ocsession[field].b;
			var c = msdyn_ocsession[field].c;
			var d = msdyn_ocsession[field].d;
			var g = msdyn_ocsession[field].g;
			var r = msdyn_ocsession[field].r;
			msdyn_ocsession[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocsession.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocsession.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
