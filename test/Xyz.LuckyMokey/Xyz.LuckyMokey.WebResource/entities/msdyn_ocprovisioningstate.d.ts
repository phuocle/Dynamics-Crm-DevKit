...
declare namespace LuckyMokey {
	namespace Formmsdyn_ocprovisioningstate_Information {
		...
		interface Body {
			...
			msdyn_exceptiondetails: DevKit.Form.Controls.ControlString;
			/** Reason for the status of the Provisioning State */
			statuscode: DevKit.Form.Controls.ControlOptionSet;
		}
	}
	class Formmsdyn_ocprovisioningstate_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_ocprovisioningstate_Information.Body;
	}
}
