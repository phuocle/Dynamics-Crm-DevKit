...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.EmailApi = function (e) {
		var EMPTY_STRING = '';
		...
		var email = {
			...
			regardingobjectid_adobe_migratedrecord_email: { b: 'regardingobjectid_adobe_migratedrecord_email', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_email: { b: 'regardingobjectid_adobe_templatedocument_email', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
