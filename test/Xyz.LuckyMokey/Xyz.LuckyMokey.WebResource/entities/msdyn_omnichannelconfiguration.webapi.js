...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_omnichannelconfigurationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_omnichannelconfiguration) {
			var a = msdyn_omnichannelconfiguration[field].a;
			var b = msdyn_omnichannelconfiguration[field].b;
			var c = msdyn_omnichannelconfiguration[field].c;
			var d = msdyn_omnichannelconfiguration[field].d;
			var g = msdyn_omnichannelconfiguration[field].g;
			var r = msdyn_omnichannelconfiguration[field].r;
			msdyn_omnichannelconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_omnichannelconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_omnichannelconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
