...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.RecurringAppointmentMasterApi = function (e) {
		var EMPTY_STRING = '';
		...
		var recurringappointmentmaster = {
			...
			regardingobjectid_adobe_migratedrecord_recurringappointmentmaster: { b: 'regardingobjectid_adobe_migratedrecord_recurringappointmentmaster', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_recurringappointmentmaster: { b: 'regardingobjectid_adobe_templatedocument_recurringappointmentmaster', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
