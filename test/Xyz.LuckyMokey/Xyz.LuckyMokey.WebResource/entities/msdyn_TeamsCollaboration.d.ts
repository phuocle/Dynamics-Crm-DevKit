...
declare namespace LuckyMokey {
	...
	class Formmsdyn_TeamsCollaboration_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_TeamsCollaboration_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_TeamsCollaboration_Information.Body;
	}
	class msdyn_TeamsCollaborationApi {
		...
		*/
		...
		msdyn_AppId: DevKit.WebApi.StringValue;
		...
		msdyn_channelType: DevKit.WebApi.StringValue;
		/** Collaboration tab content url */
		msdyn_ContentUrl: DevKit.WebApi.StringValue;
		...
		msdyn_pipedEntityId: DevKit.WebApi.StringValue;
		...
		msdyn_WebUrl: DevKit.WebApi.StringValue;
