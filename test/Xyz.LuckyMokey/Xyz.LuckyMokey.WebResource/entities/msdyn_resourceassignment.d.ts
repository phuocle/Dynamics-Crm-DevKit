...
declare namespace LuckyMokey {
	...
	class Formmsdyn_resourceassignment_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_resourceassignment_Information.Body;
	}
	class msdyn_resourceassignmentApi {
		...
		*/
		...
		/** Select the user whose capacity is assigned (Deprecated in v3.0). */
