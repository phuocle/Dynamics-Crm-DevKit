...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_transactioncategorypricelevelApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_transactioncategorypricelevel) {
			var a = msdyn_transactioncategorypricelevel[field].a;
			var b = msdyn_transactioncategorypricelevel[field].b;
			var c = msdyn_transactioncategorypricelevel[field].c;
			var d = msdyn_transactioncategorypricelevel[field].d;
			var g = msdyn_transactioncategorypricelevel[field].g;
			var r = msdyn_transactioncategorypricelevel[field].r;
			msdyn_transactioncategorypricelevel[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_transactioncategorypricelevel.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_transactioncategorypricelevel.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
