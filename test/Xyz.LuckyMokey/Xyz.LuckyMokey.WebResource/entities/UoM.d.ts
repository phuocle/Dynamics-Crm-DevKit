...
declare namespace LuckyMokey {
	namespace FormUoM_Information {
		interface tab_general_Sections {
			unit_of_measure_information: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormUoM_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.FormUoM_Information.Body;
	}
}
