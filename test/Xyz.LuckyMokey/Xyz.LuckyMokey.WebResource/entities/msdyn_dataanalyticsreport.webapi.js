...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_dataanalyticsreportApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_dataanalyticsreport) {
			var a = msdyn_dataanalyticsreport[field].a;
			var b = msdyn_dataanalyticsreport[field].b;
			var c = msdyn_dataanalyticsreport[field].c;
			var d = msdyn_dataanalyticsreport[field].d;
			var g = msdyn_dataanalyticsreport[field].g;
			var r = msdyn_dataanalyticsreport[field].r;
			msdyn_dataanalyticsreport[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_dataanalyticsreport.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_dataanalyticsreport.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
