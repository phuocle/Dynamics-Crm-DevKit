...
declare namespace LuckyMokey {
	namespace Formmsdyn_ocliveworkstreamcontextvariable_Information {
		...
		interface Body {
			msdyn_datatype: DevKit.Form.Controls.ControlOptionSet;
	...
	class Formmsdyn_ocliveworkstreamcontextvariable_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_ocliveworkstreamcontextvariable_Information.Body;
	}
	namespace Formmsdyn_ocliveworkstreamcontextvariable_Information {
