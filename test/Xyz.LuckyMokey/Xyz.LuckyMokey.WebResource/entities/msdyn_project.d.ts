...
declare namespace LuckyMokey {
	...
	class msdyn_projectApi {
		...
		*/
		...
		/** Shows the actual sales value. System Field - For PSA Use Only. */
		msdyn_ActualSales: DevKit.WebApi.MoneyValue;
		/** Shows the value of the actual sales in the base currency. System Field - For PSA Use Only. */
		...
		/** Shows the actual cost divided by the estimated cost at completion. System Field - For PSA Use Only. */
		msdyn_CostConsumption: DevKit.WebApi.DecimalValueReadonly;
		...
		/** Shows the total planned sales. System Field - For PSA Use Only. */
		msdyn_PlannedSales: DevKit.WebApi.MoneyValue;
		/** Shows the value of the planned sales in the base currency. System Field - For PSA Use Only. */
...
//{'JsForm':['Create Project','Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}