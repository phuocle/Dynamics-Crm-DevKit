...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_orderinvoicingdateApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_orderinvoicingdate) {
			var a = msdyn_orderinvoicingdate[field].a;
			var b = msdyn_orderinvoicingdate[field].b;
			var c = msdyn_orderinvoicingdate[field].c;
			var d = msdyn_orderinvoicingdate[field].d;
			var g = msdyn_orderinvoicingdate[field].g;
			var r = msdyn_orderinvoicingdate[field].r;
			msdyn_orderinvoicingdate[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_orderinvoicingdate.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_orderinvoicingdate.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
