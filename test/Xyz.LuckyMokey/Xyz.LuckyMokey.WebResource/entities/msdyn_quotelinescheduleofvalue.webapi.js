...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotelinescheduleofvalueApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotelinescheduleofvalue) {
			var a = msdyn_quotelinescheduleofvalue[field].a;
			var b = msdyn_quotelinescheduleofvalue[field].b;
			var c = msdyn_quotelinescheduleofvalue[field].c;
			var d = msdyn_quotelinescheduleofvalue[field].d;
			var g = msdyn_quotelinescheduleofvalue[field].g;
			var r = msdyn_quotelinescheduleofvalue[field].r;
			msdyn_quotelinescheduleofvalue[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotelinescheduleofvalue.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotelinescheduleofvalue.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
