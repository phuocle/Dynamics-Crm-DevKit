...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_sessionparticipantApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_sessionparticipant) {
			var a = msdyn_sessionparticipant[field].a;
			var b = msdyn_sessionparticipant[field].b;
			var c = msdyn_sessionparticipant[field].c;
			var d = msdyn_sessionparticipant[field].d;
			var g = msdyn_sessionparticipant[field].g;
			var r = msdyn_sessionparticipant[field].r;
			msdyn_sessionparticipant[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sessionparticipant.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_sessionparticipant.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
