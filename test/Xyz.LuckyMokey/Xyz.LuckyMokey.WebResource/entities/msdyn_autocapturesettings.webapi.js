...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_autocapturesettingsApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_autocapturesettings) {
			var a = msdyn_autocapturesettings[field].a;
			var b = msdyn_autocapturesettings[field].b;
			var c = msdyn_autocapturesettings[field].c;
			var d = msdyn_autocapturesettings[field].d;
			var g = msdyn_autocapturesettings[field].g;
			var r = msdyn_autocapturesettings[field].r;
			msdyn_autocapturesettings[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_autocapturesettings.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_autocapturesettings.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
