...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_agreementbookingserviceApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_agreementbookingservice) {
			var a = msdyn_agreementbookingservice[field].a;
			var b = msdyn_agreementbookingservice[field].b;
			var c = msdyn_agreementbookingservice[field].c;
			var d = msdyn_agreementbookingservice[field].d;
			var g = msdyn_agreementbookingservice[field].g;
			var r = msdyn_agreementbookingservice[field].r;
			msdyn_agreementbookingservice[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementbookingservice.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_agreementbookingservice.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
