...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_paymentApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_payment) {
			var a = msdyn_payment[field].a;
			var b = msdyn_payment[field].b;
			var c = msdyn_payment[field].c;
			var d = msdyn_payment[field].d;
			var g = msdyn_payment[field].g;
			var r = msdyn_payment[field].r;
			msdyn_payment[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_payment.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_payment.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
