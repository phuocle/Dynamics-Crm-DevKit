...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_factApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_fact) {
			var a = msdyn_fact[field].a;
			var b = msdyn_fact[field].b;
			var c = msdyn_fact[field].c;
			var d = msdyn_fact[field].d;
			var g = msdyn_fact[field].g;
			var r = msdyn_fact[field].r;
			msdyn_fact[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		msdyn_fact.Entity = u;
		msdyn_fact.EntityName = 'msdyn_fact';
		msdyn_fact.EntityCollectionName = 'msdyn_facts';
		msdyn_fact['@odata.etag'] = e['@odata.etag'];
		msdyn_fact.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_fact.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
