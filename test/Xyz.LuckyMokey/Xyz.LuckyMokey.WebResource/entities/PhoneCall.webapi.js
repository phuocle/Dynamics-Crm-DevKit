...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.PhoneCallApi = function (e) {
		var EMPTY_STRING = '';
		...
		var phonecall = {
			...
			regardingobjectid_adobe_migratedrecord_phonecall: { b: 'regardingobjectid_adobe_migratedrecord_phonecall', a: '_regardingobjectid_value', c: 'adobe_migratedrecords', d: 'adobe_migratedrecord' },
			regardingobjectid_adobe_templatedocument_phonecall: { b: 'regardingobjectid_adobe_templatedocument_phonecall', a: '_regardingobjectid_value', c: 'adobe_templatedocuments', d: 'adobe_templatedocument' },
