...
declare namespace LuckyMokey {
	namespace Formmsdyn_visitorjourney_Information {
		...
		interface Body {
			...
			msdyn_displaytitle: DevKit.Form.Controls.ControlString;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_visitorjourney_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_visitorjourney_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_visitorjourney_Information.Body;
	}
	class msdyn_visitorjourneyApi {
		...
		*/
		...
		/** Display title of the user navigation record. */
		msdyn_displaytitle: DevKit.WebApi.StringValue;
		...
		msdyn_visitorjourneyId: DevKit.WebApi.GuidValue;
