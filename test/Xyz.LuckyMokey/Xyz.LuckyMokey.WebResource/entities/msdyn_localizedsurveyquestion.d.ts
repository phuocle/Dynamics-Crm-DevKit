...
declare namespace LuckyMokey {
	namespace Formmsdyn_localizedsurveyquestion_Information {
		...
		interface Body {
			...
			msdyn_languagecode: DevKit.Form.Controls.ControlOptionSet;
			msdyn_LocalizedQuestionText: DevKit.Form.Controls.ControlString;
			/** The name of the custom entity. */
			msdyn_name: DevKit.Form.Controls.ControlString;
			/** Unique identifier for Survey Question associated with Localized Survey Question. */
			msdyn_SurveyQuestionId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_localizedsurveyquestion_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_localizedsurveyquestion_Information.Body;
	}
