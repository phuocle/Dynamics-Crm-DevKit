...
declare namespace LuckyMokey {
	...
	class Formmsdyusd_answer_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyusd_answer_Information.Body;
		/** The Footer section of form msdyusd_answer_Information */
		Footer: LuckyMokey.Formmsdyusd_answer_Information.Footer;
	}
	class msdyusd_answerApi {
		...
		*/
		...
		msdyusd_answerId: DevKit.WebApi.GuidValue;
		/** The text displayed to the user for this answer */
		msdyusd_AnswerText: DevKit.WebApi.StringValue;
		msdyusd_enabledcondition: DevKit.WebApi.StringValue;
		/** Unique identifier for Task associated with Answer. */
		msdyusd_LinkedTask: DevKit.WebApi.LookupValue;
		/** The name of the custom entity. */
