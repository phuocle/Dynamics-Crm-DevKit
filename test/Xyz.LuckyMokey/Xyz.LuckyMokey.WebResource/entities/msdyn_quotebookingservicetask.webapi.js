...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotebookingservicetaskApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotebookingservicetask) {
			var a = msdyn_quotebookingservicetask[field].a;
			var b = msdyn_quotebookingservicetask[field].b;
			var c = msdyn_quotebookingservicetask[field].c;
			var d = msdyn_quotebookingservicetask[field].d;
			var g = msdyn_quotebookingservicetask[field].g;
			var r = msdyn_quotebookingservicetask[field].r;
			msdyn_quotebookingservicetask[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotebookingservicetask.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotebookingservicetask.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
