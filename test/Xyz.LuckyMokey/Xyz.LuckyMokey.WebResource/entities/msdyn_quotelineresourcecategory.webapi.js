...
(function (LuckyMokey) {
	'use strict';
	LuckyMokey.msdyn_quotelineresourcecategoryApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_quotelineresourcecategory) {
			var a = msdyn_quotelineresourcecategory[field].a;
			var b = msdyn_quotelineresourcecategory[field].b;
			var c = msdyn_quotelineresourcecategory[field].c;
			var d = msdyn_quotelineresourcecategory[field].d;
			var g = msdyn_quotelineresourcecategory[field].g;
			var r = msdyn_quotelineresourcecategory[field].r;
			msdyn_quotelineresourcecategory[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotelineresourcecategory.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_quotelineresourcecategory.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
