...
declare namespace LuckyMokey {
	namespace Formmsdyn_surveyquestion_Information {
		...
		interface Body {
			AnswerOptions: DevKit.Form.Controls.ControlGrid;
			msdyn_AnswerType: DevKit.Form.Controls.ControlOptionSet;
			/** Unique identifier for Work stream associated with Chat Question. */
			msdyn_LiveWorkStreamToChatQuestion: DevKit.Form.Controls.ControlLookup;
			/** The name of the custom entity. */
			msdyn_name: DevKit.Form.Controls.ControlString;
			msdyn_PlaceholderText: DevKit.Form.Controls.ControlString;
			msdyn_QuestionText: DevKit.Form.Controls.ControlString;
			/** Owner Id */
			OwnerId: DevKit.Form.Controls.ControlLookup;
		}
	}
	class Formmsdyn_surveyquestion_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_surveyquestion_Information.Body;
	}
