...
declare namespace LuckyMokey {
	namespace Formmsdyn_projectteammembersignup_Information {
		interface Header {
			...
			msdyn_MembershipStatus: DevKit.Form.Controls.ControlOptionSet;
		}
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyn_projectteammembersignup_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_projectteammembersignup_Information
		...
		*/
		...
		Body: LuckyMokey.Formmsdyn_projectteammembersignup_Information.Body;
		/** The Header section of form msdyn_projectteammembersignup_Information */
		Header: LuckyMokey.Formmsdyn_projectteammembersignup_Information.Header;
	}
	class msdyn_projectteammembersignupApi {
		...
		*/
		...
		msdyn_projectteammembersignupId: DevKit.WebApi.GuidValue;
		/** Shows the team membership for the person signing up for this project team. */
		msdyn_TeamMembership: DevKit.WebApi.LookupValue;
