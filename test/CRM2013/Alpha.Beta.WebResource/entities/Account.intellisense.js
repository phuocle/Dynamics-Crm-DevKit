...
Beta.FormAccount = function (executionContext, defaultWebResourceName) {
...
Beta.AccountApi = function (entity) {
	return {
		...
		///<field name='StateCode' type='OptionSet'>ReadOnly - Edm.Int32 - this.OptionSet.StateCode</field>
