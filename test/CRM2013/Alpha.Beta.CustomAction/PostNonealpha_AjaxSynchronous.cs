...
namespace Alpha.Beta.CustomAction
{
    [CrmPluginRegistration("alpha_Ajax", "none", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "",
    "Alpha.Beta.CustomAction.None.PostNonealpha_AjaxSynchronous", 1, IsolationModeEnum.Sandbox)]
    public class PostNonealpha_AjaxSynchronous : IPlugin
    {

        //private readonly string _unsecureString = null;
        //private readonly string _secureString = null;

        //public PostNonealpha_AjaxSynchronous(string unsecureString, string secureString)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.MessageName.ToLower() != "alpha_Ajax".ToLower()) throw new InvalidPluginExecutionException("MessageName does not equals alpha_Ajax");
