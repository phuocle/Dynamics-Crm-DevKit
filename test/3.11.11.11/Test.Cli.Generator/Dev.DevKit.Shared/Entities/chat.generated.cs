...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class chat : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public chat(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>For internal use only. Unique identifier of the user who linked the record.</para>
		/// <para>ReadOnly - Lookup to systemuser</para>
		/// <para>Linked By</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>For internal use only. Date and time when the record was linked.</para>
		/// <para>ReadOnly - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		/// <para>Linked On</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>For internal use only. Subject</para>
		...
		/// <summary>
		/// <para>For internal use only. Unique identifier of the user who unlinked the record.</para>
		/// <para>ReadOnly - Lookup to systemuser</para>
		/// <para>UnLinked By</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>For internal use only. Date and time when the record was unlinked.</para>
		/// <para>ReadOnly - DateTimeBehavior: UserLocal - DateTimeFormat: DateAndTime</para>
		/// <para>UnLinked On</para>
		/// </summary>
		[DebuggerNonUserCode()]
