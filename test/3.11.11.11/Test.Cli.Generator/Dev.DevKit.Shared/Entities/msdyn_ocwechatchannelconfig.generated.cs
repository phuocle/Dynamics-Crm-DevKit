...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_ocwechatchannelconfig : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public msdyn_ocwechatchannelconfig(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public msdyn_ocwechatchannelconfig(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Application ID of WeChat Channel</para>
		/// <para>Required - String - MaxLength: 100</para>
		/// <para>Developer ID (AppID)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Application Secret of WeChat Channel</para>
		/// <para>Required - String - MaxLength: 225</para>
		/// <para>Developer password (AppSecret)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Callback URL of WeChat Channel</para>
		/// <para>String - MaxLength: 1000</para>
		/// <para>Server address (URL)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Message encryption key (EncodingAESKey) for WeChat</para>
		/// <para>Required - String - MaxLength: 200</para>
		/// <para>Message encryption key (EncodingAESKey)</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>IP Address of WeChat Channel</para>
		...
		/// <summary>
		/// <para>Work Stream of WeChat Channel</para>
		...
		/// <summary>
		/// <para>WeChat Channel identifies WeChat Channel</para>
		/// <para>Primary Key - Uniqueidentifier</para>
		/// <para>WeChat Channel identity</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>The language setting for the WeChat account</para>
		/// <para>Required - Lookup to msdyn_oclanguage</para>
		/// <para>WeChat account language</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Original ID of WeChat Channel</para>
		/// <para>Required - String - MaxLength: 255</para>
		/// <para>Original ID</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Token of WeChat Channel</para>
		...
		/// <summary>
		/// <para>Status of the WeChat Channel</para>
		/// <para>State</para>
		/// <para>Status</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Reason for the status of the WeChat Channel</para>
		/// <para>Status</para>
