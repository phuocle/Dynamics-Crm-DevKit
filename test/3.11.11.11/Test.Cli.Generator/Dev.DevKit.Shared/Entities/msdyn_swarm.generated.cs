...
namespace Dev.DevKit.Shared.Entities
{
	...
	public partial class msdyn_swarm : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public msdyn_swarm(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public msdyn_swarm(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <summary>
		/// <para>Swarm description elaborating the issue</para>
		/// <para>Required - Memo - MaxLength: 50000</para>
		/// <para>Steps already tried</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Steps taken to resolve the swarm</para>
		...
		/// <summary>
		/// <para>Lookup to the swarm related record</para>
		/// <para>Required - Lookup to account, incident</para>
		/// <para>Swarm related record</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Identifier of the Teams group chat that is created to work on the swarm</para>
		/// <para>String - MaxLength: 100</para>
		/// <para>Teams conversation</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Title of the swarm</para>
		/// <para>Required - String - MaxLength: 500</para>
		/// <para>Swarm request</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para>Reason for the status of the Swarm</para>
		/// <para>Required - Status</para>
