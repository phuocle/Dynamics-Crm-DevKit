...
declare namespace DevKit {
	...
	class Formmsdyn_rolecompetencyrequirement_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Process of form msdyn_rolecompetencyrequirement_Information */
		Process: DevKit.Formmsdyn_rolecompetencyrequirement_Information.Process;
		/** The SidePanes of form msdyn_rolecompetencyrequirement_Information */
	...
	class msdyn_rolecompetencyrequirementApi {
		...
		*/
		...
		msdyn_characteristictype: OptionSet.msdyn_rolecompetencyrequirement.msdyn_characteristictype;
		/** Type the name of the custom entity. */
		msdyn_name: string;
		/** Shows the required proficiency for this role. */
		...
		statecode: OptionSet.msdyn_rolecompetencyrequirement.statecode;
		/** Reason for the status of the Role competency requirement */
		statuscode: OptionSet.msdyn_rolecompetencyrequirement.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Select the type of the characteristic. */
			readonly msdyn_characteristictype: string;
			/** Type the name of the custom entity. */
			...
			/** Shows the entity instances. */
			readonly msdyn_rolecompetencyrequirementId: string;
			/** Date and time that the record was migrated. */
