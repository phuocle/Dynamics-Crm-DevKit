...
declare namespace DevKit {
	...
	class msdyusd_tracesourcesettingApi {
		/**
		* DynamicsCrm.DevKit msdyusd_tracesourcesettingApi
		...
		*/
		...
		msdyusd_name: string;
		/** Specifies the levels of trace messages filtered by the source switch and event type filter. */
		msdyusd_switchlevel: OptionSet.msdyusd_tracesourcesetting.msdyusd_switchlevel;
		...
		/** Status of the Trace Source Setting */
		statecode: OptionSet.msdyusd_tracesourcesetting.statecode;
		/** Reason for the status of the Trace Source Setting */
		statuscode: OptionSet.msdyusd_tracesourcesetting.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Specifies the levels of trace messages filtered by the source switch and event type filter. */
			readonly msdyusd_switchlevel: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_tracesourcesettingId: string;
			/** Date and time that the record was migrated. */
