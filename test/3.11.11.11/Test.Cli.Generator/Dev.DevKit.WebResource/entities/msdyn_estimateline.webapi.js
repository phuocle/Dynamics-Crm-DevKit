...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_estimatelineApi = function (e) {
		...
		var _msdyn_estimateline = {
			...
			msdyn_estimatelineId: { a: 'msdyn_estimatelineid' },
			msdyn_estimateperdaylines: { a: 'msdyn_estimateperdaylines' },
			msdyn_ExchangeRateDate_UtcDateOnly: { a: 'msdyn_exchangeratedate' },
			msdyn_numberofresources: { a: 'msdyn_numberofresources' },
			msdyn_Origin: { b: 'msdyn_Origin', a: '_msdyn_origin_value', c: 'msdyn_estimatelines', d: 'msdyn_estimateline' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_estimateline = {};
		msdyn_estimateline.ODataEntity = e;
		msdyn_estimateline.FormattedValue = {};
		for (var field in _msdyn_estimateline) {
			var a = _msdyn_estimateline[field].a;
			var b = _msdyn_estimateline[field].b;
			var c = _msdyn_estimateline[field].c;
			var d = _msdyn_estimateline[field].d;
			var g = _msdyn_estimateline[field].g;
			var r = _msdyn_estimateline[field].r;
			webApiField(msdyn_estimateline, field, e, a, b, c, d, r, u, g);
		}
		msdyn_estimateline.Entity = u;
		msdyn_estimateline.EntityName = 'msdyn_estimateline';
		msdyn_estimateline.EntityCollectionName = 'msdyn_estimatelines';
		msdyn_estimateline['@odata.etag'] = e['@odata.etag'];
		msdyn_estimateline.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_estimateline;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyn_estimateline = {
		msdyn_AmountMethod : {
