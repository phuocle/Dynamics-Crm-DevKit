...
declare namespace DevKit {
	...
	class Formmsdyn_knowledgesearchfilter_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_knowledgesearchfilter_Information.Body;
		/** The Process of form msdyn_knowledgesearchfilter_Information */
		Process: DevKit.Formmsdyn_knowledgesearchfilter_Information.Process;
		/** The SidePanes of form msdyn_knowledgesearchfilter_Information */
		SidePanes: DevKit.SidePanes;
	}
	namespace Formmsdyn_knowledgesearchfilter_Information2 {
		interface Tabs {
		}
		interface Body {
			/** The name of the knowledge search filter. */
	...
	class Formmsdyn_knowledgesearchfilter_Information2 extends DevKit.IForm {
		/**
		* Information [Main Form]
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		...
		/** Utility functions/methods/objects for Dynamics 365 form */
		Utility: DevKit.Utility;
		/** The Body section of form msdyn_knowledgesearchfilter_Information2 */
		Body: DevKit.Formmsdyn_knowledgesearchfilter_Information2.Body;
		/** The Process of form msdyn_knowledgesearchfilter_Information2 */
		Process: DevKit.Formmsdyn_knowledgesearchfilter_Information2.Process;
		/** The SidePanes of form msdyn_knowledgesearchfilter_Information2 */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_knowledgesearchfilterApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_knowledgesearchfilter.ComponentState;
		...
		statecode: OptionSet.msdyn_knowledgesearchfilter.statecode;
		/** Reason for the status of the Knowledge search filter */
		statuscode: OptionSet.msdyn_knowledgesearchfilter.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Allows you to choose default values based on which articles are displayed to users in the knowledge control and knowledge search page. */
			readonly msdyn_DefaultValues: string;
			/** Indicates whether the filter is activated or not. */
			...
			/** Unique identifier for entity instances */
			readonly msdyn_knowledgesearchfilterId: string;
			/** The name of the knowledge search filter. */
			readonly msdyn_name: string;
			/** Order of filter. */
			readonly msdyn_OrderId: string;
			/** Allows you to choose values that will be displayed for the users in the knowledge control and knowledge search page. */
			readonly msdyn_SelectedValues: string;
			/** Unique name of the knowledge search filter. */
