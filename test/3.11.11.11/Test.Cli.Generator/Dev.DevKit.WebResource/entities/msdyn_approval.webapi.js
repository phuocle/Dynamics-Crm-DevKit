...
(function (DevKit) {
	...
	DevKit.msdyn_approvalApi = function (e) {
		...
		var _msdyn_approval = {
			...
			regardingobjectid_msdyn_salessuggestion_msdyn_approval: { b: 'regardingobjectid_msdyn_salessuggestion_msdyn_approval', a: '_regardingobjectid_value', c: 'msdyn_salessuggestions', d: 'msdyn_salessuggestion' },
		...
		var u = {};
		var msdyn_approval = {};
		msdyn_approval.ODataEntity = e;
		msdyn_approval.FormattedValue = {};
		for (var field in _msdyn_approval) {
			var a = _msdyn_approval[field].a;
			var b = _msdyn_approval[field].b;
			var c = _msdyn_approval[field].c;
			var d = _msdyn_approval[field].d;
			var g = _msdyn_approval[field].g;
			var r = _msdyn_approval[field].r;
			webApiField(msdyn_approval, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_approval.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_approval.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
