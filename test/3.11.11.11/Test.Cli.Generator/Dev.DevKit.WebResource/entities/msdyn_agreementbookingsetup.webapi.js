...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_agreementbookingsetupApi = function (e) {
		...
		var _msdyn_agreementbookingsetup = {
		...
		msdyn_agreementbookingsetup.ODataEntity = e;
		msdyn_agreementbookingsetup.FormattedValue = {};
		for (var field in _msdyn_agreementbookingsetup) {
			var a = _msdyn_agreementbookingsetup[field].a;
			var b = _msdyn_agreementbookingsetup[field].b;
			var c = _msdyn_agreementbookingsetup[field].c;
			var d = _msdyn_agreementbookingsetup[field].d;
			var g = _msdyn_agreementbookingsetup[field].g;
			var r = _msdyn_agreementbookingsetup[field].r;
			webApiField(msdyn_agreementbookingsetup, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_agreementbookingsetup.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_agreementbookingsetup.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
