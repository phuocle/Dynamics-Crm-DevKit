...
declare namespace DevKit {
	...
	class msdyusd_scriptletApi {
		...
		*/
		...
		/** Status of the ScriptLet */
		statecode: OptionSet.msdyusd_scriptlet.statecode;
		/** Reason for the status of the ScriptLet */
		statuscode: OptionSet.msdyusd_scriptlet.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyusd_scriptletId: string;
			readonly msdyusd_ScriptText: string;
			/** Date and time that the record was migrated. */
