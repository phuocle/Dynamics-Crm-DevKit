...
(function (DevKit) {
	...
	DevKit.msdyn_resourceassignmentApi = function (e) {
		...
		msdyn_resourceassignment.ODataEntity = e;
		msdyn_resourceassignment.FormattedValue = {};
		for (var field in _msdyn_resourceassignment) {
			var a = _msdyn_resourceassignment[field].a;
			var b = _msdyn_resourceassignment[field].b;
			var c = _msdyn_resourceassignment[field].c;
			var d = _msdyn_resourceassignment[field].d;
			var g = _msdyn_resourceassignment[field].g;
			var r = _msdyn_resourceassignment[field].r;
			webApiField(msdyn_resourceassignment, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_resourceassignment.getAliasedValue = function (alias, isMultiOptionSet = false) {
