...
//{'JsForm':['Account','Account for Interactive experience','Information','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.13.33','JsFormVersion':'v2'}