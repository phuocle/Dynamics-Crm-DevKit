...
namespace Dev.DevKit.PluginAccount
{
    ...
    "Dev.DevKit.PluginAccount.PreAccountCreateSynchronous", 1/*ExecutionOrder*/, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true,
    Image1Name = "", Image1Alias = "", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "",Action = PluginStepOperationEnum.Deactivate, Description = "ABCD")]
