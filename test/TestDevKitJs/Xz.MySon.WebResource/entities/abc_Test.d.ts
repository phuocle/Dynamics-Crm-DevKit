...
declare namespace MySon {
	...
	class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: MySon.FormAccount.Body;
		/** The Header section of form Account */
		Header: MySon.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: MySon.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: MySon.FormAccount.QuickForm;
		/** The Process of form Account */
		Process: MySon.FormAccount.Process;
		/** The Grid of form Account */
		Grid: MySon.FormAccount.Grid;
	}
	...
	class FormAccount_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: MySon.FormAccount_Quick_Create.Body;
	}
	class AccountApi {
		/**
...
//{'JsForm':['Account','Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true,'Version':'2.12.31','JsFormVersion':'v2'}