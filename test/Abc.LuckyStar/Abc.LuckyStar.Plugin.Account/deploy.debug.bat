...
if %MsBuild% NEQ "" (
	echo BUILDING: Abc.LuckyStar.Plugin.Account.csproj
	call %MsBuild% /nologo /noautorsp /verbosity:quiet /p:DefineConstants="DEBUG" /p:Configuration="Debug" Abc.LuckyStar.Plugin.Account.csproj
