...
namespace Abc.LuckyStar.PluginAccount
{
    ...
    "Abc.LuckyStar.PluginAccount.PostAccountMergeAsynchronous", 1, IsolationModeEnum.Sandbox, DeleteAsyncOperation = true,
    ...
    public class PostAccountMergeAsynchronous : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Plugin: Abc.LuckyStar.PluginAccount.PostAccountMergeAsynchronous");

            ExecutePlugin(context, serviceFactory, service, tracing);

            //tracing.DebugMessage("End Plugin: Abc.LuckyStar.PluginAccount.PostAccountMergeAsynchronous");
        }
