...
if %MsBuild% NEQ "" (
	echo BUILDING: Abc.LuckyStar.DataProvider.csproj
	call %MsBuild% /nologo /noautorsp /verbosity:quiet /p:DefineConstants="DEBUG" /p:Configuration="Debug" Abc.LuckyStar.DataProvider.csproj
