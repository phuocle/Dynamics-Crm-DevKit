...
namespace Abc.LuckyStar.Shared.Entities.EntityAnalyticsConfigOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class EntityAnalyticsConfig : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState)value.Value;
			}
		}
