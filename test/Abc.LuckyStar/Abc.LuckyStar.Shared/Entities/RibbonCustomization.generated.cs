...
namespace Abc.LuckyStar.Shared.Entities.RibbonCustomizationOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class RibbonCustomization : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RibbonCustomizationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RibbonCustomizationOptionSets.ComponentState)value.Value;
			}
		}
