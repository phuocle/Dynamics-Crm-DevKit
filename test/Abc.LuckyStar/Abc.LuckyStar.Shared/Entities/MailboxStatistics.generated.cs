...
namespace Abc.LuckyStar.Shared.Entities.MailboxStatisticsOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class MailboxStatistics : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId? OperationTypeId
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationTypeId);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId)value.Value;
			}
		}
