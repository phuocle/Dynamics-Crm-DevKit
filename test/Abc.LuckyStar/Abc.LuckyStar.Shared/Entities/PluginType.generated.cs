...
namespace Abc.LuckyStar.Shared.Entities.PluginTypeOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class PluginType : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.PluginTypeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.PluginTypeOptionSets.ComponentState)value.Value;
			}
		}
