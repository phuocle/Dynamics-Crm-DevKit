...
namespace Abc.LuckyStar.Shared.Entities.AppModuleRolesOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class AppModuleRoles : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.AppModuleRolesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.AppModuleRolesOptionSets.ComponentState)value.Value;
			}
		}
