...
namespace Abc.LuckyStar.Shared.Entities.GlobalSearchConfigurationOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class GlobalSearchConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.GlobalSearchConfigurationOptionSets.ComponentState)value.Value;
			}
		}
