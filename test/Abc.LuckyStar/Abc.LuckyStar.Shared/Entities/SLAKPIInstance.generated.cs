...
namespace Abc.LuckyStar.Shared.Entities.SLAKPIInstanceOptionSets
{
	public enum Status
	{
		/// <summary>
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class SLAKPIInstance : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.SLAKPIInstanceOptionSets.Status? Status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Status);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.SLAKPIInstanceOptionSets.Status)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.SLAKPIInstanceOptionSets.WarningTimeReached? WarningTimeReached
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.WarningTimeReached);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.SLAKPIInstanceOptionSets.WarningTimeReached)value.Value;
			}
			set
			{
				if (value.HasValue)
