...
namespace Abc.LuckyStar.Shared.Entities.AppModuleComponentOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class AppModuleComponent : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.AppModuleComponentOptionSets.ComponentType? ComponentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.AppModuleComponentOptionSets.ComponentType)value.Value;
			}
			set
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.AppModuleComponentOptionSets.RootComponentBehavior? RootComponentBehavior
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RootComponentBehavior);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.AppModuleComponentOptionSets.RootComponentBehavior)value.Value;
			}
			set
			{
				if (value.HasValue)
