...
namespace Abc.LuckyStar.Shared.Entities.TemplateOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class Template : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.TemplateOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.TemplateOptionSets.ComponentState)value.Value;
			}
		}
