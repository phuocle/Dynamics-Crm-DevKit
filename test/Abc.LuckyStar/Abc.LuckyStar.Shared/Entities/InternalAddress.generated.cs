...
namespace Abc.LuckyStar.Shared.Entities.InternalAddressOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class InternalAddress : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.InternalAddressOptionSets.AddressTypeCode? AddressTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AddressTypeCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.InternalAddressOptionSets.AddressTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.InternalAddressOptionSets.ShippingMethodCode? ShippingMethodCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ShippingMethodCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.InternalAddressOptionSets.ShippingMethodCode)value.Value;
			}
			set
			{
				if (value.HasValue)
