...
namespace Abc.LuckyStar.Shared.Entities.IntegrationStatusOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class IntegrationStatus : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.IntegrationStatusOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.IntegrationStatusOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.IntegrationStatusOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.IntegrationStatusOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
