...
namespace Abc.LuckyStar.Shared.Entities.TeamOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class Team : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.TeamOptionSets.TeamType? TeamType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TeamType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.TeamOptionSets.TeamType)value.Value;
			}
			set
			{
				if (value.HasValue)
