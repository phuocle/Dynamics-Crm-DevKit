...
namespace Abc.LuckyStar.Shared.Entities.ManagedPropertyOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ManagedProperty : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ManagedPropertyOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ManagedPropertyOptionSets.ComponentState)value.Value;
			}
		}
