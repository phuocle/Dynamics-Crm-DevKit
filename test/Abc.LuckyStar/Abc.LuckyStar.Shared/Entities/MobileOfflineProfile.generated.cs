...
namespace Abc.LuckyStar.Shared.Entities.MobileOfflineProfileOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class MobileOfflineProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.MobileOfflineProfileOptionSets.ComponentState)value.Value;
			}
		}
