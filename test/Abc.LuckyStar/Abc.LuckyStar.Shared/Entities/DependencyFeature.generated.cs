...
namespace Abc.LuckyStar.Shared.Entities.DependencyFeatureOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class DependencyFeature : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.DependencyFeatureOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.DependencyFeatureOptionSets.ComponentState)value.Value;
			}
		}
