...
namespace Abc.LuckyStar.Shared.Entities.WorkflowDependencyOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class WorkflowDependency : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.WorkflowDependencyOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.WorkflowDependencyOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
