...
namespace Abc.LuckyStar.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class MobileOfflineProfileItemAssociation : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.SelectedRelationShipsSchema? SelectedRelationShipsSchema
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SelectedRelationShipsSchema);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.MobileOfflineProfileItemAssociationOptionSets.SelectedRelationShipsSchema)value.Value;
			}
			set
			{
				if (value.HasValue)
