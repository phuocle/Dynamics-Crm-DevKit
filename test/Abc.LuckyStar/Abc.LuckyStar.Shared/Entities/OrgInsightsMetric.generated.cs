...
namespace Abc.LuckyStar.Shared.Entities.OrgInsightsMetricOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class OrgInsightsMetric : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.OrgInsightsMetricOptionSets.MetricType? MetricType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MetricType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.OrgInsightsMetricOptionSets.MetricType)value.Value;
			}
			set
			{
				if (value.HasValue)
