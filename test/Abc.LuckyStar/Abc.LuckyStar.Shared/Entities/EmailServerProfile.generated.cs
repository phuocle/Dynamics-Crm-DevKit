...
namespace Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class EmailServerProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.ExchangeVersion? ExchangeVersion
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ExchangeVersion);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.ExchangeVersion)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.IncomingAuthenticationProtocol? IncomingAuthenticationProtocol
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.IncomingAuthenticationProtocol);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.IncomingAuthenticationProtocol)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.IncomingCredentialRetrieval? IncomingCredentialRetrieval
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.IncomingCredentialRetrieval);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.IncomingCredentialRetrieval)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastAuthorizationStatus? LastAuthorizationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LastAuthorizationStatus);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastAuthorizationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastTestExecutionStatus? LastTestExecutionStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LastTestExecutionStatus);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastTestExecutionStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastTestValidationStatus? LastTestValidationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LastTestValidationStatus);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.LastTestValidationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.OutgoingAuthenticationProtocol? OutgoingAuthenticationProtocol
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OutgoingAuthenticationProtocol);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.OutgoingAuthenticationProtocol)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.OutgoingCredentialRetrieval? OutgoingCredentialRetrieval
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OutgoingCredentialRetrieval);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.OutgoingCredentialRetrieval)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.ServerType? ServerType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ServerType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.ServerType)value.Value;
			}
			set
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EmailServerProfileOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
