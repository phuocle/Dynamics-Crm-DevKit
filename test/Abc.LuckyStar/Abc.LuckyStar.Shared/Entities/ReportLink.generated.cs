...
namespace Abc.LuckyStar.Shared.Entities.ReportLinkOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ReportLink : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ReportLinkOptionSets.LinkTypeCode? LinkTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.LinkTypeCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ReportLinkOptionSets.LinkTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
