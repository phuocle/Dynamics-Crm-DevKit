...
namespace Abc.LuckyStar.Shared.Entities.PrincipalSyncAttributeMapOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class PrincipalSyncAttributeMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.PrincipalSyncAttributeMapOptionSets.DefaultSyncDirection? DefaultSyncDirection
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DefaultSyncDirection);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.PrincipalSyncAttributeMapOptionSets.DefaultSyncDirection)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.PrincipalSyncAttributeMapOptionSets.SyncDirection? SyncDirection
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SyncDirection);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.PrincipalSyncAttributeMapOptionSets.SyncDirection)value.Value;
			}
			set
			{
				if (value.HasValue)
