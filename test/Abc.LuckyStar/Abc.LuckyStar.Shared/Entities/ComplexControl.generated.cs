...
namespace Abc.LuckyStar.Shared.Entities.ComplexControlOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ComplexControl : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ComplexControlOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ComplexControlOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ComplexControlOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ComplexControlOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
