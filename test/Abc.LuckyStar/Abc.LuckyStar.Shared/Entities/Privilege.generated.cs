...
namespace Abc.LuckyStar.Shared.Entities.PrivilegeOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class Privilege : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.PrivilegeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.PrivilegeOptionSets.ComponentState)value.Value;
			}
		}
