...
namespace Abc.LuckyStar.Shared.Entities.SocialInsightsConfigurationOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class SocialInsightsConfiguration : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType? SocialDataItemType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SocialDataItemType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType)value.Value;
			}
			set
			{
				if (value.HasValue)
