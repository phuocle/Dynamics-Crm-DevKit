...
namespace Abc.LuckyStar.Shared.Entities.DuplicateRuleConditionOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class DuplicateRuleCondition : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode? OperatorCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperatorCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.DuplicateRuleConditionOptionSets.OperatorCode)value.Value;
			}
			set
			{
				if (value.HasValue)
