...
namespace Abc.LuckyStar.Shared.Entities.EntityDataSourceOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class EntityDataSource : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EntityDataSourceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EntityDataSourceOptionSets.ComponentState)value.Value;
			}
		}
