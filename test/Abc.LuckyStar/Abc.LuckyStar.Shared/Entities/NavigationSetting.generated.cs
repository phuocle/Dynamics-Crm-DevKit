...
namespace Abc.LuckyStar.Shared.Entities.NavigationSettingOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class NavigationSetting : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.NavigationSettingOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.NavigationSettingOptionSets.ComponentState)value.Value;
			}
		}
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.NavigationSettingOptionSets.SettingType? SettingType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SettingType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.NavigationSettingOptionSets.SettingType)value.Value;
			}
			set
			{
				if (value.HasValue)
