...
namespace Abc.LuckyStar.Shared.Entities.ActionCardUserStateOptionSets
{
	public enum State
	{
		/// <summary>
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ActionCardUserState : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ActionCardUserStateOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ActionCardUserStateOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
