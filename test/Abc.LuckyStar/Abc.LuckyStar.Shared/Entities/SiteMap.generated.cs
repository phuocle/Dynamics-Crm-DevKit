...
namespace Abc.LuckyStar.Shared.Entities.SiteMapOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class SiteMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.SiteMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.SiteMapOptionSets.ComponentState)value.Value;
			}
		}
