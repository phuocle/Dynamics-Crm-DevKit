...
namespace Abc.LuckyStar.Shared.Entities.ActivityMimeAttachmentOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ActivityMimeAttachment : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ActivityMimeAttachmentOptionSets.ComponentState)value.Value;
			}
		}
