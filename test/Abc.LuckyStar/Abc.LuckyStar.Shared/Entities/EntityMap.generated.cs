...
namespace Abc.LuckyStar.Shared.Entities.EntityMapOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class EntityMap : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EntityMapOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EntityMapOptionSets.ComponentState)value.Value;
			}
		}
