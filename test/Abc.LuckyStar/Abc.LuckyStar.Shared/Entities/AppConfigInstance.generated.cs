...
namespace Abc.LuckyStar.Shared.Entities.AppConfigInstanceOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class AppConfigInstance : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.AppConfigInstanceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.AppConfigInstanceOptionSets.ComponentState)value.Value;
			}
		}
