...
namespace Abc.LuckyStar.Shared.Entities.ReplicationBacklogOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ReplicationBacklog : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType? ReplicationBacklogType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReplicationBacklogType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ReplicationBacklogOptionSets.ReplicationBacklogType)value.Value;
			}
		}
