...
namespace Abc.LuckyStar.Shared.Entities.CanvasAppOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class CanvasApp : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.CanvasAppOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.CanvasAppOptionSets.ComponentState)value.Value;
			}
		}
