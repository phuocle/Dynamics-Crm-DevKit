...
namespace Abc.LuckyStar.Shared.Entities.ServicePlanAppModulesOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ServicePlanAppModules : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ServicePlanAppModulesOptionSets.ComponentState)value.Value;
			}
		}
