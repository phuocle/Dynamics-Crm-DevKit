...
namespace Abc.LuckyStar.Shared.Entities.UserFormOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class UserForm : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.UserFormOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.UserFormOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
