...
namespace Abc.LuckyStar.Shared.Entities.NewProcessOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class NewProcess : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.NewProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.NewProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.NewProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.NewProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
