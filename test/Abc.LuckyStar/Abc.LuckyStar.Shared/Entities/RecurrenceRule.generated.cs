...
namespace Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class RecurrenceRule : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.Instance? Instance
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Instance);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.Instance)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.MonthOfYear? MonthOfYear
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MonthOfYear);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.MonthOfYear)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.PatternEndType? PatternEndType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PatternEndType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.PatternEndType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.RecurrencePatternType? RecurrencePatternType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RecurrencePatternType);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RecurrenceRuleOptionSets.RecurrencePatternType)value.Value;
			}
			set
			{
				if (value.HasValue)
