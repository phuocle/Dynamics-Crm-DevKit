...
namespace Abc.LuckyStar.Shared.Entities.EntityRelationshipOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class EntityRelationship : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.EntityRelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.EntityRelationshipOptionSets.ComponentState)value.Value;
			}
		}
