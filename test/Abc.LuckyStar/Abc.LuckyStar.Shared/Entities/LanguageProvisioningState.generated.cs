...
namespace Abc.LuckyStar.Shared.Entities.LanguageProvisioningStateOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class LanguageProvisioningState : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage? ProvisioningStage
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ProvisioningStage);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage)value.Value;
			}
			set
			{
				if (value.HasValue)
