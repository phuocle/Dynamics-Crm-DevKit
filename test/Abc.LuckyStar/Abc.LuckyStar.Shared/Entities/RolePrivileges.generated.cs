...
namespace Abc.LuckyStar.Shared.Entities.RolePrivilegesOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class RolePrivileges : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.RolePrivilegesOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.RolePrivilegesOptionSets.ComponentState)value.Value;
			}
		}
