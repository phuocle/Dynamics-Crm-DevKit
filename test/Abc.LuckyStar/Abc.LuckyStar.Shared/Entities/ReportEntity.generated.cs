...
namespace Abc.LuckyStar.Shared.Entities.ReportEntityOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ReportEntity : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ReportEntityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ReportEntityOptionSets.ComponentState)value.Value;
			}
		}
