...
namespace Abc.LuckyStar.Shared.Entities.ConvertRuleItemOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ConvertRuleItem : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ConvertRuleItemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ConvertRuleItemOptionSets.ComponentState)value.Value;
			}
		}
