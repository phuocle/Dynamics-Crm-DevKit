...
namespace Abc.LuckyStar.Shared.Entities.ActionCardOptionSets
{
	public enum Source
	{
		/// <summary>
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class ActionCard : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ActionCardOptionSets.Source? Source
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Source);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ActionCardOptionSets.Source)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.ActionCardOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.ActionCardOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
