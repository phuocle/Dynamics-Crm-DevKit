...
namespace Abc.LuckyStar.Shared.Entities.FieldSecurityProfileOptionSets
{
...
namespace Abc.LuckyStar.Shared.Entities
{
	public partial class FieldSecurityProfile : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Abc.LuckyStar.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Abc.LuckyStar.Shared.Entities.FieldSecurityProfileOptionSets.ComponentState)value.Value;
			}
		}
