    ...
    public class RetrieveMultiple : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Abc.LuckyStar.DataProvider.AzureTable.RetrieveMultiple");

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Abc.LuckyStar.DataProvider.AzureTable.RetrieveMultiple");
        }
