...
if %MsBuild% NEQ "" (
	echo BUILDING: Abc.LuckyStar.Workflow.Account.csproj
	call %MsBuild% /nologo /noautorsp /verbosity:quiet /p:DefineConstants="DEBUG" /p:Configuration="Debug" Abc.LuckyStar.Workflow.Account.csproj
...
"%DynamicsCrmDevKitCli%\tools\DynamicsCrm.DevKit.Cli.exe" /conn:%CrmConnection% /json:"..\DynamicsCrm.DevKit.Cli.json" /type:"workflows" /profile:"DEBUG"
exit