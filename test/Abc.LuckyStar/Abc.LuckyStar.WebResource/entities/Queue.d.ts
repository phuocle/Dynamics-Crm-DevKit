...
declare namespace LuckyStar {
	...
	class FormQueue_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormQueue_Information.Body;
	}
	namespace FormQueue {
		interface tab_general_Sections {
			queue_information: DevKit.Form.Controls.ControlSection;
...
//{'JsForm':['Queue Information','Queue'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}