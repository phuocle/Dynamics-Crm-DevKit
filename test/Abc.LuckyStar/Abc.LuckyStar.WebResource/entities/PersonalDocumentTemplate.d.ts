...
declare namespace LuckyStar {
	...
	class FormPersonalDocumentTemplate_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.FormPersonalDocumentTemplate_Information.Body;
	}
...
//{'JsForm':['PersonalDocumentTemplate Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}