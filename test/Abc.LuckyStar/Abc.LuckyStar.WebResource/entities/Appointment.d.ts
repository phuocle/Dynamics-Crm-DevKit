...
declare namespace LuckyStar {
	...
	class FormAppointment extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAppointment.Body;
		/** The Header section of form Appointment */
		Header: LuckyStar.FormAppointment.Header;
	}
	...
	class FormAppointment_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAppointment_for_Interactive_experience.Body;
		/** The Header section of form Appointment_for_Interactive_experience */
		Header: LuckyStar.FormAppointment_for_Interactive_experience.Header;
	}
	...
	class FormAppointment_Wizard extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAppointment_Wizard.Body;
		/** The Header section of form Appointment_Wizard */
		Header: LuckyStar.FormAppointment_Wizard.Header;
	}
	...
	class FormAppointment_quick_create_form extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAppointment_quick_create_form.Body;
	}
...
//{'JsForm':['Appointment','Appointment for Interactive experience','Appointment quick create form.','Appointment Wizard'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}