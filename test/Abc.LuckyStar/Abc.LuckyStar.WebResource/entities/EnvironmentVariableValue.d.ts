...
declare namespace LuckyStar {
	...
	class FormEnvironmentVariableValue_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormEnvironmentVariableValue_Information.Body;
	}
	class EnvironmentVariableValueApi {
		...
		*/
		...
		/** Unique identifier for Environment Variable Definition associated with Environment Variable Value. */
		EnvironmentVariableDefinitionId: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		EnvironmentVariableValueId: DevKit.WebApi.GuidValue;
		/** For internal use only. */
		EnvironmentVariableValueIdUnique: DevKit.WebApi.GuidValueReadonly;
...
//{'JsForm':['EnvironmentVariableValue Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}