...
declare namespace LuckyStar {
	namespace FormPostFollow_Information {
		interface tab_general_Sections {
			Follow_information: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormPostFollow_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.FormPostFollow_Information.Body;
	}
	class PostFollowApi {
		/**
...
//{'JsForm':['PostFollow Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}