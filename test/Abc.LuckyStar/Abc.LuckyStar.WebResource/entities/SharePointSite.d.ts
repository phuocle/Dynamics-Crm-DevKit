...
declare namespace LuckyStar {
	...
	class FormSharePointSite_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormSharePointSite_Information.Body;
		/** The Footer section of form SharePointSite_Information */
		Footer: LuckyStar.FormSharePointSite_Information.Footer;
		/** The Navigation of form SharePointSite_Information */
		Navigation: LuckyStar.FormSharePointSite_Information.Navigation;
	}
...
//{'JsForm':['SharePointSite Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}