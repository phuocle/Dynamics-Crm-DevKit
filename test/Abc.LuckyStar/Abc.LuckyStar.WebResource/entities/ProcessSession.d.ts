...
declare namespace LuckyStar {
	...
	class FormProcessSession_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormProcessSession_Information.Body;
		/** The Footer section of form ProcessSession_Information */
		Footer: LuckyStar.FormProcessSession_Information.Footer;
	}
...
//{'JsForm':['ProcessSession Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}