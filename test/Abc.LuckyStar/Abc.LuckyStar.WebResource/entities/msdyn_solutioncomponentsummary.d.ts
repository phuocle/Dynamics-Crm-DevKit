...
declare namespace LuckyStar {
	...
	class Formmsdyn_solutioncomponentsummary_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.Formmsdyn_solutioncomponentsummary_Information.Body;
	}
...
//{'JsForm':['msdyn_solutioncomponentsummary Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}