...
declare namespace LuckyStar {
	...
	class FormSharePointDocumentLocation_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormSharePointDocumentLocation_Information.Body;
		/** The Footer section of form SharePointDocumentLocation_Information */
		Footer: LuckyStar.FormSharePointDocumentLocation_Information.Footer;
		/** The Navigation of form SharePointDocumentLocation_Information */
		Navigation: LuckyStar.FormSharePointDocumentLocation_Information.Navigation;
	}
...
//{'JsForm':['SharePointDocumentLocation Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}