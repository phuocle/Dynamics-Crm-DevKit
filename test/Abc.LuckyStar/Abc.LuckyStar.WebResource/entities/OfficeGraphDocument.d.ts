...
declare namespace LuckyStar {
	...
	class FormOfficeGraphDocument_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.FormOfficeGraphDocument_Information.Body;
	}
...
//{'JsForm':['OfficeGraphDocument Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}