...
declare namespace LuckyStar {
	...
	class Formflowsession_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.Formflowsession_Information.Body;
	}
	class flowsessionApi {
		...
		*/
		...
		"@odata.etag": string;
		AdditionalContext_Name: DevKit.WebApi.StringValueReadonly;
		...
		Context: DevKit.WebApi.StringValue;
		...
		flowsessionId: DevKit.WebApi.GuidValue;
		/** The name of the gateway used. */
		Gateway: DevKit.WebApi.StringValue;
		...
		ProcessVersion: DevKit.WebApi.StringValue;
...
//{'JsForm':['flowsession Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}