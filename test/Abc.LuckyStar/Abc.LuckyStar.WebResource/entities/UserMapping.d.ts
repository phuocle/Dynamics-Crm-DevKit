...
declare namespace LuckyStar {
	...
	class FormUserMapping_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form UserMapping_Information
		...
		*/
		...
		Body: LuckyStar.FormUserMapping_Information.Body;
	}
...
//{'JsForm':['UserMapping Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}