...
(function (LuckyStar) {
	'use strict';
	LuckyStar.msdyn_AIBFileApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_aibfile) {
			var a = msdyn_aibfile[field].a;
			var b = msdyn_aibfile[field].b;
			var c = msdyn_aibfile[field].c;
			var d = msdyn_aibfile[field].d;
			var g = msdyn_aibfile[field].g;
			var r = msdyn_aibfile[field].r;
			msdyn_aibfile[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_aibfile.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_aibfile.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
