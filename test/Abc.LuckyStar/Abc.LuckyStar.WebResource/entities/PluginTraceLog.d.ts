...
declare namespace LuckyStar {
	...
	class FormPluginTraceLog_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormPluginTraceLog_Information.Body;
		/** The Header section of form PluginTraceLog_Information */
		Header: LuckyStar.FormPluginTraceLog_Information.Header;
	}
...
//{'JsForm':['PluginTraceLog Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}