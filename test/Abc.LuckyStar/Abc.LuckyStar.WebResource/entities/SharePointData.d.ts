...
declare namespace LuckyStar {
	...
	class FormSharePointData_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.FormSharePointData_Information.Body;
	}
...
//{'JsForm':['SharePointData Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}