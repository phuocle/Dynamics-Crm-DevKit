...
declare namespace LuckyStar {
	...
	class FormQueueItem_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormQueueItem_Information.Body;
		/** The Footer section of form QueueItem_Information */
		Footer: LuckyStar.FormQueueItem_Information.Footer;
	}
	class QueueItemApi {
		/**
...
//{'JsForm':['QueueItem Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}