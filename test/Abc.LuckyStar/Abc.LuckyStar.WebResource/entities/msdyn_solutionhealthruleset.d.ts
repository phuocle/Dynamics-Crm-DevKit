...
declare namespace LuckyStar {
	namespace Formmsdyn_solutionhealthruleset_Information {
		...
		interface Body {
			Solution_Health_Rules: DevKit.Form.Controls.ControlGrid;
			...
			msdyn_uniquename: DevKit.Form.Controls.ControlString;
		}
	}
	class Formmsdyn_solutionhealthruleset_Information extends DevKit.Form.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_solutionhealthruleset_Information
		...
		*/
		...
		Body: LuckyStar.Formmsdyn_solutionhealthruleset_Information.Body;
	}
...
//{'JsForm':['msdyn_solutionhealthruleset Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}