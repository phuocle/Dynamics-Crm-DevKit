...
(function (LuckyStar) {
    ...
    var devKit = (function () {
        ...
        function loadForm(formContext) {
            ...
            var contextData = (function () {
                if (formContext) { if (formContext.data) return formContext.data; }
                else { if (Xrm && Xrm.Page && Xrm.Page.data) return Xrm.Page.data; }
            })();
            var contextDataEntity = (function () {
                if (formContext) { if (formContext.data && formContext.data.entity) return formContext.data.entity; }
                else { if (Xrm && Xrm.Page && Xrm.Page.data && Xrm.Page.data.entity) return Xrm.Page.data.entity; }
            })();
            var contextUi = (function () {
                if (formContext) { if (formContext.ui) return formContext.ui; }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui) return Xrm.Page.ui; }
            })();
            var contextUiFormSelector = (function () {
                if (formContext) { if (formContext.ui && formContext.ui.formSelector) return formContext.ui.formSelector; }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui && Xrm.Page.ui.formSelector) return Xrm.Page.ui.formSelector; }
            })();
            ...
            form.FormNavigate = function (formId) { var formItem = contextUiFormSelector.items.get(formId); formItem.navigate(); };
            return form;
        }
        function loadProcess(formContext) {
            var process = {};
            var getProcess = (function () {
                if (formContext) { if (formContext.data && formContext.data.process) return formContext.data.process; }
                else { if (Xrm && Xrm.Page && Xrm.Page.data && Xrm.Page.data.process) return Xrm.Page.data.process; }
            })();
            var getProcessUi = (function () {
                if (formContext) { if (formContext.ui && formContext.ui.process) return formContext.ui.process; }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui && Xrm.Page.ui.process) return Xrm.Page.ui.process; }
            })();
        ...
        function loadField(formContext, body, field, type) {
            var logicalName = (function () { if (type === undefined) return field.toLowerCase(); return (type + field).toLowerCase(); })();
            var control = (function () {
                if (formContext) { if (formContext.getControl) return formContext.getControl(logicalName); }
                else { if (Xrm && Xrm.Page && Xrm.Page.getControl) return Xrm.Page.getControl(logicalName); }
            })();
            var attribute = (function () {
                if (formContext) {
                    ...
                    if (Xrm && Xrm.Page && Xrm.Page.getAttribute) {
                        var attr = Xrm.Page.getAttribute(logicalName);
                        if (attr) return attr;
                    }
                    if (Xrm && Xrm.Page && Xrm.Page.getControl) {
                        attr = Xrm.Page.getControl(logicalName).getAttribute();
                        if (attr) return attr;
                    }
                }
            })();
            ...
            body[field].AddNotification = function (title, message, notificationLevel, uniqueId, callback) { var actions = { message: message, actions: [callback] }; var notification = { messages: [title], notificationLevel: notificationLevel, uniqueId: uniqueId, actions: [actions] }; return control.addNotification(notification); };
        }
        ...
        function loadSection(formContext, tab, sections, section) {
            var tabObject = (function () {
                if (formContext) { if (formContext.ui && formContext.ui.tabs && formContext.ui.tabs.get) return formContext.ui.tabs.get(tab); }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui && Xrm.Page.ui.tabs && Xrm.Page.ui.tabs.get) return Xrm.Page.ui.tabs.get(tab); }
            })();
            var sectionObject = (function () {
                if (tabObject && tabObject.sections && tabObject.sections.get) return tabObject.sections.get(section);
            })();
        ...
        function loadNavigation(formContext, navigations, navigation) {
            var navigationItem = (function () {
                if (formContext) { if (formContext.ui && formContext.ui.navigation && formContext.ui.navigation.items && formContext.ui.navigation.items.get) return formContext.ui.navigation.items.get(navigation); }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui && Xrm.Page.ui.navigation && Xrm.Page.ui.navigation.items && Xrm.Page.ui.navigation.items.get) return Xrm.Page.ui.navigation.items.get(navigation); }
            })();
        ...
        function loadQuickForm(formContext, quickForms, quickForm) {
            var quickViewControl = (function () {
                if (formContext) { if (formContext.ui && formContext.ui.quickForms && formContext.ui.quickForms.get) return formContext.ui.quickForms.get(quickForm); }
                else { if (Xrm && Xrm.Page && Xrm.Page.ui && Xrm.Page.ui.quickForms && Xrm.Page.ui.quickForms.get) return Xrm.Page.ui.quickForms.get(quickForm); }
            })();
        ...
        function loadUtility(defaultWebResourceName) {
            ...
            var getUtility = (function () {
                if (Xrm && Xrm.Utility) return Xrm.Utility;
            })();
            var getGlobalContext = (function () {
                if (Xrm && Xrm.Utility && Xrm.Utility.getGlobalContext) return Xrm.Utility.getGlobalContext();
            })();
            var getNavigation = (function () {
                if (Xrm && Xrm.Navigation) return Xrm.Navigation;
            })();
            var getPanel = (function () {
                if (Xrm && Xrm.Panel) return Xrm.Panel;
            })();
            var getEncoding = (function () {
                if (Xrm && Xrm.Encoding) return Xrm.Encoding;
            })();
            var getDevice = (function () {
                if (Xrm && Xrm.Device) return Xrm.Device;
            })();
            ...
            Object.defineProperty(utility, 'Client', {
                get: function () {
                    var client = (function () { return Xrm.Utility.getGlobalContext().client; })();
                    var Client = {};
            ...
            Object.defineProperty(utility, 'OrganizationSettings', {
                get: function () {
                    var organizationSettings = (function () { return Xrm.Utility.getGlobalContext().organizationSettings; })();
            ...
            Object.defineProperty(utility, 'UserSettings', {
                get: function () {
                    var userSettings = (function () { return Xrm.Utility.getGlobalContext().userSettings; })();
                    var UserSettings = {};
	...
	LuckyStar.FormWebApi = function(executionContext, defaultWebResourceName) {
	...
	LuckyStar.FormWebApi_2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	LuckyStar.Formdevkit_WebApi_Quick_Create = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
