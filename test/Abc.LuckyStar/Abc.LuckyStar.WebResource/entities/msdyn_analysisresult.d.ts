...
declare namespace LuckyStar {
	...
	class Formmsdyn_analysisresult_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.Formmsdyn_analysisresult_Information.Body;
		/** The Header section of form msdyn_analysisresult_Information */
		Header: LuckyStar.Formmsdyn_analysisresult_Information.Header;
	}
...
//{'JsForm':['msdyn_analysisresult Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}