...
declare namespace LuckyStar {
	...
	class FormWebApi extends DevKit.Form.IForm {
		...
		*/
		...
		Footer: LuckyStar.FormWebApi.Footer;
		/** The Header section of form WebApi */
		Header: LuckyStar.FormWebApi.Header;
		/** The Navigation of form WebApi */
		Navigation: LuckyStar.FormWebApi.Navigation;
		/** The Process of form WebApi */
		Process: LuckyStar.FormWebApi.Process;
	}
	...
	class FormWebApi_2 extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormWebApi_2.Body;
		/** The Header section of form WebApi_2 */
		Header: LuckyStar.FormWebApi_2.Header;
		/** The Navigation of form WebApi_2 */
		Navigation: LuckyStar.FormWebApi_2.Navigation;
...
//{'JsForm':['Quick Create','WebApi','WebApi 2'],'JsWebApi':true,'IsDebugForm':false,'IsDebugWebApi':false}