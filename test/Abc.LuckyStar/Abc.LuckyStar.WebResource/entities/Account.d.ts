...
declare namespace LuckyStar {
	...
	class FormAccount_for_Interactive_experience extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAccount_for_Interactive_experience.Body;
		/** The Header section of form Account_for_Interactive_experience */
		Header: LuckyStar.FormAccount_for_Interactive_experience.Header;
		/** The Navigation of form Account_for_Interactive_experience */
		Navigation: LuckyStar.FormAccount_for_Interactive_experience.Navigation;
	}
	...
	class FormAccount_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormAccount_Information.Body;
		/** The Header section of form Account_Information */
		Header: LuckyStar.FormAccount_Information.Header;
		/** The Navigation of form Account_Information */
		Navigation: LuckyStar.FormAccount_Information.Navigation;
	}
...
//{'JsForm':['Account','Account for Interactive experience','Account Quick Create','Account Information'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false}