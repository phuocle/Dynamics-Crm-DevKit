...
(function (LuckyStar) {
	'use strict';
	LuckyStar.FormApplication_User = function(executionContext, defaultWebResourceName) {
	...
	LuckyStar.FormUser_form_Business = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
