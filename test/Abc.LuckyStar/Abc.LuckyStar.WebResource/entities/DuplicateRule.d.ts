...
declare namespace LuckyStar {
	namespace FormDuplicateRule_Information {
		...
		interface tab_administration_Sections {
			section_1_2: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormDuplicateRule_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.FormDuplicateRule_Information.Body;
	}
