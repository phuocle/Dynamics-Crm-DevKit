...
declare namespace LuckyStar {
	...
	class FormEmailServerProfile_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormEmailServerProfile_Information.Body;
		/** The Footer section of form EmailServerProfile_Information */
		Footer: LuckyStar.FormEmailServerProfile_Information.Footer;
	}
...
//{'JsForm':['EmailServerProfile Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}