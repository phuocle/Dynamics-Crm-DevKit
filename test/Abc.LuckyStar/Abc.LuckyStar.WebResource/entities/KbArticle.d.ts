...
declare namespace LuckyStar {
	...
	class FormKbArticle_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: LuckyStar.FormKbArticle_Information.Body;
		/** The Footer section of form KbArticle_Information */
		Footer: LuckyStar.FormKbArticle_Information.Footer;
	}
	class KbArticleApi {
		/**
...
//{'JsForm':['KbArticle Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}