...
declare namespace LuckyStar {
	namespace Formdevkit_processwebapi1_Information {
		...
		interface tab_StageStep23_Sections {
			StageStep23_section1: DevKit.Form.Controls.ControlSection;
		}
		interface tab_StageStep36_Sections {
			StageStep36_section1: DevKit.Form.Controls.ControlSection;
		}
		...
		interface tab_StageStep23 extends DevKit.Form.Controls.IControlTab {
			Section: tab_StageStep23_Sections;
		}
		interface tab_StageStep36 extends DevKit.Form.Controls.IControlTab {
	...
	class Formdevkit_processwebapi1_Information extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: LuckyStar.Formdevkit_processwebapi1_Information.Body;
	}
...
//{'JsForm':['devkit_processwebapi1 Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}