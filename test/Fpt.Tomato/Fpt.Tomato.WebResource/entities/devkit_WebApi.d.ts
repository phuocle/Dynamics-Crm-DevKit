...
declare namespace Tomato {
	...
	class FormWebApi extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Tomato.FormWebApi.Body;
		/** The Footer section of form WebApi */
		Footer: Tomato.FormWebApi.Footer;
		/** The Header section of form WebApi */
		Header: Tomato.FormWebApi.Header;
		/** The Navigation of form WebApi */
		Navigation: Tomato.FormWebApi.Navigation;
		/** The Process of form WebApi */
		Process: Tomato.FormWebApi.Process;
	}
	...
	class FormWebApi_2 extends DevKit.Form.IForm {
		/**
		...
		*/
		...
		Body: Tomato.FormWebApi_2.Body;
		/** The Header section of form WebApi_2 */
		Header: Tomato.FormWebApi_2.Header;
		/** The Navigation of form WebApi_2 */
		Navigation: Tomato.FormWebApi_2.Navigation;
		/** The Process of form WebApi_2 */
		Process: Tomato.FormWebApi_2.Process;
	}
	...
	class Formdevkit_WebApi_Quick_Create extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Tomato.Formdevkit_WebApi_Quick_Create.Body;
	}
