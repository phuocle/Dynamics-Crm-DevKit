...
declare namespace Tomato {
	...
	class FormContact extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Tomato.FormContact.Body;
		/** The Header section of form Contact */
		Header: Tomato.FormContact.Header;
		/** The Navigation of form Contact */
		Navigation: Tomato.FormContact.Navigation;
	}
	...
	class FormContact_Information extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Tomato.FormContact_Information.Body;
		/** The Header section of form Contact_Information */
		Header: Tomato.FormContact_Information.Header;
		/** The Navigation of form Contact_Information */
		Navigation: Tomato.FormContact_Information.Navigation;
	}
	class ContactApi {
		/**
