...
define(['xrm-mock', 'sinon'], function (/** @type {XrmMock} */_xrm_mock, /** @type {sinon} */_sinon) {
    describe('devkit_WebApi.webapi.test.js Tests', function () {
        ...
        var fakeUrl = "https://dev-devkit.crm5.dynamics.com";
        var xhr;
        ...
        async function getFromUserId() {
            ...
            var user = new Tomato.SystemUserApi(res.value[0]);
            return user.SystemUserId.Value;
        }

        async function getToContactId() {
        ...
        async function getToAccountId() {
            ...
            req.fetchXml = fetchXml;
            var res = await WebApiClient.Retrieve(req);
            var account = new Tomato.AccountApi(res.value[0]);
        ...
        beforeEach(() => {
            ...
            WebApiClient.GetDefaultHeaders().splice(3, 1);
            xhr = _sinon.fakeServer.create();
            xhr.autoRespond = true;
        });
        describe("Retrieve", () => {
            it("Retrieve STRING", async() => {
                //setup
                var data = {
  ...
  <entity name='devkit_webapi'>
    ...
    <filter type='and'>
      <condition attribute='devkit_name' operator='eq' value='${fetchData.devkit_name}'/>
                ...
                var res = await WebApiClient.Retrieve(req);
                //result
                var webapi = new Tomato.devkit_WebApiApi(res.value[0]);
                //single line of text
            ...
            it("Retrieve PartyList", async() => {
                ...
                var res = await WebApiClient.Retrieve(req);
                //result
                var webapi = new Tomato.EmailApi(res.value[0]);
            ...
            it("Retrieve Alternate Key", async () => {
                //setup
                var data = {
                ...
                //run
                var key = new Tomato.WebApi.AlternateKey("devkit_alternatekey", "KEY-0001");
                var req = new Tomato.WebApi.RetrieveRequest();
                req.alternateKey = [key];
                req.entityName = "devkit_webapi";
                var res = await WebApiClient.Retrieve(req);
                //result
                var webapi = new Tomato.devkit_WebApiApi(res);
        ...
        describe("Insert", () => {
            it("Insert devkit_WebApiApi", async () =>  {
                ...
                //run
                var api = new Tomato.devkit_WebApiApi();
                ...
                var req = new Tomato.WebApi.CreateRequest();
                req.entity = api.Entity;
                req.entityName = api.EntityName;
                var res = await WebApiClient.Create(req);
                //result
            ...
            it("Insert with Activity Party", async () => {
                //setup fromUserId
                var dataFromUserId = {
                ...
                //run
                var fromUserId = await getFromUserId();
                var toContactId = await getToContactId();
                var toAccountId = await getToAccountId();

                var from = new Tomato.ActivityPartyApi();
                ...
                var to1 = new Tomato.ActivityPartyApi();
                ...
                var to2 = new Tomato.ActivityPartyApi();
                ...
                var res = await WebApiClient.Create(req);
                var email = new Tomato.EmailApi(res);
                //send email
                var customRequest = new Tomato.WebApi.CustomRequest();
                ...
                var res2 = await WebApiClient.Execute(customRequest)
                //result
