...
declare namespace Tomato {
	...
	class FormLocation extends DevKit.IForm {
		...
		*/
		...
		Body: Tomato.FormLocation.Body;
		/** The Footer section of form Location */
		Footer: Tomato.FormLocation.Footer;
		/** The Header section of form Location */
		Header: Tomato.FormLocation.Header;
		/** The Navigation of form Location */
		Navigation: Tomato.FormLocation.Navigation;
		/** The QuickForm of form Location */
		QuickForm: Tomato.FormLocation.QuickForm;
		/** The Process of form Location */
		Process: Tomato.FormLocation.Process;
		/** The Grid of form Location */
		Grid: Tomato.FormLocation.Grid;
	}
	...
	class FormQuick_Create_Location extends DevKit.IForm {
		...
		*/
		...
		Body: Tomato.FormQuick_Create_Location.Body;
	}
}
...
//{'JsForm':['Location','Quick Create Location'],'JsWebApi':false,'IsDebugForm':true,'IsDebugWebApi':false,'Version':'2.7.31'}