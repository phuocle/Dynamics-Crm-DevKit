...
(function (DevKit) {
	...
	DevKit.msdyn_propertylogApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_propertylog) {
			var a = msdyn_propertylog[field].a;
			var b = msdyn_propertylog[field].b;
			var c = msdyn_propertylog[field].c;
			var d = msdyn_propertylog[field].d;
			var g = msdyn_propertylog[field].g;
			var r = msdyn_propertylog[field].r;
			msdyn_propertylog[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_propertylog.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_propertylog.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
