...
(function (DevKit) {
	...
	DevKit.msdyn_invoicefrequencydetailApi = function (e) {
		...
		var _msdyn_invoicefrequencydetail = {
		...
		msdyn_invoicefrequencydetail.ODataEntity = e;
		msdyn_invoicefrequencydetail.FormattedValue = {};
		for (var field in _msdyn_invoicefrequencydetail) {
			var a = _msdyn_invoicefrequencydetail[field].a;
			var b = _msdyn_invoicefrequencydetail[field].b;
			var c = _msdyn_invoicefrequencydetail[field].c;
			var d = _msdyn_invoicefrequencydetail[field].d;
			var g = _msdyn_invoicefrequencydetail[field].g;
			var r = _msdyn_invoicefrequencydetail[field].r;
			webApiField(msdyn_invoicefrequencydetail, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_invoicefrequencydetail.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_invoicefrequencydetail.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
