...
declare namespace DevKit {
	namespace FormUII_workflow_Information {
		interface tab__09646B07_3D6F_4D32_AFE9_D4E0D4EAB773_Sections {
			_CDAB4986_A675_4C28_A71C_DFD6CD9DC956: DevKit.Controls.Section;
		}
		interface tab__EEEB4B58_0136_4906_AF09_B4875AD7374B_Sections {
			_F5299BA8_8CB6_4375_9982_F1ECEFE5CAD4: DevKit.Controls.Section;
		}
		interface tab__09646B07_3D6F_4D32_AFE9_D4E0D4EAB773 extends DevKit.Controls.ITab {
			Section: tab__09646B07_3D6F_4D32_AFE9_D4E0D4EAB773_Sections;
		}
		interface tab__EEEB4B58_0136_4906_AF09_B4875AD7374B extends DevKit.Controls.ITab {
		...
		interface Body {
			...
			UII_isForcedWorkflow: DevKit.Controls.Boolean;
	...
	class UII_workflowApi {
		...
		*/
		...
		/** Status of the UII Workflow */
		statecode: OptionSet.UII_workflow.statecode;
		/** Reason for the status of the UII Workflow */
		statuscode: OptionSet.UII_workflow.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Description to hold the information about the workflow. */
			readonly UII_Description: string;
			/** To mark if the workflow is a forced workflow. If it is a forced workflow , it will be executed for every customer session. */
			readonly UII_isForcedWorkflow: string;
			/** The name of the workflow. */
