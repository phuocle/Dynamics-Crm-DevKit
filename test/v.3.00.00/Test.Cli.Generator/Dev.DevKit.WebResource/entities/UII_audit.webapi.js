...
(function (DevKit) {
	...
	DevKit.UII_auditApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in uii_audit) {
			var a = uii_audit[field].a;
			var b = uii_audit[field].b;
			var c = uii_audit[field].c;
			var d = uii_audit[field].d;
			var g = uii_audit[field].g;
			var r = uii_audit[field].r;
			uii_audit[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		uii_audit.Entity = u;
		uii_audit.EntityName = 'uii_audit';
		uii_audit.EntityCollectionName = 'uii_audits';
		uii_audit['@odata.etag'] = e['@odata.etag'];
		uii_audit.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		uii_audit.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
