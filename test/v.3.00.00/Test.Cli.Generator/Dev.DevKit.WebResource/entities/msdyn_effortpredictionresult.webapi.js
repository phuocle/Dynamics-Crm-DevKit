...
(function (DevKit) {
	...
	DevKit.msdyn_effortpredictionresultApi = function (e) {
		...
		var _msdyn_effortpredictionresult = {
			...
			msdyn_effortconfidencescore: { a: 'msdyn_effortconfidencescore' },
			msdyn_effortpredictionresultId: { a: 'msdyn_effortpredictionresultid' },
			...
			msdyn_predictedeffort: { a: 'msdyn_predictedeffort' },
		...
		return msdyn_effortpredictionresult;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
(function (OptionSet) {
	OptionSet.msdyn_effortpredictionresult = {
		ComponentState : {
			Deleted: 2,
