...
(function (DevKit) {
	...
	DevKit.msdyn_transactiontypeApi = function (e) {
		...
		msdyn_transactiontype.ODataEntity = e;
		msdyn_transactiontype.FormattedValue = {};
		for (var field in _msdyn_transactiontype) {
			var a = _msdyn_transactiontype[field].a;
			var b = _msdyn_transactiontype[field].b;
			var c = _msdyn_transactiontype[field].c;
			var d = _msdyn_transactiontype[field].d;
			var g = _msdyn_transactiontype[field].g;
			var r = _msdyn_transactiontype[field].r;
			webApiField(msdyn_transactiontype, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_transactiontype.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_transactiontype.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
