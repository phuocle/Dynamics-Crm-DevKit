...
(function (DevKit) {
	...
	DevKit.msdyn_quotelineanalyticsbreakdownApi = function (e) {
		...
		var _msdyn_quotelineanalyticsbreakdown = {
		...
		msdyn_quotelineanalyticsbreakdown.ODataEntity = e;
		msdyn_quotelineanalyticsbreakdown.FormattedValue = {};
		for (var field in _msdyn_quotelineanalyticsbreakdown) {
			var a = _msdyn_quotelineanalyticsbreakdown[field].a;
			var b = _msdyn_quotelineanalyticsbreakdown[field].b;
			var c = _msdyn_quotelineanalyticsbreakdown[field].c;
			var d = _msdyn_quotelineanalyticsbreakdown[field].d;
			var g = _msdyn_quotelineanalyticsbreakdown[field].g;
			var r = _msdyn_quotelineanalyticsbreakdown[field].r;
			webApiField(msdyn_quotelineanalyticsbreakdown, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotelineanalyticsbreakdown.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_quotelineanalyticsbreakdown.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
