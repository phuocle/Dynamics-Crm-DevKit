...
(function (DevKit) {
	...
	DevKit.MonthlyFiscalCalendarApi = function (e) {
		...
		for (var field in _monthlyfiscalcalendar) {
			var a = _monthlyfiscalcalendar[field].a;
			var b = _monthlyfiscalcalendar[field].b;
			var c = _monthlyfiscalcalendar[field].c;
			var d = _monthlyfiscalcalendar[field].d;
			var g = _monthlyfiscalcalendar[field].g;
			var r = _monthlyfiscalcalendar[field].r;
			webApiField(monthlyfiscalcalendar, field, e, a, b, c, d, r, u, g);
		}
