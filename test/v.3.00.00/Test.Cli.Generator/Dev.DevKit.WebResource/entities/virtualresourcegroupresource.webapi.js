...
(function (DevKit) {
	...
	DevKit.virtualresourcegroupresourceApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in virtualresourcegroupresource) {
			var a = virtualresourcegroupresource[field].a;
			var b = virtualresourcegroupresource[field].b;
			var c = virtualresourcegroupresource[field].c;
			var d = virtualresourcegroupresource[field].d;
			var g = virtualresourcegroupresource[field].g;
			var r = virtualresourcegroupresource[field].r;
			virtualresourcegroupresource[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		virtualresourcegroupresource.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		virtualresourcegroupresource.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
