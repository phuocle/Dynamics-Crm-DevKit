...
(function (DevKit) {
	...
	DevKit.msdyn_resourcerequirementApi = function (e) {
		...
		var _msdyn_resourcerequirement = {
		...
		msdyn_resourcerequirement.ODataEntity = e;
		msdyn_resourcerequirement.FormattedValue = {};
		for (var field in _msdyn_resourcerequirement) {
			var a = _msdyn_resourcerequirement[field].a;
			var b = _msdyn_resourcerequirement[field].b;
			var c = _msdyn_resourcerequirement[field].c;
			var d = _msdyn_resourcerequirement[field].d;
			var g = _msdyn_resourcerequirement[field].g;
			var r = _msdyn_resourcerequirement[field].r;
			webApiField(msdyn_resourcerequirement, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_resourcerequirement.getAliasedValue = function (alias, isMultiOptionSet = false) {
