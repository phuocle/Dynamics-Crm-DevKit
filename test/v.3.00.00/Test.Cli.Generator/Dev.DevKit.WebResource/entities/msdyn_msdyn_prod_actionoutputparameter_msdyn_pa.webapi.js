...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_prod_actionoutputparameter_msdyn_paApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_prod_actionoutputparameter_msdyn_pa) {
			var a = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].a;
			var b = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].b;
			var c = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].c;
			var d = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].d;
			var g = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].g;
			var r = msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field].r;
			msdyn_msdyn_prod_actionoutputparameter_msdyn_pa[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_prod_actionoutputparameter_msdyn_pa.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_prod_actionoutputparameter_msdyn_pa.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
