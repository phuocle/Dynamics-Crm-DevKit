...
(function (DevKit) {
	...
	DevKit.msdyn_migrationtrackerApi = function (e) {
		...
		msdyn_migrationtracker.ODataEntity = e;
		msdyn_migrationtracker.FormattedValue = {};
		for (var field in _msdyn_migrationtracker) {
			var a = _msdyn_migrationtracker[field].a;
			var b = _msdyn_migrationtracker[field].b;
			var c = _msdyn_migrationtracker[field].c;
			var d = _msdyn_migrationtracker[field].d;
			var g = _msdyn_migrationtracker[field].g;
			var r = _msdyn_migrationtracker[field].r;
			webApiField(msdyn_migrationtracker, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_migrationtracker.getAliasedValue = function (alias, isMultiOptionSet = false) {
