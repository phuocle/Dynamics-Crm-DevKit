...
(function (DevKit) {
	...
	DevKit.msdyn_leadmodelconfigApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_leadmodelconfig) {
			var a = msdyn_leadmodelconfig[field].a;
			var b = msdyn_leadmodelconfig[field].b;
			var c = msdyn_leadmodelconfig[field].c;
			var d = msdyn_leadmodelconfig[field].d;
			var g = msdyn_leadmodelconfig[field].g;
			var r = msdyn_leadmodelconfig[field].r;
			msdyn_leadmodelconfig[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_leadmodelconfig.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_leadmodelconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
