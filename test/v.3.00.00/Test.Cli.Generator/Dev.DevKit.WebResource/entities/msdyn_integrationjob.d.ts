...
declare namespace DevKit {
	...
	class Formmsdyn_integrationjob_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_integrationjob_Information.Body;
		/** The Process of form msdyn_integrationjob_Information */
		Process: DevKit.Formmsdyn_integrationjob_Information.Process;
		/** The SidePanes of form msdyn_integrationjob_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_integrationjobApi {
		/**
		* DynamicsCrm.DevKit msdyn_integrationjobApi
		...
		*/
		...
		msdyn_Status: OptionSet.msdyn_integrationjob.msdyn_Status;
		/** The type of integration job */
		msdyn_Type: OptionSet.msdyn_integrationjob.msdyn_Type;
		...
		statecode: OptionSet.msdyn_integrationjob.statecode;
		/** Reason for the status of the Integration Job */
		statuscode: OptionSet.msdyn_integrationjob.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyn_integrationjobId: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** The expected number of packets to be received. */
			readonly msdyn_NumberOfPackets: string;
			/** The logical name of entity related to the integration job */
			readonly msdyn_RegardingEntity: string;
			/** The primary id of entity related to the integration job */
			readonly msdyn_RegardingEntityId: string;
			/** The response of the integration job in JSON format */
			readonly msdyn_ResponseJSON: string;
			/** The status of the integration job. */
