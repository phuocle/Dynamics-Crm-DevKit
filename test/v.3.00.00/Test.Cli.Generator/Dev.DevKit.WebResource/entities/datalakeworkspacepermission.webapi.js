...
(function (DevKit) {
	...
	DevKit.datalakeworkspacepermissionApi = function (e) {
		...
		var _datalakeworkspacepermission = {
			appid: { a: 'appid' },
		...
		datalakeworkspacepermission.ODataEntity = e;
		datalakeworkspacepermission.FormattedValue = {};
		for (var field in _datalakeworkspacepermission) {
			var a = _datalakeworkspacepermission[field].a;
			var b = _datalakeworkspacepermission[field].b;
			var c = _datalakeworkspacepermission[field].c;
			var d = _datalakeworkspacepermission[field].d;
			var g = _datalakeworkspacepermission[field].g;
			var r = _datalakeworkspacepermission[field].r;
			webApiField(datalakeworkspacepermission, field, e, a, b, c, d, r, u, g);
		}
		...
		datalakeworkspacepermission.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		datalakeworkspacepermission.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
