...
(function (DevKit) {
	...
	DevKit.msdyn_ocfbpageApi = function (e) {
		...
		var u = {};
		var msdyn_ocfbpage = {};
		msdyn_ocfbpage.ODataEntity = e;
		msdyn_ocfbpage.FormattedValue = {};
		for (var field in _msdyn_ocfbpage) {
			var a = _msdyn_ocfbpage[field].a;
			var b = _msdyn_ocfbpage[field].b;
			var c = _msdyn_ocfbpage[field].c;
			var d = _msdyn_ocfbpage[field].d;
			var g = _msdyn_ocfbpage[field].g;
			var r = _msdyn_ocfbpage[field].r;
			webApiField(msdyn_ocfbpage, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocfbpage.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_ocfbpage.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
