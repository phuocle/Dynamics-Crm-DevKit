...
(function (DevKit) {
	...
	DevKit.msdyn_rtvApi = function (e) {
		...
		var u = {};
		var msdyn_rtv = {};
		msdyn_rtv.ODataEntity = e;
		msdyn_rtv.FormattedValue = {};
		for (var field in _msdyn_rtv) {
			var a = _msdyn_rtv[field].a;
			var b = _msdyn_rtv[field].b;
			var c = _msdyn_rtv[field].c;
			var d = _msdyn_rtv[field].d;
			var g = _msdyn_rtv[field].g;
			var r = _msdyn_rtv[field].r;
			webApiField(msdyn_rtv, field, e, a, b, c, d, r, u, g);
		}
		msdyn_rtv.Entity = u;
		msdyn_rtv.EntityName = 'msdyn_rtv';
		msdyn_rtv.EntityCollectionName = 'msdyn_rtvs';
		msdyn_rtv['@odata.etag'] = e['@odata.etag'];
		msdyn_rtv.getAliasedValue = function (alias, isMultiOptionSet = false) {
