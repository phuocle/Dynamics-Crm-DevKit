...
(function (DevKit) {
	...
	DevKit.msdyn_productivityagentscriptstepApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_productivityagentscriptstep) {
			var a = msdyn_productivityagentscriptstep[field].a;
			var b = msdyn_productivityagentscriptstep[field].b;
			var c = msdyn_productivityagentscriptstep[field].c;
			var d = msdyn_productivityagentscriptstep[field].d;
			var g = msdyn_productivityagentscriptstep[field].g;
			var r = msdyn_productivityagentscriptstep[field].r;
			msdyn_productivityagentscriptstep[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_productivityagentscriptstep.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_productivityagentscriptstep.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
