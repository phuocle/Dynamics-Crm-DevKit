...
declare namespace DevKit {
	...
	class msdyusd_ucisettingsApi {
		...
		*/
		...
		/** The name of the Unified Interface Settings record */
		msdyusd_name: string;
		msdyusd_theme: OptionSet.msdyusd_ucisettings.msdyusd_theme;
		...
		statecode: OptionSet.msdyusd_ucisettings.statecode;
		/** Reason for the status of the UCI Settings */
		statuscode: OptionSet.msdyusd_ucisettings.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyusd_theme: string;
			/** Saves the selected Unified Interface App Name */
			readonly msdyusd_UCIApp: string;
			/** Saves the selected Unified Interface App Id */
			readonly msdyusd_UCIAppId: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_ucisettingsId: string;
			/** Date and time that the record was migrated. */
