...
(function (DevKit) {
	...
	DevKit.msdyn_opportunitymodelconfigApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_opportunitymodelconfig) {
			var a = msdyn_opportunitymodelconfig[field].a;
			var b = msdyn_opportunitymodelconfig[field].b;
			var c = msdyn_opportunitymodelconfig[field].c;
			var d = msdyn_opportunitymodelconfig[field].d;
			var g = msdyn_opportunitymodelconfig[field].g;
			var r = msdyn_opportunitymodelconfig[field].r;
			msdyn_opportunitymodelconfig[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_opportunitymodelconfig.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_opportunitymodelconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
