...
(function (DevKit) {
	...
	DevKit.msdyn_projectApi = function (e) {
		...
		var u = {};
		var msdyn_project = {};
		msdyn_project.ODataEntity = e;
		msdyn_project.FormattedValue = {};
		for (var field in _msdyn_project) {
			var a = _msdyn_project[field].a;
			var b = _msdyn_project[field].b;
			var c = _msdyn_project[field].c;
			var d = _msdyn_project[field].d;
			var g = _msdyn_project[field].g;
			var r = _msdyn_project[field].r;
			webApiField(msdyn_project, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_project.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_project.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
