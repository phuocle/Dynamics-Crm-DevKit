...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_customerasset_knowledgebasereApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_customerasset_knowledgebasere) {
			var a = msdyn_msdyn_customerasset_knowledgebasere[field].a;
			var b = msdyn_msdyn_customerasset_knowledgebasere[field].b;
			var c = msdyn_msdyn_customerasset_knowledgebasere[field].c;
			var d = msdyn_msdyn_customerasset_knowledgebasere[field].d;
			var g = msdyn_msdyn_customerasset_knowledgebasere[field].g;
			var r = msdyn_msdyn_customerasset_knowledgebasere[field].r;
			msdyn_msdyn_customerasset_knowledgebasere[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_customerasset_knowledgebasere.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_customerasset_knowledgebasere.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
