...
(function (DevKit) {
	...
	DevKit.msdyn_iotdevicecommandApi = function (e) {
		...
		msdyn_iotdevicecommand.ODataEntity = e;
		msdyn_iotdevicecommand.FormattedValue = {};
		for (var field in _msdyn_iotdevicecommand) {
			var a = _msdyn_iotdevicecommand[field].a;
			var b = _msdyn_iotdevicecommand[field].b;
			var c = _msdyn_iotdevicecommand[field].c;
			var d = _msdyn_iotdevicecommand[field].d;
			var g = _msdyn_iotdevicecommand[field].g;
			var r = _msdyn_iotdevicecommand[field].r;
			webApiField(msdyn_iotdevicecommand, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_iotdevicecommand.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_iotdevicecommand.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
