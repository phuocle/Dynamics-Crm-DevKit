...
(function (DevKit) {
	...
	DevKit.msdyn_journallineApi = function (e) {
		...
		msdyn_journalline.ODataEntity = e;
		msdyn_journalline.FormattedValue = {};
		for (var field in _msdyn_journalline) {
			var a = _msdyn_journalline[field].a;
			var b = _msdyn_journalline[field].b;
			var c = _msdyn_journalline[field].c;
			var d = _msdyn_journalline[field].d;
			var g = _msdyn_journalline[field].g;
			var r = _msdyn_journalline[field].r;
			webApiField(msdyn_journalline, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_journalline.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_journalline.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
