...
declare namespace DevKit {
	class ServicePlanMappingApi {
		/**
		* DynamicsCrm.DevKit ServicePlanMappingApi
		...
		*/
		...
		Entity1: DevKit.WebApi.LookupValue;
		...
		FeatureControl: DevKit.WebApi.StringValue;
