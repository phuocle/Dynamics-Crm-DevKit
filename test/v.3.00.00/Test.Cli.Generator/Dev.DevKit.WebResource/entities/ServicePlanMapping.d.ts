...
declare namespace DevKit {
	class ServicePlanMappingApi {
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ServicePlanMapping.ComponentState;
		...
		statecode: OptionSet.ServicePlanMapping.statecode;
		/** Reason for the status of the Service Plan Mapping */
		statuscode: OptionSet.ServicePlanMapping.statuscode;
		/** For internal use only. */
