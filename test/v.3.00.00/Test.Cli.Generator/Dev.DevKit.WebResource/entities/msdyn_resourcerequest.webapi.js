...
(function (DevKit) {
	...
	DevKit.msdyn_resourcerequestApi = function (e) {
		...
		msdyn_resourcerequest.ODataEntity = e;
		msdyn_resourcerequest.FormattedValue = {};
		for (var field in _msdyn_resourcerequest) {
			var a = _msdyn_resourcerequest[field].a;
			var b = _msdyn_resourcerequest[field].b;
			var c = _msdyn_resourcerequest[field].c;
			var d = _msdyn_resourcerequest[field].d;
			var g = _msdyn_resourcerequest[field].g;
			var r = _msdyn_resourcerequest[field].r;
			webApiField(msdyn_resourcerequest, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_resourcerequest.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_resourcerequest.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
