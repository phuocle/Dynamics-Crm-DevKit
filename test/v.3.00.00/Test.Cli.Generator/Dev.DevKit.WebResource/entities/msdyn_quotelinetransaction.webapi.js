...
(function (DevKit) {
	...
	DevKit.msdyn_quotelinetransactionApi = function (e) {
		...
		var _msdyn_quotelinetransaction = {
		...
		msdyn_quotelinetransaction.ODataEntity = e;
		msdyn_quotelinetransaction.FormattedValue = {};
		for (var field in _msdyn_quotelinetransaction) {
			var a = _msdyn_quotelinetransaction[field].a;
			var b = _msdyn_quotelinetransaction[field].b;
			var c = _msdyn_quotelinetransaction[field].c;
			var d = _msdyn_quotelinetransaction[field].d;
			var g = _msdyn_quotelinetransaction[field].g;
			var r = _msdyn_quotelinetransaction[field].r;
			webApiField(msdyn_quotelinetransaction, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_quotelinetransaction.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_quotelinetransaction.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
