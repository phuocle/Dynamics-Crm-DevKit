...
(function (DevKit) {
	...
	DevKit.SystemFormApi = function (e) {
		...
		for (var field in _systemform) {
			var a = _systemform[field].a;
			var b = _systemform[field].b;
			var c = _systemform[field].c;
			var d = _systemform[field].d;
			var g = _systemform[field].g;
			var r = _systemform[field].r;
			webApiField(systemform, field, e, a, b, c, d, r, u, g);
		}
		systemform.Entity = u;
