...
(function (DevKit) {
	...
	DevKit.BulkOperationApi = function (e) {
		...
		var u = {};
		var bulkoperation = {};
		bulkoperation.ODataEntity = e;
		bulkoperation.FormattedValue = {};
		for (var field in _bulkoperation) {
			var a = _bulkoperation[field].a;
			var b = _bulkoperation[field].b;
			var c = _bulkoperation[field].c;
			var d = _bulkoperation[field].d;
			var g = _bulkoperation[field].g;
			var r = _bulkoperation[field].r;
			webApiField(bulkoperation, field, e, a, b, c, d, r, u, g);
		}
		...
		bulkoperation.getAliasedValue = function (alias, isMultiOptionSet = false) {
