...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_orderlinetransactionApi = function (e) {
		...
		var _msdyn_orderlinetransaction = {
			...
			msdyn_orderlinetransactionId: { a: 'msdyn_orderlinetransactionid' },
			msdyn_Origin: { b: 'msdyn_Origin', a: '_msdyn_origin_value', c: 'msdyn_orderlinetransactions', d: 'msdyn_orderlinetransaction' },
			...
			msdyn_QuoteLineTransactionId: { b: 'msdyn_QuoteLineTransactionId', a: '_msdyn_quotelinetransactionid_value', c: 'msdyn_quotelinetransactions', d: 'msdyn_quotelinetransaction' },
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_orderlinetransaction = {};
		msdyn_orderlinetransaction.ODataEntity = e;
		msdyn_orderlinetransaction.FormattedValue = {};
		for (var field in _msdyn_orderlinetransaction) {
			var a = _msdyn_orderlinetransaction[field].a;
			var b = _msdyn_orderlinetransaction[field].b;
			var c = _msdyn_orderlinetransaction[field].c;
			var d = _msdyn_orderlinetransaction[field].d;
			var g = _msdyn_orderlinetransaction[field].g;
			var r = _msdyn_orderlinetransaction[field].r;
			webApiField(msdyn_orderlinetransaction, field, e, a, b, c, d, r, u, g);
		}
		msdyn_orderlinetransaction.Entity = u;
		msdyn_orderlinetransaction.EntityName = 'msdyn_orderlinetransaction';
		msdyn_orderlinetransaction.EntityCollectionName = 'msdyn_orderlinetransactions';
		msdyn_orderlinetransaction['@odata.etag'] = e['@odata.etag'];
		msdyn_orderlinetransaction.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_orderlinetransaction.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
		...
		return msdyn_orderlinetransaction;
	};
})(DevKit || (DevKit = {}));
/** @namespace OptionSet */
var OptionSet;
