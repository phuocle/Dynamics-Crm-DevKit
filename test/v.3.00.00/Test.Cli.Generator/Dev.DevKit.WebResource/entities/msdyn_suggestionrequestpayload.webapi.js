...
(function (DevKit) {
	...
	DevKit.msdyn_suggestionrequestpayloadApi = function (e) {
		...
		var _msdyn_suggestionrequestpayload = {
		...
		msdyn_suggestionrequestpayload.ODataEntity = e;
		msdyn_suggestionrequestpayload.FormattedValue = {};
		for (var field in _msdyn_suggestionrequestpayload) {
			var a = _msdyn_suggestionrequestpayload[field].a;
			var b = _msdyn_suggestionrequestpayload[field].b;
			var c = _msdyn_suggestionrequestpayload[field].c;
			var d = _msdyn_suggestionrequestpayload[field].d;
			var g = _msdyn_suggestionrequestpayload[field].g;
			var r = _msdyn_suggestionrequestpayload[field].r;
			webApiField(msdyn_suggestionrequestpayload, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_suggestionrequestpayload.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_suggestionrequestpayload.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
