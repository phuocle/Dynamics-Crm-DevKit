...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_prod_agentscript_msdyn_sessiontemplApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_prod_agentscript_msdyn_sessiontempl) {
			var a = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].a;
			var b = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].b;
			var c = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].c;
			var d = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].d;
			var g = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].g;
			var r = msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field].r;
			msdyn_msdyn_prod_agentscript_msdyn_sessiontempl[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_prod_agentscript_msdyn_sessiontempl.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_prod_agentscript_msdyn_sessiontempl.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
