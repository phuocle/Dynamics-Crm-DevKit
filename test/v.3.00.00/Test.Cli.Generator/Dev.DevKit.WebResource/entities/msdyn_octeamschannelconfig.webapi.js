...
(function (DevKit) {
	...
	DevKit.msdyn_octeamschannelconfigApi = function (e) {
		...
		var _msdyn_octeamschannelconfig = {
		...
		msdyn_octeamschannelconfig.ODataEntity = e;
		msdyn_octeamschannelconfig.FormattedValue = {};
		for (var field in _msdyn_octeamschannelconfig) {
			var a = _msdyn_octeamschannelconfig[field].a;
			var b = _msdyn_octeamschannelconfig[field].b;
			var c = _msdyn_octeamschannelconfig[field].c;
			var d = _msdyn_octeamschannelconfig[field].d;
			var g = _msdyn_octeamschannelconfig[field].g;
			var r = _msdyn_octeamschannelconfig[field].r;
			webApiField(msdyn_octeamschannelconfig, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_octeamschannelconfig.getAliasedValue = function (alias, isMultiOptionSet = false) {
