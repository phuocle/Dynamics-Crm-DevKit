...
(function (DevKit) {
	...
	DevKit.msdyn_predictivemodelscoreApi = function (e) {
		...
		var _msdyn_predictivemodelscore = {
		...
		msdyn_predictivemodelscore.ODataEntity = e;
		msdyn_predictivemodelscore.FormattedValue = {};
		for (var field in _msdyn_predictivemodelscore) {
			var a = _msdyn_predictivemodelscore[field].a;
			var b = _msdyn_predictivemodelscore[field].b;
			var c = _msdyn_predictivemodelscore[field].c;
			var d = _msdyn_predictivemodelscore[field].d;
			var g = _msdyn_predictivemodelscore[field].g;
			var r = _msdyn_predictivemodelscore[field].r;
			webApiField(msdyn_predictivemodelscore, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_predictivemodelscore.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_predictivemodelscore.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
