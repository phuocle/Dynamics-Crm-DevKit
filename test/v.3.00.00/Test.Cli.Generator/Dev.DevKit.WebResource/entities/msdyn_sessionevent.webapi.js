...
(function (DevKit) {
	...
	DevKit.msdyn_sessioneventApi = function (e) {
		...
		msdyn_sessionevent.ODataEntity = e;
		msdyn_sessionevent.FormattedValue = {};
		for (var field in _msdyn_sessionevent) {
			var a = _msdyn_sessionevent[field].a;
			var b = _msdyn_sessionevent[field].b;
			var c = _msdyn_sessionevent[field].c;
			var d = _msdyn_sessionevent[field].d;
			var g = _msdyn_sessionevent[field].g;
			var r = _msdyn_sessionevent[field].r;
			webApiField(msdyn_sessionevent, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_sessionevent.getAliasedValue = function (alias, isMultiOptionSet = false) {
