...
(function (DevKit) {
	...
	DevKit.msdyn_purchaseorderApi = function (e) {
		...
		msdyn_purchaseorder.ODataEntity = e;
		msdyn_purchaseorder.FormattedValue = {};
		for (var field in _msdyn_purchaseorder) {
			var a = _msdyn_purchaseorder[field].a;
			var b = _msdyn_purchaseorder[field].b;
			var c = _msdyn_purchaseorder[field].c;
			var d = _msdyn_purchaseorder[field].d;
			var g = _msdyn_purchaseorder[field].g;
			var r = _msdyn_purchaseorder[field].r;
			webApiField(msdyn_purchaseorder, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_purchaseorder.getAliasedValue = function (alias, isMultiOptionSet = false) {
