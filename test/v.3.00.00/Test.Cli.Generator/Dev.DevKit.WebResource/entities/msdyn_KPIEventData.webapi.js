...
(function (DevKit) {
	...
	DevKit.msdyn_KPIEventDataApi = function (e) {
		...
		msdyn_kpieventdata.ODataEntity = e;
		msdyn_kpieventdata.FormattedValue = {};
		for (var field in _msdyn_kpieventdata) {
			var a = _msdyn_kpieventdata[field].a;
			var b = _msdyn_kpieventdata[field].b;
			var c = _msdyn_kpieventdata[field].c;
			var d = _msdyn_kpieventdata[field].d;
			var g = _msdyn_kpieventdata[field].g;
			var r = _msdyn_kpieventdata[field].r;
			webApiField(msdyn_kpieventdata, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_kpieventdata.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_kpieventdata.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
