...
(function (DevKit) {
	...
	DevKit.msdyn_projectapprovalApi = function (e) {
		...
		msdyn_projectapproval.ODataEntity = e;
		msdyn_projectapproval.FormattedValue = {};
		for (var field in _msdyn_projectapproval) {
			var a = _msdyn_projectapproval[field].a;
			var b = _msdyn_projectapproval[field].b;
			var c = _msdyn_projectapproval[field].c;
			var d = _msdyn_projectapproval[field].d;
			var g = _msdyn_projectapproval[field].g;
			var r = _msdyn_projectapproval[field].r;
			webApiField(msdyn_projectapproval, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projectapproval.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_projectapproval.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
