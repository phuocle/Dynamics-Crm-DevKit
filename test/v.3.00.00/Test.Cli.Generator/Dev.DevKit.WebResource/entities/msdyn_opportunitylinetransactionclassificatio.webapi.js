...
(function (DevKit) {
	...
	DevKit.msdyn_opportunitylinetransactionclassificatioApi = function (e) {
		...
		var _msdyn_opportunitylinetransactionclassificatio = {
		...
		msdyn_opportunitylinetransactionclassificatio.ODataEntity = e;
		msdyn_opportunitylinetransactionclassificatio.FormattedValue = {};
		for (var field in _msdyn_opportunitylinetransactionclassificatio) {
			var a = _msdyn_opportunitylinetransactionclassificatio[field].a;
			var b = _msdyn_opportunitylinetransactionclassificatio[field].b;
			var c = _msdyn_opportunitylinetransactionclassificatio[field].c;
			var d = _msdyn_opportunitylinetransactionclassificatio[field].d;
			var g = _msdyn_opportunitylinetransactionclassificatio[field].g;
			var r = _msdyn_opportunitylinetransactionclassificatio[field].r;
			webApiField(msdyn_opportunitylinetransactionclassificatio, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_opportunitylinetransactionclassificatio.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_opportunitylinetransactionclassificatio.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
