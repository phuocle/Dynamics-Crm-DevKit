...
(function (DevKit) {
	...
	DevKit.msdyn_pminferredtaskApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_pminferredtask) {
			var a = msdyn_pminferredtask[field].a;
			var b = msdyn_pminferredtask[field].b;
			var c = msdyn_pminferredtask[field].c;
			var d = msdyn_pminferredtask[field].d;
			var g = msdyn_pminferredtask[field].g;
			var r = msdyn_pminferredtask[field].r;
			msdyn_pminferredtask[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_pminferredtask.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_pminferredtask.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
