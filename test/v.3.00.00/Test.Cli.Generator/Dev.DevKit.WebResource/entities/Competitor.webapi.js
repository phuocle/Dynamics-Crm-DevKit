...
(function (DevKit) {
	'use strict';
	DevKit.CompetitorApi = function (e) {
		...
		var u = {};
		var competitor = {};
		competitor.ODataEntity = e;
		competitor.FormattedValue = {};
		for (var field in _competitor) {
			var a = _competitor[field].a;
			var b = _competitor[field].b;
			var c = _competitor[field].c;
			var d = _competitor[field].d;
			var g = _competitor[field].g;
			var r = _competitor[field].r;
			webApiField(competitor, field, e, a, b, c, d, r, u, g);
		}
		competitor.Entity = u;
		competitor.EntityName = 'competitor';
		competitor.EntityCollectionName = 'competitors';
		competitor['@odata.etag'] = e['@odata.etag'];
		competitor.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		competitor.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
