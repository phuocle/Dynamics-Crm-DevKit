...
declare namespace DevKit {
	...
	class msfp_fileresponseApi {
		...
		*/
		...
		/** First uploaded file. */
		readonly msfp_file1: string;
		/** Tenth uploaded file. */
		readonly msfp_file10: string;
		/** Second uploaded file. */
		readonly msfp_file2: string;
		/** Third uploaded file. */
		readonly msfp_file3: string;
		/** Fourth uploaded file. */
		readonly msfp_file4: string;
		/** Fifth uploaded file. */
		readonly msfp_file5: string;
		/** Sixth uploaded file. */
		readonly msfp_file6: string;
		/** Seventh uploaded file. */
		readonly msfp_file7: string;
		/** Eighth uploaded file. */
		readonly msfp_file8: string;
		/** Ninth uploaded file. */
		readonly msfp_file9: string;
