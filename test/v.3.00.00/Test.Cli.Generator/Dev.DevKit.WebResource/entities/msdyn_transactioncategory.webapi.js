...
(function (DevKit) {
	...
	DevKit.msdyn_transactioncategoryApi = function (e) {
		...
		var _msdyn_transactioncategory = {
		...
		msdyn_transactioncategory.ODataEntity = e;
		msdyn_transactioncategory.FormattedValue = {};
		for (var field in _msdyn_transactioncategory) {
			var a = _msdyn_transactioncategory[field].a;
			var b = _msdyn_transactioncategory[field].b;
			var c = _msdyn_transactioncategory[field].c;
			var d = _msdyn_transactioncategory[field].d;
			var g = _msdyn_transactioncategory[field].g;
			var r = _msdyn_transactioncategory[field].r;
			webApiField(msdyn_transactioncategory, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_transactioncategory.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_transactioncategory.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
