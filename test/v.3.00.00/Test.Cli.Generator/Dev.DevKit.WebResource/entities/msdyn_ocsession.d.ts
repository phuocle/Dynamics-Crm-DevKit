	...
	class msdyn_ocsessionApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_msdyn_processnotes_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_msdyn_productinventory_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_msdyn_projectteam_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			...
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_action_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_hostedapplication_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_nonhostedapplication_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_option_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_savedsession_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_workflow_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_workflowstep_msdyn_ocsession: string;
			/** Unique identifier of the object with which the activity is associated. */
			readonly regardingobjectid_uii_workflow_workflowstep_mapping_msdyn_ocsession: string;
			/** Scheduled duration of the activity, specified in minutes. */
