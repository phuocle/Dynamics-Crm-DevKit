...
(function (DevKit) {
	...
	DevKit.msdyn_ocwhatsappchannelaccountApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocwhatsappchannelaccount) {
			var a = msdyn_ocwhatsappchannelaccount[field].a;
			var b = msdyn_ocwhatsappchannelaccount[field].b;
			var c = msdyn_ocwhatsappchannelaccount[field].c;
			var d = msdyn_ocwhatsappchannelaccount[field].d;
			var g = msdyn_ocwhatsappchannelaccount[field].g;
			var r = msdyn_ocwhatsappchannelaccount[field].r;
			msdyn_ocwhatsappchannelaccount[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocwhatsappchannelaccount.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocwhatsappchannelaccount.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
