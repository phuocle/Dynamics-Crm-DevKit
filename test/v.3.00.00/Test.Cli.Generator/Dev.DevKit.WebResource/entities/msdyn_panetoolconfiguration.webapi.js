...
(function (DevKit) {
	...
	DevKit.msdyn_panetoolconfigurationApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_panetoolconfiguration) {
			var a = msdyn_panetoolconfiguration[field].a;
			var b = msdyn_panetoolconfiguration[field].b;
			var c = msdyn_panetoolconfiguration[field].c;
			var d = msdyn_panetoolconfiguration[field].d;
			var g = msdyn_panetoolconfiguration[field].g;
			var r = msdyn_panetoolconfiguration[field].r;
			msdyn_panetoolconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_panetoolconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_panetoolconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
