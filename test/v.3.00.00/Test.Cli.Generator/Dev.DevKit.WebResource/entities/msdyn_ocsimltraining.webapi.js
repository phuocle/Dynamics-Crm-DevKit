...
(function (DevKit) {
	...
	DevKit.msdyn_ocsimltrainingApi = function (e) {
		...
		msdyn_ocsimltraining.ODataEntity = e;
		msdyn_ocsimltraining.FormattedValue = {};
		for (var field in _msdyn_ocsimltraining) {
			var a = _msdyn_ocsimltraining[field].a;
			var b = _msdyn_ocsimltraining[field].b;
			var c = _msdyn_ocsimltraining[field].c;
			var d = _msdyn_ocsimltraining[field].d;
			var g = _msdyn_ocsimltraining[field].g;
			var r = _msdyn_ocsimltraining[field].r;
			webApiField(msdyn_ocsimltraining, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocsimltraining.getAliasedValue = function (alias, isMultiOptionSet = false) {
