...
(function (DevKit) {
	...
	DevKit.msdyn_projectparameterApi = function (e) {
		...
		msdyn_projectparameter.ODataEntity = e;
		msdyn_projectparameter.FormattedValue = {};
		for (var field in _msdyn_projectparameter) {
			var a = _msdyn_projectparameter[field].a;
			var b = _msdyn_projectparameter[field].b;
			var c = _msdyn_projectparameter[field].c;
			var d = _msdyn_projectparameter[field].d;
			var g = _msdyn_projectparameter[field].g;
			var r = _msdyn_projectparameter[field].r;
			webApiField(msdyn_projectparameter, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projectparameter.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_projectparameter.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
