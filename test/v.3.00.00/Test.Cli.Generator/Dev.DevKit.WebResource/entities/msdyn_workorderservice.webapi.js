...
(function (DevKit) {
	...
	DevKit.msdyn_workorderserviceApi = function (e) {
		...
		msdyn_workorderservice.ODataEntity = e;
		msdyn_workorderservice.FormattedValue = {};
		for (var field in _msdyn_workorderservice) {
			var a = _msdyn_workorderservice[field].a;
			var b = _msdyn_workorderservice[field].b;
			var c = _msdyn_workorderservice[field].c;
			var d = _msdyn_workorderservice[field].d;
			var g = _msdyn_workorderservice[field].g;
			var r = _msdyn_workorderservice[field].r;
			webApiField(msdyn_workorderservice, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_workorderservice.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_workorderservice.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
