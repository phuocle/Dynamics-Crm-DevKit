...
(function (DevKit) {
	...
	DevKit.msdyn_projecttaskApi = function (e) {
		...
		msdyn_projecttask.ODataEntity = e;
		msdyn_projecttask.FormattedValue = {};
		for (var field in _msdyn_projecttask) {
			var a = _msdyn_projecttask[field].a;
			var b = _msdyn_projecttask[field].b;
			var c = _msdyn_projecttask[field].c;
			var d = _msdyn_projecttask[field].d;
			var g = _msdyn_projecttask[field].g;
			var r = _msdyn_projecttask[field].r;
			webApiField(msdyn_projecttask, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projecttask.getAliasedValue = function (alias, isMultiOptionSet = false) {
