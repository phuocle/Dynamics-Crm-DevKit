...
declare namespace DevKit {
	...
	class msdyusd_agentscripttaskcategoryApi {
		...
		*/
		...
		/** Status of the Agent Script Task Category */
		statecode: OptionSet.msdyusd_agentscripttaskcategory.statecode;
		/** Reason for the status of the Agent Script Task Category */
		statuscode: OptionSet.msdyusd_agentscripttaskcategory.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_agentscripttaskcategoryId: string;
			/** The name of the custom entity. */
