...
(function (DevKit) {
	...
	DevKit.msdyn_orderlinetransactioncategoryApi = function (e) {
		...
		var _msdyn_orderlinetransactioncategory = {
		...
		msdyn_orderlinetransactioncategory.ODataEntity = e;
		msdyn_orderlinetransactioncategory.FormattedValue = {};
		for (var field in _msdyn_orderlinetransactioncategory) {
			var a = _msdyn_orderlinetransactioncategory[field].a;
			var b = _msdyn_orderlinetransactioncategory[field].b;
			var c = _msdyn_orderlinetransactioncategory[field].c;
			var d = _msdyn_orderlinetransactioncategory[field].d;
			var g = _msdyn_orderlinetransactioncategory[field].g;
			var r = _msdyn_orderlinetransactioncategory[field].r;
			webApiField(msdyn_orderlinetransactioncategory, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_orderlinetransactioncategory.getAliasedValue = function (alias, isMultiOptionSet = false) {
