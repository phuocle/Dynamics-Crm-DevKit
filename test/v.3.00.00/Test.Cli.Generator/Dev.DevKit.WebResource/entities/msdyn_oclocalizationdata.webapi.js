...
(function (DevKit) {
	...
	DevKit.msdyn_oclocalizationdataApi = function (e) {
		...
		msdyn_oclocalizationdata.ODataEntity = e;
		msdyn_oclocalizationdata.FormattedValue = {};
		for (var field in _msdyn_oclocalizationdata) {
			var a = _msdyn_oclocalizationdata[field].a;
			var b = _msdyn_oclocalizationdata[field].b;
			var c = _msdyn_oclocalizationdata[field].c;
			var d = _msdyn_oclocalizationdata[field].d;
			var g = _msdyn_oclocalizationdata[field].g;
			var r = _msdyn_oclocalizationdata[field].r;
			webApiField(msdyn_oclocalizationdata, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_oclocalizationdata.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_oclocalizationdata.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
