...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_actualApi = function (e) {
		...
		var u = {};
		var msdyn_actual = {};
		msdyn_actual.ODataEntity = e;
		msdyn_actual.FormattedValue = {};
		for (var field in _msdyn_actual) {
			var a = _msdyn_actual[field].a;
			var b = _msdyn_actual[field].b;
			var c = _msdyn_actual[field].c;
			var d = _msdyn_actual[field].d;
			var g = _msdyn_actual[field].g;
			var r = _msdyn_actual[field].r;
			webApiField(msdyn_actual, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_actual.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_actual.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
