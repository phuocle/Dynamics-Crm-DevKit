...
(function (DevKit) {
	...
	DevKit.SalesOrderApi = function (e) {
		...
		var u = {};
		var salesorder = {};
		salesorder.ODataEntity = e;
		salesorder.FormattedValue = {};
		for (var field in _salesorder) {
			var a = _salesorder[field].a;
			var b = _salesorder[field].b;
			var c = _salesorder[field].c;
			var d = _salesorder[field].d;
			var g = _salesorder[field].g;
			var r = _salesorder[field].r;
			webApiField(salesorder, field, e, a, b, c, d, r, u, g);
		}
		salesorder.Entity = u;
		salesorder.EntityName = 'salesorder';
		salesorder.EntityCollectionName = 'salesorders';
		salesorder['@odata.etag'] = e['@odata.etag'];
		salesorder.getAliasedValue = function (alias, isMultiOptionSet = false) {
