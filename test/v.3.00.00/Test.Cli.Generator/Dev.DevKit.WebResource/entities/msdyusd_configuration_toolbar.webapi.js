...
(function (DevKit) {
	...
	DevKit.msdyusd_configuration_toolbarApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyusd_configuration_toolbar) {
			var a = msdyusd_configuration_toolbar[field].a;
			var b = msdyusd_configuration_toolbar[field].b;
			var c = msdyusd_configuration_toolbar[field].c;
			var d = msdyusd_configuration_toolbar[field].d;
			var g = msdyusd_configuration_toolbar[field].g;
			var r = msdyusd_configuration_toolbar[field].r;
			msdyusd_configuration_toolbar[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyusd_configuration_toolbar.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyusd_configuration_toolbar.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
