...
declare namespace DevKit {
	...
	class msdyusd_entityassignmentApi {
		...
		*/
		...
		/** Status of the Entity Numeric Mapping */
		statecode: OptionSet.msdyusd_entityassignment.statecode;
		/** Reason for the status of the Entity Numeric Mapping */
		statuscode: OptionSet.msdyusd_entityassignment.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_entityassignmentId: string;
			/** The name of the custom entity. */
			readonly msdyusd_name: string;
			readonly msdyusd_NumericCode: string;
			/** Date and time that the record was migrated. */
