...
(function (DevKit) {
	...
	DevKit.SdkMessageResponseFieldApi = function (e) {
		...
		for (var field in _sdkmessageresponsefield) {
			var a = _sdkmessageresponsefield[field].a;
			var b = _sdkmessageresponsefield[field].b;
			var c = _sdkmessageresponsefield[field].c;
			var d = _sdkmessageresponsefield[field].d;
			var g = _sdkmessageresponsefield[field].g;
			var r = _sdkmessageresponsefield[field].r;
			webApiField(sdkmessageresponsefield, field, e, a, b, c, d, r, u, g);
		}
