...
(function (DevKit) {
	...
	DevKit.botcomponentApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in botcomponent) {
			var a = botcomponent[field].a;
			var b = botcomponent[field].b;
			var c = botcomponent[field].c;
			var d = botcomponent[field].d;
			var g = botcomponent[field].g;
			var r = botcomponent[field].r;
			botcomponent[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		botcomponent.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		botcomponent.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
