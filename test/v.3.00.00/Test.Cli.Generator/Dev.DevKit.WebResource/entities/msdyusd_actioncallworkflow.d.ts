...
declare namespace DevKit {
	...
	class msdyusd_actioncallworkflowApi {
		/**
		* DynamicsCrm.DevKit msdyusd_actioncallworkflowApi
		...
		*/
		...
		/** Status of the Action Call Workflow */
		statecode: OptionSet.msdyusd_actioncallworkflow.statecode;
		/** Reason for the status of the Action Call Workflow */
		statuscode: OptionSet.msdyusd_actioncallworkflow.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_actioncallworkflowId: string;
			/** The name of the custom entity. */
			readonly msdyusd_name: string;
			/** Contains the workflow XAML */
			readonly msdyusd_Workflow: string;
			/** Date and time that the record was migrated. */
