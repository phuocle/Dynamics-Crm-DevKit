...
(function (DevKit) {
	...
	DevKit.msdyn_purchaseorderproductApi = function (e) {
		...
		var _msdyn_purchaseorderproduct = {
		...
		msdyn_purchaseorderproduct.ODataEntity = e;
		msdyn_purchaseorderproduct.FormattedValue = {};
		for (var field in _msdyn_purchaseorderproduct) {
			var a = _msdyn_purchaseorderproduct[field].a;
			var b = _msdyn_purchaseorderproduct[field].b;
			var c = _msdyn_purchaseorderproduct[field].c;
			var d = _msdyn_purchaseorderproduct[field].d;
			var g = _msdyn_purchaseorderproduct[field].g;
			var r = _msdyn_purchaseorderproduct[field].r;
			webApiField(msdyn_purchaseorderproduct, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_purchaseorderproduct.getAliasedValue = function (alias, isMultiOptionSet = false) {
