...
(function (DevKit) {
	...
	DevKit.msdyn_journalApi = function (e) {
		...
		var u = {};
		var msdyn_journal = {};
		msdyn_journal.ODataEntity = e;
		msdyn_journal.FormattedValue = {};
		for (var field in _msdyn_journal) {
			var a = _msdyn_journal[field].a;
			var b = _msdyn_journal[field].b;
			var c = _msdyn_journal[field].c;
			var d = _msdyn_journal[field].d;
			var g = _msdyn_journal[field].g;
			var r = _msdyn_journal[field].r;
			webApiField(msdyn_journal, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_journal.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_journal.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
