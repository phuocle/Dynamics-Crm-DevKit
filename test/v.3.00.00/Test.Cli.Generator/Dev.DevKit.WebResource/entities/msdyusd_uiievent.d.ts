...
declare namespace DevKit {
	...
	class msdyusd_uiieventApi {
		...
		*/
		...
		/** Unique identifier for UII Hosted Application associated with UII Event. */
		msdyusd_HostedApplicationId: string;
		/** The name of the custom entity. */
		msdyusd_name: string;
		...
		/** Status of the UII Event */
		statecode: OptionSet.msdyusd_uiievent.statecode;
		/** Reason for the status of the UII Event */
		statuscode: OptionSet.msdyusd_uiievent.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for UII Hosted Application associated with UII Event. */
			readonly msdyusd_HostedApplicationId: string;
			/** The name of the custom entity. */
			readonly msdyusd_name: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_uiieventId: string;
			/** Date and time that the record was migrated. */
