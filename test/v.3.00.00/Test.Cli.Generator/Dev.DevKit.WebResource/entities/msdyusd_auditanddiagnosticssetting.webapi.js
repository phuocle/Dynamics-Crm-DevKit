...
(function (DevKit) {
	...
	DevKit.msdyusd_auditanddiagnosticssettingApi = function (e) {
		...
		var _msdyusd_auditanddiagnosticssetting = {
		...
		msdyusd_auditanddiagnosticssetting.ODataEntity = e;
		msdyusd_auditanddiagnosticssetting.FormattedValue = {};
		for (var field in _msdyusd_auditanddiagnosticssetting) {
			var a = _msdyusd_auditanddiagnosticssetting[field].a;
			var b = _msdyusd_auditanddiagnosticssetting[field].b;
			var c = _msdyusd_auditanddiagnosticssetting[field].c;
			var d = _msdyusd_auditanddiagnosticssetting[field].d;
			var g = _msdyusd_auditanddiagnosticssetting[field].g;
			var r = _msdyusd_auditanddiagnosticssetting[field].r;
			webApiField(msdyusd_auditanddiagnosticssetting, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyusd_auditanddiagnosticssetting.getAliasedValue = function (alias, isMultiOptionSet = false) {
