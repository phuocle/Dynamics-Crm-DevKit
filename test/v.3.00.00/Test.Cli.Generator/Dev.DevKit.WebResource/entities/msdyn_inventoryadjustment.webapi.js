...
(function (DevKit) {
	...
	DevKit.msdyn_inventoryadjustmentApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_inventoryadjustment) {
			var a = msdyn_inventoryadjustment[field].a;
			var b = msdyn_inventoryadjustment[field].b;
			var c = msdyn_inventoryadjustment[field].c;
			var d = msdyn_inventoryadjustment[field].d;
			var g = msdyn_inventoryadjustment[field].g;
			var r = msdyn_inventoryadjustment[field].r;
			msdyn_inventoryadjustment[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_inventoryadjustment.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_inventoryadjustment.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
