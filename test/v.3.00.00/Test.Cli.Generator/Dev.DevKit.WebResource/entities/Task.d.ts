	...
	class TaskApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_msdyn_processnotes_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_msdyn_productinventory_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_msdyn_projectteam_task: string;
			/** Unique identifier of the object with which the task is associated. */
			...
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_action_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_hostedapplication_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_nonhostedapplication_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_option_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_savedsession_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_workflow_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_workflowstep_task: string;
			/** Unique identifier of the object with which the task is associated. */
			readonly regardingobjectid_uii_workflow_workflowstep_mapping_task: string;
			/** Scheduled duration of the task, specified in minutes. */
