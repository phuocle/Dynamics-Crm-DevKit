...
declare namespace DevKit {
	class msdyn_appconfiguration_applicationextensionApi {
		/**
		* DynamicsCrm.DevKit msdyn_appconfiguration_applicationextensionApi
...
declare namespace OptionSet {
	namespace msdyn_appconfiguration_applicationextension {
		enum ComponentState {
			/** 2 */
			Deleted,
			/** 3 */
