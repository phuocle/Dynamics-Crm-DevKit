...
(function (DevKit) {
	...
	DevKit.msdyn_kbattachmentApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_kbattachment) {
			var a = msdyn_kbattachment[field].a;
			var b = msdyn_kbattachment[field].b;
			var c = msdyn_kbattachment[field].c;
			var d = msdyn_kbattachment[field].d;
			var g = msdyn_kbattachment[field].g;
			var r = msdyn_kbattachment[field].r;
			msdyn_kbattachment[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_kbattachment.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_kbattachment.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
