...
(function (DevKit) {
	...
	DevKit.msdyn_oclinechannelconfigApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_oclinechannelconfig) {
			var a = msdyn_oclinechannelconfig[field].a;
			var b = msdyn_oclinechannelconfig[field].b;
			var c = msdyn_oclinechannelconfig[field].c;
			var d = msdyn_oclinechannelconfig[field].d;
			var g = msdyn_oclinechannelconfig[field].g;
			var r = msdyn_oclinechannelconfig[field].r;
			msdyn_oclinechannelconfig[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_oclinechannelconfig.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_oclinechannelconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
