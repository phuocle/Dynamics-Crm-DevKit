...
(function (DevKit) {
	...
	DevKit.msdyn_ocoutboundconfigurationApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocoutboundconfiguration) {
			var a = msdyn_ocoutboundconfiguration[field].a;
			var b = msdyn_ocoutboundconfiguration[field].b;
			var c = msdyn_ocoutboundconfiguration[field].c;
			var d = msdyn_ocoutboundconfiguration[field].d;
			var g = msdyn_ocoutboundconfiguration[field].g;
			var r = msdyn_ocoutboundconfiguration[field].r;
			msdyn_ocoutboundconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocoutboundconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocoutboundconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
