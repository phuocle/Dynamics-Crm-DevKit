...
declare namespace DevKit {
	class flowmachinegroupApi {
		...
		*/
		...
		/** Internal Use Only. */
		FlowGroupType: DevKit.WebApi.OptionSetValue;
		/** Unique identifier for entity instances */
		flowmachinegroupId: DevKit.WebApi.GuidValueReadonly;
		/** Internal Use Only. */
		GroupMetadata: DevKit.WebApi.StringValue;
		...
		/** Internal Use Only */
		PrimaryKeyPackage: DevKit.WebApi.StringValue;
		/** Internal Use Only. */
		PrimaryPublicKey: DevKit.WebApi.StringValue;
		/** Internal Use Only. */
		SecondaryKeyPackage: DevKit.WebApi.StringValue;
		/** Internal Use Only. */
		SecondaryPublicKey: DevKit.WebApi.StringValue;
