...
declare namespace DevKit {
	class flowmachineApi {
		...
		*/
		...
		AgentVersion: DevKit.WebApi.StringValue;
		/** For Internal Use Only. */
		ConnectivityConfiguration: DevKit.WebApi.StringValue;
		...
		FlowMachineGroupId: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		flowmachineId: DevKit.WebApi.GuidValueReadonly;
		/** Sequence number of the import that created this record. */
		ImportSequenceNumber: DevKit.WebApi.IntegerValue;
		/** For Internal Use Only. */
		MachineMetadata: DevKit.WebApi.StringValue;
		...
		SessionCapacity: DevKit.WebApi.IntegerValue;
