...
(function (DevKit) {
	...
	DevKit.msdyn_inspectiondefinitionApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_inspectiondefinition) {
			var a = msdyn_inspectiondefinition[field].a;
			var b = msdyn_inspectiondefinition[field].b;
			var c = msdyn_inspectiondefinition[field].c;
			var d = msdyn_inspectiondefinition[field].d;
			var g = msdyn_inspectiondefinition[field].g;
			var r = msdyn_inspectiondefinition[field].r;
			msdyn_inspectiondefinition[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_inspectiondefinition.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_inspectiondefinition.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
