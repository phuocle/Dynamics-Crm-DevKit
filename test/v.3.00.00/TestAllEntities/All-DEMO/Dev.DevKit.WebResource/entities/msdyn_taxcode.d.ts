...
declare namespace DevKit {
	namespace Formmsdyn_taxcode_Information {
		...
		interface Navigation {
			nav_msdyn_msdyn_taxcode_account_SalesTaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_agreement_SalesTaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_purchaseorderbill_TaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_rma_TaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_rtv_TaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode: DevKit.Controls.NavigationItem,
	...
	class Formmsdyn_taxcode_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_taxcode_Information Main Form
	...
	class FormTax_Code_Quick_Create_FS_5x5 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Tax_Code_Quick_Create_FS_5x5 Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
