...
declare namespace DevKit {
	...
	class Formmsdyn_incidenttypeservicetask_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_incidenttypeservicetask_Information Main Form
	...
	class FormIncident_Type_Service_Task_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Incident_Type_Service_Task_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
