...
(function (DevKit) {
	...
	DevKit.msdyn_teamschatassociationApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_teamschatassociation) {
			var a = msdyn_teamschatassociation[field].a;
			var b = msdyn_teamschatassociation[field].b;
			var c = msdyn_teamschatassociation[field].c;
			var d = msdyn_teamschatassociation[field].d;
			var g = msdyn_teamschatassociation[field].g;
			var r = msdyn_teamschatassociation[field].r;
			msdyn_teamschatassociation[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_teamschatassociation.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_teamschatassociation.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
