...
declare namespace DevKit {
	...
	class Formmsdyusd_task_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyusd_task_Information Main Form
	...
	class msdyusd_taskApi {
		...
		*/
		...
		msdyusd_StartTask: DevKit.WebApi.BooleanValue;
		/** Unique identifier for entity instances */
		msdyusd_taskId: DevKit.WebApi.GuidValue;
