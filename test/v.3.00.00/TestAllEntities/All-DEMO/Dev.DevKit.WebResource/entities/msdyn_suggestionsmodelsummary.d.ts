...
declare namespace DevKit {
	...
	class Formmsdyn_suggestionsmodelsummary_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_suggestionsmodelsummary_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_suggestionsmodelsummary_Information */
		Process: DevKit.Formmsdyn_suggestionsmodelsummary_Information.Process;
	...
	class msdyn_suggestionsmodelsummaryApi {
		...
		*/
		...
		msdyn_CaseProcessedDateTime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** Number of delta Case records processed in the run */
		msdyn_CaseRecordsProccessed: DevKit.WebApi.IntegerValue;
		/** Utc Timestamp of when the Case model was retrained */
		msdyn_CaseRetrainedDateTime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** Is Case Model Training succeeded. Default is Yes */
		msdyn_IsCaseTrainingSucceeded: DevKit.WebApi.BooleanValue;
		/** Is KB Model Training succeeded. Default is Yes */
		msdyn_IsKbTrainingSucceeded: DevKit.WebApi.BooleanValue;
		/** Number of delta KB records processed in the run */
		msdyn_KbArticlesProcessed: DevKit.WebApi.IntegerValue;
		/** Utc Timestamp of when the KB model was processed */
		msdyn_KbProcessedDateTime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** Utc Timestamp of when the KB model was retrained */
		msdyn_KbRetrainedDateTime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_suggestionsmodelsummaryId: DevKit.WebApi.GuidValue;
		/** Utc Timestamp of when the model was trained */
		msdyn_TrainedDateTime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
