...
(function (DevKit) {
	...
	DevKit.msdyn_segmentApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_segment) {
			var a = msdyn_segment[field].a;
			var b = msdyn_segment[field].b;
			var c = msdyn_segment[field].c;
			var d = msdyn_segment[field].d;
			var g = msdyn_segment[field].g;
			var r = msdyn_segment[field].r;
			msdyn_segment[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_segment.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_segment.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
