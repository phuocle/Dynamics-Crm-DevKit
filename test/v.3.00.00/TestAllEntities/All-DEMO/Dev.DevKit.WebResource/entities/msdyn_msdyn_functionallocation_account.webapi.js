...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_functionallocation_accountApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_functionallocation_account) {
			var a = msdyn_msdyn_functionallocation_account[field].a;
			var b = msdyn_msdyn_functionallocation_account[field].b;
			var c = msdyn_msdyn_functionallocation_account[field].c;
			var d = msdyn_msdyn_functionallocation_account[field].d;
			var g = msdyn_msdyn_functionallocation_account[field].g;
			var r = msdyn_msdyn_functionallocation_account[field].r;
			msdyn_msdyn_functionallocation_account[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_functionallocation_account.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_functionallocation_account.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
