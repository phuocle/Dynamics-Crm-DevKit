...
(function (DevKit) {
	...
	DevKit.msdyn_iermltrainingApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_iermltraining) {
			var a = msdyn_iermltraining[field].a;
			var b = msdyn_iermltraining[field].b;
			var c = msdyn_iermltraining[field].c;
			var d = msdyn_iermltraining[field].d;
			var g = msdyn_iermltraining[field].g;
			var r = msdyn_iermltraining[field].r;
			msdyn_iermltraining[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_iermltraining.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_iermltraining.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
