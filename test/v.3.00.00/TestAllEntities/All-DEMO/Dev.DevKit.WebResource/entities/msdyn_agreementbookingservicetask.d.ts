...
declare namespace DevKit {
	...
	class FormAgreement_Booking_Service_Task_Mobile extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Agreement_Booking_Service_Task_Mobile Main Form
	...
	class Formmsdyn_agreementbookingservicetask_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_agreementbookingservicetask_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
