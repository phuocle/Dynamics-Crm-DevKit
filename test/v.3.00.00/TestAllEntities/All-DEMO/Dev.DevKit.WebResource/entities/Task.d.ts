...
declare namespace DevKit {
	...
	class FormTask extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Task Main Form
	...
	class FormTask_for_Interactive_experience extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Task_for_Interactive_experience Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormTask_quick_create_form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Task_quick_create_form Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
