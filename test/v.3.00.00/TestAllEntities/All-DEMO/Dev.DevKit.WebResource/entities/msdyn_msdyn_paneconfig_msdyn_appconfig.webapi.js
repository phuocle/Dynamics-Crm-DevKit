...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_paneconfig_msdyn_appconfigApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_paneconfig_msdyn_appconfig) {
			var a = msdyn_msdyn_paneconfig_msdyn_appconfig[field].a;
			var b = msdyn_msdyn_paneconfig_msdyn_appconfig[field].b;
			var c = msdyn_msdyn_paneconfig_msdyn_appconfig[field].c;
			var d = msdyn_msdyn_paneconfig_msdyn_appconfig[field].d;
			var g = msdyn_msdyn_paneconfig_msdyn_appconfig[field].g;
			var r = msdyn_msdyn_paneconfig_msdyn_appconfig[field].r;
			msdyn_msdyn_paneconfig_msdyn_appconfig[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_paneconfig_msdyn_appconfig.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_paneconfig_msdyn_appconfig.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
