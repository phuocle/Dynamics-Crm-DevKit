...
declare namespace DevKit {
	...
	class Formmsdyn_inspectioninstance_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_inspectioninstance_Information Main Form
	...
	class msdyn_inspectioninstanceApi {
		...
		*/
		...
		msdyn_Completed: DevKit.WebApi.StringValue;
		/** Unique identifier for Customer Asset associated with Inspection. */
		msdyn_CustomerAssetId: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyn_inspectioninstanceId: DevKit.WebApi.GuidValue;
		/** Unique identifier for Inspection Response associated with Inspection. */
		msdyn_inspectionresponseid: DevKit.WebApi.LookupValue;
		/** Unique identifier for Inspection Template associated with Inspection. */
		msdyn_InspectionTemplateId: DevKit.WebApi.LookupValue;
		/** Unique identifier for Inspection Template Version associated with Inspection. */
		msdyn_InspectionTemplateVersionId: DevKit.WebApi.LookupValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_surveybounded: DevKit.WebApi.StringValue;
