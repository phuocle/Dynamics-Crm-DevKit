...
declare namespace DevKit {
	...
	class Formmsdyn_iermlmodel_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_iermlmodel_Information Main Form
	...
	class msdyn_iermlmodelApi {
		...
		*/
		...
		msdyn_iermlmodelId: DevKit.WebApi.GuidValue;
		/** Indicates model's status */
		msdyn_iermlmodelstatus: DevKit.WebApi.OptionSetValue;
		/** Indicates model's recent training status */
		msdyn_iermlmodeltrainingstatus: DevKit.WebApi.OptionSetValue;
		/** Model name */
		...
		msdyn_wizarddata: DevKit.WebApi.StringValue;
