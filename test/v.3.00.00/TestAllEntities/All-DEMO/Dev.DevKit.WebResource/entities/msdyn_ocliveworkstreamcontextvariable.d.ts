...
declare namespace DevKit {
	...
	class Formmsdyn_ocliveworkstreamcontextvariable_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocliveworkstreamcontextvariable_Information Main Form
	...
	class Formmsdyn_ocliveworkstreamcontextvariable_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocliveworkstreamcontextvariable_Information2 Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
