...
(function (DevKit) {
	...
	DevKit.msdyn_octwitterhandleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_octwitterhandle) {
			var a = msdyn_octwitterhandle[field].a;
			var b = msdyn_octwitterhandle[field].b;
			var c = msdyn_octwitterhandle[field].c;
			var d = msdyn_octwitterhandle[field].d;
			var g = msdyn_octwitterhandle[field].g;
			var r = msdyn_octwitterhandle[field].r;
			msdyn_octwitterhandle[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_octwitterhandle.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_octwitterhandle.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
