...
declare namespace DevKit {
	...
	class FormEntry_Edit_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Entry_Edit_Form Main Form
	...
	class Formmsdyn_timeentry_Field_Service_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_timeentry_Field_Service_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class Formmsdyn_timeentry_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_timeentry_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormRow_Edit_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Row_Edit_Form Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormTESA_Time_Entry_Main_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form TESA_Time_Entry_Main_Form Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormCreate_Time_Entry extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Create_Time_Entry Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormField_Service_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Field_Service_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormTESA_Time_Entry_Quick_Create_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form TESA_Time_Entry_Quick_Create_Form Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
