...
declare namespace DevKit {
	...
	class Formmsdyn_oclanguage_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_oclanguage_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_oclanguage_Information */
		Process: DevKit.Formmsdyn_oclanguage_Information.Process;
	...
	class msdyn_oclanguageApi {
		...
		*/
		...
		msdyn_localecode: DevKit.WebApi.StringValue;
		/** The Locale ID of the language this record represents. */
		msdyn_localeid: DevKit.WebApi.IntegerValue;
		/** Unique identifier for entity instances */
		msdyn_oclanguageId: DevKit.WebApi.GuidValue;
