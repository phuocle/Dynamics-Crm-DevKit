...
(function (DevKit) {
	...
	DevKit.CommentApi = function (e) {
		...
		for (var field in comment) {
			var a = comment[field].a;
			var b = comment[field].b;
			var c = comment[field].c;
			var d = comment[field].d;
			var g = comment[field].g;
			var r = comment[field].r;
			comment[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		comment.Entity = u;
		comment.EntityName = 'comment';
		comment.EntityCollectionName = 'comments';
		comment['@odata.etag'] = e['@odata.etag'];
		comment.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		comment.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
