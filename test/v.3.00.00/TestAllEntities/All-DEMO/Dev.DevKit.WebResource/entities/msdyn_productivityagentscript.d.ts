...
declare namespace DevKit {
	...
	class Formmsdyn_productivityagentscript_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_productivityagentscript_Information Main Form
	...
	class msdyn_productivityagentscriptApi {
		...
		*/
		...
		/** Language for agent script */
		msdyn_language: DevKit.WebApi.IntegerValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_productivityagentscriptId: DevKit.WebApi.GuidValue;
		/** Unique Name for the entity. */
