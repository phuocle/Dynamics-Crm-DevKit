...
declare namespace DevKit {
	...
	class Formmsdyn_occommunicationprovidersetting_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_occommunicationprovidersetting_Information Main Form
	...
	class msdyn_occommunicationprovidersettingApi {
		...
		*/
		...
		/** Account SID */
		msdyn_AccountSID: DevKit.WebApi.StringValue;
		...
		msdyn_isTrial: DevKit.WebApi.BooleanValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Communication provider picklist */
		msdyn_OcCommunicationProvider: DevKit.WebApi.OptionSetValue;
		/** Unique identifier for entity instances */
		msdyn_occommunicationprovidersettingId: DevKit.WebApi.GuidValue;
		/** Authtoken or connectionstring */
		msdyn_Secret: DevKit.WebApi.StringValue;
