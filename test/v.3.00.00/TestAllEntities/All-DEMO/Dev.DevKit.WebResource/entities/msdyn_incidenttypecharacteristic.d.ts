...
declare namespace DevKit {
	...
	class Formmsdyn_incidenttypecharacteristic_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_incidenttypecharacteristic_Information Main Form
	...
	class FormIncident_Type_Characteristic_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Incident_Type_Characteristic_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
