...
declare namespace DevKit {
	...
	class Formmsdyn_workqueuestate_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_workqueuestate_Information Main Form
	...
	class msdyn_workqueuestateApi {
		...
		*/
		...
		/** IsRead */
		msdyn_isread: DevKit.WebApi.BooleanValue;
		...
		msdyn_workqueuestateId: DevKit.WebApi.GuidValue;
		/** It store unique key for each record. */
		msdyn_wqstateuniquekey: DevKit.WebApi.StringValue;
