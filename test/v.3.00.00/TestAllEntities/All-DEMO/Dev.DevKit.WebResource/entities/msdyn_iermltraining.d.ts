...
declare namespace DevKit {
	...
	class FormModel_training_details_main_form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Model_training_details_main_form Main Form
	...
	class msdyn_iermltrainingApi {
		...
		*/
		...
		/** Effort estimation model */
		msdyn_iermlmodelid: DevKit.WebApi.LookupValue;
		/** Unique identifier for model training detail */
		msdyn_iermltrainingId: DevKit.WebApi.GuidValue;
		/** Model training status */
