...
declare namespace DevKit {
	...
	class Formmsdyn_orderinvoicingproduct_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_orderinvoicingproduct_Information Main Form
	...
	class Formmsdyn_orderinvoicingproduct_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_orderinvoicingproduct_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class Formmsdyn_orderinvoicingproduct_New_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_orderinvoicingproduct_New_Form Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
