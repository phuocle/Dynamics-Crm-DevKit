...
declare namespace DevKit {
	...
	class Formmsdyn_quotelinescheduleofvalue_Project_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_quotelinescheduleofvalue_Project_Information Main Form
	...
	class Formmsdyn_quotelinescheduleofvalue_Project_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_quotelinescheduleofvalue_Project_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
