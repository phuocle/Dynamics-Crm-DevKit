...
declare namespace DevKit {
	...
	class Formmsdyn_resourcecategorypricelevel_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_resourcecategorypricelevel_Information Main Form
	...
	class Formmsdyn_resourcecategorypricelevel_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_resourcecategorypricelevel_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
