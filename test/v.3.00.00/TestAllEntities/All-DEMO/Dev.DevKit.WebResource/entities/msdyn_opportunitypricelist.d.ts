...
declare namespace DevKit {
	...
	class Formmsdyn_opportunitypricelist_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_opportunitypricelist_Information Main Form
	...
	class msdyn_opportunitypricelistApi {
		...
		*/
		...
		/** Select the opportunity that the price list is associated to. */
		msdyn_Opportunity: DevKit.WebApi.LookupValue;
		/** Shows the entity instances. */
		msdyn_opportunitypricelistId: DevKit.WebApi.GuidValue;
		/** Select the price list that is associated to the opportunity. */
