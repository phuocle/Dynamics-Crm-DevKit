...
declare namespace DevKit {
	...
	class FormRatingValue_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form RatingValue_Information Main Form
	...
	class FormRatingValue_Omnichannel_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form RatingValue_Omnichannel_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormRatingValue_Omnichannel_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form RatingValue_Omnichannel_Information2 Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
