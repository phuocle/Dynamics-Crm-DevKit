...
declare namespace DevKit {
	...
	class FormEffort_estimate_results extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Effort_estimate_results Main Form
	...
	class msdyn_effortpredictionresultApi {
		...
		*/
		...
		msdyn_effortconfidencescore: DevKit.WebApi.DecimalValue;
		/** Unique identifier for entity instances */
		msdyn_effortpredictionresultId: DevKit.WebApi.GuidValue;
		/** liveworkitemid */
		msdyn_liveworkitemid: DevKit.WebApi.LookupValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Effort value (minutes) */
		msdyn_predictedeffort: DevKit.WebApi.IntegerValue;
