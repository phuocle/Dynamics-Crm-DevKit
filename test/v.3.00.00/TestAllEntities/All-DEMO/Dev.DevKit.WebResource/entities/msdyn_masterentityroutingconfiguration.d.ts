...
declare namespace DevKit {
	...
	class Formmsdyn_masterentityroutingconfiguration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_masterentityroutingconfiguration_Information Main Form
	...
	class FormInformation_New2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Information_New2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class msdyn_masterentityroutingconfigurationApi {
		...
		*/
		...
		/** Unique identifier for entity instances */
		msdyn_masterentityroutingconfigurationId: DevKit.WebApi.GuidValue;
		/** The name of the custom entity. */
