...
(function (DevKit) {
	...
	DevKit.msdyn_estimatelineApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_estimateline) {
			var a = msdyn_estimateline[field].a;
			var b = msdyn_estimateline[field].b;
			var c = msdyn_estimateline[field].c;
			var d = msdyn_estimateline[field].d;
			var g = msdyn_estimateline[field].g;
			var r = msdyn_estimateline[field].r;
			msdyn_estimateline[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_estimateline.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_estimateline.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
