...
declare namespace DevKit {
	...
	class Formmsdyn_incidenttyperecommendationrunhistory_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_incidenttyperecommendationrunhistory_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_incidenttyperecommendationrunhistory_Information */
		Process: DevKit.Formmsdyn_incidenttyperecommendationrunhistory_Information.Process;
	...
	class msdyn_incidenttyperecommendationrunhistoryApi {
		...
		*/
		...
		msdyn_incidenttyperecommendationrunhistoryId: DevKit.WebApi.GuidValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Shows the version of incident type suggestion model. */
		msdyn_RecommendationModelVersion: DevKit.WebApi.StringValue;
		/** Shows the result of incident type suggestion. */
		msdyn_RunResult: DevKit.WebApi.BooleanValue;
		/** Shows the count of incident type suggestion run results */
		msdyn_RunResultCount: DevKit.WebApi.IntegerValue;
