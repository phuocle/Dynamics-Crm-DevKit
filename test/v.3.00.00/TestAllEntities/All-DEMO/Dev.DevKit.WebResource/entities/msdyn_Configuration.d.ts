...
declare namespace DevKit {
	...
	class Formmsdyn_Configuration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_Configuration_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_Configuration_Information */
		Process: DevKit.Formmsdyn_Configuration_Information.Process;
	...
	class Formmsdyn_Configuration_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_Configuration_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** The Process of form msdyn_Configuration_Information2 */
		Process: DevKit.Formmsdyn_Configuration_Information2.Process;
	...
	class msdyn_ConfigurationApi {
		...
		*/
		...
		msdyn_ConfigurationId: DevKit.WebApi.GuidValue;
		/** The name of the custom entity. */
