...
declare namespace DevKit {
	...
	class FormEntity_link_chat_configuration extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Entity_link_chat_configuration Main Form
	...
	class msdyn_entitylinkchatconfigurationApi {
		...
		*/
		...
		msdyn_ContextViewId: DevKit.WebApi.StringValue;
		/** Value of Enable AI suggestion */
		msdyn_EnableAiSuggestion: DevKit.WebApi.BooleanValue;
		/** Enable auto name chats */
		msdyn_EnableAutoNameChats: DevKit.WebApi.BooleanValue;
		/** Enable kickoff message */
		msdyn_EnableKickoffMessage: DevKit.WebApi.BooleanValue;
		/** Enable logic-based suggestion */
		msdyn_EnableLogicBasedSuggestion: DevKit.WebApi.BooleanValue;
		/** Unique identifier for entity instances */
		msdyn_entitylinkchatconfigurationId: DevKit.WebApi.GuidValue;
		...
		msdyn_UserCanJoinChat: DevKit.WebApi.BooleanValue;
