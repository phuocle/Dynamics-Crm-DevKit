...
declare namespace DevKit {
	...
	class FormOpportunityProduct_Field_Service_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form OpportunityProduct_Field_Service_Information Main Form
	...
	class FormOpportunityProduct_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form OpportunityProduct_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormOpportunityProduct extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form OpportunityProduct Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormOpportunityProduct_Project_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form OpportunityProduct_Project_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
