...
declare namespace DevKit {
	...
	class Formmsdyn_productivityparameterdefinition_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_productivityparameterdefinition_Information Main Form
	...
	class msdyn_productivityparameterdefinitionApi {
		...
		*/
		...
		/** JSON string describing parameter structure for a JSON or an Array type parameter */
		msdyn_jsonobjectstructure: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_parametertype: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_productivityparameterdefinitionId: DevKit.WebApi.GuidValue;
		/** Unique Name for the entity. */
