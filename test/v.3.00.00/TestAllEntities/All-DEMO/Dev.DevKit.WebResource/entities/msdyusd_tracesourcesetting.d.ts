...
declare namespace DevKit {
	...
	class Formmsdyusd_tracesourcesetting_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyusd_tracesourcesetting_Information Main Form
	...
	class msdyusd_tracesourcesettingApi {
		...
		*/
		...
		/** Specifies the levels of trace messages filtered by the source switch and event type filter. */
		msdyusd_switchlevel: DevKit.WebApi.OptionSetValue;
		/** Unique identifier for entity instances */
		msdyusd_tracesourcesettingId: DevKit.WebApi.GuidValue;
