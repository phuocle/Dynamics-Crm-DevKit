...
declare namespace DevKit {
	...
	class Formmsdyn_segment_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_segment_Information Main Form
