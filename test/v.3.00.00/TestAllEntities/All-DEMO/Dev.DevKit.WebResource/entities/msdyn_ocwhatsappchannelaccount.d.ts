...
declare namespace DevKit {
	...
	class Formmsdyn_ocwhatsappchannelaccount_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocwhatsappchannelaccount_Information Main Form
	...
	class msdyn_ocwhatsappchannelaccountApi {
		...
		*/
		...
		/** Authentication token of WhatsApp account. */
		msdyn_authenticationtoken: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_ocwhatsappchannelaccountId: DevKit.WebApi.GuidValue;
		/** The account ID of 3rd party provider */
		msdyn_provideraccountid: DevKit.WebApi.StringValue;
		/** URL for Twilio inbound request */
