...
declare namespace DevKit {
	namespace Formmsdyn_shipvia_Information {
		...
		interface Navigation {
			nav_msdyn_msdyn_shipvia_msdyn_purchaseorder_ShipVia: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_shipvia_msdyn_purchaseorderreceipt_ShipVia: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_shipvia_msdyn_rma_ShipVia: DevKit.Controls.NavigationItem,
			nav_msdyn_msdyn_shipvia_msdyn_rmareceipt_ShipVia: DevKit.Controls.NavigationItem,
	...
	class Formmsdyn_shipvia_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_shipvia_Information Main Form
