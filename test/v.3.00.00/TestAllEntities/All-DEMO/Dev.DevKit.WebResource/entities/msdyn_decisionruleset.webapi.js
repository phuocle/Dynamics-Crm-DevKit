...
(function (DevKit) {
	...
	DevKit.msdyn_decisionrulesetApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_decisionruleset) {
			var a = msdyn_decisionruleset[field].a;
			var b = msdyn_decisionruleset[field].b;
			var c = msdyn_decisionruleset[field].c;
			var d = msdyn_decisionruleset[field].d;
			var g = msdyn_decisionruleset[field].g;
			var r = msdyn_decisionruleset[field].r;
			msdyn_decisionruleset[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_decisionruleset.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_decisionruleset.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
