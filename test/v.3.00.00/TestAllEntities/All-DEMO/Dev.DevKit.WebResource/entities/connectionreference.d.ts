...
declare namespace DevKit {
	...
	class Formconnectionreference_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form connectionreference_Information Main Form
	...
	namespace Formconnectionreference_Information2 {
		interface Tabs {
		}
		interface Body {
			/** Display name of the connection reference */
	...
	class Formconnectionreference_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form connectionreference_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
