...
(function (DevKit) {
	...
	DevKit.msdyn_solutioncomponentcountsummaryApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_solutioncomponentcountsummary) {
			var a = msdyn_solutioncomponentcountsummary[field].a;
			var b = msdyn_solutioncomponentcountsummary[field].b;
			var c = msdyn_solutioncomponentcountsummary[field].c;
			var d = msdyn_solutioncomponentcountsummary[field].d;
			var g = msdyn_solutioncomponentcountsummary[field].g;
			var r = msdyn_solutioncomponentcountsummary[field].r;
			msdyn_solutioncomponentcountsummary[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_solutioncomponentcountsummary.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_solutioncomponentcountsummary.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
