...
declare namespace DevKit {
	...
	class Formmsdyn_rulesetdependencymapping_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_rulesetdependencymapping_Information Main Form
	...
	class msdyn_rulesetdependencymappingApi {
		...
		*/
		...
		/** Polymorphic entity id referenced by the ruleset */
		msdyn_referencedpolymorphicentityid_msdyn_rulesetdependencymapping_msdyn_liveworkstream: DevKit.WebApi.LookupValue;
		/** Polymorphic entity id referenced by the ruleset */
		msdyn_referencedpolymorphicentityid_msdyn_rulesetdependencymapping_msdyn_ocliveworkstreamcontextvariable: DevKit.WebApi.LookupValue;
		/** Polymorphic entity id referenced by the ruleset */
