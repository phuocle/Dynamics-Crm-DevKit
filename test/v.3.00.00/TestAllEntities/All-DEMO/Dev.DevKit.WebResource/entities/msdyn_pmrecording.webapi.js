...
(function (DevKit) {
	...
	DevKit.msdyn_pmrecordingApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_pmrecording) {
			var a = msdyn_pmrecording[field].a;
			var b = msdyn_pmrecording[field].b;
			var c = msdyn_pmrecording[field].c;
			var d = msdyn_pmrecording[field].d;
			var g = msdyn_pmrecording[field].g;
			var r = msdyn_pmrecording[field].r;
			msdyn_pmrecording[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_pmrecording.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_pmrecording.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
