...
declare namespace DevKit {
	...
	class Formmsdyn_requirementresourcecategory_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcecategory_Information Main Form
	...
	class Formmsdyn_requirementresourcecategory_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcecategory_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class Formmsdyn_requirementresourcecategory_Quick_Create_from_Requirement extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcecategory_Quick_Create_from_Requirement Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class msdyn_requirementresourcecategoryApi {
		...
		*/
		...
		msdyn_requirementresourcecategoryId: DevKit.WebApi.GuidValue;
		/** Resource Category */
