...
declare namespace DevKit {
	...
	class Formmsdyn_rolecompetencyrequirement_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_rolecompetencyrequirement_Information Main Form
	...
	class Formmsdyn_rolecompetencyrequirement_Quick_Create_Form extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_rolecompetencyrequirement_Quick_Create_Form Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
