...
(function (DevKit) {
	...
	DevKit.msdyn_contactsuggestionruleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_contactsuggestionrule) {
			var a = msdyn_contactsuggestionrule[field].a;
			var b = msdyn_contactsuggestionrule[field].b;
			var c = msdyn_contactsuggestionrule[field].c;
			var d = msdyn_contactsuggestionrule[field].d;
			var g = msdyn_contactsuggestionrule[field].g;
			var r = msdyn_contactsuggestionrule[field].r;
			msdyn_contactsuggestionrule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_contactsuggestionrule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_contactsuggestionrule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
