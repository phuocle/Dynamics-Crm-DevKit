...
declare namespace DevKit {
	...
	class Formmsdyn_tour_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_tour_Information Main Form
	...
	class msdyn_tourApi {
		...
		*/
		...
		msdyn_labelsresource: DevKit.WebApi.StringValue;
		/** Path */
		msdyn_path: DevKit.WebApi.StringValue;
		msdyn_tourdefinition: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_tourId: DevKit.WebApi.GuidValue;
