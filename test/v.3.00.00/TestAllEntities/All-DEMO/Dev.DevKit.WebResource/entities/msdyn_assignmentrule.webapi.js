...
(function (DevKit) {
	...
	DevKit.msdyn_assignmentruleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_assignmentrule) {
			var a = msdyn_assignmentrule[field].a;
			var b = msdyn_assignmentrule[field].b;
			var c = msdyn_assignmentrule[field].c;
			var d = msdyn_assignmentrule[field].d;
			var g = msdyn_assignmentrule[field].g;
			var r = msdyn_assignmentrule[field].r;
			msdyn_assignmentrule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_assignmentrule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_assignmentrule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
