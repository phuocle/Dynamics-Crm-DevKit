...
(function (DevKit) {
	...
	DevKit.msfp_satisfactionmetricApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msfp_satisfactionmetric) {
			var a = msfp_satisfactionmetric[field].a;
			var b = msfp_satisfactionmetric[field].b;
			var c = msfp_satisfactionmetric[field].c;
			var d = msfp_satisfactionmetric[field].d;
			var g = msfp_satisfactionmetric[field].g;
			var r = msfp_satisfactionmetric[field].r;
			msfp_satisfactionmetric[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msfp_satisfactionmetric.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msfp_satisfactionmetric.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
