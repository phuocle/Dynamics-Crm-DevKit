...
declare namespace DevKit {
	...
	class Formmsdyn_twitterengagementctx_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_twitterengagementctx_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_twitterengagementctx_Information */
		Process: DevKit.Formmsdyn_twitterengagementctx_Information.Process;
	...
	class msdyn_twitterengagementctxApi {
		...
		*/
		...
		msdyn_followerscount: DevKit.WebApi.StringValue;
		/** Twitter Customer Friends Count */
		msdyn_friendscount: DevKit.WebApi.StringValue;
		/** Twitter Customer Handle Id */
		msdyn_handleid: DevKit.WebApi.StringValue;
		...
		msdyn_screenname: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_twitterengagementctxId: DevKit.WebApi.GuidValue;
		/** Twitter Engagement Id */
		msdyn_twitterengagementid: DevKit.WebApi.StringValue;
