...
declare namespace DevKit {
	...
	class Formmsdyn_panetoolconfiguration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_panetoolconfiguration_Information Main Form
	...
	class msdyn_panetoolconfigurationApi {
		...
		*/
		...
		msdyn_controlname: DevKit.WebApi.StringValue;
		msdyn_data: DevKit.WebApi.StringValue;
		msdyn_defaulticon: DevKit.WebApi.StringValue;
		msdyn_description: DevKit.WebApi.StringValue;
		msdyn_isConfigurable: DevKit.WebApi.BooleanValue;
		msdyn_learnmorelink: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_panetoolconfigurationId: DevKit.WebApi.GuidValue;
		msdyn_toolConfigurationEntity: DevKit.WebApi.StringValue;
		/** Unique Name for the entity. */
