...
declare namespace DevKit {
	...
	class Formmsdyn_requirementrelationship_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementrelationship_Information Main Form
	...
	class msdyn_requirementrelationshipApi {
		...
		*/
		...
		msdyn_minconditioncount: DevKit.WebApi.IntegerValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_operator: DevKit.WebApi.OptionSetValue;
		/** Parent Requirement Relationship */
		msdyn_parentrequirementrelationshipid: DevKit.WebApi.LookupValue;
		...
		msdyn_requirementrelationshipId: DevKit.WebApi.GuidValue;
		msdyn_resourceGroupings: DevKit.WebApi.MultiOptionSetValue;
