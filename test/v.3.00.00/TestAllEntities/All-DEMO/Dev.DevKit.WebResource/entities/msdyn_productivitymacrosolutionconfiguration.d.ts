...
declare namespace DevKit {
	...
	class Formmsdyn_productivitymacrosolutionconfiguration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_productivitymacrosolutionconfiguration_Information Main Form
	...
	class msdyn_productivitymacrosolutionconfigurationApi {
		...
		*/
		...
		/** Sets designer fallback url */
		msdyn_designerfallbackurl: DevKit.WebApi.StringValue;
		/** Sets the entity from which to read designer URL */
		msdyn_designerurlconfigentity: DevKit.WebApi.StringValue;
		/** Sets the attributes of designer url config entity */
		msdyn_designerurlconfigentityattrib: DevKit.WebApi.StringValue;
		/** Sets the id from which to read designer URL */
		msdyn_designerurlconfigentityid: DevKit.WebApi.StringValue;
		/** An OData query to retrieve record from which to read designer URL */
		msdyn_designerurlconfigentityquery: DevKit.WebApi.StringValue;
		/** Sets the path to designer blob with designer URL */
		msdyn_designerurlrelativepath: DevKit.WebApi.StringValue;
		/** Macro solution version */
		msdyn_macrosversion: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_productivitymacrosolutionconfigurationId: DevKit.WebApi.GuidValue;
		/** Sets the value for serach hint */
		msdyn_searchhint: DevKit.WebApi.StringValue;
		/** Unique Name for the entity. */
		msdyn_UniqueName: DevKit.WebApi.StringValue;
		/** Sets the value for user voice link */
		msdyn_uservoicelink: DevKit.WebApi.StringValue;
		/** Sets the value for user voice text */
		msdyn_uservoicetext: DevKit.WebApi.StringValue;
