...
declare namespace DevKit {
	class msdyn_notificationtemplate_notificationfieldApi {
		...
		*/
		...
		msdyn_notificationfieldid: DevKit.WebApi.GuidValueReadonly;
		msdyn_notificationtemplate_notificationfieldId: DevKit.WebApi.GuidValueReadonly;
		msdyn_notificationtemplateid: DevKit.WebApi.GuidValueReadonly;
		/** For internal use only. */
