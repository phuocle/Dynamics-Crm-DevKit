...
declare namespace DevKit {
	...
	class Formmsdyn_casetopicsetting_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_casetopicsetting_Information Main Form
	...
	class msdyn_casetopicsettingApi {
		...
		*/
		...
		/** Attribute In Use */
		msdyn_AttributeInUse: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_casetopicsettingId: DevKit.WebApi.GuidValue;
		/** Delimiters */
		msdyn_Delimiters: DevKit.WebApi.StringValue;
		/** Is Enabled */
		...
		/** Selection Location */
		msdyn_SelectionLocation: DevKit.WebApi.OptionSetValue;
