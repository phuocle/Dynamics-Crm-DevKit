...
declare namespace DevKit {
	...
	class Formsolutioncomponentbatchconfiguration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form solutioncomponentbatchconfiguration_Information Main Form
	...
	class solutioncomponentbatchconfigurationApi {
		...
		*/
		...
		PrimaryEntity: DevKit.WebApi.LookupValue;
		RelatedEntity: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		solutioncomponentbatchconfigurationId: DevKit.WebApi.GuidValue;
