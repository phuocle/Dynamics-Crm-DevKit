...
declare namespace DevKit {
	...
	class Formmsdyusd_actioncallworkflow_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyusd_actioncallworkflow_Information Main Form
	...
	class msdyusd_actioncallworkflowApi {
		...
		*/
		...
		msdyusd_actioncallworkflowId: DevKit.WebApi.GuidValue;
		/** The name of the custom entity. */
		msdyusd_name: DevKit.WebApi.StringValue;
		/** Contains the workflow XAML */
		msdyusd_Workflow: DevKit.WebApi.StringValue;
