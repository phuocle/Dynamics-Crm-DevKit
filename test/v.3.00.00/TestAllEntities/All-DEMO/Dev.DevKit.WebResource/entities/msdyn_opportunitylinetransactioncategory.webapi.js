...
(function (DevKit) {
	...
	DevKit.msdyn_opportunitylinetransactioncategoryApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_opportunitylinetransactioncategory) {
			var a = msdyn_opportunitylinetransactioncategory[field].a;
			var b = msdyn_opportunitylinetransactioncategory[field].b;
			var c = msdyn_opportunitylinetransactioncategory[field].c;
			var d = msdyn_opportunitylinetransactioncategory[field].d;
			var g = msdyn_opportunitylinetransactioncategory[field].g;
			var r = msdyn_opportunitylinetransactioncategory[field].r;
			msdyn_opportunitylinetransactioncategory[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_opportunitylinetransactioncategory.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_opportunitylinetransactioncategory.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
