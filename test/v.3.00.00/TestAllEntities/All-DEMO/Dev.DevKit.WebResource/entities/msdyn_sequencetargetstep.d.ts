...
declare namespace DevKit {
	...
	class Formmsdyn_sequencetargetstep_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_sequencetargetstep_Information Main Form
	...
	class msdyn_sequencetargetstepApi {
		...
		*/
		...
		msdyn_convertedtomanualfrom: DevKit.WebApi.OptionSetValue;
		...
		msdyn_errorstate: DevKit.WebApi.OptionSetValue;
		/** Unique identifier of the activity linked to the sequence step */
		msdyn_linkedactivityid: DevKit.WebApi.GuidValue;
		/** The name of the Sequence Target step entity. */
