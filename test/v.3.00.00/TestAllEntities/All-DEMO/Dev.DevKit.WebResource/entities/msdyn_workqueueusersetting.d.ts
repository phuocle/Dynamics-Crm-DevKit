...
declare namespace DevKit {
	...
	class Formmsdyn_workqueueusersetting_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_workqueueusersetting_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_workqueueusersetting_Information */
		Process: DevKit.Formmsdyn_workqueueusersetting_Information.Process;
	...
	class msdyn_workqueueusersettingApi {
		...
		*/
		...
		msdyn_actiononmarkcomplete: DevKit.WebApi.OptionSetValue;
		/** Work list user setting picklist for action on skip */
		msdyn_actiononskip: DevKit.WebApi.OptionSetValue;
		/** User configuration of linking between sequence step and activities */
		msdyn_linkingconfiguration: DevKit.WebApi.StringValue;
		/** Name of the entity for the related workqueue user settings. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for user setting instances. */
		msdyn_workqueueusersettingId: DevKit.WebApi.GuidValue;
