...
(function (DevKit) {
	...
	DevKit.msdyn_ocphonenumberApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocphonenumber) {
			var a = msdyn_ocphonenumber[field].a;
			var b = msdyn_ocphonenumber[field].b;
			var c = msdyn_ocphonenumber[field].c;
			var d = msdyn_ocphonenumber[field].d;
			var g = msdyn_ocphonenumber[field].g;
			var r = msdyn_ocphonenumber[field].r;
			msdyn_ocphonenumber[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocphonenumber.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocphonenumber.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
