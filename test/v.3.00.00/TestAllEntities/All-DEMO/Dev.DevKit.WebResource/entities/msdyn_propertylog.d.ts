...
declare namespace DevKit {
	...
	class Formmsdyn_propertylog_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_propertylog_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_propertylog_Information */
		Process: DevKit.Formmsdyn_propertylog_Information.Process;
	...
	class FormProperty_Log_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Property_Log_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class msdyn_propertylogApi {
		...
		*/
		...
		msdyn_booleanvalue: DevKit.WebApi.BooleanValue;
		msdyn_customerasset: DevKit.WebApi.LookupValue;
		msdyn_datevalue_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		/** For Internal Use only */
		msdyn_delta: DevKit.WebApi.DecimalValue;
		msdyn_islatest: DevKit.WebApi.BooleanValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_numbervalue: DevKit.WebApi.DecimalValue;
		msdyn_property: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyn_propertylogId: DevKit.WebApi.GuidValue;
		msdyn_readingtime_UtcDateAndTime: DevKit.WebApi.UtcDateAndTimeValue;
		msdyn_stringvalue: DevKit.WebApi.StringValue;
		msdyn_valuetodisplay: DevKit.WebApi.StringValue;
