...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_journal_msdyn_timeentryApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_journal_msdyn_timeentry) {
			var a = msdyn_msdyn_journal_msdyn_timeentry[field].a;
			var b = msdyn_msdyn_journal_msdyn_timeentry[field].b;
			var c = msdyn_msdyn_journal_msdyn_timeentry[field].c;
			var d = msdyn_msdyn_journal_msdyn_timeentry[field].d;
			var g = msdyn_msdyn_journal_msdyn_timeentry[field].g;
			var r = msdyn_msdyn_journal_msdyn_timeentry[field].r;
			msdyn_msdyn_journal_msdyn_timeentry[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_journal_msdyn_timeentry.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_journal_msdyn_timeentry.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
