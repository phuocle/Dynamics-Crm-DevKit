...
declare namespace DevKit {
	...
	class Formmsdyn_inventoryadjustmentproduct_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_inventoryadjustmentproduct_Information Main Form
	...
	class FormQuick_Create_Inventory_Adjustment_Product extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Quick_Create_Inventory_Adjustment_Product Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
