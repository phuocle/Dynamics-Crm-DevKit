...
declare namespace DevKit {
	...
	class Formmsdyn_ocsmschannelsetting_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocsmschannelsetting_Information Main Form
	...
	class msdyn_ocsmschannelsettingApi {
		...
		*/
		...
		msdyn_enablefileattachmentforagents: DevKit.WebApi.BooleanValue;
		/** Enable file attachments for customers */
		msdyn_enablefileattachmentforcustomers: DevKit.WebApi.BooleanValue;
		/** URL for Inbound link */
		msdyn_inboundurl: DevKit.WebApi.StringValue;
		/** The language setting for the SMS number */
		msdyn_language: DevKit.WebApi.LookupValue;
		...
		msdyn_ocsmschannelsettingId: DevKit.WebApi.GuidValue;
