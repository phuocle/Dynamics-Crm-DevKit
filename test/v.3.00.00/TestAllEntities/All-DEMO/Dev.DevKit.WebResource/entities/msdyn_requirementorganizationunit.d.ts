...
declare namespace DevKit {
	...
	class Formmsdyn_requirementorganizationunit_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementorganizationunit_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_requirementorganizationunit_Information */
		Process: DevKit.Formmsdyn_requirementorganizationunit_Information.Process;
	...
	class Formmsdyn_requirementorganizationunit_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementorganizationunit_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** The Process of form msdyn_requirementorganizationunit_Information2 */
		Process: DevKit.Formmsdyn_requirementorganizationunit_Information2.Process;
	...
	class Formmsdyn_requirementorganizationunit_Quick_Create_from_Requirement extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementorganizationunit_Quick_Create_from_Requirement Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class msdyn_requirementorganizationunitApi {
		...
		*/
		...
		msdyn_requirementorganizationunitId: DevKit.WebApi.GuidValue;
