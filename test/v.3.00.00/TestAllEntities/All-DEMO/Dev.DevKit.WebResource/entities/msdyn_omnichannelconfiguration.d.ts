...
declare namespace DevKit {
	...
	class Formmsdyn_omnichannelconfiguration_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_omnichannelconfiguration_Information Main Form
	...
	class FormMarkdown_Settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Markdown_Settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormMasking_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Masking_settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormNotifications extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Notifications Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormPersonal_quick_replies extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Personal_quick_replies Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormReal_Time_Translation_Settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Real_Time_Translation_Settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormSelf_service_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Self_service_settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormSkill_based_routing_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Skill_based_routing_settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormSupervisor_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Supervisor_settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormTranscript_settings extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Transcript_settings Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
