...
(function (DevKit) {
	...
	DevKit.msdyn_problematicassetApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_problematicasset) {
			var a = msdyn_problematicasset[field].a;
			var b = msdyn_problematicasset[field].b;
			var c = msdyn_problematicasset[field].c;
			var d = msdyn_problematicasset[field].d;
			var g = msdyn_problematicasset[field].g;
			var r = msdyn_problematicasset[field].r;
			msdyn_problematicasset[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_problematicasset.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_problematicasset.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
