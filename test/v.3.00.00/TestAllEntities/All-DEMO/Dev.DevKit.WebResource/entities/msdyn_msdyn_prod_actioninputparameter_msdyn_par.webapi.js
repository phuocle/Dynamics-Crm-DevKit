...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_prod_actioninputparameter_msdyn_parApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_prod_actioninputparameter_msdyn_par) {
			var a = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].a;
			var b = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].b;
			var c = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].c;
			var d = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].d;
			var g = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].g;
			var r = msdyn_msdyn_prod_actioninputparameter_msdyn_par[field].r;
			msdyn_msdyn_prod_actioninputparameter_msdyn_par[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_prod_actioninputparameter_msdyn_par.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_prod_actioninputparameter_msdyn_par.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
