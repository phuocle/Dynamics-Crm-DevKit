...
declare namespace DevKit {
	...
	class FormBookableResourceCategoryAssn_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form BookableResourceCategoryAssn_Information Main Form
	...
	class FormBookableResourceCategoryAssn_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form BookableResourceCategoryAssn_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
