...
(function (DevKit) {
	...
	DevKit.msdyn_productivitymacroactiontemplateApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_productivitymacroactiontemplate) {
			var a = msdyn_productivitymacroactiontemplate[field].a;
			var b = msdyn_productivitymacroactiontemplate[field].b;
			var c = msdyn_productivitymacroactiontemplate[field].c;
			var d = msdyn_productivitymacroactiontemplate[field].d;
			var g = msdyn_productivitymacroactiontemplate[field].g;
			var r = msdyn_productivitymacroactiontemplate[field].r;
			msdyn_productivitymacroactiontemplate[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_productivitymacroactiontemplate.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_productivitymacroactiontemplate.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
