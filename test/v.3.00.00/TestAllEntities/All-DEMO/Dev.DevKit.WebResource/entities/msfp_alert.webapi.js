...
(function (DevKit) {
	...
	DevKit.msfp_alertApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msfp_alert) {
			var a = msfp_alert[field].a;
			var b = msfp_alert[field].b;
			var c = msfp_alert[field].c;
			var d = msfp_alert[field].d;
			var g = msfp_alert[field].g;
			var r = msfp_alert[field].r;
			msfp_alert[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msfp_alert.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msfp_alert.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
