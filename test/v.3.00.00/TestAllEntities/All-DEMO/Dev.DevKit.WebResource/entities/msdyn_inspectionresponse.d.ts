...
declare namespace DevKit {
	...
	class Formmsdyn_inspectionresponse_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_inspectionresponse_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_inspectionresponse_Information */
		Process: DevKit.Formmsdyn_inspectionresponse_Information.Process;
	...
	class msdyn_inspectionresponseApi {
		...
		*/
		...
		msdyn_InspectionDefinition: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyn_inspectionresponseId: DevKit.WebApi.GuidValue;
		...
		msdyn_isvalidresponse: DevKit.WebApi.BooleanValue;
		/** The name of the Inspection Response entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Contains the response json */
		msdyn_ResponseJsonContent: DevKit.WebApi.StringValue;
