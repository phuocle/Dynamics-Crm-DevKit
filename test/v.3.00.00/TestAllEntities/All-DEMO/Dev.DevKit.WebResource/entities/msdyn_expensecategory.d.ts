...
declare namespace DevKit {
	...
	class Formmsdyn_expensecategory_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_expensecategory_Information Main Form
	...
	class msdyn_expensecategoryApi {
		...
		*/
		...
		msdyn_expensecategoryId: DevKit.WebApi.GuidValue;
		/** Select the Transaction Category associated with Expense Category. */
		msdyn_ExpenseCategoryuId: DevKit.WebApi.LookupValue;
		/** Enter the type of expense */
		msdyn_ExpenseType: DevKit.WebApi.OptionSetValue;
		/** Type the name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Shows whether the expense entry requires a receipt. */
		msdyn_ReceiptRequired: DevKit.WebApi.OptionSetValue;
