...
declare namespace DevKit {
	namespace Formmsdyn_paymentterm_Information {
		...
		interface Navigation {
			nav_msdyn_msdyn_paymentterm_msdyn_purchaseorder_PaymentTerm: DevKit.Controls.NavigationItem,
	...
	class Formmsdyn_paymentterm_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_paymentterm_Information Main Form
