...
(function (DevKit) {
	...
	DevKit.msdyn_ocsmschannelsettingApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocsmschannelsetting) {
			var a = msdyn_ocsmschannelsetting[field].a;
			var b = msdyn_ocsmschannelsetting[field].b;
			var c = msdyn_ocsmschannelsetting[field].c;
			var d = msdyn_ocsmschannelsetting[field].d;
			var g = msdyn_ocsmschannelsetting[field].g;
			var r = msdyn_ocsmschannelsetting[field].r;
			msdyn_ocsmschannelsetting[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocsmschannelsetting.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocsmschannelsetting.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
