...
declare namespace DevKit {
	...
	class Formmsdyn_ocrecording_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_ocrecording_Information Main Form
		...
		*/
		...
		/** The Process of form msdyn_ocrecording_Information */
		Process: DevKit.Formmsdyn_ocrecording_Information.Process;
	...
	class msdyn_ocrecordingApi {
		...
		*/
		...
		msdyn_mediauri: DevKit.WebApi.StringValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_ocrecordingId: DevKit.WebApi.GuidValue;
		/** Recording file */
		msdyn_recording: DevKit.WebApi.StringValueReadonly;
		/** Meta data associated to the recording */
		msdyn_recordingmetadata: DevKit.WebApi.StringValueReadonly;
		/** Language of recording source */
		msdyn_sourcelanguage: DevKit.WebApi.LookupValue;
