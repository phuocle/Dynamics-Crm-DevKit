...
declare namespace DevKit {
	...
	class FormSalesOrder_Field_Service_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form SalesOrder_Field_Service_Information Main Form
	...
	class FormOrder extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Order Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormSalesOrder_Project_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form SalesOrder_Project_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormSalesOrder_Project_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form SalesOrder_Project_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
