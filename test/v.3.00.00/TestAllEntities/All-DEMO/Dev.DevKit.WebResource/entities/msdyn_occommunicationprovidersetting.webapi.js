...
(function (DevKit) {
	...
	DevKit.msdyn_occommunicationprovidersettingApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_occommunicationprovidersetting) {
			var a = msdyn_occommunicationprovidersetting[field].a;
			var b = msdyn_occommunicationprovidersetting[field].b;
			var c = msdyn_occommunicationprovidersetting[field].c;
			var d = msdyn_occommunicationprovidersetting[field].d;
			var g = msdyn_occommunicationprovidersetting[field].g;
			var r = msdyn_occommunicationprovidersetting[field].r;
			msdyn_occommunicationprovidersetting[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_occommunicationprovidersetting.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_occommunicationprovidersetting.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
