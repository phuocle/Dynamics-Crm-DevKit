...
declare namespace DevKit {
	...
	class Formmsdyn_assignmentmap_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_assignmentmap_Information Main Form
	...
	class msdyn_assignmentmapApi {
		...
		*/
		...
		msdyn_applicableforrouting: DevKit.WebApi.BooleanValue;
		msdyn_assignedticks: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_assignmentmapId: DevKit.WebApi.GuidValue;
		msdyn_availablecapacity: DevKit.WebApi.IntegerValue;
		msdyn_maxcapacity: DevKit.WebApi.IntegerValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		msdyn_systemuserid: DevKit.WebApi.LookupValue;
