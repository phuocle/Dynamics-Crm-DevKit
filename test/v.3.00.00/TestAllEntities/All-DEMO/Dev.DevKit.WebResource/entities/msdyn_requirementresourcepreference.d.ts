...
declare namespace DevKit {
	...
	class Formmsdyn_requirementresourcepreference_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcepreference_Information Main Form
	...
	class Formmsdyn_requirementresourcepreference_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcepreference_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class Formmsdyn_requirementresourcepreference_Quick_Create_from_Requirement extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementresourcepreference_Quick_Create_from_Requirement Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class msdyn_requirementresourcepreferenceApi {
		...
		*/
		...
		/** Preference Type */
		msdyn_PreferenceType: DevKit.WebApi.OptionSetValue;
		/** The unique identifier for an entity instance. */
		msdyn_requirementresourcepreferenceId: DevKit.WebApi.GuidValue;
		/** Resource Requirement */
