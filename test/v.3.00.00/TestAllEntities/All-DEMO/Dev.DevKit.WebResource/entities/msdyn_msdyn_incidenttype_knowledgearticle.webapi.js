...
(function (DevKit) {
	...
	DevKit.msdyn_msdyn_incidenttype_knowledgearticleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_msdyn_incidenttype_knowledgearticle) {
			var a = msdyn_msdyn_incidenttype_knowledgearticle[field].a;
			var b = msdyn_msdyn_incidenttype_knowledgearticle[field].b;
			var c = msdyn_msdyn_incidenttype_knowledgearticle[field].c;
			var d = msdyn_msdyn_incidenttype_knowledgearticle[field].d;
			var g = msdyn_msdyn_incidenttype_knowledgearticle[field].g;
			var r = msdyn_msdyn_incidenttype_knowledgearticle[field].r;
			msdyn_msdyn_incidenttype_knowledgearticle[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_msdyn_incidenttype_knowledgearticle.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_msdyn_incidenttype_knowledgearticle.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
