...
declare namespace DevKit {
	...
	class Formmsdyn_salesroutingrun_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_salesroutingrun_Information Main Form
	...
	class msdyn_salesroutingrunApi {
		...
		*/
		...
		msdyn_assignmentruleid: DevKit.WebApi.LookupValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Assigned owner id */
		msdyn_ownerassigned_systemuser: DevKit.WebApi.LookupValue;
		/** Assigned owner id */
		msdyn_ownerassigned_team: DevKit.WebApi.LookupValue;
		/** Unique identifier for entity instances */
		msdyn_salesroutingrunId: DevKit.WebApi.GuidValue;
		msdyn_segmentid: DevKit.WebApi.LookupValue;
		msdyn_targetobject_lead: DevKit.WebApi.LookupValue;
		msdyn_targetobject_opportunity: DevKit.WebApi.LookupValue;
