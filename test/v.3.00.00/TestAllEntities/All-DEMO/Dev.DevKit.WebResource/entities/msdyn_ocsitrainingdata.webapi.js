...
(function (DevKit) {
	...
	DevKit.msdyn_ocsitrainingdataApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocsitrainingdata) {
			var a = msdyn_ocsitrainingdata[field].a;
			var b = msdyn_ocsitrainingdata[field].b;
			var c = msdyn_ocsitrainingdata[field].c;
			var d = msdyn_ocsitrainingdata[field].d;
			var g = msdyn_ocsitrainingdata[field].g;
			var r = msdyn_ocsitrainingdata[field].r;
			msdyn_ocsitrainingdata[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocsitrainingdata.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocsitrainingdata.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
