...
(function (DevKit) {
	...
	DevKit.msdyn_rulesetdependencymappingApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_rulesetdependencymapping) {
			var a = msdyn_rulesetdependencymapping[field].a;
			var b = msdyn_rulesetdependencymapping[field].b;
			var c = msdyn_rulesetdependencymapping[field].c;
			var d = msdyn_rulesetdependencymapping[field].d;
			var g = msdyn_rulesetdependencymapping[field].g;
			var r = msdyn_rulesetdependencymapping[field].r;
			msdyn_rulesetdependencymapping[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_rulesetdependencymapping.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_rulesetdependencymapping.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
