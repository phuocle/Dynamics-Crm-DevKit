...
declare namespace DevKit {
	namespace FormTerritory_Information {
		...
		interface Navigation {
			nav_msdyn_territory_account_ServiceTerritory: DevKit.Controls.NavigationItem,
	...
	class FormTerritory_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Territory_Information Main Form
	...
	class FormTerritory_Quick_Create extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Territory_Quick_Create Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
