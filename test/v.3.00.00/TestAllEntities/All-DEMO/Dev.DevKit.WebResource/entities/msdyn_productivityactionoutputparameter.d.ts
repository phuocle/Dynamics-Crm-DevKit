...
declare namespace DevKit {
	...
	class Formmsdyn_productivityactionoutputparameter_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_productivityactionoutputparameter_Information Main Form
	...
	class msdyn_productivityactionoutputparameterApi {
		...
		*/
		...
		msdyn_actiontemplateoutputparameterid: DevKit.WebApi.LookupValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** Unique identifier for entity instances */
		msdyn_productivityactionoutputparameterId: DevKit.WebApi.GuidValue;
		/** Unique Name for the entity. */
