...
(function (DevKit) {
	...
	DevKit.msdyn_ocsentimentdailytopickeywordApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_ocsentimentdailytopickeyword) {
			var a = msdyn_ocsentimentdailytopickeyword[field].a;
			var b = msdyn_ocsentimentdailytopickeyword[field].b;
			var c = msdyn_ocsentimentdailytopickeyword[field].c;
			var d = msdyn_ocsentimentdailytopickeyword[field].d;
			var g = msdyn_ocsentimentdailytopickeyword[field].g;
			var r = msdyn_ocsentimentdailytopickeyword[field].r;
			msdyn_ocsentimentdailytopickeyword[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_ocsentimentdailytopickeyword.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_ocsentimentdailytopickeyword.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
