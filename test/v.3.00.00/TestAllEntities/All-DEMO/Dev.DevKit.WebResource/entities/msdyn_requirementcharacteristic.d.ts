...
declare namespace DevKit {
	...
	class Formmsdyn_requirementcharacteristic_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementcharacteristic_Information Main Form
	...
	class Formmsdyn_requirementcharacteristic_Information2 extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementcharacteristic_Information2 Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class Formmsdyn_requirementcharacteristic_Quick_Create_from_Requirement extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_requirementcharacteristic_Quick_Create_from_Requirement Quick Create
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
