...
declare namespace DevKit {
	...
	class Formmsdyn_integrationjob_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form msdyn_integrationjob_Information Main Form
	...
	class msdyn_integrationjobApi {
		...
		*/
		...
		msdyn_integrationjobId: DevKit.WebApi.GuidValue;
		/** The name of the custom entity. */
		msdyn_name: DevKit.WebApi.StringValue;
		/** The expected number of packets to be received. */
		msdyn_NumberOfPackets: DevKit.WebApi.IntegerValue;
		/** The logical name of entity related to the integration job */
		msdyn_RegardingEntity: DevKit.WebApi.StringValue;
		/** The primary id of entity related to the integration job */
		msdyn_RegardingEntityId: DevKit.WebApi.StringValue;
		/** The response of the integration job in JSON format */
		msdyn_ResponseJSON: DevKit.WebApi.StringValue;
