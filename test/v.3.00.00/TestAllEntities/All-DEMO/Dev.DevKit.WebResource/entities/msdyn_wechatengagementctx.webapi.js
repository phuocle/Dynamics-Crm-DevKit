...
(function (DevKit) {
	...
	DevKit.msdyn_wechatengagementctxApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_wechatengagementctx) {
			var a = msdyn_wechatengagementctx[field].a;
			var b = msdyn_wechatengagementctx[field].b;
			var c = msdyn_wechatengagementctx[field].c;
			var d = msdyn_wechatengagementctx[field].d;
			var g = msdyn_wechatengagementctx[field].g;
			var r = msdyn_wechatengagementctx[field].r;
			msdyn_wechatengagementctx[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_wechatengagementctx.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_wechatengagementctx.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
