...
declare namespace DevKit {
	...
	class FormInvoice_Field_Service_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Invoice_Field_Service_Information Main Form
	...
	class FormInvoice_Information extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Invoice_Information Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormInvoice extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Invoice Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
	...
	class FormProject_Invoice extends DevKit.IForm {
		/**
		* DynamicsCrm.DevKit form Project_Invoice Main Form
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
