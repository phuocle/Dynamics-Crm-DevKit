...
(function (DevKit) {
	...
	DevKit.msdyn_dataanalyticsreport_fspredictrsApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_dataanalyticsreport_fspredictrs) {
			var a = msdyn_dataanalyticsreport_fspredictrs[field].a;
			var b = msdyn_dataanalyticsreport_fspredictrs[field].b;
			var c = msdyn_dataanalyticsreport_fspredictrs[field].c;
			var d = msdyn_dataanalyticsreport_fspredictrs[field].d;
			var g = msdyn_dataanalyticsreport_fspredictrs[field].g;
			var r = msdyn_dataanalyticsreport_fspredictrs[field].r;
			msdyn_dataanalyticsreport_fspredictrs[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_dataanalyticsreport_fspredictrs.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_dataanalyticsreport_fspredictrs.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
