...
(function (DevKit) {
	...
	DevKit.msdyn_liveworkstreamcapacityprofileApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_liveworkstreamcapacityprofile) {
			var a = msdyn_liveworkstreamcapacityprofile[field].a;
			var b = msdyn_liveworkstreamcapacityprofile[field].b;
			var c = msdyn_liveworkstreamcapacityprofile[field].c;
			var d = msdyn_liveworkstreamcapacityprofile[field].d;
			var g = msdyn_liveworkstreamcapacityprofile[field].g;
			var r = msdyn_liveworkstreamcapacityprofile[field].r;
			msdyn_liveworkstreamcapacityprofile[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_liveworkstreamcapacityprofile.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_liveworkstreamcapacityprofile.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
