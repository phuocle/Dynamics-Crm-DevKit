...
(function (DevKit) {
	...
	DevKit.msdyusd_configuration_sessionlinesApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyusd_configuration_sessionlines) {
			var a = msdyusd_configuration_sessionlines[field].a;
			var b = msdyusd_configuration_sessionlines[field].b;
			var c = msdyusd_configuration_sessionlines[field].c;
			var d = msdyusd_configuration_sessionlines[field].d;
			var g = msdyusd_configuration_sessionlines[field].g;
			var r = msdyusd_configuration_sessionlines[field].r;
			msdyusd_configuration_sessionlines[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyusd_configuration_sessionlines.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyusd_configuration_sessionlines.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
