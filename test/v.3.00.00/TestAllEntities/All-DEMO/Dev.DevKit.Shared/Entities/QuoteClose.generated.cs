...
namespace Dev.DevKit.Shared.Entities
{
	public partial class QuoteClose : EntityBase
	{
		...
		[DebuggerNonUserCode()]
		public QuoteClose(Entity entity)
		{
			Entity = entity;
			PreEntity = CloneThisEntity(Entity);
		}
		...
		[DebuggerNonUserCode()]
		public QuoteClose(Entity entity, Entity merge)
		{
			Entity = entity;
		...
		/// <para>Lookup to account, bookableresourcebooking, bookableresourcebookingheader, bulkoperation, campaign, campaignactivity, entitlement, entitlementtemplate, incident, interactionforemail, knowledgearticle, knowledgebaserecord, lead, msdyn_customerasset, msdyn_playbookinstance, opportunity, quote, site</para>
		/// <para>Regarding</para>
		/// </summary>
		[DebuggerNonUserCode()]
