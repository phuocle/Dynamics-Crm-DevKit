...
declare namespace DevKit {
	...
	class FormWebApi extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.FormWebApi.Body;
		/** The Footer section of form WebApi */
		Footer: DevKit.FormWebApi.Footer;
		/** The Header section of form WebApi */
		Header: DevKit.FormWebApi.Header;
		/** The Navigation of form WebApi */
		Navigation: DevKit.FormWebApi.Navigation;
		/** The QuickForm of form WebApi */
		QuickForm: DevKit.FormWebApi.QuickForm;
		/** The Process of form WebApi */
		Process: DevKit.FormWebApi.Process;
		/** The Grid of form WebApi */
		Grid: DevKit.FormWebApi.Grid;
	}
	...
	class FormWebApi_2 extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.FormWebApi_2.Body;
		/** The Header section of form WebApi_2 */
		Header: DevKit.FormWebApi_2.Header;
		/** The Process of form WebApi_2 */
		Process: DevKit.FormWebApi_2.Process;
	}
	...
	class Formdevkit_WebApi_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formdevkit_WebApi_Quick_Create.Body;
	}
