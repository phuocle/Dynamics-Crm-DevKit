...
(function (DevKit) {
	'use strict';
	DevKit.FormLocation = function(executionContext, defaultWebResourceName) {
	...
	DevKit.FormLocation_2 = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	DevKit.FormQuick_Create_Location = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
