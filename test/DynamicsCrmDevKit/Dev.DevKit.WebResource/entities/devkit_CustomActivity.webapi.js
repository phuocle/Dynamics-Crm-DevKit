...
(function (DevKit) {
	'use strict';
	DevKit.devkit_CustomActivityApi = function (e) {
		var EMPTY_STRING = '';
		...
		var devkit_customactivity = {
			...
			regardingobjectid_devkit_azureaccount_devkit_customactivity: { b: 'regardingobjectid_devkit_azureaccount_devkit_customactivity', a: '_regardingobjectid_value', c: 'devkit_azureaccounts', d: 'devkit_azureaccount' },
...
var OptionSet;
(function (OptionSet) {
	OptionSet.devkit_CustomActivity = {
		Community : {
			Facebook: 1,
			Other: 0,
			Twitter: 2
