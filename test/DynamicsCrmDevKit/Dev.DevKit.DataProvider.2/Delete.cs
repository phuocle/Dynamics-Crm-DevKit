...
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider._2.Delete", VirtualTablePlugin.Delete)]
    public class Delete : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Dev.DevKit.DataProvider._2.Delete");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Dev.DevKit.DataProvider._2.Delete");
        }
