...
namespace Dev.DevKit.DataProvider._2
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider._2.RetrieveMultiple", VirtualTablePlugin.RetrieveMultiple)]
    public class RetrieveMultiple : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Dev.DevKit.DataProvider._2.RetrieveMultiple");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Dev.DevKit.DataProvider._2.RetrieveMultiple");
        }
