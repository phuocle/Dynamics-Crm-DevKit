...
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider._2.Retrieve", VirtualTablePlugin.Retrieve)]
    public class Retrieve : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Dev.DevKit.DataProvider._2.Retrieve");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Dev.DevKit.DataProvider._2.Retrieve");
        }
