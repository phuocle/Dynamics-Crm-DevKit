...
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider._2.Create", VirtualTablePlugin.Create)]
    public class Create : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            //tracing.DebugMessage("Begin Data Provider: Dev.DevKit.DataProvider._2.Create");
            //tracing.DebugContext(context);

            ExecutePlugin(context, serviceFactory, service, tracing, dataSource);

            //tracing.DebugMessage("End Data Provider: Dev.DevKit.DataProvider._2.Create");
        }
