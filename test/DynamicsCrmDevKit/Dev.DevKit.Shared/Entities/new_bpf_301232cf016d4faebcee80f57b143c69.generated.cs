...
namespace Dev.DevKit.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	public partial class new_bpf_301232cf016d4faebcee80f57b143c69 : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.new_bpf_301232cf016d4faebcee80f57b143c69OptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
