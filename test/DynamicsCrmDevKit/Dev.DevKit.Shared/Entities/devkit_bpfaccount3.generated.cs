...
namespace Dev.DevKit.Shared.Entities.devkit_bpfaccount3OptionSets
{
...
namespace Dev.DevKit.Shared.Entities
{
	public partial class devkit_bpfaccount3 : EntityBase
	{
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.devkit_bpfaccount3OptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.devkit_bpfaccount3OptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKit.Shared.Entities.devkit_bpfaccount3OptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKit.Shared.Entities.devkit_bpfaccount3OptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
