...
namespace Dev.DevKit.PluginPhoneCall
{

    [CrmPluginRegistration("Create", "phonecall", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.PluginPhoneCall.PostPhoneCalltCreateAsynchronous", 1, IsolationModeEnum.Sandbox, Description = "Description", UnSecureConfiguration = "")]

    public class PostPhoneCallCreateAsynchronous : IPlugin
    {
        /*
          InputParameters:
        ...
        */
        ...
        //public PostPhoneCallCreateAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
