...
declare namespace DevKit {
	namespace Formmsdyn_dimensionfieldname_Information {
		...
		interface Body {
			...
			msdyn_DimensionId: DevKit.Controls.Lookup;
	...
	class Formmsdyn_dimensionfieldname_Information extends DevKit.IForm {
		/**
		...
		*/
		...
		Body: DevKit.Formmsdyn_dimensionfieldname_Information.Body;
		/** The Process of form msdyn_dimensionfieldname_Information */
		Process: DevKit.Formmsdyn_dimensionfieldname_Information.Process;
		/** The SidePanes of form msdyn_dimensionfieldname_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_dimensionfieldnameApi {
		/**
		* DynamicsCrm.DevKit msdyn_dimensionfieldnameApi
		...
		*/
		...
		statecode: OptionSet.msdyn_dimensionfieldname.statecode;
		/** Reason for the status of the Pricing Dimension Field Name */
		statuscode: OptionSet.msdyn_dimensionfieldname.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyn_dimensionfieldnameId: string;
			/** Pricing dimension that this field name is for. */
			readonly msdyn_DimensionId: string;
			/** Logical name of the entity that the field belongs to. */
			readonly msdyn_EntityLogicalName: string;
			/** Name of the field. */
			readonly msdyn_FieldName: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
