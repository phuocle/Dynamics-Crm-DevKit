...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_forecastinstanceApi = function (e) {
		...
		msdyn_forecastinstance.ODataEntity = e;
		msdyn_forecastinstance.FormattedValue = {};
		for (var field in _msdyn_forecastinstance) {
			var a = _msdyn_forecastinstance[field].a;
			var b = _msdyn_forecastinstance[field].b;
			var c = _msdyn_forecastinstance[field].c;
			var d = _msdyn_forecastinstance[field].d;
			var g = _msdyn_forecastinstance[field].g;
			var r = _msdyn_forecastinstance[field].r;
			webApiField(msdyn_forecastinstance, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_forecastinstance.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_forecastinstance.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
