...
declare namespace DevKit {
	...
	class msdyusd_sessiontransferApi {
		...
		*/
		...
		/** Status of the Session Transfer */
		statecode: OptionSet.msdyusd_sessiontransfer.statecode;
		/** Reason for the status of the Session Transfer */
		statuscode: OptionSet.msdyusd_sessiontransfer.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyusd_SessionInformation: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_sessiontransferId: string;
			/** Date and time that the record was migrated. */
