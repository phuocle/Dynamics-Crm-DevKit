...
(function (DevKit) {
	...
	DevKit.msdyn_projecttaskstatususerApi = function (e) {
		...
		var _msdyn_projecttaskstatususer = {
		...
		msdyn_projecttaskstatususer.ODataEntity = e;
		msdyn_projecttaskstatususer.FormattedValue = {};
		for (var field in _msdyn_projecttaskstatususer) {
			var a = _msdyn_projecttaskstatususer[field].a;
			var b = _msdyn_projecttaskstatususer[field].b;
			var c = _msdyn_projecttaskstatususer[field].c;
			var d = _msdyn_projecttaskstatususer[field].d;
			var g = _msdyn_projecttaskstatususer[field].g;
			var r = _msdyn_projecttaskstatususer[field].r;
			webApiField(msdyn_projecttaskstatususer, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_projecttaskstatususer.getAliasedValue = function (alias, isMultiOptionSet = false) {
