...
declare namespace DevKit {
	...
	class Formmsdyn_opportunitypricelist_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKit.Formmsdyn_opportunitypricelist_Information.Body;
		/** The Process of form msdyn_opportunitypricelist_Information */
		Process: DevKit.Formmsdyn_opportunitypricelist_Information.Process;
		/** The SidePanes of form msdyn_opportunitypricelist_Information */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_opportunitypricelistApi {
		/**
		* DynamicsCrm.DevKit msdyn_opportunitypricelistApi
		...
		*/
		...
		statecode: OptionSet.msdyn_opportunitypricelist.statecode;
		/** Reason for the status of the Opportunity Price List */
		statuscode: OptionSet.msdyn_opportunitypricelist.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Select the opportunity that the price list is associated to. */
			readonly msdyn_Opportunity: string;
			/** Shows the entity instances. */
			readonly msdyn_opportunitypricelistId: string;
			/** Select the price list that is associated to the opportunity. */
