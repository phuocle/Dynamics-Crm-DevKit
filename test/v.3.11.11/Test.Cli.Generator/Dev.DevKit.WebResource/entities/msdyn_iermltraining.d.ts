...
declare namespace DevKit {
	namespace FormModel_training_details_main_form {
		...
		interface Body {
			...
			msdyn_iermlmodelid: DevKit.Controls.Lookup;
	...
	class FormModel_training_details_main_form extends DevKit.IForm {
		...
		*/
		...
		/** The Process of form Model_training_details_main_form */
		Process: DevKit.FormModel_training_details_main_form.Process;
		/** The SidePanes of form Model_training_details_main_form */
		SidePanes: DevKit.SidePanes;
	}
	class msdyn_iermltrainingApi {
		/**
		* DynamicsCrm.DevKit msdyn_iermltrainingApi
		...
		*/
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.msdyn_iermltraining.ComponentState;
		...
		/** Model training status */
		msdyn_mltrainingstatus: OptionSet.msdyn_iermltraining.msdyn_mltrainingstatus;
		/** The name of the model training detail. */
		msdyn_name: string;
		...
		/** Status of the iermltraining */
		statecode: OptionSet.msdyn_iermltraining.statecode;
		/** Reason for the status of the iermltraining */
		statuscode: OptionSet.msdyn_iermltraining.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for model training detail */
			readonly msdyn_iermltrainingId: string;
			/** Model training status */
