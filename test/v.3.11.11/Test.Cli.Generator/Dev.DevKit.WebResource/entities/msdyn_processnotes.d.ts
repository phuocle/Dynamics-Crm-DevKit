...
declare namespace DevKit {
	...
	class msdyn_processnotesApi {
		...
		*/
		...
		statecode: OptionSet.msdyn_processnotes.statecode;
		/** Reason for the status of the Process Notes */
		statuscode: OptionSet.msdyn_processnotes.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Form identifier. */
			readonly msdyn_Form: string;
			/** Process message. */
			readonly msdyn_Message: string;
			/** The name of the custom entity. */
			readonly msdyn_name: string;
			/** Unique identifier for entity instances */
			readonly msdyn_processnotesId: string;
			/** Unique identifier for the organization */
			readonly OrganizationId: string;
			/** Date and time that the record was migrated. */
