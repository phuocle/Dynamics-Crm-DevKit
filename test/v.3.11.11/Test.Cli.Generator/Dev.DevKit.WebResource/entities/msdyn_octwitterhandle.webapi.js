...
(function (DevKit) {
	'use strict';
	DevKit.msdyn_octwitterhandleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		var msdyn_octwitterhandle = {};
		msdyn_octwitterhandle.ODataEntity = e;
		msdyn_octwitterhandle.FormattedValue = {};
		for (var field in _msdyn_octwitterhandle) {
			var a = _msdyn_octwitterhandle[field].a;
			var b = _msdyn_octwitterhandle[field].b;
			var c = _msdyn_octwitterhandle[field].c;
			var d = _msdyn_octwitterhandle[field].d;
			var g = _msdyn_octwitterhandle[field].g;
			var r = _msdyn_octwitterhandle[field].r;
			webApiField(msdyn_octwitterhandle, field, e, a, b, c, d, r, u, g);
		}
		msdyn_octwitterhandle.Entity = u;
		msdyn_octwitterhandle.EntityName = 'msdyn_octwitterhandle';
		msdyn_octwitterhandle.EntityCollectionName = 'msdyn_octwitterhandles';
		msdyn_octwitterhandle['@odata.etag'] = e['@odata.etag'];
		msdyn_octwitterhandle.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_octwitterhandle.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
