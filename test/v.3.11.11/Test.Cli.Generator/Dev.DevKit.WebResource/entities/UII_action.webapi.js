...
(function (DevKit) {
	...
	DevKit.UII_actionApi = function (e) {
		...
		var u = {};
		var uii_action = {};
		uii_action.ODataEntity = e;
		uii_action.FormattedValue = {};
		for (var field in _uii_action) {
			var a = _uii_action[field].a;
			var b = _uii_action[field].b;
			var c = _uii_action[field].c;
			var d = _uii_action[field].d;
			var g = _uii_action[field].g;
			var r = _uii_action[field].r;
			webApiField(uii_action, field, e, a, b, c, d, r, u, g);
		}
		uii_action.Entity = u;
		uii_action.EntityName = 'uii_action';
		uii_action.EntityCollectionName = 'uii_actions';
		uii_action['@odata.etag'] = e['@odata.etag'];
		uii_action.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		uii_action.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
