	...
	class FaxApi {
		...
		*/
		...
		readonly FormattedValue: {
			...
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_msdyn_processnotes_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_msdyn_productinventory_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_msdyn_projectteam_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			...
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_action_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_hostedapplication_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_nonhostedapplication_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_option_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_savedsession_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_workflow_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_workflowstep_fax: string;
			/** Unique identifier of the object with which the fax activity is associated. */
			readonly regardingobjectid_uii_workflow_workflowstep_mapping_fax: string;
			/** Shows the expected duration of the fax activity, in minutes. */
