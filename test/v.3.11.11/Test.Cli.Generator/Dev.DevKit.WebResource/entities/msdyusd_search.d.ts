...
declare namespace DevKit {
	namespace Formmsdyusd_search_Information {
		...
		interface Body {
			...
			msdyusd_searchorder: DevKit.Controls.Integer;
	...
	class msdyusd_searchApi {
		...
		*/
		...
		msdyusd_Direction: OptionSet.msdyusd_search.msdyusd_Direction;
		...
		/** Status of the Search */
		statecode: OptionSet.msdyusd_search.statecode;
		/** Reason for the status of the Search */
		statuscode: OptionSet.msdyusd_search.statuscode;
		...
		readonly FormattedValue: {
			...
			/** Unique identifier for entity instances */
			readonly msdyusd_searchId: string;
			readonly msdyusd_searchorder: string;
			/** Date and time that the record was migrated. */
