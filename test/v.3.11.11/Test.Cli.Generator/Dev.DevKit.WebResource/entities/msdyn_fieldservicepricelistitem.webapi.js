...
(function (DevKit) {
	...
	DevKit.msdyn_fieldservicepricelistitemApi = function (e) {
		...
		var _msdyn_fieldservicepricelistitem = {
		...
		msdyn_fieldservicepricelistitem.ODataEntity = e;
		msdyn_fieldservicepricelistitem.FormattedValue = {};
		for (var field in _msdyn_fieldservicepricelistitem) {
			var a = _msdyn_fieldservicepricelistitem[field].a;
			var b = _msdyn_fieldservicepricelistitem[field].b;
			var c = _msdyn_fieldservicepricelistitem[field].c;
			var d = _msdyn_fieldservicepricelistitem[field].d;
			var g = _msdyn_fieldservicepricelistitem[field].g;
			var r = _msdyn_fieldservicepricelistitem[field].r;
			webApiField(msdyn_fieldservicepricelistitem, field, e, a, b, c, d, r, u, g);
		}
		...
		msdyn_fieldservicepricelistitem.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		msdyn_fieldservicepricelistitem.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
