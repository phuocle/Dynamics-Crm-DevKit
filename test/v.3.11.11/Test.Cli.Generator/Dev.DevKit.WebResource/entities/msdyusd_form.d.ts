...
declare namespace DevKit {
	namespace Formmsdyusd_form_Information {
		...
		interface Body {
			msdyusd_markup: DevKit.Controls.String;
	...
	class Formmsdyusd_form_Information extends DevKit.IForm {
		/**
	...
	class msdyusd_formApi {
		...
		*/
		...
		/** Status of the Form */
		statecode: OptionSet.msdyusd_form.statecode;
		/** Reason for the status of the Form */
		statuscode: OptionSet.msdyusd_form.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly ModifiedOnBehalfBy: string;
			/** Unique identifier for entity instances */
			readonly msdyusd_formId: string;
			readonly msdyusd_markup: string;
			/** The name of the custom entity. */
