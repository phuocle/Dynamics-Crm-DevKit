...
declare namespace DevKit {
	...
	class ApplicationUserApi {
		...
		*/
		...
		ApplicationType: OptionSet.ApplicationUser.ApplicationType;
		...
		/** For internal use only. */
		readonly ComponentState: OptionSet.ApplicationUser.ComponentState;
		...
		statecode: OptionSet.ApplicationUser.statecode;
		/** Reason for the status of the ApplicationUser */
		statuscode: OptionSet.ApplicationUser.statuscode;
		/** For internal use only. */
		...
		readonly FormattedValue: {
			...
			/** Indicates whether the application user can impersonate system user */
			readonly CanImpersonateAsSystemUser: string;
			/** For internal use only. */
			readonly ComponentIdUnique: string;
			/** For internal use only. */
