...
declare namespace DevKit {
	...
	class msdyusd_agentscriptactionApi {
		...
		*/
		...
		/** Status of the Agent Script Action */
		statecode: OptionSet.msdyusd_agentscriptaction.statecode;
		/** Reason for the status of the Agent Script Action */
		statuscode: OptionSet.msdyusd_agentscriptaction.statuscode;
		...
		readonly FormattedValue: {
			...
			readonly msdyusd_ActionData: string;
			/** Unique identifier for entity instances */
			...
			readonly msdyusd_LaunchifDynamic: string;
			/** The name of the custom entity. */
