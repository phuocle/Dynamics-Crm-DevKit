...
(function (DevKit) {
	...
	DevKit.UoMApi = function (e) {
		...
		for (var field in _uom) {
			...
			var g = _uom[field].g;
			var r = _uom[field].r;
			webApiField(uom, field, e, a, b, c, d, r, u, g);
		}
		uom.Entity = u;
		uom.EntityName = 'uom';
		uom.EntityCollectionName = 'uoms';
		uom['@odata.etag'] = e['@odata.etag'];
		uom.getAliasedValue = function (alias, isMultiOptionSet = false) {
		...
		uom.getAliasedFormattedValue = function (alias, isMultiOptionSet = false) {
