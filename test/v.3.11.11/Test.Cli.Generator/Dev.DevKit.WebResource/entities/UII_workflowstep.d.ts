...
declare namespace DevKit {
	...
	class FormUII_workflowstep_Information extends DevKit.IForm {
		...
		*/
		...
		/** The Process of form UII_workflowstep_Information */
		Process: DevKit.FormUII_workflowstep_Information.Process;
	...
	class UII_workflowstepApi {
		...
		*/
		...
		/** Status of the UII Workflow Step */
		statecode: OptionSet.UII_workflowstep.statecode;
		/** Reason for the status of the UII Workflow Step */
		statuscode: OptionSet.UII_workflowstep.statuscode;
		...
		/** Workflow Step shall be mapped to Hosted Application. */
		uii_hostedapplicationworkflowstepid: string;
		/** The name of the workflow step . */
		UII_name: string;
		...
		readonly FormattedValue: {
			...
			/** Workflow Step shall be mapped to Hosted Application. */
			readonly uii_hostedapplicationworkflowstepid: string;
			/** The name of the workflow step . */
			readonly UII_name: string;
			/** Unique identifier for entity instances */
			readonly UII_workflowstepId: string;
			/** Time zone code that was in use when the record was created. */
