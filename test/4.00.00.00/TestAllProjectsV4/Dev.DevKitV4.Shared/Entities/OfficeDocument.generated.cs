...
namespace Dev.DevKitV4.Shared.Entities.OfficeDocumentOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class OfficeDocument : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.OfficeDocumentOptionSets.DocumentType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.OfficeDocumentOptionSets.DocumentType? DocumentType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.DocumentType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.OfficeDocumentOptionSets.DocumentType)value.Value;
			}
			set
			{
				if (value.HasValue)
