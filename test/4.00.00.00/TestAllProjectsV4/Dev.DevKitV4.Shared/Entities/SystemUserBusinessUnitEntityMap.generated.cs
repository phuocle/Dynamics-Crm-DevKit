...
namespace Dev.DevKitV4.Shared.Entities.SystemUserBusinessUnitEntityMapOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SystemUserBusinessUnitEntityMap : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "SystemUserBusiness Unit Entity Maps";
		public const string DisplayName = "SystemUser BusinessUnit Entity Map";
		public const string EntitySetName = "systemuserbusinessunitentitymaps";
		public const string EntityLogicalCollectionName = "";
		public const string EntityPrimaryIdAttribute = "systemuserbusinessunitentitymapid";
		...
		/// <summary>
		/// Instance new late bound class <see cref="SystemUserBusinessUnitEntityMap"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public SystemUserBusinessUnitEntityMap(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="SystemUserBusinessUnitEntityMap"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public SystemUserBusinessUnitEntityMap(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new SystemUserBusinessUnitEntityMap(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="SystemUserBusinessUnitEntityMap"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public SystemUserBusinessUnitEntityMap(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new SystemUserBusinessUnitEntityMap(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the SystemUserBusinessUnitEntityMap .</para>
