...
namespace Dev.DevKitV4.Shared.Entities.MultiEntitySearchEntitiesOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class MultiEntitySearchEntities : EntityBase
	{
		...
		/// <para><strong>Description</strong>: Logical entity name of the entity participating in the multi entity search.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Entity Order</para>
		/// <para><strong>Description</strong>: Order of the entity in the result collection.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Shows the entity used for the multiple entity search.</para>
		...
		/// <para><strong>Description</strong>: Shows the ID of the multiple entity search.</para>
