...
namespace Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class devkit_bpfaccount : EntityBase
	{
		...
		public const string EntityLogicalName = "devkit_bpfaccount";
		[System.Obsolete("This value is different for each instance. Please don't use it.")]
		public const int EntityTypeCode = 10632;
		public const string EntityCollectionSchemaName = "devkit_bpfaccounts";
		public const string EntityDisplayCollectionName = "BPF Account";
		public const string DisplayName = "BPF Account";
		public const string EntitySetName = "devkit_bpfaccounts";
		public const string EntityLogicalCollectionName = "devkit_bpfaccounts";
		...
		public const string EntitySchemaName = "devkit_bpfaccount";
		[DebuggerNonUserCode()]
		public devkit_bpfaccount()
		{
			Entity = new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(Guid devkit_bpfaccountId)
		{
			Entity = new Entity(EntityLogicalName, devkit_bpfaccountId);
			PreEntity = CloneThisEntity(Entity);
		}
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(string keyName, object keyValue)
		{
			Entity = new Entity(EntityLogicalName, keyName, keyValue);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="devkit_bpfaccount"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="devkit_bpfaccount"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new devkit_bpfaccount(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="devkit_bpfaccount"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new devkit_bpfaccount(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		[DebuggerNonUserCode()]
		public devkit_bpfaccount(KeyAttributeCollection keys)
		{
		...
		{
			get { return Entity.GetAttributeValue<EntityReference>(Fields.bpf_accountid); }
			set { Entity.Attributes[Fields.bpf_accountid] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Status of the BPF Account</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the BPF Account</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.devkit_bpfaccountOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
