...
namespace Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ExternalParty : EntityBase
	{
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StateCode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExternalPartyOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
