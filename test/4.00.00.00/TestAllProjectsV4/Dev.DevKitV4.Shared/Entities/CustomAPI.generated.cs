...
namespace Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets
{
	public enum AllowedCustomProcessingStepType
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Async Only</para>
		...
		None = 0,
		/// <summary>
		/// <para><strong>Display Name</strong>: Sync and Async</para>
	...
	public enum BindingType
	{
		...
		Entity = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: Entity Collection</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		Entity_Collection = 2,
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class CustomAPI : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Custom APIs";
		public const string DisplayName = "Custom API";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Allowed Custom Processing Step Type</para>
		/// <para><strong>Description</strong>: The type of custom processing step allowed</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.AllowedCustomProcessingStepType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.AllowedCustomProcessingStepType.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.AllowedCustomProcessingStepType? AllowedCustomProcessingStepType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AllowedCustomProcessingStepType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.AllowedCustomProcessingStepType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Binding Type</para>
		/// <para><strong>Description</strong>: The binding type of the custom API</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.BindingType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.BindingType.Global"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.BindingType? BindingType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.BindingType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.BindingType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: The logical name of the entity bound to the custom API</para>
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: Unique identifier for custom API instances</para>
		...
		/// <para><strong>Description</strong>: Localized description for custom API instances</para>
		...
		/// <para><strong>Description</strong>: Localized display name for custom API instances</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Name of the privilege that allows execution of the custom API</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Is Function</para>
		/// <para><strong>Description</strong>: Indicates if the custom API is a function (GET is supported) or not (POST is supported)</para>
		...
		/// <para><strong>Description</strong>: Indicates if the custom API is private (hidden from metadata and documentation)</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: The primary name of the custom API</para>
		...
		/// <para><strong>Description</strong>: Status of the Custom API</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Custom API</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CustomAPIOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Unique name for the custom API</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Enabled for Workflow</para>
		/// <para><strong>Description</strong>: Indicates if the custom API is enabled as a workflow action</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
