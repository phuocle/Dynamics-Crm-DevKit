...
namespace Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class EntityAnalyticsConfig : EntityBase
	{
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Entity Data Source</para>
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource.Dataverse"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource? EntityDataSource
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.EntityDataSource);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.EntityAnalyticsConfigOptionSets.EntityDataSource)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.EntityDataSource] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.EntityDataSource] = null;
			}
		}
		/// <summary>
