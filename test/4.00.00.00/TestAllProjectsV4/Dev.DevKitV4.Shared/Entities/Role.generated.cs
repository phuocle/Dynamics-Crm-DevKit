...
namespace Dev.DevKitV4.Shared.Entities.RoleOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Role : EntityBase
	{
		...
		/// <para><strong>Description</strong>: Application Id of user who created the role</para>
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RoleOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RoleOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RoleOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsAutoAssigned"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsAutoAssigned? IsAutoAssigned
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.IsAutoAssigned);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsAutoAssigned)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsInherited"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsInherited.Direct_User_Basic_access_level_and_Team_privileges"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsInherited? IsInherited
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.IsInherited);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RoleOptionSets.IsInherited)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Is System Generated</para>
		/// <para><strong>Description</strong>: Is this role generated by the system</para>
		...
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.IsSystemGenerated); }
			set { Entity.Attributes[Fields.IsSystemGenerated] = value; }
		}
		/// <summary>
