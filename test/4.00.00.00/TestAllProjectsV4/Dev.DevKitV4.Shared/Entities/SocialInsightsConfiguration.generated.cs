...
namespace Dev.DevKitV4.Shared.Entities.SocialInsightsConfigurationOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SocialInsightsConfiguration : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType.Search_Item"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType? SocialDataItemType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SocialDataItemType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SocialInsightsConfigurationOptionSets.SocialDataItemType)value.Value;
			}
			set
			{
				if (value.HasValue)
