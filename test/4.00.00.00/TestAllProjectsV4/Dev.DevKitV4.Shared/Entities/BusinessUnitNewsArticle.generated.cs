...
namespace Dev.DevKitV4.Shared.Entities.BusinessUnitNewsArticleOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class BusinessUnitNewsArticle : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode.All_Users"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode? ArticleTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ArticleTypeCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.BusinessUnitNewsArticleOptionSets.ArticleTypeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
