...
namespace Dev.DevKitV4.Shared.Entities.RibbonContextGroupOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class RibbonContextGroup : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RibbonContextGroupOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RibbonContextGroupOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RibbonContextGroupOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
