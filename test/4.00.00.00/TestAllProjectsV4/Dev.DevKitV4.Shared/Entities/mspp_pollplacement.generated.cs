...
namespace Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class mspp_pollplacement : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Poll Placements";
		public const string DisplayName = "Poll Placement";
		...
		/// <para><strong>Description</strong>: Unique identifier for Website associated with Poll Placement.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier for Web Template associated with Poll Placement.</para>
		...
		/// <para><strong>Description</strong>: Status of the Poll Placement</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Poll Placement</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_pollplacementOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
