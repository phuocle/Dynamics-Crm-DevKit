...
namespace Dev.DevKitV4.Shared.Entities.SystemApplicationMetadataOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SystemApplicationMetadata : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "System Application Metadata Collection";
		public const string DisplayName = "System Application Metadata";
		...
		/// <para><strong>Description</strong>: The logical name of the entity this application metadata is associated with.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Metadata Subtype</para>
		/// <para><strong>Description</strong>: For internal use only.</para>
