...
namespace Dev.DevKitV4.Shared.Entities.FaxOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Fax : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Faxes";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Fax</para>
		/// <para><strong>Description</strong>: Unique identifier of the fax activity.</para>
		...
		/// <para><strong>Description</strong>: Type the number of minutes spent creating and sending the fax. The duration is used in reporting.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual end date and time of the fax. By default, it displays the date and time when the activity was completed or canceled, but can be edited to capture the actual time to create and send the fax.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual start date and time for the fax. By default, it displays the date and time when the activity was created, but can be edited to capture the actual time to create and send the fax.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Billing Code</para>
		/// <para><strong>Description</strong>: Type the billing code for the fax to make sure the fax is charged to the correct sender or customer account.</para>
		...
		/// <para><strong>Description</strong>: Type a category to identify the fax type, such as sales offer or press release, to tie the fax to a business group or function.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Cover Page Name</para>
		/// <para><strong>Description</strong>: Type the name of the cover page to use when sending the fax.</para>
		...
		/// <para><strong>Description</strong>: Type additional information to describe the fax, such as the primary message or the products and services featured.</para>
		...
		/// <para><strong>Description</strong>: Select the direction of the fax as incoming or outbound.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Fax Number</para>
		/// <para><strong>Description</strong>: Type the recipient&apos;s fax number.</para>
		...
		/// <para><strong>Description</strong>: Enter the account, contact, lead, queue, or user who sent the fax.</para>
		...
		/// <para><strong>Description</strong>: Information regarding whether the fax activity was billed as part of resolving a case.</para>
		...
		/// <para><strong>Description</strong>: Indication of whether the fax activity was created by a workflow rule.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Number of Pages</para>
		/// <para><strong>Description</strong>: Type the number of pages included in the fax.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the business unit that owns the fax activity.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the team that owns the fax activity.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the user that owns the fax activity.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.FaxOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.FaxOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.FaxOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.FaxOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Choose the record that the fax relates to.</para>
		...
		/// <para><strong>Description</strong>: Shows the expected duration of the fax activity, in minutes.</para>
		...
		/// <para><strong>Description</strong>: Choose the service level agreement (SLA) that you want to apply to the fax record.</para>
		...
		/// <para><strong>Description</strong>: Last SLA that was applied to this fax. This field is for internal use only.</para>
		...
		/// <para><strong>Description</strong>: Shows whether the fax activity is open, completed, or canceled. Completed and canceled fax activities are read-only and can&apos;t be edited.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.FaxOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.FaxOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.FaxOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.FaxOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Select the fax&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.FaxOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.FaxOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.FaxOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type a subcategory to identify the fax type to relate the activity to a specific product, sales region, business group, or other function.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a short description about the objective or primary topic of the fax.</para>
		...
		/// <para><strong>Description</strong>: Enter the account, contact, lead, queue, or user recipients for the fax.</para>
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="queue"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Transmit. Station Id</para>
		/// <para><strong>Description</strong>: Type the Transmitting Subscriber ID (TSID) associated with a send action. This is typically a combination of the recipient&apos;s fax or phone number and company name.</para>
		...
		/// <para><strong>Description</strong>: Version number of the fax.</para>
