...
namespace Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class BusinessProcessFlowInstance : EntityBase
	{
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.BusinessProcessFlowInstanceOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
