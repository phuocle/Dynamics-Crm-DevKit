...
namespace Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class msdyn_analysisjob : EntityBase
	{
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_analysisjobOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
