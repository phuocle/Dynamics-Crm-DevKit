...
namespace Dev.DevKitV4.Shared.Entities.RoleTemplatePrivilegesOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class RoleTemplatePrivileges : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Description</strong>: Information about whether the role in the template applies to the user, the user&apos;s team, or objects shared by the user.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Information about whether the role in the template applies to child business units of the business unit associated with the user.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Information about whether the role in the template applies to the entire organization.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Information about whether the role in the template applies to the user&apos;s business unit.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the privilege assigned to the role template.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the role template that is associated with the role privilege.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the role template privileges.</para>
