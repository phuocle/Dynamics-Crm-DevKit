...
namespace Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ActivityParty : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode.Not_Recurring"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode? InstanceTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.InstanceTypeCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.InstanceTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.ParticipationTypeMask"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.ParticipationTypeMask? ParticipationTypeMask
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ParticipationTypeMask);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ActivityPartyOptionSets.ParticipationTypeMask)value.Value;
			}
			set
			{
				if (value.HasValue)
