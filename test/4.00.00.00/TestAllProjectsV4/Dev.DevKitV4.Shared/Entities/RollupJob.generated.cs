...
namespace Dev.DevKitV4.Shared.Entities.RollupJobOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class RollupJob : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StateCode.Ready"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StateCode)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RollupJobOptionSets.StatusCode)value.Value;
			}
		}
	}
}