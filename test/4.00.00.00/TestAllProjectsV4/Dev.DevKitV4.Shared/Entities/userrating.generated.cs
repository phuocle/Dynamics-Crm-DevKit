...
namespace Dev.DevKitV4.Shared.Entities.userratingOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class userrating : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "User Ratings";
		public const string DisplayName = "User Rating";
		...
		/// <para><strong>Description</strong>: Status of the User Rating</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.userratingOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.userratingOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.userratingOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the User Rating</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.userratingOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.userratingOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.userratingOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
