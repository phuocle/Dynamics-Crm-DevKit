...
namespace Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets
{
	public enum CanvasAppType
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Code App</para>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class CanvasApp : EntityBase
	{
		...
		/// <para><strong>Description</strong>: The type of the canvas app.</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.CanvasAppType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.CanvasAppType? CanvasAppType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CanvasAppType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.CanvasAppType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CanvasAppOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
