...
namespace Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SdkMessageProcessingStepImage : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType.PreImage"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType? ImageType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ImageType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SdkMessageProcessingStepImageOptionSets.ImageType)value.Value;
			}
			set
			{
				if (value.HasValue)
