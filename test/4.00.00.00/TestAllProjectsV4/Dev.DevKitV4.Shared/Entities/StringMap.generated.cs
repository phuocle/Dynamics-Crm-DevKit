...
namespace Dev.DevKitV4.Shared.Entities.StringMapOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class StringMap : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "String Maps";
		public const string DisplayName = "String Map";
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the string map.</para>
