...
namespace Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class EventExpanderBreadcrumb : EntityBase
	{
		...
		public const int EntityTypeCode = 5006;
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StateCode.Ready"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StatusCode.Waiting_For_Resources"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.EventExpanderBreadcrumbOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
