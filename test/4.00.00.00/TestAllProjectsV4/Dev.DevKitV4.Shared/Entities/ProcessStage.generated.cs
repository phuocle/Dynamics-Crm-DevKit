...
namespace Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ProcessStage : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationKind"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationKind? OperationKind
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationKind);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationKind)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationType? OperationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.OperationType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.StageCategory"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.StageCategory.Qualify"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.StageCategory? StageCategory
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StageCategory);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ProcessStageOptionSets.StageCategory)value.Value;
			}
			set
			{
				if (value.HasValue)
