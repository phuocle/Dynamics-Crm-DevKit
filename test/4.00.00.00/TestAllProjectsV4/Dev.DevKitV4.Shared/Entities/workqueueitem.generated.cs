...
namespace Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets
{
	...
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: AtRisk</para>
		/// <para><strong>Value</strong>: 2</para>
		/// </summary>
		AtRisk = 2,
		/// <summary>
		...
		NotSet = 0,
		/// <summary>
		/// <para><strong>Display Name</strong>: Out</para>
		/// <para><strong>Value</strong>: 3</para>
		/// </summary>
		Out = 3
	}
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class workqueueitem : EntityBase
	{
		public struct Fields
		{
			...
			public const string slastatus = "slastatus";
			public const string slathresholddate = "slathresholddate";
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.processortype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.processortype.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.processortype? processortype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.processortype);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.processortype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: SLA Status</para>
		/// <para><strong>Description</strong>: The SLA status provides more context for on the item processing status (In SLA, At Risk, Out of SLA).</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.slastatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.slastatus.NotSet"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.slastatus? slastatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.slastatus);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.slastatus)value.Value;
			}
			set
			{
				if (value.HasValue)
					Entity.Attributes[Fields.slastatus] = new OptionSetValue((int)value.Value);
				else
					Entity.Attributes[Fields.slastatus] = null;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: SLA Threshold Time</para>
		/// <para><strong>Description</strong>: Date and time on which the work queue item starts to be at risk of SLA violation.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public DateTime? slathresholddateUtc
		{
			get { return Entity.GetAttributeValue<DateTime?>(Fields.slathresholddate); }
			set { Entity.Attributes[Fields.slathresholddate] = value; }
		}
		/// <summary>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.workqueueitemOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
