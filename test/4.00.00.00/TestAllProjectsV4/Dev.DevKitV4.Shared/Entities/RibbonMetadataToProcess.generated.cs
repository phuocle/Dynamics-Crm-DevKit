...
namespace Dev.DevKitV4.Shared.Entities.RibbonMetadataToProcessOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class RibbonMetadataToProcess : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Ribbon Metadata Set To Process";
		public const string DisplayName = "Ribbon Metadata To Process";
		...
		/// <para><strong>Description</strong>: Shows the date and time when the ribbon entity record has finished processing. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Exception message which occurred during ribbon entity processing.</para>
		/// <para><strong>Description</strong>: Exception message</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Is entity created via Db Update</para>
		/// <para><strong>Description</strong>: Is entity created via Db Update</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Processed On</para>
		/// <para><strong>Description</strong>: Shows the date and time when the record was processed. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier for Ribbon Metadata Instance To Process</para>
		...
		/// <para><strong>Description</strong>: Solution Id</para>
		/// <para><strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Solution Name of the ribbon entity.</para>
		/// <para><strong>Description</strong>: Solution Name of the ribbon entity</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 256</para>
		/// </summary>
		[DebuggerNonUserCode()]
