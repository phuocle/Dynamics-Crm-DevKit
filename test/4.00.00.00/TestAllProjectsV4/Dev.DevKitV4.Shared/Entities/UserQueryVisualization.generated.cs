...
namespace Dev.DevKitV4.Shared.Entities.UserQueryVisualizationOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class UserQueryVisualization : EntityBase
	{
		public struct Fields
		{
			...
			public const string isNLGenerated = "isnlgenerated";
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.UserQueryVisualizationOptionSets.ChartType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.UserQueryVisualizationOptionSets.ChartType.ASPNET_Charts"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.UserQueryVisualizationOptionSets.ChartType? ChartType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ChartType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.UserQueryVisualizationOptionSets.ChartType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Tells whether the chart can retrieve data from all cluster partitions.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: NL Generated Chart</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		public bool? isNLGenerated
		{
			get { return Entity.GetAttributeValue<bool?>(Fields.isNLGenerated); }
			set { Entity.Attributes[Fields.isNLGenerated] = value; }
		}
		/// <summary>
