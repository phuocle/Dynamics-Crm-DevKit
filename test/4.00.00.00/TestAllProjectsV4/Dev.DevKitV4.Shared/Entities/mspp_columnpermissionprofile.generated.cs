...
namespace Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class mspp_columnpermissionprofile : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Column Permission Profiles";
		public const string DisplayName = "Column Permission Profile";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: All Column Permissions</para>
		/// <para><strong>MultiSelect OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.mspp_allcolumnpermissions"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public System.Collections.Generic.List<Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.mspp_allcolumnpermissions> mspp_allcolumnpermissions
		{
			get
			{
				var data = new System.Collections.Generic.List<Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.mspp_allcolumnpermissions>();
				...
				if (items != null)
				{
					...
					{
						data.Add((Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.mspp_allcolumnpermissions)item.Value);
					}
				}
				return data;
			}
		...
		/// <para><strong>Description</strong>: Status of the Column Permission Profile</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Column Permission Profile</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_columnpermissionprofileOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
