...
namespace Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets
{
	public enum AuthorizationServerType
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Access Control Service</para>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class AuthorizationServer : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Authorization Servers";
		public const string DisplayName = "Authorization Server";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Authorization Server Type</para>
		/// <para><strong>Description</strong>: The type of the Authorization Server</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.AuthorizationServerType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.AuthorizationServerType.Access_Control_Service"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.AuthorizationServerType? AuthorizationServerType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.AuthorizationServerType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.AuthorizationServerType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Contains the metadata for the authorization server.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Metadata Refreshed On</para>
		/// <para><strong>Description</strong>: Shows the date and time when the metadata was refreshed from the authorization server.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Contains the URL for the metadata.</para>
		...
		/// <para><strong>Description</strong>: Type the name of the authorization server.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Issuer Id</para>
		/// <para><strong>Description</strong>: Contains the issuer ID of the authorization server.</para>
		...
		/// <para><strong>Description</strong>: Shows whether the authorization server is active or inactive.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StateCode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StateCode)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Status Reason</para>
		/// <para><strong>Description</strong>: Select the authorization server&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.AuthorizationServerOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Version number of the authorization server.</para>
