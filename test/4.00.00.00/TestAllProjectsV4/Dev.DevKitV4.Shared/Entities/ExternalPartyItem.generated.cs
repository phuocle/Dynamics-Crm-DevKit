...
namespace Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ExternalPartyItem : EntityBase
	{
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StateCode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExternalPartyItemOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
