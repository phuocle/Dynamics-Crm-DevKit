...
namespace Dev.DevKitV4.Shared.Entities.CardTypeOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class CardType : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.CardTypeOptionSets.ClientAvailability"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.CardTypeOptionSets.ClientAvailability? ClientAvailability
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ClientAvailability);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.CardTypeOptionSets.ClientAvailability)value.Value;
			}
			set
			{
				if (value.HasValue)
