...
namespace Dev.DevKitV4.Shared.Entities.AppModuleMetadataOperationLogOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class AppModuleMetadataOperationLog : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "AppModule Metadata Async Operation Collection";
		public const string DisplayName = "AppModule Metadata Async Operation";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: AppModule Metadata Async Id</para>
		/// <para><strong>Description</strong>: For internal use only.</para>
		...
		/// <para><strong>Description</strong>: Date and time when the Async job was started.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Async Job State</para>
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
