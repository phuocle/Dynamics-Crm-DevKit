...
namespace Dev.DevKitV4.Shared.Entities.PrivilegeOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Privilege : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrivilegeOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PrivilegeOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PrivilegeOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
