...
namespace Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class msdyn_entityrefreshhistory : EntityBase
	{
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_entityrefreshhistoryOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
