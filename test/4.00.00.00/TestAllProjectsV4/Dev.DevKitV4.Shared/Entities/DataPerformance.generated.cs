...
namespace Dev.DevKitV4.Shared.Entities.DataPerformanceOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class DataPerformance : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Data Performance Collection";
		public const string DisplayName = "Data Performance Dashboard";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Any Optimization Applied</para>
		/// <para><strong>Description</strong>: An internal state which indicates whether at least one optimization is applied.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Any Optimization Available</para>
		/// <para><strong>Description</strong>: An internal state which indicates whether at least one optimization is available for this record.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Name of the component</para>
		...
		/// <para><strong>Description</strong>: Number of times a queries were executed (Aggregated)</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the performance suggestion.</para>
		...
		/// <para><strong>Description</strong>: Primary entity</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Estimated Optimization Impact</para>
		/// <para><strong>Description</strong>: The expected average cost benefit of an optimization.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Execution Period</para>
		/// <para><strong>Description</strong>: The execution period for which the performance metrics are calculated.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Last Action Result</para>
		/// <para><strong>Description</strong>: An internal state which shows the result of the last action that was taken on this record.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Last Optimization Date</para>
		/// <para><strong>Description</strong>: Last time an optimization was applied.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Max Time</para>
		/// <para><strong>Description</strong>: Maximum execution time in seconds. (Aggregated)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Median Time</para>
		/// <para><strong>Description</strong>: Average execution time in seconds. (Aggregated)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Min Time</para>
		/// <para><strong>Description</strong>: Minimum execution time in seconds. (Aggregated)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Data operation that triggered the query (Retrieve Multiple, etc.)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Current optimization status of the record, showed to the customer.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Optimization Storage</para>
		/// <para><strong>Description</strong>: Storage consumed by the optimization. (MB)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the organization associated.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Optimization Impact (%)</para>
		/// <para><strong>Description</strong>: Actual performance change after taking an optimization action on the record.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 50</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Name of the solution that owns the component</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 100,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Query Weight of the component. Factored with the Optimization Impact to determine the overall importance of applying an optimization. (P2)</para>
		/// <para><strong>ReadOnly</strong> - <strong>Floating Point Number</strong> - <strong>MinValue</strong>:  - <strong>MaxValue</strong>: 1,000,000,000</para>
		/// </summary>
		[DebuggerNonUserCode()]
