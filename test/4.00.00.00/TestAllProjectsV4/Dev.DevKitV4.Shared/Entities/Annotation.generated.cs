...
namespace Dev.DevKitV4.Shared.Entities.AnnotationOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Annotation : EntityBase
	{
		...
		/// <para><strong>Lookup</strong>: <see cref="account"/>, <see cref="adx_invitation"/>, <see cref="adx_inviteredemption"/>, <see cref="adx_portalcomment"/>, <see cref="appointment"/>, <see cref="approvalprocess"/>, <see cref="approvalstageapproval"/>, <see cref="calendar"/>, <see cref="channelaccessprofile"/>, <see cref="channelaccessprofilerule"/>, <see cref="channelaccessprofileruleitem"/>, <see cref="chat"/>, <see cref="contact"/>, <see cref="convertrule"/>, <see cref="duplicaterule"/>, <see cref="email"/>, <see cref="emailserverprofile"/>, <see cref="fax"/>, <see cref="goal"/>, <see cref="kbarticle"/>, <see cref="knowledgearticle"/>, <see cref="knowledgebaserecord"/>, <see cref="letter"/>, <see cref="mailbox"/>, <see cref="msdyn_aifptrainingdocument"/>, <see cref="msdyn_aimodel"/>, <see cref="msdyn_aiodimage"/>, <see cref="msdyn_flow_approval"/>, <see cref="msfp_alert"/>, <see cref="msfp_question"/>, <see cref="msfp_surveyinvite"/>, <see cref="msfp_surveyresponse"/>, <see cref="mspcat_catalogsubmissionfiles"/>, <see cref="phonecall"/>, <see cref="recurringappointmentmaster"/>, <see cref="routingrule"/>, <see cref="routingruleitem"/>, <see cref="sharepointdocument"/>, <see cref="sla"/>, <see cref="socialactivity"/>, <see cref="task"/>, <see cref="workflow"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
