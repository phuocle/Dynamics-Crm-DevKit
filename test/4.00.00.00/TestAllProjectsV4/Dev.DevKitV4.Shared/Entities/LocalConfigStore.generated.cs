...
namespace Dev.DevKitV4.Shared.Entities.LocalConfigStoreOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class LocalConfigStore : EntityBase
	{
		...
		/// <para><strong>Description</strong>: Assembly Name</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of LocalConfigStore entry.</para>
		...
		/// <para><strong>Description</strong>: Key Name</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 255</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Assembly Public Token</para>
		/// <para><strong>Description</strong>: Assembly Public Token</para>
		/// <para><strong>ReadOnly</strong> - <strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 255</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Value</para>
