...
namespace Dev.DevKitV4.Shared.Entities.SubscriptionManuallyTrackedObjectOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SubscriptionManuallyTrackedObject : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Subscription Manually Tracked Objects";
		public const string DisplayName = "Subscription Manually Tracked Object";
		...
		/// <para><strong>Description</strong>: Unique identifier of the object with which the subscription is associated.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Type code of the object with which the subscription is associated.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Information that specifies if the object is tracked.</para>
		...
		/// <para><strong>Description</strong>: Version number of the subscription manually tracked object.</para>
