...
namespace Dev.DevKitV4.Shared.Entities.Entity2OptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Entity2 : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.Entity2OptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.Entity2OptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.Entity2OptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
