...
namespace Dev.DevKitV4.Shared.Entities.ProvisionLanguageForUserOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ProvisionLanguageForUser : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus? OperationStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationStatus);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ProvisionLanguageForUserOptionSets.OperationStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
