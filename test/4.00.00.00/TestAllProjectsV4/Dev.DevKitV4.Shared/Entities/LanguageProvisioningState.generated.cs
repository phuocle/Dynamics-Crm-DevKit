...
namespace Dev.DevKitV4.Shared.Entities.LanguageProvisioningStateOptionSets
{
	public enum ProvisioningStage
	{
		...
		Other = 4,
		/// <summary>
		/// <para><strong>Display Name</strong>: Ribbon</para>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class LanguageProvisioningState : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Language Provisioning States";
		public const string DisplayName = "Language Provisioning State";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Application Version</para>
		/// <para><strong>Description</strong>: Application Version</para>
		...
		/// <para><strong>Description</strong>: Language Id</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Provisioning Stage</para>
		/// <para><strong>Description</strong>: Provisioning Stage</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage? ProvisioningStage
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ProvisioningStage);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.LanguageProvisioningStateOptionSets.ProvisioningStage)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Solution File Version</para>
		/// <para><strong>Description</strong>: Solution File Version</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 256</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Solution Unique Name</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 256</para>
		/// </summary>
		[DebuggerNonUserCode()]
