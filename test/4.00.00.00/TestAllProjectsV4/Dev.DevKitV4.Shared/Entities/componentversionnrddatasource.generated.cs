...
namespace Dev.DevKitV4.Shared.Entities.componentversionnrddatasourceOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class componentversionnrddatasource : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.componentversionnrddatasourceOptionSets.Operation"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.componentversionnrddatasourceOptionSets.Operation? Operation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Operation);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.componentversionnrddatasourceOptionSets.Operation)value.Value;
			}
			set
			{
				if (value.HasValue)
