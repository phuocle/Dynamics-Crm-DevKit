...
namespace Dev.DevKitV4.Shared.Entities.QueueItemOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class QueueItem : EntityBase
	{
		...
		/// <para>Required - <strong>Lookup</strong>: <see cref="activitypointer"/>, <see cref="adx_inviteredemption"/>, <see cref="adx_portalcomment"/>, <see cref="appointment"/>, <see cref="chat"/>, <see cref="email"/>, <see cref="fax"/>, <see cref="knowledgearticle"/>, <see cref="letter"/>, <see cref="msdyn_knowledgearticletemplate"/>, <see cref="msfp_alert"/>, <see cref="msfp_surveyinvite"/>, <see cref="msfp_surveyresponse"/>, <see cref="phonecall"/>, <see cref="recurringappointmentmaster"/>, <see cref="socialactivity"/>, <see cref="task"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.ObjectTypeCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.ObjectTypeCode? ObjectTypeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ObjectTypeCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.ObjectTypeCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.QueueItemOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
