...
namespace Dev.DevKitV4.Shared.Entities.ClientUpdateOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ClientUpdate : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ClientUpdateOptionSets.WhenExecute"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ClientUpdateOptionSets.WhenExecute.After_download_data"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ClientUpdateOptionSets.WhenExecute? WhenExecute
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.WhenExecute);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ClientUpdateOptionSets.WhenExecute)value.Value;
			}
			set
			{
				if (value.HasValue)
