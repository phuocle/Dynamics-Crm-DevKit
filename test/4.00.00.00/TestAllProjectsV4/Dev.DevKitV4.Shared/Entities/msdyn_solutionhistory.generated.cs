...
namespace Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets
{
	public enum msdyn_operation
	{
		...
		Export = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: ExportLite</para>
		...
		Uninstall = 1,
		/// <summary>
		/// <para><strong>Display Name</strong>: UpdatingMissingPackages</para>
	...
	public enum msdyn_suboperation
	{
		...
		Delete = 4,
		/// <summary>
		/// <para><strong>Display Name</strong>: FailedInstallingMissingPackages</para>
		/// <para><strong>Value</strong>: 8</para>
		/// </summary>
		FailedInstallingMissingPackages = 8,
		/// <summary>
		/// <para><strong>Display Name</strong>: InlineUpgrade</para>
		/// <para><strong>Value</strong>: 5</para>
		/// </summary>
		InlineUpgrade = 5,
		/// <summary>
		/// <para><strong>Display Name</strong>: InstalledMissingPackages</para>
		/// <para><strong>Value</strong>: 7</para>
		/// </summary>
		...
		Upgrade = 2,
		/// <summary>
		/// <para><strong>Display Name</strong>: WaitingForMissingPackages</para>
		/// <para><strong>Value</strong>: 6</para>
		/// </summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class msdyn_solutionhistory : EntityBase
	{
		public struct Fields
		{
			...
			public const string msdyn_solutionhistorydescription = "msdyn_solutionhistorydescription";
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_operation"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_operation? msdyn_operation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_operation);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_operation)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		{
			get { return Entity.GetAttributeValue<string>(Fields.msdyn_solutionhistorydescription); }
			set { Entity.Attributes[Fields.msdyn_solutionhistorydescription] = value; }
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_status"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_status? msdyn_status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_status);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_status)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_suboperation"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_suboperation? msdyn_suboperation
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_suboperation);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_solutionhistoryOptionSets.msdyn_suboperation)value.Value;
			}
			set
			{
				if (value.HasValue)
