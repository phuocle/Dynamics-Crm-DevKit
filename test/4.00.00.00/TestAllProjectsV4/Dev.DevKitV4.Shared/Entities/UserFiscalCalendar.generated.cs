...
namespace Dev.DevKitV4.Shared.Entities.UserFiscalCalendarOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class UserFiscalCalendar : EntityBase
	{
		...
		public const string EntityCollectionSchemaName = "UserFiscalCalendars";
		public const string EntityDisplayCollectionName = "User Fiscal Calendars";
		public const string DisplayName = "User Fiscal Calendar";
		...
		/// <summary>
		/// Instance new late bound class <see cref="UserFiscalCalendar"/> with <paramref name="targetEntity"/>.
		/// </summary>
		[DebuggerNonUserCode()]
		public UserFiscalCalendar(Entity targetEntity)
		{
			Entity = targetEntity ?? new Entity(EntityLogicalName, Guid.Empty);
			PreEntity = CloneThisEntity(Entity);
		}
		/// <summary>
		/// Instance new late bound class <see cref="UserFiscalCalendar"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public UserFiscalCalendar(Entity preEntity, Entity targetEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new UserFiscalCalendar(preEntity, targetEntity) with targetEntity = null");
		...
		/// <summary>
		/// Instance new late bound class <see cref="UserFiscalCalendar"/> with <paramref name="preEntity"/>. Then copy all attributes from <paramref name="targetEntity"/> to <paramref name="preEntity"/>. After that copy all attributes from <paramref name="postEntity"/> to the last result. Existing attribute will be overwritten.
		/// </summary>
		/// <exception cref="InvalidPluginExecutionException">when <paramref name="targetEntity"/> is null.</exception>
		[DebuggerNonUserCode()]
		public UserFiscalCalendar(Entity preEntity, Entity targetEntity, Entity postEntity)
		{
			if (targetEntity == null) throw new InvalidPluginExecutionException($"new UserFiscalCalendar(preEntity, targetEntity, postEntity) with targetEntity = null");
			if (preEntity == null) preEntity = new Entity(targetEntity.LogicalName, targetEntity.Id);
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the business unit with which the user fiscal calendar is associated.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Date and time when the fiscal calendar was created.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who created the userfiscalcalendar.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Date and time when the fiscal calendar takes effect.</para>
		...
		/// <para><strong>Description</strong>: Exchange rate for the currency associated with the user fiscal calendar with respect to the base currency.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Type of fiscal period used in the fiscal calendar.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the user who last modified the fiscal calendar.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Date and time when the fiscal calendar was last modified.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateAndTime</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the delegate user who last modified the userfiscalcalendar.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the salesperson to whom the fiscal calendar is assigned.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the currency associated with the user fiscal calendar.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier for the fiscal calendar.</para>
