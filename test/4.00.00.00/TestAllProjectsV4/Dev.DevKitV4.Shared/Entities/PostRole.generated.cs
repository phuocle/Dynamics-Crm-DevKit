...
namespace Dev.DevKitV4.Shared.Entities.PostRoleOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class PostRole : EntityBase
	{
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostRoleOptionSets.Type"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostRoleOptionSets.Type.Regarding"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PostRoleOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PostRoleOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
