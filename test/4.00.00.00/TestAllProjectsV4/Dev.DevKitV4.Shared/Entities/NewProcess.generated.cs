...
namespace Dev.DevKitV4.Shared.Entities.NewProcessOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class NewProcess : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "New Process";
		public const string DisplayName = "New Process";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: New Process Instance Id</para>
		/// <para><strong>Description</strong>: Unique identifier for New Process bpf entity instances</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the Knowledge Article associated to the Business Process Flow instance.</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.NewProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
