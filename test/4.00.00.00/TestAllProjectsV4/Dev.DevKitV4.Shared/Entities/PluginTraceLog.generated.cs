...
namespace Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets
{
	public enum Mode
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class PluginTraceLog : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.Mode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.Mode.Asynchronous"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.Mode? Mode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Mode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.Mode)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>Display Name</strong>: Operation Type</para>
		/// <para><strong>Description</strong>: Type of custom code.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.OperationType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.OperationType.Unknown"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.OperationType? OperationType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PluginTraceLogOptionSets.OperationType)value.Value;
			}
		}
		/// <summary>
