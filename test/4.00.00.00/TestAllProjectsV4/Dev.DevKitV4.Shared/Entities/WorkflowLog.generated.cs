...
namespace Dev.DevKitV4.Shared.Entities.WorkflowLogOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class WorkflowLog : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.WorkflowLogOptionSets.Status"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.WorkflowLogOptionSets.Status.In_Progress"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.WorkflowLogOptionSets.Status? Status
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Status);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.WorkflowLogOptionSets.Status)value.Value;
			}
			set
			{
				if (value.HasValue)
