...
namespace Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class RibbonRule : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.RuleType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.RuleType? RuleType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RuleType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.RibbonRuleOptionSets.RuleType)value.Value;
			}
			set
			{
				if (value.HasValue)
