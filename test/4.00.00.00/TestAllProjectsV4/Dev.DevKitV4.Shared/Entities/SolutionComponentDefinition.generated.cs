...
namespace Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class SolutionComponentDefinition : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.RemoveActiveCustomizationsBehavior"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.RemoveActiveCustomizationsBehavior.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.RemoveActiveCustomizationsBehavior? RemoveActiveCustomizationsBehavior
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.RemoveActiveCustomizationsBehavior);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SolutionComponentDefinitionOptionSets.RemoveActiveCustomizationsBehavior)value.Value;
			}
			set
			{
				if (value.HasValue)
