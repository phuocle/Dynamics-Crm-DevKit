...
namespace Dev.DevKitV4.Shared.Entities.SolutionOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Solution : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SolutionType"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SolutionType.None"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SolutionType? SolutionType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SolutionType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SolutionType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SourceControlSyncStatus"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SourceControlSyncStatus.Not_started"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SourceControlSyncStatus? SourceControlSyncStatus
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SourceControlSyncStatus);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.SolutionOptionSets.SourceControlSyncStatus)value.Value;
			}
			set
			{
				if (value.HasValue)
