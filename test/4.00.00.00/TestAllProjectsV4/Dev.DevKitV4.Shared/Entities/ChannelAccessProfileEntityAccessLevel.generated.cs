...
namespace Dev.DevKitV4.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ChannelAccessProfileEntityAccessLevel : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the entity access level associated with the channel access profile.</para>
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the channel access profile.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ChannelAccessProfileEntityAccessLevelOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
