...
namespace Dev.DevKitV4.Shared.Entities.PostOptionSets
{
	public enum Source
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Post : EntityBase
	{
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostOptionSets.Source"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostOptionSets.Source.Manual_Post"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PostOptionSets.Source? Source
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Source);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PostOptionSets.Source)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostOptionSets.Type"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PostOptionSets.Type.Check_in"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PostOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PostOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
