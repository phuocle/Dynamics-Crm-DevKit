...
namespace Dev.DevKitV4.Shared.Entities.FileAttachmentOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class FileAttachment : EntityBase
	{
		...
		/// <para><strong>Lookup</strong>: <see cref="activityfileattachment"/>, <see cref="activitypointer"/>, <see cref="approvalprocess"/>, <see cref="approvalstageintelligent"/>, <see cref="asyncoperation"/>, <see cref="botcomponent"/>, <see cref="canvasapp"/>, <see cref="cascadegrantrevokeaccessrecordstracker"/>, <see cref="deleteditemreference"/>, <see cref="desktopflowbinary"/>, <see cref="desktopflowmodule"/>, <see cref="email"/>, <see cref="exportedexcel"/>, <see cref="exportsolutionupload"/>, <see cref="flowmachineimageversion"/>, <see cref="flowsession"/>, <see cref="imagedescriptor"/>, <see cref="knowledgearticle"/>, <see cref="mailbox"/>, <see cref="msdyn_aibfeedbackloop"/>, <see cref="msdyn_aibfile"/>, <see cref="msdyn_aiconfiguration"/>, <see cref="msdyn_aidataprocessingevent"/>, <see cref="msdyn_aidocumenttemplate"/>, <see cref="msdyn_aievent"/>, <see cref="msdyn_aioptimizationprivatedata"/>, <see cref="msdyn_aitestcasedocument"/>, <see cref="msdyn_analysisjob"/>, <see cref="msdyn_dataworkspace"/>, <see cref="msdyn_fileupload"/>, <see cref="msdyn_integratedsearchprovider"/>, <see cref="msdyn_kbattachment"/>, <see cref="msdyn_knowledgearticleimage"/>, <see cref="msdyn_mobileapp"/>, <see cref="msdyn_plan"/>, <see cref="msdyn_planartifact"/>, <see cref="msdyn_planattachment"/>, <see cref="msdyn_pminferredtask"/>, <see cref="msdyn_richtextfile"/>, <see cref="msfp_fileresponse"/>, <see cref="mspcat_catalogsubmissionfiles"/>, <see cref="mspcat_packagestore"/>, <see cref="package"/>, <see cref="packagehistory"/>, <see cref="pluginpackage"/>, <see cref="powerbidataset"/>, <see cref="powerbireport"/>, <see cref="powerpagecomponent"/>, <see cref="powerpagesitepublished"/>, <see cref="powerpagesscanreport"/>, <see cref="powerpagessourcefile"/>, <see cref="report"/>, <see cref="retaineddataexcel"/>, <see cref="revokeinheritedaccessrecordstracker"/>, <see cref="ribbonclientmetadata"/>, <see cref="searchcustomanalyzer"/>, <see cref="solution"/>, <see cref="stagesolutionupload"/>, <see cref="unstructuredfilesearchrecord"/>, <see cref="webresource"/>, <see cref="workflowbinary"/>, <see cref="workflowlog"/>, <see cref="workflowmetadata"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
