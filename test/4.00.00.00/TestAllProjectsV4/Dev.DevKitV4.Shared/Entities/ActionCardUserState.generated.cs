...
namespace Dev.DevKitV4.Shared.Entities.ActionCardUserStateOptionSets
{
	public enum State
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ActionCardUserState : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ActionCardUserStateOptionSets.State"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ActionCardUserStateOptionSets.State.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ActionCardUserStateOptionSets.State? State
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.State);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ActionCardUserStateOptionSets.State)value.Value;
			}
			set
			{
				if (value.HasValue)
