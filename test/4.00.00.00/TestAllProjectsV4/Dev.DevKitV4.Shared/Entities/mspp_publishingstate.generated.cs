...
namespace Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class mspp_publishingstate : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Publishing States";
		public const string DisplayName = "Publishing State";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Select whether the publishing state is visible.</para>
		/// <para>Required - <strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier for Website associated with Publishing State.</para>
		...
		/// <para><strong>Description</strong>: Status of the Publishing State</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Publishing State</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspp_publishingstateOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
