...
namespace Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ReportVisibility : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.VisibilityCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.VisibilityCode? VisibilityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.VisibilityCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ReportVisibilityOptionSets.VisibilityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
