...
namespace Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets
{
	...
	public enum mspcat_ImageSize
	{
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Screen Shot</para>
		/// <para><strong>Value</strong>: 526,430,002</para>
		/// </summary>
		Screen_Shot = 526_430_002
	}
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class mspcat_CatalogSubmissionFiles : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Catalog Submission Files";
		public const string DisplayName = "Catalog Submission Files";
		...
		/// <para><strong>Description</strong>: File Item description</para>
		...
		/// <para><strong>Description</strong>: File asset</para>
		...
		/// <para><strong>Description</strong>: Type of File Described</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_FileType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_FileType? mspcat_FileType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.mspcat_FileType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_FileType)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Image Size</para>
		/// <para><strong>Description</strong>: Size of Image Described</para>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_ImageSize"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_ImageSize? mspcat_ImageSize
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.mspcat_ImageSize);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.mspcat_ImageSize)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Related Package Store Item.</para>
		...
		/// <para><strong>Description</strong>: Status of the Catalog Submission Files</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statecode"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statecode? statecode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statecode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statecode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Reason for the status of the Catalog Submission Files</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statuscode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statuscode? statuscode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.statuscode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mspcat_CatalogSubmissionFilesOptionSets.statuscode)value.Value;
			}
			set
			{
				if (value.HasValue)
