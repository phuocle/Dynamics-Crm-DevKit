...
//		Last Modified: 2025-09-16 06:21:12
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets
{
	...
	public enum StatusCode
	{
		...
		Canceled = 3,
		/// <summary>
		/// <para><strong>Display Name</strong>: Made</para>
		/// <para><strong>Value</strong>: 2</para>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class PhoneCall : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Phone Calls";
		public const string DisplayName = "Phone Call";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Phone Call</para>
		/// <para><strong>Description</strong>: Unique identifier of the phone call activity.</para>
		...
		/// <para><strong>Description</strong>: Type the number of minutes spent on the phone call. The duration is used in reporting.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual end date and time of the phone call. By default, it displays the date and time when the activity was completed or canceled, but can be edited to capture the actual duration of the phone call.</para>
		...
		/// <para><strong>Description</strong>: Enter the actual start date and time for the phone call. By default, it displays the date and time when the activity was created, but can be edited to capture the actual duration of the phone call.</para>
		/// <para><strong>Date and Time</strong> - <strong>DateTimeBehavior</strong>: UserLocal - <strong>DateTimeFormat</strong>: DateOnly</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a category to identify the phone call type, such as lead gathering or customer follow-up, to tie the phone call to a business group or function.</para>
		...
		/// <para><strong>Description</strong>: Type additional information to describe the phone call, such as the primary message or the products and services discussed.</para>
		...
		/// <para><strong>Description</strong>: Select the direction of the phone call as incoming or outbound.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Call From</para>
		/// <para><strong>Description</strong>: Enter the account, contact, lead, or user who made the phone call.</para>
		...
		/// <para><strong>Description</strong>: Information which specifies whether the phone call activity was billed as part of resolving a case.</para>
		...
		/// <para><strong>Description</strong>: Indication which specifies if the phone call activity was created by a workflow rule.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Select whether a voice mail was left for the person.</para>
		/// <para><strong>Two Option</strong> - [<strong>Yes</strong>]: true - [<strong>No</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>No</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Unique identifier of the business unit that owns the phone call activity.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the team that owns the phone call activity.</para>
		...
		/// <para><strong>Description</strong>: Unique identifier of the user that owns the phone call activity.</para>
		/// <para><strong>ReadOnly</strong> - <strong>Lookup</strong>: <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type the phone number.</para>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.PriorityCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.PriorityCode.Normal"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.PriorityCode? PriorityCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.PriorityCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.PriorityCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Choose the record that the phone call relates to.</para>
		...
		/// <para><strong>Description</strong>: Scheduled duration of the phone call activity, specified in minutes.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Due</para>
		...
		/// <para><strong>Description</strong>: Choose the service level agreement (SLA) that you want to apply to the Phone Call record.</para>
		...
		/// <para><strong>Description</strong>: Last SLA that was applied to this Phone Call. This field is for internal use only.</para>
		...
		/// <para><strong>Description</strong>: Shows whether the phone call is open, completed, or canceled. Completed and canceled phone calls are read-only and can&apos;t be edited.</para>
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StateCode.Open"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Select the phone call&apos;s status.</para>
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PhoneCallOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Description</strong>: Type a subcategory to identify the phone call type and relate the activity to a specific product, sales region, business group, or other function.</para>
		/// <para><strong>Single Line of Text</strong> - <strong>MaxLength</strong>: 250</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Type a short description about the objective or primary topic of the phone call.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Call To</para>
		/// <para><strong>Description</strong>: Enter the account, contact, lead, or user recipients of the phone call.</para>
		/// <para>Required - <strong>Lookup</strong>: <see cref="account"/>, <see cref="contact"/>, <see cref="systemuser"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Version number of the phone call activity.</para>
