...
namespace Dev.DevKitV4.Shared.Entities.UserFormOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class UserForm : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.UserFormOptionSets.Type"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.UserFormOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.UserFormOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
