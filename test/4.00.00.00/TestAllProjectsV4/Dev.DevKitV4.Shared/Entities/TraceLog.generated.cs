...
namespace Dev.DevKitV4.Shared.Entities.TraceLogOptionSets
{
	public enum Level
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class TraceLog : EntityBase
	{
		...
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TraceLogOptionSets.Level"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TraceLogOptionSets.Level.Information"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.TraceLogOptionSets.Level? Level
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Level);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.TraceLogOptionSets.Level)value.Value;
			}
			set
			{
				if (value.HasValue)
