...
namespace Dev.DevKitV4.Shared.Entities.msdyn_odatav4dsOptionSets
{
	public enum msdyn_paginationtype
	{
		/// <summary>
		/// <para><strong>Display Name</strong>: Client-side Paging</para>
		/// <para><strong>Value</strong>: 0</para>
		/// </summary>
		Client_side_Paging = 0,
		/// <summary>
		/// <para><strong>Display Name</strong>: Server-side Paging</para>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class msdyn_odatav4ds : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "OData v4 Data Sources";
		public const string DisplayName = "OData v4 Data Source";
		...
		/// <para><strong>Description</strong>: Type additional information to describe this OData v4 data source. What environment does this data source target and what is the purpose of this system ?</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter10 Type</para>
		/// <para><strong>Description</strong>: Parameter10 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter1 Type</para>
		/// <para><strong>Description</strong>: Parameter1 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter2 Type</para>
		/// <para><strong>Description</strong>: Parameter2 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter3 Type</para>
		/// <para><strong>Description</strong>: Parameter3 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter4 Type</para>
		/// <para><strong>Description</strong>: Parameter4 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter5 Type</para>
		/// <para><strong>Description</strong>: Parameter5 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter6 Type</para>
		/// <para><strong>Description</strong>: Parameter6 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter7 Type</para>
		/// <para><strong>Description</strong>: Parameter7 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter8 Type</para>
		/// <para><strong>Description</strong>: Parameter8 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Parameter9 Type</para>
		/// <para><strong>Description</strong>: Parameter9 Type</para>
		/// <para><strong>Two Option</strong> - [<strong>Header</strong>]: true - [<strong>Query String</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Query String</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <para><strong>Description</strong>: Name of the OData v4 data source. This name appears in the data source drop-down list when creating a new entity.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Pagination Mode</para>
		/// <para><strong>Two Option</strong> - [<strong>Server-side Paging</strong>]: true - [<strong>Client-side Paging</strong>]: false</para>
		/// <para><strong>Default Value</strong> [<strong>Client-side Paging</strong>]: false</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Pagination Mode</para>
		/// <para>Required - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype.Client_side_Paging"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype? msdyn_paginationtype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.msdyn_paginationtype);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.msdyn_odatav4dsOptionSets.msdyn_paginationtype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Return Inline Count</para>
		...
		/// <para><strong>Description</strong>: Amount of time to wait, in seconds, before timing out an OData v4 request.</para>
		...
		/// <para><strong>Description</strong>: URL of the OData v4 web service endpoint this data source will target.</para>
