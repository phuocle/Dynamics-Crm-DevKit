...
namespace Dev.DevKitV4.Shared.Entities.EntityRelationshipOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class EntityRelationship : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Entity Relationships";
		public const string DisplayName = "Entity Relationship";
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.EntityRelationshipOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.EntityRelationshipOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.EntityRelationshipOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Description</strong>: The name of this Entity Relationship.</para>
