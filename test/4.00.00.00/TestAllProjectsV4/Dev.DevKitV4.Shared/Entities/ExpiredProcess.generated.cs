...
namespace Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class ExpiredProcess : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Expired Process";
		public const string DisplayName = "Expired Process";
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Expired Process Instance Id</para>
		/// <para><strong>Description</strong>: Unique identifier for Expired Process bpf entity instances</para>
		...
		/// <para><strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StateCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ExpiredProcessOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
