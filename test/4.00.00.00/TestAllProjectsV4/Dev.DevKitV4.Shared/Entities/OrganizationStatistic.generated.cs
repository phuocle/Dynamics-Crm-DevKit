...
namespace Dev.DevKitV4.Shared.Entities.OrganizationStatisticOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class OrganizationStatistic : EntityBase
	{
		...
		public const string EntityDisplayCollectionName = "Organization Statistics";
		public const string DisplayName = "Organization Statistic";
		...
		/// <para><strong>Description</strong>: Hour that the statistic measurement was taken.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Org Statistic</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Server Name</para>
		/// <para><strong>Description</strong>: Server that owns this record.</para>
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Statistic Type</para>
		/// <para><strong>Description</strong>: Statistic type that is being measured.</para>
		/// <para><strong>ReadOnly</strong> - Required - <strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
		...
		/// <summary>
		/// <para><strong>Display Name</strong>: Statistic Value</para>
		/// <para><strong>Description</strong>: Value of the statistic.</para>
		/// <para><strong>ReadOnly</strong> - Required - <strong>Whole Number</strong> - <strong>MinValue</strong>: -2,147,483,648 - <strong>MaxValue</strong>: 2,147,483,647</para>
		/// </summary>
		[DebuggerNonUserCode()]
