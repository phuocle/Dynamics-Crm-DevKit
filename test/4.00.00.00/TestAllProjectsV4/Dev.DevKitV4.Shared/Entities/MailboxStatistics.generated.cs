...
namespace Dev.DevKitV4.Shared.Entities.MailboxStatisticsOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class MailboxStatistics : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId? OperationTypeId
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.OperationTypeId);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.MailboxStatisticsOptionSets.OperationTypeId)value.Value;
			}
		}
		/// <summary>
