...
namespace Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets
{
	public enum subtype
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class mobileofflineprofileitemfilter : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.subtype"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.subtype? subtype
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.subtype);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.subtype)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.type"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.type? type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.type);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.mobileofflineprofileitemfilterOptionSets.type)value.Value;
			}
			set
			{
				if (value.HasValue)
