...
namespace Dev.DevKitV4.Shared.Entities.ImportOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class Import : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.ModeCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.ModeCode.Create"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ImportOptionSets.ModeCode? ModeCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ModeCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ImportOptionSets.ModeCode)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <para><strong>ReadOnly</strong> - <strong>Status</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.StateCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.StateCode.Active"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ImportOptionSets.StateCode? StateCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StateCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ImportOptionSets.StateCode)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>Status Reason</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.StatusCode"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.ImportOptionSets.StatusCode.Submitted"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.ImportOptionSets.StatusCode? StatusCode
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.StatusCode);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.ImportOptionSets.StatusCode)value.Value;
			}
			set
			{
				if (value.HasValue)
