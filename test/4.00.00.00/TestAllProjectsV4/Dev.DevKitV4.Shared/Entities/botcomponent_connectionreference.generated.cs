...
namespace Dev.DevKitV4.Shared.Entities.botcomponent_connectionreferenceOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class botcomponent_connectionreference : EntityBase
	{
		...
		/// <para><strong>Description</strong>: For internal use only.</para>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.botcomponent_connectionreferenceOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.botcomponent_connectionreferenceOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.botcomponent_connectionreferenceOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>Uniqueidentifier</strong></para>
