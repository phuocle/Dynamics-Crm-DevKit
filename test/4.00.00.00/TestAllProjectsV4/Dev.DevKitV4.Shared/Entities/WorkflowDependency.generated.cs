...
namespace Dev.DevKitV4.Shared.Entities.WorkflowDependencyOptionSets
{
	public enum Type
	{
		/// <summary>
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class WorkflowDependency : EntityBase
	{
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.WorkflowDependencyOptionSets.Type"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.WorkflowDependencyOptionSets.Type.Local_parameter"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.WorkflowDependencyOptionSets.Type? Type
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.Type);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.WorkflowDependencyOptionSets.Type)value.Value;
			}
			set
			{
				if (value.HasValue)
