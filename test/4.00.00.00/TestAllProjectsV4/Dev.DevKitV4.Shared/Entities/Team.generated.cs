...
namespace Dev.DevKitV4.Shared.Entities.TeamOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
    ...
    public partial class Team : EntityBase
    {
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TeamOptionSets.MembershipType"/></para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TeamOptionSets.MembershipType.Members_and_guests"/></para>
        /// </summary>
        [DebuggerNonUserCode()]
        public Dev.DevKitV4.Shared.Entities.TeamOptionSets.MembershipType? MembershipType
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MembershipType);
                if (value == null) return null;
                return (Dev.DevKitV4.Shared.Entities.TeamOptionSets.MembershipType)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TeamOptionSets.TeamType"/></para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.TeamOptionSets.TeamType.Owner"/></para>
        /// </summary>
        [DebuggerNonUserCode()]
        public Dev.DevKitV4.Shared.Entities.TeamOptionSets.TeamType? TeamType
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TeamType);
                if (value == null) return null;
                return (Dev.DevKitV4.Shared.Entities.TeamOptionSets.TeamType)value.Value;
            }
            set
            {
                if (value.HasValue)
