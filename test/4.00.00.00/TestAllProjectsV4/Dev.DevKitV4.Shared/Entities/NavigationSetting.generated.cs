...
namespace Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class NavigationSetting : EntityBase
	{
		...
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.ComponentState"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.ComponentState? ComponentState
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ComponentState);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.ComponentState)value.Value;
			}
		}
		/// <summary>
		...
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.SettingType"/></para>
		/// <para><strong>Default Value</strong>: <see langword="null"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.SettingType? SettingType
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.SettingType);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.NavigationSettingOptionSets.SettingType)value.Value;
			}
			set
			{
				if (value.HasValue)
