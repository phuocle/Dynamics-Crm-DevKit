...
namespace Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets
{
...
namespace Dev.DevKitV4.Shared.Entities
{
	...
	public partial class PrincipalAttributeAccessMap : EntityBase
	{
		...
		/// <summary>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.CreateAccess"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.CreateAccess? CreateAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.CreateAccess);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.CreateAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>Description</strong>: Unique identifier of the principal attribute access.</para>
		...
		/// <summary>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadAccess"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadAccess? ReadAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReadAccess);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
		...
		/// <summary>
		/// <para><strong>ReadOnly</strong> - <strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadUnMaskedAccess"/></para>
		/// <para><strong>Default Value</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadUnMaskedAccess.Not_Allowed"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadUnMaskedAccess? ReadUnMaskedAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.ReadUnMaskedAccess);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.ReadUnMaskedAccess)value.Value;
			}
		}
		/// <summary>
		/// <para><strong>OptionSet</strong>: <see cref="Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.UpdateAccess"/></para>
		/// </summary>
		[DebuggerNonUserCode()]
		public Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.UpdateAccess? UpdateAccess
		{
			get
			{
				var value = Entity.GetAttributeValue<OptionSetValue>(Fields.UpdateAccess);
				if (value == null) return null;
				return (Dev.DevKitV4.Shared.Entities.PrincipalAttributeAccessMapOptionSets.UpdateAccess)value.Value;
			}
			set
			{
				if (value.HasValue)
