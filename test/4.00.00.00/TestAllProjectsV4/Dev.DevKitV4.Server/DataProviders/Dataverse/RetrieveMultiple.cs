...
namespace Dev.DevKitV4.Server.DataProviders.Dataverse
{
    [CrmPluginRegistration("Dev.DevKitV4.Server.DataProviders.Dataverse.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "v4_dataverse_datasource")]
