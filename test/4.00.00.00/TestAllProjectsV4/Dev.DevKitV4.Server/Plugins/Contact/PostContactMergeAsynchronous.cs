...
{
    [CrmPluginRegistration("Merge", "contact", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.Plugins.Contact.PostContactMergeAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true, Image1Name = "PreImage", Image1Alias = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "*", Image2Name = "PostImage", Image2Alias = "PostImage", Image2Type = ImageTypeEnum.PostImage, Image2Attributes = "*")]
    public class PostContactMergeAsynchronous : IPlugin
    {
        ...
        InputParameters:
            ...
            UpdateContent             Microsoft.Xrm.Sdk.Entity
        ...
        */
        ...
        //public PostContactMergeAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (!string.Equals(context.MessageName, "Merge", StringComparison.OrdinalIgnoreCase)) throw new InvalidPluginExecutionException("MessageName does not equals Merge");
