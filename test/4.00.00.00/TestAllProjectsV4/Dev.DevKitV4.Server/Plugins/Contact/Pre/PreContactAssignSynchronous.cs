...
{
    [CrmPluginRegistration("Assign", "contact", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "", "Dev.DevKitV4.Server.Plugins.Contact.Pre.PreContactAssignSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Image1Name = "PreImage", Image1Alias = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "*")]
    public class PreContactAssignSynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PreContactAssignSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
