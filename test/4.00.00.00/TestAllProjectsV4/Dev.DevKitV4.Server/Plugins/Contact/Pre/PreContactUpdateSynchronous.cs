...
{
    [CrmPluginRegistration("Update", "contact", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "firstname", "Dev.DevKitV4.Server.Plugins.Contact.Pre.PreContactUpdateSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Image1Name = "PreImage", Image1Alias = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "*")]
    public class PreContactUpdateSynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PreContactUpdateSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
