...
{
    [CrmPluginRegistration("Delete", "contact", StageEnum.PreOperation, ExecutionModeEnum.Synchronous, "", "Dev.DevKitV4.Server.Plugins.Contact.Pre.PreContactDeleteSynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, Image1Name = "PreImage", Image1Alias = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "*")]
    public class PreContactDeleteSynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PreContactDeleteSynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
