...
namespace Dev.DevKitV4.Server.Plugins.Contact
{
    ...
    public class PostContactAssignAsynchronous : IPlugin
    {
        ...
        */
        ...
        //public PostContactAssignAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
