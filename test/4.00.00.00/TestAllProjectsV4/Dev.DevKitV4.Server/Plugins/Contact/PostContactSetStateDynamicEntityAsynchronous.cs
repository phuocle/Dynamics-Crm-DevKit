...
{
    [CrmPluginRegistration("SetStateDynamicEntity", "contact", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.Plugins.Contact.PostContactSetStateDynamicEntityAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true, Image1Name = "PreImage", Image1Alias = "PreImage", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "*", Image2Name = "PostImage", Image2Alias = "PostImage", Image2Type = ImageTypeEnum.PostImage, Image2Attributes = "*")]
    public class PostContactSetStateDynamicEntityAsynchronous : IPlugin
    {
        /*
        ...
        */
        ...
        //public PostContactSetStateDynamicEntityAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
