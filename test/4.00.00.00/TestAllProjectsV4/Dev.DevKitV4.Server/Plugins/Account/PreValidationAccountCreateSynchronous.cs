...
{
    [CrmPluginRegistration("Create", "account", StageEnum.PreValidation, ExecutionModeEnum.Synchronous, "", "Dev.DevKitV4.Server.Plugins.Account.PreValidationAccountCreateSynchronous", 2, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, UnSecureConfiguration = "PreValidationAccountCreateSynchronous")]
