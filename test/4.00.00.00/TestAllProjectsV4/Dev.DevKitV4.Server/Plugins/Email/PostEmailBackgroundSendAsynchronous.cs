...
{
    [CrmPluginRegistration("BackgroundSend", "email", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.Plugins.Email.PostEmailBackgroundSendAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true)]
    public class PostEmailBackgroundSendAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        OutputParameters:
            ...
            HasAttachments      System.Boolean[] - require
        */

        //private readonly string unSecureConfiguration = null;
        //private readonly string secureConfiguration = null;
        //public PostEmailBackgroundSendAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (!string.Equals(context.MessageName, "BackgroundSend", StringComparison.OrdinalIgnoreCase)) throw new InvalidPluginExecutionException("MessageName does not equals BackgroundSend");
