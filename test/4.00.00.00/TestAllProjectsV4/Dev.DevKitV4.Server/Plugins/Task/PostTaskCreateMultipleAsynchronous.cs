...
namespace Dev.DevKitV4.Server.Plugins.Task
{
    [CrmPluginRegistration("CreateMultiple", "task", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.Plugins.Task.PostTaskCreateMultipleAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true, Image1Name = "PostImage", Image1Alias = "PostImage", Image1Type = ImageTypeEnum.PostImage, Image1Attributes = "*")]
    public class PostTaskCreateMultipleAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostTaskCreateMultipleAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
