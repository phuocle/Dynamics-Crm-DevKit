    ...
    public class PostPhoneCallAssignAsynchronous : IPlugin
    {
        ...
        */
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (!string.Equals(context.PrimaryEntityName, "phonecall", StringComparison.OrdinalIgnoreCase)) throw new InvalidPluginExecutionException("PrimaryEntityName does not equals phonecall");
