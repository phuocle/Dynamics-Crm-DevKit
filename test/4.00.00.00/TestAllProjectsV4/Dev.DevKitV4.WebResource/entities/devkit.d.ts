 ...
 *
 * Comprehensive TypeScript definitions for Dynamics 365 Customer Engagement Client API.
 * This library provides a PascalCase wrapper around the official Microsoft Client API,
 * working in conjunction with devkit.js runtime.
 *
 * @version 4.0
 ...
 * - PascalCase naming convention (intentional design choice)
 * - Dual-mode async support (callbacks + promises)
 * - Comprehensive JSDoc with official Microsoft documentation links
 * - Coverage of all major Client API surfaces (formContext, controls, WebApi, processes, etc.)
 *
 * Note: This library uses PascalCase naming conventions for properties and methods,
 * which differs from the official Microsoft camelCase API. This is an intentional
 * design choice to provide a consistent API surface with the devkit.js runtime.
 */
