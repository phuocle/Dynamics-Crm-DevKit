...
declare namespace DevKitV4 {
	namespace FormApplication_User {
		...
		interface Navigation {
			...
			sa_suggestedaction_CompletedBy_systemuser: DevKit.Controls.NavigationItem;
			...
			user_aiinsightcard: DevKit.Controls.NavigationItem;
			...
			user_approvalprocess: DevKit.Controls.NavigationItem;
			user_approvalstageapproval: DevKit.Controls.NavigationItem;
			user_approvalstagecondition: DevKit.Controls.NavigationItem;
			user_approvalstageintelligent: DevKit.Controls.NavigationItem;
			user_approvalstageorder: DevKit.Controls.NavigationItem;
			...
			user_businessprocess: DevKit.Controls.NavigationItem;
			user_businessprocesslinkedartifact: DevKit.Controls.NavigationItem;
			...
			user_federatedknowledgecitation: DevKit.Controls.NavigationItem;
			...
			user_federatedknowledgemetadatarefresh: DevKit.Controls.NavigationItem;
			user_flowaggregation: DevKit.Controls.NavigationItem;
			...
			user_indexedtrait: DevKit.Controls.NavigationItem;
			user_intelligentmemory: DevKit.Controls.NavigationItem;
			...
			user_knowledgefaq: DevKit.Controls.NavigationItem;
			...
			user_msdyn_aiconfigurationsearch: DevKit.Controls.NavigationItem;
			user_msdyn_aidataprocessingevent: DevKit.Controls.NavigationItem;
			user_msdyn_aidocumenttemplate: DevKit.Controls.NavigationItem;
			user_msdyn_aievaluationconfiguration: DevKit.Controls.NavigationItem;
			user_msdyn_aievaluationrun: DevKit.Controls.NavigationItem;
			...
			user_msdyn_aimodelcatalog: DevKit.Controls.NavigationItem;
			...
			user_msdyn_aioptimization: DevKit.Controls.NavigationItem;
			user_msdyn_aioptimizationprivatedata: DevKit.Controls.NavigationItem;
			user_msdyn_aitemplate: DevKit.Controls.NavigationItem;
			user_msdyn_aitestcase: DevKit.Controls.NavigationItem;
			user_msdyn_aitestcasedocument: DevKit.Controls.NavigationItem;
			user_msdyn_aitestcaseinput: DevKit.Controls.NavigationItem;
			user_msdyn_aitestrun: DevKit.Controls.NavigationItem;
			user_msdyn_aitestrunbatch: DevKit.Controls.NavigationItem;
			...
			user_msdyn_dataworkspace: DevKit.Controls.NavigationItem;
			...
			user_msdyn_healthcare_feedback: DevKit.Controls.NavigationItem;
			...
			user_msdyn_objectdetectionproduct: DevKit.Controls.NavigationItem;
			user_msdyn_onlineshopperintention: DevKit.Controls.NavigationItem;
			user_msdyn_plan: DevKit.Controls.NavigationItem;
			user_msdyn_planartifact: DevKit.Controls.NavigationItem;
			user_msdyn_planattachment: DevKit.Controls.NavigationItem;
			...
			user_msdyn_qna: DevKit.Controls.NavigationItem;
			...
			user_powerpagesddosalert: DevKit.Controls.NavigationItem;
			...
			user_powerpagessourcefile: DevKit.Controls.NavigationItem;
			user_privilegecheckerrun: DevKit.Controls.NavigationItem;
			user_processorregistration: DevKit.Controls.NavigationItem;
			...
			user_savingrule: DevKit.Controls.NavigationItem;
			...
			user_signalregistration: DevKit.Controls.NavigationItem;
			...
			user_tag: DevKit.Controls.NavigationItem;
			user_taggedflowsession: DevKit.Controls.NavigationItem;
			user_taggedprocess: DevKit.Controls.NavigationItem;
			...
			user_traitregistration: DevKit.Controls.NavigationItem;
			user_unstructuredfilesearchentity: DevKit.Controls.NavigationItem;
			user_unstructuredfilesearchrecord: DevKit.Controls.NavigationItem;
			...
			user_workflowmetadata: DevKit.Controls.NavigationItem;
			user_workqueue: DevKit.Controls.NavigationItem;
			user_workqueueitem: DevKit.Controls.NavigationItem;
			Workflow_licensee: DevKit.Controls.NavigationItem;
	...
	class FormApplication_User extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormApplication_User.Body;
		/** The Navigation of form Application_User */
		Navigation: DevKitV4.FormApplication_User.Navigation;
	...
	class FormUser extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormUser.Body;
		/** The Navigation of form User */
		Navigation: DevKitV4.FormUser.Navigation;
		/** The Grid of form User */
		Grid: DevKitV4.FormUser.Grid;
	...
	class FormUser_form_Business extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormUser_form_Business.Body;
		/** The Navigation of form User_form_Business */
		Navigation: DevKitV4.FormUser_form_Business.Navigation;
		/** The Grid of form User_form_Business */
		Grid: DevKitV4.FormUser_form_Business.Grid;
