...
(function (DevKitV4) {
	DevKitV4.TaskApi = function (e) {
		...
		task.ODataEntity = e;
		task.FormattedValue = {};
		for (const field in _task) {
			const fieldConfig = _task[field];
			webApiField(task, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		task.Entity = u;
