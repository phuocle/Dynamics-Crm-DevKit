...
(function (DevKitV4) {
	DevKitV4.TeamApi = function (e) {
		...
		const _team = {
			...
			DelegatedAuthorizationId: { b: 'delegatedauthorizationid', a: '_delegatedauthorizationid_value', c: 'delegatedauthorizations', d: 'delegatedauthorization' },
			...
			MembershipType: { a: 'membershiptype', g: 'Integer' },
		...
		team.ODataEntity = e;
		team.FormattedValue = {};
		for (const field in _team) {
			const fieldConfig = _team[field];
			webApiField(team, field, e, fieldConfig.a, fieldConfig.b, fieldConfig.c, fieldConfig.d, fieldConfig.r, u, fieldConfig.g);
		}
		team.Entity = u;
