...
declare namespace DevKitV4 {
	...
	class FormContact extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormContact.Body;
		/** The Header section of form Contact */
		Header: DevKitV4.FormContact.Header;
		/** The Navigation of form Contact */
		Navigation: DevKitV4.FormContact.Navigation;
	...
	class FormContact_Information extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormContact_Information.Body;
		/** The Header section of form Contact_Information */
		Header: DevKitV4.FormContact_Information.Header;
		/** The Navigation of form Contact_Information */
		Navigation: DevKitV4.FormContact_Information.Navigation;
		/** The Grid of form Contact_Information */
		Grid: DevKitV4.FormContact_Information.Grid;
	...
	class FormInvite_Web_Form extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormInvite_Web_Form.Body;
		/** The Navigation of form Invite_Web_Form */
		Navigation: DevKitV4.FormInvite_Web_Form.Navigation;
	...
	class FormPortal_Contact_Enhanced extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormPortal_Contact_Enhanced.Body;
		/** The Header section of form Portal_Contact_Enhanced */
		Header: DevKitV4.FormPortal_Contact_Enhanced.Header;
		/** The Navigation of form Portal_Contact_Enhanced */
		Navigation: DevKitV4.FormPortal_Contact_Enhanced.Navigation;
		/** The Grid of form Portal_Contact_Enhanced */
		Grid: DevKitV4.FormPortal_Contact_Enhanced.Grid;
	...
	class FormProfile_Web_Form_Enhanced extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormProfile_Web_Form_Enhanced.Body;
		/** The Navigation of form Profile_Web_Form_Enhanced */
		Navigation: DevKitV4.FormProfile_Web_Form_Enhanced.Navigation;
	...
	class FormProfile_Web_Form_Enhanced_Japanese extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormProfile_Web_Form_Enhanced_Japanese.Body;
		/** The Navigation of form Profile_Web_Form_Enhanced_Japanese */
		Navigation: DevKitV4.FormProfile_Web_Form_Enhanced_Japanese.Navigation;
	...
	class FormContact_Quick_Create extends DevKit.IForm {
		...
		*/
		...
		Body: DevKitV4.FormContact_Quick_Create.Body;
	}
	class ContactApi {
		/**
		...
		*/
		constructor(entity?: Record<string, any>) : DevKitV4.ContactApi;
		/**
