...
declare namespace DevKit {
	...
	export class AccountApi {
		...
		*/
		...
		readonly msdyn_travelcharge_Base: number | null;
		/** Specify how travel is charged for this account. */
		msdyn_TravelChargeType: OptionSet.Account.msdyn_TravelChargeType | null;
		...
		msevtmgt_HotelGroup: OptionSet.Account.msevtmgt_HotelGroup | null;
		msevtmgt_RentalCarProvider: OptionSet.Account.msevtmgt_RentalCarProvider | null;
		/** Type the company or business name. */
		Name: string | null;
		/** Type the number of employees that work at the account for use in marketing segmentation and demographic analysis. */
