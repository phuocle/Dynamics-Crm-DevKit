...
(function (DevKit) {
	DevKit.AccountApi = function (e) {
		...
		const _account = {
			...
			msdyn_accountkpiid: { b: 'msdyn_accountkpiid', a: '_msdyn_accountkpiid_value', c: 'msdyn_accountkpiitems', d: 'msdyn_accountkpiitem' },
			msdyn_BillingAccount: { b: 'msdyn_BillingAccount', a: '_msdyn_billingaccount_value', c: 'accounts', d: 'account' },
			msdyn_gdproptout: { a: 'msdyn_gdproptout', g: 'Boolean' },
			...
			msdyn_PrimaryTimeZone: { a: 'msdyn_primarytimezone', g: 'Integer' },
			msdyn_salesaccelerationinsightid: { b: 'msdyn_salesaccelerationinsightid', a: '_msdyn_salesaccelerationinsightid_value', c: 'msdyn_salesaccelerationinsights', d: 'msdyn_salesaccelerationinsight' },
			...
			msdyn_TaxExempt: { a: 'msdyn_taxexempt', g: 'Boolean' },
			msdyn_TaxExemptNumber: { a: 'msdyn_taxexemptnumber' },
			msdyn_TravelCharge: { a: 'msdyn_travelcharge', g: 'Number' },
			msdyn_travelcharge_Base: { a: 'msdyn_travelcharge_base', r: true, g: 'Number' },
			msdyn_TravelChargeType: { a: 'msdyn_travelchargetype', g: 'Integer' },
			...
			msevtmgt_HotelGroup: { a: 'msevtmgt_hotelgroup', g: 'Integer' },
			msevtmgt_RentalCarProvider: { a: 'msevtmgt_rentalcarprovider', g: 'Integer' },
			Name: { a: 'name' },
			NumberOfEmployees: { a: 'numberofemployees', g: 'Integer' },
			OnHoldTime: { a: 'onholdtime', r: true, g: 'Integer' },
			OpenDeals: { a: 'opendeals', r: true, g: 'Integer' },
			OpenDeals_Date_UtcDateAndTime: { a: 'opendeals_date', r: true, g: 'DateTime' },
			OpenDeals_State: { a: 'opendeals_state', r: true, g: 'Integer' },
			OpenRevenue: { a: 'openrevenue', r: true, g: 'Number' },
			OpenRevenue_Base: { a: 'openrevenue_base', r: true, g: 'Number' },
			OpenRevenue_Date_UtcDateAndTime: { a: 'openrevenue_date', r: true, g: 'DateTime' },
			OpenRevenue_State: { a: 'openrevenue_state', r: true, g: 'Integer' },
			...
			TeamsFollowed: { a: 'teamsfollowed', g: 'Integer' },
...
(function (OptionSet) {
	OptionSet.Account = {
		...
		CustomerTypeCode : { Competitor: 1, Consultant: 2, Customer: 3, Influencer: 6, Insurance_carrier: 13, Investor: 4, Other: 12, Partner: 5, Press: 7, Prospect: 8, Reseller: 9, Supplier: 10, Vendor: 11 },
		...
		msdyn_TravelChargeType : { Fixed: 690970002, Hourly: 690970000, Mileage: 690970001, None: 690970003 },
		msevtmgt_HotelGroup : { No: 100000001, Yes: 100000002 },
		msevtmgt_RentalCarProvider : { No: 100000001, Yes: 100000002 },
