...
{
    [CrmPluginRegistration("devkit_CustomActionSync", "none", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.Server.CustomAction.PostNonedevkit_CustomActionSyncAsynchronous2", 2, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
    public class PostNonedevkit_CustomActionSyncAsynchronous2 : IPlugin
    {
        /* Custom Action 1
        InputParameters:
        ...
        */
        ...
        //public PostNonedevkit_CustomActionSyncAsynchronous2(string unSecureConfiguration, string secureConfiguration)
        //{
