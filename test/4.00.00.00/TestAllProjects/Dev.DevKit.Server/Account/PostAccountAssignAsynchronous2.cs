...
{
    [CrmPluginRegistration("Assign", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.Server.Account.PostAccountAssignAsynchronous", 2, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true)]
    public class PostAccountAssignAsynchronous2 : IPlugin
    {
        /* PL1
        InputParameters:
