...
{
    [CrmPluginRegistration("Assign", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKit.Server.Account.PostAccountAssignAsynchronous4", 4, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true)]
    public class PostAccountAssignAsynchronous4 : IPlugin
    {
        /* This is custom template for Plugin 2
        InputParameters:
        ...
        */
        ...
        //public PostAccountAssignAsynchronous4(string unSecureConfiguration, string secureConfiguration)
        //{
