...
//		Last Modified: 2025-09-09 07:18:43
// </auto-generated>
//---------------------------------------------------------------------------------------------------
...
namespace Dev.DevKit.Server.Entities.TeamOptionSets
{
...
{
    [DebuggerNonUserCode()]
    public partial class Team : Dev.DevKit.Shared.EntityBase
    {
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Server.Entities.TeamOptionSets.MembershipType"/></para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Server.Entities.TeamOptionSets.MembershipType.Members_and_guests"/></para>
        /// </summary>
        [DebuggerNonUserCode()]
        public Dev.DevKit.Server.Entities.TeamOptionSets.MembershipType? MembershipType
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.MembershipType);
                if (value == null) return null;
                return (Dev.DevKit.Server.Entities.TeamOptionSets.MembershipType)value.Value;
            }
            set
            {
                if (value.HasValue)
        ...
        /// <para><strong>OptionSet</strong>: <see cref="Dev.DevKit.Server.Entities.TeamOptionSets.TeamType"/></para>
        /// <para><strong>Default Value</strong>: <see cref="Dev.DevKit.Server.Entities.TeamOptionSets.TeamType.Owner"/></para>
        /// </summary>
        [DebuggerNonUserCode()]
        public Dev.DevKit.Server.Entities.TeamOptionSets.TeamType? TeamType
        {
            get
            {
                var value = Entity.GetAttributeValue<OptionSetValue>(Fields.TeamType);
                if (value == null) return null;
                return (Dev.DevKit.Server.Entities.TeamOptionSets.TeamType)value.Value;
            }
            set
            {
                if (value.HasValue)
