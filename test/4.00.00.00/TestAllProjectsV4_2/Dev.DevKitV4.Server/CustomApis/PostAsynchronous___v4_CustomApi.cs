...
{
    [CrmPluginRegistration("v4_CustomApi", "none", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.CustomApis.PostAsynchronous___v4_CustomApi", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
    public class PostAsynchronous___v4_CustomApi : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostAsynchronous___v4_CustomApi(string unSecureConfiguration, string secureConfiguration)
        //{
