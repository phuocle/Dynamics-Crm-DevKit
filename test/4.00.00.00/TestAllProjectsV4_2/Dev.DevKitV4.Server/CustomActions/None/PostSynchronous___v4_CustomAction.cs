...
namespace Dev.DevKitV4.Server.CustomActions.None
{
    [CrmPluginRegistration("v4_CustomAction", "none", StageEnum.PostOperation, ExecutionModeEnum.Synchronous, "", "Dev.DevKitV4.Server.CustomActions.None.PostSynchronous___v4_CustomAction", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction)]
    public class PostSynchronous___v4_CustomAction : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostSynchronous___v4_CustomAction(string unSecureConfiguration, string secureConfiguration)
        //{
