...
{
    [CrmPluginRegistration("v4_AccountCustomAction", "account", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "Dev.DevKitV4.Server.CustomActions.Account.PostAsynchronous___v4_AccountCustomAction", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
    public class PostAsynchronous___v4_AccountCustomAction : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostAsynchronous___v4_AccountCustomAction(string unSecureConfiguration, string secureConfiguration)
        //{
