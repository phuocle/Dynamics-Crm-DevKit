...
"%DynamicsCrmDevKitCli%\tools\DynamicsCrm.DevKit.Cli.exe" /conn:%ConnectionString% /json:"..\..\..\DynamicsCrm.DevKit.Cli.json" /type:"webresources" /profile:"DOWNLOAD_DEVKITV4"