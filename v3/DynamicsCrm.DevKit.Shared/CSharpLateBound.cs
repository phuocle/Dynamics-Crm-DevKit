...
namespace DynamicsCrm.DevKit.Shared
{
    public static class CSharpLateBound
    {
        ...
        public static string GetCsCode(CrmServiceClient crmServiceClient, EntityMetadata entityMetadata, string schemaName, string rootNameSpace)
        {
            ...
            code += $"{{{NEW_LINE}";
            code += $"{TAB}public partial class {schemaName} : EntityBase{NEW_LINE}";
            code += $"{TAB}{{{NEW_LINE}";
            ...
            code += $"{TAB}{TAB}public {schemaName}(){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
            ...
            code += $"{NEW_LINE}";
            code += $"{TAB}{TAB}[DebuggerNonUserCode()]{NEW_LINE}";
            code += $"{TAB}{TAB}public {schemaName}(Guid {schemaName}Id){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
            code += $"{TAB}{TAB}{TAB}Entity = new Entity(EntityLogicalName, {schemaName}Id);{NEW_LINE}";
            code += $"{TAB}{TAB}{TAB}PreEntity = CloneThisEntity(Entity);{NEW_LINE}";
            code += $"{TAB}{TAB}}}{NEW_LINE}";
            code += $"{NEW_LINE}";
            code += $"{TAB}{TAB}[DebuggerNonUserCode()]{NEW_LINE}";
            code += $"{TAB}{TAB}public {schemaName}(string keyName, object keyValue){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
            ...
            code += $"{NEW_LINE}";
            code += $"{TAB}{TAB}[DebuggerNonUserCode()]{NEW_LINE}";
            code += $"{TAB}{TAB}public {schemaName}(Entity entity){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
            ...
            code += $"{NEW_LINE}";
            code += $"{TAB}{TAB}[DebuggerNonUserCode()]{NEW_LINE}";
            code += $"{TAB}{TAB}public {schemaName}(Entity entity, Entity merge){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
            code += $"{TAB}{TAB}{TAB}Entity = entity;{NEW_LINE}";
            ...
            code += $"{NEW_LINE}";
            code += $"{TAB}{TAB}[DebuggerNonUserCode()]{NEW_LINE}";
            code += $"{TAB}{TAB}public {schemaName}(KeyAttributeCollection keys){NEW_LINE}";
            code += $"{TAB}{TAB}{{{NEW_LINE}";
        ...
        private static string DeclareType(AttributeMetadata attribute)
        {
            ...
            switch (attribute.AttributeType)
            {
                ...
                case AttributeTypeCode.Status:
                    return $"{RootNameSpace}.{EntityMetadata.SchemaName}OptionSets.{Utility.SafeIdentifier(attribute.SchemaName)}?";
                ...
                case AttributeTypeCode.String:
                    if (attribute is MultiSelectPicklistAttributeMetadata)
                        return $"System.Collections.Generic.List<{RootNameSpace}.{EntityMetadata.SchemaName}OptionSets.{attribute.SchemaName}>";
                    else
                        return $"string";
        ...
        private static string GetGet(AttributeMetadata attribute)
        {
            ...
            switch (attribute.AttributeType)
            {
                ...
                case AttributeTypeCode.Status:
                    ...
                    code += $"{TAB}{TAB}{TAB}{TAB}return ({RootNameSpace}.{EntityMetadata.SchemaName}OptionSets.{Utility.SafeIdentifier(attribute.SchemaName)})value.Value;{NEW_LINE}";
                    code += $"{TAB}{TAB}{TAB}}}{NEW_LINE}";
                    return code;
                case AttributeTypeCode.BigInt:
                ...
                case AttributeTypeCode.String:
                    if (attribute is MultiSelectPicklistAttributeMetadata)
                    {
                        code += $"{TAB}{TAB}{TAB}get{NEW_LINE}";
                        code += $"{TAB}{TAB}{TAB}{{{NEW_LINE}";
                        code += $"{TAB}{TAB}{TAB}{TAB}var data = new System.Collections.Generic.List<{RootNameSpace}.{EntityMetadata.SchemaName}OptionSets.{attribute.SchemaName}>();{NEW_LINE}";
                        ...
                        code += $"{TAB}{TAB}{TAB}{TAB}{TAB}{TAB}data.Add(({RootNameSpace}.{EntityMetadata.SchemaName}OptionSets.{attribute.SchemaName})item.Value);{NEW_LINE}";
                        code += $"{TAB}{TAB}{TAB}{TAB}{TAB}}}{NEW_LINE}";
                        code += $"{TAB}{TAB}{TAB}{TAB}}}{NEW_LINE}";
