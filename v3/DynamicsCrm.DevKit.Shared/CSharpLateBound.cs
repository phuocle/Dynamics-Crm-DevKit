        ...
        private static string DeclareType(AttributeMetadata attribute)
        {
            ...
            switch (attribute.AttributeType)
            {
                ...
                case AttributeTypeCode.Status:
                    return $"{RootNamespace}.{Utility.SafeDeclareName(EntityMetadata.SchemaName)}OptionSets.{Utility.SafeIdentifier(attribute.SchemaName)}?";
                ...
                case AttributeTypeCode.String:
                    if (attribute is MultiSelectPicklistAttributeMetadata)
                        return $"System.Collections.Generic.List<{RootNamespace}.{Utility.SafeDeclareName(EntityMetadata.SchemaName)}OptionSets.{attribute.SchemaName}>";
                    else
                        return $"string";
