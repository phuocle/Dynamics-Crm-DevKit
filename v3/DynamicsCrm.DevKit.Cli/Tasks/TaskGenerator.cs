...
namespace DynamicsCrm.DevKit.Cli.Tasks
{
    public class TaskGenerator : ITask
    {
        ...
        private string GetDefaultFileWithCs(EntityMetadata entityMetadata, string @namespace)
        {
            ...
            code += $"{TAB}{TAB}//public xxxxxxxOptionSets.xxxxxxxx_code? OptionSetField {{ get {{ return (xxxxxxxOptionSets.xxxxxxxx_code?)GetAliasedValue<OptionSetValue>(\"aliased.field\")?.Value; }} }}{NEW_LINE}";
            ...
            code += $"{TAB}{TAB}{TAB}throw new InvalidPluginExecutionException(\"Not Implemented\");{NEW_LINE}";
            code += $"{TAB}{TAB}}}{NEW_LINE}";
            code += NEW_LINE;
            code += $"{TAB}{TAB}#endregion{NEW_LINE}";
            code += $"{TAB}}}{NEW_LINE}";
